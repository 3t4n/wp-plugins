...
* Modified code by the Enzo Sforna
*
...
;(function($) {
	...
	*/
	...
	Calendar.defaultSelectHandler = function(calendar) {
		...
		//remark
		myid=$(calendar.dateField).attr('id');
		var myid=myid.substr(7,40);
		if($("#"+myid).length>0){
			var iso_format='%Y-%m-%d';
			($('#'+myid).attr('tagName') == 'INPUT')
				? $('#'+myid).attr('value',calendar.date.print(iso_format))
				: $('#'+myid).attr('innerHTML',calendar.date.print(iso_format));
		}
		//remark
