...
Tags: woocommerce, quick view, product quick view, product popup, woocommerce quick view
...
QuickSwish is an ultimate and exclusive WooCommerce plugin that allows you to create stunning quickview button for your WooCommerce store. By using this handy Quickview plugin.
...
= Button Settings: =
* Enable you to show the button in product list page.
* Enable you to show the button in the mobile device.
* You can set the Shop Page Button Position.
* The options to customize Quickview button text, icon and style.

= Popup Settings: =
* The options to thumbnail layout control.
* Shortable content manager
* Ajax Quick Add to cart
* Social share button

= Style Settings: =
* From the style settings, you can set the Button style, popup window width etc.

= Why Use QuickSwish - WooCommerce Product Quick View? =
The Quick View is a common feature in e-commerce websites nowadays that quickly provides essential information about a product to help customers proceed easily to the purchase step. For example, it displays the price and specifications of the product to the viewers, enabling them to get a quick overview of the product they are looking for. With a sophisticated product quick view button, the online buyers can remain more focused on what they actually want as they don't have to open the products in a new tab. The role of an ideal Product quick view on your e-commerce site is significant in terms of improving customer experience, increasing site ranking, or reducing the bounce rate. Therefore QuickSwish - WooCommerce Product Quick View comes into play as your perfect assistant in including excellent quick view functionality within your WooCommerce site. It means that you can offer more convenience for anyone who comes to your site and browses the products you offer!

Try this highly customizable and feature-rich WooCommerce product quick view plugin today to grab more attention of your potential customers, empowering them to browse your products with more ease and comfort.
...
2. Search For "QuickSwish".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `quickswish` folder to the `/wp-content/plugins/` directory
...
3. Now you can use our QuickSwish.
...
2. Popup Settings
3. Style Options
4. Button frontend view
5. Popup frontend view
