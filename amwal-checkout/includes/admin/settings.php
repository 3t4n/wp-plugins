...
//	register_setting( $section_name, AMWALWC_SETTINGS_ENABLE_CRONJOBS );
	...
	add_settings_section( $section_name, '', false, $section_name );
	register_setting( $section_name, AMWALWC_SETTING_ENABLE_DYNAMIC_SHIPPING_DETAILS );
...
//	add_settings_field( AMWALWC_SETTINGS_ENABLE_CRONJOBS, __( 'Cron Jobs', 'amwal-checkout' ), 'amwalwc_cron_jobs_content', $settings_section, $settings_section );
	...
	add_settings_field( AMWALWC_SETTING_ENABLE_DYNAMIC_SHIPPING_DETAILS, __( 'Enable Dynamic Shipping Retrieve', 'amwal-checkout' ), 'amwalwc_amwalwc_enable_dynamic_shipping_details_content', $settings_section, $settings_section );
...
function amwalwc_amwalwc_enable_dynamic_shipping_details_content(){
	$amwalwc_enable_dynamic_shipping = amwalwc_get_option_or_set_default( AMWALWC_SETTING_ENABLE_DYNAMIC_SHIPPING_DETAILS, '1' );

	amwalwc_settings_field_checkbox(
		array(
			'name'        => AMWALWC_SETTING_ENABLE_DYNAMIC_SHIPPING_DETAILS,
			'current'     => $amwalwc_enable_dynamic_shipping,
			'label'       => __( 'Enable dynamic shipping retrieve', 'amwal-checkout' ),
		)
	);
}
/**
