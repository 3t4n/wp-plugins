...
define('AMWALWC_VERSION', '1.0.62');
define('AMWALWC_SDK_VERSION', '0.0.60');
...
if (amwalwc_is_woocommerce_active()) {
	...
	function amwalwc_plugins_loaded() {
		...
		require_once AMWALWC_PATH . 'includes/class-wc-gateway-amwal-installments.php';
		require_once AMWALWC_PATH . 'includes/blocks/amwal-checkout-blocks.php';
	}
