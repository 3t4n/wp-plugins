<?php
/**
 * Class WC_Gateway_Amwal_Installment file.
 *
 * @package Amwal
 */
...
class WC_Gateway_Amwal_Installments extends WC_Gateway_Amwal {
	...
	public function __construct() {
		...
		$this->id                 = AMWALWC_PAYMENT_METHOD_ID.'_installments';
		$this->supports = [
			'products',
			'refunds',
		];
		...
		$this->title   = __( 'Installment Checkout', 'amwal-checkout' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				...
				'type'        => 'checkbox',
				'label'       => __( 'Enable Amwal Installment', 'amwal-checkout' ),
...
//        }
	...
	{
		amwalwc_render_cart(AMWALWC_BTNPOS_BEFORE_CHECKOUT, $order_id, 'installments');
	}
}