jQuery(function ($) {
    ...
    if (typeof window.wc !== 'undefined' && typeof window.wp !== 'undefined' && typeof window.wc.wcSettings !== 'undefined' && typeof window.wc.wcBlocksRegistry !== 'undefined') {
        const settings = window.wc.wcSettings.getSetting('amwalcheckout_installments_data', {});
        const label = window.wp.htmlEntities.decodeEntities(settings.title) || window.wp.i18n.__('Installment Checkout', 'amwal-checkout');

        const Icon = () => {
            return settings.icon
                ? window.wp.element.createElement('img', {
                    src: settings.icon, id: 'amwalcheckout_installments-logo', style: {
                        maxWidth: '70px',
                        float: 'right',
                        paddingTop: '6px'
                    }
        ...
        const Block_Gateway = {
            name: 'amwalcheckout_installments',
        ...
        const css = `
         html[lang="en"] #amwalcheckout_installments-logo {
             float: right !important;
         }
         html[lang="ar"] #amwalcheckout_installments-logo {
