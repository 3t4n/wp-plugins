<section class="general" id="fc-general-section">
    ...
    <table class="widefat wpx-table">
        <?php 
            ...
            WPXtension_Setting_Fields_Basic::select(
                $options = array(
                    'tr_class' => '',
                    'label' => esc_attr__('Tray Position', 'fast-cart'),
            ...
            WPXtension_Setting_Fields_Basic::select(
                $options = array(
                    'tr_class' => 'alternate',
                    'label' => esc_attr__('Closing Behavior', 'fast-cart'),
            ...
            WPXtension_Setting_Fields_Basic::multiselect(
                $options = array(
                    ...
                    'label' => esc_attr__('Select Menus', 'fast-cart'),
    ...
    <table class="widefat wpx-table">
        ...
        <?php 
            ...
            WPXtension_Setting_Fields_Basic::checkbox(
                $options = array(
                    'tr_class' => 'new',
                    'label' => esc_attr__('Enable Quantity Control', 'fast-cart'),
    ...
    <h3><?php echo esc_attr__( 'Floating Cart Icon Settings', 'fast-cart'); ?></h3>
    <table class="widefat wpx-table">
        <?php 
    ...
    <h3><?php echo esc_attr__( 'Styling', 'fast-cart' ); ?></h3>
    <table class="widefat wpx-table">
        ...
        ?>
        <tr class="alternate new" valign="top" data-new-tag="New">
            ...
            <td>
                <div class="buttons-style">
                    <label>
                        <input type="radio" name="fast_cart_option[buttons_style]" value="inline" <?php echo ( Fast_Cart::get_options()->buttons_style === 'inline' ) ? "checked" : ""; ?> />
                        <span>
                    ...
                    <label>
                        <input type="radio" name="fast_cart_option[buttons_style]" value="full" <?php echo ( Fast_Cart::get_options()->buttons_style === 'full' ) ? "checked" : ""; ?> />
                        <span>
                            <img src="<?php  // phpcs:disable PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
