    ...
    <div id="post-body" class="metabox-holder columns-2">
        ...
        <?php 
            ...
            WPXtension_Sidebar::block(
                ...
                'Documentation',
                'To know more about settings, Please check our <a href="https://wordpress.org/plugins/fast-cart/" target="_blank">documentation</a>'
            ); 
            ...
            WPXtension_Sidebar::block(
                ...
                'Help & Support',
                'Still facing issues with Fast Cart for WooCommerce? Please <a href="https://wordpress.org/support/plugin/fast-cart/" target="_blank">open a ticket.</a>'
            ); 
