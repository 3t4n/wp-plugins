...
== Description ==
WC Builder is a WooCommerce Addons for WPBakery Page Builder. WC Builder is included in this plugin to build a custom product page and archive page.

[Download Pre-build Templates for WC Builder Free and Pro](https://demo.hasthemes.com/plugins/wc-builder/wc-builder-prebuild-templates.zip)

== WC Builder Includes ==
* WooCommerce Template Builder (Basic)
* Option to select single product layout.
* Option to select an archive page template.
* Option to build an unlimited custom design for WooCommerce pages.
* 15+ Addons
* Rename Label
* Ajax add to Cart for Single Product
* Redirect to "Checkout Page" after "Add to Cart" features
* Unlimited Color and Font Variations.

== WC Builder Pro Features ==
* Cart Page Builder
* Checkout Page Builder
* Thank You Page Builder
* MyAccount Page Builder
* Category Specific Layout Builder
* Individual Product Layout Builder
* Rename labels (Includes all)
* Sticky Add to Cart for Product Details page
* Sidebar / Side / Floating Cart for Product Details page
* 34+ Addons

[PURCHASE WC BUILDER PRO FROM OUR WEBSITE](https://hasthemes.com/plugins/wc-builder-woocoomerce-page-builder-for-wpbakery/#pricing)

### VIDEO TUTORIALS:
https://youtu.be/BjZu-6YBql4
...
> Don't forgate to check our WooLentor – WooCommerce Elementor Addons + Builder
...
= Version: 1.0.18 - Date: 27 Sep 2022 =
* Updated: Plugin list in the Recommendations menu

= Version: 1.0.17 - Date: 16 Nov 2021 =
* Improved: Admin notice 

= Version: 1.0.16 - Date: 12 Oct 2021 =
* Added: Compatibility for the "Bridge" theme
* Fixed: Related products columns & posts per page does not show problem

= Version: 1.0.15 - Date: 05 Sep 2021 =
* Added: Condition for hook_suffix

= Version: 1.0.14 - Date: 18 Jul 2021 =
* Fixed: Archive product shortcode Ordering & Query post type issues

= Version: 1.0.13 - Date: 23 Jun 2021 =
* Recommendation class warning fixed on plugin activation
* Added quick settings link

= Version: 1.0.12 - Date: 08 Jun 2021 =
* Fixed recommended plugins code
* Fixed related products responsive issue
* Added copatibility for any custom WPBakery page builder plugin

= Version: 1.0.11 - Date: 01 Jun 2021 =
* Added recommended plugins
* 

= Version: 1.0.8 - Date: 2021-01-06 =
* Capability With latest WordPress Version

= Version: 1.0.6 - Date: 2020-04-26 =
* Product title Style Issue Solved.
* Product Add To cart Style Issue Solved.
* Product Data tab style Issue solved.
* Product description style issue solved.
* Product meta style issue solved.
* Product Price style issue solved.
* Product rating style issue solved.
* Product sort description style issue solved.

== Installation ==
This section describes how to install the WC Builder plugin and get it working.

= 1) Install =

1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "WC Builder".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `wc-builder` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. After install and activate the plugin you will get a notice to install WpBakery Page Builder Plugin ( If allready install it then do not show notice. ).
2. Install and Activate the plugin
3. ‘WPBforWPbakery’ Category will be appear in WPBakery page builder
