	...
	public function render_plugin_page(): void
    {
		...
		echo '<form action="" method="post" id="spel_settings" name="spel_settings" class="wrapper spel_dashboard">';
			...
			echo '<div class="sidebar_navigation">';
				...
				if ( file_exists(require_once __DIR__ . '/dashboard/sidebar.php') ) {
			...
			echo '<div class="tab_contents">';
				...
				if ( file_exists(require_once __DIR__ . '/dashboard/welcome.php') ) {
					require_once __DIR__ . '/dashboard/welcome.php';
				}

				if ( file_exists(require_once __DIR__ . '/dashboard/elements.php') ) {
					require_once __DIR__ . '/dashboard/elements.php';
				}

				if ( file_exists(require_once __DIR__ . '/dashboard/features.php') ) {
