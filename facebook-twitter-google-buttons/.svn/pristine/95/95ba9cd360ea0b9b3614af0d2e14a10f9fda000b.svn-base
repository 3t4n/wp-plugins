<?php
/* 
Plugin Name: Facebook Like and Share , Twitter , Google +1 , Google buzz buttons 
Plugin URI: http://freewpthemesandplugins.com/facebook-like-and-share-twitter-google-1-google-buzz-buttons-4/ 
...
Author: Dominique1 
Version: 1.1 
Author URI: http://freewpthemesandplugins.com/ 
*/
...
add_shortcode( 'kon_tergos', 'kon_tergos_shortcode' );
