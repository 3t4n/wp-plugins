    ...
    <tr>
      ...
      <td>
        <p class="description">
          ...
          <span class="more"><?php echo wp_kses( __( '<strong>Requirements</strong>: video has to be on https:// and splash screen has to be present. Videos with download protection are automatically excluded.', 'fv-player' ), array( 'strong' => array() ) ); ?></span> <a href="#" class="show-more">(&hellip;)</a>
        </p>
      </td>
    </tr>
    <?php
