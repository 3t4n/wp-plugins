...
function mightyforms_register_admin_settings()
{
    ...
    $page_hook = add_submenu_page('mightyforms', 'Dashboard', 'Dashboard', 'manage_options', 'mightyforms', 'mightyforms_run_application');
    $page_forms_hook = add_submenu_page('mightyforms', 'Embed Forms', 'Embed Forms', 'manage_options', 'mightyforms-forms', 'mightyforms_run_forms');
    add_submenu_page('mightyforms', 'How to', 'How to', 'manage_options', 'mightyforms-how-to', 'mightyforms_run_how_to');

    add_action( "load-{$page_hook}", 'mightyforms_admin_load_assets' );
    add_action( "load-{$page_forms_hook}", 'mightyforms_forms_admin_load_assets' );
}
