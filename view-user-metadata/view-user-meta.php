...
class SS88_ViewUserMetadata {
    ...
    function admin_enqueue_scripts() {
        ...
        wp_enqueue_script('SS88_VUM-jsuser', plugin_dir_url( __FILE__ ) . 'assets/js/user.js', false, $this->V);
        ...
        <tbody>
            ...
            <tr>
                <th>
					...
					<button class="btn-delete" data-key="<?php echo esc_html($Key); ?>" data-uid="<?php echo intval($U->ID); ?>" title="Delete this entry" type="button"><span class="dashicons dashicons-trash"></span></button>
				</th>
                <td>
