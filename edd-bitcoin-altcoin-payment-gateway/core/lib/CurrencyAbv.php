...
class CurrencyAbv {
     ...
     * @return type
     */
    public static function full_name( $slug ){
        $full_names =  array(
        ...
        return isset($full_names[$slug]) ? $full_names[ $slug ] : '';
    }
     ...
     * @return type
     */
    public static function symbol( $slug ){
        $symbols = array(
		'AED' => '&#x62f;.&#x625;',
		'AFN' => '&#x60b;',
		'ALL' => 'L',
        ...
        $slug = strtoupper( $slug );
        return isset( $symbols[ $slug ] ) ? $symbols[ $slug ] : '';
    }
}
