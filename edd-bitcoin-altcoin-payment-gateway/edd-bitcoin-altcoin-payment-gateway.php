...
/**
 * @wordpress-plugin
 * Plugin Name:       CS Easy Digital Downloads - Bitcoin / AltCoin Payment Gateway
 * Plugin URI:        https://coinmarketstats.online/product/easy-digital-downloads-bitcoin-altcoin-payment-gateway
 * Description:       A very light weight Crypto-currency payment gateway for Easy Digital Downloads. Accept Bitcoin, Bitcoin Cash, Ethereum, Dogecoin, Dash, Litecoin, Ripple & 1800+ cryptocurrencies  
 * Version:           1.0.1
 * Author:            CoinMarketStats
 * Author URI:        http://coinmarketstats.online
 * License:           GPLv3
