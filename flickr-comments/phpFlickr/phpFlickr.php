	...
	class phpFlickr {
		...
		function post ($data, $type = null) {
			...
			if ( function_exists('curl_init') ) {
				...
				curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false); //jdleung
				curl_setopt($curl, CURLOPT_SSL_VERIFYHOST, false); //jdleung
...
/* 			$this->parsed_response = json_decode($this->response, TRUE); */
			$this->parsed_response = $this->clean_text_nodes(json_decode($this->response, TRUE)); // jdleung
...
/* 			return $this->parsed_response ? $this->parsed_response['items']['item'] : false; */
			return $this->parsed_response ? $this->parsed_response['items'] : false; // jdleung
