...
<div class="cp-sw-status-bar cp-sw-status-bar--<?php echo $uuid; ?>"
    style="<?php echo esc_attr(trim($styles)); ?>"
    data-site-url="<?php echo esc_url( get_site_url() ); ?>"
    data-twitch-username="<?php echo esc_attr($twitchUsername); ?>"
    data-youtube-username="<?php echo esc_attr($youtubeUsername); ?>"
    data-kick-username="<?php echo esc_attr($kickUsername); ?>"
        ...
        <div class="cp-sw-status-bar__right">
            ...
            <?php if ( ! $hideButtons ) : ?>
                <div class="cp-sw-status-bar__cta-wrapper">
                    <?php if ($kickUsername) { ?>
                        <a class="l-kick-cta" href="https://www.kick.com/<?php echo esc_attr($kickUsername); ?>" data-status="" target="_blank"><i aria-hidden="true">
                    ...
                    <?php if ($twitchUsername) { ?>
                        <a class="l-twitch-cta" href="https://www.twitch.tv/<?php echo esc_attr($twitchUsername); ?>" data-status="" target="_blank"><i aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="200" height="200" viewBox="0 0 200 200" xml:space="preserve">
                    ...
                    <?php if ($youtubeUsername) { ?>
                        <a class="l-youtube-cta" href="https://www.youtube.com/channel/<?php echo esc_attr($youtubeUsername); ?>" data-status="" target="_blank"><i aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="200" height="200" viewBox="0 0 200 200" xml:space="preserve">
