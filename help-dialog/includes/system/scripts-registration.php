...
function ephd_get_common_admin_script_vars() {
	...
	return array(
		...
		'msg_no_data'                   => esc_html__( 'No data recorded yet for the selected time frame. Excluded users will not be counted.', 'help-dialog' ),
		...
		'include_wildcard_url'        	=> esc_html__( 'Include Pages Matching URL', 'help-dialog' ),
		'exclude_wildcard_url'        	=> esc_html__( 'Exclude Pages Matching URL', 'help-dialog' ),
		'msg_save_widget'             	=> esc_html__( 'To save the widget, set the widget\'s appearance location settings', 'help-dialog' ),
	);
}
