...
The plugin doesn't use the official MailChimp API wrapper and instead the super-simple [MailChimp API v3 wrapper](https://github.com/drewm/mailchimp-api/) provided by [Drew McLellan](http://allinthehead.com/).
