...
<div>
    ...
    <div class="emtmpl-setting-row" data-attr="user_role">
        <div class="emtmpl-option-label"><?php esc_html_e( 'Apply to user role', '9mail-wp-email-templates-designer' ) ?></div>
        <a href="https://1.envato.market/kj3VaN" target="_blank" class="vi-ui small button">
