...
= 0.67 =
*Jul 08 2024*
* Safer usage of configured external services ID strings.
* Minor translation help additions.
* WordPress 6.6 basic compatibility checked.

= 0.66 =
*Apr 03 2024*
* Fixed the newsletter subscription purpose indication on the first layer.
* Changed the required capability to access the settings page.
* Adjusted timezone for copyright year calculation.
* Fixed admin menu notifications display.
* Improved language detection.
* Extended output filtering.
