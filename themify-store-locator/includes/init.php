...
class Themify_Store_Locator {
	...
	function setting_page(){
		if(isset($_POST['action']) && $_POST['action'] == 'themify_sl_data'){
            if ( wp_verify_nonce( $_POST['_wpnonce'], 'themify_storelocator_settings' ) ) {
	...
	<div class="wrap">
		...
		<form action="" method="post">
            <?php
            wp_nonce_field( 'themify_storelocator_settings' );
            ?>
			<style>
				.sl_table {
					text-align:left;
	...
	public function admin_enqueue() {
		...
		wp_enqueue_script( 'themify-store-locator-marker', THEMIFY_STORE_LOCATOR_URI . 'assets/js/marker.js', null, THEMIFY_STORE_LOCATOR_VERSION, true );
		wp_enqueue_script( 'themify-store-locator', THEMIFY_STORE_LOCATOR_URI . 'assets/js/admin_js.js', null, THEMIFY_STORE_LOCATOR_VERSION, true );
	...
	function user_enqueue(){
		wp_enqueue_script( 'themify-store-locator', THEMIFY_STORE_LOCATOR_URI . 'assets/js/user_js.js', null, THEMIFY_STORE_LOCATOR_VERSION, true );
		wp_localize_script( 'themify-store-locator', 'themifyStoreLocator', array(
			'ajaxurl' => admin_url( 'admin-ajax.php' ),
			'marker_js' =>  THEMIFY_STORE_LOCATOR_URI . 'assets/js/marker.js',
