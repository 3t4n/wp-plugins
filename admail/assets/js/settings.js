jQuery(document).ready(function ($) {
    ...
    $("div#toggle-button input.checkbox").click(function () {
        ...
        var settingDiv = $(this).closest('.setting');
        
        if ($(this).prop('checked') == true) {
            
            $(this).val('1');
            
            if(settingDiv.hasClass('hider')){
                
                settingDiv.closest('.hide-parent').addClass('enabled');
            ...
            if(settingDiv.hasClass('hider')){
                ...
                settingDiv.closest('.hide-parent').removeClass('enabled');
    ...
    $('.nm-save-settings').click(function (e) {
        ...
        $(".setting select").each(function () {
            var attr = $(this).attr('setting');
            var value = $(this).val();
            if (typeof attr !== 'undefined' && attr !== false && value !== '') {
                allSettings[attr] = value;
            }
        });
