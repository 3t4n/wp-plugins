    ...
    <div class="inner-content">
        <div class="wc-ambisn-form <?php echo esc_attr($popup_close_class); ?>">
            ...
            <div class="subscription-form">
                ...
                <button data-sitekey="<?php echo esc_attr($recaptcha_tree_site_key); ?>" data-callback='onSubmit' data-action='submit' type="submit" name="ambisn-submit" class='g-recaptcha wc-ambisn-button product-<?php echo esc_attr($product_id); ?>' id="ambisn-submit" value="<?php echo esc_attr(ambisn_get_translated('button_text')); ?>"><?php echo esc_attr(ambisn_get_translated('button_text')); ?><span class="ld-circle"></span></button>
  
                <?php } else{ ?>
                
                <button type="submit" name="ambisn-submit" class='wc-ambisn-button product-<?php echo esc_attr($product_id); ?>' id="ambisn-submit" value="<?php echo esc_attr(ambisn_get_translated('button_text')); ?>"><?php echo esc_attr(ambisn_get_translated('button_text')); ?><span class="ld-circle"></span></button>
