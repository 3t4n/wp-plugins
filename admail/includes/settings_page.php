...
<div class="settings-container ambisn-settings">
    ...
    <div class="section-container">
        <div class="sec-heading">
            ...
            $custom_position_enabled = ambisn_get_setting('enable_custom_form_position') == 1 ? 'enabled' : '';
            
            echo '<div class="custom-position admail-setting-wrapper hide-parent beta-setting '.$custom_position_enabled.'">';
            
            $admail_settings->print_setting_html('enable_custom_form_position','toggle','Enable custom form position (BETA)','','','hider');
            
            echo '<div class="tb-hidden">';
            
            $product_positions = array(
                'woocommerce_before_single_product_summary'   => 'Before the product summary',
                'woocommerce_single_product_summary'          => 'Inside the product summary (Default)',
                'woocommerce_after_single_product_summary'    => 'After the product summary',
                'woocommerce_after_single_product'            => 'After the single product wrapper',
                'woocommerce_product_thumbnails'              => 'After the product image thumbnails',
                ...
                'woocommerce_after_add_to_cart_button'        => 'After the add to cart button',
            );

            $hook_priority =  [ 0 => 'Priority - 0', 5 => 'Priority - 5', 10 => 'Priority - 10', 15 => 'Priority - 15' , 20 => 'Priority - 20' , 25 => 'Priority - 25', 30 => 'Priority - 30' , 35 => 'Priority - 35', 40 => 'Priority - 40' ];

            $admail_settings->print_setting_html('s_products_position', 'dropdown', 'Simple products (*)', '', $product_positions);
            
            $admail_settings->print_setting_html('s_hook_priority', 'dropdown', '', '', $hook_priority);
            
            $admail_settings->print_setting_html('v_products_position', 'dropdown', 'Variable products  (**)', '', $product_positions);
            
            $admail_settings->print_setting_html('v_hook_priority', 'dropdown', '', '', $hook_priority);
            
            echo '<p>* Adjust the priority to control the position of the subscription form on the page.</p>';
            echo '<p>** The custom position for variable products will only apply if no variations are available and WooCommerce’s "Hide out of stock items from the catalog" setting is enabled.</p>';
