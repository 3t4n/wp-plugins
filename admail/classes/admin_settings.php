...
class Admail_Settings{
    ...
    public function print_setting_html($setting, $type, $title, $subtitle = "", $data_array = "", $extra_classes = "") {
        ...
        ?>
        <div class="setting <?php echo esc_attr($setting.' '.$extra_classes); ?>">
        ...
        <?php 
            ...
            if ($type == "toggle") {
                ...
                if (is_array($data_array) && is_array($saved_array)) {
                    ...
                    echo '<div class="element-settings full">';
                        ...
                        foreach ($data_array as $key => $name) {
                            ...
                            $class = (in_array($key, $saved_array)) ? 'active' : '';
                ...
                if (is_array($data_array)) {
                    ...
                    echo '<select ' . wp_kses_post($setting_value) . '>';
