...
class Enqueue {
    ...
    public function register_all_scripts() {
        ...
        wp_register_script( self::FRONTEND_SCRIPT, BOOKSTER_EXTRA_OPTIONS_PLUGIN_URL . 'assets/dist/extra-options/frontend.js', $deps, BOOKSTER_EXTRA_OPTIONS_VERSION, true );
        wp_set_script_translations( self::FRONTEND_SCRIPT, 'bookster-extra-options', BOOKSTER_EXTRA_OPTIONS_PLUGIN_PATH . 'languages' );

        wp_register_script( self::ADMIN_SCRIPT, BOOKSTER_EXTRA_OPTIONS_PLUGIN_URL . 'assets/dist/extra-options/admin.js', $deps, BOOKSTER_EXTRA_OPTIONS_VERSION, true );
