...
! defined( 'WPCBR_VERSION' ) && define( 'WPCBR_VERSION', '2.0.0' );
...
! defined( 'WPCBR_DIR' ) && define( 'WPCBR_DIR', plugin_dir_path( __FILE__ ) );
	...
	function wpcbr_init() {
		...
		if ( ! class_exists( 'WPCleverWpcbr' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWpcbr {
				...
				function init() {
					// load text-domain
					load_plugin_textdomain( 'wpc-brands', false, basename( WPCBR_DIR ) . '/languages/' );

                    // default brands
					if ( self::get_setting( 'woo_brands', 'yes' ) === 'yes' ) {
                    ...
                    <div class="wpclever_settings_page wrap">
                        ...
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
                                ...
                                <br/>
                                <a href="<?php echo esc_url( WPCBR_REVIEWS ); ?>"
                                   target="_blank"><?php esc_html_e( 'Reviews', 'wpc-brands' ); ?></a> |
                                <a href="<?php echo esc_url( WPCBR_CHANGELOG ); ?>"
                                   target="_blank"><?php esc_html_e( 'Changelog', 'wpc-brands' ); ?></a> |
                                <a href="<?php echo esc_url( WPCBR_DISCUSSION ); ?>"
                                   target="_blank"><?php esc_html_e( 'Discussion', 'wpc-brands' ); ?></a>
                            </p>
                        </div>
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcbr&tab=settings' ) ); ?>"
                                   class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
									<?php esc_html_e( 'Settings', 'wpc-brands' ); ?>
                                </a>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcbr&tab=shortcodes' ) ); ?>"
                                   class="<?php echo esc_attr( $active_tab === 'shortcodes' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
							...
							<?php if ( $active_tab === 'settings' ) {
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'WooCommerce Brands', 'wpc-brands' ); ?></th>
                                            <td>
                                                <label>
													<?php $woo_brands = get_option( 'wc_feature_woocommerce_brands_enabled', 'yes' ); ?>
                                                    <select name="wpcbr_settings[woo_brands]">
                                                        <option value="yes" <?php selected( $woo_brands, 'yes' ); ?>><?php esc_html_e( 'Enable', 'wpc-brands' ); ?></option>
                                                        <option value="no" <?php selected( $woo_brands, 'no' ); ?>><?php esc_html_e( 'Disable', 'wpc-brands' ); ?></option>
                                                    </select>
                                                </label>
                                                <p class="description">
                                                    From WooCommerce 9.6, Brands is integrated into WooCommerce core and
                                                    turned on by default for all users. To continue using WPC Brands,
                                                    please disable WooCommerce Brands.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input type="text" class="regular-text" name="wpcbr_settings[slug]"
                                                           value="<?php echo esc_attr( self::get_setting( 'slug', 'brand' ) ); ?>"/>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
				...
				function form_fields( $term = null ) {
                    ...
                    <div class="wpcbr_image_uploader">
                        <input type="hidden" name="wpcbr_logo" id="wpcbr_logo" class="wpcbr_image_val"
                               value="<?php echo esc_attr( $logo ); ?>"/>
                        <a href="#" id="wpcbr_logo_select"
                           class="button"><?php esc_html_e( 'Select image', 'wpc-brands' ); ?></a>
					...
					?>
                    <div class="wpcbr_image_uploader">
                        <input type="hidden" name="wpcbr_banner" id="wpcbr_banner" class="wpcbr_image_val"
                               value="<?php echo esc_html( $banner ); ?>"/>
                        <a href="#" id="wpcbr_banner_select"
                           class="button"><?php esc_html_e( 'Select image', 'wpc-brands' ); ?></a>
					...
					echo $th_end . $td_start;
					?>
                    <input type="url" name="wpcbr_banner_link" id="wpcbr_banner_link"
                           value="<?php echo esc_url( $banner_link ); ?>"/>
					<?php
