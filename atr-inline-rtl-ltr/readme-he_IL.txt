...
Tags: block, גוטנברג, RTL, LTR, כיוון טקסט
Author: Yehuda Tiram
...
כפתור לסרגל עורך הבלוקים שמטרתו להקל על עריכת טקסטים בכיוונים מעורבים Rtl Ltr. הוא עוטף מילים (או משפטים) בפסקה בבלוק ברכיב span ומשנה את הכיוון שלהם
