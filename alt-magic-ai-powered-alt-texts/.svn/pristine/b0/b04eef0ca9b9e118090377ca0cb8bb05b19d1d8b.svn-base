...
function alt_magic_render_bulk_generation_page() {
    ...
    <div class="wrap">
        ...
        <h1>Alt Magic - Bulk Generation</h1>
        ...
        <div class="main-content">
            ...
            <div class="info-cards-container">
                <div class="card card-total-images">
                    ...
                    <h3><?php echo esc_html($image_stats['total_images']); ?></h3>
                </div>
                <div class="card card-images-with-missing-alt">
                    ...
                    <h3><?php echo esc_html($image_stats['images_with_missing_alt']); ?></h3>
                </div>
            </div>
            ...
            <div class="bulk-generation-actions-container">
                ...
                <div class="bulk-generation-settings-action-item">
                    ...
                    <!-- <span id="image-count" style="margin-top: 32px;">[Scope: <?php echo esc_html($image_stats['images_with_missing_alt']); ?> image<?php echo $image_stats['images_with_missing_alt'] == 1 ? '' : 's'; ?>]</span> -->
                ...
                <div class="account-info-container">
                    <p id="account-info-text" style="font-size: 14px; color: #333;"><?php echo $is_account_active ? 
                    'You have <span class="credits-available-text">... credits</span> remaining in your account. <a target="_blank" href="https://altmagic.pro/#pricing">Purchase credits in bulk.</a>' 
