document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch(bulkGenerationData.ajaxurl, {
            ...
            .then(data => {
                ...
                if (data.credits_available || data.credits_available == 0) {
                    ...
                    creditsTextElement.textContent = data.credits_available + ' credits';
    ...
    async function fetchImageStats() {
        try {
            ...
            if (data) {
                ...
                document.querySelector('.card-total-images h3').innerText = data.total_images;
                document.querySelector('.card-images-with-missing-alt h3').innerText = data.images_with_missing_alt;
            }
        } catch (error) {
    ...
    function updateProcessedCount(data) {
        ...
        document.getElementById('processed-count').innerHTML = 'Processed: ' + processedCount + '/' + imageCount + ' images';
