...
== Description ==
Easy Sider allows you to create a slider where the customized link button content for each slide can be anything you want - images, text, HTML, shortcodes. You can be able to generate beautiful slider entirely with prev/next navigation, bullets.
...
Easy Slider provides many features, which include:
...
1. Upload the entire `easy-slider'folder to the `/wp-content/plugins/` directory.
...
*General code optimizations and stability improvements.
...
* Initial release of Easy Slider.
