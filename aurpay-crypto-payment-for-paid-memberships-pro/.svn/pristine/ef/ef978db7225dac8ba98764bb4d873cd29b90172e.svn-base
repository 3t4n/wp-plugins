...
Pay with Crypto For Paid Memberships Pro (PMP) merchants, Let your customer pay with ETH, USDC, USDT, DAI, lowest fees, non-custodail & no fraud/chargeback, 50+ cryptos. Invoice, payment link, payment button.
...
[Sign up](https://dashboard.aurpay.net/#/login?cur_url=/integration&platform=PAIDMEMBERSHIPSPRO)

[youtube https://youtu.be/OCaz-_dbTGA]
...
You can place a test order in [Demo store.](https://example-wp.aurpay.net/membership-account/membership-checkout/)
...
4. **[Sign up](https://dashboard.aurpay.net/#/login?cur_url=/integration&platform=PAIDMEMBERSHIPSPRO)** an Aurpay account to get "Publickey".
...
Supports all fiat currencies. Automatically converts to crypto at real-time exchange rates.
...
Join hundreds of successful WordPress and PaidMembershipsPro sellers who have chosen Aurpay as their global growth partner. Start accepting crypto in just one minute and experience the immediate benefits of our managed platform.
...
= 1.0.17 =
New: Add more text introduction to the choose to payment method display function.
Update: Bug fixes and performance improvements.

= 1.0.16 =
New: Support enabling aurpay payment method according to membership level.
New: Optimize code and process quality.

= 1.0.15 =
New: Adapt to WordPress 6.6 version.

= 1.0.14 =
New: Support zero subscription.
...
= 1.0.10 =
Update: Fix bug for membership level update.

= 1.0.9 =
Update: Readme file.

= 1.0.8 =
Update: Fix bug for session start and session end.

= 1.0.7 =
Update: Fix bug for order callback.
...
= 1.0.4 =
Fix: Static variable method invocation.
New: Add logs for PHP version and WordPress version.
...
= 1.0.2 =
New: Optimizing text and user experience.

= 1.0.1 =
Fix: variable naming error.

= 1.0.0 =
New: Initial realease, Aurpay Crypto Payment for Paid Memberships Pro (PMP) merchants.
