...
(function() {
	...
	<div class="atec-footer atec-center atec-fs-12">
		<span class="atec-ml-10" style="float:left;">
			...
			if (!$mega) echo '&middot; <a class="atec-nodeco" href="',esc_url(get_admin_url().'admin.php?page=atec_group'),'">atec-',  esc_attr__('plugins','atec-web-map-service'), ' – ', esc_attr__('Group','atec-web-map-service'), '</a>';
			echo '
		</span>
