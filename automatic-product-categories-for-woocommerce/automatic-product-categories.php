 ...
 * Author:            BerryPress
 * Plugin URI:        https://berrypress.co/
 * Requires Plugins:  woocommerce
 * Text Domain:       automatic-product-categories-for-woocommerce
 * GitHub Plugin URI: BerryPress/automatic-product-categories-for-woocommerce
 */

namespace Penthouse\AutomaticProductCategories;

class AutomaticProductCategories {
	const VERSION = '1.0.8', ADMIN_CAPABILITY = 'manage_woocommerce';
