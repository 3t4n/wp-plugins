...
[https://demo.themeinprogress.eu/chatbox-manager-pro/layouts/](https://demo.themeinprogress.eu/chatbox-manager-pro/layouts/)
...
3. Go to ‘Chatbox Manager' page to configure the plugin.

== Screenshots ==

1. Option panel
2. Example of WhatsApp button
3. Available layouts (free and premium)
...
* Fixed : Fixed a CSRF vulnerability in the save_option() function of the Chatbox Manager plugin (up to version 1.2.0)
* Updated : Documentation link
* Tested with block themes
