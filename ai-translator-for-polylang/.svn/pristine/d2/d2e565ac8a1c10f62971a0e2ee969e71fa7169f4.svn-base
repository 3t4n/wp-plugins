...
class polylai {
    ...
    public function __construct() {
        if ( defined( 'POLYAI_DEBUG' ) && POLYAI_DEBUG ) {
            $this->version = rand( 1, 10000 );
        } else {
            $this->version = '1.0.0';
        }
    ...
    private function load_dependencies() {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'plugins/class-polylai-yoast.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'plugins/class-polylai-elementor.php';
        /**
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-polylai-translator-translation-request.php';
