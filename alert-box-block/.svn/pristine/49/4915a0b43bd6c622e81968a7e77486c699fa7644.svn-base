...
Create and display notices/alerts on the page using the Gutenberg block. it comes up with a few customizable options to design the alert box as you want. Improve the user experience of your website using this block plugin.
...
= Features =
- **Fully Customizable**: Lots of options available to make the alert box as you want!
- **Different Types**: Alert box block comes with different types, you can easily switch the type of alert box.
- **Standard Preset**: Some preset alerts/notices are ready to use without any modification. 


= How to use =
- First, install the Alert Box Block plugin
- Add the Alert Box Block from the block category called "Widgets" in the Gutenberg editor.
