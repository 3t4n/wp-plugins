...
final class Debug {
     ...
     */
    public static function add_debug_message($msg, $msg_verbosity = Debug::VERBOSITY_MEDIUM) {
        if (Environment::is_debug_enabled()) {
            $verbosity_level = Environment::get_debug_verbosity();

            if ($verbosity_level >= $msg_verbosity) {
