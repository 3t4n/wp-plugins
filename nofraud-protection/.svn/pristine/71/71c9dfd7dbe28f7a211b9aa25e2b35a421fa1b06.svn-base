...
final class Gateways {
    ...
    const NOFRAUD_SUPPORTED_GATEWAYS = [
        ...
        'usaepay' => [
            'key' => self::NOFRAUD_GATEWAY_KEY_PREFIX . 'usaepay',
            'enabled' => true,
        ],
    ];
    ...
    const NOFRAUD_SUPPORTED_PLUGINS = [
        ...
        'woocommerce-gateway-paypal-powered-by-braintree/woocommerce-gateway-paypal-powered-by-braintree.php' => [
            'gateway' => 'braintree',
        ...
        'squarewoosync/squarewoosync.php' => [
            'gateway' => 'square',
            'payment_method' => 'squaresync_credit',
        ],
        'woocommerce-gateway-usa-epay/woocommerce-gateway-usa-epay.php' => [
            'gateway' => 'usaepay',
            'payment_method' => 'usa_epay_credit_card',
        ],
    ];
