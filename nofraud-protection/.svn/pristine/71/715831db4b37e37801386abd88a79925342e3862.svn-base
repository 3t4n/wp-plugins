...
final class Constants {
    ...
    /**
     * "Transaction Reprocess Status"
     *
     * @var string Reprocess means the order was triggered for reprocessing
     */
    const TRANSACTION_STATUS_REPROCESS = 'reprocess';

    /**
     * "Transaction Reprocess Count"
     *
     * @var string Reprocesscount
     */
    const TRANSACTION_STATUS_REPROCESS_COUNT_KEY = 'reprocesscount';

    /**
     * "Transaction Reprocess Failed Status"
     *
     * @var string Reprocesscomplete means the order completed reprocessing
     */
    const TRANSACTION_STATUS_REPROCESS_FAILED = 'reprocessfailed';

    /**
     * "Transaction Reprocess Evaluated Status"
     *
     * @var string Reprocesscomplete means the order completed reprocessing
     */
    const TRANSACTION_STATUS_REPROCESS_EVALUATED = 'reprocessevaluated';

    /**
     * "Transaction Reprocess Completed Status"
     *
     * @var string Reprocesscomplete means the order completed reprocessing
     */
    const TRANSACTION_STATUS_REPROCESS_COMPLETE = 'reprocesscomplete';
