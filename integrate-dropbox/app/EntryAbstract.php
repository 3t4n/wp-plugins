...
abstract class EntryAbstract
{
    ...
    public function get__thumbnail()
    {
        return $this->thumbnail;
    }

    public function set__thumbnail($url)
    {
    ...
    {
        return $this->thumbnail_size = $size;
    }

    public function get_thumbnail_dimension()
    {
        return $this->thumbnail_dimension;
    }

    public function set_thumbnail_dimension($dimension)
    {
        return $this->thumbnail_dimension = $dimension;
    }
