...
class CacheNode
{
    ...
    /**
     * @param \CodeConfig\IntegrateDropbox\API\Dropbox\Models\FileLinkMetaData|\CodeConfig\IntegrateDropbox\API\Dropbox\Models\FolderLinkMetaData $shared_link_info
    ...
    /**
     * @param \CodeConfig\IntegrateDropbox\SDK\Models\MediaInfo $media_info
     */
    public function add_media_info($media_info)
    {
        $media_data = $media_info->getMediaMetadata();
        // if ( ! $media_data instanceof \CodeConfig\IntegrateDropbox\API\Dropbox\Models\MediaMetadata ) {
        ...
        // if ( $media_data instanceof \CodeConfig\IntegrateDropbox\API\Dropbox\Models\VideoMetadata ) {
