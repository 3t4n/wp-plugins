...
class DownloadLinks extends Widget_Base
{

    public function get_name()
    {
        return 'indbox_download_links';
    }

    public function get_title()
    {
        return __('Download Links', 'integrate-dropbox');
    }

    public function get_icon()
    {
        return 'indbox-download';
    }
  ...
  "whoCanViewModule": "Everyone"
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Download Links Module', 'integrate-dropbox'),
    ...
    public function render()
    {
        ...
        if ($is_init && Plugin::$instance->editor->is_edit_mode()) { ?>
            ...
            <div class="indbox-toplavel-wrapper integrate-dropbox-intro-preview-wrapper">
                ...
                <img src="<?php echo esc_attr(INDBOX_ASSETS . '/images/shortcode-builder/types/download.svg'); ?>">
                <h3><?php esc_html_e('Download Links', 'integrate-dropbox'); ?></h3>
