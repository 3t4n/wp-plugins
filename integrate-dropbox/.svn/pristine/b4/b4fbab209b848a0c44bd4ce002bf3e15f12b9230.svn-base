...
class EmbedDocuments extends Widget_Base
{

    public function get_name()
    {
        return 'indbox_embed_documents';
    }
  ...
  "whoCanViewModule": "Everyone"
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Embed Documents Module', 'integrate-dropbox'),
    ...
    public function render()
    {
        ...
        if ($is_init && Plugin::$instance->editor->is_edit_mode()) { ?>
            ...
            <div class="indbox-toplavel-wrapper integrate-dropbox-intro-preview-wrapper">
                ...
                <img src="<?php echo esc_attr(INDBOX_ASSETS . '/images/shortcode-builder/types/embed.svg'); ?>">
                <h3><?php esc_html_e('Embed Documents', 'integrate-dropbox'); ?></h3>
