...
class Shortcodes extends Widget_Base
{
    ...
    public function render()
    {
        ...
        $shortcode_content = do_shortcode('[integrate_dropbox id="' . esc_attr($shortcode_id) . '"]');
        ...
        if (!empty($shortcode_id)) {
            ...
            if ($is_editor) { ?>
                <div class="indbox-toplavel-wrapper integrate-dropbox-intro-preview-wrapper">
                    <img src="<?php echo esc_url(INDBOX_ASSETS . '/images/shortcode-builder/types/shortcodes.svg'); ?>" class="module-shortcodes" alt="Module Shortcodes">
