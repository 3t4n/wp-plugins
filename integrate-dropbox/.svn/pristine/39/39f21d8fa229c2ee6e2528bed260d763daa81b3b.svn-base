...
use CodeConfig\IntegrateDropbox\SDK\Http\DropboxRawResponse;
use CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Client;
use CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Exception\BadResponseException;
use CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Exception\RequestException;
use CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\Request;
...
class DropboxGuzzleHttpClient implements DropboxHttpClientInterface
{
     ...
     * GuzzleHttp client.
     *
     * @var \CodeConfig\IntegrateDropbox\GuzzleHttp\Client
     */
    protected $client;
