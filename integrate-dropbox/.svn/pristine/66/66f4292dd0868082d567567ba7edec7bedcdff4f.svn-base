...
class FileBrowser extends Widget_Base
{
    ...
    {
        global $indbox_fs;
        if (!$indbox_fs->is_paying_or_trial() && is_user_logged_in()) {
        ...
        if ($is_init && Plugin::$instance->editor->is_edit_mode()) { ?>
            ...
            <div class="indbox-toplavel-wrapper integrate-dropbox-intro-preview-wrapper">
                ...
                <img src="<?php echo esc_attr(INDBOX_ASSETS . '/images/shortcode-builder/types/browser.svg'); ?>">
                <h3><?php esc_html_e('File Browser', 'integrate-dropbox'); ?></h3>
