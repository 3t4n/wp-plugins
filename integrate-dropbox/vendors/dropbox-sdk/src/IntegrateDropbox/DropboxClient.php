...
use CodeConfig\IntegrateDropbox\SDK\Http\Clients\DropboxHttpClientInterface;
...
class DropboxClient
{
     ...
     * @const string
     */
    public const BASE_PATH = 'https://api.dropboxapi.com/2';
     ...
     * @const string
     */
    public const CONTENT_PATH = 'https://content.dropboxapi.com/2';

    /**
     * DropboxHttpClientInterface Implementation
     *
     * @var \CodeConfig\IntegrateDropbox\SDK\Http\Clients\DropboxHttpClientInterface
     */
     ...
     * Get the HTTP Client
     *
     * @return \CodeConfig\IntegrateDropbox\SDK\Http\Clients\DropboxHttpClientInterface $httpClient
     */
     ...
     * Set the HTTP Client
     *
     * @param \CodeConfig\IntegrateDropbox\SDK\Http\Clients\DropboxHttpClientInterface $httpClient
     *
     ...
     */
    protected function buildAuthHeader(AccessToken $accessToken)
    {
     ...
     *
     * @param  \CodeConfig\IntegrateDropbox\SDK\DropboxRequest $request
     *
