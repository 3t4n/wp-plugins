...
class ViewLinks extends Widget_Base
{

    public function get_name()
    {
        return 'indbox_view_links';
    }

    public function get_title()
    {
        return __('View Links', 'integrate-dropbox');
    }
  ...
  "whoCanViewModule": "Everyone"
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('View Links Module', 'integrate-dropbox'),
    ...
    public function render()
    {
        ...
        if ($is_init && Plugin::$instance->editor->is_edit_mode()) { ?>
            ...
            <div class="indbox-toplavel-wrapper integrate-dropbox-intro-preview-wrapper">
                ...
                <img src="<?php echo esc_attr(INDBOX_ASSETS . '/images/shortcode-builder/types/view.svg'); ?>">
                <h3><?php esc_html_e('View Links', 'integrate-dropbox'); ?></h3>
