...
final class Base
{
    ...
    public function __construct()
    {
        ...
        if (isset($settings['enableAutoSynchronization']) && ! empty($settings['enableAutoSynchronization']) && $settings['enableAutoSynchronization'] !== 'false' && indbox_fs()->is_paying_or_trial()) {
            AutoSync::instance();
        } else {
    ...
    private function init_hooks(): void
    {
        ...
        add_action('wp_insert_site', [$this, 'add_plugin_basic_data_to_new_site']);
        ...
        if ($ajaxAction === 'indbox_authorization') {
            ...
            add_action('init', [$this, 'indbox_download_file']);
        }
    }
    ...
    {
        Install::init('activate');
    }

    public function deactivate()
    {
        Install::init('deactivate');
    }
    ...
    /**
     * Add basic plugin data to the options table for a new site.
     *
     * @param WP_Site $new_site The newly created site object.
     * @param array $args Additional arguments used to create the site.
     */
    public function add_plugin_basic_data_to_new_site($new_site)
    {
        // Switch to the newly created site's context.
        switch_to_blog($new_site->blog_id);

        // Add your basic data to the options table.
        Install::handle_single_site('activate');

        // You can add more options as needed.
        // For example:
        // add_option('plugin_enabled', true);
