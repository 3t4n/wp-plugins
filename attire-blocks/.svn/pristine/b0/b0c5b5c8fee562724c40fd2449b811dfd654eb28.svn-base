...
Plugin Name: Attire Blocks
Contributors: w3eden, codename065, shafayat-alam
Tags: attire blocks, page builder, Gutenberg blocks, gutenberg, blocks
Stable tag: 1.9.7
...
Attire Blocks is a collection of beautifully designed, highly customisable gutenberg UI blocks and ready-made layouts to create pages and posts with just a few clicks.



=== Description ===
Attire Blocks is an essential page builder you must have. This plugin contains blocks listed below and many more to come in future weekly updates.

* [Features/Information Box](https://demo.wpattire.com/attire-blocks-element-information-box/) [[Tutorial]](https://www.youtube.com/watch?v=72R90y6E5UA)
* [HTML Section](https://demo.wpattire.com/attire-blocks-element-section/) [[Tutorial]](https://www.youtube.com/watch?v=Ors9rqEB3G8)
* [Accordion](https://demo.wpattire.com/attire-blocks-element-accordion/) [[Tutorial]](https://www.youtube.com/watch?v=dmKzPmfTYmM)
* [Buttons](https://demo.wpattire.com/attire-blocks-element-buttons/) [[Tutorial]](https://www.youtube.com/watch?v=hIqMiiH0K6E)
* [Post Grid](https://demo.wpattire.com/attire-blocks-element-post-grid/) [[Tutorial]](https://www.youtube.com/watch?v=iyLOIj9fJEM)
* [Post Carousel](https://demo.wpattire.com/attire-blocks-element-post-carousel/) [[Tutorial]](https://www.youtube.com/watch?v=dsZyWH4SWMI)
* [Hero/Call-To-Action](https://demo.wpattire.com/attire-blocks-element-call-to-action/) [[Tutorial]](https://www.youtube.com/watch?v=bTM5P0Nzt3g)
* [Icons](https://demo.wpattire.com/attire-blocks-element-icons/) [[Tutorial]](https://www.youtube.com/watch?v=DoAgSDH7b04)
* [WooCommerce Products Categories](https://demo.wpattire.com/attire-blocks-element-product-categories/) [[Tutorial]](https://www.youtube.com/watch?v=4tAmM4qsIic)
* [Pricing Table](https://demo.wpattire.com/attire-blocks-element-pricing-table/) [[Tutorial]](https://www.youtube.com/watch?v=UZOnoJxEYUA)
* [SVG Image](https://demo.wpattire.com/attire-blocks-element-svg/) [[Tutorial]](https://www.youtube.com/watch?v=iJkqXHMQhUE)
* [Progress Bar](https://demo.wpattire.com/attire-blocks-element-progress-bar/) [[Tutorial]](https://www.youtube.com/watch?v=klzVX_elmjg)
* [Tabs](https://demo.wpattire.com/attire-blocks-tabs/) [[Tutorial]](https://www.youtube.com/watch?v=Bs48v42E-yQ)
* [Social Share](https://demo.wpattire.com/attire-blocks-element-social-share/) [[Tutorial]](https://www.youtube.com/watch?v=17nFu3sP3vE)
* [Testimonial](https://demo.wpattire.com/attire-blocks-element-testimonial/) [[Tutorial]](https://www.youtube.com/watch?v=CuNWKtRvrc0)
* [Carousel](https://demo.wpattire.com/attire-blocks-element-carousel/) [[Tutorial]](https://www.youtube.com/watch?v=OcKdmaTooaY)
* [Table of Contents](https://demo.wpattire.com/attire-blocks-element-toc/) [[Tutorial]](https://www.youtube.com/watch?v=Ez_z5LMsxhM)
* [WordPress Search](https://demo.wpattire.com/attire-blocks-element-wordpress-search/) [[Tutorial]](https://www.youtube.com/watch?v=fStqBXwBhfg)
* [Voting](https://demo.wpattire.com/attire-blocks-element-voting/) [[Tutorial]](https://www.youtube.com/watch?v=oKEyzlvPGgY)

=== Installation ===

1. Upload the `attire-blocks` folder to your `/wp-content/plugins/` directory or alternatively upload the attire-blocks.zip file via the plugin page of WordPress by clicking 'Add New' and selecting the zip from your computer.
...
= 1.9.0 =
* Social share block can be used as a proper widget now.

= 1.8.9 =
* Accordion block behavior fix.
* Fixed an issue where Carousel block prev/next button overlapping content.

= 1.8.8 =
* CSS issue fix in Social Share block editor.

= 1.8.7 =
* New Block - Voting

= 1.8.6 =
* Fixed an issue which caused post author name to be shown in a wrong format in relevant blocks(Post Grid, Carousel, etc.).

= 1.8.5 =
* New layouts and type (Footers).
...
= 1.8.2 =
* Added a bunch of new Layouts and Starter packs
* Minimized CSS/JS file size
* Support for WordPress 6

= 1.8.1 =
* New layouts (`Photography`)
* Return of the color scheme and reset button for Attire theme
...
= 1.7.9 =
* Button url value fix
* `Post Grid` & `Post Carousel` date url replaced with post url.
* `Post Grid` & `Post Carousel` thumbnail is now linked to the post.

= 1.7.8 =
* New layouts in Layout Importer.
* General bug fixes.

= 1.7.7 =
* Added advanced spacing options for blocks.
* General optimisations and bug fixes.

= 1.7.5 =
* `Post Grid` & `Post Carousel` optimisations
* Api and CSS adjustments for faster performance

= 1.7.3 =
* New block `WordPress Search`.
* Fixed anchoring issues in some blocks

= 1.7.0 =
* New block `Table of Contents`
* `Section` block now supports anchor.
...
* Added some new customisations to`Accordion`block.
