...
Tags:  woocommerce, dynamic discount, dynamic pricing, bulk discount, bogo
...
[FRONT-END DEMO](https://wpdemo.redefiningtheweb.com/woocommerce-dynamic-pricing-and-discount-with-ai/offers/) | [DOCUMENTATION](https://redefiningtheweb.com/docs/woocommerce-dynamic-pricing-disocunt-with-a-i/) | [VIDEO TOTURIALS](https://youtube.com/playlist?list=PLHf_zRlSyhkanTEE48idySLz5bi-Hs2MA&si=In28dUr-y0_46N57) | **[PRO WITH 50% DISCOUNT FOR $26](https://codecanyon.net/item/woocommerce-dynamic-pricing-discounts-with-ai/24165502)**

https://youtu.be/Mdw6AhQjhA0?si=tzzYQ5VkMT2KJna_

### Are There Any Discount Rules That Are Not Available In Our Plugin? Let Us Know, We Will Implement It At **No Cost** In Our Premium Plugin ###
...
### For Premium plugin you can click here [Pro version](https://codecanyon.net/item/woocommerce-dynamic-pricing-discounts-with-ai/24165502)
...
- Or rate us on [WordPress](https://wordpress.org/support/plugin/woo-dynamic-pricing-discounts-lite/reviews/) :)
...
* Compatible: Latest version of WordPress & WooCommerce
* Fix: Minor Bug Fixes.

= 2.0.2 =
* Tweak: With WooCommerce and plugin review
* Enchanced: Removal of redundant codes which enchanced workflow 
* Compatibility: Latest version of PHP, WordPress & WooCommerce
...
= 2.0.0 =
- Added: Either select for parent category or child category discount will be implemented in category rule
...
- Fixed: Issue in single product rule when selected for multiple products
- Fixed: The payment rule refresh the order summery data whenever customer select the payment method
- Fixed: Other minor bug fixes
* Compatibility: Latest version of WordPress & WooCommerce

= 1.6.1 =
* Fixed: Product Rule multiple select
* Fixed: Banner issue in Category Rule
* Compatibility: Latest version of WordPress & WooCommerce
* Fixed: Other Minor bugs

= 1.6.0 =
* Added: Option to give discount Based on the Day In Bogo Rule
* Added: Compatible with latest version of PHP, Wordpress & Woocommerce
* Fixed: Other Minor bugs

= 1.5.2 =
* Fixed: Bugs in Cart rule  regarding percent discount  not applied correctly
* Fixed: Other Minor bugs
...
= 1.5.0 =
* Added: Feature to applied discount on multiple products in product rule
* Fixed: Minor bugs

= 1.4.0 =
* Added: Feature to add required product in cart based discount rule
* Fixed: Minor bugs

= 1.3.4 =
* Fixed: Popup of pro version
* Fixed: BOGO rule issue
* Fixed: Category rule issue

= 1.3.3 =
* Minor Bug Fixed of category discount rule section

= 1.3.2 =
* Minor Bug Fixed with name improvement
