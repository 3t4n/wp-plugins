...
<div class="rtw_sb_popup">
	<div class="rtw_sb_card">
		<div class="rtw_sb_card_label">
			<label> <?php echo esc_html_e('Cyber Week Sale','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></label>
		</div>
		<div class="rtw_sb_card_body">
			<div class="rtw_sb_close_popup">
				<div class="rtw_sb_close_icon"></div>
			</div>
			<h2><?php echo esc_html_e('Get PRO @ 50% Off','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></h2>
			<a class="rtw_sb_link" href="https://codecanyon.net/item/woocommerce-dynamic-pricing-discounts-with-ai/24165502" target="_blank"> <button id="rtw_sb_banner_button"><?php echo esc_html_e('Buy Now','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></button></a>
			<p class="rtw_popper"><img src="<?php echo RTWWDPDL_URL . '/admin/images/party-popper.png' ?>" alt="offer popper image"></p>
			<p class="rtw_sb_price"><?php echo esc_html_e('Just in ','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?><span><strike>$49</strike></span><span>$26</span></p>
			<!-- <p class="rtw_sb_bottom_text"> <?php echo esc_html_e('* Hurry up offer valid till','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?><span class="rtw_sb_date"> <?php echo esc_html_e('18th August','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></span></p> -->
			<p class="rtw_sb_bottom_text"> <?php echo esc_html_e('* Hurry up limited time offer','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></p>
		</div>
	</div>
</div>
