...
define( 'DWUL_PLUGIN_VERSION', '1.0.2' );
...
function dwul_admin_settings( $actions, $plugin_file ) {
	...
	if ( $plugin === $plugin_file ) {
		$settings = array();
		$settings['settings']         = '<a href="' . esc_url( admin_url( 'options-general.php?page=dwul-block-user-setting' ) ) . '">' . esc_html__( 'Settings', 'wp-users-disable' ) . '</a>';
