=== HT Service - Roofing Service WordPress Plugin ===
Contributors: htplugins, devitemsllc, madhusudandev, zenaulislam, tarekht, aslamhasib
Tags: Service, Roofing Service, Service List, Service Box, Service plugin.
...
== Description ==
HT Service is a Roofing Service WordPress plugin which helps you exhibit your services, portfolios or products in a befitting manner. It is a fully responsive and mobile friendly plugin. To create unlimited service for the website, HT Service is second to none. 
In addition, this plugin supports Elementor page builder. Using the Elementor Page Builder, you can show the services anywhere in the site in a quick time. Creativity and effectiveness is all around in this WordPress Plugin. 


 A theme using HT Service Plugin : [Live Demo](http://demo.wphash.com/shieldem)
Purchase a Premium [Roofing Service WordPress Theme](https://themeforest.net/cart/configure_before_adding/19837552) only at $49
...
* Related Service Show/Hide Option.
* Related Service Title Change Option.
* Featured Image Show/Hide Option.
* Elementor Addons Included.
* Display Service By Grid/Carousel.
* Display Service By Category.
* Title Link Show/Hide Option.
* Unlimited Color options.
* Service Title Font Color Option.
* Service Content Font Color Option.
* Service Icon Color Option.
* Service Box Background Color Option.
* Service Box Background Hover Color Option.
* Service Box Border Color Option.
* Service Box Border Hover Color Option.
* Carousel Option.
* Carousel Navigation Icon Select Option.
* Carousel Navigation Style Option.
* Carousel AutoPlay Control Option.
* Autoplay Speed Control Option.
* Unlimited Service Box Anywhere Your  Theme
...
HT Service - Roofing Service WordPress Plugin has the following third-party resources:
...
= Version: 1.1.3 - Date: 2022-11-07 =
* Compatibility with the latest WordPress version.

= Version: 1.1.2 - Date: 2022-09-19 =
* Added: Recommendations submenu

= Version: 1.1.1 - Date: 07-07-2022 =
* Compatibility With Elementor Latest Version.
* Fixed container responsive issue.

= Version: 1.1.0 - Date: 06-06-2022 =
* Compatibility With WordPress Latest Version.
* Compatibility With Elementor Latest Version.
* Fixed Yoast SEO plugin conflict issue.


= Version: 1.0.16 - Date: 12-04-2022 =
* Compatibility With WordPress 5.9.3 Version.
* Compatibility Elementor Latest Version.

= Version: 1.0.15 - Date: 10-11-2021 =
* Compatibility With WordPress 5.8.1 Version.
* Compatibility Elementor Latest Version.
* Updated Elementor widgets Title Icon.
* Elementor Widgets Icon Update.
* Admin Panel Menu Category Problem Solve.

= Version: 1.0.14 - Date: 04-09-2021 =
* Compatibility With Elementor Latest Version
* Updated All Elements title icon

= Version: 1.0.13 - Date: 25-07-2021 =
* Compatibility With WordPress Latest Version
* Compatibility With Elementor Latest Version

= Version: 1.0.12 - Date: 24-04-2021 =
* Compatible with Elementor Version 3.2.1

= Version: 1.0.11 - Date: 2021-03-14 =
* Compatible with WordPress 5.7 Version

= Version: 1.0.10 - Date: 2021-01-05 =
* Services ordering option added.
* Compatible with WordPress 5.6 Version


== Installation ==
This section describes how to install the HT Service - Roofing Service WordPress Plugin and get it working.

= 1) Install =

= Modern Way: =
1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "HT Services ".
3. Install, then Activate it.

= Old Way: =
1. Unzip (if it is zipped) and Upload `htservice` folder to the `/wp-content/plugins/` directory
...
3. After install and activate the both plugin you will get a Dashboard Menu(HT Service).

== Screenshots ==
1. HT Service Style 1
2. HT Service Style 2
3. HT Service Style 3
4. HT Service Details Page
5. HT Service Page Option
6. HT Service Addons Option