...
include_once plugin_dir_path(__FILE__) . '/reservit-hotel-bestprice-shortcode.php';
...
class Reservit_Hotel_Bestprice {
    ...
    public function __construct() {
        ...
        add_action('init', array(Reservit_Hotel_Bestprice_Shortcode::instance(), 'init'), 0);
    ...
    public function enqueue_admin_js_css() {
        ...
        wp_enqueue_style('rsvit_fontawsome', plugins_url('assets/font-awesome/css/font-awesome.min.css', __FILE__),[],'3.0');
        ...
        wp_enqueue_style('rsvit_option_css', plugins_url('reservit-hotel-option.css', __FILE__),[],'3.0');
    }
    ...
    public function reservit_hotel_id_html() {
        ?>
        <h1><?php echo esc_html(get_admin_page_title(), 'reservit-hotel'); ?></h1>
        <p><?php echo esc_html_e('Set your reservit codes', 'reservit-hotel'); ?></p>
    ...
    public function rsvit_hotel_content_html() {
        ?>
        <h1><?php echo esc_html(get_admin_page_title(), 'reservit-hotel'); ?></h1>
        <h2><?php echo esc_html_e('Widget content setting', 'reservit-hotel'); ?></h2>
        <form method="post" action="options.php">
    ...
    public function rsvit_hotel_style_html() {
        ?>
        <h1><?php echo esc_html(get_admin_page_title(), 'reservit-hotel'); ?></h1>
        <h2><?php echo esc_html_e('Widget style setting', 'reservit-hotel'); ?></h2>
        <p><?php echo esc_html_e('You have the option to customize certain elements of the widget. We have deliberately limited the number of style parameters but this could change in the future ...', 'reservit-hotel') ?></p>
    ...
    public function chaine_id_html() {
        ?>
        <input type="number" min="0" step="1" name="rsvit_chaine_id" value="<?php echo esc_attr(get_option('rsvit_chaine_id')) ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the chain ID given by reservit', 'reservit-hotel'); ?>">
    ...
    public function hotel_id_html() {
        ?>
        <input type="number" min="0" step="1" name="rsvit_hotel_id" value="<?php echo esc_attr(get_option('rsvit_hotel_id')) ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the hotel ID given by reservit', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_max_adlut_html() {
        $rsvit_hotel_max_adlut = esc_attr(get_option('rsvit_hotel_max_adlut'));
        ?>
        <input type="number" min="0" step="1" name="rsvit_hotel_max_adlut" min="0" value="<?php if (!empty($rsvit_hotel_max_adlut)) {
            echo esc_attr($rsvit_hotel_max_adlut);
        } else {
            echo '4';
        } ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the maximum adults number admitted', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_max_child_html() {
        $rsvit_hotel_max_child = esc_attr(get_option('rsvit_hotel_max_child'));
        ?>
        <input type="number" min="0" step="1" name="rsvit_hotel_max_child" min="0" value="<?php if (!empty($rsvit_hotel_max_child)) {
            echo esc_attr($rsvit_hotel_max_child);
        } else {
            echo '2';
        } ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the maximum children number admitted', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_design_version_html() {
        $rsvit_design_version = esc_attr(get_option('rsvit_hotel_design_version'));
        ?>
    ...
    public function hotel_bestprice_display_html() {
        ...
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Check this option if you want to display a higher price from a partner', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_distributorprice_display_html() {
        ?>
        <input type="checkbox" name="rsvit_hotel_distributorprice_display" value="true" <?php if (esc_attr(get_option('rsvit_hotel_distributorprice_display')) == "true") {
            echo "checked";
        }; ?>/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e("Display the distributor\'s price even if it is equal to the hotel\'s price", 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_distributorpriceblock_display_html() {
        ?>
        <input type="checkbox" name="rsvit_hotel_distributorpriceblock_display" value="true" <?php if (esc_attr(get_option('rsvit_hotel_distributorpriceblock_display')) == "true") {
            echo "checked";
        }; ?>/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Check this option if you want to display a higher price from a partner', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
    ...
    public function hotel_partner_id_html() {
        ?>
        <input type="text" name="rsvit_hotel_partner_id" value="<?php echo esc_attr(get_option('rsvit_hotel_partner_id')); ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the partner ID that you want to display', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_distributorpartner1_id_html() {
        ?>
        <input type="text" name="rsvit_hotel_distributorpartner1_id" value="<?php echo esc_attr(get_option('rsvit_hotel_distributorpartner1_id')); ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the distributorpartner1 ID that you want to display', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_distributorpartner2_id_html() {
        ?>
        <input type="text" name="rsvit_hotel_distributorpartner2_id" value="<?php echo esc_attr(get_option('rsvit_hotel_distributorpartner2_id')); ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the distributorpartner2 ID that you want to display', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_distributorpartner3_id_html() {
        ?>
        <input type="text" name="rsvit_hotel_distributorpartner3_id" value="<?php echo esc_attr(get_option('rsvit_hotel_distributorpartner3_id')); ?>"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Fill with the distributorpartner3 ID that you want to display', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function section_btn_html() {
        ...
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('30 characters maximun', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_btn_fr_html() {
        $rsvit_btn_txt_fr = esc_attr(get_option('rsvit_btn_txt_fr'));
        ?>
        <input type="text" name="rsvit_btn_txt_fr" value="<?php if (!empty($rsvit_btn_txt_fr)) {
            echo esc_attr($rsvit_btn_txt_fr);
        } else {
            echo 'Meilleur tarif';
    ...
    public function hotel_btn_en_html() {
        $rsvit_btn_txt_en = esc_attr(get_option('rsvit_btn_txt_en'));
        ?>
        <input type="text" name="rsvit_btn_txt_en" value="<?php if (!empty($rsvit_btn_txt_en)) {
            echo esc_attr($rsvit_btn_txt_en);
        } else {
            echo 'Best price';
    ...
    public function hotel_btn_pt_html() {
        $rsvit_btn_txt_pt = esc_attr(get_option('rsvit_btn_txt_pt'));
        ?>
        <input type="text" name="rsvit_btn_txt_pt" value="<?php if (!empty($rsvit_btn_txt_pt)) {
            echo esc_attr($rsvit_btn_txt_pt);
        } else {
            echo 'Melhor preço';
    ...
    public function hotel_btn_it_html() {
        $rsvit_btn_txt_it = esc_attr(get_option('rsvit_btn_txt_it'));
        ?>
        <input type="text" name="rsvit_btn_txt_it" value="<?php if (!empty($rsvit_btn_txt_it)) {
            echo esc_attr($rsvit_btn_txt_it);
        } else {
            echo 'Miglior prezzo';
    ...
    public function hotel_btn_de_html() {
        $rsvit_btn_txt_de = esc_attr(get_option('rsvit_btn_txt_de'));
        ?>
        <input type="text" name="rsvit_btn_txt_de" value="<?php if (!empty($rsvit_btn_txt_de)) {
            echo esc_attr($rsvit_btn_txt_de);
        } else {
    ...
    public function hotel_btn_es_html() {
        $rsvit_btn_txt_es = esc_attr(get_option('rsvit_btn_txt_es'));
        ?>
        <input type="text" name="rsvit_btn_txt_es" value="<?php if (!empty($rsvit_btn_txt_es)) {
            echo esc_attr($rsvit_btn_txt_es);
        } else {
            echo 'Mejor tarifa';
    ...
    public function hotel_btn_bgcolor_html() {
        $rsvit_btn_bgcolor = esc_attr(get_option('rsvit_btn_bgcolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_bgcolor" value="<?php if (!empty($rsvit_btn_bgcolor)) {
            echo esc_attr($rsvit_btn_bgcolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_btn_mobilebgcolor_html() {
        $rsvit_btn_mobilebgcolor = esc_attr(get_option('rsvit_btn_mobilebgcolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_mobilebgcolor" value="<?php if (!empty($rsvit_btn_mobilebgcolor)) {
            echo esc_attr($rsvit_btn_mobilebgcolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_btn_mobilehoverbgcolor_html() {
        $rsvit_btn_mobilehoverbgcolor = esc_attr(get_option('rsvit_btn_mobilehoverbgcolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_mobilehoverbgcolor" value="<?php if (!empty($rsvit_btn_mobilehoverbgcolor)) {
            echo esc_attr($rsvit_btn_mobilehoverbgcolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_btn_mobilehovercolor_html() {
        $rsvit_btn_mobilehovercolor = esc_attr(get_option('rsvit_btn_mobilehovercolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_mobilehovercolor" value="<?php if (!empty($rsvit_btn_mobilehovercolor)) {
            echo esc_attr($rsvit_btn_mobilehovercolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_btn_radius_html() {
        ?>
        <input type="number" min="0" step="0.01" name="rsvit_btn_radius" value="<?php echo esc_attr(get_option('rsvit_btn_radius')); ?>"/>
        <select name="rsvit_btn_radiusunit">
            <option value="" <?php if ((esc_attr(get_option('rsvit_btn_radiusunit')) == "")) {
            echo 'selected';
        }; ?>><?php echo esc_html_e('Default unit', 'reservit-hotel'); ?>  </option> 
            <option value="px" <?php if ((esc_attr(get_option('rsvit_btn_radiusunit')) == "px")) {
            echo 'selected';
        }; ?>>px</option>
            <option value="em" <?php if ((esc_attr(get_option('rsvit_btn_radiusunit')) == "em")) {
            echo 'selected';
        }; ?>>em</option>
            <option value="rem" <?php if ((esc_attr(get_option('rsvit_btn_radiusunit')) == "rem")) {
            echo 'selected';
        }; ?>>rem</option>
            <option value="%" <?php if ((esc_attr(get_option('rsvit_btn_radiusunit')) == "%")) {
            echo 'selected';
        ...
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty & default unit to use the default value of your theme', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_btn_ico_html() {
        ?>
        <input type="radio" name="rsvit_btn_ico" value="initial" <?php if (esc_attr(get_option('rsvit_btn_ico')) == "initial") {
            echo 'checked';
        }; ?>>
        <label><?php echo esc_html_e('Yes', 'reservit-hotel'); ?></label>
        <input type="radio" name="rsvit_btn_ico" value="none" <?php if (esc_attr(get_option('rsvit_btn_ico')) == "none") {
            echo 'checked';
        }; ?>>
        <label><?php echo esc_html_e('No', 'reservit-hotel'); ?></label>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('The icon is displayed before the text, you have got the choise to display it or not', 'reservit-hotel'); ?>">
            <i class="fa fa-circle fa-stack-2x"></i>
            <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
        </span>
        </a>
    ...
    public function hotel_btn_fontsize_html() {
        $rsvit_btn_fontsize = esc_attr(get_option('rsvit_btn_fontsize'));
        ?>
        <input type="number" name="rsvit_btn_fontsize" min="0" step="0.01" value="<?php if (!empty($rsvit_btn_fontsize)) {
            echo esc_attr($rsvit_btn_fontsize);
        } ?>"/>
        <select name="rsvit_btn_fontunit">
            <option value="" <?php if ((esc_attr(get_option('rsvit_btn_fontunit')) == "")) {
            echo 'selected';
        }; ?>> <?php echo esc_html_e('Default unit', 'reservit-hotel'); ?>  </option> 
            <option value="px" <?php if ((esc_attr(get_option('rsvit_btn_fontunit')) == "px")) {
            echo 'selected';
        }; ?>>px</option>
            <option value="em" <?php if ((esc_attr(get_option('rsvit_btn_fontunit')) == "em")) {
            echo 'selected';
        }; ?>>em</option>
            <option value="rem" <?php if ((esc_attr(get_option('rsvit_btn_fontunit')) == "rem")) {
            echo 'selected';
        }; ?>>rem</option>
            <option value="%" <?php if ((esc_attr(get_option('rsvit_btn_fontunit')) == "%")) {
            echo 'selected';
    ...
    public function hotel_btn_fontweight_html() {
        ...
        <select name="rsvit_btn_fontweight">
            <option value="" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "")) {
            echo 'selected';
        }; ?>> <?php echo esc_html_e('Default weight', 'reservit-hotel'); ?>  </option>
            <option value="100" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "100")) {
            echo 'selected';
        }; ?>>100</option>
            <option value="200" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "200")) {
            echo 'selected';
        }; ?>>200</option>
            <option value="300" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "300")) {
            echo 'selected';
        }; ?>>300</option>
            <option value="400" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "400")) {
            echo 'selected';
        }; ?>>normal</option>
            <option value="500" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "500")) {
            echo 'selected';
        }; ?>>500</option>
            <option value="600" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "600")) {
            echo 'selected';
        }; ?>>600</option>
            <option value="700" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "700")) {
            echo 'selected';
        }; ?>>bold</option>
            <option value="800" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "800")) {
            echo 'selected';
        }; ?>>800</option>
            <option value="900" <?php if ((esc_attr(get_option('rsvit_btn_fontweight')) == "900")) {
            echo 'selected';
        }; ?>>900</option>
        </select>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep default weight to use the default value of your theme', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_btn_borderwidth_html() {
        ?>
        <input type="number" min="0" step="0.01" name="rsvit_btn_borderwidth" value="<?php echo esc_attr(get_option('rsvit_btn_borderwidth')); ?>"/>
        <select name="rsvit_btn_borderunit">
            <option value="" <?php if ((esc_attr(get_option('rsvit_btn_borderunit')) == "")) {
            echo 'selected';
        }; ?>> <?php echo esc_html_e('Default unit', 'reservit-hotel'); ?>  </option> 
            <option value="px" <?php if ((esc_attr(get_option('rsvit_btn_borderunit')) == "px")) {
            echo 'selected';
        }; ?>>px</option>
            <option value="em" <?php if ((esc_attr(get_option('rsvit_btn_borderunit')) == "em")) {
            echo 'selected';
        }; ?>>em</option>
            <option value="rem" <?php if ((esc_attr(get_option('rsvit_btn_borderunit')) == "rem")) {
            echo 'selected';
        }; ?>>rem</option>
            <option value="%" <?php if ((esc_attr(get_option('rsvit_btn_borderunit')) == "%")) {
            echo 'selected';
    ...
    public function hotel_btn_hoverbordercolor_html() {
        $rsvit_btn_hoverbordercolor = esc_attr(get_option('rsvit_btn_hoverbordercolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_hoverbordercolor" value="<?php if (!empty($rsvit_btn_hoverbordercolor)) {
            echo esc_attr($rsvit_btn_hoverbordercolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_btn_mobilehoverbordercolor_html() {
        $rsvit_btn_mobilehoverbordercolor = esc_attr(get_option('rsvit_btn_mobilehoverbordercolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_mobilehoverbordercolor" value="<?php if (!empty($rsvit_btn_mobilehoverbordercolor)) {
            echo esc_attr($rsvit_btn_mobilehoverbordercolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_btn_mobilebordercolor_html() {
        $rsvit_btn_mobilebordercolor = esc_attr(get_option('rsvit_btn_mobilebordercolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_btn_mobilebordercolor" value="<?php if (!empty($rsvit_btn_mobilebordercolor)) {
            echo esc_attr($rsvit_btn_mobilebordercolor);
        } else {
            echo '';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Keep empty to use the default value of your theme', 'reservit-hotel'); ?>">
    ...
    public function hotel_box_btn_color_html() {
        $rsvit_box_btn_color = esc_attr(get_option('rsvit_box_btn_color'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_box_btn_color" value="<?php if (!empty($rsvit_box_btn_color)) {
            echo esc_attr($rsvit_box_btn_color);
        } else {
            echo '#ffffff';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('We set white as default but you can change this value to match with your theme', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_box_btn_textcolor_html() {
        $rsvit_box_btn_textcolor = esc_attr(get_option('rsvit_box_btn_textcolor'));
        ?>
        <input type="text" class="color-picker" data-alpha="true" name="rsvit_box_btn_textcolor" value="<?php if (!empty($rsvit_box_btn_textcolor)) {
            echo esc_attr($rsvit_box_btn_textcolor);
        } else {
            echo '#000000';
        } ?>" placeholder="rgba(244,158,76,0.82)"/>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('We set black as default but you can change this value to match with your theme', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function hotel_custom_css_html() {
        $rsvit_hotel_custom_css = esc_attr(get_option('rsvit_hotel_custom_css'));
        ?>
        <p> <?php echo esc_html_e('Write here your own CSS', 'reservit-hotel'); ?></p>
        <textarea rows="6" cols="80" form="styleForm" name="rsvit_hotel_custom_css"><?php if (!empty($rsvit_hotel_custom_css)) {
            echo esc_attr($rsvit_hotel_custom_css);
        } else {
            echo "";
        }; ?></textarea>
        <a class="picto-item" href="#" aria-label= "<?php echo esc_html_e('Use carefully. The content of this section could generate some conflicts', 'reservit-hotel'); ?>">
            <span class="fa-stack fa-xs">
                <i class="fa fa-circle fa-stack-2x"></i>
                <i class="fa fa-medkit fa-stack-1x fa-inverse"></i>
            </span>
    ...
    public function reservit_sanitize_num_field($rsrvitoption) {
        //sanitize
        $rsrvitsafeoption = stripslashes(wp_strip_all_tags($rsrvitoption));
