<?php
  function gfct_fontawesome_enqueue_script() {
	 wp_enqueue_style( 'font-awesome-css', '//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), '4.5.0' );
}
...
//   var_dump(print_r($form['fields'][1])); 
    foreach($form['fields'] as &$field){
       if(isset($field['gfctfaField'])) {
        $field["cssClass"] .= " gfct_add " . "gfct-".$field['gfctfaField'] . " gfct_end";
     //   $field["cssClass"] = 'xxx';
        }
    }
    return $form;
