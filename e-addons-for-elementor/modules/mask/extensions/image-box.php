 ...
 * @since 1.0.1
 */
class Image_Box extends Base_Extension {
    ...
    public function get_description() {
        return __('Image-box masking for elementor extension', 'e-addons-for-elementor');
    }
    ...
    protected function add_actions() {
        add_action( 'elementor/element/image-box/section_image/after_section_end', [$this, 'add_controls'], 10, 2);
    }
