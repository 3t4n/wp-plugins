                                    ...
                                    foreach ($e_addons_plugins as $e_plugin) {
                                        ...
                                        <li id="e_addon_plugin_module_<?php echo $e_plugin['TextDomain']; ?>_settings" class="e_addon_plugin e_addon_plugin_area">
                                            ...
                                            <ul class="e_addon_plugin_modules">
                                                ...
                                                if ($e_plugin['TextDomain'] == 'e-addons-for-elementor') { 
                                                    $custom_order = ['disable', 'wrapper', 'heading', 'mask', 'shortcode', 'external'];
                                                    foreach($custom_order as $cord) {
                                                        $key = array_search($cord, $modules);
                                                        if ($key !== false) {
                                                            $tmp = $modules[$key];
                                                            unset($modules[$key]);
                                                            array_unshift($modules, $tmp);
                                                        }
                                                    }
                                                }
                                                foreach ($modules as $amod) {
                                                    ...
                                                    switch ($unique_mod) {
                                                        case 'e-addons-for-elementor_external':
                                                            echo '<li><h2>For Delelopers</h2></li>';
                                                            break;
                                                        case 'e-addons-for-elementor_mask':
                                                            echo '<li><h2>For Designers</h2></li>';
                                                            break;
                                                        case 'e-addons-for-elementor_wrapper':
                                                            echo '<li><h2>Utilities for Elementor</h2></li>';
                                                            break;
                                                    }
                                                    
                                                    ?>
                                                    <li class="e_addon_plugin_module" id="e_addon_plugin_module_<?php echo $unique_mod; ?>">
                                                        <h3 class="e-settings-module-title"><?php echo Utils::slug_to_camel($amod, ' '); ?></h3>
                                                        <ul>
                                                            <?php
                                                            $has_features = false;
                                                            foreach ($folders as $folder) {
                                                                            ...
                                                                            foreach ($files as $afile) {
                                                                                ...
                                                                                if ($file_name == 'wordpress') {
                                                                                    ...
                                                                                    foreach ($wp_widget_factory->widgets as $widget_class => $widget_obj) {
                                                                                        ...
                                                                                        ?>
                                                                                        <li class="e-setting">
                                                                                            <input id="<?php echo $unique_feature; ?>" type="checkbox" name="settings[<?php echo $folder; ?>][<?php echo $amod; ?>][<?php echo $element->get_name(); ?>]"<?php echo $checked; ?>>
                                                                                    ...
                                                                                    ?>
                                                                                    <li class="e-setting">
                                                                                        <input id="<?php echo $unique_feature; ?>" type="checkbox" name="settings[<?php echo $folder; ?>][<?php echo $amod; ?>][<?php echo $file_name; ?>]"<?php echo $checked; ?>>
                                                                                        <label class="e-setting-label" for="<?php echo $unique_feature; ?>"><i class="e-setting-icon <?php echo $element->get_icon(); ?>"></i><span class="e-settings-label"><?php echo $file_label; ?></span></label>
                                                                                        <a class="e-setting-info" href="<?php echo $docs; ?>" target="_blank"><i class="eicon-help-o"></i></a>
                                                                                    </li>
                                                                                    <?php
