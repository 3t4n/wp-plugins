...
class Drim_Share {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Drim_Share_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $drim_share    The string used to uniquely identify this plugin.
	 */
	protected $drim_share;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-drim-share-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-drim-share-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-drim-share-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-drim-share-public.php';

		$this->loader = new Drim_Share_Loader();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Drim_Share_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Drim_Share_Loader    Orchestrates the hooks of the plugin.
	 */
