                    ...
                    <div class="gs-plugins--single_top">
                        ...
                        <div class="gs-plugins--single_details">
                            ...
                            <ul class="gs-plugins--single_actions">
								<?php if ( $action_links ) {
									echo wp_kses_post( '<li>' . implode( "</li><li>", $action_links ) . '</li>' );
								} ?>
                            </ul>
                        </div>
                    ...
                    <div class="gs-plugins--single_bottom">
                        ...
                        <div class="gs-plugins--single_downloaded">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="14px">
                                <path fill-rule="evenodd" fill-opacity="0.251" fill="rgb(24, 24, 24)" d="M-0.000,14.000 L-0.000,12.000 L10.000,12.000 L10.000,14.000 L-0.000,14.000 ZM0.293,6.477 L1.862,4.908 L4.000,7.000 L4.000,-0.000 L6.000,-0.000 L6.000,7.000 L8.138,4.908 L9.707,6.477 L5.000,11.000 L0.293,6.477 Z"/>
                            </svg>
                    ...
                    <div class="gs-plugins--single_bottom">
                        ...
                        <div class="gs-plugins--single_right">
                            ...
                            <a class="button button_buy" href="<?php echo esc_url( $plugin['permalink'] ); ?>" target="_blank">
                                <svg width="20" class="feather feather-shopping-cart" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="gs-plugins--list_inner">
                    ...
                    <div class="gs-plugins--list_items">
                        <div class="gs-plugins--list_items_row">
							<?php foreach ( $this->get_free_plugins() as $plugin ) {
								$this->plugin_single( $plugin );
							} ?>
                        </div>
                    </div>
		...
		public function display_pro_plugins() {
            ...
            <div class="gs-plugins--list gs-plugins--list_pro">
                ...
                <div class="gs-plugins--list_inner">
                    ...
                    <div class="gs-plugins--list_items">
                        <div class="gs-plugins--list_items_row">
							<?php foreach ( $this->get_pro_plugins() as $plugin ) {
								$this->plugin_single__pro( $plugin );
							} ?>
                        </div>
                    </div>
                        ...
                        <div class="gs-plugins--list_items_row">
                            ...
                            <div class="gs-plugins--single_wrapper">
                                <div class="gs-plugins--single gs-plugin--color-three">
                                    <div class="gs-plugins--single_top">
                                        <div class="gs-plugins--single_icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31.5" height="32.188" viewBox="0 0 31.5 32.188">
                                                <path fill-rule="evenodd" fill="#1e90ff" d="M423.629,777.9h-1.958v-3.573a1.153,1.153,0,0,0-1.152-1.153H398.635a1.153,1.153,0,0,0-1.152,1.153v7.416a12.1,12.1,0,0,0,5,9.8h-4.734a1.152,1.152,0,0,0-1.152,1.152A1.529,1.529,0,0,0,398,794h23a1.378,1.378,0,0,0,1.247-1.308,1.152,1.152,0,0,0-1.152-1.152h-4.426a12.184,12.184,0,0,0,3.887-4.726h3.073A4.458,4.458,0,0,0,423.629,777.9Zm-4.262,3.843a9.79,9.79,0,1,1-19.58,0v-6.264h19.58v6.264Zm4.262,2.766h-2.277a12.129,12.129,0,0,0,.319-2.766v-1.537h1.958A2.152,2.152,0,0,1,423.629,784.508ZM409.577,769.6a1.153,1.153,0,0,0,1.152-1.153v-5.5a1.152,1.152,0,1,0-2.3,0v5.5A1.153,1.153,0,0,0,409.577,769.6Zm5.49,1.844a1.153,1.153,0,0,0,1.152-1.153v-5.5a1.152,1.152,0,1,0-2.3,0v5.5A1.152,1.152,0,0,0,415.067,771.444Zm-10.98,0a1.153,1.153,0,0,0,1.152-1.153v-5.5a1.152,1.152,0,1,0-2.3,0v5.5A1.153,1.153,0,0,0,404.087,771.444Z" transform="translate(-396.594 -761.812)"/>
                                            </svg>
                                        </div>
							...
							<?php if ( ! empty( $this->data['links']['tutorial_link'] ) ) : ?>
                                <div class="gs-plugins--single_wrapper">
                                    <div class="gs-plugins--single gs-plugin--color-four">
                                        <div class="gs-plugins--single_top">
                                            <div class="gs-plugins--single_icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="36.5" height="21.38" viewBox="0 0 36.5 21.38">
                                                    <path fill="#ed1c24" fill-rule="evenodd" d="M982.534,1383.57l-6.411-3.7a1.072,1.072,0,0,0-1.6.93v7.4a1.072,1.072,0,0,0,1.6.93l6.411-3.7a1.077,1.077,0,0,0,0-1.86h0Zm-5.877,2.78v-3.7l3.206,1.85Zm22.036-10.29-7.076,3.51v-4.69a1.07,1.07,0,0,0-1.069-1.07H964.832a1.07,1.07,0,0,0-1.068,1.07v19.24a1.07,1.07,0,0,0,1.068,1.07h25.716a1.07,1.07,0,0,0,1.069-1.07v-4.63l7.082,3.45a1.07,1.07,0,0,0,1.541-.96v-14.96a1.074,1.074,0,0,0-1.547-.96h0ZM965.9,1393.05v-17.1H989.48v17.1H965.9Zm32.2-2.78-6.482-3.16v-5.15l6.482-3.22v11.53Z" transform="translate(-963.75 -1373.81)"/>
                                                </svg>
                                            </div>
