...
== Changelog ==
= 2.2.24 =
* Update Route Order Status for admin orders without Route Fee

= 2.2.23 =
* Display correctly route fee amount in orders admin view

= 2.2.22 =
* Fix problem for astracker shipment tracking compatibility 

= 2.2.21 =
* Fix route information columns

= 2.2.20 =
* Fix route information columns, display correct information

= 2.2.19 =
* Minor update on code format

= 2.2.18 =
* Update shipping tracking status for shipping providers

= 2.2.17 =
* Fix version miss match

= 2.2.16 =
* fix deployment issue

= 2.2.15 =
* Update order reconcile functionality
...
= 2.2.11 =
* Fix deprecated rtrim null check
