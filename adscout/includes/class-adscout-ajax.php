...
{
    /**
     * Saves integration settings for AdScout.
     * Verifies nonce and required fields before saving the settings.
     * Retrieves and sets the API token and partner domain hex values.
     * Checks the validity of the token and updates the options accordingly.
     * Masks the API token and partner domain hex before sending a success response.
     *
     * @return void
     */
