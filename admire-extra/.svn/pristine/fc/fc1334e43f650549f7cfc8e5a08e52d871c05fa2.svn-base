...
class Admire_Extra_Dashboard {
    ...
    function admire_extra_box_links(){
        ...
        ?>
        <div class="cd-box">
            <div class="cd-box-top"><?php esc_attr_e( 'Links to Customizer Settings', 'admire-extra' ); ?></div>
    ...
    function admire_extra_box_recommend_plugins(){
        ...
        if ( $html ) {
            ?>
            <div class="cd-box">
                <div class="cd-box-top"><?php esc_attr_e('Recommend Plugins', 'admire-extra'); ?></div>
