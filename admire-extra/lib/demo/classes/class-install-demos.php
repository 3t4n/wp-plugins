                            ...
                            <div class="theme fwp-open-popup" data-demo-id="<?php echo esc_attr($demo); ?>">
                                ...
                                <div class="theme-id-container">
                                    ...
                                    <div class="theme-actions">
                                        <a class="button button-primary" href="<?php echo esc_url('https://admiretheme.com/demos/').esc_attr($demo); ?>" target="_blank"><?php esc_html_e('Live Preview', 'admire-extra'); ?></a>
                                    </div>
