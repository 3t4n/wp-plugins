...
class CF7_CTRL_PRINT_FORM_BUTTON extends CF7_COMPLEMENTARY_CTRL {
	...
	public function wpcf7_tag_generator_printform( $contact_form, $args = '' ) {
		...
		?>
		<style>
.tag-generator-dialog#tag-generator-panel-printform fieldset{margin-inline-start:0 !important;}
.tag-generator-dialog#tag-generator-panel-printform fieldset legend{margin-inline-start:0 !important;}
.tag-generator-dialog .tag-generator-panel[data-id="printform"]{height:auto;}
.tag-generator-dialog#tag-generator-panel-printform{min-height:auto;}
.tag-generator-dialog#tag-generator-panel-printform:has(.close-button) .tag-generator-panel {
    margin-top: 20px;
}
.tag-generator-dialog#tag-generator-panel-printform .control-box{
	overflow:initial !important;
}
.tag-generator-dialog#tag-generator-panel-printform .insert-box [name="printform"]{flex-grow:1;}
.tag-generator-dialog#tag-generator-panel-printform fieldset{margin-inline-start:0 !important;}
.tag-generator-dialog #tag-generator-panel-printform fieldset legend{margin-inline-start:0 !important;}
		</style>
		<div class="control-box">
			<fieldset>
				...
				<input type="hidden" data-tag-part="basetype" value="printform">
				<table class="form-table">
					<tbody>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-values' ); ?>"><?php echo esc_html( __( 'Label', 'contact-form-7' ) ); ?></label></th>
							<td><input type="text" data-tag-part="value" name="values" class="oneline" id="<?php echo esc_attr( $args['content'] . '-values' ); ?>" /></td>
						</tr>

						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-id' ); ?>"><?php echo esc_html( __( 'Id attribute', 'contact-form-7' ) ); ?></label></th>
							<td><input type="text" data-tag-part="name" pattern="[A-Za-z][A-Za-z0-9_\-]*" name="id" class="idvalue oneline option" id="<?php echo esc_attr( $args['content'] . '-id' ); ?>" /></td>
						</tr>

						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-class' ); ?>"><?php echo esc_html( __( 'Class attribute', 'contact-form-7' ) ); ?></label></th>
							<td><input type="text" data-tag-part="option" data-tag-option="class:" name="class" class="classvalue oneline option" id="<?php echo esc_attr( $args['content'] . '-class' ); ?>" /></td>
						</tr>
					</tbody>
				</table>
			</fieldset>
		...
		<div class="insert-box"  style="display:flex;overflow:hidden;">
			<input type="text" data-tag-part="tag" name="printform" class="tag code" readonly="readonly" onfocus="this.select();" style="margin-right:5px;" />

			<div class="submitbox">
				<input type="button" data-taggen="insert-tag" class="button button-primary insert-tag" value="<?php echo esc_attr( __( 'Insert Tag', 'contact-form-7' ) ); ?>" />
			</div>
		</div>
		<?php
