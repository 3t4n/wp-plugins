...
== Description ==
ai12z plugin allow you to connect your site to ai12z platform. Any content updates will automatically sync with the platform.

== Frequently Asked Questions ==
= How do I get started? =
You can signup for [free trial](https://app.ai12z.net/signup)
