...
function custom_enqueue_scripts_and_styles() {
  ...
  wp_enqueue_style( 'ai12z-style', 'https://cdn.ai12z.net/pkg/ai12z@'.$version.'/dist/library/library.css', array(), AI12Z_BUILD );
  wp_enqueue_script( 'ai12z-script', 'https://cdn.ai12z.net/pkg/ai12z@'.$version.'/dist/esm/library.js', array(), AI12Z_BUILD, true );
...
function enqueue_custom_ajax_script() {
  wp_enqueue_script('custom-ajax-js', '/wp-content/plugins/ai12z-ai-copilot/js/ajax.js', array('jquery'), AI12Z_BUILD, true);
