		...
		<div class="wrap">
			...
			<form method="post">
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row">
							<label for="gttEase"><?php echo __('Easing effect', 'go-to-top'); ?></label>
						</th>
						<td>
                            <select name="gttEase">
                            <?php 
					...
					<tr>
						<th scope="row">
							<label for="gttMiscSettings"><?php echo __('Misc Settings', 'go-to-top'); ?></label>
						</th>
						<td>
							<fieldset><legend class="screen-reader-text"><span><?php echo __('Misc Settings', 'go-to-top'); ?></span></legend>
