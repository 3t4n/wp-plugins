...
function eh_crm_js_translation_obj( $page ) {
	switch ( $page ) {
		case 'settings':
			$js_var = array(
				'Archived_Tickets'                         => __( 'Ticket Data is Archived Successfully!', 'wsdesk' ),
				'Unarchived_Tickets'                       => __( 'Ticket Data is Unarchived Successfully!', 'wsdesk' ),
				...
				'trigger_name_exists'                      => __( 'The trigger name exists', 'wsdesk' ),
				...
				'Codes_for_Google_chat'                    => __( 'Codes for Notification Google Chat', 'wsdesk' ),
				...
				'To_Insert_Ticket_Number_in_the_notification_chat' => __( 'To Insert Ticket Number in the notification google chat', 'wsdesk' ),
				...
				'To_Insert_Ticket_Assignee_in_the_notification_chat' => __( 'To Insert Ticket Assignee in the notification google chat', 'wsdesk' ),
				...
				'To_Insert_Ticket_Date_and_Time_in_the_notification_chat' => __( 'To Insert Ticket Date and Time in the notification google chat', 'wsdesk' ),
				...
				'To_Insert_Latest_Ticket_Content_in_the_notification_chat' => __( 'To Insert Latest Ticket Reply in the notification google chat', 'wsdesk' ),
				...
				'To_Insert_Ticket_Note_in_the_notification_chat' => __( 'To Insert Latest Ticket Reply (even if it is a note) in the notification google chat', 'wsdesk' ),
				...
				'To_Insert_Conversation_History_in_the_notification_chat' => __( 'To Insert Conversation History in the notification google chat', 'wsdesk' ),
				...
				'Specify_the_Chat_Body'                    => __( 'Specify the Google Chat Body', 'wsdesk' ),
				'Enter_mail_body'                          => __( 'Enter mail body', 'wsdesk' ),
				'Enter_chat_body'                          => __( 'Enter Google Chat Message', 'wsdesk' ),
				...
				'Empty_Scheduled_Actions'                  => __( 'Empty Scheduled Actions', 'wsdesk' ),
				'WSDesk_will_Delete_the_tickets_Permanently' => __( 'WSDesk will delete the tickets permanently. Please take a backup', 'wsdesk' ),
				'WSDesk_will_Delete_the_scheduled_actions' => __( 'WSDesk will delete the scheduled actions permanently', 'wsdesk' ),
				'Okay_Empty_it'                            => __( 'Okay! Empty it', 'wsdesk' ),
				'Empty_Ticket_Success'                     => __( 'All trash tickets deleted successfully!', 'wsdesk' ),
				'Empty_Scheduled_Actions_Success'          => __( 'All scheduled actions deleted successfully!', 'wsdesk' ),
		...
		case 'tickets':
			$js_var = array(
				...
				'Do_You_want_to_Archive_Ticket'       => __( 'Do you want to archive the ticket?', 'wsdesk' ),
				'Do_You_want_to_Unarchive_Ticket'     => __( 'Do you want to restore the ticket(s)?', 'wsdesk' ),
				...
				'Yes_Unarchive'                       => __( 'Yes! Restore', 'wsdesk' ),
				'Yes_archive'                         => __( 'Yes! Archive', 'wsdesk' ),
				...
				'Create_Template'                     => __( 'Create Template', 'wsdesk' ),
				'Tickets_Deleted_Successfully'        => __( 'Tickets Deleted Successfully', 'wsdesk' ),
				'Tickets_Unarchived_Successfully'     => __( 'Tickets Restored Successfully', 'wsdesk' ),
				...
				'Do_You_want_to_Archive_Tickets'      => __( 'Do you want to archive tickets?', 'wsdesk' ),
				'Yes_Update'                          => __( 'Yes! Update', 'wsdesk' ),
				'Yes_Archived'                        => __( 'Yes! Update', 'wsdesk' ),
				'Tickets_Updated_Successfully'        => __( 'Tickets Updated Successfully', 'wsdesk' ),
				'Tickets_Archived_Successfully'       => __( 'Tickets Archived Successfully', 'wsdesk' ),
