...
/** Class used to intend the Incoming Mails
 * 
 * @see    https://github.com/barbushin/php-imap
 */
class EH_CRM_IncomingMail {
	...
	public function addAttachment( EH_CRM_IncomingMailAttachment $attachment ) {
...
class EH_CRM_IncomingMailAttachment {
