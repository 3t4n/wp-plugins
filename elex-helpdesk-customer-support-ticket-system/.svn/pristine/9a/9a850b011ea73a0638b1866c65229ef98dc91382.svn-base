...
jQuery(document).ready(function () {
    ...
    page_tab_load();
    archive_tab_load();
    jQuery('.wsdesk_ticket_settings').hide();
    jQuery('.wsdesk_advanced_settings').hide()
    jQuery('.wsdesk_general_settings').show();



    jQuery("#show_archive").select2({
        width: '30%',
...
function archive_tab_load()
{
    jQuery("#archive_start_date").datepicker({
        maxDate:"d",
        defaultDate: "d",
        dateFormat: "yy-mm-dd",
        beforeShow: function(input, inst) {
    ...
    jQuery("#archive_end_date").datepicker({
        maxDate:"d",
        defaultDate: "d",
        dateFormat: "yy-mm-dd",
        beforeShow: function(input, inst) {
    ...
    jQuery("#archive_start_date_restored").datepicker({
        maxDate:"d",
        defaultDate: "d",
        dateFormat: "yy-mm-dd",
        beforeShow: function(input, inst) {
    ...
    jQuery("#archive_end_date_restored").datepicker({
        maxDate:"d",
        defaultDate: "d",
        dateFormat: "yy-mm-dd",
        beforeShow: function(input, inst) {
...
function page_tab_load()
{
    ...
    jQuery.ajax({
        ...
        success: function(data){
            jQuery("#ticket_page_tab").html(data.data.page);
            page_tab_load();
        },
...
jQuery(function () {
    ...
    jQuery(".nav-pills").on("click", "a", function (e) {
        ...
        {
            case 'general':
                jQuery('li.advanced').removeClass('active');
                jQuery('li.general_submenu').addClass('active');
            ...
            case 'ticket_fields':
                ...
                jQuery('li.ticket_labels').removeClass('active');
                jQuery('li.ticket_tags').removeClass('active');
                jQuery('li.ticket_views').removeClass('active');
                jQuery('li.ticket_page').removeClass('active');
                jQuery('li.ticket_fields_submenu').addClass('active');

                jQuery('.wsdesk_ticket_settings').show();
                jQuery('.wsdesk_advanced_settings').hide()
                jQuery('.wsdesk_general_settings').hide();
            ...
            case 'integrations':
                ...
                jQuery('.wsdesk_advanced_settings').hide()
                jQuery('.wsdesk_general_settings').hide();
                jQuery('#breadcrump_section').html("integrations");
                break;
            case 'backup_restore':
                jQuery('li.archive').removeClass('active');
                jQuery('li.export').removeClass('active');
                jQuery('li.backup_restore_sub_menu').addClass('active');
                jQuery('.wsdesk_ticket_settings').hide();
                jQuery('.wsdesk_advanced_settings').show()
                jQuery('.wsdesk_general_settings').hide();
                jQuery('#breadcrump_section').html(js_obj.Backup_Restore);
                break;
            case 'archive_tab':
                jQuery('#breadcrump_section').html(js_obj.Archived_Tickets);
            break;
            case 'activation_wsdesk not_activated btn-danger':
                jQuery('.wsdesk_ticket_settings').hide();
                jQuery('.wsdesk_advanced_settings').hide();
                jQuery('.wsdesk_general_settings').hide();
    ...
    jQuery(".general_settings").on("click", "#save_general", function (e) {
        e.preventDefault();
        jQuery(".loader").css("display", "block");
        var wsdesk_mode = jQuery("input[name='wsdesk_mode']:checked").val();
        var ticket_count_view = jQuery("input[name='ticket_count_view']:checked").val();
        var quick_view_tickets = jQuery("input[name='quick_view_tickets']:checked").val();
        var refresh_ticket_page = jQuery("input[name='refresh_ticket_page']:checked").val();
        var default_assignee = jQuery('#default_assignee').val();
        var scheduled_triggers_time = jQuery("#scheduled_triggers_time").val();
        var default_label = jQuery("#default_label").val();
        var ticket_raiser = jQuery('[name=ticket_raiser]:checked').val();
        var auto_assign = jQuery("input[name='auto_assign']:checked").val();
        var auto_suggestion = jQuery('input[name=auto_suggestion]:checked').val();;
        var show_excerpt_in_auto_suggestion = '';
        var ticket_rows = jQuery("#ticket_display_row").val();
        var ticket_display_hyperlink = jQuery('#ticket_display_hyperlink').val();
        ...
        var enable_api = '';
        var scheduled_triggers_enable = '';
        var default_deep_link = encodeURI(jQuery("#default_deep_link").val());
        ...
        var display_default_status_count = 'disable';
        var linkify_urls = '';
        ...
        if(jQuery("input[name='scheduled_triggers_enable']:checked").val()!==undefined)
        {
            scheduled_triggers_enable = jQuery("input[name='scheduled_triggers_enable']:checked").val();
        }
        ...
        if(jQuery("input[name='display_default_status_count']:checked").val() !== undefined)
        {
            display_default_status_count = jQuery("input[name='display_default_status_count']:checked").val();
        }
        jQuery.ajax({
            type: 'post',
            url: ajaxurl,
            data: {
                ...
                display_default_status_count: display_default_status_count,
                default_label : default_label,
                ticket_raiser: ticket_raiser,
                scheduled_triggers_time: scheduled_triggers_time,
                ...
                scheduled_triggers_enable: scheduled_triggers_enable,
                ...
                wsdesk_mode: wsdesk_mode,
                ticket_count_view: ticket_count_view,
                quick_view_tickets: quick_view_tickets,
                refresh_ticket_page: refresh_ticket_page,
                ticket_display_hyperlink: ticket_display_hyperlink,
            },
            success: function (data) {
                ...
                jQuery("#general_tab").html(data.data.page);
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
            }
    ...
    jQuery("#woocommerce_tab").on("click", "#save_woocommerce", function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery("#woocommerce_tab").html(data.data.page);
                woocommerce_tab_load();
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
    ...
    jQuery("#appearance_tab").on("click", "#save_appearance", function (e) {
        ...
        var purchase_credit_redirect_url = jQuery("#purchase_credit_redirect_url").val();
        var set_credit_limit = jQuery("#set_credit_limit").val();
        ...
        var reg_url = jQuery("#reg_url").val();
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                purchase_credit_redirect_url        : purchase_credit_redirect_url,
                login_url                           : login_url,
                reg_url                             : reg_url
            },
            success: function (data) {
                ...
                jQuery("#appearance_tab").html(data.data.page);
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
            }
    ...
    jQuery("#ticket_fields_tab").on("click", ".ticket_field_edit_type", function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery("#ticket_field_edit_append").html(data.data.page);
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
            }
        ...
        jQuery("#ticket_label_edit_type").val(label);
            ...
            jQuery.ajax({
                ...
                jQuery("#ticket_label_add_display").slideUp(10).hide();
                    ...
                    jQuery("#ticket_label_edit_append").html(data.data.page);
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    console.log(textStatus, errorThrown);
                }
    ...
    //To Archive the tickets
    jQuery("#archive_tab").on("click",".archive_data",function(e){
        e.preventDefault();
        var start_date = jQuery("#archive_start_date").val();
        var end_date = jQuery("#archive_end_date").val();
        jQuery(".loader").css("display", "block");
        var status = jQuery(".show_archive").val();
        ...
        jQuery.ajax({
            ...
            url: ajaxurl,
            data: {
                action: 'eh_crm_archive_ticket_data',
            ...
            success: function (data) {
                jQuery(".loader").css("display", "none");
                jQuery(".success_archive").css("display","block").removeClass("hidden");
                window.setTimeout(function () {
                	jQuery(".success_archive").addClass("hidden");
                }, 4000);
            }
    ...
    //To Unarchive the tickets
    jQuery("#archive_tab").on("click",".archive_data_restored",function(e){
        e.preventDefault();
        var start_date = jQuery("#archive_start_date_restored").val();
        var end_date = jQuery("#archive_end_date_restored").val();
        jQuery(".loader").css("display", "block");
        var status = [];
        jQuery(".show_unarchive").each(function(){
        ...
        if(start_date === ''){
            ...
            jQuery.ajax({
                ...
                url: ajaxurl,
                data: {
                    action: 'eh_crm_archive_ticket_data_restored',
                    start_date:start_date,
                    end_date:end_date,
                    status:status,
                    nonce: js_obj.nonce,
                ...
                success: function (data) {
                   jQuery(".loader").css("display", "none");
                   jQuery(".success_unarchive").css("display", "block");
                   window.setTimeout(function () {
                        jQuery(".success_unarchive").fadeTo(500, 0).slideUp(500, function () {
                            jQuery(this).css("display", "none");
                        });
                    }, 4000);
                }
        ...
        jQuery("#ticket_tag_edit_type").val(tag);
            ...
            jQuery.ajax({
                ...
                jQuery("#ticket_tag_add_display").slideUp(10).hide();
                    ...
                    jQuery("#ticket_tag_edit_append").html(data.data.page);
                    tag_tab_edit_load();
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    console.log(textStatus, errorThrown);
    ...
    jQuery("#ticket_views_tab").on("click", "#save_ticket_views", function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery("#ticket_views_tab").html(data.data.page);
                view_tab_load();
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
    ...
    jQuery("#ticket_views_tab").on("click", ".ticket_view_edit_type", function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery("#ticket_view_edit_append").html(data.data.page);
    ...
    jQuery("#triggers_tab").on("click", ".ticket_trigger_activate", function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery("#triggers_tab").html(data.data.page);
                trigger_tab_load();
            },
            error: function (jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
    ...
    jQuery("#triggers_tab").on("change", "#trigger_add_schedule", function (e) {
        ...
        if (jQuery(this).val()!=="") {
            ...
            var html = '<span class="help-block">'+js_obj.Enter_Period_for_New_Trigger+' </span><input type="number" min="0" id="trigger_add_period" placeholder="How much '+name+'" class="form-control crm-form-element-input" value="1">';
    ...
    jQuery("#triggers_tab").on("change", "#trigger_edit_schedule", function (e) {
        ...
        if (jQuery(this).val()!=="") {
            var name = jQuery(this).val();
            var html = '<span class="help-block">'+js_obj.Edit_Period_for_the_Trigger+' </span><input type="number" min="0" id="trigger_edit_period" placeholder="How much '+name+'" class="form-control crm-form-element-input" value="1">';
    ...
    jQuery("#triggers_tab").on("click", "#save_triggers", function (e) {
        ...
        if (jQuery("#add_new_trigger_yes").val() === 'yes') {
            ...
            jQuery(".specify_tactions").each(function () {
                ...
                if(jQuery("#"+div_id+"_type").val()!=="")
                {
                    if(jQuery("#"+div_id+"_type").val() !== "notify" && jQuery("#"+div_id+"_type").val() !== "sms" && jQuery("#"+div_id+"_type").val() !== "chat")
                    {
                        values['type'] = jQuery("#"+div_id+"_type").val();
                        values['value'] = jQuery("#"+div_id+"_value").val();
                    }
                    else
                    {
                    	...
                    	values['body'] = ['sms', 'chat'].indexOf(values['type']) >= 0 ? jQuery('#'+div_id + '_body').val() :jQuery("#"+div_id+"_body .ql-editor").html();
                    }
                    actions.push(values);
                }
            });
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.success === false) {
                	const alert_danger = jQuery('.alert-danger');
					alert_danger.css( "display", "block" );
					alert_danger.css( "opacity", "1" );
                	alert_danger.find("#danger_alert_text").html("<strong>"+js_obj.Edit_Trigger+"</strong><br>"+data.data.message+"!");
            ...
            error: function (f, textStatus, errorThrown) {
                if (f.responseJSON && f.responseJSON.message) {
                	jQuery("#danger_alert_text").html("<strong>"+js_obj.Edit_Trigger+"</strong><br>"+js_obj.Specify_some_action_for_the_Trigger+"!");
                	window.setTimeout(function () {
                    	jQuery(".alert-danger").fadeTo(500, 0).slideUp(500, function () {
                        	jQuery(this).css("display", "none");
        ...
        jQuery("#trigger_edit_type").val(trigger);
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    jQuery("#trigger_edit_append").html(data.data.page);
	...
	var toolbarOptions = [
    	...
    	['clean']                                         // remove formatting button
                    ...
                    jQuery('[data-notification-email]').each(function () {
            			console.log(this);
            			new Quill(this, {
        					theme: 'snow',
        					modules: {
...
jQuery(function () {
                        ...
                        if(file.val()!=="")
                        {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    jQuery(".alert-success").css("display", "block");
                                    jQuery(".alert-success").css("opacity", "1");
                                    jQuery("#success_alert_text").html("<strong>"+data.data.message+"Successfully Restored!");
                                    window.setTimeout(function () {
                                        jQuery(".alert-success").fadeTo(500, 0).slideUp(500, function () {
                                            jQuery(this).css("display", "none");
                                        });
    ...
    jQuery("#backup_restore_tab").on("click", "#empty_scheduled_trigger", function (e) {
        e.preventDefault();
        BootstrapDialog.show({
            title: js_obj.Empty_Scheduled_Actions,
            message: js_obj.WSDesk_will_Delete_the_scheduled_actions,
            cssClass: 'wsdesk_wrapper',
            buttons: [{
                    label: js_obj.Okay_Empty_it,
                    // no title as it is optional
                    cssClass: 'btn-primary',
                    action: function (dialogItself) {
                        var btn = jQuery("#empty_scheduled_trigger");
                        btn.prop("disabled","disabled");
                        jQuery.ajax({
                            type: 'post',
                            url: ajaxurl,
                            data: {
                                action: 'eh_crm_settings_empty_scheduled_actions'
                            },
                            success: function (data) {
                                btn.prop("disabled", false);
                                var response = jQuery.parseJSON(data);
                                if(response.result == 'success')
                                {
                                    jQuery(".alert-success").css("display", "block");
                                    jQuery(".alert-success").css("opacity", "1");
                                    jQuery("#success_alert_text").html("<strong>"+js_obj.Empty_Scheduled_Actions+"</strong><br>"+js_obj.Empty_Scheduled_Actions_Success+"!");
                                    window.setTimeout(function () {
                                        jQuery(".alert-success").fadeTo(500, 0).slideUp(500, function () {
                                            jQuery(this).css("display", "none");
                                        });
...
function triggers_action_maker(data,parent)
{
    ...
    switch(type)
    {
        case "chat":
            var value = data.values;
            html += '<div class="input-group"><span class="input-group-addon" id="basic-addon1">Webhook URL </span><input type="text" id="'+parent+'_subject" placeholder="https://chat.googleapis.com/v1/spaces/AAAAAAAA/messages?key=AAAAAAAA&token=BBBBBBBB" class="form-control crm-form-element-input" aria-describedby="helpBlock"></div>';
            html += '<span class="help-block">'+js_obj.Codes_for_Google_chat+'.<table style="text-indent: 10px;padding:5px;">';
            html += '<tr><td>[id] </td><td> => </td><td> '+js_obj.To_Insert_Ticket_Number_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[assignee] </td><td> => </td><td> '+js_obj.To_Insert_Ticket_Assignee_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[tags] </td><td> => </td><td> '+js_obj.To_Insert_Ticket_Tags_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[date] </td><td> => </td><td> '+js_obj.To_Insert_Ticket_Date_and_Time_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[latest_reply] </td><td> => </td><td> '+js_obj.To_Insert_Latest_Ticket_Content_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[latest_reply_with_notes] </td><td> => </td><td> '+js_obj.To_Insert_Ticket_Note_in_the_notification_chat+'</td></tr>';
            html += '<tr><td>[conversation_history] </td><td> => </td><td> '+js_obj.To_Insert_Conversation_History_in_the_notification_chat+'</td></tr>';
            jQuery.each(shortvalues, function( index, value ) {
                html += '<tr><td>'+index+'</td><td> => </td><td> '+value+'</td></tr>';
            });
            html += '</table></span>';
            html += '<span class="help-block">'+js_obj.Specify_the_Chat_Body+'.</span>';
            html += '<textarea id="'+parent+'_body" class="form-control crm-form-element-input crm-input-textarea-body" placeholder="'+js_obj.Enter_chat_body+'"/>';
            jQuery("#"+parent+"_append").html(html);
        ...
        case "notification":
            ...
            html += '<div id="'+parent+'_body" class="" placeholder="'+js_obj.Enter_mail_body+'"></div>';
            jQuery("#"+parent+"_append").html(html);
