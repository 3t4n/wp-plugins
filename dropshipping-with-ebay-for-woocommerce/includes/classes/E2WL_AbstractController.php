...
/* * class
 * Description of E2WL_AbstractController
 *
 * @author andrey
 * 
 * @position: 1
...
if (!class_exists('E2WL_AbstractController')) {

    abstract class E2WL_AbstractController {
        private $model = array();
        private $views = array();
