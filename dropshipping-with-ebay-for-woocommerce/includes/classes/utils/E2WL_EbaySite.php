<?php
/**
 * Description of E2WL_EbaySite
 *
 * @author Andrey
 */
if (!class_exists('E2WL_EbaySite')){
    ...
    class E2WL_EbaySite {
        ...
        public static function get_sites() {
            ...
            foreach ($sites as $row) {
                $result[] = new E2WL_EbaySite($row);
            }

            return $result;
        }
        
        public static function get_site($site_id_or_code){
            $sites = E2WL_EbaySite::get_sites();
            foreach ($sites as $site){
                if($site->sitecode === $site_id_or_code || $site->siteid === $site_id_or_code){
                    return $site;
                }
            }
            return false;
        ...
        public static function get_site_by_id($siteid){
            $sites = E2WL_EbaySite::get_sites();
            foreach ($sites as $site){
        ...
        public static function get_site_by_code($sitecode){
            $sites = E2WL_EbaySite::get_sites();
            foreach ($sites as $site){
