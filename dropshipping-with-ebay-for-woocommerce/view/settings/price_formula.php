<?php
$e2wl_use_extended_price_markup = e2wl_get_setting('use_extended_price_markup');
$e2wl_use_compared_price_markup = e2wl_get_setting('use_compared_price_markup');
$e2w_local_currency = strtoupper(e2wl_get_setting('local_currency'));
?>
...
<div class="global-pricing mt20">
    <div class="panel panel-primary">
        ...
        <div class="panel-body p20 border-bottom js-default-prices"  <?php if ($e2wl_use_extended_price_markup): ?>style="display: none;" <?php else: ?>style="display: block;"<?php endif;?>>
            ...
            <div class="row pb20 border-bottom">
                ...
                <div class="col-sm-3 col-md-3 vertical-align">
                    <div class="input-group price-dropdown-group">
                        <input type="text" class="form-control value" value="<?php echo esc_attr($default_formula->value); ?>">
            ...
            <div class="row pt20 compared">
                <div class="col-sm-1 vertical-align">
                    <div class="price-rulle-toggle <?php if (!$e2wl_use_compared_price_markup): ?>price-rulle-toggle--disabled<?php endif;?>"></div>
                </div>

                <div class="col-sm-10 vertical-align switch-col" <?php if ($e2wl_use_compared_price_markup): ?>style="display:none;"<?php endif;?>>
                    <span class="grey-color" style="">Set your compared at pricing rules</span>
                </div>
                <div class="col-sm-2 vertical-align switch-col" <?php if (!$e2wl_use_compared_price_markup): ?>style="display:none;"<?php endif;?>>
                    <h3>Product cost</h3>
                </div>
                <div class="col-sm-1 vertical-align switch-col" <?php if (!$e2wl_use_compared_price_markup): ?>style="display:none;"<?php endif;?>>
                ...
                <div class="col-sm-3 col-md-3 vertical-align switch-col" <?php if (!$e2wl_use_compared_price_markup): ?>style="display:none;"<?php endif;?>>
                    <div class="input-group price-dropdown-group">

                        <input type="text" value="<?php echo esc_attr($default_formula->compared_value); ?>" class="form-control compared_value">
        ...
        <div class="p20 extended_prices">
            <div class="container-flex">
                <div class="price-rulle-toggle <?php if (!$e2wl_use_extended_price_markup): ?>price-rulle-toggle--disabled<?php endif;?>"></div>
                <div>
            ...
            <div class="js-advanced-prices mt20" <?php if (!$e2wl_use_extended_price_markup): ?>style="display: none;" <?php else: ?>style="display: block;"<?php endif;?>>
                    ...
                    <table class="border">
                        <thead>
                            <tr class="border-bottom">
                                ...
                                <th width="25%" style="white-space: nowrap;">
                                    <input class="use_compared_price_markup" type="checkbox" <?php if ($e2wl_use_compared_price_markup): ?>checked="checked"<?php endif;?>><span>Compared at price markup</span>
                                </th>
                                <th>&nbsp;</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="border-bottom">
                                    <td>
                                        <div class="input-group">
                                            <input type="text" class="form-control min_price" value="<?php echo esc_attr($formula->min_price); ?>"><span class="input-group-addon"> <?php echo esc_html($e2w_local_currency); ?> </span>
                                        </div>
                                    </td>
                                    <td>-</td>
                                    <td>
                                        <div class="input-group">
                                            <input type="text" class="form-control max_price" value="<?php echo esc_attr($formula->max_price); ?>"><span class="input-group-addon"> <?php echo esc_html($e2w_local_currency); ?> </span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="input-group price-dropdown-group">
                                            <input type="text" class="form-control value" value="<?php echo esc_attr($formula->value); ?>">
                                    ...
                                    <td>
                                        <div class="input-group price-dropdown-group <?php if (!$e2wl_use_compared_price_markup): ?>visually-hidden<?php endif;?>">
                                            <input type="text" class="form-control compared_value" value="<?php echo esc_attr($formula->compared_value); ?>">
                        ...
                        <tfoot>
                            <tr class="border-bottom">
                                ...
                                <td>
                                    <div class="input-group price-dropdown-group">
                                        <input type="text" class="form-control default_value" value="<?php echo esc_attr($default_formula->value); ?>">
                                ...
                                <td>
                                    <div class="input-group price-dropdown-group <?php if (!$e2wl_use_compared_price_markup): ?>visually-hidden<?php endif;?>">
                                        <input type="text" value="<?php echo esc_attr($default_formula->compared_value); ?>" class="form-control default_compared_value">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                        <div class="input-wrap">
                            ...
                            <input type="text" class="form-control small-input" id="set-cents"  <?php if ($cents > -1): ?> value="<?php echo esc_attr($cents); ?>" <?php else: ?> disabled="" <?php endif;?>>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-10">
                        <div class="input-wrap" <?php if (!$e2wl_use_compared_price_markup): ?>style="display:none;"<?php endif;?>>
                            ...
                            <input type="text" class="form-control small-input" id="compared-set-cents" <?php if ($compared_cents > -1): ?> value="<?php echo esc_attr($compared_cents); ?>" <?php else: ?> disabled="" <?php endif;?>>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid">
    <div class="row pt20 border-top">
        <div class="col-sm-12">
            <input class="btn btn-success mt20" type="submit" id="save-price-rules" value="<?php _e('Save settings', 'dropshipping-with-ebay-for-woocommerce');?>"/>
        </div>
    </div>
</div>
...
<div class="modal-overlay modal-apply-pricing-rules">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-default close-btn" type="button"><?php _e('Close', 'dropshipping-with-ebay-for-woocommerce');?></button>
            <button class="btn btn-success apply-btn" type="button"><?php _e('Apply', 'dropshipping-with-ebay-for-woocommerce');?></button>
        </div>
    </div>
</div>
...
<script>
    jQuery(function ($) {
        ...
        $(".modal-apply-pricing-rules .apply-btn").on("click", function () {
            ...
            var data = {action: 'e2wl_apply_pricing_rules', type:$(".modal-apply-pricing-rules .btn-group.type").data().value,scope:$(".modal-apply-pricing-rules .btn-group.scope").data().value};
        ...
        $(".js-default-prices div.info-box").on("mouseover", function () {
            $(this).attr('title', rule_info_box_calculation("E.g., A product that costs %d <?php echo esc_attr($e2w_local_currency); ?> would have its price set to %d <?php echo esc_attr($e2w_local_currency); ?> (%d %s %d = %d).", get_el_sign_value($('.js-default-prices ul.sign')), get_value()));
            $(this).tooltip('fixTitle').tooltip('show');
        });

        $(".js-default-prices .compared div.info-box").on("mouseover", function () {
            $(this).attr('title', rule_info_box_calculation("If you import a product that costs %d <?php echo esc_attr($e2w_local_currency); ?>, we'll set its compared at price to %d <?php echo esc_attr($e2w_local_currency); ?> (%d %s %d = %d).", get_el_sign_value($('.js-default-prices ul.compared_sign')), get_value(true)));
            $(this).tooltip('fixTitle').tooltip('show');
        });
            ...
            if (use_extended_price_markup) {
                ...
                if (check_price_rules()) {
                    ...
                    if ($('.js-advanced-prices table .input-group.has-error').length === 0) {
                        if (check_cents()) {
                            var data = {'action': 'e2wl_update_price_rules', 'use_extended_price_markup': 'yes', 'use_compared_price_markup': use_compared ? 'yes' : 'no', 'rules': [],
                ...
                if ($('.js-default-prices .input-group.has-error').length === 0) {
                    ...
                    if (check_cents()) {
                        var data = {'action': 'e2wl_update_price_rules',
