...
require_once WC_Super_Payments::plugin_abspath() . 'include/funding-summary.php';
...
class WC_Super_Payments_Gateway extends WC_Super_Payments_Base_Gateway {
	...
	public function init_form_fields() {
		$this->form_fields = [
			...
			'enable_product_ingestion'                 => [
				'title'   => __( 'Enable Product Ingestion', 'super-payments' ),
				'label'   => __( 'Enable product ingestion to automatically send product data to Super', 'super-payments' ),
				'type'    => 'checkbox',
				'default' => 'yes',
			],
			'test_mode'                                => [
	...
	public function get_payment_method_fragments() {
		...
		if ( ! is_admin() && ! wcsp_is_wc_api_request() ) {
