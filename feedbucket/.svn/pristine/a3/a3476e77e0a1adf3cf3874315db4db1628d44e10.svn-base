                                ...
                                <div class="mt-1">
                                    ...
                                    <div v-if="showProjectKeyHelp" class="mt-1 bg-gray-100 border border-gray-200 rounded-md p-2">
                                        <ol class="list-decimal list-outside text-sm text-gray-400">
                                            <li>Go to <a href="https://dashboard.feedbucket.app" class="text-indigo-600 underline underline-offset-4 hover:text-indigo-800">feedbucket.app</a> and log in, or create a free 14 day trial.</li>
