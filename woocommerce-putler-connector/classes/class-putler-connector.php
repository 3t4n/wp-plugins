...
if ( ! class_exists( 'Putler_Connector' ) ) {
	...
	class Putler_Connector {
		...
		public function get_authorization_header() {
			...
			if ( ! empty( $_SERVER['REDIRECT_HTTP_AUTHORIZATION'] ) ) { // added as observed on client site in case of redirection's.
			...
			if ( ! empty( $_SERVER['PHP_AUTH_USER'] ) && ! empty( $_SERVER['PHP_AUTH_PW'] ) ) {
				return sanitize_text_field( wp_unslash( $_SERVER['PHP_AUTH_USER'] ) ) . ':' . sanitize_text_field( wp_unslash( $_SERVER['PHP_AUTH_PW'] ) );
			}
