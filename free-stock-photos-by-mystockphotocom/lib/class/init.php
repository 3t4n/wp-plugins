<?php
 ...
 class mystockphoto  extends msp {
  ...
  $mystp_btn  = '<a href="'.admin_url('admin-ajax.php?action=mystp_proxy&fpage=index');
	...
	$mystp_btn .= '"  id="mystp-button" class="mystp_popup " title="'.__('My Stock Photos - Add Photos to your blog posts', MYSTP_TEXT_DOMAIN).'"> <span class="mystp-button-pop"></span></a>';
  ...
  function min_version_error() {
    echo '<div class="error"><p>',__('My Stock photos', MYSTP_TEXT_DOMAIN),'<b>',__('This plugin requires WordPress version ', MYSTP_TEXT_DOMAIN),'<b>',__(' or higher. Current installed is version ', MYSTP_TEXT_DOMAIN),get_bloginfo('version'),__('Please <a href="update-core.php">Upgrade</a> your wordpress installation.' , MYSTP_TEXT_DOMAIN);
  } // min_version_error
