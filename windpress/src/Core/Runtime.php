...
class Runtime
{
    ...
    public function enqueue_play_cdn_v3($can_load_modules)
    {
        ...
        $loaded_modules = [];
        if ($can_load_modules) {
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v3/play/autocomplete.js', ['handle' => WIND_PRESS::WP_OPTION . ':autocomplete', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':autocomplete';
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v3/play/sort.js', ['handle' => WIND_PRESS::WP_OPTION . ':sort', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':sort';
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v3/play/classname-to-css.js', ['handle' => WIND_PRESS::WP_OPTION . ':classname-to-css', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':classname-to-css';
        }
        AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v3/play/observer.js', ['handle' => WIND_PRESS::WP_OPTION . ':observer', 'in-footer' => \true, 'dependencies' => \array_merge(['wp-i18n', 'wp-hooks'], \is_array($loaded_modules) ? $loaded_modules : \iterator_to_array($loaded_modules))]);
    }
    public function enqueue_play_cdn_v4($can_load_modules)
    {
        ...
        $loaded_modules = [];
        if ($can_load_modules) {
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v4/play/autocomplete.js', ['handle' => WIND_PRESS::WP_OPTION . ':autocomplete', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':autocomplete';
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v4/play/sort.js', ['handle' => WIND_PRESS::WP_OPTION . ':sort', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':sort';
            AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v4/play/classname-to-css.js', ['handle' => WIND_PRESS::WP_OPTION . ':classname-to-css', 'in-footer' => \true]);
            $loaded_modules[] = WIND_PRESS::WP_OPTION . ':classname-to-css';
        }
        AssetVite::get_instance()->register_asset('assets/packages/core/tailwindcss-v4/play/observer.js', ['handle' => WIND_PRESS::WP_OPTION . ':observer', 'in-footer' => \true, 'dependencies' => \array_merge(['wp-i18n', 'wp-hooks'], \is_array($loaded_modules) ? $loaded_modules : \iterator_to_array($loaded_modules))]);
    }
    ...
    {
        $metadata = ['_version' => WIND_PRESS::VERSION, '_tailwindcss_version' => static::tailwindcss_version(), '_wp_version' => \get_bloginfo('version'), '_via_wp_org' => !Common::is_updater_library_available(), 'is_ubiquitous' => $this->is_ubiquitous_panel(), 'assets' => ['url' => AssetVite::asset_base_url()], 'user_data' => ['data_dir' => [
        ...
        if (\current_user_can('manage_options')) {
            ...
            $metadata['site_meta'] = ['name' => \get_bloginfo('name'), 'site_url' => \get_site_url()];
        }
        return $metadata;
    }
}
