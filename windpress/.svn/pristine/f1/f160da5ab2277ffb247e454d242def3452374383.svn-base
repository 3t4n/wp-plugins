import { m as et, __tla as __tla_0 } from "./monaco-editor-Dg0eLWcY.js";
...
let gt, xt, dt, Mt, Pt, wt, cr, Dt, At, Ct, mt, It, Et, Ft, ut, k, Qe, dr, m, D;
let __tla = Promise.all([
  ...
  var tt = Object.defineProperty, rt = Object.getOwnPropertyDescriptor, nt = Object.getOwnPropertyNames, it = Object.prototype.hasOwnProperty, ot = (e, n, i, r) => {
    if (n && typeof n == "object" || typeof n == "function") for (let t of nt(n)) !it.call(e, t) && t !== i && tt(e, t, {
      get: () => n[t],
  ...
  (function(e) {
    function n(r, t) {
      return r === Number.MAX_VALUE && (r = M.MAX_VALUE), t === Number.MAX_VALUE && (t = M.MAX_VALUE), {
        line: r,
        character: t
      };
    }
  ...
  (function(e) {
    function n(r, t, o, s) {
      if (a.uinteger(r) && a.uinteger(t) && a.uinteger(o) && a.uinteger(s)) return {
        start: w.create(r, t),
        end: w.create(o, s)
      };
      if (w.is(r) && w.is(t)) return {
        start: r,
        end: t
      };
  ...
  (function(e) {
    function n(r, t, o) {
      ...
      return typeof t == "string" ? (u = false, s.kind = t) : I.is(t) ? s.command = t : s.edit = t, u && o !== void 0 && (s.kind = o), s;
    }
    e.create = n;
    function i(r) {
      let t = r;
  ...
  (function(e) {
    ...
    function t(o, s) {
      ...
      t(f, s), t(c, s);
      let g = 0, _ = 0, b = 0;
      for (; g < f.length && _ < c.length; ) s(f[g], c[_]) <= 0 ? o[b++] = f[g++] : o[b++] = c[_++];
...
` && r++;
  ...
  dt = class {
    constructor(e, n, i) {
      ...
      this._disposables.push(d.editor.onDidCreateModel(r)), this._disposables.push(d.editor.onWillDisposeModel(t)), this._disposables.push(d.editor.onDidChangeModelLanguage((o) => {
        t(o.model), r(o.model);
      })), this._disposables.push(i((o) => {
  ...
  gt = class {
    ...
    provideCompletionItems(e, n, i, r) {
      ...
      return this._worker(t).then((o) => o.doComplete(t.toString(), k(n))).then((o) => {
        if (!o) return;
        const s = e.getWordUntilPosition(n), u = new d.Range(n.lineNumber, s.startColumn, n.lineNumber, s.endColumn), f = o.items.map((c) => {
          const g = {
            label: c.label,
...
` + e.value + "\n```\n"
  ...
  function bt(e) {
    if (e) return Array.isArray(e) ? e.map(Be) : [
      Be(e)
    ];
  }
  wt = class {
  ...
  Dt = class {
    constructor(e) {
      this._worker = e, this.canFormatMultipleRanges = false;
    }
  ...
  Mt = class {
    ...
    provideColorPresentations(e, n, i) {
      const r = e.uri;
      return this._worker(r).then((t) => t.getColorPresentations(r.toString(), n.color, Qe(n.range))).then((t) => {
        if (t) return t.map((o) => {
          let s = {
            label: o.label
          };
  ...
  Ft = class {
    ...
    provideSelectionRanges(e, n, i) {
      const r = e.uri;
      return this._worker(r).then((t) => t.getSelectionRanges(r.toString(), n.map(k))).then((t) => {
        if (t) return t.map((o) => {
          const s = [];
          for (; o; ) s.push({
            range: m(o.range)
