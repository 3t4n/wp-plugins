import { c as L, a as v, r as M } from "./isObject-CRxghtyK.js";
var N = /\s/;
function B(n) {
...
function q(n, r, t) {
  var u, c, l, s, i, f, d = 0, p = false, o = false, T = true;
  if (typeof n != "function") throw new TypeError(H);
  r = S(r) || 0, v(t) && (p = !!t.leading, o = "maxWait" in t, l = o ? P(S(t.maxWait) || 0, r) : l, T = "trailing" in t ? !!t.trailing : T);
  function x(e) {
    var a = u, m = c;
  ...
  function I() {
    ...
    if (u = arguments, c = this, f = e, a) {
      ...
      if (o) return clearTimeout(i), i = setTimeout(g, r), x(f);
    }
