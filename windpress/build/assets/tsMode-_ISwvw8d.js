import { t as L, m as O, __tla as __tla_0 } from "./monaco-editor-Dg0eLWcY.js";
...
let m, X, z, W, $, Q, y, q, Z, p, V, J, U, G, Y, B, j, H, C, Oe, Ie, Le, Pe;
let __tla = Promise.all([
  ...
  var I = Object.defineProperty, N = Object.getOwnPropertyDescriptor, M = Object.getOwnPropertyNames, R = Object.prototype.hasOwnProperty, K = (e, t, i, o) => {
    if (t && typeof t == "object" || typeof t == "function") for (let n of M(t)) !R.call(e, n) && n !== i && I(e, n, {
      get: () => t[n],
  ...
  r = {};
  r["lib.d.ts"] = true;
  r["lib.decorators.d.ts"] = true;
  r["lib.decorators.legacy.d.ts"] = true;
  r["lib.dom.asynciterable.d.ts"] = true;
  r["lib.dom.d.ts"] = true;
  r["lib.dom.iterable.d.ts"] = true;
  r["lib.es2015.collection.d.ts"] = true;
  r["lib.es2015.core.d.ts"] = true;
  r["lib.es2015.d.ts"] = true;
  r["lib.es2015.generator.d.ts"] = true;
  r["lib.es2015.iterable.d.ts"] = true;
  r["lib.es2015.promise.d.ts"] = true;
  r["lib.es2015.proxy.d.ts"] = true;
  r["lib.es2015.reflect.d.ts"] = true;
  r["lib.es2015.symbol.d.ts"] = true;
  r["lib.es2015.symbol.wellknown.d.ts"] = true;
  r["lib.es2016.array.include.d.ts"] = true;
  r["lib.es2016.d.ts"] = true;
  r["lib.es2016.full.d.ts"] = true;
  r["lib.es2016.intl.d.ts"] = true;
  r["lib.es2017.d.ts"] = true;
  r["lib.es2017.date.d.ts"] = true;
  r["lib.es2017.full.d.ts"] = true;
  r["lib.es2017.intl.d.ts"] = true;
  r["lib.es2017.object.d.ts"] = true;
  r["lib.es2017.sharedmemory.d.ts"] = true;
  r["lib.es2017.string.d.ts"] = true;
  r["lib.es2017.typedarrays.d.ts"] = true;
  r["lib.es2018.asyncgenerator.d.ts"] = true;
  r["lib.es2018.asynciterable.d.ts"] = true;
  r["lib.es2018.d.ts"] = true;
  r["lib.es2018.full.d.ts"] = true;
  r["lib.es2018.intl.d.ts"] = true;
  r["lib.es2018.promise.d.ts"] = true;
  r["lib.es2018.regexp.d.ts"] = true;
  r["lib.es2019.array.d.ts"] = true;
  r["lib.es2019.d.ts"] = true;
  r["lib.es2019.full.d.ts"] = true;
  r["lib.es2019.intl.d.ts"] = true;
  r["lib.es2019.object.d.ts"] = true;
  r["lib.es2019.string.d.ts"] = true;
  r["lib.es2019.symbol.d.ts"] = true;
  r["lib.es2020.bigint.d.ts"] = true;
  r["lib.es2020.d.ts"] = true;
  r["lib.es2020.date.d.ts"] = true;
  r["lib.es2020.full.d.ts"] = true;
  r["lib.es2020.intl.d.ts"] = true;
  r["lib.es2020.number.d.ts"] = true;
  r["lib.es2020.promise.d.ts"] = true;
  r["lib.es2020.sharedmemory.d.ts"] = true;
  r["lib.es2020.string.d.ts"] = true;
  r["lib.es2020.symbol.wellknown.d.ts"] = true;
  r["lib.es2021.d.ts"] = true;
  r["lib.es2021.full.d.ts"] = true;
  r["lib.es2021.intl.d.ts"] = true;
  r["lib.es2021.promise.d.ts"] = true;
  r["lib.es2021.string.d.ts"] = true;
  r["lib.es2021.weakref.d.ts"] = true;
  r["lib.es2022.array.d.ts"] = true;
  r["lib.es2022.d.ts"] = true;
  r["lib.es2022.error.d.ts"] = true;
  r["lib.es2022.full.d.ts"] = true;
  r["lib.es2022.intl.d.ts"] = true;
  r["lib.es2022.object.d.ts"] = true;
  r["lib.es2022.regexp.d.ts"] = true;
  r["lib.es2022.sharedmemory.d.ts"] = true;
  r["lib.es2022.string.d.ts"] = true;
  r["lib.es2023.array.d.ts"] = true;
  r["lib.es2023.collection.d.ts"] = true;
  r["lib.es2023.d.ts"] = true;
  r["lib.es2023.full.d.ts"] = true;
  r["lib.es5.d.ts"] = true;
  r["lib.es6.d.ts"] = true;
  r["lib.esnext.collection.d.ts"] = true;
  r["lib.esnext.d.ts"] = true;
  r["lib.esnext.decorators.d.ts"] = true;
  r["lib.esnext.disposable.d.ts"] = true;
  r["lib.esnext.full.d.ts"] = true;
  r["lib.esnext.intl.d.ts"] = true;
  r["lib.esnext.object.d.ts"] = true;
  r["lib.esnext.promise.d.ts"] = true;
  r["lib.scripthost.d.ts"] = true;
  r["lib.webworker.asynciterable.d.ts"] = true;
  r["lib.webworker.d.ts"] = true;
  r["lib.webworker.importscripts.d.ts"] = true;
  r["lib.webworker.iterable.d.ts"] = true;
  C = function(e, t, i = 0) {
    ...
    if (o += e.messageText, i++, e.next) for (const n of e.next) o += C(n, t, i);
    return o;
  };
  function _(e) {
  ...
  V = class {
    ...
    isLibFile(e) {
      return e && e.path.indexOf("/lib.") === 0 ? !!r[e.path.slice(1)] : false;
    }
    getOrCreateModel(e) {
      const t = a.Uri.parse(e), i = a.editor.getModel(t);
      if (i) return i;
      if (this.isLibFile(t) && this._hasFetchedLibFiles) return a.editor.createModel(this._libFiles[t.path.slice(1)], "typescript", t);
  ...
  W = class extends m {
    constructor(e, t, i, o) {
      ...
      this._disposables.push(a.editor.onDidCreateModel((s) => n(s))), this._disposables.push(a.editor.onWillDisposeModel(c)), this._disposables.push(a.editor.onDidChangeModelLanguage((s) => {
        c(s.model), n(s.model);
    ...
    async _doValidate(e) {
      ...
      const s = u.reduce((g, d) => d.concat(g), []).filter((g) => (this._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(g.code) === -1), l = s.map((g) => g.relatedInformation || []).reduce((g, d) => d.concat(g), []).map((g) => g.file ? a.Uri.parse(g.file.fileName) : null);
      await this._libFiles.fetchLibFilesIfNecessary(l), !e.isDisposed() && a.editor.setModelMarkers(e, this._selector, s.map((g) => this._convertDiagnostics(e, g)));
    }
    _convertDiagnostics(e, t) {
      const i = t.start || 0, o = t.length || 1, { lineNumber: n, column: c } = e.getPositionAt(i), { lineNumber: u, column: s } = e.getPositionAt(i + o), l = [];
...
`),
    ...
    _convertRelatedInformation(e, t) {
      ...
      return t.forEach((o) => {
        let n = e;
        if (o.file && (n = this._libFiles.getOrCreateModel(o.file.fileName)), !n) return;
        const c = o.start || 0, u = o.length || 1, { lineNumber: s, column: l } = n.getPositionAt(c), { lineNumber: g, column: d } = n.getPositionAt(c + u);
        i.push({
          resource: n.uri,
          startLineNumber: s,
          startColumn: l,
...
`)
  ...
  j = class x extends m {
    ...
    async provideCompletionItems(t, i, o, n) {
      const c = t.getWordUntilPosition(i), u = new a.Range(i.lineNumber, c.startColumn, i.lineNumber, c.endColumn), s = t.uri, l = t.getOffsetAt(i), g = await this._worker(s);
    ...
    async resolveCompletionItem(t, i) {
      const o = t, n = o.uri, c = o.position, u = o.offset, l = await (await this._worker(n)).getCompletionEntryDetails(n.toString(), u, o.label);
      return l ? {
        uri: n,
        position: c,
        label: l.name,
    ...
    static createDocumentationString(t) {
      ...
      if (t.tags) for (const o of t.tags) i += `
...
` + l : "")
  ...
  $ = class extends m {
    async provideDocumentHighlights(e, t, i) {
      ...
      if (!(!u || e.isDisposed())) return u.flatMap((s) => s.highlightSpans.map((l) => ({
  ...
  z = class extends m {
    ...
    async provideDefinition(e, t, i) {
      ...
      if (!u || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(u.map((l) => a.Uri.parse(l.fileName))), e.isDisposed())) return;
      const s = [];
      for (let l of u) {
  ...
  G = class extends m {
    ...
    async provideReferences(e, t, i, o) {
      ...
      if (!s || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(s.map((g) => a.Uri.parse(g.fileName))), e.isDisposed())) return;
      const l = [];
      for (let g of s) {
    ...
    async provideDocumentSymbols(e, t) {
      ...
      const c = (s, l) => {
        ...
        return {
          ...
          tags: [],
          children: (_a2 = s.childItems) == null ? void 0 : _a2.map((d) => c(d, s.text)),
          containerName: l
        };
      };
...
`,
  ...
  Q = class extends y {
    ...
    async provideDocumentRangeFormattingEdits(e, t, i, o) {
      ...
      if (e.isDisposed()) return;
      const l = await s.getFormattingEditsForRange(n.toString(), c, u, y._convertOptions(i));
      if (!(!l || e.isDisposed())) return l.map((g) => this._convertTextChanges(e, g));
    }
  };
  q = class extends y {
...
`
    ...
    async provideOnTypeFormattingEdits(e, t, i, o, n) {
      ...
      if (e.isDisposed()) return;
      const l = await s.getFormattingEditsAfterKeystroke(c.toString(), u, i, y._convertOptions(o));
      if (!(!l || e.isDisposed())) return l.map((g) => this._convertTextChanges(e, g));
    }
  };
  X = class extends y {
    ...
    _tsCodeFixActionToMonacoCodeAction(e, t, i) {
      const o = [];
      for (const c of i.changes) for (const u of c.textChanges) o.push({
        resource: e.uri,
        versionId: void 0,
        textEdit: {
  ...
  Y = class extends m {
    ...
    async provideRenameEdits(e, t, i, o) {
      ...
      if (l.canRename === false) return {
        edits: [],
        rejectReason: l.localizedErrorMessage
      };
      if (l.fileToRename !== void 0) throw new Error("Renaming files is not supported.");
      const g = await s.findRenameLocations(c, u, false, false, false);
...
export {
  ...
  Oe as getJavaScriptWorker,
  Ie as getTypeScriptWorker,
  Le as setupJavaScript,
  Pe as setupTypeScript
};
