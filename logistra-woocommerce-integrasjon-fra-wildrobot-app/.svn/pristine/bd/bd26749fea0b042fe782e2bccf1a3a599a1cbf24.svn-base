...
class Wildrobot_Logistra
{
	...
	private function load_dependencies()
	{
		...
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-wildrobot-logistra-api.php';
	...
	private function define_admin_hooks()
	{
		...
		$api = new Wildrobot_Logistra_Api($this->get_plugin_name(), $this->get_version());
		...
		$this->loader->add_filter('woocommerce_admin_order_actions', $admin, 'order_actions', 10, 2);
		...
		$this->loader->add_filter('handle_bulk_actions-woocommerce_page_wc-orders', $order_utils, "bulk_send_order", 10, 3);
		$this->loader->add_filter('handle_bulk_actions-edit-shop_order', $order_utils, "bulk_print_freight_labels", 10, 3);
		$this->loader->add_filter('handle_bulk_actions-woocommerce_page_wc-orders', $order_utils, "bulk_print_freight_labels", 10, 3);
		$this->loader->add_filter('handle_bulk_actions-edit-shop_order', $picklist, "bulk_picklist_order", 10, 3);
		$this->loader->add_filter('handle_bulk_actions-woocommerce_page_wc-orders', $picklist, "bulk_picklist_order", 10, 3);
		...
		$this->loader->add_action('admin_notices', $order_utils, "display_freight_labels_notices");
		...
		$this->loader->add_action('rest_api_init', $api, 'wildrobot_api_create_consignment_register');
	}
	...
	private function define_public_hooks()
	{
		...
		$this->loader->add_action('woocommerce_checkout_process', $plugin_public, 'stop_checkout_if_service_partner_not_set', 10, 1);
