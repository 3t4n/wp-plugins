=== Freight Integration for Woocommerce to Profrakt and Logistra by WildRobot  ===
...
Freight Integration for Woocommerce to Profrakt and Logistra by WildRobot. Automatic freight administration and print shipping labels from Woocommerce. Requires API key from Logistra or Profrakt that you can get here: https://logistra.no/

[DOCUMENTATION](https://support.wildrobot.no/no/)
