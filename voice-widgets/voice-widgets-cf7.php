...
class QC_VOICEWIDGET_CF7_Voice_Message{
    ...
    public function __construct(){
        ...
        add_filter('wpcf7_special_mail_tags', [$this, 'qcwpvoicemessage_wpcf7_tag_tournament' ], 10, 3);

    }

    public function QC_qcwpvoicemessage_send_mail_function( $posted_data ) {
    ...
    public function QC_qcwpvoicemessage_form_tag_handler( $tag ) {
        ...
        if( isset($form_id) && $form_id > 0 ){
            ...
            return do_shortcode('[qcwpvoicemessage  id="'.$form_id.'"][/qcwpvoicemessage]');
    ...
    public function qcwpvoicemessage_wpcf7_tag_tournament($output, $name, $html){
        ...
        $voice_cf7_enable_audio_webhooks = get_option( 'voice_cf7_enable_audio_webhooks' ) ? get_option( 'voice_cf7_enable_audio_webhooks' ) : '';

        if ( ( 'qcwpvoicemessage' == $name ) && ( isset( $voice_cf7_enable_audio_webhooks ) && $voice_cf7_enable_audio_webhooks == 1 ) ) {
            return $submission->get_posted_data("qcwpvoicemessage");
        }
