...
class Feed{
    ...
    public  function doProccess(){
        ...
        foreach($xml as $x){
            ...
            $feed_title = '';
            if(!empty($x['title'])){
                $feed_title =\wp_kses_post($x['title']);
            }
   
            if(!empty($this->feed['feed_before_title'])){
                $feed_title = \wp_kses_post($this->feed['feed_before_title']).' '.$feed_title;
            }
