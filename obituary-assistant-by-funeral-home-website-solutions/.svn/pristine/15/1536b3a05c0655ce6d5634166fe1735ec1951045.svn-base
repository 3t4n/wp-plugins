...
* Fixed some language and functionality related to share by text, directions by text, share by email, directions by email
* Fixed bug related to theme font color
* Fixed bug related to popup box buttons and styling on very small screens
* Updated placement of More / Previous obituaries buttons / links
* Fixed wording on tree planting
* Reordered tributes and condolences
* Take off css rule making flower images blend in with background
* Don't show unnecessary fields on tree checkout page (depends on certificate choice)
* Change some wording on tree checkout page
* Fix padding issues on tree paragraphs
