...
<div class="fhw-solutions-obituaries_all-obituary-listings bootstrap-fhws-obituaries-container p-2">
  ...
  <?php
    ...
    if ($jsonString['CLIENT_INFO']['OBITUARY_ARCHIVE'] != ""){
      echo '<div id="id="fhws-obituary-archive" class="row text-center text-decoration-none mt-5"><a class="fs-5 text-decoration-none" href="' . $jsonString['CLIENT_INFO']['OBITUARY_ARCHIVE'] . '">Obituary Archive</a></div>';
    }
    ?>
