...
<?php function fws_create_input($size, $type, $label, $comment, $section, $delivery_dates, $value, $nameOverride){ ?>
  ...
  <div class="<?php echo $size;?>">
    ...
    <?php
      ...
      if (isset($nameOverride)){
        $field_name = $nameOverride;
      }

      switch ($section) {
        case "Delivery Date":
          $id_suffix = "-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Loved One":
          $id_suffix = "-tree-certificate-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Sender Display":
          $id_suffix = "-tree-certificate-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        ...
        case "Deliver Info Tree":
          $id_suffix = "-tree-certificate-email-behalf-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Delivery Info":
          $id_suffix = "-special-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Deliver To":
           $id_suffix = "-recipient-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Bill To":
          $id_suffix = "-customer-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Payment":
          $id_suffix = "-payment-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
        case "Product":
          $id_suffix = "-product-" . strtolower(preg_replace('/[\*]+/', '', preg_replace("/[\s_]/", "-", $field_name)));
          break;
      }
  ...
  <?php if($products_for_display != "" || $products_for_display != null  ) { ?>
      ...
      <form class="checkout-form">
           ...
           <div class="row mb-5 g-4">
             <?php
                //fws_create_row("Name of Loved One*","The name of your loved one that has passsed. This name will be used in the tree certificate.");
                 fws_create_input("col-12", "input", "Name of Loved One*", "The name of your loved one that has passsed. This name will be used in the tree certificate.", "Loved One", null, null, null);
                 fws_create_input("col-12", "input", "Sender Display Name*", "Who the trees are 'from'. This will be used in the tree certificate.", "Sender Display", null, null, null);
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 ps-sm-5">
                  <ul class="mt-2 fw-light lh-sm ms-0">
                    <li>Choosing this option means that we will email the certificate to the family of the deceased.</li>
            ...
            <div class="row mb-5 ps-3 ps-sm-5 g-4 pb-3 email-certificate-fields" style="display: <?php echo ($_SESSION['florist-one-flower-delivery-tree-certificate'] == 'Cert-email-behalf') ? 'block' : 'none'; ?>;">

              <?php
              fws_create_input("col-12", "input", "Recipient Name*", null , "Deliver Info Tree", null, null, null);
              fws_create_input("col-12", "input", "Recipient Email*", "The name and email of the person or family receiving the tree gift and certificate.", "Deliver Info Tree", null, null, null);
              fws_create_input("col-12", "textarea", "Message to Recipient", "Optional: (500 characters max)", "Deliver Info Tree", null, null, null);
              ?>
         ...
         <?php } else { ?>
          ...
          <div class="row mb-5 g-4">
            ...
            <?php
              ...
              fws_create_input("col-12", "select", "Delivery Date", null, "Delivery Date", $delivery_dates, null, null);
              fws_create_input("col-12", "textarea", "Card Message", "(200 characters max) Please remember to include who the flowers are from in your message.", "Delivery Info", null, null, null);
              if($obituary == 1){ echo $purchaseRecognition; }
              fws_create_input("col-12", "textarea", "Special Instructions", "Optional: (100 characters max)" , "Delivery Info", null, null, null);
          ...
          <div class="row mb-5 g-4 ">
            ...
            <?php
              fws_create_input("col-12", "input", "Name*", null, "Deliver To", null, null, null);
              fws_create_input("col-12", "input", "Institution", null, "Deliver To", null, null, null);
              fws_create_input("col-12", "input", "Address 1*", null, "Deliver To", null, null, null);
              fws_create_input("col-12", "input", "Address 2", null, "Deliver To", null, null, null);
              fws_create_input("col-12", "input", "City*", null, "Deliver To", null, null, null);
              fws_create_input("col-sm-6", "select", "Country*", null, "Deliver To", null, null, null);
              fws_create_input("col-sm-6", "select", "State*", null, "Deliver To", null, null, null);
              fws_create_input("col-sm-6", "input", "Postal Code*", null, "Deliver To", null, null, null);
              fws_create_input("col-sm-6", "input", "Phone*", null, "Deliver To", null, null, null);
            ?>
        ...
        <p class="mb-1 fw-bolder fs-5">Bill To</p>
          ...
          <?php
            fws_create_input("col-12", "input", "Your Name*", null, "Bill To", null, null, "Name");
            fws_create_input("col-12", "input", "Your Email*", ($products_for_display[0]['CODE'] == "TREES" ? "We will email you a copy of the certificate." : ""), "Bill To", null, null, "Email");
            fws_create_input("col-12", "input", "Address 1*", null, "Bill To", null, null, null);
            fws_create_input("col-12", "input", "Address 2", null, "Bill To", null, null, null);
            fws_create_input("col-12", "input", "City*", null, "Bill To", null, null, null);
            fws_create_input("col-sm-6", "select", "Country*", null, "Bill To", null, null, null);
            fws_create_input("col-sm-6 country-trigger", "select", "State*", null, "Bill To", null, null, null);
            fws_create_input("col-sm-6 country-trigger", "input", "Postal Code*", null, "Bill To", null, null, null);
            fws_create_input("col-sm-6", "input", "Your Mobile Number*", null, "Bill To", null, null, "Phone");
          ?>
        ...
        <?php
          ...
          if (isSecure() && !$internationalTree) {
            ...
            fws_create_input("col-sm-6", "input", "Credit Card Number", null, "Payment", null, null, null);
            fws_create_input("col-sm-6", "input", "Security Code", null, "Payment", null, null, null);
            fws_create_input("col-sm-6", "select", "Expiration Month", null, "Payment", null, null, null);
            fws_create_input("col-sm-6", "select", "Expiration Year", null, "Payment", null, null, null);

            fws_create_input("col-12", "hidden", "Username", null, "Payment", null, $credentials["USERNAME"], null);
            fws_create_input("col-12", "hidden", "Client Key", null, "Payment", null, $credentials["AUTHORIZENET_KEY"], null);

            fws_create_input("col-12", "hidden", "Token", null, "Payment", null, null, null);
      ...
      <?php
        ...
        if ($products_for_display[0]['CODE'] != "TREES"){
          ...
          fws_create_input("col-12", "hidden", "Product Type", null, "Product", null, 'FLOWERS', null);
        }
        else {
          fws_create_input("col-12", "hidden", "Product Type", null, "Product", null, 'TREES', null);
        }
