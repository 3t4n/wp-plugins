...
<form name="thp_ysxfw_main_settings_form" method="post" action="">
				...
				<details>
					...
					<p style="margin: 30px 20px;">
						...
						<a href="https://pluginbrew.com/product/woocommerce-you-save-plugin-for-wordpress-pro/" target="_blank" rel="noopener" style="font-weight: bold;"><?php _e( "Upgrade to PRO now!", 'you-save-x-for-woocommerce' ); ?></a>
					</p>
