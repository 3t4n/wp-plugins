 ...
 * Plugin URI: https://pluginbrew.com/product/woocommerce-you-save-plugin-for-wordpress-pro/
 ...
 * Version: 1.0.2
 * Author: Pluginbrew
 * Author URI: https://pluginbrew.com/
...
function thp_ysxfw_version_check() {
	...
	if ( thp_ysxfw_yspro_active() ) {
		...
		if ( version_compare($yspro_user_v, $yspro_latest_v, '<') ) {
			$url = 'https://pluginbrew.com/my-account/';
