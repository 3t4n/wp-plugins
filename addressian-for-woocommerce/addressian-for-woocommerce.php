...
function addressian_custom_override_checkout_fields($fields) {
   ...
   if ($strategy == 1) {
      ...
      $fields['shipping']['find_shipping_address'] = array('label' => __('Address Finder', 'woocommerce'), 'placeholder' => _x('Type an address in here', 'placeholder', 'woocommerce'), 'required' => false, 'class' => array('form-row-wide'), 'clear' => true, 'priority' => 40, 'label_class' => array('fndadresssh'));
   } else if ($strategy == 2) {
      ...
      $fields['shipping']['find_shipping_address'] = array('label' => __('Postcode Finder', 'woocommerce'), 'placeholder' => _x('Type a postcode', 'placeholder', 'woocommerce'), 'required' => false, 'class' => array('form-row-wide'), 'clear' => true, 'priority' => 40, 'label_class' => array('fndpostcodesh'));
   }
   return $fields;
}
      ...
      ?>
       <script>
           jQuery(document).ready(function ($) {
               ...
               //$('#find_shipping_address_field').hide();
   ...
   ?>
    <script>
        jQuery(document).ready(function ($) {
            ...
            $("#find_address, #find_address_postcode, #find_shipping_address").val("");
            ...
            $("#shipping_country").on("change", function (event) {
                ...
                if (selected_country != 'GB') {
                    jQuery('#find_shipping_address_field').addClass("add_hide");
                    jQuery('#find_shipping_address_field').removeClass("add_show");
                    $('#find_shipping_address_field').hide();
                    $('#find_shipping_address_field').hide();
                    ...
                    jQuery('#find_shipping_address_field').removeClass("add_hide");
                    jQuery('#find_shipping_address_field').addClass("add_show");
                    $('#find_shipping_address_field').show();
                    jQuery('#find_shipping_address_field label, #find_shipping_address_field input').fadeIn("slow");
            ...
            $('#find_shipping_address, #find_address_postcode, #find_address').attr('name', r_name);
        });
    </script>
   <?php
}
