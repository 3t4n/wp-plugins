...
function hide_find_shipping_address(action) {
    if (action === 'show') {
        jQuery('#find_shipping_address_field label, #find_shipping_address_field input').fadeIn('slow', function () {
            hide_shipping_address_fields("hide", "");
        })
    } else if (action === 'hide') {
        jQuery('#find_shipping_address_field label, #find_shipping_address_field input').fadeOut('slow', function () {
...
function hide_find_shipping_address(action) {
    if (action === 'show') {
        jQuery('#find_shipping_address_field label, #find_shipping_address_field input, #find_shipping_address_field select, .findaddr_shipping').fadeIn('slow', function () {
            hide_shipping_address_fields("hide", "");
        })
    } else if (action === 'hide') {
        jQuery('#find_shipping_address_field label, #find_shipping_address_field input, #find_shipping_address_field select, .findaddr_shipping').fadeOut('slow', function () {
            hide_shipping_address_fields("show", "");
        })
    }
}
