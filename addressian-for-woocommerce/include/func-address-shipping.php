...
<script>
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#find_shipping_address").attr("autocomplete", "new-password");
        $('<span  class="descriptions_shipping" style=""><a href="#"  class="manually_address_shipping">Enter address manually</a></span>').insertAfter("#find_shipping_address");
        ...
        var myMap2 = new Map();
        $("#find_shipping_address").addClass('js-typeahead');
        $("#find_shipping_address").wrap('<div class="typeahead__container">');
        $("#find_shipping_address").wrap('<div class="typeahead__field">');
        $("#find_shipping_address").wrap('<div class="typeahead__query">');
        $(".typeahead__field").append('<div class="typeahead__button"><button type="submit"><span class="typeahead__search-icon"></span></button></div>');
        $("#find_shipping_address").typeahead({
            input: '#find_shipping_address',
            order: "desc",
            delay: 400,
            dynamic: true,
            source: {
