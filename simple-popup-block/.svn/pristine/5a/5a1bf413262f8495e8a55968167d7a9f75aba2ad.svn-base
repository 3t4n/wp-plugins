...
Tags:              popup, block, simple-popup, modal
Tested up to:      6.6
Stable tag:        1.2.3
...
**Useful Links**
👉 [Live Demo Test](https://tastewp.com/new/?pre-installed-plugin-slug=simple-popup-block)
...
6. Popup Conditions
7. Popup Dimension
8. Close Button Options

== Changelog ==

= 1.2.3 2024-22-12 =
* Fix: Stop video playback when closing the popup

= 1.2.2 2024-09-23 =
* Enhancement: Added classes `simple-popup--closed` and `simple-popup--opened` based on the popup modal open/close status
