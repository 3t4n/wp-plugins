...
Contributors: htplugins, tarekht, zenaulislam, aslamhasib
Tags: News, WordPress News, Magazine, blog, Elementor
...
== Description ==
WP News is a WordPress News / Magazine Plugin. You can create any news site easily. 
This plugin includes Elementor Addon, WordPress Widget, Custom styles options with different customization option, News Slider, News Grid, News Tab.

You can see the plugin demo here : [Demo](http://demo.wphash.com/1/wpnews/)

Download Our Free Theme Compatible with WP News Plugin : [Download](https://freethemescloud.com/item/wp-news-free-wordpress-news-magazine-theme/)
...
= Version: 1.2.1 - Date: 2024-11-27 =
* Updated: Twitter latest icon

= Version: 1.2.0 - Date: 2023-02-09 =
* Added: Nonce verification for recommended plugins
* Improved: Coding standards in some areas

= Version: 1.1.9 - Date: 2022-11-05 =
* Compatible With WordPress Latest Version

= Version: 1.1.8 - Date: 2022-09-26 =
* Added: Recommendation Menu
* Compatible With WordPress Latest Version

= Version: 1.1.7 - Date: 2022-07-05 =
* Sub menu issue solved
* Minor issue solved

= Version: 1.1.6 - Date: 2022-06-13 =
* Minor Issue Solved

= Version: 1.1.5 - Date: 2022-06-07 =
* Compatible With Elementor Latest Version
* Compatible With WordPress Latest Version
* Minor Issue Solved

= Version: 1.1.4 - Date: 2022-04-10 =
* Compatible with Elementor latest version

= Version: 1.1.3 - Date: 2022-02-07 =
* Compatible with Elementor latest version

= Version: 1.1.2 - Date: 2021-09-15 =
* Fixed Some minor issues for several add-ons.
* Added image size.
* Compatible with Elementor latest version.

= Version: 1.1.1 - Date: 2021-09-01 =
* Compatible with Elementor latest version

= Version: 1.0.9 - Date: 2021-04-25 =
* Compatible with WordPress latest version
...
* Instagram feed issue solved.
* Capability with the latest WordPress.

= Version: 1.0.5 - Date: 2020-11-29 =
* Instagram feed issue solved.
* Capability with the latest WordPress.
...
2. Search For "WP News Magazine".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `wp-news-magazine` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. Go to the WP News Settings Options.
2. Add the Google Map Api (If Google map is required).


== Screenshots ==
1. Elementor Addons widgets
2. WordPress widgets
3. Elementor Style Option
4. News Tab
5. News Grid Style
6. News Slider
