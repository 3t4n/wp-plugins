...
17. Tested with PHP 8.2 and WordPress 6.6
18. Adblock popup can be disabled on posts by category and tag.
	
	
== Changelog ==

= 1.2.5 2024/08/26 =
* Disable adblock popup on post by category and tag

= 1.2.4 2024/07/17 =
* Tested with PHP 8.2 and WordPress 6.6
...
= 1.2.5 =
Upgrade for new feature - disable adblock popup on post by category and tag

= 1.2.4 =
Upgrade for PHP 8.2 and Wordpress 6.6
