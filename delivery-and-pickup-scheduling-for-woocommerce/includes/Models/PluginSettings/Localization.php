...
class Localization extends BaseModel {
	 ...
	 * @since 1.4.3
	 */
	public static function getNoTimeSlotsAvailableText(): string {
		return self::get_setting( 'localization__checkout_no_available_time_slots_text', esc_html__( 'No available time slots', 'delivery-and-pickup-scheduling-for-woocommerce' ) );
	}
	 ...
	 * @since 1.4.3
	 */
	public static function getPleaseChooseAnOptionText(): string {
		return self::get_setting( 'localization__checkout_please_choose_an_option_text', esc_html__( 'Please choose an option', 'delivery-and-pickup-scheduling-for-woocommerce' ) );
	}
