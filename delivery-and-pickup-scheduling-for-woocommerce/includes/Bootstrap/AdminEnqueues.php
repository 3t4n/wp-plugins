...
use Lpac_DPS\Controllers\Admin\OrderEditPageController;
...
class AdminEnqueues {
	...
	private function add_inline_scripts(): void {
		$controller_admin_order_edit_page = new OrderEditPageController();
		$data                             = $controller_admin_order_edit_page->get_js_globals();
		if ( empty( $data ) ) {
			return;
		}
