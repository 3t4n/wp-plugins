...
use Lpac_DPS\Controllers\Email\OrderEmailsController;
...
class Main {
    ...
    private function define_admin_hooks() {
        ...
        $notice = new Notice();
        $email_reminders_controller = new EmailRemindersController();
    ...
    private function define_public_hooks() {
         ...
         */
        $this->loader->add_action( 'woocommerce_checkout_update_order_meta', $controller_checkout_order_data, 'saveChwaziOrderMetaData' );
        /*
    ...
    public function output_root_submenu_upsells() {
		...
		<a href='https://printus.cloud/?utm_source=wpadmin&utm_medium=sl-plugins-page&utm_campaign=plugins-upsell' target='_blank'><img alt='Printus plugin banner' src='<?php 
		...
		<div style='margin-bottom: 40px'>
		<a href='https://lpacwp.com/?utm_source=wpadmin&utm_medium=sl-plugins-page&utm_campaign=plugins-upsell' target='_blank'><img alt='Kikote plugin banner' src='<?php 
		...
		<div style='margin-bottom: 40px'>
		<a href='https://chwazidatetime.com/?utm_source=wpadmin&utm_medium=sl-plugins-page&utm_campaign=plugins-upsell' target='_blank'><img alt='Chwazi plugin banner' src='<?php 
        echo esc_attr( LPAC_DPS_PLUGIN_ASSETS_PATH_URL . 'admin/img/delivery-and-pickup-scheduling.png' );
        ?>' /></a>
		<p style='font-size: 18px; font-weight: 700;'><?php 
        esc_html_e( 'Allow customers to set their delivery/pickup date and time during order checkout.', 'delivery-and-pickup-scheduling-for-woocommerce' );
        ?></p>
