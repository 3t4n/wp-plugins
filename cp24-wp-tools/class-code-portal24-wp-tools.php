 ...
 * Plugin URI: https://code-portal24.com/cp24-wp-tools
 * Description: Build custom headers and footers, manage emails and memberships effortlessly—more powerful features coming soon!
 * Version: 1.3.0
 * Requires at least: 5.6
 * Requires PHP: 7.1
 * Author: Hadi Mohammade
 * Author URI: https://code-portal24.com/cp24-wp-tools
 * License: GPL2
 * Text Domain: cp24
 */
...
if ( ! class_exists( 'Code_Portal24_WP_Tools' ) ) {
	...
	class Code_Portal24_WP_Tools {
		...
		private function define_constants() {
			...
			define( 'CP24_WP_TOOLS_URL', plugin_dir_url( __FILE__ ) );
			define( 'CP24_MULTI_SMTP_ASSETS_PATH', CP24_MULTI_SMTP_PATH . 'dist/' );
			define( 'CP24_MULTI_SMTP_ASSETS_URL', CP24_WP_TOOLS_URL . 'dist/' );
			define(
		...
		public function render_plugin_dashboard_page() {
			$menu_items = apply_filters( Settings::DASHBOARD_MENU_ITEMS, [] );

			?>
			<script>
				window.cp24_menu_items = <?php echo wp_json_encode( $menu_items ); ?>
			</script>
			<div id="cp24-main-dashboard"></div>
