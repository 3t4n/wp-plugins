...
Plugin require **[Page Builder by AZEXO](https://wordpress.org/plugins/page-builder-by-azexo/)**.
...
= Elements types =
 ...
 - counter
 - feature
 - form (only in **[PRO version](https://codecanyon.net/item/elastik-page-builder/22431626)**)
 - gallery
 - google-map
 - list
 - logos
