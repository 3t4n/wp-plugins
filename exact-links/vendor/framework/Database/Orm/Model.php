...
namespace ExactLinks\Framework\Database\Orm;
...
use ExactLinks\Framework\Support\Str;
use ExactLinks\Framework\Foundation\App;
use ExactLinks\Framework\Support\UrlRoutable;
use ExactLinks\Framework\Database\Orm\DateTime;
use ExactLinks\Framework\Foundation\Dispatcher;
use ExactLinks\Framework\Support\QueueableEntity;
use ExactLinks\Framework\Support\JsonableInterface;
use ExactLinks\Framework\Support\ArrayableInterface;
use ExactLinks\Framework\Database\Orm\Relations\Pivot;
use ExactLinks\Framework\Database\Orm\Relations\HasOne;
use ExactLinks\Framework\Database\Orm\ModelHelperTrait;
use ExactLinks\Framework\Database\Orm\Relations\MorphTo;
use ExactLinks\Framework\Database\Orm\Relations\HasMany;
use ExactLinks\Framework\Database\Orm\Relations\MorphOne;
use ExactLinks\Framework\Database\Orm\Relations\MorphMany;
use ExactLinks\Framework\Database\Orm\Relations\Relation;
use ExactLinks\Framework\Database\Orm\Relations\BelongsTo;
use ExactLinks\Framework\Database\Orm\Relations\MorphToMany;
use ExactLinks\Framework\Support\Collection as BaseCollection;
use ExactLinks\Framework\Database\Orm\Relations\BelongsToMany;
use ExactLinks\Framework\Database\Orm\Relations\HasManyThrough;
use ExactLinks\Framework\Database\Query\Builder as QueryBuilder;
use ExactLinks\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \WPFluent\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @var \WPFluent\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \WPFluent\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \WPFluent\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \WPFluent\Database\Eloquent\Scope|string  $scope
     * @return \WPFluent\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \WPFluent\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \WPFluent\Database\Eloquent\Collection
     */
     ...
     *
     * @return \WPFluent\Database\Eloquent\Builder
     */
     ...
     *
     * @return \WPFluent\Database\Query\Builder
     */
     ...
     * @return \WPFluent\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \WPFluent\Database\Eloquent\Builder|static
     */
     ...
     * @return \WPFluent\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \WPFluent\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \WPFluent\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \WPFluent\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \WPFluent\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \WPFluent\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \WPFluent\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \WPFluent\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \WPFluent\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \WPFluent\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \WPFluent\Database\Orm\DateTime
     */
     ...
     *
     * @param  \WPFluent\Database\Query\Builder  $query
     * @return \WPFluent\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param  \WPFluent\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \WPFluent\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'WPFluent\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \WPFluent\Database\Eloquent\Model
     */
     ...
     *
     * @return \WPFluent\Database\Connection
     */
     ...
     *
     * @return \WPFluent\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \WPFluent\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \WPFluent\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \WPFluent\Foundation\Dispatcher  $dispatcher
     * @return void
     */
