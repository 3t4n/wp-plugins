...
namespace ExactLinks\Framework\Database\Query;
...
use ExactLinks\Framework\Support\Collection;
use ExactLinks\Framework\Pagination\Paginator;
use ExactLinks\Framework\Pagination\LengthAwarePaginator;
use ExactLinks\Framework\Support\MacroableTrait;
use ExactLinks\Framework\Database\Query\Grammar;
use ExactLinks\Framework\Database\Query\Processor;
use ExactLinks\Framework\Support\ArrayableInterface;
use ExactLinks\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \WPFluent\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \WPFluent\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \WPFluent\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \WPFluent\Database\ConnectionInterface  $connection
     * @param  \WPFluent\Database\Query\Grammar  $grammar
     * @param  \WPFluent\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \WPFluent\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\WPFluent\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \WPFluent\Database\Query\Builder|static
     *
     ...
     *
     * @param  \WPFluent\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \WPFluent\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \WPFluent\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \WPFluent\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \WPFluent\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \WPFluent\Database\Query\Expression
     */
     ...
     *
     * @return \WPFluent\Database\ConnectionInterface
     */
     ...
     *
     * @return \WPFluent\Database\Query\Processor
     */
     ...
     *
     * @return \WPFluent\Database\Query\Grammar
     */
