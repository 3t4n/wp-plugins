...
class FileSystem
{
    ...
    public function _getDir()
    {
        ...
        return $uploadDir['basedir'] . EXACTLINKS_UPLOAD_DIR;
    }
    ...
    {
        $folderName = '/'.EXACTLINKS_UPLOAD_DIR;
    ...
    {
        $prefix = 'exactlinks-' . md5(uniqid(rand())) . '___';
        $prefix = apply_filters('exactlinks/uploaded_file_name_prefix', $prefix);
