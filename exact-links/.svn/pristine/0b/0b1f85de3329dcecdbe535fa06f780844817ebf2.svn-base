...
namespace ExactLinks\Framework\Database\Orm\Relations;

use ExactLinks\Framework\Support\Arr;
use ExactLinks\Framework\Support\Str;
use ExactLinks\Framework\Database\Orm\Model;
use ExactLinks\Framework\Database\Orm\Builder;
use ExactLinks\Framework\Database\Orm\Collection;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \WPFluent\Database\Orm\Builder  $query
     * @param  \WPFluent\Database\Orm\Model  $parent
     * @param  string  $table
     ...
     * @return \WPFluent\Database\Orm\Relations\BelongsToMany
     */
     ...
     * @param  int|null  $page
     * @return \WPFluent\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  array  $columns
     * @param  string  $pageName
     * @return \WPFluent\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \WPFluent\Database\Orm\Builder  $query
     * @param  \WPFluent\Database\Orm\Builder  $parent
     * @param  array|mixed  $columns
     * @return \WPFluent\Database\Orm\Builder
     */
     ...
     *
     * @param  \WPFluent\Database\Orm\Builder|null  $query
     * @return $this
     */
     ...
     *
     * @param  array   $models
     * @param  \WPFluent\Database\Orm\Collection  $results
     * @param  string  $relation
     * @return array
     */
     ...
     *
     * @return \WPFluent\Support\Collection
     */
     ...
     *
     * @param  \WPFluent\Support\Collection|array  $models
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model|\WPFluent\Database\Orm\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WPFluent\Support\Collection|\WPFluent\Database\Orm\Model
     */
     ...
     *
     * @param  \WPFluent\Database\Orm\Collection|array  $ids
     * @return array
     */
     ...
     * @param  array  $attributes
     * @param  bool   $exists
     * @return \WPFluent\Database\Orm\Relations\Pivot
     */
