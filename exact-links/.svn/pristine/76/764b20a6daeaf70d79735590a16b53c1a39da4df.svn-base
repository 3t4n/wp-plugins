...
use ExactLinks\Framework\Pagination\Paginator;
use ExactLinks\Framework\Database\Query\Expression;
use ExactLinks\Framework\Pagination\LengthAwarePaginator;
use ExactLinks\Framework\Database\Orm\Relations\Relation;
use ExactLinks\Framework\Database\Orm\ModelNotFoundException;
...
class Builder
{
     ...
     *
     * @var \WPFluent\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \WPFluent\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \WPFluent\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \WPFluent\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model|\WPFluent\Database\Orm\Collection|static[]|static|null
     */
     ...
     * @param  array  $ids
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model|\WPFluent\Database\Orm\Collection
     *
     * @throws \WPFluent\Database\Orm\ModelNotFoundException
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model
     */
     ...
     *
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Model|static
     *
     * @throws \WPFluent\Database\Orm\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \WPFluent\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \WPFluent\Database\Orm\Relations\Relation
     */
     ...
     * @param  string  $operator
     * @param  mixed   $value
     * @return \WPFluent\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \WPFluent\Database\Orm\Builder  $hasQuery
     * @param  \WPFluent\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \WPFluent\Database\Orm\Builder|static
     ...
     *
     * @param  \WPFluent\Database\Orm\Builder  $relation
     * @return \WPFluent\Database\Orm\Builder|static
     */
