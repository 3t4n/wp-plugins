...
{ 
	...
	if ($atec_active_slug!=='atec_group')
	{
		...
		atec_reg_script('atec_debug',__DIR__,'atec-debug.min.js','1.0.1'); 	
	}
});
	
if ($atec_active_slug!=='atec_group') { function atec_wpd(): void { @require(__DIR__.'/atec-wpd-dashboard.php'); } }
?>
