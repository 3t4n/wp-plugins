...
<div class="atec-btn-div">
  <div class="tablenav">
	<div class="atec-dilb">'; atec_checkbox_button_div(esc_attr($value),esc_attr($value),false,$status[$value],$url,'&nav=Updates&action='.esc_attr($value).'&set='.($status[$value]?'false':'true'),$nonce); echo '</div>
