...
namespace Dev4Press\Plugin\TopicPolls\Table;
...
class Votes extends Table {
	...
	public string $_table_class_name = 'gdpol-grid-votes';
	public string $_self_nonce_key = 'gdpol-admin-panel';
	...
	public function column_poll_id( $item ) : string {
	...
	public function column_answer_id( $item ) : string {
		$poll = $this->polls[ $item->poll_id ];
	...
	public function column_voted( $item ) : string {
