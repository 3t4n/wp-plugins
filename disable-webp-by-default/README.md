...
To help site owners manage the transition, this plugin adds a setting under Settings -> Media to either enable or disable WebP creation on upload of JPEGs.  For Multiesite, the plugin can be activated network-wide or on individual sites.
