...
class April_Helper {
  ...
  public static function validate_payment_token( $paymentToken ) {
  ...
  public static function validate_payment_source( $paymentSource ) {
  ...
  public static function validate_payment_data_string( $paymentDataString ) {
