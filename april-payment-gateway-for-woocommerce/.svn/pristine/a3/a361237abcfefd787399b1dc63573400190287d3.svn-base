...
jQuery( function( $ ) {
	...
	var lpWooComForm = {
		...
		loadAprilParams: function() {
			try {
				lpWooComForm.aprilCurrency = wc_april_params_currency;	// Change variable name to match payment method
				lpWooComForm.aprilAmount = wc_april_params_amount;	// Change variable name to match payment method
				lpWooComForm.aprilParams = wc_april_params;	// Change variable name to match payment method
			} catch(e) {
