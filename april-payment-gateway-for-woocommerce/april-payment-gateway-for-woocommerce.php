...
define( 'APRIL_TOGGLE_DEFAULT_COLOR', '#3A3CA6' );
define( 'APRIL_BNPL_AMOUNT_DEFAULT_COLOR', '#fa5402' );
...
function april_init() {
  ...
  // Include April - Apple Pay domain association
...
function april_action_links( $links ) {
  $plugin_links = array(
      '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=checkout' ) . '">' . __( 'Settings', 'april' ) . '</a>',
  );
