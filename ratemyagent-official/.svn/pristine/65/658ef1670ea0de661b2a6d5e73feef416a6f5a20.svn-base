				...
				<?php foreach ($reviews as $review) : ?>
					...
					<div class="swiper-slide ">
						<article
							...
							<?php if ($show_img) : ?>
								<?php if ($review->PropertyCoverImage !==  '' || str_contains($review->PropertyCoverImage, '/cdn/staticLocation/')): ?>
									<img src="<?php echo esc_url('https://static.ratemyagent.com.au/assets/images/placeholder/no-property-placeholder.png') ?>" class="rma-card-hero" alt="" />
								<?php else: ?>
									<img src="<?php echo esc_url($review->PropertyCoverImage) ?>" class="rma-card-hero" alt="" />
								<?php endif; ?>
							<?php endif; ?>
							...
							<div class="rma-card-content">
								...
								<p class="rma-card-details">
									...
									<strong>
										...
										(<?php _e(esc_textarea($review->ReviewerType), 'ratemyagent-official') ?>)
									</strong>
									<?php
