...
Tags: WooCommerce, Sale notification, Popup notification, Manual notification, Custom notification
...
You can see the plugin demo here : [Live Demo](https://woolentor.com/demo/sales-notification/)

== Features: ==
* Real sales notification
* Notification limit
...
= Version: 1.2.5 - Date: 2024-13-06 =
* Added: Option to enable fake notifications to be displayed in random order.

= Version: 1.2.4 - Date: 2023-26-02 =
* Added: Display option for city, state & country
* Added: Option to add custom label for purchased by & price
* Added: Nonce verification for recommended plugins
* Improved: Coding standards in some areas

= Version: 1.2.2 - Date: 2022-07-11 =
* Compatible with the WooCommerce latest version

= Version: 1.2.1 - Date: 2022-26-09 =
* Added : Recommendation Menu
* Compatible with WordPress latest version
* Compatible with WooCommerce latest version

= Version: 1.2.0 - Date: 2021-05-10 =
* Added : Notification width option.
* Added : Notification width option for mobile.
* Added : Image position for manual notification.
* Added : All product showing option for real order.
* Fixed : Notification first load time.

= Version: 1.1.0 - Date: 2021-30-09 =
* Added : Manual Notification option.
* Added : All pro option.

= Version: 1.0.5 - Date: 2021-25-07 =
* Compatible with WordPress latest version
* Compatible with WooCommerce latest version

== Installation ==
This section describes how to install the WC Sales Notification Plugins for WordPress get it working.

= 1) Install =

= Install: =
1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "WC Sales Notification".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `wc-sales-notification` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

== Screenshots ==
1. Sales Notification
2. Notification Options
3. Manual Notification data add option.
