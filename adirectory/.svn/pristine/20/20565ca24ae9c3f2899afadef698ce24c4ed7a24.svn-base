            ...
            <div class="single-field-wrapper">
                <div class="adqs-form-inner">
                    ...
                    <div class="adqs-gallery-image-restriction">
                        <p>** A maximum of five images is allowed, and their total size must be less than 3 MB</p>
                    ...
                    <?php
                    if (!$log_status) { ?>
                        <div class="adqs-guest-listing-container">
                            <h4 class="qsd-form-label">
                                Email (An email will be sent to you to reset your password ) </h4>
                            <input type="text" value="" name="guest_email" class="adqs-title-input">
                        </div>
                    <?php }
                    ?>
