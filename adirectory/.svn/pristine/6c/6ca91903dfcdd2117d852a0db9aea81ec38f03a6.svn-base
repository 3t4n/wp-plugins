...
add_action('adqs_after_new_registration', 'adqs_mail_to_user', 10, 2);
...
add_action('adqs_new_user_account', 'adqs_new_user_account', 10, 3);
add_action('adqs_expire_listing_notification', 'adqs_send_mail_user_expiry_package', 10, 3);
