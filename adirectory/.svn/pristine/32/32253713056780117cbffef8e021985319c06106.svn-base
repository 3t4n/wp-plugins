...
class Listing_By extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'multiple' => true,
				'options' => [
					'top' => esc_html__('Top Position', 'adirectory'),
					'sidebar' => esc_html__('Sidebar Position', 'adirectory'),
				],
				'default' => adqs_get_setting_option('filterLayoutPosition') === 'sidebar' ? 'sidebar' : 'top',
			]
		);
		...
		$this->add_control(
			'pagination_type',
			[
				'label' => esc_html__('Layout With Type', 'adirectory'),
				'type' => Controls_Manager::SELECT,
				'label_block' => true,
				'multiple' => true,
				'options' => [
					'' => esc_html__('Default', 'adirectory'),
		...
		$this->add_responsive_control('grid_columns', [
			'label' => esc_html__('Gird Columns', 'adirectory'),
			'type' => Controls_Manager::NUMBER,
			'min' => 1,
			'max' => 12,
			'step' => 1,
			...
			'selectors' => [
				'{{WRAPPER}} .qsd-prodcut-grid-list-main' =>
				'-ms-grid-columns: (1fr)[{{VALUE}}] !important;
             -webkit-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
             -moz-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
             -o-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
             grid-template-columns: repeat({{VALUE}}, 1fr) !important;',
			],
		]);
		$this->add_responsive_control('list_columns', [
			'label' => esc_html__('List Columns', 'adirectory'),
			'type' => Controls_Manager::NUMBER,
			'min' => 1,
			'max' => 12,
			'step' => 1,
			...
			'selectors' => [
				'{{WRAPPER}} .qsd-prodcut-grid-list-main.list-view' =>
				'-ms-grid-columns: (1fr)[{{VALUE}}] !important;
             -webkit-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
             -moz-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
             -o-grid-template-columns: repeat({{VALUE}}, 1fr) !important;
		...
		$this->add_responsive_control(
			'grid_columns_gap',
			[
				'label' => esc_html__('Grid Columns Gap', 'adirectory'),
				...
				'selectors' => [
					'{{WRAPPER}} .qsd-prodcut-grid-list-main' => 'gap: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			'list_columns_gap',
			[
				'label' => esc_html__('List Columns Gap', 'adirectory'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%', 'px', 'vw'],
				'range' => [
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} .qsd-prodcut-grid-list-main.list-view' => 'gap: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
	...
	protected function render()
	{
		...
		$filter_layout = $settings['filter_layout'] ?? 'top';
		$ajax_filter = $settings['ajax_filter'] ?? '';
