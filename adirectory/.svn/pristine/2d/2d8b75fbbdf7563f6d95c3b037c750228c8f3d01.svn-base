...
class Setting
{
	...
	public function __construct()
	{
		...
		$this->currencyList = apply_filters('adqs_currency_settings', [
			...
			["label" => esc_html__("Ghanaian Cedi ₵", "adirectory"), "value" => 'GHS__$__before'],
		...
		$this->settingsNavs = array(
			...
			array(
				"title" => esc_html__("Advance Search", "adirectory"),
				"path"  => "filters",
				"sub_setting" => array(),
			...
			array(
				"title" => esc_html__("Login / Registration", "adirectory"),
				"path" => "log_reg",
				'icon'  => "fa fa-user-plus",
				"sub_setting" => array(),
			),
			array(
				"title" => esc_html__("Import/Export", "adirectory"),
				"path" => "import_export",
		...
		$this->settingFields = array(
			...
			array(
				"path" => "import_export",
				"input" => "urlredirect",
				"label" => esc_html__("Import Listings", "adirectory"),
				"value" => "Importer",
			...
			array(
				"path" => "import_export",
				"input" => "export",
				"label" => esc_html__("Export Listings", "adirectory"),
				"value" => "Export ",
				"cb" => "const formdata = new FormData();
formdata.append('action', 'adqs_export_listings');
formdata.append('security', window.qsdObj.adqs_admin_nonce);
formdata.append('termid', Number(exportTerm));
...
try {
    ...
    if (buttonRefs.current[index]) {
        fieldlabel.innerHTML = 'Listings Exported';
    ...
    spinner.style.display = 'none';
			...
			array(
				"path" => "general",
				"input" => "dropdown",
				"label" => esc_html__("Plan purchase users listing expire duration", "adirectory"),
				"option_name" => "purchase_expiry_type",
				"options" => [
					["label" => esc_html__("Use Default Expire Days", "adirectory"), "value" => ''],
					["label" => esc_html__("From Post Date", "adirectory"), "value" => 'by_post_date'],
					["label" => esc_html__("Expire When Plan Ends", "adirectory"), "value" => 'by_plan_expire'],
				],
			),
			array(
				"path" => "general",
				"input" => "number",
				"label" => esc_html__("Plan purchase users expire notification", "adirectory"),
				'option_name' => 'purchase_expiry_notification',
				'value' => 7,
			),
			array(
				"path" => "general",
				"input" => "dropdown",
				"label" => esc_html__("Status after listing Expired", "adirectory"),
				'option_name' => 'action_expiry_date',
				'options' => [
					["label" => esc_html__("Pending", "adirectory"), "value" => 'pending'],
					["label" => esc_html__("Draft", "adirectory"), "value" => 'draft'],
					["label" => esc_html__("Trash", "adirectory"), "value" => 'trash'],
					["label" => esc_html__("Force Delete", "adirectory"), "value" => 'delete'],
					["label" => esc_html__("None", "adirectory"), "value" => ''],
				],
			...
			array(
				"path" => "general",
				"input" => "toggle",
				"label" => esc_html__('Hide author from listing', 'adirectory'),
				"option_name" => "hide_author_listing",
				'value' => '0',
			),
			array(
				"path" => "general",
			...
			array(
				"path" => "general",
				"input" => "toggle",
				"label" => esc_html__('Enable guest listing', 'adirectory'),
				"option_name" => "enable_guest_listing",
				'value' => '0',
			),
			array(
				"path" => "general",
				"input" => "toggle",
				"label" => esc_html__('Guest Listing Post Approval', 'adirectory'),
				"option_name" => "enable_guest_listing_post_approv",
				'value' => '1',
			),
			array(
				"path" => "general",
			...
			array(
				...
				'option_name' => 'ajax_filters',
			),

			array(
				"path" => "filters",
				"input" => "dropdown",
				"label" => esc_html__("Filter Layout Position", "adirectory"),
				"option_name" => "filterLayoutPosition",
				"options" => [
					["label" => esc_html__("Top Position", "adirectory"), "value" => 'top'],
					["label" => esc_html__("Sidebar Position", "adirectory"), "value" => 'sidebar'],
				],
			),
			...
			array(
				"path" => "filters",
				"input" => "toggle",
				"label" => esc_html__("Exclude Search Filters", 'adirectory'),
				'option_name' => 'excludeSearch',
			),
			array(
				"path" => "filters",
				"input" => "toggle",
				"label" => esc_html__("Exclude Expandable Filter", 'adirectory'),
				'option_name' => 'excludeExpandSearch',
			),
			array(
				"path" => "filters",
				"input" => "toggle",
				"label" => esc_html__("Exclude Directory Type Filter", 'adirectory'),
				'option_name' => 'excludeDirectoryFilter',
			),
			array(
				"path" => "filters",
				"input" => "toggle",
				"label" => esc_html__("Exclude Sort By", 'adirectory'),
				'option_name' => 'excludeSortBy',
			),
			array(
				"path" => "filters",
				"input" => "text",
				"label" => esc_html__("Search Heading Text", 'adirectory'),
				'option_name' => 'searchHeadingText',
			),
			array(
				"path" => "filters",
				"input" => "text",
				"label" => esc_html__("Filter Button Text", 'adirectory'),
				'option_name' => 'filterBtnText',
			),
			array(
				"path" => "filters",
				"input" => "text",
				"label" => esc_html__("Find Listing Button Text", 'adirectory'),
				'option_name' => 'findListingBtnText',
			),
			array(
				"path" => "filters",
				"input" => "checkbox",
				"label" => esc_html__("Exclude Filter Fields", "adirectory"),
				'option_name' => 'excludedFilterFields',
				'value' => array(
					'search',
					'category',
					'location',
				...
				'options' => array(
					array(
						"label" => esc_html__("Search", "adirectory"),
						"value" => "search"
					),
					array(
						"label" => esc_html__("Category", "adirectory"),
						"value" => "category"
					),
					array(
						"label" => esc_html__("Location", "adirectory"),
						"value" => "location"
					),
					array(
						"label" => esc_html__("Min and Max Price", "adirectory"),
						"value" => "min_max_price"
					),
					array(
						"label" => esc_html__("Range Price", "adirectory"),
						"value" => "range_price"
					),
					...
					array(
						"label" => esc_html__("Tags", "adirectory"),
						"value" => "tags"
					),
					array(

						"label" => esc_html__("Featured", "adirectory"),
						"value" => "display_featured"
					),
				)
			),
			array(
				"path" => "filters",
				"input" => "checkbox",
				"label" => esc_html__("Exclude Sort By Items", "adirectory"),
				'option_name' => 'excludedSortByItem',
				'value' => array(
					'date-desc',
					'date-asc',
					'views-desc',
				...
				'options' => array(
					array(
						"label" => esc_html__("Latest listings", "adirectory"),
						"value" => "date-desc"
					),
					array(
						"label" => esc_html__("Oldest listings", "adirectory"),
						"value" => "date-asc"
					),
					array(
						"label" => esc_html__("Popular listings", "adirectory"),
						"value" => "views-desc"
					),
					array(
						"label" => esc_html__("5 to 1 (star rating)", "adirectory"),
						"value" => "rating-desc"
					),
					array(
						"label" => esc_html__("Review Count", "adirectory"),
						"value" => "review-count"
					),
					array(
						"label" => esc_html__("A to Z (title)", "adirectory"),
						"value" => "title-asc"
					),
					array(
						"label" => esc_html__("Z to A (title)", "adirectory"),
						"value" => "title-desc"
					),
					array(
						"label" => esc_html__("Price (low to high)", "adirectory"),
						"value" => "price-asc"
					),
					array(
						"label" => esc_html__("Price (high to low)", "adirectory"),
						"value" => "price-desc"
					),
					array(
						"label" => esc_html__("Random listings", "adirectory"),
						"value" => "rand"
					),
				)
			),
			...
			array(
				"path" => "log_reg",
				"input" => "toggle",
				"label" => esc_html__("Enable Registration reCAPTCHA", "adirectory"),
				'option_name' => "reg_reCAPTCHA_enable"
			),
			array(
				"path" => "log_reg",
				"input" => "toggle",
				"label" => esc_html__("Enable Login reCAPTCHA", "adirectory"),
				'option_name' => "log_reCAPTCHA_enable"
			),
			array(
				"path" => "log_reg",
				"input" => "text",
				"label" => esc_html__("reCAPTCHA Site Key", "adirectory"),
				'option_name' => "reCAPTCHA_site_key"
			),
			array(
				"path" => "log_reg",
				"input" => "text",
				"label" => esc_html__("reCAPTCHA Secret Key", "adirectory"),
			...
			array(
				...
				'adirectory',
				"option_name" => "terms_condition_text",
				"value" => 'By clicking the "Sign Up" button you are agreeing to the <a href="#">Terms and Conditions</a>.',
			),
			array(
				"path" => "paypal",
				"input" => "textarea",
...
try {
    ...
    alert('failed');
			...
			array(
				"path" => "pages",
				"input" => "media",
				"label" => esc_html__('Content Not Found Image', 'adirectory'),
				"option_name" => "content_not_found_image",
			),
			array(
				"path" => "pages",
				"input" => "editor",
				"label" => esc_html__('Content Not Found Text', 'adirectory'),
				"option_name" => "content_not_found",
			),
			array(
				"path" => "shortcodes",
				"input" => "shortcode",
			...
			array(
				...
				'options' => array(
					...
					array(
						"label" => esc_html__("Order created", 'adirectory'),
