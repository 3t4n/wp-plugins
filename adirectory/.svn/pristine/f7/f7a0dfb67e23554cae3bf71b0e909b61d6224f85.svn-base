	...
	?>
			<div class="adqs-section-wrapper">
				...
				<div class="adqs-section-head-title">
					...
					<div class="qsd-ad-form-check-control">
						...
						<label for="adqs_mtsh_hide_<?php echo esc_attr($sectionId); ?>"><?php echo esc_html__('Hide Heading on Single Listing Page', 'adirectory'); ?></label>
					</div>
				</div>
				<?php
...
adqs_get_template_part("fields-template/media", "images", compact('post_id', 'ispricing', 'pricing_active', 'log_status'));
