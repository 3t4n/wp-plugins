...
class Topmisc extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Before Login Options', 'adirectory'),
		...
		$this->add_control(
			'dash_btn_text',
			[
				'label' => __('Login Button Text', 'adirectory'),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'after_login_heading',
			[
				'label' => esc_html__('After Login Options', 'adirectory'),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'hide_dash' => 'yes',
		...
		$this->add_control(
			'afdh_action',
			[
				'label' => esc_html__('Action Type', 'adirectory'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__('Logout', 'adirectory'),
					'custom_link' => esc_html__('Custom Link', 'adirectory'),
				],
				'condition' => [
					'hide_dash' => 'yes',
				],
		...
		$this->add_control(
			'afdh_custom_link',
			[
				'label' => esc_html__('Link', 'adirectory'),
			...
			?>
				<div
					...
					<?php if ($logged_in):
						...
						if (($settings['afdh_action'] ?? '') === 'custom_link') {
							if (! empty($settings['afdh_custom_link']['url'])) {
								$this->add_link_attributes('custom_link', $settings['afdh_custom_link']);
							}
						}
					...
					?>
						<a <?php
							if (!empty($this->get_render_attribute_string('custom_link'))):
								$this->print_render_attribute_string('custom_link');
							else:
							?> href="<?php echo esc_url($dash_permalink); ?>" <?php
																			endif;

																				?> class="icon-text-wrapper ">

							<?php
							$afIcon = !empty($settings['after_dashbaord_icon']['value'] ?? '') ? $settings['after_dashbaord_icon'] : $settings['dashbaord_icon'];
							if (!empty($afIcon)):
							?>
								<span class="btn_icon">
									<?php \Elementor\Icons_Manager::render_icon($afIcon, ['aria-hidden' => 'true']); ?>
								</span>
							<?php endif; ?>
							<?php if (!empty($settings['after_dash_btn_text'] ?? '')): ?>
								<span class="btn_text"><?php echo esc_html($settings['after_dash_btn_text']); ?></span>
							<?php endif; ?>
						</a>
					<?php else: ?>
						<a href="<?php echo esc_url($dash_permalink); ?>" class="icon-text-wrapper">
							<?php if (!empty($settings['dashbaord_icon'] ?? '')): ?>
								<span class="btn_icon">
									<?php \Elementor\Icons_Manager::render_icon($settings['dashbaord_icon'], ['aria-hidden' => 'true']); ?>
								</span>
							<?php endif; ?>
							<?php if (!empty($settings['dash_btn_text'] ?? '')): ?>
								<span class="btn_text"><?php echo esc_html($settings['dash_btn_text']); ?></span>
							<?php endif; ?>
						</a>
					<?php endif; ?>
				</div>
