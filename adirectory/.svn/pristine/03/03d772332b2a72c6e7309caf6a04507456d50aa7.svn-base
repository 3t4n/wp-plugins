...
class Listing_Taxonomy extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			'pagination_type',
			[
				'label' => esc_html__('Layout With Type', 'directory'),
				'type' => Controls_Manager::SELECT,
				'label_block' => true,
				'multiple' => true,
				'options' => [
					'' => esc_html__('Default', 'directory'),
		...
		$this->start_controls_section(
			'tax_section_styles',
			[
				'label' => esc_html__('Column Style', 'adirectory'),
		...
		$this->add_responsive_control(
			'column_basis',
			[
				'label' => esc_html__('Columns Basis', 'adirectory'),
				...
				'selectors' => [
					'{{WRAPPER}} .qsd-select-category-grid-item .qsd-tax-grid-single' => '-webkit-flex-basis: {{SIZE}}{{UNIT}} !important;flex-basis: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__('Columns Gap', 'adirectory'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%', 'px', 'vw'],
				'range' => [
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} .qsd-select-category-grid-item' => 'gap: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
