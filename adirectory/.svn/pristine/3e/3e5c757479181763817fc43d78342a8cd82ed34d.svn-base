...
?>
	...
	?> <style>
			...
			#adminmenu li.wp-has-current-submenu a.wp-menu-open.menu-icon-adqs_directory {
				background: -webkit-gradient(linear, left top, right top, from(rgba(149, 185, 255, 0.96)), color-stop(50%, rgb(61, 93, 255)));
				background: -o-linear-gradient(left, rgba(149, 185, 255, 0.96) 0%, rgb(61, 93, 255) 50%);
				background: linear-gradient(90deg, rgba(149, 185, 255, 0.96) 0%, rgb(61, 93, 255) 50%);
			}
		</style>
	<?php
	}
