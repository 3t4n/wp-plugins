...
?>
<form method="post" id="adqs_loginForm">
	...
	<div class="adqs-form-fields rememeber-check">
		...
		<a href="#" class="adqs-forget-pass-text"
			data-content="forget"><?php echo esc_html__('Forget password ?', 'adirectory'); ?></a>
	</div>

	<!-- Add the reCAPTCHA widget -->
	<?php
	if (!empty(adqs_get_setting_option('log_reCAPTCHA_enable'))) {
		add_grecaptcha_input_field();
	}
