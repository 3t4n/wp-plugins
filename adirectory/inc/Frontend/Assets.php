...
class Assets
{
	...
	public function assetsloading()
	{
		...
		wp_enqueue_script('adqs-global', ADQS_DIRECTORY_ASSETS_URL . '/frontend/js/global.js', array('jquery'), ADQS_DIRECTORY_VERSION, true);
		...
		wp_register_script("adqs_ajax_search", ADQS_DIRECTORY_ASSETS_URL . '/frontend/js/ajax-search.js', array('jquery'), ADQS_DIRECTORY_VERSION, true);
