...
?>
				<style>
					#qsd-widget-loc-tax-<?php echo esc_attr($tax_w_id) . ' '; ?>>li:nth-child(n+<?php echo esc_attr($display_number + 1); ?>),
		...
		<?php
			...
			echo '<ul class="qsd-categories-list qsd-widget-tax" id="qsd-widget-loc-tax-' . esc_attr($tax_w_id) . '">';
