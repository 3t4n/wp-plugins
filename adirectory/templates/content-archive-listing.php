...
$is_active_sidebar = is_active_sidebar('adqs_archive_listings') ? true : false;
$wap_classes = $is_active_sidebar ? ["column-2"] : ["column-3"];
...
<section class="qsd-prodcut-grid-with-side-bar-main qsd-archive" id="qsd_archive" data-ad-fragment="qsd_archive">
	<div class="adqs-admin-container">
		<div class="qsd-prodcut-grid-with-side-bar-main-item">
			...
			<div class="qsd-prodcut-grid-right">
				<?php adqs_get_template_part('grid/header-top', 'bar', compact('listings_query', 'has_map_view', 'reset_filter', 'is_active_sidebar'));
