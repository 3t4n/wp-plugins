(function ($) {
	...
	function adqs_empty_section_hide() {
		$('.adqs-singleSection').each(function () {
			let section = $(this);
			if (!(section.find('.listing-grid-info').length > 0)) {
	...
	$(function () {
		...
		// empty section hide
		if (typeof adqs_empty_section_hide === 'function') {
			adqs_empty_section_hide();
		}
