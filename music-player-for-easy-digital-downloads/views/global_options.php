	...
	<tr>
		<td>
			<table class="widefat" style="border:1px solid #e1e1e1;margin-bottom:20px;">
				...
				<tr>
					<td colspan="2">
						<table class="widefat" style="border:2px solid #E6DB55;">
							<tr>
								<td width="30%"><?php esc_html_e( 'Include the players only for registered users', 'music-player-for-easy-digital-downloads' ); ?></td>
								<td><input aria-label="<?php esc_attr_e( 'Include the players only for registered users', 'music-player-for-easy-digital-downloads' ); ?>" type="checkbox" name="_eddmp_registered_only" <?php print( ( $registered_only ) ? 'CHECKED' : '' ); ?> /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr><td colspan="2"><?php _e( '<p style="color:red;font-weight:bold;">FEATURE AVAILABLE IN THE PROFFESIONAL VERSION OF THE PLUGIN: <a target="_blank" href="https://wordpress.dwbooster.com/content-tools/music-player-for-easy-digital-downloads?wp=1#download"  class="eddmp-blink">CLICK HERE</a></p>', 'music-player-for-easy-digital-downloads' ); // phpcs:ignore WordPress.Security.EscapeOutput ?></td></tr>
				<tr>
			...
			<table class="widefat" style="border:1px solid #e1e1e1;margin-bottom:20px;">
				<tr>
					<td><h2><?php esc_html_e( 'Troubleshoot Area', 'music-player-for-easy-digital-downloads' ); ?></h2></td>
				</tr>
				<tr>
					<td style="font-weight:600;">
						<?php esc_html_e( 'Q: Are audio players not visible or working properly on iPads or iPhones? Activate the iPads and iPhone native controls.', 'music-player-for-easy-digital-downloads' ); ?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="font-weight:600;">
						<?php esc_html_e( 'Q: Could an installed optimizer or cache management plugin be causing player loading issues? Try loading players on page load.', 'music-player-for-easy-digital-downloads' ); ?>
					</td>
				</tr>
				<tr>
					<td style="padding-bottom:20px;">
				...
				<tr>
					<td style="font-weight:600;">
						<?php esc_html_e( 'Q: Are the audio files in product settings missing file extensions, or are they stored in the cloud and not recognized as audio files by the plugin? Check the box to treat unidentified files as audio files.', 'music-player-for-easy-digital-downloads' ); ?>
					</td>
				</tr>
				<tr>
					<td style="padding-bottom:20px;">
				...
				<tr>
					<td style="font-weight:600;">
						<?php esc_html_e( 'Q: Have you installed a custom WordPress theme that doesn\'t use the standard Easy Digital Downloads hooks and players are not visible on shop pages? If so, please enter the hook names separated by commas that the plugin should check to load the audio players on the shop pages.', 'music-player-for-easy-digital-downloads' ); ?>
					</td>
				</tr>
				<tr>
					<td style="padding-bottom:20px;">
				...
				<tr>
					<td style="font-weight:600;">
						<?php esc_html_e( 'Q: Have you installed a custom WordPress theme that doesn\'t use the standard Easy Digital Downloads hooks and players are not visible on download pages? If so, please enter the hook names separated by commas that the plugin should check to load the audio players on the download pages.', 'music-player-for-easy-digital-downloads' ); ?>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td style="padding-bottom:20px;"><?php _e( 'Click on <a href="https://easydigitaldownloads.com/categories/docs/actions/" target="_blank">THIS LINK</a> to access the list of available <a href="https://easydigitaldownloads.com/categories/docs/actions/" target="_blank" style="font-weight:bold;font-size:1.3em;">EDD Hooks</a>', 'music-player-for-easy-digital-downloads' ); // phpcs:ignore WordPress.Security.EscapeOutput ?></td>
				</tr>
				<tr>
					<td style="font-weight:600;"><?php esc_html_e( 'Q: Are the demo files outdated or were they generated incorrectly? Delete the previously generated demo files to allow the plugin to regenerate them.', 'music-player-for-easy-digital-downloads' ); ?></td>
				</tr>
				<tr>
					<td>
						<label>
						<input aria-label="<?php esc_attr_e( 'Delete local demo files', 'music-player-for-easy-digital-downloads' ); ?>" type="checkbox" name="_eddmp_delete_demos" /> (only applied to demo files stored locally on the website)
						</label>
					</td>
				</tr>
				<tr>
					<td>
						<p style="border:1px solid #E6DB55;margin-bottom:10px;padding:10px;background-color:#FFFFE0;"><b><?php esc_html_e( 'Attention !!!', 'music-player-for-easy-digital-downloads' ); ?></b> <?php esc_html_e( 'After modifying the troubleshooting area attributes, it is recommended to clear the website and browser caches.', 'music-player-for-easy-digital-downloads' ); ?></p>
					</td>
				</tr>
			</table>
			<table class="widefat eddmp-player-settings" style="border:1px solid #e1e1e1;">
				<tr><td colspan="2"><h2><?php esc_html_e( 'Player Settings', 'music-player-for-easy-digital-downloads' ); ?></h2></td></tr>
				<tr>
				...
				<tr>
					<td colspan="2">
						<table class="widefat" style="border:1px solid #e1e1e1;">
							<tr><td colspan="2"><h2 style="color:#DADADA;"><?php esc_html_e( 'Files Protection', 'music-player-for-easy-digital-downloads' ); ?></h2></td></tr>
							<tr>
						...
						<table class="widefat" style="border:1px solid #e1e1e1;margin-top:10px;">
							<tr>
								<td>
									<div><h2><?php esc_html_e( 'Scope', 'music-player-for-easy-digital-downloads' ); ?></h2></div>
