...
Tags:Easy Digital Downloads,music player,audio player,music,audio
...
[youtube https://www.youtube.com/watch?v=VWpPpvAKh8o]
...
* Modifies the playlist to include the original files' duration (Do not confuse it with audio files for demos) and purchase buttons.
...
* Makes the plugin settings page more intuitive.
* Modifies the module that generates the files for demos (Commercial plugin version).
...
* Modifies the structure of the files' URLs.
