...
class sibg_backend{
	...
	public function SIBG_admin_init(){
		...
		wp_register_style( 'font-awesome-icon', "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css","",  1.0 );
        ...
        <form action="" method="POST">
            <table class="ga_form_settings" cellspacing="0" cellpadding="0">
                ...
                <tr class="bg_form_color">
                    ...
                    <td>
                        <?php
                        $formMainColor = isset($formMainColor) ? $formMainColor : "#EEE";
