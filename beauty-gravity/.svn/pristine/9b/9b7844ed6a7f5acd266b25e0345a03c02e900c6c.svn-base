...
Contributors: sehreideas, emadsharqi, jafarshirdel, aminnz
Donate link: https://sehreideas.com/
Tags: gravity forms styler , gravity forms multi-page transition , gravity forms tooltip , gravity forms theme, gravity forms
...
Effortlessly customize forms in Gravity Forms and enhances it with multi-step transitions, field icons, and material design themes for easy CSS styling
...
<strong> BeautyForm Styler highlights: </strong>

<strong>[View Online Demo](https://sehreideas.com/beauty-gravity/demo)</strong>
...
=== <strong>BeautyGravity Pro Version Features:</strong> ===

[Click On To Buy BeautyGravity Pro Version ](https://sehreideas.com/beauty-gravity) 

* <strong>10+Transition for Multi Page Navigation in Gravity Forms</strong>
Slide animation, Fade animation, Window animation, Flip animation, Modern animation and plenty more…

* <strong>8+ Gravity Forms themes</strong>

* <strong>Gravity Forms range slider</strong>

* <strong>10+ Gravity Forms tooltips</strong>

* <strong>Add icon to Gravity Form fields</strong>
...
== Screenshots ==
1. Add tooltip , field icon and toggle or button mode to form.

2. Gravity Forms styling sample.

3. Add theme, font and trnsition to Gravity Forms.

== Frequently Asked Questions ==

=Form transition doesn’t work after installation=
First choose your intended animation, then activate your form Ajax property.

=No changes occures after installing BeautyGravity=
...
== Changelog ==
= 1.6.2 =
* Fix: Compatibility issues with latest version of Gravity forms (v 2.9.2)
* Fix: Tooltip breaks the fields 
* Fix: Some animation are not working
