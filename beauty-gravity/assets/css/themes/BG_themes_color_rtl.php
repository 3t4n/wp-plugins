...
:root {
  --android-primary-color: #3ddc84; /* Android Green */
  --cute-primary-color: #ff69b4; /* Hot Pink */
  --material-primary-color: #6200ee; /* Material Deep Purple */
  --microsoft-color-primary: #f25022; /* Microsoft Red */
}
