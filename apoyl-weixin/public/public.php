...
class Apoyl_Weixin_Public
{
    ...
    public function apoyl_weixin_callback()
    {
        ...
        if (isset($weixinuser->userid)&&!empty($weixinuser->userid)) {
            ...
            if ($userid > 0) {
                $file = apoyl_weixin_file('addavatar');
                if ($file) {
                    include $file;
                }
                ...
                if(wp_is_mobile()){
                    $weixindata['mbopenid'] = $openid;
                }else{
                    $weixindata['openid'] = $openid;
                }
