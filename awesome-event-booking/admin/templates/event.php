...
<h1><?php esc_html_e('Event Sign Up Field Settings', 'wp_event_booking');?></h1>
  <form class="wpeb-event-sign-up-settings" method="post" action="options.php">
    ...
    <table class="form-table">
	    <tbody>
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant first name', 'wp_event_booking');?></th>
          <td>
            ...
            <?php esc_html_e('Enable/Disable', 'wp_event_booking');?></span>
            <?php $mafn = esc_attr(get_option('mandatory_attendant_first_name'));?>
            <span>
            <input type="checkbox" disabled="disabled" name="mandatory_attendant_first_name" value="true" <?php echo ($mafn == 'true' ? 'checked="checked"' : ''); ?> /><?php esc_html_e('Mandatory', 'wp_event_booking');?>
            </span>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant last name', 'wp_event_booking');?></th>
          <td>
            ...
            <?php esc_html_e('Mandatory', 'wp_event_booking');?></span>
          </td>
        </tr>
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant phone number', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant e-mail address', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant address', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant zip code', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant city', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Attendant state', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company name', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company address', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company zip code', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company city', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company state', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company vat number', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company contact person', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company contact person phone number', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company invoice e-mail address', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Company reference', 'wp_event_booking');?></th>
          <td>
        ...
        <tr valign="top">
          <th scope="row"><?php esc_html_e('Personal identification number', 'wp_event_booking');?></th>
          <td>
