...
function enqueue_admin_scripts_bootstrap_datepicker()
{
	...
	wp_enqueue_script('datepair', WPEB_URL . 'src/js/datepair.js', array('jquery'), wp_rand(), true);
	...
	wp_enqueue_script(WPEB_NAME, WPEB_URL . 'src/js/admin-scripts.js', array('jquery', 'wp-color-picker'), wp_rand(), true);
