 ...
 * Description:       Koppel WooCommerce aan uw Silvasoft bedrijfssoftware voor automatische boekhouding, orders & facturatie en voorraadbeheer. Automatisch. Eenvoudig. Gratis. 
 * Version:           3.0.5
 * Author:            silvasoft
...
function cron_add_silvaschedules( $schedules ) {
	...
	$schedules['silvasoftwoosyncstock'] = array(
		'interval' => 60, //60 seconds = 1 minute
		'display' => __( 'Silvasoft Woo sync - 60s' )
	);
