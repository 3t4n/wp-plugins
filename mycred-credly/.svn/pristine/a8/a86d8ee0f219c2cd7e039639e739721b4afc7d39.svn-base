				...
				<div class="mycred-ui-accordion">
					<div class="mycred-ui-accordion-header">
						<h4 class="mycred-ui-accordion-header-title">
							...
							<label><?php esc_html_e('Credly Badges', 'mycred'); ?></label>
						</h4>
					...
					<div class="mycred-ui" style="font-size: medium; padding: 20px;">
						<h4><?php esc_html_e('Credly Badges Integration', 'mycred_credly'); ?></h4>
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label for="mycred_credly_token"><?php esc_html_e('Authorization Token', 'mycred_credly'); ?></label>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label for="mycred_credly_organization"><?php esc_html_e('Organization ID', 'mycred_credly'); ?></label>
