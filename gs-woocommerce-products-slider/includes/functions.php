...
function gs_appsero_init() {
    ...
    if ( ! class_exists('\GSProductSlider\Client') ) {
        require_once GSWPS_FILES_DIR . '/includes/appsero/Client.php';
    }

    $client = new \GSProductSlider\Client( '2156b216-b37e-4d27-9d22-a51ff9d88fc8', 'Woo Product Views', __FILE__ );
