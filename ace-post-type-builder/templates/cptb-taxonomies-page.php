...
// File: templates/taxonomies-page.php
    ...
    <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php?action=cptb_save_taxonomy' ) ); ?>">
        <table class="form-table">
            <tr>
                ...
                <td>
                <input type="text" name="taxonomy_slug" id="taxonomy_slug" required placeholder="<?php esc_attr_e('Enter taxonomy slug', 'ace-post-type-builder'); ?>">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    ...
                    <input type="text" name="taxonomy_singular" id="taxonomy_singular" required placeholder="<?php esc_attr_e('Enter singular name', 'ace-post-type-builder'); ?>">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                <input type="text" name="taxonomy_plural" id="taxonomy_plural" required placeholder="<?php esc_attr_e('Enter plural name', 'ace-post-type-builder'); ?>">
                </td>
            </tr>
            <tr>
                <th scope="row">
        ...
        <p class="submit">
            <input type="submit" class="button-primary" value="<?php esc_html_e('Save Taxonomy', 'ace-post-type-builder'); ?>">
        </p>
    </form>
</div>
...
$existing_taxonomies = get_option('cptb_custom_taxonomies', array());
...
if (!empty($existing_taxonomies)) {
    ...
    foreach ($existing_taxonomies as $taxonomy) {
        if (isset($taxonomy['singular'], $taxonomy['plural'], $taxonomy['slug'], $taxonomy['post_type'])) {
            ...
            echo '<a href="' . esc_url(admin_url('admin-post.php?action=cptb_delete_taxonomy&taxonomy=' . $taxonomy['slug'])) . '" onclick="return confirm(\'Are you sure you want to delete this taxonomy?\')">' . esc_html__('Delete', 'ace-post-type-builder') . '</a>';
            echo '</td>';
            echo '</tr>';
        }
    }
...
if (isset($_GET['edit_taxonomy'])) {
    $taxonomy_slug = sanitize_text_field($_GET['edit_taxonomy']);
    $taxonomy_to_edit = $existing_taxonomies[$taxonomy_slug] ?? null;
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="taxonomy_slug" id="taxonomy_slug" value="<?php echo esc_attr($taxonomy_to_edit['slug']); ?>" required placeholder="<?php esc_attr_e('Enter taxonomy slug', 'ace-post-type-builder'); ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        ...
                        <input type="text" name="taxonomy_singular" id="taxonomy_singular" value="<?php echo esc_attr($taxonomy_to_edit['singular']); ?>" required placeholder="<?php esc_attr_e('Enter singular name', 'ace-post-type-builder'); ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="taxonomy_plural" id="taxonomy_plural" value="<?php echo esc_attr($taxonomy_to_edit['plural']); ?>" required placeholder="<?php esc_attr_e('Enter plural name', 'ace-post-type-builder'); ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <select name="post_type" id="post_type" required>
                            <?php
                            foreach ($post_types as $post_type) {
                                $selected = $taxonomy_to_edit['post_type'] === $post_type->name ? 'selected' : '';
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="hierarchical" id="hierarchical" <?php checked($taxonomy_to_edit['hierarchical'], true); ?>>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="checkbox" name="public" id="public" <?php checked($taxonomy_to_edit['public'], true); ?>>
                    </td>
                </tr>
            </table>
            <?php wp_nonce_field('cptb_update_taxonomy', 'cptb_nonce'); ?>
            <p class="submit">
                <input type="submit" class="button-primary" value="<?php esc_html_e('Update Taxonomy', 'ace-post-type-builder'); ?>">
            </p>
        </form>
        <?php
    }
