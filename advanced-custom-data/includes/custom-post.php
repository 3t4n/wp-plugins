...
class advanced_data {
    ...
    public function save( $post_id ) {
        ...
        if ( ! isset( $data['acd_inner_custom_box_nonce'] ) ) {
            return $post_id;
        }
 
        $nonce = sanitize_text_field($data['acd_inner_custom_box_nonce']);
        ...
        $type = sanitize_text_field($data['acd_type']);
        $data = sanitize_post_field('post_content', $data['acd_data'], $post_id, 'edit');
    ...
    public function render_meta_box_content( $post ) {
        ...
        $type = get_post_meta($post->ID, '_acd_type', true);
        $data = get_post_meta($post->ID, '_acd_data', true);
