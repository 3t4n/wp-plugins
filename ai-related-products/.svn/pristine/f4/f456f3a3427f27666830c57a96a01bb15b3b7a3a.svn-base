...
class ST_Woo_AI_Rel_Products_Setting
{
    ...
    public function st_woo_ai_rel_products_settings_fields()
    {
        ...
        add_settings_field('st_woo_ai_rel_products_first_seperator_single_rel_products',
            ...
            $this->setting_id,
            array(
                'label' => __( 'AI Related Products Setting', 'ai-related-products' ),
                'description' => __( 'We provide AI Related Product recommendations on the single product and cart pages. Customize them easily with these settings controls.', 'ai-related-products' ),
            )
        );
        ...
        add_settings_field(
            'st_woo_ai_rel_products_replace_single_rel_products',
            __('Replace Default Related Products With AI Related Products', 'ai-related-products'),
        ...
        add_settings_field(
            'st_woo_ai_rel_products_cart_page_rel_products',
            __('Enable AI Related Products in Cart Page', 'ai-related-products'),
            array($this, 'st_woo_ai_rel_products_checkbox_control'),
            $this->page_slug,
            $this->setting_id,
            array(
    ...
    public function st_woo_ai_rel_products_text_control($args)
    {
        ...
        <label class="st-text-label <?php echo $args['name']; ?>">
            <input id="<?php echo $args['name']; ?>" class='st-text' type="text" name="<?php echo $args['name']; ?>"
    ...
    { ?>
        <p class="st-description"><?php echo $args['description']; ?></p>
        <?php
    }
