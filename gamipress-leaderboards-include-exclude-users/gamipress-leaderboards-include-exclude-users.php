...
final class GamiPress_Leaderboards_Include_Exclude_Users {
    ...
    private function constants() {
        ...
        // Plugin version
        define( 'GAMIPRESS_LEADERBOARDS_INCLUDE_EXCLUDE_USERS_VER', '1.0.9' );

        // Required leaderboards version
        define( 'GAMIPRESS_LEADERBOARDS_INCLUDE_EXCLUDE_USERS_LEADERBOARDS_MIN_VER', '1.4.0' );
    ...
    public function admin_notices() {
        ...
        <?php if ( class_exists( 'GamiPress_Leaderboards' ) && defined( 'GAMIPRESS_LEADERBOARDS_VER' )
            && version_compare( GAMIPRESS_LEADERBOARDS_VER, GAMIPRESS_LEADERBOARDS_INCLUDE_EXCLUDE_USERS_LEADERBOARDS_MIN_VER, '<' ) ) : ?>

            <div id="message" class="notice notice-error is-dismissible">
                <p>
                    <?php printf(
                        __( 'GamiPress - Leaderboards Include/Exclude Users requires %1$s <strong>%2$s</strong> or higher in order to work. Please update %1$s.', 'gamipress-leaderboards-include-exclude-users' ),
                        '<a href="https://gamipress.com/add-ons/gamipress-leaderboards/" target="_blank">GamiPress - Leaderboards</a>',
                        GAMIPRESS_LEADERBOARDS_INCLUDE_EXCLUDE_USERS_LEADERBOARDS_MIN_VER
                    ); ?>
                </p>
            </div>
