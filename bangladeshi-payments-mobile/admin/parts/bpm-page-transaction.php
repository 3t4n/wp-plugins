...
function bangladeshi_payments_render_transaction_info_page() {
    ...
    if (isset($_GET['bangladeshi_payments_nonce'])) {
        $nonce = isset($_GET['bangladeshi_payments_nonce']) ? sanitize_text_field(wp_unslash($_GET['bangladeshi_payments_nonce'])) : '';
    ...
    <div class="wrap bpm-wrap">
        ...
        <form method="GET">
            ...
            <?php
                if (isset($_GET['page']) && 'bangladeshi-payments' === sanitize_text_field(wp_unslash($_GET['page']))) {
                    // Safe to use $_GET['page'] here
                    echo '<label for="payment_method">';
                    esc_html_e('Payment Method:', 'bangladeshi-payments-mobile');
                    echo '</label>';
                }
            ?>
