 ...
 * @subpackage App_Swiper_Slider/public
 * @author     Nababur 
 * */
if (!class_exists('AppSwiperSlider_Resize')) {

	class AppSwiperSlider_Resize
	{
		/**
...
if (!function_exists('AppSwiperSlider_Resize')) {

	/**
	 * This is just a tiny wrapper function for the class above so that there is no
	 * need to change any code in your own WP themes. Usage is still the same :)
	 */
	function AppSwiperSlider_resize($url, $width = null, $height = null, $crop = null, $single = true, $upscale = false)
	{
		/* WPML Fix */
		...
		$AppSwiperSlider_resize = AppSwiperSlider_Resize::getInstance();
		return $AppSwiperSlider_resize->process($url, $width, $height, $crop, $single, $upscale);
	}
}
