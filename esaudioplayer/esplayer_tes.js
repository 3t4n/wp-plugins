...
EsAudioPlayer.prototype.onClick = function(ev)
{
	...
	var cid = jQuery(this.canvas).attr("id");
	var pos = getMouseXYInElement(this.getEv(ev), cid);
	var px = pos.x;
	var py = pos.y;
...
function getMouseXYInElement(e, id) {
	var ua = navigator.userAgent;
	var flgAndroidChrome = ((/Chrome/i.test(ua)) && (/Android/i.test(ua)));
...
{
	if (this.mySound[this.nowPlaying] === undefined) {
		return;
	}
