...
class DashboardLatestSpam {
	...
	function DashboardLatestSpam() {
		...
		// Tell my "Dashboard Widget Manager" plugin that this widget is safe to be edited by anyone
		add_filter( 'dashwidman_safewidgets', array(&$this, 'dashwidman_safewidgets') );

		// Remove the default Defensio text
		remove_action( 'activity_box_end', 'defensio_render_activity_box' );
	}
	...
	// Add this widget to the array of widgets that are safe to be edited by anyone with my "Dashboard Widget Manager" plugin
	function dashwidman_safewidgets( $editablewidgets ) {
		$editablewidgets[] = 'dashboard_latest_spam';
