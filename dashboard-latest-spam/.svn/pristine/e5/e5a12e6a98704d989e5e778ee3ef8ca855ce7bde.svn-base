...
* Update to work with Defensio v1.6.

**Version 1.0.3**

* Allow non-admins to edit this widget when my [Dashboard Widget Manager](http://wordpress.org/extend/plugins/dashboard-widget-manager/) plugin is installed.

**Version 1.0.2**

* Remove the Defensio quarantine status from the "Right Now" box as this plugin makes it obsolete.
