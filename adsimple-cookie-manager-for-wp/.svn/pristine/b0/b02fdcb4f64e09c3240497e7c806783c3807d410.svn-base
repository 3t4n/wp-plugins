...
<div class="as_cm-container-clear-cache">
	<p>
		<label class="as_cm-clear-cache-checkbox">
			...
			<span class="as_cm-clear-cache-checkbox__title"><?= __( 'Save a local copy of the script and clear it every', 'adsimple-cookie-manager-for-wp' ); ?></span>
		</label>
		...
		<?php if( !empty( $clear_cache_url ) ): ?>
			<?= __( 'OR', 'adsimple-cookie-manager-for-wp' ); ?> <a href="<?= $clear_cache_url; ?>"><?= __( 'clear the cache manually', 'adsimple-cookie-manager-for-wp' ); ?></a>
		<?php endif; ?>
	</p>
</div>
<?php if( !AS_CM_Services_Cache_Loader::is_cache_dir_available() ):?>
	<p class="as_cm-update-content__notice-error"><?= __( "We can't save the cache locally because your site doesn't allow writing files.", 'adsimple-cookie-manager-for-wp' ); ?></p>
<?php endif; ?>
<p class="as_cm-update-content__notice-header"><strong><?= __( 'Local cache', 'adsimple-cookie-manager-for-wp' ); ?></strong></p>
