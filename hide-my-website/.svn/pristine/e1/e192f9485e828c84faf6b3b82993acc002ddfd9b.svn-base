...
function hmwp_register_general_settings() {
    ...
    $general_settings_sections = array(
        ...
        'hmw_ipwhitelist_section' => array(
            'title' => 'IP Whitelist Settings',
            'callback' => 'hmwp_ipwhitelist_section_callback'
        ),
        'hmw_excude_section' => array(
            'title' => 'Page Exclusions Settings',
            'callback' => 'hmwp_exclusion_section_callback'
        ),
        'hmw_seo_section' => array(
            'title' => 'Search Engine & Indexing Settings',
    ...
    $general_settings = array(
       ...
       'hmw_ip_whitelist_enabled' => array(
        ...
        'section' => 'hmw_ipwhitelist_section',
    ...
    // Add new excluded pages setting
    'hmw_excluded_pages_enabled' => array(
        'label' => 'Enable Page Exclusions',
        'section' => 'hmw_excude_section',
        'callback' => 'hmw_excluded_pages_enabled_callback',
        'sanitize_callback' => 'absint'
    ),
    'hmw_excluded_pages' => array(
            'label' => 'Excluded Pages',
            'section' => 'hmw_excude_section',
            'callback' => 'hmw_excluded_pages_callback',
            'sanitize_callback' => 'sanitize_textarea_field'
        ),
    'hmw_disable_protection' => array( 
        'label' => 'Disable the Password Protection',
        'section' => 'hmw_password_section',
...
function hmwp_support_section_callback() {
    echo '<p>If you encounter any bugs or have suggestions for improvement, please dont hesitate to reach out. You can contact me directly using the link below, or post your question in the WordPress Plugin Support forum. I actively monitor both channels and will try to respond to your inquiries as fast i can😊.</p>';
}


function faq_1_callback() {
    echo '<div id="faq-accordion">';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is Hide My Website?</h3>';
    echo '<div class="faq-answer"><p>Hide My Website is a plugin that helps protect your WordPress site from unauthorized access. This plugin is mainly used during development when no visitors are allowed.</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">How does it work?</h3>';
    echo '<div class="faq-answer"><p>It adds a password protection layer to your website, preventing access to those without the correct password. Adding a password will automatically turn on the password protection. There is no enable button for this. However, if you want to disable the protection for testing (without deactivating the plugin), you can choose the <b>Disable the Password Protection (For Testing)</b> option for that.</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is IP whitelisting?</h3>';
    echo '<div class="faq-answer"><p>IP whitelisting allows users with specific IPs to access the site while preventing others. You can add multiple IPs, one per line. Remember to turn on the IP whitelisting settings before adding IPs.</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is Page Exclusions Settings</h3>';
    echo '<div class="faq-answer"><p>This setting allows you to exclude specific pages from password protection. Simply enter the slugs of the pages you want to exclude, one per line:</p>';
    echo '<p><strong>Examples:</strong></p>';
    echo '<ul>';
    echo '<li>Use <strong>"home"</strong> to exclude the homepage.</li>';
    echo '<li>For other pages, enter the last part of their URL (e.g., <strong>"about-us"</strong> for <em>example.com/about-us</em>).</li>';
    echo '</ul>';
    echo '<p>Make sure to enable the Page Exclusions feature before adding the slugs.</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is Prevent Search Indexing?</h3>';
    echo '<div class="faq-answer"><p>This option enables the "Discourage search engine indexing" setting in WordPress, thus preventing search engine crawlers from indexing your site (please note this is up to the crawlers).</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is Robots.txt Management?</h3>';
    echo '<div class="faq-answer"><p>This option creates, deletes, or modifies the robots.txt file, which is used for SEO controls. By default, there is content that blocks all bots once it is active. To know more about robots.txt, visit this <a href="https://wp-zip.com/understanding-the-robots-txt-file-a-guide-for-webmasters/">link</a>.</p></div>';
    echo '</div>';
    
    echo '<div class="faq-item">';
    echo '<h3 class="faq-question">What is Templates for Login Page?</h3>';
    echo '<div class="faq-answer"><p>This option allows you to switch login templates (more are coming soon!).</p></div>';
    echo '</div>';
    
    echo '</div>'; // End of FAQ Accordion
}
...
function support_button_callback() {
    ...
    echo '<a href="' . esc_url($email_link) . '" class="button button-primary">🗨 Email me!</a>';
}
