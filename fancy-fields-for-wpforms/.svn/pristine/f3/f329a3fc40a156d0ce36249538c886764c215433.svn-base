 ...
 * Phone field.
 *
 * @deprecated 1.0.5 New Field type f-phone is introduced. This will be removed since version 1.1.0
 * @package    Fancy Fields For WPForms
 * @author     sanzeeb3
 * @since      1.0.4
 * @license    GPL-2.0+
 */
class FFWP_Field_Phone extends WPForms_Field {
