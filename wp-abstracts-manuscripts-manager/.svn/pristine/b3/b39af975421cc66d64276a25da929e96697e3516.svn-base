...
= 2.7.4 - 02-10-2025 =
* Improvement - Added ability to sort topics.
* Improvement - Added ability to set display order of Abstract admin columns.
* Improvement - Included author affiliation in Abstract admin columns.
* Security - Implemented best practices to protect against Cross-Site Request Forgery vulnerability.
* Compatibility testing up to WP 6.7.1

= 2.7.3 - 01/16/2025 =
* Fix - Resolved blank value for topics in PDF exports and {ABSTRACT_TOPIC} shortcode in email notifications.
* Improvement - Added peekaboo password icon on login and registration pages.
* Security - Implemented best practices to protect against Cross-Site Request Forgery to Reflected Cross-Site Scripting vulnerability.
* Compatibility testing up to WP 6.7.1

= 2.7.2 - 10/28/2024 =
* Security - Implemented data validation and sanitization to protect against Cross Site Scripting (XSS) vulnerability on topic names.
...
* Fix - Resolved bad account activation link in new user confirmation email.
