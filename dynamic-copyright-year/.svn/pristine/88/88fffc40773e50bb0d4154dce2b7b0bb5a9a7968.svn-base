...
if ( fsdcy_fs()->is_not_paying() ) {
    ...
    if ( !function_exists( 'fsdcy_beacon_header_free' ) ) {
        function fsdcy_beacon_header_free(  $page  ) {
            ...
            $beacon_html = '<script>document.addEventListener("DOMContentLoaded", function () { let button = document.createElement("a"); button.href = "https://wordpress.org/support/plugin/dynamic-copyright-year/"; button.target = "_blank"; button.style.position = "fixed"; button.style.bottom = "40px"; button.style.right = "40px"; button.style.width = "50px"; button.style.height = "50px"; button.style.backgroundColor = "lightblue"; button.style.color = "#fff"; button.style.borderRadius = "50%"; button.style.display = "flex"; button.style.alignItems = "center"; button.style.justifyContent = "center"; button.style.boxShadow = "0 4px 6px rgba(0, 0, 0, 0.1)"; button.style.textDecoration = "none"; button.style.fontSize = "28px"; button.style.zIndex = "9000"; button.innerHTML = "❓"; document.body.appendChild(button); });</script>';
            echo $beacon_html;
        }
