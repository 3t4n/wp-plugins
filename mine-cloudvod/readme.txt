...
Contributors: 995525477
Tags: course, elearning, lms, education, player
Donate link: http://www.zwtt8.com/
...
Mine CloudVod is an video player. And it is also a complete learning management system, which can help you create an online education website.
...
[Documentation](https://www.zwtt8.com/docs/create-course/)
...
* [Wechat MiniProgram](https://www.zwtt8.com/docs/miniprogram/)
* [Checkout with WooCommerce plugin](https://www.zwtt8.com/docs/woocommerce/).
* [Purchase Video](https://www.zwtt8.com/docs/%e8%a7%86%e9%a2%91%e4%bb%98%e8%b4%b9/)
* [Alibaba Cloud](https://www.zwtt8.com/docs/aliyunvod-setting/)
* [Tencent Cloud](https://www.zwtt8.com/docs/tcvod-setting/)
* [BunnyNet Stream](https://www.zwtt8.com/docs/bunnynet/).
* [Cloud Flare Stream](https://www.zwtt8.com/docs/cloudflare-stream/)
* [Dogecloud](https://www.zwtt8.com/docs/%e4%b8%83%e7%89%9b%e4%ba%91%e5%ad%98%e5%82%a8/)
* [Qiniu Kodo](https://www.zwtt8.com/docs/%e4%b8%83%e7%89%9b%e4%ba%91%e5%ad%98%e5%82%a8/)
* [Lesson Attachments](https://www.zwtt8.com/docs/%e9%9a%8f%e8%af%be%e8%b5%84%e6%96%99/)
* [Auto Next Lesson](https://www.zwtt8.com/docs/%e8%87%aa%e5%8a%a8%e4%b8%8b%e4%b8%80%e8%af%be/)
* [Partial Purchase](https://www.zwtt8.com/docs/%e9%83%a8%e5%88%86%e8%b4%ad%e4%b9%b0/)
* [Course Progress](https://www.zwtt8.com/docs/%e8%af%be%e7%a8%8b%e8%bf%9b%e5%ba%a6/)
* [Course Review](https://www.zwtt8.com/docs/course-review/)
* [Duplicate Course](https://www.zwtt8.com/docs/duplicate-course/)
* [Exchange Code](https://www.zwtt8.com/docs/exchange-code/)
* [Course Package](https://www.zwtt8.com/docs/course-package/)
* [Coupon Code](https://www.zwtt8.com/docs/coupon-code/)
* [Coupon](https://www.zwtt8.com/docs/coupon/)
* [Easy Pay](https://www.zwtt8.com/docs/mcv-epay/)
* [HaiPay](https://www.zwtt8.com/docs/haipay/)
* [Courses Sorting](https://www.zwtt8.com/docs/courses-sorting/).
* [Promotion Rebate](https://www.zwtt8.com/docs/promotion-rebate/).
* [AlphaPay](https://www.zwtt8.com/docs/AlphaPay/).
...
* [Integrate RiPro V2 theme](https://www.zwtt8.com/docs/ripro-v2/), support video post list, and VIP users can learn all coursee for free.
* [Integrate CeoMax theme](https://www.zwtt8.com/docs/ceo/), support video post list.
* [Integrate Elementor plugin](https://www.zwtt8.com/docs/elementor/).
* [Integrate the MasterStudy LMS plugin](https://www.zwtt8.com/docs/masterstudy-lms/).
...
= v2.0.2 - 2025-02-24 =
* New: CloudFlare Stream Add-on。
* New: ShortCodes for some pages.
* Optimize: The user page is not logged in and the login box pops up.
* Optimize: After using the redemption code, the user automatically becomes a student.
...
= v2.0.0 - 2024-12-29 =
* New: WooCommerce Add-on.
* New: Wechat MiniProgram Add-on.
* Optimize: 部分UI。
* Fix: Some knowned issues.

= v1.9.21 - 2024-11-28 =
* New: Quiz Add-on.
* Optimize: 课程表页面增加过滤选项，调整展示方式.
* Fix: Some knowned issues.

= v1.9.20 - 2024-11-15 =
* Fix: WordPress 6.7 compatibility.
* Fix: Some knowned issues.
...
* New: 课时页面动态水印.
* Optimize: 课程表页面.
* Optimize: Course Progress Addons.
* Fix: Some knowned issues.

= v1.9.17 - 2024-10-17 =
* New: 增加设置选项，管理员无需购买课程.
* Optimize: Exchange Code add-on.
* Fix: Some knowned issues.

= v1.9.16 - 2024-10-08 =
* New: The color options of Course page.
* New: 支持七牛云实时转码（边转边播）.
* Fix: Some knowned issues.

= v1.9.15 - 2024-09-29 =
* New: Watermark in the lesson page.
* New: Promotion Rebate Add-on.
* Fix: Some knowned issues.

= v1.9.14 - 2024-09-06 =
* New: AlphaPay Add-on.
* New: BunnyNet Stream Add-on.
* Fix: Some knowned issues.
...
= v1.9.12 - 2024-06-30 =
* New: Wpcom Add-on.
* New: Add edit link course in frontend page.
* Optimize: Show the Recommended courses in the same category.
* Fix: Some knowned issues.

= v1.9.11 - 2024-04-25 =
* New: Add anchor links for graphics and text type of lessons.
* Optimize: Calculate course progress base on the number of completed lessons.
* Fix: Some knowned issues.

= v1.9.10 - 2024-03-29 =
* Optimize: Courses Sorting add-on.
* Optimize: Auto Next Lesson Add-on.
* Fix: Some knowned issues.
...
= v1.9.7 - 2024-01-26 =
* New: User registration switch.
* Optimize: Course student management.
...
= v1.9.5 - 2024-01-09 =
* New: Default player of lesson import.
* Fix: Some knowned issues.

= v1.9.4 - 2024-01-05 =
* New: Coupon Code add-on.
* Optimize: User center.
* Fix: Some knowned issues.
...
= v1.9.2 - 2023-12-22 =
* New: Graphics and text type for lessons.
* Fix: Some knowned issues.

= v1.9.1 - 2023-12-15 =
* New: Show course's catalog after enrolled.
* Fix: Some knowned issues.

= v1.9.0 - 2023-12-08 =
* New: Documentation add-on.
* Optimize: Course Package add-on.
* Fix: Some knowned issues.

= v1.8.9 - 2023-11-22 =
* New: Invite Code.
* New: Course Index page.
* New: Course validity period.
* Fix: Some knowned issues.

= v1.8.8 - 2023-11-17 =
* New: Exchange Code add-on.
* New: Duplicate Course add-on.
* Optimize: Course Package add-on.
* Fix: Some knowned issues.

= v1.8.7 - 2023-11-10 =
* New: Course permalink and lesson permalink options.
* New: Change order's price.
* Optimize: Course Package add-on.
* Optimize: Course Checkout page.
* Fix: Some knowned issues.

= v1.8.6 - 2023-11-03 =
* New: Course Package add-on.
* New: Show course catalog after login.
* Optimize: Hide section title if there is only one section.
...
* New: [Courses Sorting](https://www.zwtt8.com/docs/courses-sorting/) Add-on, sort the courses by sequence number.
* Fix: Some knowned issues.
...
= v1.3.2 - 2022-2-12 =
* New Feature: Audio Player, thanks DIYgod's [APlayer](https://github.com/DIYgod/APlayer).
...
= v1.3 - 2022-1-19 =
* New Feature: [Integrate the WP Job Manager plugin](https://www.zwtt8.com/docs/wp-job-manager/).
* New Feature: Add Preview component for Aliplayer.
* Change the Aliplayer's height from 500px to auto.

= v1.2.20 - 2021-12-15 =
* New Feature: [Integrate the MasterStudy LMS plugin](https://www.zwtt8.com/docs/masterstudy-lms/).
* Change the Aliplayer's height from 500px to auto.
