                ...
                <div class="selector">
                    <div class="selector-main" style="height:auto">
                        <div class="kc-tag-group" style="width: 100%;margin: 10px;justify-content:center;">
                            <form action="<?php echo mcv_lms_filter_permalink(); ?>" class="mcv-search-form">
                                <input name="mcv-s" class="mcv-search" placeholder="<?php echo __('Search Courses', 'mine-cloudvod'); ?>" value="<?php echo isset($wp_query->query_vars['mcv-s'])?$wp_query->query_vars['mcv-s']:''; ?>">
                                <input type="submit" value="<?php echo __('Search', 'mine-cloudvod'); ?>" style="position:absolute;width:60px;right:0;background-color:#2080f71a;color:#2080f7;border:0;padding:5px;height:28px;min-height: 28px;" />
                            </form>
                        </div>
        ...
        <div class="block-container">
            <div class="result">
                ...
                <span class="result__desc">
                    <em class="result__count"><?php echo $wp_query->found_posts ?></em> <?php echo __('Courses', 'mine-cloudvod'); ?>
                </span>
            </div>
