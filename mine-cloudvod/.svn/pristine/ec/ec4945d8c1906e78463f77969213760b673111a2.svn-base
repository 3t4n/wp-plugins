                ...
                <div class="course-banner-row course-single">
                    ...
                    <div class="section-right">
                        ...
                        <p class="course-hints" style="flex-wrap: wrap;line-height:1.6;">
                            ...
                            <span>
                                <span class="num"><?php echo $lessonCount; ?></span><?php echo _x( 'Lessons', 'course single page', 'mine-cloudvod' );?>
                            </span>
                            <?php endif; ?>
                            <?php if( $cd_options && ($cd_options['hours']??true) ): ?>
                            <span>
                                <span class="num"><?php echo round($duration/60/60, 2);?></span><?php echo _x( 'Hours', 'course single page', 'mine-cloudvod' );?>
                            </span>
                            <?php endif; ?>
                            <?php if( $cd_options && ($cd_options['student_num']??true) ): ?>
                            <span>
                                <span class="num"><?php echo mcv_lms_get_course_enrolled_number(); ?></span><?php echo _x( 'Students', 'course single page', 'mine-cloudvod' );?>
                            </span>
                            <?php endif; ?>
                            <?php if( $cd_options && ($cd_options['update']??true) ): ?>
                            <span>
                                <span class="num"><?php echo get_the_modified_date('Y-m-d'); ?></span><?php echo _x( 'Updated', 'course single page', 'mine-cloudvod' );?>
                            </span>
                            <?php endif; ?>
                            <?php if( $cd_options && ($cd_options['difficulty']??true) ): 
                                ...
                                ?>
                            <span>
                            <?php echo _x( 'Difficulty', 'course single page', 'mine-cloudvod' );?> <span class="num"><?php echo $darr[$difficulty]; ?></span>
                            </span>
                            <?php endif; ?>
                            <span>
            ...
            <div class="course-banner--pay">
                ...
                <div class="course-banner-hd">
                    <div class="mcv-breadcrumb">
                        <a href="<?php echo get_post_type_archive_link($post->post_type); ?>"><?php echo __('All courses', 'mine-cloudvod'); ?></a>
                        <?php if( $course_terms ): ?>
                    ...
                    <div class="course-banner-row">
                        <div class="section-left">
                            <div class="cover-pay-wrapper" style="background-image: url(&quot;<?php echo $thumbnail;?>&quot;);">
                                <a class="cover-mask cover-mask--trial <?php echo !$shixue && !$is_user_logged_in && $access_mode!='open' ? 'mcv-login' : '' ;?>" href="<?php echo $shixue ? $shixue : (!$is_user_logged_in && $access_mode!='open' ? 'javascript:;' : $start_url) ; ?>">
                                    ...
                                    <p class="cover-mask-txt"><?php echo $shixue ? __('Can try', 'mine-cloudvod') : __('Start learning', 'mine-cloudvod'); ?></p>
                                </a>
                            </div>
                        </div>
                        <div class="section-right">
                        ...
                        <p class="course-hints mcv-kefu">
                            <?php
                                ...
                                if( $kefuqr ) echo '<span class="btn-fav qrtips" data-title="添加客服" data-qr="'.$kefuqr.'" data-tips="'.$kefutips.'">客服</span>';
                                $mpqr = MINECLOUDVOD_SETTINGS['mcv_lms_general']['mpqr']??'';
                                $mptips = MINECLOUDVOD_SETTINGS['mcv_lms_general']['mptips']??'';
                                if( $mpqr ) echo '<span class="btn-fav qrtips" data-title="关注公众号" data-qr="'.$mpqr.'" data-tips="'.$mptips.'">公众号</span>';
                                $qqgroup = get_post_meta( $course_id, 'qqgroup', true );
                                $qqgrouptips = get_post_meta( $course_id, 'qqgrouptips', true );
                                if( $qqgroup ) echo '<span class="btn-fav qqtips " data-title="QQ群" data-qq="'.$qqgroup.'" data-tips="'.$qqgrouptips.'">QQ群</span>';
                            ?>
                        </p>
                        </div>
                    </div>
        ...
        <div class="section-main">
            ...
            <div class="mcv-tab-panel">
                <div role="tablist" aria-orientation="horizontal" class="components-tab-panel__tabs">
                    <button type="button" role="tab" aria-selected="true" id="tab-panel-0-tab-content" aria-controls="tab-panel-0-tab-content-view" class="components-button components-tab-panel__tabs-item tab-content is-active"><?php echo __('Course Details', 'mine-cloudvod');?></button>
                    <button type="button" role="tab" tabindex="-1" aria-selected="false" id="tab-panel-0-tab-mulu" aria-controls="tab-panel-0-tab-mulu-view" class="components-button components-tab-panel__tabs-item tab-mulu"><?php echo __('Course Catelog', 'mine-cloudvod');?></button>
                </div>
            ...
            <aside class="aside">
                <div class="recommend ">
                    <div class="recommend-box">
                        <h2 class="recommend-tt"><?php echo __('Recommended courses', 'mine-cloudvod');?></h2>
                                        ...
                                        <div class="kc-course-card-content">
                                            ...
                                            <div class="kc-course-card-footer">
                                                <div class="kc-coursecard-footer-left">
                                                    ...
                                                    <?php if( $cd_options && ($cd_options['student_num']??true) ): ?>
                                                    <span class="kc-course-card-student"><?php echo mcv_lms_get_course_enrolled_number($rc) . _x( 'Students', 'course single page', 'mine-cloudvod' );?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
