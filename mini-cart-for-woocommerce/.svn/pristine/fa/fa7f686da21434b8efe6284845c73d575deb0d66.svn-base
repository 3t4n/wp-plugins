...
$notification_imageremovet = isset($notifications['notification_imageremove']) && $notifications['notification_imageremove'] === 'notification_imageremove' ? 'checked' : '';
