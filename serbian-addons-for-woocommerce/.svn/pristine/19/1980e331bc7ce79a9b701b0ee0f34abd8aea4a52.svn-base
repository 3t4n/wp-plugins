...
return array(
    ...
    'XWP\\ANM\\Notice_Manager' => $vendorDir . '/x-wp/admin-notice-manager/src/Notice_Manager.php',
    'XWP\\ANM\\Notice_Repository' => $vendorDir . '/x-wp/admin-notice-manager/src/Notice_Repository.php',
    ...
    'XWP_Admin_Notice' => $vendorDir . '/x-wp/admin-notice-manager/src/Core/Notice.php',
