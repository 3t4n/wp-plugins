    ...
    public function modify_action_links($actions, $plugin_file) {
        ...
        if ($plugin_file == plugin_basename(__FILE__)) {
            if (is_plugin_active('woocommerce/woocommerce.php')) {
                ...
                $actions['go_pro'] = sprintf( '<a href="%s" style="%s">%s</a>', 'https://signsdesigner.us/all-signs-customizer-product/', 'color:#35b747;font-weight:bold', __( 'Get Premium!', 'all-signs-options-free' ) );
