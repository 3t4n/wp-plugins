...
class Func{
    ...
    */
    public static function getPublicSettings(){
        ...
        $ret['searchUrl_only_products']= false;
        ...
        $ret['redirect_to_search']=false;
        $ret['hit_enter_on_field']=false;
        $ret['redirect_to_search_newtab']=false;
        $ret['newtab']=false;
        ...
        if($opt){
            ...
            $ret['hit_enter_on_field']=!empty($opt['general']['hit_enter_on_field']) ? $opt['general']['hit_enter_on_field']=='yes' : false;
            $ret['redirect_to_search_newtab']=!empty($opt['general']['redirect_to_search_newtab']) ? $opt['general']['redirect_to_search_newtab']=='yes' : false;
            ...
            $ret['woocommerce_search_product']=!empty($opt['woocommerce']['redirect_to_search_product']) && $opt['woocommerce']['redirect_to_search_product'] =='yes';
            $ret['woocommerce']=$opt['woocommerce']['woocommerce']=='yes';
            ...
            $ret['woocommerce_search_product']
                ...
                $ret['searchUrl_only_products']= true;
