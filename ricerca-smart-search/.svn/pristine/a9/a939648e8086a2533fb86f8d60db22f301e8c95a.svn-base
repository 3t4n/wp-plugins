...
class Fields{
    ...
    */
    public static function getFieldsSettings(){
        ...
        $f=[];
        $f['key'] = 'hit_enter_on_field';
        $f['def'] = 'no';
        $f['type'] = 'checkbox';
        $f['subtype'] = 'none';
        $f['label'] = esc_html__('Enter key should open Wordpress default search results','ric');
        $f['label_row_after'] = '';
        $r['general'][]=$f;
        ...
        $f=[];
        $f['key'] = 'redirect_to_search_newtab';
        $f['def'] = 'no';
        $f['type'] = 'checkbox';
        $f['subtype'] = 'none';
        $f['label'] = esc_html__('Open link to a search results in a new tab','ric');
        $f['label_row_after'] = '';
        $r['general'][]=$f;
        ...
        $f['label_row_after'] = esc_html__('On filling this, the option to choose layout will be disabled, and the modal design will be shown by default.','ric');
        $r['general'][]=$f;
