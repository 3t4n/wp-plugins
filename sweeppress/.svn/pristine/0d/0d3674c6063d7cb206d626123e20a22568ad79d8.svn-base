...
class Settings extends BaseSettings {
    ...
    protected function init() {
        ...
        $this->settings['meta'] = $this->upsell( __( 'The Pro version includes additional options for data preview and deletion.', 'coresocial' ) ) + $this->settings['meta'];
        $this->settings['expand'] = $this->upsell( __( 'The Pro version includes additional to control list of Sweepers in the admin bar menu for quick sweeping.', 'coresocial' ) ) + $this->settings['expand'];
