...
class Settings {
	...
	public function get_settings_sections() {
		$sections = array(
			array(
				...
				'desc'  => __( 'General settings for the plugin.', 'wc-variation-swatches' ),
			),
			array(
				'id'    => 'shape_settings',
				'title' => __( 'Shape Settings', 'wc-variation-swatches' ),
				'desc'  => __( 'Shape settings for the plugin.', 'wc-variation-swatches' ),
			),
			array(
				'id'    => 'tooltip_settings',
				'title' => __( 'Tooltip Settings', 'wc-variation-swatches' ),
				'desc'  => __( 'Tooltip settings for the plugin.', 'wc-variation-swatches' ),
			),
			array(
				'id'    => 'border_settings',
				'title' => __( 'Border Settings', 'wc-variation-swatches' ),
				'desc'  => __( 'Border settings for the plugin.', 'wc-variation-swatches' ),
			),
		);
	...
	public function get_settings_fields() {
		$settings_fields = array(
			'general_settings' => array(
				...
				apply_filters(
					'wc_variation_swatches_show_attr',
					array(
						'name'    => 'show_attr',
				...
				apply_filters(
					'wc_variation_swatches_catalog_pos',
					array(
						'name'    => 'catalog_pos',
	...
	public function settings_page() {
		echo '<div class="wrap">';
		printf( '<h2>%s</h2>', esc_html__( 'WC variation Swatches', 'wc-variation-swatches' ) );
