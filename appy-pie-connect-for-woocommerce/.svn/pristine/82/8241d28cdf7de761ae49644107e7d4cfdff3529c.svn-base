...
class Wc_Order_PI
{
    ...
    function update_order($request)
    {
        ...
        {
            $error->add(400, __("order_id' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
        }
    ...
    function create_order($request)
    {
        ...
        $address = array(
         ...
         if (empty($first_name))
         {
            $error->add(400, __("First name field 'first name' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         if (empty($last_name))
         {
            $error->add(400, __("Last name field 'last name' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         if (empty($address_1))
         {
            $error->add(400, __("Address field 'address' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         if (empty($city))
         {
            $error->add(400, __("City field 'city' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         if (empty($state))
         {
            $error->add(400, __("State field 'state' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         ...
         if (empty($country))
         {
            $error->add(400, __("Country field 'country' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         ...
         if (empty($email))
         {
            $error->add(400, __("Email field 'email' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         if (!is_email($email))
         {
            $error->add(400, __("Invalid E-mail-id.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
         ...
         if (empty($phone))
         {
            $error->add(400, __("Phone field 'phone' is required.", 'appy-pie-connect-for-woocommerce') , array(
                'status' => 400
            ));
            return $error;
         }
