...
== Changelog ==
2.1.4 Small adjustment to HPOS logic to support older versions of WooCommerce
2.1.3 Small change to age verification. Now the product setting can override category age restriction setting.
2.1.2 Added more languages to freepay settings
2.1.1 Added support for HPOS when Subscriptions for WooCommerce plugin is installed
2.1.0 Added age verification property on product category level
2.0.10 Fix for notification about depriacted function call wc_get_log_file_path
2.0.9 Bulk editing of Age verification product settings
2.0.8 Age verification logic
2.0.7 Added ViaBill icon for checkout
2.0.6 Void authorization when order is cancelled configuration option added
2.0.5 Added customer email to payment generation parameters
2.0.4 Added card icons to block layout design
2.0.3 Small fix for missing array variable "is_renew" error in the error log.
