	...
	public static function get_fields() {
		$fields =
			[
				...
				'freepay_voidoncancel' => [
					'title'       => __( 'Delete Freepay authorization on order cancellation', 'freepay-for-woocommerce' ),
					'type'        => 'checkbox',
					'label'       => __( 'Enable', 'freepay-for-woocommerce' ),
					'description' => __( 'When enabled freepay payments will automatically be deleted/voided when order state is set to "Cancelled".', 'freepay-for-woocommerce' ),
					'default'     => 'no',
					'desc_tip'    => true,
				],
				...
				'freepay_ageverificationmode'             => [
					'title'       => __( 'Age verification mode', 'freepay-for-woocommerce' ),
					'type'        => 'checkbox',
					'description' => __( 'Enable age verification.', 'freepay-for-woocommerce' ),
					'default'     => 'no',
					'desc_tip'    => true,
				],
			];
