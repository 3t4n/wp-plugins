    ...
    class KCP_CSPGEN_Settings {
        ...
        */
        private function kcp_cspgen_menu( ) : void {
            ...
            if( class_exists( 'KPSHG' ) ) {
                ...
                // are we allowing the child-site overrides
                $_allow_child_overrides = filter_var( KCP_CSPGEN_Common::get_our_option( 'apply_child_override', true ), FILTER_VALIDATE_BOOLEAN );

                // our settings id
                $_settings_id = 'wpsh_settings';

                if( ( KCP_CSPGEN_Common::is_child_site( ) ) ) {
                ...
                // if we're in the network admin... or we're allowed to be here
                if( ( KCP_CSPGEN_Common::is_child_site( ) && KCP_CSPGEN_Common::section_is_allowed( 1 ) ) ) {
                ...
                // if we're in the network admin... or we're allowed to be here
                if( ( KCP_CSPGEN_Common::is_child_site( ) && KCP_CSPGEN_Common::section_is_allowed( 2 ) ) ) {

                    // Content Security Policy
                    KPSHG::createSection( $_settings_id, 
                        array(
                            'title'  => __( 'Content Security Policy', 'security-header-generator' ),
                ...
                // if we're in the network admin... or we're allowed to be here
                if( ( KCP_CSPGEN_Common::is_child_site( ) && KCP_CSPGEN_Common::section_is_allowed( 3 ) ) ) {

                    // Feature / Permissions Policy
                    KPSHG::createSection( $_settings_id, 
                        array(
                            'title'  => __( 'Permissions Policy', 'security-header-generator' ),
                ...
                // if we're in the network admin... or we're allowed to be here
                if( ( KCP_CSPGEN_Common::is_child_site( ) && (
                    KCP_CSPGEN_Common::section_is_allowed( 1 ) || KCP_CSPGEN_Common::section_is_allowed( 2 ) || KCP_CSPGEN_Common::section_is_allowed( 3 )
                ) ) ) {
        ...
        */
        private function kcp_content_security_policy_headers( ) : array {
            ...
            $_dir = ( KCP_CSPGEN_Common::get_csp_directives( ) ) ?? array( );
                ...
                // we don't want the full fields set for the report-to directive
                    ...
                    $_ret_dir[] = array(
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'default' => 0,
                            'attributes' => array( 'type' => 'hidden', 'readonly' => 'readonly' ),
                            'dependency' => array( 'generate_csp', '==', true ),
                            'class' => 'kpsh-half-field',
                        )
                ...
                // it's not, we can move on
                    ...
                    $_ret_dir[] = array(
                        ...
                        array(
                            ...
                            'type' => 'checkbox',
                            'options' => array(
                                // 0 => __( 'Nothing', 'security-header-generator' ), // this needs to be removed.  There is no reason to have it.
