    ...
    */
    class KCP_CSPGEN_Headers {
        ...
        */
         ...
         * 
         * This method is responsible for adding the headers to the front end
         * 
         * @since 7.4
         * @access private
         * @author Kevin Pirnie <me@kpirnie.com>
        ...
        */
        private function add_the_frontend_headers( ) : void {
            ...
            add_action( 'send_headers', function( ) : void { 
                ...
                $_gen_headers = ( $this -> kp_populate_header_array( ) ) ?? array( );
        ...
        */
        private function add_the_restapi_headers( ) : void {
            ...
            add_action( 'rest_api_init', function( ) : void {
                ...
                // apply_csp_to_rest
                $_apply_to_rest = filter_var( KCP_CSPGEN_Common::get_our_option( 'apply_to_rest', true ), FILTER_VALIDATE_BOOLEAN );
        ...
        */
        private function kp_populate_header_array( ) : array {
            ...
            $_admin_apply = filter_var( KCP_CSPGEN_Common::get_our_option( 'apply_to_admin', false ), FILTER_VALIDATE_BOOLEAN ) && is_admin( );

            // set the apply to admin flag for the content security headers
            $_admin_csp_apply = filter_var( KCP_CSPGEN_Common::get_our_option( 'apply_csp_to_admin', false ), FILTER_VALIDATE_BOOLEAN ) && is_admin( );

            // set the apply to admin flag for the feature policy headers
            $_admin_fp_apply = filter_var( KCP_CSPGEN_Common::get_our_option( 'apply_fp_to_admin', false ), FILTER_VALIDATE_BOOLEAN ) && is_admin( );

            // include STS setting
            $_apply_sts = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_sts', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_sts ) {
                ...
                $_age = ( KCP_CSPGEN_Common::get_our_option( 'include_sts_max_age', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'include_sts_max_age', true ) : 31536000;
                $_include = ( KCP_CSPGEN_Common::get_our_option( 'include_sts_subdomains', true ) ) ? 'includeSubdomains;' : '';
                $_preload = ( KCP_CSPGEN_Common::get_our_option( 'include_sts_preload', true ) ) ? 'preload;' : '';
            ...
            $_apply_ect = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_expectct', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            $_apply_ofs = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_ofs', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_ofs ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    $_ret['X-Frame-Options'] = ( KCP_CSPGEN_Common::get_our_option( 'include_ofs_type', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'include_ofs_type', true ) : 'DENY';
            ...
            // include ACO setting
            $_apply_aco = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_acao', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_aco ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    // setup the origin
                    $_origin = ( KCP_CSPGEN_Common::get_our_option( 'include_acao_origin', true ) ) ?: '*';
            ...
            $_apply_mimesniffing = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_mimesniffing', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            $_apply_rp = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_referrer_policy', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_rp ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    $_ret['Referrer-Policy'] = ( KCP_CSPGEN_Common::get_our_option( 'include_referrer_policy_setting', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'include_referrer_policy_setting', true ) : 'strict-origin';
            ...
            $_apply_dl = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_download_options', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            $_apply_cdo = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_crossdomain', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            $_apply_coep = filter_var( KCP_CSPGEN_Common::get_our_option( 'coep', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_coep ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    // append the header
                    $_ret['Cross-Origin-Embedder-Policy'] = ( KCP_CSPGEN_Common::get_our_option( 'coep_setting', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'coep_setting', true ) : 'unsafe-none';
            ...
            $_apply_coop = filter_var( KCP_CSPGEN_Common::get_our_option( 'coop', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_coop  ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    // append the header
                    $_ret['Cross-Origin-Opener-Policy'] = ( KCP_CSPGEN_Common::get_our_option( 'coop_setting', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'coop_setting', true ) : 'unsafe-none';
            ...
            $_apply_corp = filter_var( KCP_CSPGEN_Common::get_our_option( 'corp', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_corp ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    // append the header
                    $_ret['Cross-Origin-Resource-Policy'] = ( KCP_CSPGEN_Common::get_our_option( 'corp_setting', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'corp_setting', true ) : 'same-origin';
            ...
            $_apply_acam = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_acam', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_acam ) {
                ...
                if( $_admin_apply || ( ! is_admin( ) ) ) {
                    ...
                    // get the methods
                    $_methods = ( KCP_CSPGEN_Common::get_our_option( 'include_acam_methods', true ) ) ? KCP_CSPGEN_Common::get_our_option( 'include_acam_methods', true ) : array( 'GET', 'POST', 'HEAD' );
            ...
            $_apply_acac = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_acac', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            $_apply_fp = filter_var( KCP_CSPGEN_Common::get_our_option( 'feature_policy', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            // include content security Policy setting
            $_apply_csp = filter_var( KCP_CSPGEN_Common::get_our_option( 'generate_csp', false ), FILTER_VALIDATE_BOOLEAN );
            ...
            if( $_apply_csp ) {
                ...
                if( $_admin_csp_apply || ( ! is_admin( ) ) ) {
                    ...
                    $_apply_upgrade = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_upgrade_insecure', false ), FILTER_VALIDATE_BOOLEAN );
        ...
        */
        private function kp_csp_builder( ) : string {
            ...
            foreach( $_directives as $_key => $_val ) {
                ...
                $_uris = KCP_CSPGEN_Common::get_our_option( $_val['id'], true );

                // get the unsafe config
                $_unsafe = KCP_CSPGEN_Common::get_our_option( $_val['id'] . '_allow_unsafe', true );
        ...
        */
        private function kp_csp_wp_defaults( string $_setting ) : string {
            ...
            $_defaults_allowed = filter_var( KCP_CSPGEN_Common::get_our_option( 'include_wordpress_defaults', true ), FILTER_VALIDATE_BOOLEAN );
        ...
        */
        private function kp_permissions_policy_builder( ) : string {
            ...
            $_directives = ( KCP_CSPGEN_Common::get_permissions_directives( ) ) ?? array( );

            // get the configured options
            $_options = KCP_CSPGEN_Common::get_our_option( 'feature_policies', true );
