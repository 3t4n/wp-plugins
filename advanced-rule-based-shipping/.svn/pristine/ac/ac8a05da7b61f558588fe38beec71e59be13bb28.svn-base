...
<table class="table-advanced-rule-based-shipping-rule">
    ...
    <template v-if="!collapse">
        ...
        <tr>
            ...
            <td class="shipping-cost-type-cell">
                ...
                <select v-model="shipping_cost_operator" v-if="['based_on_weight', 'based_on_quantity', 'based_on_subtotal'].includes(shipping_cost_type)">
                ...
                <template v-if="['based_on_weight', 'based_on_quantity', 'based_on_subtotal'].includes(shipping_cost_type)">
        ...
        <tr v-if="['based_on_weight', 'based_on_quantity', 'based_on_subtotal'].includes(shipping_cost_type)">
            <th class="vcenter"></th>
            <td class="shipping-cost-type-cell">
                <template v-if="'based_on_subtotal' == shipping_cost_type">
                    <label style="margin-left: 5px;">
                        <input type="checkbox" v-model="shipping_cost_including_tax">
                        <?php esc_html_e('Including Tax', 'advanced-rule-based-shipping'); ?>
                    </label>

                    <label style="margin-left: 6px;">
                        <input type="checkbox" v-model="shipping_cost_exclude_discount">
                        <?php esc_html_e('Exclude Discount', 'advanced-rule-based-shipping'); ?>
                    </label>
                </template>

                <label style="margin-left: 6px;" v-if="['based_on_weight', 'based_on_quantity', 'based_on_subtotal'].includes(shipping_cost_type)">
                    <input type="checkbox" v-model="shipping_cost_exclude_virtual_products">
