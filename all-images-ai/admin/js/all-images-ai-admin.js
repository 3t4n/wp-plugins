(function( $ ) {
	...
	$(document).ready(function() {
		...
		$('.all-images-image-wrapper').on('submit', 'form.modal-form', function(e) {
			import_callback(e, $(this).closest('.all-images-image-wrapper'));
		});
		$('.all-images-image-wrapper').on('click', '.trigger-download', function(e) {
			import_callback(e, $(this).closest('.all-images-image-wrapper'));
		});

		$('.all-images-image-wrapper').on('click', 'a.settings.open-modal', function (e) {
			e.preventDefault();
			$('.ai-modal-window.open').removeClass('open');
