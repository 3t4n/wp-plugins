...
function ibamu_admin_add_assets() {
    wp_enqueue_style('lawwwing-admin-styles', plugins_url('/css/lw-styles.css', __FILE__ ), array(), "1.2.8");
    wp_enqueue_style('lawwwing-font-awesome', "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css", array(), "1.2.8");
}
...
function ibamu_options_page_html() {
    ...
    <div class="lawwwing-wrapper">
        <div class="lawwwing-header" id="ibamu-header">
            ...
            <div class="lawwwing-header-links">
                <div>
                   <a href="https://docs.lawwwing.com" title="Documentación" target="_blank"> <i class="fa-solid fa-book"></i> Documentación</a>
                </div>
                <div>
                   <a href="https://app.lawwwing.com/login/" title="Abrir dashboard" target="_blank"> <i class="fa-solid fa-bars-progress"></i> Dashboard</a>
                </div>
                <div>
                   <a href="https://lawwwing.com/contacto/" title="Contacto" target="_blank"> <i class="fa-solid fa-phone"></i> Contacto</a>
                </div>
                <div class="lawwwing-version">
                    v1.2.8
                </div>
            </div>
        </div>
        <div class="lawwwing-content">
                ...
                <div class="lawwwing-plan-card">
                    ...
                    <div class="lawwwing-plan-card-bottom">
                        <div class="lawwwing-plan-card-bottom-left">
                            ...
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Actualizaciones automáticas</p>
                        ...
                        <div class="lawwwing-plan-card-bottom-right">
                            ...
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Microsoft UET Consent Mode</p>

                            <p class="lawwwing-bullet-element"><i class="fas fa-circle-xmark"></i>Métricas de consentimiento</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-circle-xmark"></i>IAB TCF v2.2</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-circle-xmark"></i>Lawwwing SOS</p>
                        </div>
                    </div>
                ...
                <div class="lawwwing-plan-card">
                    ...
                    <div class="lawwwing-plan-card-bottom">
                        ...
                        <div class="lawwwing-plan-card-bottom-right">
                            ...
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Escaneo <u>diario</u></p>

                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Google Consent Mode v2</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Microsoft UET Consent Mode</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Métricas de consentimiento</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>IAB TCF v2.2</p>
                            <p class="lawwwing-bullet-element"><i class="fas fa-check-circle"></i>Lawwwing SOS</p>
                        </div>
                    </div>
                    <div class="lawwwing-plans-wrapper">
                        <div class="lawwwing-plan">
            ...
            <div class="lawwwing-configuration-wrapper">
                ...
                <div class="lawwwing-configuration-columns-wrapper">
                    <div class="lawwwing-configuration-column">
                        <p class="lawwwing-configuration-column-description">
                        Para <strong>configurar</strong> el plugin necesitarás <strong>rellenar el formulario</strong> con el "plugin id" que encontrarás en tu <a class="ibamu-url" href="https://lawwwing.com/signup/" target="_blank">panel de Lawwwing.</a>
                        </p>
                        <form class="lawwwing-configuration-form-input" action="options.php" method="post">
                            <?php
                    ...
                    <div class="lawwwing-configuration-column">
                        ...
                        <div class="lawwwing-configuration-badges">
                            <img src="https://cdn.lawwwing.com/media/catalogue/files/2025/01/iab_logo_registered_cmp_base.webp" height="80">
                            <img src="https://cdn.lawwwing.com/media/catalogue/files/2025/01/google-cmp-badge.svg" height="100">
                            <img src="https://cdn.lawwwing.com/media/catalogue/files/2025/01/uet-consent-mode.png" height="100">
                        </div>
                    </div>
                </div>
            </div>
...
function lawwwing_include_plugin() {
    ...
    wp_enqueue_script("lawwwing-plugin", $base_script, "", "1.2.8");
}
