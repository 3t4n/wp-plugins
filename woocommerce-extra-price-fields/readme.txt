...
= Enhanced Product Descriptions: = With our plugin, you can effortlessly enrich your product listings by adding supplementary price descriptions. Whether it's highlighting special features, bonuses, or discounts, you can now convey important details directly to your customers.
...
= Boosted Sales: =
By providing comprehensive information about your products, you empower your customers to make informed purchase decisions. This can result in increased trust and higher conversion rates.
...
* Show extra price info for variable products
* Use shortcode in price info
...
* [Views for WPForms](https://wordpress.org/plugins/views-for-wpforms-lite)
* [Views for Ninja Forms](https://wordpress.org/plugins/views-for-ninja-forms)
* [Views for Contact Form 7](https://wordpress.org/plugins/cf7-views/)
...
Install it and edit/create a new product. Add the info into the newly created fields under Advanced tab.For more Info check the screenshots.
...
== Changelog ==
= 2.0 =
* Added compatibility for woocommerce v3.5+.
...
* Removed deprecated code to retrieve product id.
