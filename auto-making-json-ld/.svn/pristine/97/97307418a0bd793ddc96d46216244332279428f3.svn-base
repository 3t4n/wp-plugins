...
//=====[ private ]=====//
if(!defined('amJL_detailed_page_link'))	define('amJL_detailed_page_link', 'https://richynokurashi.com');
if(!defined('amJL_api_URL'))		define('amJL_api_URL', 'https://api.richynokurashi.com');
