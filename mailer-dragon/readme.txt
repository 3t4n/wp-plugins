...
Tags: newsletter,email,email newsletter,autoresponder,email marketing
...
* *Your translation? - [Just send it in](https://implecode.com/contact/)*

*Note:* All our plugins are localized/translatable by default. This is very important for all users worldwide. So please contribute your language to the plugin to make it even more useful. For translating we recommend the awesome ["Codestyling Localization" plugin](https://wordpress.org/extend/plugins/codestyling-localization/).
