...
Tags: work, portfolio, freelance, custom post type, cpt, guerrilla
...
Currently, the [Clarirty](http://www.madebyguerrilla.com/clarity-wordpress-theme) WordPress theme is the first to adopt this plugin so it will work perfect right out of the box. *see screenshots*
...
1. The admin panel option for you to view, or add new work in it's own custom post type.
2. This is how the plugin works out of the box (with the template files added to your theme)
3. This is a screenshot of the backend options built into the Work custom post type.
4. In your admin panel sidebar, this is what you will see
