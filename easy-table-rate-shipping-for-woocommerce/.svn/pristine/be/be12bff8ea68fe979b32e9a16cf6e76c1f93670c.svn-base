...
👉 [Pro Version](https://exlac.com/downloads/easy-table-rate-shipping-pro-for-woocommerce/) | [Documentation](https://exlac.com/docs/easy-table-rate-shipping-pro-for-woocommerce/) | [Support](https://exlac.com/contact-us/) 👈
...
More features are available in the  [__Pro version__](https://exlac.com/downloads/easy-table-rate-shipping-pro-for-woocommerce/).
...
👉 Like us on Facebook : [Exlac](https://www.facebook.com/exlac)
👉 Official YouTube Channel : [YouTube](https://www.youtube.com/@exlacofficial)
...
After installing and activating the plugin, you go to  "Settings" menu from "WooCommerce": then

1. Click on shipping tab.
2. Click on "Add shipping zone"
3. Customize Zone name and Zone regions and then click on "add shipping method" button and select "Table Rate Shipping option".
2. Finally click On "Add new" and customize all.


== Screenshots ==
1. Add shipping method
2. List of shipping method
...
* Fixed : CSS issue
= 1.0.1 =
* Fixed : Default value of "Based ON" shipping
= 1.0.0 =
* Initial release
