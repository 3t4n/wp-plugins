...
Contributors: 
Tags: Auto refresh, Post refresh, Page refresh, Scheduled refresh, Custom refresh timing
...
A select field where user can select the unit of time like Hours, Minutes, Seconds along time field
