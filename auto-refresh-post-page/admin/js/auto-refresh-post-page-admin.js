            ...
            jQuery('#cb_global_save_post').on('click', function() {
              ...
              var data = {};
                ...
                jQuery('.js-time-field').each(function() {
                  ...
                  // Include the selected time unit
                  var timeUnitKey = 'time_unit-' + key.split('-')[1];
                  var timeUnitValue = jQuery(this).siblings('.js-time-unit').val();
                  data[timeUnitKey] = timeUnitValue;
              });
                console.log(data);
