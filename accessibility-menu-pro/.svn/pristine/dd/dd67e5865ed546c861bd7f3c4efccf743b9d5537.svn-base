...
function applyGeneralStyles(baseClassName) {
  ...
  const parentArrowElementHeight = tarray.menu_options[baseClassName].parent_arrow_element_height;
  const submenuArrowElementHeight = tarray.menu_options[baseClassName].submenu_arrow_element_height;
  ...
  style.innerHTML = `
    ...
    .${baseClassName}_accessibility_menu_pro_dd_button {
      ...
      width: 55px;
      height: ${parentArrowElementHeight}px;
      padding-top: 0px;
      display: flex;
    ...
    ul ul .${baseClassName}_accessibility_menu_pro_dd_button {
      height: ${submenuArrowElementHeight}px;
      margin-top: 0px;
    }
