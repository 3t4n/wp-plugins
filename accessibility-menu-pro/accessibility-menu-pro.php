...
function ampro_add_assets() {
  ...
  foreach ($menu_names as $menu_name) {
    $menu_options[$menu_name] = array(
      ...
      'parent_arrow_element_height' => get_option("ampro_parent_arrow_element_height_" . $menu_name, '48'),
      'submenu_arrow_element_height' => get_option("ampro_submenu_arrow_element_height_" . $menu_name, '45'),
