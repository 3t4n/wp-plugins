...
View all previous change items at https://www.theblog.ca/anti-spam-history
*/
...
<form name="cas_current_settings" method="post" action="<?php print '?page=' . basename(__FILE__); ?>">
...
print "<hr />\n";
print "<p>Need more help? Post a comment on the <a href=\"https://www.theblog.ca/anti-spam\" title=\"Where all information is posted about the plugin\">Peter's Custom Anti-Spam page</a>.</p>\n";
print "</div>\n";
}
