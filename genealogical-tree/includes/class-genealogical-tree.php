...
class Genealogical_Tree {
    ...
    private function define_admin_hooks() {
        ...
        //$this->loader->add_action('wp_ajax_nopriv_get_posts_by_term_or_no_term', $plugin_admin, 'get_posts_by_term_or_no_term_ajax'); // If needed for non-logged in users
        // Meta Box.
        ...
        // Add a filter to modify the arguments passed to `get_terms()`.
        /**
         * This filter modifies the arguments passed to `get_terms()` to restrict
         * the terms displayed for the 'gt-family-group' taxonomy.
         *
         * Reference:
        ...
        $this->loader->add_filter(
            'get_terms_args',
            // The filter hook to modify term query arguments.
            $plugin_admin_family,
            // The instance of the class containing the callback method.
            'gt_family_group_filter',
            // The method name to be executed for the filter.
            10,
