...
class EnODFLfreightFdo
{
    ...
    public function en_cart_package($package)
    {
        ...
        $this->en_fdo_meta_data['plugin_name'] = 'odfl_quotes';
        $accessorials['residential'] = get_option('odfl_residential') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('odfl_liftgate') == 'yes' ? true : false;
        $accessorials['inside'] = get_option('odfl_accessorial_inside_delivery') == 'yes' ? true : false;
