 ...
 */
if (!function_exists('en_odfl_shipping_rules_template')) {
    function en_odfl_shipping_rules_template($action = false)
    {
      ob_start();

      global $wpdb;
      $shipping_rules_list = $wpdb->get_results(
          "SELECT * FROM " . $wpdb->prefix . "eniture_odfl_shipping_rules"
      );

      ?>
        <div>
          <table class="en_wd_warehouse_list" id="en_odfl_shipping_rules_list">
            <!-- Table Headings -->
            <thead>
                  <tr>
              ...
              <?php
                if (count($shipping_rules_list) > 0) {
                  ...
                  foreach ($shipping_rules_list as $rule) {
                    ...
                    ?>
                      <tr id="sr_row_<?php echo (isset($rule->id)) ? esc_attr($rule->id) : ''; ?>">
                        ...
                        <td class="en_wd_warehouse_list_data">
                          <a href="#" class="en_odfl_sr_status_link" data-id="<?php echo (isset($rule->id)) ? esc_attr($rule->id) : ''; ?>" data-status="<?php echo $rule->is_active; ?>"><?php echo $rule->is_active ? 'Yes' : 'No'; ?></a>
                        </td>
                        <td class="en_wd_warehouse_list_data">
                          <!-- Edit rule link -->
                          <a href="#" class="en_odfl_sr_edit_link" data-id="<?php echo (isset($rule->id)) ? esc_attr($rule->id) : ''; ?>">
                            <img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit">
                          </a>
                          <!-- Delete rule link -->
                          <a href="#" class="en_odfl_sr_delete_link" data-id="<?php echo (isset($rule->id)) ? esc_attr($rule->id) : ''; ?>">
                            <img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete">
                          </a>
                        </td>
                      </tr>
                    <?php
                  ...
                  ?>
                    <tr class="new_warehouse_add en_odfl_empty_sr_row" data-id=0>
...
<div class="en_odfl_shipping_rules_setting_section">
    <br />
    <!-- Add rule button -->
    <div class="en_sr_add_btn">
      <a href="#en_odfl_add_sr_btn" title="Add Rule"
             class="en_odfl_add_sr_btn button-primary" id="en_odfl_add_shipping_rule_btn">Add Rule</a>
    </div>

    <div class="updated inline warehouse_deleted odfl_sr_deleted">
      <p><strong>Success!</strong> Shipping rule is deleted successfully.</p>
    </div>
    <div class="updated inline warehouse_created odfl_sr_created">
        <p><strong>Success!</strong> Shipping rule is added successfully.</p>
    </div>
    <div class="updated inline warehouse_updated odfl_sr_updated">
        <p><strong>Success!</strong> Shipping rule is updated successfully.</p>
    </div>

    <!-- Shipping rules data table -->
    <?php en_odfl_shipping_rules_template(); ?>

    <!-- Add popup for new rule -->
    <div id="en_odfl_add_sr_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup en_odfl_add_sr_popup">
            <h2 class="warehouse_heading">Add Rule</h2>
            <a class="close" href="#">&times;</a>
            <div class="content" id="en_odfl_sr_content" style="overflow-y: auto; height: 80vh;">

              <div class="already_exist odfl_sr_already_exist">
                <strong>Error!</strong> Shipping rule with this name already exists.
              </div>
                <!-- Wordpress Form closed -->
                </form>

                <form id="odfl_add_shipping_rule" role="form">
                    ...
                    <!-- Type -->
                    <div class="en_sr_form_control">
                        <label for="en_odfl_sr_rule_type">Type</label>
                        <select name="en_odfl_sr_rule_type" id="en_odfl_sr_rule_type">
                    ...
                    <div class="en_sr_override_rates">
                      ...
                      <div class="en_sr_form_control">
                          ...
                          <select name="en_sr_service" id="en_sr_service">
                            ...
                            <?php 
                              $services = ['transportation_service' => 'Transportation service', 'residential_delivery_service' => 'Residential delivery service', 'liftgate_delivery_service' => 'Lift gate delivery service', 'hat_service' => 'Hold at terminal service'];
                      ...
                      <div class="en_sr_form_control">
                        <div>
                          <label for="filter_by_country">
                            <input type="checkbox" title="Filter by country" name="filter_by_country" id="filter_by_country"> Filter by country
                          </label>
                        </div>
                        <span class="en_sr_err"></span>
                      </div>
                      <div class="en_sr_form_control">
                        <select name="en_sr_country" id="en_sr_country">
                    ...
                    <!-- Form submit button -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form en_odfl_save_shipping_rule_form">
                    </div>
                </form>
            </div>
        </div>
