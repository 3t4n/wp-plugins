...
if (!class_exists("EnODFLWDQuotes")) {

    class EnODFLWDQuotes
    {

        public function __construct()
        {
            add_filter('en_wd_update_query_string', array($this, 'en_wd_update_query_string'), 10, 1);
            add_filter('en_odfl_wd_origin_array_set', array($this, 'en_odfl_wd_origin_array_set'), 10, 1);
        ...
        public function suppress_local_delivery($quotes, $origin_array, $package_plugin, $Instor_pickup_local_delivery)
        {
            ...
            return ($origin_array['suppress_local_delivery'] != 1 || is_admin()) ? $quotes : [];
        }
         ...
         * @return array type
         */
        public function en_odfl_wd_origin_array_set($origin)
        {
            ...
            $odfl_account = (isset($origin->odfl_account)) ? $origin->odfl_account : "";
            ...
            return array(
                ...
                'location' => $location,
                'country' => $country,
                'odfl_account' => $odfl_account,
                'account_number' => $odfl_account,
