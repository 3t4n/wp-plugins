...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#en_wd_origin_zip").keydown(function (e) {
            console.log(e.which);
            ...
            {
                jQuery("#en_wd_origin_zip").val(this.value.toUpperCase());
            }
        });

        jQuery("#en_wd_origin_state").keyup(function (e) {

            jQuery("#en_wd_origin_state").val(this.value.toUpperCase());
        });

        jQuery("#en_wd_origin_country").keyup(function (e) {

            jQuery("#en_wd_origin_country").val(this.value.toUpperCase());
        });

    });
    function odfl_en_wd_add_warehouse_btn()
    {
    ...
    function odfl_change_warehouse_zip()
    {
        if (jQuery("#en_wd_origin_zip").val() == '') {
            return false;
        }
        
        // check current zip-code and test connection zip-code is same then hide the account field
        var get_input_zip = jQuery('#en_wd_origin_zip').val();
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    <h1>Warehouses</h1><br>
    <?php echo apply_filters('en_append_account_number_hidden_multiple_plugins', '', 20); ?>
    <?php odfl_warehouse_template(); ?>

    <!-- Add Popup for new warehouse -->
    <div id="odfl_en_wd_add_warehouse_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup">
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <div class="dynamic_warehouse_error wrng_standard_pckg">
                    <p></p>
                </div>
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Zip"  maxlength="7" onchange="odfl_change_warehouse_zip()" value="" name="en_wd_origin_zip" placeholder="30214" id="en_wd_origin_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="numericonly" title="Handling Fee / Markup" name="en_wd_origin_markup"
                                data-optional="1" value="" placeholder="e.g Currency 1.00 or percentage 5%" id="en_wd_origin_markup">
                    </div>
                    <div class="en_warehouse_custom_input_section">
                ...
                -->
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <input type="checkbox" title="Enable in-store pick up" data-optional="1" id="enable-instore-pickup" name="enable-instore-pickup" value="" class="enable-instore-pickup <?php echo $disabled; ?>" />
                        </div>
                    </div>
                    <div class="en_wd_add_warehouse_input ">
                ...
                -->
                    <div class="form-btns">
                    <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form" onclick="return odfl_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
