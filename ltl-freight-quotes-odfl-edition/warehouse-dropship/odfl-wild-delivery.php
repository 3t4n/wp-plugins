<?php
    ...
    require_once 'wild/includes/odfl-wild-delivery-save.php';
    
    
    /**
     * Admin Warehouse Dropship Scripts
     */
    if(!function_exists("odfl_en_woo_wd_admin_script_style"))
    {
        function odfl_en_woo_wd_admin_script_style() 
        {
            ...
            wp_enqueue_script('en_odfl_woo_wd_script', plugin_dir_url(__FILE__) . '/wild/assets/js/odfl_warehouse_section.js', [], '2.1.6');
            wp_localize_script('en_odfl_woo_wd_script', 'en_odfl_wh_script', array(
                    'pluginsUrl' => plugins_url(),
                    'nonce' => wp_create_nonce('en_odfl_woo_wd_nonce'),
                ));

            wp_register_style('odfl_warehouse_section', plugin_dir_url(__FILE__) . '/wild/assets/css/odfl_warehouse_section.css', false, '2.1.5');
            wp_enqueue_style('odfl_warehouse_section');
        }

        add_action('admin_enqueue_scripts', 'odfl_en_woo_wd_admin_script_style');
    }
    
    /**
     * Warehouse Template
     */
    if(!function_exists('odfl_warehouse_template'))
    {
        function odfl_warehouse_template($action = FALSE){
        ...
        <div class="add_btn_warehouse">
            ...
            <a href="#odfl_en_wd_add_warehouse_btn" onclick="odfl_en_wd_add_warehouse_btn()" title="Add Warehouse" class="odfl_en_wd_add_warehouse_btn <?php echo $multi_warehouse_disabled; ?>" name="avc">Add</a>
                ...
                if (count($warehous_list) > 0) {
                    ...
                    foreach ($warehous_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? $tr_disabled_me : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>" data-id="<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_warehouse_list_data">
                                <a href="javascript(0)" onclick="return odfl_en_wd_edit_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_odfl_wd_delete_current_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
     ...
     * Dropship Template
     */
    if(!function_exists('odfl_dropship_template'))
    {
        function odfl_dropship_template($action = FALSE){
        ...
        <div class="add_btn_dropship">
            <a href="#add_dropship_btn" onclick="odfl_hide_drop_val()" title="Add Drop Ship" class="en_wd_add_dropship_btn odfl_hide_drop_val <?php echo $multi_dropship_disabled; ?>">Add</a>
                ...
                if (count($dropship_list) > 0) {
                    ...
                    foreach ($dropship_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? $tr_disabled_me : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_dropship_list_data">
                                <a href="javascript(0)" onclick="return odfl_en_wd_edit_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_odfl_wd_delete_current_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-odfl-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
