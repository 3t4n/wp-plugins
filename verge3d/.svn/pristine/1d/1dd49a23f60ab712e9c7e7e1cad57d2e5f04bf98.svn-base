...
= 4.8.3 =
* Fixed bug with Chrome/Chromium not able to produce PDF attachments/quotes/invoices.
* Fixed possible security issues.
* Remove unusable product_admin_form.php template.

= 4.8.2 =
* Fixed app uploading error on macOS and Linux.

= 4.8.1 =
* Fixed security issue with possible XSS.

= 4.8.0 =
* Verge3D 4.8 version bump.
