...
Tags: Tags: abandoned carts, email marketing, woocommerce, cart abandonment, woocommerce emails, sms
Requires at least: 3.8.0
Requires PHP: 5.6
Tested up to: 6.7
Last Updated: 2025-Feb-14
Stable tag: 1.0.44
License: GPLv2 or later

Recapture is the easiest and most effective way to recover abandoned carts and do SMS and email marketing for your WooCommerce store in WordPress. Recommended by Jilt as the best alternative for abandoned cart recovery in WooCommerce.

== Description ==

[Main Site](https://recapture.io/) | [Support](https://recapture.io/contact) | [Docs](https://docs.recapture.io/)

Recapture is the easiest and most effective way to recover abandoned carts and do email marketing for your WooCommerce site.  We also support [Easy Digital Downloads abandoned cart recovery](https://wordpress.org/plugins/recapture-for-edd/) as well!

**NOTE:**
> **Requires: WooCommerce 3.0** or newer and a free Recapture account

Recapture helps your store increase sales.  This plugin connects Recapture to WooCommerce to send triggered emails to your customers to recover abandoned carts for WooCommerce, win back old customers, or request reviews.

= ** Recapture has a long history of success with Abandoned Carts ** =

_Recapture has already helped merchants generate **over $280,000,000** in additional revenue since 2015._  We're recovering hundreds of thousands a week for stores like yours.

Recapture's [abandoned cart recovery for WooCommerce](https://recapture.io/abandoned-carts-woocommerce) helps your ecommerce store **recover lost revenue** from abandoned carts for WooCommerce.  Recapture tracks when carts are abandoned on your store, then lets you send recovery emails to encourage the customers who abandoned these carts to complete the purchase.
...
Recapture is backed by a team with a long history of ecommerce success.  Recapture Abandoned Carts for WooCommerce works on any store and scales automatically with our AWS load-balanced, multi-server infrastructure.  We handle stores of all sizes.  No need to worry as you grow!

= ** Friendly, responsive support ** =

_We (heart) our merchants and ecommerce_

Our #1 goal is to make your store more successful, and we love to do it!  [Contact us for support](http://recapture.io/contact/) and find out what sets us apart from so many other WordPress plugins.  Live chat available in the Recapture dashboard.

= More Details =

**Translators:** the plugin text domain is: `recapture-for-woocommerce`
...
2.  To install the plugin, you can do one of the following:
    ...
    - (Recommended) Search for "Recapture Abandoned Carts for WooCommerce" under Plugins &gt; Add New
    - Upload the entire `recapture-for-woocommerce` folder to the `/wp-content/plugins/` directory.
...
Yes, a free Recapture account is required to recover abandoned carts for your WooCommerce store (we'll create one for you on install, automatically!).  You can recover up to $500 completely free, You can [learn more about Recapture pricing here](https://recapture.io/pricing/) for our paid accounts.
...
Yep! Recapture can find and include WooCommerce coupon codes in your automated emails.  This gives you a proven and powerful means of increasing conversion rates and generating more orders!

= Do you support broadcast emails? =

Yes.  As of July 2021, Recapture can now send broadcast campaigns to promote your sales, send newsletters and more.
...
2.  Configure your store settings once you're connected
...
= 1.0.43 =
* Support generic currency conversion for carts and orders

= 1.0.42 =
* Add option to disable recreating a cart if no meta data is available

= 1.0.41 =
* Fix an issue adding a Recapture admin sub-menu

= 1.0.40 =
* Support WCML currency conversion and switcher

= 1.0.39 =
* Fix issue with sending discount codes to Recapture when an order status changes

= 1.0.38 =
* Send discount codes and adjusted prices with order conversion data

= 1.0.37 =
* Don't send empty cart updates to Recapture if it is the first time that the cart is initialized.
...
= 1.0.34 =
* Fixed an issue when processing order status updates that occasionally created duplicate carts for admin users.

= 1.0.33 =
* Avoid optimize API calls to Recapture.

= 1.0.32 =
* Correctly handle WooCommerce carts associated with a user account and loaded at login.

= 1.0.31 =
* Support user defined product block
...
= 1.0.28.1 =
* Add endpoint to disable a discount code

= 1.0.28 =
* Support discount code expiry dates

= 1.0.27 =
* Fix static/non-static function call issue

= 1.0.26 =
* Support custom WooCommerce order statuses
* Update Recapture api URL

= 1.0.25 =
* Multi-currency support with WOOCS – Currency Switcher for WooCommerce
...
= 1.0.23 =
* Include WooCommerce cart context when saving and recovering abandoned carts.

= 1.0.22 =
* Include customer name in order conversion

= 1.0.21 =
* Fix incorrect cart total calculation when converting orders.

= 1.0.20 =
* Include full order details in the order conversion event.

= 1.0.19 =
* Support for unique discount codes.

= 1.0.18 =
* Send order state changes to Recapture

= 1.0.17 =
* Added option to include sales tax in cart total.

= 1.0.16 =
* Remove review titles from product review page.

= 1.0.15 =
* Fix invalid order conversion issue with some payment providers.

= 1.0.14 =
* Check the order for first name before accessing the field when rendering reviews.

= 1.0.13 =
* Added support for Review Booster campaigns
...
= 1.0.8 =
* Improve checkout URL generation

= 1.0.6 =
* Code review upgrades for WPE

= 1.0.5 =
* Integration updates for LW

= 1.0.4 =
* Refactoring to include RCP as another option in codebase
