...
**Features:**
* ✅ **Two-Way Product Synchronize** with **Google Sheets**
...
* 🔥🔥🔥 **Stock Synchronize for Multiple Sites** from a single Google Sheet using SKU
...
= 1.1.0 =
* Prie update issue from Quick Edit and Google Sheet has been fixed.
* Code more optimized
* Bug Fixed

= 1.0.9 =
* Checked at latest version of WooCommerce 
* Checked at latest version of WordPress 
* Faster Sync time
* Code more optimized
* Bug Fixed
...
* Faster load time 
* Faster Sync time
* Added: Added Post URL, Edit URL, Post Status in premium version
* Fixed: Speed optimized for Sync with Google 
* Fixed: Quick Table issue fixed.
* Fixed: edit from Quick Table issue fixed.
* Code more optimized
* Bug Fixed
