...
class Api
{
    ...
    public function handle_request($request)
    {
        ...
        if( count($this->requestedParams) <= 1){
            return new \WP_REST_Response( [
                'status' => 'error', 
                'message' => __('Parameter is not found', 'product-sync-master-sheet'),
        ...
        /**
         * $this->product_updated_stats 
         * this value actually changed/handled by action hook 'pssg_api_request_handle'
         * 
