...
class Inactive_Element extends Admin_Base
{
    ...
    public function row_render($saved_data, $page_name)
    {
        ...
        <?php
        $column_post_status = $saved_data['column_post_status'] ?? '';
        $checked = $column_post_status == 'on' ? 'checked' : '';
        ...
        <tr class="pssg-premium-row">
            <td>
                <div class="pssg-form-control">
                    <div class="form-label col-lg-4">
                        <label for="pssg-choose-category"> <?php echo esc_html__( 'Post Status', 'product-sync-master-sheet' ); ?></label>
                    </div>
                    <div class="form-field col-lg-8">
                    
                    <label class="switch">
                        <input name="column_post_status" type="checkbox" id="table_view_switcher_on_of" <?php echo esc_attr( $checked ); ?>>
            ...
            <td>
                <div class="pssg-form-info">
                    <p>Change post status from Sheet.</p>
        ...
        <?php
        $column_post_permalink = $saved_data['column_post_permalink'] ?? '';
        $checked = $column_post_permalink == 'on' ? 'checked' : '';
        ?>
        <tr class="pssg-premium-row">
            <td>
                <div class="pssg-form-control">
                    <div class="form-label col-lg-4">
                        <label for="pssg-choose-category"> <?php echo esc_html__( 'Product URL', 'product-sync-master-sheet' ); ?></label>
                    </div>
                    <div class="form-field col-lg-8">
                    
                    <label class="switch">
                        <input name="column_post_permalink" type="checkbox" id="table_view_switcher_on_of" <?php echo esc_attr( $checked ); ?>>
                        <div class="slider round"><!--ADDED HTML -->
                            <span class="on">Yes</span><span class="off">No</span><!--END-->
                        </div>
                    </label>
        ...
        <?php
        $column_post_edit_link = $saved_data['column_edit_link'] ?? '';
        $checked = $column_post_edit_link == 'on' ? 'checked' : '';
        ...
        <tr class="pssg-premium-row">
            <td>
                <div class="pssg-form-control">
                    <div class="form-label col-lg-4">
                        <label for="pssg-choose-category"> <?php echo esc_html__( 'Edit URL', 'product-sync-master-sheet' ); ?></label>
                    </div>
                    <div class="form-field col-lg-8">
                    
                    <label class="switch">
                        <input name="column_edit_link" type="checkbox" id="table_view_switcher_on_of" <?php echo esc_attr( $checked ); ?>>
                        <div class="slider round"><!--ADDED HTML -->
                            <span class="on">Yes</span><span class="off">No</span><!--END-->
                        </div>
                    </label>
            ...
            <td>
                <div class="pssg-form-info">
                    <p>Show Product Edit URL in Sheet</p>
