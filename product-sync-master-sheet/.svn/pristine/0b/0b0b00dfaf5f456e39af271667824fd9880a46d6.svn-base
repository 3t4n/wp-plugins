...
jQuery(function($) {
    ...
    $(document).ready(function() {
        ...
        //For Multi Step Wizard - Main Page actually now - It's demo multiple site connect

        $(document.body).on('change','.multiple-site-connection-demo form#pssg-multisite-form .site-type-changer-wrapper select',function(){
            var siteType = $(this).val();
            $(this).closest('form#pssg-multisite-form').attr('class','pssg-multisite-form-' + siteType);
        });


        //disable submit button for .multiple-site-connection-demo form#pssg-multisite-form
        $(document.body).on('submit','.multiple-site-connection-demo form#pssg-multisite-form',function(e){
            e.preventDefault();
        });
