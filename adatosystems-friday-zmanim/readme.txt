...
Donate link: https://www.adatosystems.com/donate/
...
For a version that works with current WordPress installations, please see [Zmanim WP](https://wordpress.org/plugins/zmanim-wp/#description) or some other plugin.
