...
You can use this pricelist block to create easily maintainable pricelists. All editing is done inside the block editor.
...
More examples and further documentation can be found [here](https://pricelist-block.waardwebsites.nl/).

== Donations == 
Donations for developing and maintaining this block are most welcome. Make a donation [on the donation page](https://donate.stripe.com/8wMg1r5QEaOb2oodQQ).
