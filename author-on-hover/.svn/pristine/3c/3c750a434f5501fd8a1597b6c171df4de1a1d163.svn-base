...
(function($) {
  ...
  function AOHAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  AOHAjaxChosen.prototype.init = function() {
  ...
  AOHAjaxChosen.prototype.events = function() {
  ...
  AOHAjaxChosen.prototype.search_field_focused = function() {
  ...
  AOHAjaxChosen.prototype.search_welcome_message = function() {
  ...
  AOHAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('aoh-chosen', _this.options.data).done( function( response ) {
  ...
  AOHAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.aoh-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.AOHChosenOrder($hidden_value, true);
  ...
  $.fn.AOHAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new AOHAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, AOHAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  AOHAbstractChosenOrder = (function() {

    function AOHAbstractChosenOrder() {}

    AOHAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    AOHAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    AOHAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    AOHAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    AOHAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    AOHAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    AOHAbstractChosenOrder.AOHChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    AOHChosenOrder: function(order, force) {
      return _AOHChosenOrder.AOHChosenOrder(this, order, force);
    }
  });

  this._AOHChosenOrder = (function(_super) {
    __extends(_AOHChosenOrder, _super);

    function _AOHChosenOrder() {
      _ref = _AOHChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _AOHChosenOrder.relAttributeName = 'data-option-array-index';

    _AOHChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _AOHChosenOrder.getDOMElement = function(element) {
    ...
    _AOHChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _AOHChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _AOHChosenOrder;

  })(AOHAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('aoh-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectAOH = FormSerializer.serializeObject;
    $.fn.serializeJSONAOH   = FormSerializer.serializeJSON;
  }
