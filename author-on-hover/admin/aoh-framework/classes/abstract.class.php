 ...
 *
 */
if ( ! class_exists( 'AOH_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class AOH_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      AOH::$css = apply_filters( "aoh_{$this->unique}_output_css", AOH::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'AOH_Field_' . $field_type;
