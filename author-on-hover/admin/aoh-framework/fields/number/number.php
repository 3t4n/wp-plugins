 ...
 *
 */
if ( ! class_exists( 'AOH_Field_number' ) ) {
  class AOH_Field_number extends AOH_Fields {
    ...
    public function render() {
      ...
      echo ( ! empty( $args['unit'] ) ) ? '<span class="aoh--unit">'. esc_attr( $args['unit'] ) .'</span>' : '';
      echo '</div>';
