...
Tags: form, stripe, payment, subscriptions, recurring
...
* Put an unlimited number of payment forms anywhere on your website with a simple shortcode.   
...
## 🛠️ CUSTOM PAYMENT FORM BUILDER
* Customize every design detail of your payment form with our powerful custom payment form builder. We love feature requests - so feel free to reach out. 
...
* Let your customers choose how much to pay based on their invoice amount or self-selecting for donations. Customers can even choose recurring payment options.

## ✍️ PREFILL FORM FIELDS
* Automatically prefill form fields when visitors land on your payment page by adding simple query string parameters.

## 🔗 SEND DATA TO EXTERNAL URL
* Using simple POST requests, you can send form data to any external URL to automate your payment flow with a SaaS, mobile app, and more.

## ⛏ DEVELOPER FRIENDLY
* Initiate any custom action you’d like with developer-friendly triggers. 
...
Free plan: 
* PayPal Standard Checkout, which surfaces relevant payment methods based on customer location. 
* One-time payments with PayPal are supported. 
...
* **Fully Customizable Templates** - We provide a bunch of free templates that can be fully customized in terms of design, layout, color palette, fonts, and more. 
...
* **Full Access to All Templates** - All our templates are available for free to import.
...
* **Remove 2% Transaction Fee** - Remove the 2% transaction fee charged in the free version for all payment types. The Breakeven Point (when it’s worth upgrading) is if you’re making more than $4,950/year with Payment Page.
...
Then, you’ll be the Add new form screen to select a form and connect payment gateways.

= Manual installation =

The manual installation method involves downloading the plugin and uploading it to your server via your favorite FTP application. WordPress documentation contains [instructions on how to do this here](https://wordpress.org/documentation/article/manage-plugins/#manual-plugin-installation-1/).
...
Once you've activated the Payment Page plugin, you can select a Payment Page template based on your business needs. Customize the template as you choose, and you'll be accepting payments in minutes. 
...
Stripe and PayPal are currently both supported. 
...
Yes. The free version supports recurring subscription payments for Stripe. 
...
Absolutely. You can add custom form fields in the free version. The data in these fields will get stored in the Stripe metadata for that payment. 

= Can I prefill form fields automatically? =

Yes. In the free version, you can utilize Query String Parameters to automatically prefill all of your form fields, including custom fields. Query strings that match your custom fields’ labels will be matched to those fields. Unmatched query strings will be passed to HTTP Requests as well as Stripe metadata fields. 
...
You can build your custom payment form using our form builder and then place the shortcode for your form anywhere on your site. We also have an Elementor widget available. 
...
See our full changelog in our [documentation](https://docs.payment.page/changelog/changelog). 
