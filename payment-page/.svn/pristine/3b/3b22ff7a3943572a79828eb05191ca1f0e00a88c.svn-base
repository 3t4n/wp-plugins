...
class Form extends Skeleton {
	...
	public function attach_controls() {
		...
		$this->elementorWidgetInstance->add_control(
			$this->control_alias . '_data_section_label',
			array(
      ...
      __( 'Custom fields are stored at your payment gateway in the relevant transaction details. E.g. - You might want to collect an invoice ID when a customer is entering a unique Custom Amount for an invoice.', 'payment-page' ) .
		...
		$this->elementorWidgetInstance->add_control(
			$this->control_alias . '_fields_map',
			array(
      ...
      payment_page_elementor_builder_color_control_default_args() + array(
		...
		$this->elementorWidgetInstance->add_control(
			$this->control_alias . '_' . $field_name . '_styles_heading',
			array(
		...
		$this->elementorWidgetInstance->add_control(
			$this->control_alias . '_' . $field_name . '_heading',
			array(
		...
		$this->elementorWidgetInstance->add_control(
			$this->control_alias . '_' . $field_name . '_style',
			array(
