 ...
 * Description:       Effortlessly create and customize eCards with a variety of pre-made designs, then seamlessly send them via email and social media using our WordPress plugin.
 * Version:           1.3.905
 * Author:            eCardWidget LLC
