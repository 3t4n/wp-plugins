...
class Wp_Ecards_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		function ecardtag_func( $atts ) {
			...
			// Escape the 'id' attribute for output
			$embed = '<script type="text/javascript" src="https://ecardwidget.com/embed/ecard/'.esc_attr($atts["id"]).'"></script><div id="ecardwidget_id_'.esc_attr($atts["id"]).'"></div>';
		...
		function ecardstag_func( $atts ) {
			...
			// Escape the 'id' attribute for output
			$embed = '<script type="text/javascript" src="https://ecardwidget.com/embed/widget/'.esc_attr($atts["id"]).'"></script><div id="ecardwidget_id_'.esc_attr($atts["id"]).'"></div>';
