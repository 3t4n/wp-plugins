...
function apexchat_setting_companykey_callback_function() {
	...
	echo '<input name="apexchat_settings_group[apexchat_setting_companykey]" id="apexchat_setting_companykey" type="text" value="' . sanitize_text_field(@$options[ 'apexchat_setting_companykey' ]) . '" class="code" /> The company key provided to you by Blazeo';
}
