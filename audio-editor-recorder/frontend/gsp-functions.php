...
wp_enqueue_script( 'gsp-bootstrap-edit', plugins_url( '../assets/js/custom.js?id='.rand(),  __FILE__ ),false,false );
    $translation_array = array(
		...
		'translate_click' => __('Click', 'audio-editor-recorder'), //  welcome screen editor
		'translate_to_record' => __('to record', 'audio-editor-recorder'), //  welcome screen editor
		'translate_to_upload' => __('to upload a file', 'audio-editor-recorder'), // welcome screen editor
		'translate_play' => __('Play', 'audio-editor-recorder'), // Buttons play pause
		'translate_pause' => __('Pause', 'audio-editor-recorder'), // Buttons play pause
		'translate_save' => __('Save', 'audio-editor-recorder'), // Download file
		'translate_save_export' => __('Save &amp; Export Audio', 'audio-editor-recorder'), // Download file
	);
...
<?php } ?>
		...
		<div class="col-sm-12 position_inherit editor-container" <?php if ($a['mini'] == 'true') : ?>style="padding:0 20px;"<?php endif; ?>>
			...
			<div class="audiolayout-right" <?php if ($a['mini'] == 'true') : ?>style="display:inline-block;"<?php endif; ?>>
				...
				<div class="top-audiobar">
					...
					<div class="play playbtn resetbtn re-select cursor_pointer tooltip_a_box" data-toggle="tooltip" title="Re-select" onclick="stop_fun();" id="btn_play" <?php if ($a['mini'] == 'true') {echo 'style="display:none;"';} ?>><i class="fa fa-i-cursor"></i>
					<div class="audio-button-text"><?php _e('Re-select', 'audio-editor-recorder'); ?></div></div>
    ...
    <script type="text/javascript">
              ...
              function refresh_statu()
            {
            	...
            	{
            		jQuery("#btn_play").html("<i class='fa fa-pause'></i><br/><div class=\"audio-button-text\">"+ jsVars.translate_pause +"</div>");
            	}
            	else
            	{
            		jQuery("#btn_play").html("<i class='fa fa-play'></i><br/><div class=\"audio-button-text\">"+ jsVars.translate_play +"</div>");
            	}
