...
function rapidtextai_settings_page() {
    ...
    <div class="wrap">
        ...
        <table class="form-table">
                    <tr>
                    <th scope="row"><label><?php esc_html_e('How To Generate Articles:', 'rapidtextai'); ?></label></th>
                    <td>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/5w7i20-vUdA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label><?php esc_html_e('Enable Auto Posting', 'rapidtextai'); ?></label></th>
                    <td>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/5FhAb54Lw4g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <p><a class="button-primary" href="https://github.com/alisaleem252/Rapidtextai-Auto-Post-Scheduler/archive/refs/heads/master.zip" target="_blank">Download from Github</a></p>
                            <p>To install a plugin from a ZIP file in WordPress, follow these steps:</p>
                            <ol>
                                ...
                                <li>Click the <strong>Choose File</strong> button and select the plugin ZIP file from your computer.</li>
                                <li>Click the <strong>Install Now</strong> button.</li>
                                <li>Once the plugin is installed, click the <strong>Activate Plugin</strong> button to activate it.</li>
                            </ol>
                    </td>
                </tr>
        </table>
