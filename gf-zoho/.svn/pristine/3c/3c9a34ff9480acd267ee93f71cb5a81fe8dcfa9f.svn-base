...
<div  class="vx_div">
   <div class="vx_head">
<div class="crm_head_div"> <?php esc_html_e('4. Map Form Fields to Zoho Fields.', 'gravity-forms-zoho-crm'); ?></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"><i class="fa crm_toggle_btn vx_action_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  ...
  <?php 
   $req_span=" <span class='vx_red vx_required'>(".__('Required','gravity-forms-zoho-crm').")</span>";
 $req_span2=" <span class='vx_red vx_required vx_req_parent'>(".__('Required','gravity-forms-zoho-crm').")</span>";
...
<?php
 if(! $required){   
?>
<i class="vx_remove_btn vx_remove_btn vx_action_btn fa fa-trash-o" title="<?php esc_html_e('Delete','gravity-forms-zoho-crm'); ?>"></i>
<?php } ?>
<i class="fa crm_toggle_btn vx_action_btn vx_btn_inner <?php echo $btn_icon ?>" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"></i>
</div>
...
<div class="more_options crm_panel_content" style="display: <?php echo $display ?>;">
  ...
  <span class="crm-desc-name-div"><?php echo esc_html__('Name:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-name"><?php echo esc_html($v['name']); ?></span> </span>
  <?php if($this->post('type',$v) !=""){ ?>
    <span class="crm-desc-type-div">, <?php echo esc_html__('Type:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-type"><?php echo esc_html($v['type']) ?></span> </span>
<?php
   }
  if($this->post('maxlength',$v) !=""){ 
   ?>
   <span class="crm-desc-len-div">, <?php echo esc_html__('Max Length:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-len"><?php echo esc_html($v['maxlength']); ?></span> </span>
  <?php 
  }  if($this->post('eg',$v) !=""){ 
   ?>
   <span class="crm-eg-div">, <?php echo esc_html__('e.g:','gravity-forms-zoho-crm')." ";?><span class="crm-eg"><?php echo $v['eg']; ?></span> </span>
  <?php 
  }
  ?>
   </div> 
...
<div class="entry_row">
<div class="entry_col1 vx_label"><label  for="vx_type_<?php echo $k ?>"><?php esc_html_e('Field Type','gravity-forms-zoho-crm') ?></label></div>
...
<div class="crm_panel_head2">
<div class="crm_head_div"><span class="crm_head_text crm_text_label">  <?php esc_html_e('Custom Field', 'gravity-forms-zoho-crm');?></span> </div>
<div class="crm_btn_div">
<i class="vx_remove_btn vx_action_btn fa fa-trash-o" title="<?php esc_html_e('Delete','gravity-forms-zoho-crm'); ?>"></i>
<i class="fa crm_toggle_btn vx_action_btn vx_btn_inner fa-minus" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"></i>
</div>
<div class="crm_clear"></div> </div>
<div class="more_options crm_panel_content" style="display: block;">
  ...
  <div class="crm-panel-description">
  <span class="crm-desc-name-div"><?php echo esc_html__('Name:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-name"></span> </span>
  <span class="crm-desc-type-div">, <?php echo esc_html__('Type:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-type"></span> </span>
  <span class="crm-desc-len-div">, <?php echo esc_html__('Max Length:','gravity-forms-zoho-crm')." ";?><span class="crm-desc-len"></span> </span>
 <span class="crm-eg-div">, <?php echo esc_html__('e.g:','gravity-forms-zoho-crm')." ";?><span class="crm-eg"></span> </span>
   </div> 
...
<div class="entry_row">
<div class="entry_col1 vx_label"><label  for="vx_type"><?php esc_html_e('Field Type','gravity-forms-zoho-crm') ?></label></div>
<div class="entry_col2">
...
<div class="crm_clear"></div>
  ...
  <div class="entry_row entry_row2">
<div class="entry_col1 vx_label">
<label for="vx_field" class="vxc_fields vxc_field_"><?php esc_html_e('Select Field','gravity-forms-zoho-crm') ?></label>

<label for="vx_value" class="vxc_fields vxc_field_value" style="display: none;"> <?php esc_html_e('Custom Value','gravity-forms-zoho-crm') ?></label>
</div>
<div class="entry_col2">
<div class="vxc_fields vxc_field_value" style="display: none;">
<input type="text" name='value'  placeholder='<?php esc_html_e("Custom Value",'gravity-forms-zoho-crm')?>' class='vx_input_100 vxc_field_input'>
<div class="howto"><?php echo sprintf(__('You can add a form field %s in custom value from following form fields','gravity-forms-zoho-crm'),'<code>{field_id}</code>')?></div>
</div>
...
<div class="crm_clear"></div>
  ...
  <div class="clear"></div>
   ...
   <div class="crm_panel crm_panel_100">
<div class="crm_panel_head2">
<div class="crm_head_div"><span class="crm_head_text ">  <?php esc_html_e("Add New Field", 'gravity-forms-zoho-crm');?></span> </div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn vx_btn_inner fa-minus" style="display: none;" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"></i></div>
<div class="crm_clear"></div> </div>
<div class="more_options crm_panel_content" style="display: block;">
...
echo '<option value="'.esc_attr($k).'" '.$disable.'>'.esc_html($v['label']).'</option>';  
 ...
 <button type="button" class="button button-default" style="vertical-align: middle;" id="xv_add_custom_field"><i class="fa fa-plus-circle" ></i> <?php esc_html_e('Add Field','gravity-forms-zoho-crm')?></button>
...
<div class="vx_div">
   <div class="vx_head">
<div class="crm_head_div"> <?php esc_html_e('5. When to Send Entry to Zoho.', 'gravity-forms-zoho-crm'); ?></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"><i class="fa crm_toggle_btn vx_action_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  </div>
  ...
  <?php esc_html_e('Send Entry to Zoho', 'gravity-forms-zoho-crm'); ?>
  ...
  <?php esc_html_e('Send Entry', 'gravity-forms-zoho-crm'); ?>
  </span></legend>
  <label for="crm_manual_export">
  <select name="meta[manual_export]" >
  <?php
  $events_arr=array(''=>__( 'When anyone submits form.', 'gravity-forms-zoho-crm'),'1'=>__( 'Manually send the entries to zoho.', 'gravity-forms-zoho-crm'));
  if(self::$is_pr){
      $events_arr['2']=__( 'When payment is complete.', 'gravity-forms-zoho-crm');
            //$events_arr['3']=__( 'When subscription payment is complete.', 'gravity-forms-zoho-crm');
      $events_arr['4']=__( 'When form submission is Complete.', 'gravity-forms-zoho-crm');
  }
  ...
  <div class="vx_col1">
  <label for="crm_optin">
  <?php esc_html_e("Opt-In Condition", 'gravity-forms-zoho-crm'); ?>
  ...
  <label for="crm_optin">
  <?php esc_html_e("Enable", 'gravity-forms-zoho-crm'); ?>
  </label>
  </div>
  <div style="clear: both;"></div>
  ...
  <?php esc_html_e('OR','gravity-forms-zoho-crm') ?>
  </div>
  <?php } ?>
  ...
  <?php if($sno_i>1){ ?>
  <div class="vx_filter_label">
  <?php esc_html_e('AND','gravity-forms-zoho-crm') ?>
  </div>
  <?php } ?>
  ...
  <?php 
  echo $this->gf_fields_options($form_id,$this->post('field',$s_v),$this->account,$feed['id']);
                ?>
  </select>
  </div>
  ...
  <input type="text" class="vxc_filter_text" placeholder="<?php esc_html_e('Value','gravity-forms-zoho-crm') ?>" value="<?php echo $this->post('value',$s_v) ?>" name="meta[filters][<?php echo $filter_k ?>][<?php echo $s_k ?>][value]">
  </div>
  <?php if( $sno_i>1){ ?>
  ...
  <button class="button button-default button-small vx_add_and" title="<?php esc_html_e('Add AND Filter','gravity-forms-zoho-crm'); ?>"><i class="vx_icons-s vx_trash_and fa fa-hand-o-right"></i>
  <?php esc_html_e('Add AND Filter','gravity-forms-zoho-crm') ?>
  </button>
  <?php if($sno>1){ ?>
  <a href="#" class="vx_trash_or">
  <?php esc_html_e('Trash','gravity-forms-zoho-crm') ?>
  </a>
  <?php } ?>
  </div>
  </div>
  ...
  <?php
                      ...
                      ?>
  <div class="vx_btn_div">
  <button class="button button-default  vx_add_or" title="<?php esc_html_e('Add OR Filter','gravity-forms-zoho-crm'); ?>"><i class="vx_icons vx_trash_and fa fa-check"></i>
  <?php esc_html_e('Add OR Filter','gravity-forms-zoho-crm') ?>
  </button>
  </div>
  </div>
  <!--------- template------------>
  ...
  <?php 
  echo $this->gf_fields_options($form_id,'',$this->account,$feed['id']);
                ?>
  </select>
  </div>
  <div class="vx_filter_field vx_filter_field2">
  ...
  <div class="vx_filter_field vx_filter_field3">
  <input type="text" class="vxc_filter_text" placeholder="<?php esc_html_e('Value','gravity-forms-zoho-crm') ?>" name="value">
  </div>
  <div class="vx_filter_field vx_filter_field4"><i class="vx_icons vx_trash_and vxc_tips fa fa-trash-o"></i></div>
  <div style="clear: both;"></div>
  </div>
  <div class="vx_btn_div">
  <button class="button button-default button-small vx_add_and" title="<?php esc_html_e('Add AND Filter','gravity-forms-zoho-crm'); ?>"><i class="vx_icons vx_trash_and  fa fa-hand-o-right"></i>
  <?php esc_html_e('Add AND Filter','gravity-forms-zoho-crm') ?>
  </button>
  <a href="#" class="vx_trash_or">
  <?php esc_html_e('Trash','gravity-forms-zoho-crm') ?>
...
?>
  ...
  <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_notes"><?php esc_html_e('Entry Notes ', 'gravity-forms-zoho-crm');  gform_tooltip('vx_entry_notes');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_notes" class="crm_toggle_check" name="meta[entry_notes]" value="1" <?php echo !empty($meta['entry_notes']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_notes"><?php esc_html_e('Add / delete notes to Zoho when added / deleted in Gravity Forms', 'gravity-forms-zoho-crm'); ?></label>
...
<?php
  ...
  <div class="vx_div "> 
  <div class="vx_head ">
<div class="crm_head_div"> <?php  echo sprintf(__('%s. Choose Primary Key.',  'gravity-forms-zoho-crm' ),$panel_count); ?></div>
...
<div class="crm_clear"></div> 
 ...
 <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_update"><?php esc_html_e('Update Entry ', 'gravity-forms-zoho-crm');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_update" class="crm_toggle_check" name="meta[update]" value="1" <?php echo !empty($meta['update']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_update"><?php esc_html_e('Do not update entry, if already exists', 'gravity-forms-zoho-crm'); ?></label>
  ...
  <div class="clear"></div>
    ...
    <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_new_entry"><?php esc_html_e('Create New Entry ', 'gravity-forms-zoho-crm');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_new_entry" class="crm_toggle_check" name="meta[new_entry]" value="1" <?php echo !empty($meta['new_entry']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_new_entry"><?php esc_html_e('Do not create new entry in Zoho', 'gravity-forms-zoho-crm'); ?></label>
...
<div class="vx_div">
     <div class="vx_head">
<div class="crm_head_div"> <?php echo sprintf(__('%s. Add Note.', 'gravity-forms-zoho-crm'),$panel_count+=1); ?></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zoho-crm') ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  </div>
  ...
  <div class="vx_col1">
  <label for="crm_note">
  <?php esc_html_e("Add Note ", 'gravity-forms-zoho-crm'); ?>
  ...
  <?php esc_html_e( 'Note Fields ', 'gravity-forms-zoho-crm' ); gform_tooltip("vx_note_fields") ?>
  </label>
  </div>
   <div class="vx_col2 entry_col2">
  <textarea name="meta[note_val]"  placeholder="<?php esc_html_e("{field-id} text",'gravity-forms-zoho-crm')?>" class="vx_input_100 vxc_field_input" style="height: 60px"><?php
...
<select name="field"  class="vxc_field_option vx_input_100">
<?php echo $this->gf_fields_options($form_id,$this->post('note_fields',$meta),$this->account,$feed['id']); ?>
</select>
   </div>
  ...
  <?php esc_html_e( 'Disable Note ', 'gravity-forms-zoho-crm' ); gform_tooltip("vx_disable_note") ?>
  </label>
  </div>
  <div class="vx_col2">
  ...
  <label for="crm_disable_note">
  <?php esc_html_e('Do not Add Note if entry already exists in Zoho', 'gravity-forms-zoho-crm'); ?>
  </label>
...
?>
  ...
  <button type="submit" title="<?php esc_html_e('Save Feed','gravity-forms-zoho-crm'); ?>" name="<?php echo esc_attr($this->id) ?>_submit" class="button button-primary button-hero"> <i class="vx_icons vx vx-arrow-50"></i> <?php echo empty($fid) ? esc_html__("Save Feed", 'gravity-forms-zoho-crm') : esc_html__("Update Feed", 'gravity-forms-zoho-crm'); ?> </button>
  </div>
  
<?php
        do_action('vx_plugin_upgrade_notice_plugin_'.$this->id);
  ?>  
