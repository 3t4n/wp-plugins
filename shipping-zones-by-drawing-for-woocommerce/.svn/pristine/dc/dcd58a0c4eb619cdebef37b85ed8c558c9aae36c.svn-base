...
Tags: delivery zone, shipping, area, woocommerce, map
...
Shipping Zones by Drawing allows you to draw your own custom shipping areas in WooCommerce.
...
* Fix: Do not send country component when plus code is global format.
