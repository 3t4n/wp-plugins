...
class Primer_Admin {
	...
	public function primer_admin_order_success_message() { ?>
		<div class="notice notice-success is-dismissible">
			<p><strong><?php esc_html_e('Editing of this order has been disabled because it has been converted to invoice', 'primer'); ?></strong></p>
	...
	public function primer_admin_order_error_message() { ?>
		<div class="notice notice-error">
			<p><strong><?php esc_html_e('Editing of this order has been disabled because data have been send to AADE, but there was an error in the conversion. Please check conversion log and fix conversion error to continue', 'primer'); ?></strong></p>
		</div>
	<?php }
...
function primer_check_time_difference() {
	...
	$format_date  = $date->format(DateTime::W3C);
