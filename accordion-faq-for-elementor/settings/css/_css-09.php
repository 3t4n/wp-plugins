...
.afaq-6310-faq-template-<?php echo $ids; ?>-head-title {
  ...
  width: calc(100% - <?php echo (($cssData['head_icon_width_number'] ? $cssData['head_icon_width_number'] : 20) + ($cssData['title_empty_space'] ? $cssData['title_empty_space'] : 20));?>px);
...
.afaq-6310-faq-template-<?php echo $ids; ?>-content {
  ...
  display: flex;
  box-sizing: border-box;
  width: calc(100% - <?php echo ceil(($cssData['head_icon_width_number'] ? $cssData['head_icon_width_number'] : 20) + ($cssData['title_empty_space'] ? $cssData['title_empty_space'] : 20));?>px );
  ...
  margin-left: <?php echo  ceil(($cssData['head_icon_width_number'] ? $cssData['head_icon_width_number'] : 10) + ($cssData['title_empty_space'] ? $cssData['title_empty_space'] : 10));?>px;
