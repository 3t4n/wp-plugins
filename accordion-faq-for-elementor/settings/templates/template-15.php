   ...
   <div class="afaq-6310-sm">
      <div class="afaq-6310-plugin-setting-left">
         ...
         <div class="afaq_6310_tabs_panel_preview">
            <div 
               class="afaq-6310-faq-for-elementor-<?php echo esc_attr($ids); ?> afaq-6310-faq-for-elementor afaq-6310-template-15" 
               ...
               data-search-template-show-hide-id='<?php echo esc_attr(isset($cssData['search_template_show_hide']) ? 1 : 0) ?>'
               data-category-active='<?php echo esc_attr(isset($cssData['category_template_show_hide']) ? 1 : 0) ?>'
            ...
            >
               ...
               ?>
                     <div class="afaq-6310-faq-template-<?php echo esc_attr($ids) . afaq_6310_explode_class_code($faq['class_code']); ?>">
                        <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-left-section">
                           <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-head-arrow">
                              <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-head-arrow-before"></div>
                              <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-head-arrow-after"></div>
                              <?php echo esc_attr($i)?>
                           </div>
                        </div>
                        <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-right-section ">
                           ...
                           <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-head-left-icon"><i class="<?php echo esc_attr($faq['icons_name']) ?>"></i></div>
