            ...
            <table class="table table-responsive afaq_6310_admin_table">            
              ...
              <tr class="description-act-field">
                <td><b>Angle Effect Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="after_effect_background_color" id="after_effect_background_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb"  value="<?php echo esc_attr($cssData['after_effect_background_color']) ?>">
                </td>
              </tr>
               <tr>
                <td><b>Angle Width</b>
            ...
            <table class="table table-responsive afaq_6310_admin_table">  
              ...
              <tr>
                <td><b>Margin Bottom</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="8" name="body_margin_bottom" value="<?php echo esc_attr($cssData['body_margin_bottom']) ?>" class="afaq-6310-form-input" step="1" id="body_margin_bottom" />
                </td>
              </tr>        
            </table>
          </div>
