            ...
            <table class="table table-responsive afaq_6310_admin_table"> 
              ...
              <tr class="description-act-field">
                <td><b>Indicator Border Size</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="indicator_border_size_number" value="<?php echo esc_attr($cssData['indicator_border_size_number']) ?>" class="afaq-6310-form-input" step="1" id="indicator_border_size_number" />
                </td>
              </tr>            
              <tr class="description-act-field">
                <td><b> Indicator Border Radius</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="indicator_border_radius" value="<?php echo esc_attr($cssData['indicator_border_radius']) ?>" class="afaq-6310-form-input" step="1" id="indicator_border_radius" />
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b> Indicator Border Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_border_color" id="indicator_border_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['indicator_border_color']) ?>">
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b> Indicator Border hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_border_hover_color" id="indicator_border_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['indicator_border_hover_color']) ?>">
                </td>
              </tr>
            ...
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr>
                <td><b>Line Height</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="title_line_height_number" id="title_line_height_number" min="0" max="60" type="number" value="<?php echo esc_attr($cssData['title_line_height_number']) ?>" class="afaq-6310-form-input" />
                </td>
              </tr>
              <tr>
                <td><b>Font Weight</b>
