   ...
   <?php
      ...
      ?>
            <div class="afaq-6310-faq-template-<?php echo esc_attr($ids) . afaq_6310_explode_class_code($faq['class_code']); ?>">
                  <div class="afaq-6310-faq-template-<?php echo esc_attr($ids); ?>-label-head afaq-6310-faq-template-common-head  <?php if ($i++ == 1) {echo "afaq-6310-faq-template-".esc_attr($ids)."-active"; } ?>">
