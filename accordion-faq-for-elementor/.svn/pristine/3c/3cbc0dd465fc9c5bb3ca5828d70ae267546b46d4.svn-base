...
Contributors: WpMart
Tags: FAQ, Accordion FAQ, FAQ for elementor, Knowledge-based FAQ, FAQ with Category, FAQ plugin for WordPress, Gutenberg FAQ, WooCommerce FAQ, FAQ plugin, Collapse, Toggle FAQ
...
Responsive FAQ plugin with Accordion and Category for Elementor and page builders. Add FAQ with collapse and toggle activator easily. Also works with Gutenberg blocks using the shortcode. 

== Description ==
https://www.youtube.com/watch?v=92aD7c1ytmU

[Live Demo](https://wpmart.org/faq-demo-01-05/) | [Support](https://wpmart.org/contact/) | [Upgrade to Pro!](https://wpmart.org/downloads/best-accordion-faq-with-category/)

The best FAQ and Accordion plugin that also works with Gutenberg blocks using the shortcode. Highly responsive and customizable FAQ builder for Elementor with Category.

FAQ for Elementor with Category is the standard, lightweight FAQ plugin for WordPress which contains all of the responsive Accordion FAQ features you can think of while working on your next project in WordPress. With its excellence, the WpMart brought to you the exclusive FAQ plugin that works with all types of blocks for the Elementor page builder. The awesome toggle tab, accordion faq with custom category, and the fastest knowledge-based FAQ all are some exclusive features for the <b>FAQ for Elementor WordPress FAQ plugins which every developer needs.</b>


The FAQ for Elementor with Category was designed to be the best way for adding <b>dynamic</b> accordion faq very easily within any professional website and knowledge-based sites. It is one of the responsive and highly efficient FAQ plugins in WordPress which works seamlessly within <b>gutenberg blocks</b> as well. 
...
<b>FAQ for Elementor with Category</b> WordPress plugin comes with an exclusive toolset that lets you create truly responsive websites in a whole new and visual way. From different font sizes per device, to reverse column ordering, this is the most powerful solution for creating perfect FAQs for mobile pages. You can develop your webpage with our plugin simply using your mobile device as well. This is very perfect for landing pages, coming soon pages, or knowledge-based FAQ pages of your website which needs so many FAQ tabs. Our developed canvas works on any theme and lets you get rid of the header area so you get a blank template to work on.
...
><i>Major Builder Supported FAQ for Elementor is totally compatible with all the page builders including Elementor, Beaver Builder, Divi, Visual Composer, SiteOrigin, and so on.</i>
...
It is an important matter of concern while it comes to the FAQ loading speed. Most of the users suffer from the lazy page load and terminate that particular website right away. This would really be a disastrous incident for a webmaster, right? Our FAQ plugin comes with a <b>lightning speed super fast FAQ loading page</b>. This is a fast and simple plugin to be working with while considering zero in the speed issues. 
...
Creating FAQs and customizing it for <strong>100% responsiveness</strong> with this plugin has never been harder. You can design your FAQ section and customize it with 100% responsiveness for every dimension as you have full control over height, width, padding, margin, and so on. Simply Add Title and content into the FAQ panel and set or customize them all from one page. You can also set the global condition to your tabs from our awesome interface. This plugin is very handy and comes with a <b>100% user-friendly</b> track record.
...
FAQ and Accordion tabs with different toggles or accordion effects are an important part while creating attractive, informative, and professional-looking FAQ sections. FAQ for Elementor with Category lets you reach your website at an apex level of responsiveness with all dimensions support. It allows you to add faq tabs and accordion effects to display your content/information more firmly and beautifully within eCommerce sites as well. 



= Lots of Interactive faqs and Accordion Features =


We developed and released our plugin with lots of the features of the most useful tab into our FAQ for Elementor with Category. Thus, more than we had to offer, but we wanted to spare nothing from you, so you can reach the top of your design capabilities. Here is a list of what we offer:


> * One-click Toggle/Collapsible feature: FAQ for Elementor comes up with one click toggle or collapse effect so that you can open one or more faq and accordions at the same time.
> * Custom Content- Add your own content from wherever you want in the FAQs.
> * General FAQ type- Most common tabs style with some basic effects are designed for you in the demo. We decorated this type with a wide range of customizations and editing options. You can import any style you like anytime from the demo page and start customizing it to embed within your post/page by using the shortcode.
> * Unlimited Shortcode with simple code: With the FAQ for Elementor, you can create unlimited accordion groups with the unlimited shortcode. So by using shortcodes very easily you can display your accordion on multiple pages and post.

> * Icon Tabs with more than 1600 font awesome libraries- With over 1600+ font awesome icon libraries, you can choose your own by entering the name of the icon or browsing it within the panel. You can also use social icons or any custom icon you need. But for adding your own designed icon you have to work with some custom CSS style sheet. Please contact us for getting some help regarding custom CSS.

> * Hardware accelerated – FAQ for Elementor with Category completely used new techniques used in the transition effects to create a smooth transition, fastest, and saves the system memory.  


> * Text/Visual Editor- You can get a text editor type interface to edit the content details. Here you can add custom HTML or CSS style. You can add HTML in the content of the tabs in the details section. With this convenience, you can easily customize the style and effect of the text if you want to.
...
> * Unlimited Shortcode- Here you can create an unlimited accordion group with an unlimited shortcode. So using shortcodes you can display your tabs on multiple pages and post.


> * No Coding required- This plugin is so simple and clean UI with user-friendly functions. Add new tabs and then easily publish it within minutes. It works with any theme. We have tested the FAQ for Elementor with Category with multiple themes, and it worked perfectly on every theme in every version. So the design is very clean and will work with your custom theme as well.
> * Custom Borders and Shadows on the FAQ tabs – All borders and shadows of the faq tab’s title and description have multiple configuration options with 100% flexibility. You can fully customize the size, color, transparency of the tabs interface all in one place. Shadow also has an additional blur option for the faq tab contents. All options could be configured with a tab control or defined values manually in edit fields of the tabs with accordion content options. 


> * Styling Text of the Tabs Content – FAQ for Elementor packed with specialized customization. You can find separate sections for each group of functionality. We’ve given you the maximum customization options for every section from general measurements to the typography, both separated for FAQ title and description. 
All text on the Tabs could be styled in both front and backend. For the title and description of the tab, we have advanced settings for customization of the font individually. We’ve designed separate sections for customizing both heading and description. You can select font style, size, and colors for the static and hovered text of the image hover elements. 
> * Color Pickers – All Content of the FAQ Tabs implements a very comfortable color picker. With the color picker option, you can define color in multiple ways. For accordion contents, you can select transparency for the color. Colors could be defined in HEX or RGB style.



The design of FAQ for Elementor with Category is responsive and very user-friendly to any dimensions device including mobiles and tabs. Add multiple FAQ tabs on multiple pages and post. Unlimited color schemes and font styles are available for creating faq content here. FAQ for Elementor is 100% responsive and compatible with any device including mobiles, tablets, desktop computers, and all modern web browsers which include iPhone, iPad, Android, Chrome, Safari, Firefox, Opera, Internet Explorer 7/8/9/10/11, and also Microsoft Edge.


<strong>FAQ for Elementor with Category</strong> plugin is by far the latest plugin that has all the latest features including traditional ones. With this plugin, you’ll never miss anything while creating your next knowledge-based site or FAQ-oriented glossary page. It was designed to be the most developer-friendly yet simple FAQ building plugin with accordion and toggle. 


The top-class quality of a solid extension framework, which means different functionality is separated out into different areas in the codebase. It also means the core plugin is lightweight, but still allowing for the most flexibility. All of these exclusive features made FAQ for Elementor with Category plugin most efficient in this category.


FAQ for Elementor with Category is a kind of WordPress plugin that can give you all you can think of while adding FAQ or Accordion tabs. You can trust this super responsive and dynamic FAQ building plugin with Accordion and Knowledge-based features including categories for each item. 


User-friendliness, responsiveness, dynamism, sleek and smooth, top-notch quality, fully custom and flexible - FAQ for Elementor has it all!
So grab it before you spend too much time and energy on a complex one!
...
== Changelog ==
= 1.6 =
* FEATURE – Fixed Editor Issue

= 1.5 =
* FEATURE – Search Option Added
