  ...
  <div class="afaq-6310-tab-6">
    ...
    <tr >
      ...
      <tr>
        ...
        <td>
          <input name="category_01_title_font_family" id="category_01_title_font_family" type="text" value="<?php echo esc_attr($cssData['category_01_title_font_family']) ?>" />
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="number" min="0" name="category_01_title_font_size_number_number" value="<?php echo esc_attr((isset($cssData['category_01_title_font_size_number_number']) && $cssData['category_01_title_font_size_number_number']  !== '') ? $cssData['category_01_title_font_size_number_number'] : 16); ?>" class="afaq-6310-form-input" step="1" id="category_01_title_font_size_number_number" />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input name="category_01_title_line_height_number" id="category_01_title_line_height_number" type="number" value="<?php echo esc_attr((isset($cssData['category_01_title_line_height_number']) && $cssData['category_01_title_line_height_number'] !=='') ? $cssData['category_01_title_line_height_number'] : 14); ?>" class="afaq-6310-form-input" />
        </td>
      </tr>
      <tr>
      ...
      <tr >
        ...
        <td>
          <input type="text" name="category_01_title_color" id="category_01_title_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_title_color']) && $cssData['category_01_title_color'] !== '') ? $cssData['category_01_title_color'] : '#dbf0e4'); ?>">
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_01_title_hover_color" id="category_01_title_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_title_hover_color']) && $cssData['category_01_title_hover_color'] !== '') ? $cssData['category_01_title_hover_color'] : '#dbf0e4'); ?>">
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_01_title_background_hover_color" id="category_01_title_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_title_background_hover_color']) && $cssData['category_01_title_background_hover_color'] !== '') ? $cssData['category_01_title_background_hover_color'] : '#ededed'); ?>">
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="number" min="0" name="category_01_border_size_number" value="<?php echo esc_attr((isset($cssData['category_01_border_size_number']) && $cssData['category_01_border_size_number']  !== '') ? $cssData['category_01_border_size_number'] : 0); ?>" class="afaq-6310-form-input" step="1" id="category_01_border_size_number" />
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_01_border_color" id="category_01_border_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_border_color']) && $cssData['category_01_border_color'] !== '') ? $cssData['category_01_border_color'] : '#80808085'); ?>">
        </td>
      </tr>  
    </table>
  </div>
  <div class="afaq-6310-tab-6">
    <table class="table table-responsive afaq_6310_admin_table">
      <tr >
        ...
        <td>
          <input type="number" min="0" name="category_01_icon_font_size_number" value="<?php echo esc_attr((isset($cssData['category_01_icon_font_size_number']) && $cssData['category_01_icon_font_size_number']  !== '') ? $cssData['category_01_icon_font_size_number'] : 35); ?>" class="afaq-6310-form-input" step="1" id="category_01_icon_font_size_number" />
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_01_icon_color" id="category_01_icon_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_icon_color']) && $cssData['category_01_icon_color'] !== '') ? $cssData['category_01_icon_color'] : '#00b4b3'); ?>">
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_icon_hover_color" id="category_icon_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_icon_hover_color']) && $cssData['category_icon_hover_color'] !== '') ? $cssData['category_icon_hover_color'] : '#00b4b3'); ?>">
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input name="category_01_description_font_family" id="category_01_description_font_family" type="text" value="<?php echo esc_attr($cssData['category_01_description_font_family']) ?>" />
        </td>
      </tr>
      <tr >
      ...
      <tr >
        ...
        <td>
          <input type="number" min="0" name="category_01_description_line_height_number_number" value="<?php echo esc_attr((isset($cssData['category_01_description_line_height_number_number']) && $cssData['category_01_description_line_height_number_number']  !== '') ? $cssData['category_01_description_line_height_number_number'] : 20); ?>" class="afaq-6310-form-input" step="1" id="category_01_description_line_height_number_number" />
        </td>
      </tr>
      <tr>
      ...
      <tr >
        ...
        <td>
          <input type="text" name="category_01_description_color" id="category_01_description_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_description_color']) && $cssData['category_01_description_color'] !== '') ? $cssData['category_01_description_color'] : '#8a8a8a') ?>">
        </td>
      </tr>
      <tr >
        ...
        <td>
          <input type="text" name="category_01_description_hover_color" id="category_01_description_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($cssData['category_01_description_hover_color']) && $cssData['category_01_description_hover_color'] !== '') ? $cssData['category_01_description_hover_color'] : '#4f676e') ?>">
        </td>
      </tr>
...
<style>
  ...
  <?php
    for($x = 1; $x <= $category_per_row - 1; $x++){
      echo ".afaq-6310-category-template-01 .afaq-6310-category-template-01-wrapper:nth-child({$category_per_row}n+{$x}) {
        margin-right: ".((esc_attr($category_per_row * 10)) / (esc_attr($category_per_row - 1)))."px;
      }";
    }
  ?>
  ...
  .afaq-6310-category-template-01-description {
    ...
    line-height:<?php echo esc_attr((isset($cssData['category_01_description_line_height_number_number']) && $cssData['category_01_description_line_height_number_number'] !=='') ? $cssData['category_01_description_line_height_number_number'] : 16); ?>px;
  }
</style>
