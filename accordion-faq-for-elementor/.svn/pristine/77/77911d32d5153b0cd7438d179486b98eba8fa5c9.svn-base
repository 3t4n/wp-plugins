...
function afaq_6310_faq_faq_install()
{
   ...
   if(!$install_default){
      $wpdb->query("INSERT INTO {$wpdb->prefix}options(option_name, option_value) VALUES ('faq_6310_editor_type', 'new')");
      $wpdb->query("INSERT INTO {$wpdb->prefix}options(option_name, option_value) VALUES ('faq_6310_install_default', 1)");
   } else{
      if(!$faq_6310_editor_type){
         $wpdb->query("INSERT INTO {$wpdb->prefix}options(option_name, option_value) VALUES ('faq_6310_editor_type', 'old')");
      }
      return;
   }
...
function afaq_6310_description($description){
   $faq_6310_editor_type = faq_6310_get_option( 'faq_6310_editor_type');
   if($faq_6310_editor_type == 'old'){
      return wpautop(stripslashes(html_entity_decode(esc_attr(afaq_6310_scRemove($description)))));
   }
   return afaq_6310_scRemove(wpautop(html_entity_decode($description)));
