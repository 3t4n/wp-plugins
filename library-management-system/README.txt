...
Tags: library, management, system, books, LMS
...
Now, if you have decided to get this plugin to use for your library, please look into this list of premium features as well. These features make it more powerful to manage everything efficiently. This is the full list of features provided by LMS.
...
LMS comes with 2-tier Premium Levels. Tiers are **Basic**, **Full**. You will feel the real magic of the Library Management System plugin by using its Full Version.
...
No, we have built **Library management system** to be extremely easy to use and manage.

**Do you provide support?**
Yes, We have an LMS Support team available. You can drop your query with the email mentioned.

**Is plugin data backup feature available?**
Yes, but it is available in a Pro version of the LMS plugin. By using this, you can take plugin data backup anytime and restore it in future to the same website or a different website.

== Changelog ==

= 3.1 =
* Feature - Added Sync WordPress Users to LMS
* Feature - Self Checkout / Self Return by User from Frontend
* Feature - Borrowed Books / Returned Books list for Users
* Feature - Users can Request to Borrow Book
* Feature - Data Clone Function for any module like Bookcases, Sections, Categories, Books, etc
* Feature - Bulk Data Operation for Delete, Move to Active Status, Inactive Status for any module like Bookcases, Sections, Categories, Books, etc
* Feature - Multi-Librarian Support
* Feature - Sell PDF eBooks with WooCommerce store

= 3.0 =
* Feature - Added WooCommerce Integration
* Feature - Enhanced User History Management

= 2.5 =
* Fix - Improved Transaction Tracking
* Fix - Enhanced Reporting Options
...
= 3.1 =
Upgrade to the latest version for new features including WordPress user synchronization, self-checkout, and multi-librarian support.
