...
if ( 'ngg-' == substr( $_REQUEST['id'], 0, 4 ) ) {
	...
	$fpwImage = wp_get_attachment_image_src( $_REQUEST['id'] );
	echo '<img src="' . $fpwImage[0] . '" class="attachment-thumbnail size-thumbnail" alt width="' . get_option('thumbnail_size_w') . '">';
