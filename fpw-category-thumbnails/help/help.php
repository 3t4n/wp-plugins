...
$opts =		'<p style="font-size: larger">' . __( 'Available Options', 'fpw-category-thumbnails' ) . '</p>' .
			...
			'<strong>' . __( "Add thumbnail column to categories list", 'fpw-category-thumbnails' ) . '</strong> ' .
			'( ' . __( 'checked', 'fpw-category-thumbnails' ) . ' ) - ' . __( "adds custom column <strong>Thumbnails</strong> to the list of categories", "fpw-category-thumbnails" ) . '<br />' .
            '<strong>' . __( "Add thumbnail column to posts list", 'fpw-category-thumbnails' ) . '</strong> ' .
			'( ' . __( 'checked', 'fpw-category-thumbnails' ) . ' ) - ' . __( "adds custom column <strong>Thumbnails</strong> to the list of posts", "fpw-category-thumbnails" ) . '<br />' .
