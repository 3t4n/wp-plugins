...
* Tested up to 6.5
= 1.9.4 =
* Added options to control insertion of category thumbnal column to list of categories / posts
* Updated plugin's help screen
= 1.9.3 =
* Added category thumbnal column to list of posts
= 1.9.2 =
* Minor code fixes
= 1.9.1 =
* Removed code for old translation methods
= 1.9.0 =
* PHP 8 compatibility
* FPW Post Thumbnails - Fixed: AJAX forms submition
= 1.8.0 =
