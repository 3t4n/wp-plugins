...
class WCISPluginWidget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct('isp_search_box_widget',
            __( 'Fast Simon Search Box', 'instantsearch-for-woocommerce' ),
            array('description' => __( 'Fast Simon search box for your site', 'instantsearch-for-woocommerce' ),
    ...
    public function form( $instance ) {
        ...
        $form = '
			<p>
				<label for="'. $this->get_field_id('search_box_inner_text') .'">'. __('Search box inner text: ', 'instantsearch-for-woocommerce'). '</label>
			...
			<p>
				<label for="'. $this->get_field_id('search_box_width') .'">'. __('Width - search box size: ', 'instantsearch-for-woocommerce'). '</label>
			...
			<p>
				<label for="'. $this->get_field_id('search_box_height') .'">'. __('Height - search box size: ', 'instantsearch-for-woocommerce'). '</label>
			...
			<p>
				<label for="'. $this->get_field_id('search_box_units') .'">'. __('Height/Width units: ', 'instantsearch-for-woocommerce'). '</label>
				
		        <label for="rem">'. __('rem', 'instantsearch-for-woocommerce'). '
	            ...
	            <label for="percent">'. __('percent(%%)', 'instantsearch-for-woocommerce'). '
			...
			<p>
				<label for="'. $this->get_field_id('search_box_float') .'">'. __('Float - push/move search box to the left or to the right side: ', 'instantsearch-for-woocommerce').'</label>
