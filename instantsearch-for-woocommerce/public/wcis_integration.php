...
class WCISIntegration extends WC_Integration{
	public function __construct() {
		...
		$this->method_title       = __( 'Fast Simon for WooCommerce', 'instantsearch-for-woocommerce' );
		 
		$this->method_description = __( 'Best search plugin for WooCommerce.', 'instantsearch-for-woocommerce' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
	 			'customize_button' => array(
	 				'title'             => __( 'Fast Simon Dashboard', 'instantsearch-for-woocommerce' ),
 					'button_name'       => __( 'Load Fast Simon Dashboard', 'instantsearch-for-woocommerce' ),
	 				'type'              => 'button',
	 				'custom_attributes' => array(
	 									'onclick' => "window.open('" . $dashboard_url . "', '_blank')",
					),
	 				'description'       => __( 'Customize your settings by going to the integration site directly.', 'instantsearch-for-woocommerce' ),
	 				'desc_tip'          => true,
	  			)
