...
function alumnionline_reunion_website_set_default_settings() {
	...
	$defaults = array(
		...
		'alumnionline_media_page'            => alumnionline_reunion_website_getpost_id_by_title( __( 'Media', 'alumnionline-reunion-website' ) ),
		'pagination_limit'                   => '15',
		'file_size_limit'                    => '2',
		'file_formats'                       => 'image/jpg,image/jpeg',
		'alumnionline_nav_menu'              => '',
		'alumnionline_public_content'        => '',
		'alumnionline_disable_logging'       => 'true',
		'alumnionline_photo_thumbnails'      => '',
		'alumnionline_maincontent_id'        => 'maincontent',
		'included_media_categories'          => '',
		'youtube_channel'                    => '',
		'youtube_channel_playlist'           => '',
		'youtube_channel_results'           => '10',
		'alumnionline_disable_public_user_tags' => '',
	);
...
<div class="alumnionline-reunion-website-setup-instructions">
	...
	<ol>
		...
		<li>
			<?php esc_html_e( 'To allow users to upload profile pictures instead of using Gravatar, install the ', 'alumnionline-reunion-website' ); ?>	
			<a href="https://wordpress.org/plugins/one-user-avatar/" target="_blank" title="<?php esc_html_e( 'opens in a new tab', 'alumnionline-reunion-website' ); ?>"><?php esc_html_e( ' One User Avatar plugin ', 'alumnionline-reunion-website' ); ?></a>
</li>
		<li><?php esc_html_e( 'Review or change additional settings as desired.', 'alumnionline-reunion-website' ); ?>
		</li>
		<li><a
				href="<?php echo esc_url_raw( site_url() ); ?>/wp-admin/options-general.php"><?php esc_html_e( 'Enable "Anyone can register" on the General Settings page.', 'alumnionline-reunion-website' ); ?></a>
		</li>
	</ol>
	<p> <a
...
<div class="alumnionline-reunion-website-pages alumnionline-reunion-website-fields hidden">
	...
	<p class="description">
		<label
			for="file_formats"><?php esc_html_e( 'Comma seperated list of allowed mimetypes of file uploads: ', 'alumnionline-reunion-website' ); ?>
			(<a href="https://mimetype.io/all-types" target="_blank"
				title="<?php esc_html_e( 'opens a new tab', 'alumnionline-reunion-website' ); ?>"><?php esc_html_e( 'mimetypes', 'alumnionline-reunion-website' ); ?></a>)<br><textarea
				id="file_formats" size="45" cols="45" rows="10"
				name="alumnionline_reunion_website_settings[file_formats]" type="text"><?php
				if ( isset( $settings['file_formats'] ) ) {
					echo esc_attr( $settings['file_formats'] );
				}?></textarea></label>
	</p>
	<?php
	if ( function_exists( 'SimpleLogger' ) ) {
		if ( ! array_key_exists( 'alumnionline_disable_logging', $settings ) ) {
			$settings['alumnionline_disable_logging'] = 'true';
		}
		?>
	<p class="description">
		<label for="alumnionline_disable_logging">
			...
			<?php esc_html_e( 'Enable activity log. - Requires the free ', 'alumnionline-reunion-website-pro' ); ?>
			<a href="https://wordpress.org/plugins/simple-history/" target="_blank"
				title="<?php esc_html_e( 'opens a new tab', 'alumnionline-reunion-website' ); ?>"><?php esc_html_e( 'Simple History plugin', 'alumnionline-reunion-website-pro' ); ?></a>
		</label>
	</p>
	<?php } ?>

	<p class="description">
		<label for="alumnionline_photo_thumbnails">
			<input type="checkbox" id="alumnionline_photo_thumbnails" value="true"
				name="alumnionline_reunion_website_settings[alumnionline_photo_thumbnails]" 
				<?php
				if ( 'true' === $settings['alumnionline_photo_thumbnails'] ) {
					echo ' checked ';
				}
				?>
			>
			<?php esc_html_e( 'Display photo thumbnails in message board topic lists. ', 'alumnionline-reunion-website-pro' ); ?>
		</label>
	</p>
