...
class OWCPV_Run{
	...
	public function enqueue_backend_scripts_and_styles() {
		...
		wp_register_script( 'owcpv-input-number-format-lib', OWCPV_PLUGIN_URL . 'assets/js/libs/input-number-format.jquery.min.js', array( 'jquery' ), OWCPV_VERSION, true );
		...
		wp_enqueue_script( 'owcpv-input-number-format-lib' );
