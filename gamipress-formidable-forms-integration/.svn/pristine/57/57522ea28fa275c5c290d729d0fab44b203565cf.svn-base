...
function gamipress_frm_requirement_ui_fields( $requirement_id, $post_id ) {
    ...
    <span class="frm-field-name"><input type="text" value="<?php echo $field_name; ?>" placeholder="<?php echo __( 'Field name', 'gamipress-formidable-forms-integration' ); ?>" /></span>
    <span class="frm-field-value"><input type="text" value="<?php echo $field_value; ?>" placeholder="<?php echo __( 'Field value', 'gamipress-formidable-forms-integration' ); ?>" /></span>
