...
final class Tools {
	...
	function register_settings() {
		...
		// 			'attribute' => [ 
		// 				'type' => 'checkbox',
		// 				'name' => $this->option_name . '[email_logs]',
		// 			],
		// 			'value'     => $this->settings['email_logs'] ?? "",
		// 			'note'      => 'See: Admin dashboard/ Tools/ Email logs',
		// 		] );
		// 	},
		// 	$this->id,
		// 	'adminz_tools_log'
