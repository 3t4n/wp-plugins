...
$___->shortcode_name     = 'mk_readmore_readless';
$___->shortcode_title    = 'Read more read less';
...
$___->shortcode_callback = function ($atts, $content=null) {
	...
	?>
	<div class="adminz_readmore mk_readmore_readless" id="<?php echo esc_attr( $_id ); ?>">
	<div class="adminz_readmore_inner mk_readmore_readless_content relative">
