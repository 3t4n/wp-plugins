	...
	function register_settings() {
		...
		add_settings_field(
			...
			function () {
				$list = [
					'Tools/ Request logs',
					'Tools/ Email logs - move from mailer',
					'Wpcf7/ Thankyou',
					'Tools/ Server tools',
					'Wordpress/ Login footer text',
					'Flatsome/ Slider auto free scroll',
					'Wordpress/ Quiz login',
					'Wpcf7/ New letters',
					'Wpcf7/ email layout',
					'Wordpress/ Taxonomy thumbnail (renew)',
					'Wordpress/ Gettext',
					'Enqueue/ Photoswipe (renew)',
					'Wordpress/ Preg Replace',
					'Email/ Email logs ans Schedule',
					'Flatsome/Mfp button element',
					'Flatsome/Ux menu with custom icons',
					'Woocommerce/Order notification to Teletegram',
					'Flatsome/Change flatsome icons',
					'Flatsome/Button with custom icons',
		...
		add_settings_field(
			...
			'Adminz old version',
			function () {
				echo '<a class="button" target="_blank" href="https://quyle91.net/files/administrator-z.zip">Download v3000</a>';
			},
			$this->id,
			'adminz'
		);		
		...
		add_settings_field(
			...
			'Document',
			function () {
				echo '<a class="button" href="https://quyle91.net" target="_blank">
					https://quyle91.net
				</a>';
			},
			$this->id,
