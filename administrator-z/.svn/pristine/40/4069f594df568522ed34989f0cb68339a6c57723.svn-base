		...
		add_settings_field(
			...
			function () {
				...
				echo adminz_field( [ 
					...
					'note'      => 'Previous - Slider nav light',
				] );
				// field
				echo adminz_field( [ 
					'field'     => 'input',
		...
		add_settings_field(
			...
			<p>
				<small>
					...
					<?= adminz_copy( '[adminz_post_field post_field="post_content"][/adminz_post_field]' ) ?> |
