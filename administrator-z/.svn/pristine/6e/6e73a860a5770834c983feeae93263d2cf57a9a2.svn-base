...
$___->shortcode_callback = function ($atts, $content = null) {
	...
	<style type="text/css">
		...
		if ( $slide_item_padding ) {
			...
			#<?php echo esc_attr( $_id ); ?> .flickity-slider>* {
				padding-left:
					<?php echo esc_attr( $slide_item_padding ); ?>
				;
				padding-right:
					<?php echo esc_attr( $slide_item_padding ); ?>
				;
	...
	<div class="<?php echo esc_attr( $wrapper_classes ); ?>" id="<?php echo esc_attr( $_id ); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
		<div class="<?php echo esc_attr( $classes ); ?>" data-flickity-options='{
				"cellAlign": "<?php echo esc_attr( $slide_align ); ?>"
				,"imagesLoaded": true
				,"lazyLoad": 1
				,"freeScroll": <?php echo esc_attr( $freescroll ); ?>
				,"wrapAround": <?php echo esc_attr( $infinitive ); ?>
				<?php if ( $auto_slide ) : ?>,"autoPlay": <?php echo esc_attr( $auto_slide ) ?> <?php endif; ?>
				...
				,"adminz_auto_freescroll_direction": "<?php echo esc_attr( $adminz_auto_freescroll_direction ); ?>"
				,"adminz_auto_freescroll_speed": "<?php echo esc_attr( $adminz_auto_freescroll_speed ); ?>"
				,"adminz_auto_freescroll_mobile": "<?php echo esc_attr( $adminz_auto_freescroll_mobile ); ?>"
