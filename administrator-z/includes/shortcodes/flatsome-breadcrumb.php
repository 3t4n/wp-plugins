...
$___->shortcode_name     = 'adminz_breadcrumb';
$___->shortcode_title    = 'Breadcrumb';
...
$___->options            = function () {
	...
	// $_options['integrations'] = $other_plugins;
	$_options['seperator'] = array(
		'type'    => 'textfield',
		'heading' => 'Seperator',
		'default' => '/',
	...
	$_options['hide_current_item'] = array(
		'type'    => 'checkbox',
	...
	$_options['post_title_options'] = array(
		'type'    => 'group',
		'heading' => __( 'Title' ),
		'options' => array(
			'size'  => array(
	...
	$_options['advanced_options'] = require( get_template_directory() . '/inc/builder/shortcodes/commons/advanced.php' );
	return $_options;
};
$___->shortcode_callback = function ($atts, $content = null) {
	// make sure load 1 time
	if (
		isset( $GLOBALS['administrator-z']['breadcrumb_exist'] ) &&
		$GLOBALS['administrator-z']['breadcrumb_exist'] === true ) {
		return '';
	}
	$GLOBALS['administrator-z']['breadcrumb_exist'] = true;
	...
	} else if ( class_exists( 'WPSEO_Admin_Init' ) ) {
	...
	<style type="text/css">
		...
		#<?php echo do_shortcode( $_id ); ?> li {
			margin: 0px;
		}

		#<?php echo do_shortcode( $_id ); ?> li.seperator {
			margin-right: 5px;
			margin-left: 5px;
		}

		#<?php echo do_shortcode( $_id ); ?> .item {
			text-decoration: none;
		}

		<?php if ( $hide_current_item == "true" ) : ?>
			#<?php echo do_shortcode( $_id ); ?> .item-current {
				display: none
			}
