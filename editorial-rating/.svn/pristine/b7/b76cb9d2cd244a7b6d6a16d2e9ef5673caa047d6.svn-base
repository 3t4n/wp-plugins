 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WPAS_Field_shortcode' ) ) {

	class WPAS_Field_shortcode extends WPAS_Fields {
		...
		public function render() {
			...
			echo ( ! empty( $post_id ) ) ? '<div class="wpas-shortcode-input-group">
			<input id="wpasCTCinput" type="text" value=\'[editorial-rating id="' . $post_id . '"]\' readonly>
			<span class="wpas-shortcode-input-group-button">
