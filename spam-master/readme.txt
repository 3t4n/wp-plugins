=== Spam Master ===
Contributors: TechGasp,pedromalves
Tags: firewall, spam, antispam, antibot, protection
Requires at least: 5.0
Tested up to: 6.7.2
Stable tag: 7.5.7
License: GPLv2 or later

Real-Time Saas Firewall, anti-spam, anti-bot, anti-crawler and anti-flood protection from millions of known spam ips, emails, domains and words.
...
> You can Generate a Free Server License in the plugin Settings page. This plugin provides a service [software as a service wiki](https://en.wikipedia.org/wiki/Software_as_a_service).


**ONLINE DEMO**

* [Demo Link](https://www.spammaster.org/)
* [Search Threat DB](https://www.spammaster.org/search-threat/)
* [New Threats](https://www.spammaster.org/new-threats/)
* [Top Threats](https://www.spammaster.org/top-10-threats/)
* [RBL Cluster Status](https://www.spammaster.org/rbl-servers-status/)

**ONLINE TOOLS**

* [Manage your Stats Online](https://www.spammaster.org/websites-stats/)
* [Manage your Licenses Online](https://www.spammaster.org/licenses-stats/)
...
* [Click Here](https://www.techgasp.com)
...
4. [Spam Master Documentation](https://www.spammaster.org/documentation/)
...
Upon plugin installation click Generate Free License. You may also get a Free License in [www.spammaster.org](https://www.spammaster.org/).

= Malfunction 3 when generating a free license =
This usually occurs because of your server php version. If that's the case you can login to[www.spammaster.org](https://www.spammaster.org/) and get a free license.
...
You can check our server statistics with the following link [FREE RBL Cluster Status](https://www.spammaster.org/rbl-servers-status/).
...
Yes, emails can be individually turned off in [www.spammaster.org](https://www.spammaster.org/) Licenses page, Tools, Configure button. Make sure to login or register with your attached email, to check your attached email please visit your website Spam Master Settings page.
...
Yes, Pro License is optional and it costs peanuts per year [License](https://www.techgasp.com/downloads/spam-master-license/). Pro license allows connections to our Premium Primary and Secondary server clusters with impressive connection times.
...
You can also take a look at [Spam Master Documentation](https://www.spammaster.org/documentation/)
...
= 7.5.7 =
* Displaying database protection hash in Spam Master Settings page
* Synchronising db hash with key sender
* Checkout exemptions
* Reduced cpu and memory combining integration for external plugin functions

= 7.5.6 =
* Increased security by refreshing db protection hash weekly
* Checkout exemptions
* New Code Tamper malfunction and help
* Clean-up and speed-up

= 7.5.5 =
* New uninstall options
* New protection tools setting, you are now able to select Spam Master type of implementation. Live Production website or Test Development website.
* New action stats
* Fixing status on installs where auto connection returns INACTIVE and connection page is forced to users
...
= 7.5.3 =
* Tweaking actions.
* Add CDN status to actions.
* Add logs retention to actions.
* Tweaking notices padding and changing dashicons.
* Improved checkout fraud scans.

= 7.5.2 =
* Changing invitation dates
* Changing frequency of alert emails
* Malfunction statuses should auto fix upon status ceases or changes

= 7.5.1 =
* Changing invitation dates
* High volume labels, with spam checks demand
...
= 7.4.9 =
* Invitation should be outside malfunctions
* Changing invitation dates
...
= 7.4.7 =
* Fixing typo in invitation email
* Clean-up and speed up

= 7.4.6 =
* Removing security exemption
* Removing queue exemption
* Removing cart exemption
* New uninstall options

= 7.4.5 =
* Formatting Equals sign in wpforms
* Adding line breack to wpforms sig
* Removing time needle

= 7.4.4 =
* WPForms antibot update
* Clean up and speed improvments

= 7.4.3 =
* Action service should take in account firewall rule set
* Further speed improvements and log reduction
* Load reduction by removing duplicate checks in forms via HAF check
* Honeypot and antibot single check trigger
* Cleaning and removing legacy data collection in honeypot and HAF

= 7.4.2 =
* New whitelist management page in Spam Master Settings Protection Tools tab
* New buffer management page in Spam Master Settings Protection Tools tab
* Relaxed firewall rules should account for sniffers
* More scan exemptions from known origins

= 7.4.1 =
* Fine tunning Relaxed firewall rule set
* Actions should be exempt from status
* Actions should account for firewall rules
* More scan exemptions from known origins
...
= 6.6 =
* IMPORTANT Stable Release, if you helped us test the Plugin, upgrade to Stable release
* Version 6 is currently being developed, please check logs here.
