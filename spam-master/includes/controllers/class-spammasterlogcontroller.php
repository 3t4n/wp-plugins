...
class SpamMasterLogController {
	...
	public function spammasterlog( $remote_ip, $blog_threat_email, $remote_referer, $dest_url, $remote_agent, $spamuser_a, $spamtype, $spamvalue, $cache ) {
		...
		if ( 'VALID' === $spam_master_status || 'MALFUNCTION_1' === $spam_master_status || 'MALFUNCTION_2' === $spam_master_status || 'UNSTABLE' === $spam_master_status || 'HIGH_VOLUME' === $spam_master_status || 'CODE_TAMPER_1' === $spam_master_status ) {
