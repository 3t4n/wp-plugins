...
<a class="spam-master-admin-link-decor" href="' . esc_url( $current_url . '&spammasterdisfu=1', 'spammasterdisnonce' ) . '"><span class="dashicons dashicons-dismiss spam-master-top-admin-f-red spam-master-top-admin-shadow-orange spam-master-admin-float-r" title="' . __( 'Dismiss', 'spam_master' ) . '"></span></a>
	...
	public function spammasterdatecheck( $spammasterdateshort ) {
		...
		if ( 'FREE' === $spam_master_type ) {
			...
			$spamdescper        = false;
			$spamcode           = false;
			if ( '2026-01-01' === $spammasterdateshort ) {
				$spamdesc    = 'New Year';
				$spamdescper = '25%';
				$spamcode    = 'NEWYPRO25';
			}
			if ( '2025-02-14' === $spammasterdateshort ) {
				$spamdesc    = 'Valentines Day';
				$spamdescper = '25%';
				$spamcode    = 'VALENTINEPRO25';
			}
			if ( '2025-03-20' === $spammasterdateshort ) {
				$spamdesc    = 'Spring';
				$spamdescper = '25%';
				$spamcode    = 'SPRINGRO25';
			}
			if ( '2025-06-20' === $spammasterdateshort ) {
				$spamdesc    = 'Summer';
				$spamdescper = '25%';
				$spamcode    = 'SUMMERPRO25';
			}
			if ( '2025-08-01' === $spammasterdateshort ) {
				$spamdesc    = 'August';
				$spamdescper = '25%';
				$spamcode    = 'AUGUSTPRO25';
			}
			if ( '2025-10-31' === $spammasterdateshort ) {
				$spamdesc    = 'Halloween';
				$spamdescper = '25%';
				$spamcode    = 'HALLOWEENPRO25';
			}
			if ( '2025-11-28' === $spammasterdateshort ) {
				$spamdesc    = 'Black Friday';
				$spamdescper = '20%';
				$spamcode    = 'BLACKPRO20';
			}
			if ( '2025-12-01' === $spammasterdateshort ) {
				$spamdesc    = 'Cyber Monday';
				$spamdescper = '25%';
				$spamcode    = 'CYBERPRO25';
			}
			if ( '2025-12-25' === $spammasterdateshort ) {
				$spamdesc    = 'Christmas';
				$spamdescper = '20%';
				$spamcode    = 'XMASPRO20';
			}
	...
	public function spammasteradminnot( $spammasterdateshort ) {
		...
		if ( 'FREE' === $spam_master_type ) {
			if ( '2026-01-01' === $spammasterdateshort ) {
				$is_invitation = '<div class="notice notice-success spam-master-pad-notice">
					<p>
					<span class="dashicons dashicons-admin-post spam-master-admin-green"></span> 
