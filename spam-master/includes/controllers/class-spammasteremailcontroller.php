...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammasteralert( $spammail ) {
		...
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_daily_email_plus1   = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_emails_alert_date ) ) );
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammasterunstablenotify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_free_unstable_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammasterfullinactnotify( $spammail ) {
		...
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		// Plus days.
		$spam_master_emails_plus_days = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_full_inactive_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammasterfullexpnotify( $spammail ) {
		...
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		// Plus days.
		$spam_master_emails_plus_days = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_full_expired_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammasterfreeexpnotify( $spammail ) {
		...
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		// Plus days.
		$spam_master_emails_plus_days = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_free_expired_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammastertrialexpnotify( $spammail ) {
		...
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		// Plus days.
		$spam_master_emails_plus_days = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_trial_expired_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammastermalfunction1notify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_malfunction_1_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammastermalfunction2notify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_malfunction_2_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammastermalfunction6notify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_malfunction_6_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	public function spammastermalfunction8notify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_malfunction_8_date ) ) );
		// Check Notice.
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
	...
	/**
	 * Spam master code tamper 1 notify.
	 *
	 * @param spammail $spammail for email.
	 *
	 * @return string
	 */
	public function spammastercodetamper1notify( $spammail ) {
		global $wpdb, $blog_id;
		...
		$spam_master_emails_extra_email_list = $wpdb->get_var( "SELECT spamvalue FROM {$spam_master_keys} WHERE spamkey = 'Option' AND spamtype = 'spam_master_emails_extra_email_list'" );
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared
		$spam_master_code_tamper_1_date = $wpdb->get_var( "SELECT spamvalue FROM {$spam_master_keys} WHERE spamkey = 'Option' AND spamtype = 'spam_master_code_tamper_1_date'" );
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared
		$spam_master_code_tamper_1_notice = $wpdb->get_var( "SELECT spamvalue FROM {$spam_master_keys} WHERE spamkey = 'Option' AND spamtype = 'spam_master_code_tamper_1_notice'" );
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared
		$spam_master_attached = $wpdb->get_var( "SELECT spamvalue FROM {$spam_master_keys} WHERE spamkey = 'Option' AND spamtype = 'spam_master_attached'" );
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared
		$spam_master_ip = substr( $wpdb->get_var( "SELECT spamvalue FROM {$spam_master_keys} WHERE spamkey = 'Option' AND spamtype = 'spam_master_ip'" ), 0, 48 );
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_code_tamper_1_date ) ) );
		// Check Notice.
		if ( $spam_master_emails_current_date >= $spam_master_emails_plus_days && '1' !== $spam_master_code_tamper_1_notice ) {
			$data_spam1  = array( 'spamvalue' => $spam_master_emails_current_date );
			$where_spam1 = array(
				'spamkey'  => 'Option',
				'spamtype' => 'spam_master_code_tamper_1_date',
			);
			// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
			$wpdb->update( $spam_master_keys, $data_spam1, $where_spam1 );
			$data_spam2  = array( 'spamvalue' => '1' );
			$where_spam2 = array(
				'spamkey'  => 'Option',
				'spamtype' => 'spam_master_code_tamper_1_notice',
			);
			// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
			$wpdb->update( $spam_master_keys, $data_spam2, $where_spam2 );
			 ...
			 * @return string
			 */
			function spam_master_send_user_notice_codetamper1_html() {
				return 'text/html';
			}
			add_filter( 'wp_mail_content_type', 'spam_master_send_user_notice_codetamper1_html' );
			// Email Subject Title Header.
			$spam_master_subject_title = 'Warning! Code Tamper';
			$spam_master_html          = '<!DOCTYPE html><html>';
			$spam_master_header        = '<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>' . $spam_master_subject_title . '</title></head>';
			$spam_master_body          = '<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="background-color: #f6f6f6; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif;">';
			$spam_master_table_header  = '<div style="width:100%; -webkit-text-size-adjust:none !important; margin:0; padding: 70px 0 70px 0;">
...
<div style="color: #000000; font-size:14px; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; line-height:150%; text-align:left;">';
			// Email Content.
			$spam_master_table_content        = '<p>Spam Master Code Tamper detected.</p>
<p>Altered code detected. You are not protected...</p>
<p> Please read Spam Master online documentation to solve the issue.</p>
<p>Thanks</p>
<p>SpamMaster Team</p>';
			$spam_master_table_content_close  = '</div>
...
<td colspan="2" valign="middle" id="credit" style="border:0; color: #000000; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:14px; line-height:125%; text-align:center;">';
			...
			wp_mail( $to, $subject, $message, $headers );
			// Reset content-type to avoid conflicts.
			remove_filter( 'wp_mail_content_type', 'spam_master_send_user_notice_codetamper1_html' );
			...
			$spamuser                   = array( 'ID' => 'none' );
			$spamuser_a                 = wp_json_encode( $spamuser );
			$spamtype                   = 'Code Tamper';
			$spamvalue                  = 'License email code tamper notice successfully sent.';
			$cache                      = '1D';
			$spam_master_log_controller = new SpamMasterLogController();
			$is_log                     = $spam_master_log_controller->spammasterlog( $remote_ip, $blog_threat_email, $remote_referer, $dest_url, $remote_agent, $spamuser_a, $spamtype, $spamvalue, $cache );
		}
	...
	public function spammasterhighvolumenotify( $spammail ) {
		...
		// Get date.
		$spam_master_emails_current_date = current_datetime()->format( 'Y-m-d' );
		$spam_master_emails_plus_days    = gmdate( 'Y-m-d', strtotime( '+3 days', strtotime( $spam_master_high_volume_date ) ) );
		// Check Notice.
...
<div style="color: #000000; font-size:14px; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; line-height:150%; text-align:left;">';
			// Email Content.
			$spam_master_table_content        = '<p>Spam Master High Volume of spam checks detected with free keys.</p>
<p>Your blog: ' . $blogname . '</p>
<p>You are not Protected!!! Please wait 24 hours in order for spam checks count to decrease or consider a <a href="https://www.techgasp.com/downloads/spam-master-license/" title="Pro License" target="_blank"><strong><em>Pro License</strong></em></a>, it costs peanuts per year and connects to our Premium Business Server Clusters.</p>
<p>Thanks</p>
<p>SpamMaster Team</p>';
			$spam_master_table_content_close  = '</div>
</td>
