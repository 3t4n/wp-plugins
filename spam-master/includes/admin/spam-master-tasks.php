...
if ( empty( $spam_master_code_tamper_1_date ) ) {
...
if ( empty( $spam_master_code_tamper_1_notice ) ) {
	// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
	$wpdb->insert(
		$spam_master_keys,
		array(
...
if ( $spam_master_current_date >= $spam_master_code_tamper_1_date && '1' === $spam_master_code_tamper_1_notice ) {
	// Update Notice.
	$data_spam  = array( 'spamvalue' => '0' );
	$where_spam = array(
		'spamkey'  => 'Option',
