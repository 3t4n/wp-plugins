...
if ( ( is_user_logged_in() ) && ( current_user_can( 'administrator' ) ) ) {
	if ( is_multisite() ) {
		...
		foreach ( $blogs as $idb ) {
			...
			delete_blog_option( $idb, 'spam_master_upgrade_to_7_5_3' );
			delete_blog_option( $idb, 'spam_master_upgrade_to_7_5_5' );
		...
		delete_option( 'spam_master_upgrade_to_7_5_3' );
		delete_option( 'spam_master_upgrade_to_7_5_5' );
