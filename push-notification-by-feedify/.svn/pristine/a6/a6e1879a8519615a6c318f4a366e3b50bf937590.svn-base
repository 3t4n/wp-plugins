...
Donate link: 
Tags: chrome push, firefox push, mobile notifications, desktop notification, push notifications
...
* Performance optimizations and UI changes.
