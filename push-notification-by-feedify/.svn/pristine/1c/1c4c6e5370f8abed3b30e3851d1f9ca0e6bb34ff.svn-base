	...
	<form method="post" enctype="multipart/form-data" action="" id="frm_send_push">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td><textarea id="push_message" class="regular-text" name="push_message"></textarea></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="push_url">URL</label></th>
                <td><input type="text" id="push_url" class="regular-text" name="push_url" value="" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="push_url">Push Icon URL</label></th>
                <td><input type="text" id="push_icon" class="regular-text" name="push_icon" value="" /></td>
            </tr>
        </table>
        <input type="hidden" name="feedify_cmd" value="feedify_send_push_to_server" />
        <div class="btn_center">
        <button class="button button-primary" type="submit" id="btn_send_push">Send Push</button>
        </div>
	</form>
	<div class="clear"></div>
</div>