...
<?php
if(isset($_REQUEST['msg']) && $_REQUEST['msg'] == 'feedify_register' && isset($_REQUEST['_wpnonce']) && 
    wp_verify_nonce(sanitize_text_field(wp_unslash($_REQUEST['_wpnonce'])), 'feedify_register')
) 
{
	?>
...
?>
    ...
    <div class="upImageSection">
      ...
      <div class="uploadImage">
        <div class="uploadImageLeft">
          <input type="text" id="image_url" class="regular-text" value="<?php echo isset($feedify_uploded_logo) ?  esc_attr($feedify_uploded_logo) : '' ; ?>" readonly="readonly">
        </div>
    ...
    <input type="hidden" name="custom_image_url_type" id="custom_image_url_type" value="<?php echo isset($custom_image_url_type) ?  esc_attr($custom_image_url_type)  : ''; ?>" />
    <input type="hidden" name="custom_image_url" id="custom_image_url" value="<?php echo isset($feedify_is_website_logo) ?  esc_attr($feedify_is_website_logo) : '' ; ?>" />
