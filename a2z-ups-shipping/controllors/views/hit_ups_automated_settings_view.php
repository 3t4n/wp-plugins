...
<fieldset>
 ...
 <table style="padding-left:10px;padding-right:10px;">
		...
		<td><span style="float:right;padding-right:10px;"><input type="checkbox" name="hit_ups_auto_ppt" <?php _e((isset($general_settings['hit_ups_auto_ppt']) && $general_settings['hit_ups_auto_ppt'] == 'yes') || ($initial_setup) ? 'checked="true"' : '','hit_ups_auto'); ?> value="yes" ><small style="color:gray"> Paperless Trade.</small></span></td>	
	</table>
