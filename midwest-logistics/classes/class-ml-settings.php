    ...
    class ML_Settings {
        ...
        public function settings_init(  ) { 
            ...
            add_settings_field( 
                ...
                __( 'Order lookup batch count:', 'Midwest_Logistics' ), 
                array($this,'check_tracking_order_count'),
                'Midwest_Logistics_plugin_Page', 
                'Midwest_Logistics_Midwest_Logistics_plugin_Page_section' 
            );  
            add_settings_field( 
                'Midwest_Logistics_api_timeout_setting', 
                __( 'API Connection Timeout Seconds:', 'Midwest_Logistics' ), 
                array($this,'api_timeout_setting'),
                'Midwest_Logistics_plugin_Page', 
                'Midwest_Logistics_Midwest_Logistics_plugin_Page_section' 
            );  
            /*
        ...
        public function check_tracking_order_count(  ) { 
            $options = get_option( 'Midwest_Logistics_settings' );  
            $value = "50";
            if(isset($options['Midwest_Logistics_tracking_order_count'])) {
                $value = $options['Midwest_Logistics_tracking_order_count'];
            }
            if(empty($value)) {
                $value = "50";
            }
            $optionArray = ["5","10","15","20","25","30","35","40","45","50"];
            ?>    
            
            <select name='Midwest_Logistics_settings[Midwest_Logistics_tracking_order_count]'>
                <?php
            ...
            <p>This option specifies how many orders are checked per hour for tracking updates. Orders are checked consecutively.</p>
            <p>For best performance, this should be set as low as possible to check all orders in 24 hours</p>
            <?php
        }
        public function api_timeout_setting(  ) { 
            $options = get_option( 'Midwest_Logistics_settings' );  
            $value = "60";
            if(isset($options['Midwest_Logistics_api_timeout_setting'])) {
                $value = $options['Midwest_Logistics_api_timeout_setting'];
            }
            if(empty($value)) {
                $value = "60";
            }
            $optionArray = ["60","120","180","240","300"];
            ?>
            
            <select name='Midwest_Logistics_settings[Midwest_Logistics_api_timeout_setting]'>
                <?php
                foreach($optionArray as $option ) {
                    ?><option value='<?php echo $option ?>' <?php selected( $value, $option ); ?>><?php echo $option ?></option><?php
                }
            ...
            <p>Default is 60 seconds. Do not change this setting unless requested by Midwest Logistics IT support.</p>
            <?php
        }
