...
const ControlStyled = styled.fieldset`
...
export function UnitRangeControl({
  ...
  unitsProp = { ...RANGE_CONTROL_CUSTOM_SETTINGS, ...unitsProp };
  ...
  return (
    <ControlStyled className={clsx("unit-range-control", className)}>
      {!hideLabelFromVision && (
