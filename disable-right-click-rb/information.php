...
<div class="rbs_nw_wrap">
    <div class="rbs_nw_item">
        <div class="rbs_nw_item_logo">
            <img class="rbs_nw_item_logo_ro" src="<?php echo RB_DISABLE_RIGHT_CLICK_URL; ?>assets/images/logo_rg.gif" width="150" hight="150">
        </div>
    ...
    <div class="rbs_nw_item">
        <div class="rbs_nw_item_logo">
            <img class="rbs_nw_item_logo_upz" src="<?php echo RB_DISABLE_RIGHT_CLICK_URL; ?>assets/images/upzilla_black_logo.svg" width="225" hight="100">
        </div>
        <h3 class="rbs_nw_item_header">
            <?php _e('Free website uptime and performance monitoring service for your WordPress', 'disable-comments-rb'); ?>
        </h3>
        <div  class="rbs_nw_item_button">
            <a class="button-primary" href="https://www.upzilla.co/?pk_campaign=wp_dp_rb" target="_blank">
