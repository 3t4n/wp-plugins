...
class PLZ_PleziForm extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Plezi form', 'plezi' );
	...
	public function get_fields() {
		...
		$options = array( '' => __( 'Choose a Plezi form', 'plezi' ) );
		...
		return array(
			'plezi_form' => array(
				'default' => esc_html__( 'Choose a form', 'plezi' ),
				'label' => esc_html__( 'Plezi form', 'plezi' ),
				'type' => 'select',
				'option_category' => 'basic_option',
				'options' => $options,
				'toggle_slug' => 'main_content',
				'description' => esc_html__( 'Choose a plezi form', 'plezi' ),
			),
		);
	}
