...
class PLZ_List_Forms extends WP_List_Table {
  ...
  public function get_columns() {
    $columns = array('name' => __('Name', 'plezi'),
                     'edit' => __('Edit', 'plezi'),
                     'plz_preview' => __('Preview', 'plezi'),
                     'stats' => __('Stats', 'plezi'),
                     'shortcode' => __('Shortcode', 'plezi'),
                     'copy' => __('Copy', 'plezi'),
                    );
  ...
  public function column_default( $item, $column_name ) {	
    switch ( $column_name ) :
      ...
      case 'edit':
        $content = '<a href="https://enjoy.plezi.co/resources/" title="' . esc_attr__( 'Edit', 'plezi' ) . ' - ' . esc_attr( $item->attributes->title ) . '" target="_blank">';
        ...
        return $content;
      case 'plz_preview':
        $content = '<a href="#" title="' . esc_attr__( 'Preview', 'plezi' ) . ' - ' . esc_attr( $item->attributes->title ) . '" form-id="' . esc_attr( $item->id ) . '" class="plz-preview-shortcode">';
        ...
        return $content;
      case 'stats':
        $content = '<a href="https://enjoy.plezi.co/resources/" title="' . esc_attr__( 'Stats', 'plezi' ) . ' - ' . esc_attr( $item->attributes->title ) . '" target="_blank">';
      ...
      case 'copy':
        $content = '<a href="#" title="' . esc_attr__( 'Copy', 'plezi' ) . ' - ' . esc_attr( $item->attributes->title ) . '" form-id="' . esc_attr( $item->id ) . '" class="plz-copy-shortcode">';
