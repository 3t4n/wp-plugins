...
abstract class RobotSettings {
    protected static function getRobotPrimaryCats($id, $postType) {
        ...
        $default = [
            'term_id' => 'none',
            'name'    => __('None (will disable this feature)', 'wp-rankology'),
        ];
    ...
    public static function getMetaKeys($id = null) {
        ...
        $data = apply_filters('rankology_api_meta_robot_settings', [
            [
                ...
                'default'     => 'yes',
                'label'       => __('Do not display this page in search engine results / XML - HTML sitemaps (noindex)', 'wp-rankology'),
                'visible'     => true,
            ],
            [
                ...
                'default'     => 'yes',
                'label'       => __('Do not follow links for this page (nofollow)', 'wp-rankology'),
                'visible'     => true,
            ],
            [
                ...
                'default'     => 'yes',
                'label'       => __('Do not display a "Cached" link in the Google search results (noarchive)', 'wp-rankology'),
                'visible'     => true,
            ],
            [
                ...
                'default'     => 'yes',
                'label'       => __('Do not display a description in search results for this page (nosnippet)', 'wp-rankology'),
                'visible'     => true,
            ],
            [
                ...
                'default'     => 'yes',
                'label'       => __('Do not index images for this page (noimageindex)', 'wp-rankology'),
                'visible'     => true,
            ],
            [
                ...
                'type'        => 'input',
                'use_default' => '',
                'placeholder' => sprintf('%s %s', __('Default value: ', 'wp-rankology'), urldecode(get_permalink($id))),
                'default'     => '',
