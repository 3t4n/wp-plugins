...
namespace RankologyFno\Services\Admin\Settings;
...
class RenderSectionPro
{
    ...
    public function render($key)
    {
        ...
        $breadcrumbs_desc = __('Configure your breadcrumbs, using schema.org markup, helps to appear in Google\'s search results.', 'wp-rankology') . ' <a class="rankology-help" href="https://developers.google.com/search/docs/data-types/breadcrumb" target="_blank" title="' . __('Google developers website (new window)', 'wp-rankology') . '">' . __('Lean more on Google developers website', 'wp-rankology') . '</a><span class="rankology-help dashicons dashicons-redo"></span>';

        $sections = [
            'local-business'=> [
                'toggle' => 1,
                'title'  => __('Local Business', 'wp-rankology'),
                'desc'   => sprintf(__('Local Business data type for Google. This schema will be displayed on the homepage. <br>You can also display these informations using our <a href="%1$s">Local Business widget</a> or Local Business block to optimize your site for Google EAT.', 'wp-rankology'), admin_url('widgets.php')),
            ],
            'edd'=> [
                'toggle' => 1,
                'title'  => __('Easy Digital Downloads', 'wp-rankology'),
                'desc'   => __('Improve Easy Digital Downloads SEO.', 'wp-rankology'),
            ],
            'woocommerce'=> [
                'toggle' => 1,
                'title'  => __('WooCommerce', 'wp-rankology'),
                'desc'   => __('Improve WooCommerce SEO. By enabling this feature, we‘ll automatically add <strong>product identifiers type</strong> and <strong>product identifiers value</strong> fields to the WooCommerce product metabox (barcode) for the Product schema.', 'wp-rankology'),
                'alert'  => sprintf(__('We also recommend <a class="nav-tab" %s>adding WooCommerce directives to your robots.txt</a> file to reduce your crawl budget.','wprankology-fno'), 'id="tab_rankology_robots-tab" href="?page=rankology-fno-page#tab=tab_rankology_robots" style="
                display: inline;
                margin: inherit;
                padding: inherit;
            ...
            'dublin-core'=> [
                'toggle' => 1,
                'title'  => __('Dublin Core', 'wp-rankology'),
                'desc'   => __('Dublin Core is a set of meta tags to describe your content.<br> These tags are automatically generated. Recognized by states / governements, they are used by directories, Bing, Baidu and Yandex.', 'wp-rankology'),
            ],
            'rich-snippets'=> [
                'toggle' => 1,
                'title'  => __('Structured Data Types (schema.org)', 'wp-rankology'),
                'desc'   => __('Add Structured Data Types support, and get better Google Search Results.', 'wp-rankology'),
            ],
            'page-speed'=> [
            ...
            'rss'=> [
                ...
                'desc'  => sprintf(__('Configure WordPress default feeds. <br><br><a href="%s" class="btn btnSecondary" target="_blank">View my RSS feed</a>', 'wp-rankology'), get_home_url() . '/feed'),
            ],
            'rewrite'=> [
                'toggle' => 1,
            ...
            'ai'=> [
                ...
                'desc'   => __('Use the power of OpenAI to improve your content.', 'wp-rankology'),
            ],
        ];
