            ...
            $.ajax({
                ...
                success: function (s) {
                    ...
                    $("#rankology_cpt .google-snippet-preview .snippet-title").html(s.data._rankology_titles_title),
                        ...
                        $("#rankology_cpt .google-snippet-preview .snippet-description").html(s.data.rankology_titles_desc),
                        $("#rankology_cpt .google-snippet-preview .snippet-description-default").html(s.data.rankology_titles_desc),
                        $("#rankology_titles_desc_meta").val(s.data.rankology_titles_desc),
                        ...
                        $("#rankology_titles_title_meta_cb").val(s.data._rankology_titles_title_ct),
                        $("#rankology_cpt .google-snippet-preview .snippet-description-ct").html(s.data._rankology_titles_desc_ct),
                        $("#rankology_cpt .google-snippet-preview .snippet-description-default-ct").html(s._data.rankology_titles_desc_ct),
                        $("#rankology_titles_desc_meta_ct").val(s.data._rankology_titles_desc_ct)
