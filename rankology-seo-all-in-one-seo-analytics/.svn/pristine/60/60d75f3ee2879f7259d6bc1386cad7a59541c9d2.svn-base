...
<label for="rankology_404_enable">
    <input id="rankology_404_enable" name="rankology_fno_option_name[rankology_404_enable]" type="checkbox" <?php checked($check, '1'); ?>
    value="1"/>
...
<label for="rankology_404_cleaning">
    <input id="rankology_404_cleaning" name="rankology_fno_option_name[rankology_404_cleaning]" type="checkbox" <?php checked($check, '1'); ?>
    value="1"/>
    <?php
        $args = [];
...
<select id="rankology_404_redirect_home" name="rankology_fno_option_name[rankology_404_redirect_home]">
...
function rankology_404_redirect_custom_url_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_404_redirect_custom_url]" placeholder="' . esc_html__('Enter your custom url', 'wp-rankology') . '" aria-label="' . __('Redirect to specific URL', 'wp-rankology') . '" value="%s"></textarea>',
        esc_html($check)
    );
}
...
<select id="rankology_404_redirect_status_code" name="rankology_fno_option_name[rankology_404_redirect_status_code]">
...
<label for="rankology_404_enable_mails">
    <input id="rankology_404_enable_mails" name="rankology_fno_option_name[rankology_404_enable_mails]" type="checkbox"
        <?php checked($check, '1'); ?>
    value="1"/>
...
function rankology_404_enable_mails_from_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_404_enable_mails_from]" placeholder="' . esc_html__('Enter your email', 'wp-rankology') . '" aria-label="' . __('Send emails to', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
...
<label for="rankology_404_disable_automatic_redirects">
    <input id="rankology_404_disable_automatic_redirects"
        name="rankology_fno_option_name[rankology_404_disable_automatic_redirects]" type="checkbox" <?php checked($check, '1'); ?>
    value="1"/>
...
<label for="rankology_404_disable_guess_automatic_redirects_404">
    <input id="rankology_404_disable_guess_automatic_redirects_404"
        name="rankology_fno_option_name[rankology_404_disable_guess_automatic_redirects_404]" type="checkbox" <?php checked($check, '1'); ?>
    value="1"/>
...
<select id="rankology_404_ip_logging" name="rankology_fno_option_name[rankology_404_ip_logging]">
    <option <?php if ('none' == $selected) { ?>
        selected="selected"
        <?php } ?>
