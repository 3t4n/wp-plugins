...
class ACP_Column_rkseo_canonical extends AC\Column\Meta
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-rkseo_canonical' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'Canonical', 'wp-rankology' ) );
	}
	...
	public function editing() {
		return new ACP_Editing_Model_rkseo_canonical( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_rkseo_canonical( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_canonical( $this );
	}
 ...
 */
class ACP_Editing_Model_rkseo_canonical extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_rankology_robots_canonical', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_canonical extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_canonical extends \ACP\Export\Model {
