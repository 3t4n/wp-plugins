...
namespace {
    if (!\class_exists('Puc_v4p13_Plugin_UpdateChecker', \false)) {
        ...
        class Puc_v4p13_Plugin_UpdateChecker extends \Puc_v4p13_UpdateChecker
        {
             ...
             * @param string $optionName Where to store book-keeping info about update checks. Defaults to 'geoipset_updates-$slug'.
            ...
            /**
             * Register a callback for filtering the plugin info retrieved from the geoipset API.
             *
