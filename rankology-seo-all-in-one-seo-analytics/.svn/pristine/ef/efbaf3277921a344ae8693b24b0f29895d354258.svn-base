...
class I18nUniversalMetabox
{
    public function getTranslations() {
        ...
        return [
            'generic' => [
                'pixels' => __('pixels', 'wp-rankology'),
                'save' => __('Save', 'wp-rankology'),
            ...
            'services' => [
                ...
                'canonical_url' => [
                    ...
                    'canonicals_found' => __('We found %d canonical URL in your source code. Below, the list:', 'wp-rankology'),
                    'canonicals_found_plural' => __('We found %d canonicals URLs in your source code. Below, the list:', 'wp-rankology'),
            ...
            'forms' => [
                'maximum_limit' => __('maximum limit', 'wp-rankology'),
                'maximum_recommended_limit' => __('maximum recommended limit', 'wp-rankology'),
                'meta_title_description' => [
                    'title' => __('Title', 'wp-rankology'),
                    'tooltip_title' => __('Meta Title', 'wp-rankology'),
                    ...
                    'placeholder_title' => __('Enter your title', 'wp-rankology'),
                    'meta_description' => __('Meta description', 'wp-rankology'),
                    ...
                    'placeholder_description' => __('Enter your description', 'wp-rankology'),
                    'generate_ai' => __('Generate meta with AI', 'wp-rankology')
                ],
                'repeater_how_to' => [
                    'title_step' => __(
            ...
            'google_preview' => [
                'title'  => __('Google Preview', 'wp-rankology'),
                'tooltip_title' => __('Snippet Preview', 'wp-rankology'),
                'tooltip_description_1' => __('The Google preview is a simulation.', 'wp-rankology'),
                'tooltip_description_2' => __('There is no reliable preview because it depends on the screen resolution, the device used, the expression sought, and Google.', 'wp-rankology'),
                'tooltip_description_3' => __('There is not one snippet for one URL but several.', 'wp-rankology'),
                'tooltip_description_4' => __('All the data in this overview comes directly from your source code.', 'wp-rankology'),
                'tooltip_description_5' => __('This is what the crawlers will see.', 'wp-rankology'),
                'description' => __(
            ...
            'layouts' => [
                'meta_robot' => [
                    ...
                    'robots_index_tooltip_title' => __('"noindex" robots meta tag', 'wp-rankology'),
                    ...
                    'robots_follow_tooltip_title' => __('"nofollow" robots meta tag', 'wp-rankology'),
                    ...
                    'robots_archive_tooltip_title' => __('"noarchive" robots meta tag', 'wp-rankology'),
                    ...
                    'robots_snippet_tooltip_title' => __('"nosnippet" robots meta tag', 'wp-rankology'),
                    ...
                    'robots_imageindex_tooltip_title' => __('"noimageindex" robots meta tag', 'wp-rankology'),
                ...
                'content_analysis' => [
                    ...
                    'description_2' => '',
                    'title_severity' => __('Degree of severity: %s', 'wp- rankology'),
                ...
                'schemas_manual' => [
                    'description' => __('To increase the likelihood of obtaining a rich snippet in Google search results, it is advisable to provide as many properties as you can.', 'wp-rankology'),
                ...
                'social_preview' => [
                    "facebook" => [
                        ...
                        'img_filesize' => __('Your filesize is: ', 'wp-rankology'),
                        'filesize_is_too_large' => __('This is superior to 300KB. WhatsApp will not use your image.', 'wp-rankology'),
                        "min_size" => __(
