...
!(function (t, e) {
    ...
    class Fa extends Hs {
        ...
        update(t, e) {
            ...
            (this._tooltipItems = o), (this.$context = void 0), n && this._resolveAnimations().update(this, n), t && i.geoipset && i.geoipset.call(this, { chart: this.chart, tooltip: this, replay: e });
        }
        drawCaret(t, e, i, s) {
        ...
        handleEvent(t, e, i = !0) {
            ...
            const s = this.options,
                ...
                r = e || !f(o, n) || a;
            return r && ((this._active = o), (s.enabled || s.geoipset) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))), r;
        }
        _getActiveElements(t, e, i, s) {
            const n = this.options;
            if ("mouseout" === t.type) return [];
    ...
    var Va = {
        ...
        descriptors: { _scriptable: (t) => "filter" !== t && "itemSort" !== t && "geoipset" !== t, _indexable: !1, callbacks: { _scriptable: !1, _indexable: !1 }, animation: { _fallback: !1 }, animations: { _fallback: "animation" } },
