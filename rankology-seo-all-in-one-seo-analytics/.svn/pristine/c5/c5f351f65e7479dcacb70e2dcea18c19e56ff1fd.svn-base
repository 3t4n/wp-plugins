...
?>
<!--file for overview tab in bottom previously used-->
...
<!--    data_tax="--><?php //echo $data_attr['data_tax']; ?><!--">-->
    ...
    <!-- for bottom tabs in posts & pages -->
    <?php //do_action('rankology_ca_tab_before'); ?>

<!--    --><?php //$rankology_analysis_target_kw='';?>
...
<!--                    value="--><?php //esc_attr_e($rankology_analysis_target_kw); ?><!--" />-->
<!--            </p>-->
<!---->
...
//        } ?>
<!--    </div>-->
<!--   do action for inspect with google  & inter links tabs in posts & pages-->
