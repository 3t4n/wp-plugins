...
function rankology_google_analytics_ga4_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_ga4]" placeholder="' . esc_html__('Enter measurement ID (G-XXXXXXXXXX)', 'wp-rankology') . '" aria-label="' . __('Enter your measurement ID', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
...
<p class="description">
    <?php esc_html_e('Your theme must be compatible with <code>wp_body_open</code> hook introduced in WordPress 5.2 if "Inside the body tag" option selected.'); ?>
</p>
...
function rankology_google_analytics_opt_out_msg_ok_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_opt_out_msg_ok]" placeholder="' . esc_html__('Accept', 'wp-rankology') . '" aria-label="' . __('Change the button value', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
);
}
...
function rankology_google_analytics_opt_out_msg_close_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_opt_out_msg_close]" placeholder="' . esc_html__('default: X', 'wp-rankology') . '" aria-label="' . __('Change the close button value', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
);
}
...
function rankology_google_analytics_opt_out_msg_edit_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_opt_out_msg_edit]" placeholder="' . esc_html__('default: Manage cookies', 'wp-rankology') . '" aria-label="' . __('Change the edit button value', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
);
}
...
function rankology_google_analytics_cb_width_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_width]" aria-label="' . __('Change the cookie bar width', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
<p class="description">
...
<?php printf(
'<input type="text" data-default-color="rgba(255,255,255,0.8)" data-alpha="true" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_backdrop_bg]" aria-label="' . __('Change the background color of the backdrop', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" data-alpha="true" data-default-color="#F1F1F1" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_bg]" aria-label="' . __('Change the color of the cookie bar background', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_txt_col]" aria-label="' . __('Change the color of the cookie bar text', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_lk_col]" aria-label="' . __('Change the color of the cookie bar link', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php printf(
'<input type="text" data-alpha="true" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_bg]" aria-label="' . __('Change the color of the cookie bar button background', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" data-alpha="true" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_bg_hov]" aria-label="' . __('Change the color of the cookie bar button hover background', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_col]" aria-label="' . __('Change the color of the cookie bar button', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_col_hov]" aria-label="' . __('Change the color of the cookie bar button hover', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" data-alpha="true" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_sec_bg]" aria-label="' . __('Change the color of the cookie bar secondary button background', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_sec_col]" aria-label="' . __('Change the color of the cookie bar secondary button hover background', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" data-alpha="true" data-default-color="#222222" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_sec_bg_hov]" aria-label="' . __('Change the color of the cookie bar secondary button', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<?php
    printf(
'<input type="text" data-default-color="#FFFFFF" name="rankology_google_analytics_option_name[rankology_google_analytics_cb_btn_sec_col_hov]" aria-label="' . __('Change the color of the cookie bar secondary button hover', 'wp-rankology') . '" value="%s" class="color-picker"/>',
esc_html($check)
);
}
...
<p>
    <label for="rankology_google_analytics_roles_<?php echo $key; ?>">
        <input
            id="rankology_google_analytics_roles_<?php echo $key; ?>"
            name="rankology_google_analytics_option_name[rankology_google_analytics_roles][<?php echo $key; ?>]"
...
function rankology_google_analytics_optimize_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_optimize]" placeholder="' . esc_html__('Enter your Google Optimize container ID', 'wp-rankology') . '" value="%s" aria-label="' . __('GTM-XXXXXXX', 'wp-rankology') . '"/>',
esc_html($check)); ?>
...
<?php
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_ads]" placeholder="' . esc_html__('Enter your Google Ads conversion ID (e.g. AW-123456789)', 'wp-rankology') . '" value="%s" aria-label="' . __('AW-XXXXXXXXX', 'wp-rankology') . '"/>',
esc_html($check)); ?>
...
function rankology_google_analytics_other_tracking_body_callback() {
    ...
    printf(
'<textarea id="rankology_google_analytics_other_tracking_body" name="rankology_google_analytics_option_name[rankology_google_analytics_other_tracking_body]" rows="16" placeholder="' . esc_html__('Paste your tracking code here like Google Tag Manager (body)', 'wp-rankology') . '" aria-label="' . __('Additional tracking code field added to body', 'wp-rankology') . '">%s</textarea>',
$check); ?>
...
function rankology_google_analytics_other_tracking_footer_callback() {
    ...
    printf(
'<textarea id="rankology_google_analytics_other_tracking_footer" name="rankology_google_analytics_option_name[rankology_google_analytics_other_tracking_footer]" rows="16" placeholder="' . esc_html__('Paste your tracking code here (footer)', 'wp-rankology') . '" aria-label="' . __('Additional tracking code field added to footer', 'wp-rankology') . '">%s</textarea>',
$check); ?>
...
function rankology_google_analytics_cross_domain_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_cross_domain]" placeholder="' . esc_html__('Enter your domains: rankology.com,sub.rankology.com,sub2.rankology.com', 'wp-rankology') . '" value="%s" aria-label="' . __('Cross domains', 'wp-rankology') . '"/>',
esc_html($check)
);
}
...
function rankology_google_analytics_download_tracking_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_download_tracking]" placeholder="' . esc_html__('docx|pdf|pptx|zip', 'wp-rankology') . '" aria-label="' . __('Track downloads\' clicks', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
<p class="description">
...
function rankology_google_analytics_affiliate_tracking_callback() {
    ...
    printf(
'<input type="text" name="rankology_google_analytics_option_name[rankology_google_analytics_affiliate_tracking]" placeholder="' . esc_html__('aff|go|out', 'wp-rankology') . '" aria-label="' . __('Track affiliate/outbound links', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
<p class="description">
...
<select id="rankology_google_analytics_cd_author"
    ...
    <option <?php if ('dimension' . $i . '' == $selected) { ?>
        selected="selected"
        <?php } ?>
        value="dimension<?php echo $i; ?>"><?php printf(__('Custom Dimension #%d', 'wp-rankology'), $i); ?>
    </option>
    <?php } ?>
</select>
