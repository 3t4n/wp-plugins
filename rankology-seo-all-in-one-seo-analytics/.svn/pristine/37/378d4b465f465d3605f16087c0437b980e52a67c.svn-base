...
function rkseo_print_section_info_social_knowledge()
{
    ?>
...
function rkseo_print_section_info_social_accounts()
{
    ?>
...
function rkseo_print_section_info_social_facebook()
{
?>
<div class="rkseo-section-header">
    <h2>
...
function rkseo_print_section_info_social_twitter()
{
?>
<div class="rkseo-section-header">
    <h2>
