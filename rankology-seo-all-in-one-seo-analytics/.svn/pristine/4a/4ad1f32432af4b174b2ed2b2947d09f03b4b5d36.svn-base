...
class Social_Preview_Control extends \Elementor\Base_Control {
    public function get_type() {
        return 'rankology-social-preview';
    }

    public function enqueue() {
        wp_enqueue_style(
            'rkseo-el-social-preview-style',
            RANKOLOGY_ELEMENTOR_ADDON_URL . 'assets/css/social-preview.css'
        );

        wp_enqueue_script(
            'rkseo-el-social-preview-script',
            RANKOLOGY_ELEMENTOR_ADDON_URL . 'assets/js/social-preview.js',
            ['rankology-elementor-base-script'],
            11,
            true
        );

        wp_localize_script('rkseo-el-social-preview-script', 'rankologyFiltersElementor', [
            'resize_panel' => apply_filters('rankology_resize_panel_elementor', true),
        ]);
    }
			...
			<div class="elementor-control-field facebook-snippet-box">
				...
				<div class="facebook-snippet-text">
					<div class="snippet-meta">
						...
						<div class="fb-by"><?php esc_html_e('By', 'wp-rankology'); ?>&nbsp;</div>
				...
				<div class="google-snippet-preview mobile-preview">
					<div class="wrap-toggle-preview">
						<p>
							...
							<strong><?php esc_html_e('Mobile Preview', 'wp-rankology'); ?></strong>
					...
					<div class="wrap-snippet">
                        ...
                        <div class="wrap-snippet-mobile">
                            <div class="wrap-meta-desc">
                                <?php echo rankology_display_date_snippet(); ?>
