...
class UserOnline
{
     ...
     * @var string
     */
    public static $check_user_online_opt = 'rankology_stats_check_user_online';
    ...
    public static function active()
    {
         ...
         *
         * @example add_filter('rankology_stats_active_user_online', function(){ if( is_page() ) { return false; } });
         */
        return (has_filter('rankology_stats_active_user_online')) ? apply_filters('rankology_stats_active_user_online', true) : Option::get('useronline');
    }

    /**
     * Reset Active/Online User Process By Option time
     *
     * @return string
     */
    public function reset_user_online()
    {
        ...
        if (self::active()) {
            ...
            //Last check Time
            $rkns_run = get_option(self::$check_user_online_opt);
            if (isset($rkns_run) and is_numeric($rkns_run)) {
                if (($rkns_run + $reset_time) > $now) {
                    return;
                }
            }
    ...
    public static function add_user_online($args = array())
    {
        ...
        $user_online = apply_filters('rankology_stats_user_online_information', wp_parse_args($args, $user_online));
        ...
        do_action('rankology_stats_save_user_online', $user_online_id, $user_online);
    }
    ...
    public static function update_user_online()
    {
        ...
        $user_online = apply_filters('rankology_stats_update_user_online_data', $user_online);
        ...
        do_action('rankology_stats_update_user_online', $user_id, $user_online);
    }
