...
jQuery(document).ready(function ($) {
    ...
    if ($("#rankology-schemas-tabs").length) {
        $("#rankology-schemas-tabs .hidden").removeClass("hidden");
        $("#rankology-schemas-tabs").tabs();
    }
    ...
    $("#js-add-schema-manual").on("click", function (e) {
        ...
        str = str
            .replace("[X]", key)
            .replace(
                "rankology_fno_rich_snippets_data[X]",
                "rankology_fno_rich_snippets_data[" + key + "]"
            )
            .replace("[X]", key);
    ...
    $(document).on("click", ".js-delete-schema-manual", function (e) {
        ...
        if ($(".box-schema-item").length === 0) {
            ...
            str = str
                ...
                .replace(
                    "rankology_fno_rich_snippets_data[X]",
                    "rankology_fno_rich_snippets_data[" + number + "]"
                )
                .replace("[X]", number);
    ...
    $(document).on(
        "change",
        ".js-select_rankology_fno_rich_snippets_type",
        function (e) {
            e.preventDefault();
            ...
            if (alreadyExistItem) {
                ...
                str = str
                    .split(find)
                    .join("rankology_fno_rich_snippets_data[" + number + "]");
    ...
    function bindSnippetArticleCounter(number) {
        const selector =
            ...
            number +
            "'] .rankology_rich_snippets_articles_counters";

        $(selector).after(
            '<div class="rankology_rich_snippets_articles_counters_val">/ 110</div>'
        );
        ...
        if ($(selector).length != 0) {
            $(selector).text(
                $(
                    ".box-schema-item[data-key='" +
                        number +
                        "'] .rankology_fno_rich_snippets_article_title_meta"
                ).val().length
            );
            if (
                $(
    ...
    function bindSnippetCourseDescription(number) {
        const selector =
            ".box-schema-item[data-key='" +
            number +
            "'] .rankology_rich_snippets_courses_counters";

        $(selector).after(
            '<div id="rankology_rich_snippets_courses_counters_val">/ 60</div>'
        );
        ...
        $(".rankology-date-picker").datepicker({
            ...
            beforeShow: function (input, inst) {
                $("#ui-datepicker-div")
                    ...
                    .addClass("rankology-ui-datepicker");
            },
        });
    }
    ...
    $(document).on(
        ...
        function () {
            var e = $(this)
                .closest(".rankology_fno_rich_snippets_jobs_employment_type_p")
                .find(".rankology_fno_rich_snippets_jobs_employment_type");
            if (e.val().length == 0) {
                ...
                var section = template
                    ...
                    .each(function () {
                        ...
                        var newId = this.id.replace(
                            /(\[rankology_fno_rich_snippets_faq\])\[.*?\]/,
                            "$1[" + sectionsCount + "]"
                        );
            ...
            function (e) {
                ...
                var section = template
                    ...
                    .each(function () {
                        ...
                        //set id to store the updated section number
                        var newId = this.id.replace(
                            /(\[rankology_fno_rich_snippets_how_to\])\[.*?\]/,
                            "$1[" + sectionsCount + "]"
                        );
                ...
                const baseIdValue =
                    "rankology_fno_rich_snippets_data_" +
                    number +
                    "_" +
                    sectionsCount;
                ...
                section
                    .find(
                        ".js-media-upload-how-to-repeater .rankology_media_upload"
                    )
                    .attr(
                        "id",
                ...
                section
                    .find(
                        ".js-media-upload-how-to-repeater .rankology_fno_rich_snippets_data_image_height"
                    )
                ...
                section
                    .find(
                        ".js-media-upload-how-to-repeater .rankology_fno_rich_snippets_data_image_width"
                    )
                ...
                section
                    .find(
                        ".js-media-upload-how-to-repeater .rankology_fno_rich_snippets_data_image_meta"
                    )
                    .attr(
                        "id",
    ...
    function check_and_del_buttons() {
        ...
        $(".rankology_fno_rich_snippets_rules_del").show();
        if (1 == $gl) {
            $(".rankology_fno_rich_snippets_rules_del:first").hide();
        }
    }

    $(".wrap-rich-snippets-rules").on(
        "click",
        ".rankology_fno_rich_snippets_rules_and",
        function (e) {
            // Clone a row.
    ...
    $(".wrap-rich-snippets-rules").on(
        "click",
        ".rankology_fno_rich_snippets_rules_del",
        function (e) {
    ...
    $(document).on(
        "click",
        ".wrap-rich-snippets-rules #rankology_fno_rich_snippets_rules_add",
        function (e) {
            // Clone a row.
    ...
    if (
        $(
            "#rankology-your-schema #rankology_fno_rich_snippets_type option:selected"
        ).val() == "none"
    ) {
        $(sc_ad).show();
    } else if (
    ...
    $("#rankology-your-schema #rankology_fno_rich_snippets_type").change(
        function () {
            var rankology_rs_type = $(
                "#rankology-your-schema #rankology_fno_rich_snippets_type"
            ).val();
            if (rankology_rs_type == "none") {
                $(sc_ad).show();
                $(
                    sc_a +
                        "," +
            ...
            if (rankology_rs_type == "localbusiness") {
                $(sc_b).show();
                $(
                    sc_ad +
                        "," +
            ...
            if (rankology_rs_type == "softwareapp") {
                $(sc_app).show();
                $(
                    sc_ad +
                        "," +
