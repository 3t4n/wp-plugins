...
function rankology_rss_before_html_callback() {
    ...
    printf(
    '<textarea id="rankology_rss_before_html" name="rankology_fno_option_name[rankology_rss_before_html]" rows="4" placeholder="' . esc_html__('Enter your HTML content', 'wp-rankology') . '" aria-label="' . __('Display content before each post', 'wp-rankology') . '">%s</textarea>',
    esc_html($check)); ?>
...
function rankology_rss_after_html_callback() {
    ...
    printf(
    '<textarea id="rankology_rss_after_html" name="rankology_fno_option_name[rankology_rss_after_html]" rows="4" aria-label="' . __('Display content after each post', 'wp-rankology') . '" placeholder="' . esc_html__('Enter your HTML content', 'wp-rankology') . '">%s</textarea>',
    esc_html($check)); ?>
...
<label for="rankology_rss_post_thumbnail">
    <input id="rankology_rss_post_thumbnail" name="rankology_fno_option_name[rankology_rss_post_thumbnail]"
...
<label for="rankology_rss_disable_comments_feed">
    <input id="rankology_rss_disable_comments_feed" name="rankology_fno_option_name[rankology_rss_disable_comments_feed]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_rss_disable_posts_feed">
    <input id="rankology_rss_disable_posts_feed" name="rankology_fno_option_name[rankology_rss_disable_posts_feed]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_rss_disable_extra_feed">
    <input id="rankology_rss_disable_extra_feed" name="rankology_fno_option_name[rankology_rss_disable_extra_feed]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_rss_disable_all_feeds">
    <input id="rankology_rss_disable_all_feeds" name="rankology_fno_option_name[rankology_rss_disable_all_feeds]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
