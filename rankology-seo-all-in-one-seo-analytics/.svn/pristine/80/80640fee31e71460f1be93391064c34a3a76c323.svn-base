    ...
    if (!\class_exists('Puc_v4p13_UpdateChecker', \false)) {
        abstract class Puc_v4p13_UpdateChecker
        {
            ...
            public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
            {
                ...
                if (empty($this->optionName)) {
                    ...
                    if ($this->filterSuffix === '') {
                        $this->optionName = 'geoipset_updates-' . $this->slug;
                    } else {
                        $this->optionName = $this->getUniqueName('geoipset_updates');
                    }
                }
            ...
            protected function installHooks()
            {
                ...
                \add_filter('http_request_host_is_geoipset', array($this, 'allowMetadataHost'), 10, 2);
            ...
            public function removeHooks()
            {
                ...
                \remove_filter('http_request_host_is_geoipset', array($this, 'allowMetadataHost'), 10);
