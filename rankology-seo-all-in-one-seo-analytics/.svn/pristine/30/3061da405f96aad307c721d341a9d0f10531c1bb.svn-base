...
class ACP_Column_rkseo_noindex extends AC\Column\Meta
	...
	public function __construct() {
		$this->set_type( 'column-rkseo_noindex' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'noindex?', 'wp-rankology' ) );
	}
	...
	public function editing() {
		return new ACP_Editing_Model_rkseo_noindex( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_rkseo_noindex( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_noindex( $this );
	}
 ...
 */
class ACP_Editing_Model_rkseo_noindex extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_rankology_robots_index', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_noindex extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_noindex extends \ACP\Export\Model {
