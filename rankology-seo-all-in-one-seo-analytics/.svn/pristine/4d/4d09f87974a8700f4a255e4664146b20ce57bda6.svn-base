...
class PrivacyExporter
{
    ...
    public static function visitorsDataExporter($emailAddress, $page = 1)
    {
        ...
        foreach ($visitors as $visitor) {
            ...
            $response['data'][] = array(
                'group_id'          => 'rankology_stats_visitors',
                'group_label'       => __('Statistics Data', 'rankology-stats'),
                'group_description' => sprintf(__('Visitor\'s data for user ID #%s', 'rankology-stats'), $visitor->user_id),
