<div class="postbox-container" id="rkns-big-postbox">
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox" id="<?php echo \RANKOLOGY_STATS\Meta_Box::getMetaBoxKey('top-pages-chart'); ?>">
                <div class="postbox-header postbox-toggle">
                    <h2 class="hndle rkns-d-inline-block"><span><?php echo esc_html($top_trending_title); ?></span></h2>
                    <button class="handlediv" type="button" aria-expanded="true">
                        <span class="screen-reader-text"><?php printf(__('Toggle panel: %s', 'rankology-stats'), __('Top 5 Trending Pages', 'rankology-stats')); ?></span>
...
<div class="postbox-container rkns-postbox-full">
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox" id="<?php echo \RANKOLOGY_STATS\Meta_Box::getMetaBoxKey('pages'); ?>">
                <div class="postbox-header postbox-toggle">
                    <h2 class="hndle rkns-d-inline-block"><span><?php echo esc_attr($title); ?></span></h2>
                    <button class="handlediv" type="button" aria-expanded="true">
                        <span class="screen-reader-text"><?php printf(__('Toggle panel: %s', 'rankology-stats'), esc_attr($title)); ?></span>
                        <span class="toggle-indicator" aria-hidden="true"></span>
                    </button>
                </div>
                <div class="inside">
                    ...
                    if (empty($lists)) {
                        ...
                        esc_html_e('No data to display', 'rankology-stats');
                        echo '</div>';
                    } else {
                        ?>
                        <div class="o-table-wrapper">
                            <table width="100%" class="o-table">
                                <tbody>
                                <tr>
                                    <td width='10%'><?php esc_html_e('ID', 'rankology-stats'); ?></td>
                                    <td width='40%'><?php esc_html_e('Title', 'rankology-stats'); ?></td>
                                    <td width='10%'><?php esc_html_e('Visits', 'rankology-stats'); ?></td>
                                </tr>
                                ...
                                foreach ($lists as $li) {
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: left;'>
                                            <a href="<?php echo esc_url(site_url($li['str_url'])); ?>" title="<?php echo esc_attr($li['title']); ?>" target="_blank"><?php echo esc_attr($li['title']); ?> <i class="dashicons dashicons-geoipset" style="font-size: 15px; vertical-align: middle"></i></a>
                                        </td>
                                        <td style="text-align: left">
