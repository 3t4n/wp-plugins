...
$meta_value_ct = get_term_meta($term_id, $meta_key_ct, true);
...
<div id="tabs-1">
    ...
    <div class="box-leftsnip">
        <div class="google-snippet-preview mobile-preview">
            ...
            if (get_the_title()) {
                $gp_title = '<div class="snippet-title-default-ct" style="display:none">' . get_the_title() . ' - ' . get_bloginfo('name') . '</div>';
            ...
            <div class="wrap-snippet">
                ...
                <div class="snippet-title-ct"></div>
                <div class="snippet-title-custom-ct" style="display:none"></div>
                ...
                <div class="wrap-snippet-mobile">
                    <div class="wrap-meta-desc">
                        ...
                        <div class="snippet-description-ct"></div>
                        <div class="snippet-description-custom-ct" style="display:none"></div>
                        <div class="snippet-description-default-ct" style="display:none"></div>
                    </div>
                    <div class="wrap-post-thumb"><?php the_post_thumbnail('full', ['class' => 'snippet-post-thumb']); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="box-right">
        ...
        <div class="rkseo-metadesc-con">
            <div class="label-scoreperc-con">
                <label for="rankology_titles_title_meta_cb">
                    <?php
            ...
            <input id="rankology_titles_title_meta_ct" type="text" name="rankology_titles_title_ct"
                class="components-text-control__input"
                placeholder="<?php esc_html_e('Enter your title', 'wp-rankology'); ?>"
                aria-label="<?php esc_html_e('Title', 'wp-rankology'); ?>" value="<?php if (isset($meta_value)) {
                       echo $meta_value;
                   } ?>" />
        </div>
        ...
        <div class="wrap-tags">
            <?php if ('term.php' == $pagenow || 'edit-tags.php' == $pagenow) { ?>
                <button type="button" class="<?php echo rankology_btn_secondary_classes(); ?> tag-title"
        ...
        <div class="rkseo-metadesc-con">
            ...
            <textarea id="rankology_titles_desc_meta_ct" rows="4" name="rankology_titles_desc_ct"
                class="components-text-control__input"
                placeholder="<?php esc_html_e('Enter your meta description', 'wp-rankology'); ?>"
                aria-label="<?php esc_html_e('Meta description', 'wp-rankology'); ?>"><?php echo esc_attr($meta_value_ct); ?></textarea>
        </div>
        ...
        <div class="wrap-tags">
            <?php if ('term.php' == $pagenow || 'edit-tags.php' == $pagenow) { ?>
                <button type="button" class="<?php echo rankology_btn_secondary_classes(); ?> tag-title"
                    id="rankology-tag-single-excerpt" data-tag="%%_category_description%%">
                    <span
                        class="dashicons dashicons-tag"></span><?php esc_html_e('Category / term description', 'wp-rankology'); ?>
                </button>
            <?php } else { ?>
                <button type="button" class="<?php echo rankology_btn_secondary_classes(); ?> tag-title"
