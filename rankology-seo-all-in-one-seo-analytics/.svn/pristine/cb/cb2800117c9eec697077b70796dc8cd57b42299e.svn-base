...
class CheckUserOnline extends \RANKOLOGY_STATS\RestAPI
{
    /**
     * REST API Address for Checking Active Users
     *
     * @var string
     */
    ...
    public function __construct()
    {
        ...
        # Create REST API to Check Active/Online User
        add_action('rest_api_init', array($this, 'register_online_user_rest_api'));
    }

    // Create REST API to Check Active Users
    ...
    {
        \RANKOLOGY_STATS\UserOnline::record();
