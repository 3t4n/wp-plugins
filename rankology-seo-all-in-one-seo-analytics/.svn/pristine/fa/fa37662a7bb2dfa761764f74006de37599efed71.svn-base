function rankology_sortable_lb_business() {
    var container = jQuery(".rankology-sortable-lb-widget");
    container.sortable({
        placeholder: "widget-placeholder",
        connectWith: ".rankology-sortable-lb-widget p",
        items: "[data-id]",
...
jQuery(document).ready(function () {
    rankology_sortable_lb_business();
