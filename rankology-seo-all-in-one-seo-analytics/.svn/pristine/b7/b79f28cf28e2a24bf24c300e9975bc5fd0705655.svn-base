...
class SearchEngine
{
    ...
    {
        return RANKOLOGY_STATS_URL . 'assets/images/search-engine/';
    }

    /**
     * Get List Of Search engine in Rankology Stats
     *
     * @param bool $all
     * @return array
     */
    public static function getList($all = false)
    {
        ...
        $default = $engines = array(
            'ask'        => array(
                'name'         => 'Ask.com',
                'translated'   => __('Ask.com', 'rankology-stats'),
                'tag'          => 'ask',
                'sqlpattern'   => '%ask.com%',
            ...
            'baidu'      => array(
                'name'         => 'Baidu',
                'translated'   => __('Baidu', 'rankology-stats'),
                'tag'          => 'baidu',
            ...
            'bing'       => array(
                'name'         => 'Bing',
                'translated'   => __('Bing', 'rankology-stats'),
                'tag'          => 'bing',
                'sqlpattern'   => '%bing.com%',
            ...
            'clearch'    => array(
                'name'         => 'clearch.org',
                'translated'   => __('clearch.org', 'rankology-stats'),
                'tag'          => 'clearch',
            ...
            'duckduckgo' => array(
                'name'         => 'DuckDuckGo',
                'translated'   => __('DuckDuckGo', 'rankology-stats'),
                'tag'          => 'duckduckgo',
            ...
            'google'     => array(
                'name'         => 'Google',
                'translated'   => __('Google', 'rankology-stats'),
                'tag'          => 'google',
                'sqlpattern'   => '%google.%',
                'regexpattern' => 'google\.',
                'querykey'     => 'q',
            ...
            'yahoo'      => array(
                'name'         => 'Yahoo!',
                'translated'   => __('Yahoo!', 'rankology-stats'),
                'tag'          => 'yahoo',
            ...
            'yandex'     => array(
                'name'         => 'Yandex',
                'translated'   => __('Yandex', 'rankology-stats'),
                'tag'          => 'yandex',
            ...
            'qwant'      => array(
                'name'         => 'Qwant',
                'translated'   => __('Qwant', 'rankology-stats'),
                'tag'          => 'qwant',
    ...
    {
        return array(
            'name'         => _x('Unknown', 'Search Engine', 'rankology-stats'),
            'tag'          => '',
            'sqlpattern'   => '',
            'regexpattern' => '',
            'querykey'     => 'q',
            ...
            if (wp_http_validate_url($referred)) {
                ...
                foreach ($search_engines as $key => $value) {
                    ...
                    if (isset($matches[1])) {
                        ...
                        $search_word = apply_filters('rankology_stats_search_engine_word', $search_word);
    ...
    public static function save_word($data = array())
    {
        ...
        do_action('rankology_stats_save_search_word', $data, $wpdb->insert_id);
    }
    ...
    public static function getLastSearchWord($arg = array())
    {
        ...
        // Prepare Query
        $search_query = rankology_stats_searchword_query($args['search_engine']);
