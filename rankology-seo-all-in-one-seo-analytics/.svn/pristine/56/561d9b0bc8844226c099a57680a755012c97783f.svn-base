...
class Video extends JsonSchemaValue implements GetJsonData {
    ...
    protected function getVariablesForManualSnippet($schemaManual) {
        $keys = [
            ...
            'thumbnailUrl' => '_rankology_fno_rich_snippets_videos_img',
            'imgWidth' => '_rankology_fno_rich_snippets_videos_img_width',
            'imgHeight' => '_rankology_fno_rich_snippets_videos_img_height',
            'duration' => '_rankology_fno_rich_snippets_videos_duration',
            'url' => '_rankology_fno_rich_snippets_videos_url',
            'published_date' => '_rankology_fno_rich_snippets_videos_date_posted',
        ];
        $variables = [];
    ...
    public function getJsonData($context = null) {
        ...
        if(isset($variables['published_date']) && !empty($variables['published_date'])){
            $variables['uploadDate'] = $variables['published_date'];
        }
        ...
        return apply_filters('rankology_fno_get_json_data_video', $data, $context);
    }
