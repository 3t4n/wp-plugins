...
class Notifications {
    public function generateAllNotifications() {
        ...
        $args[] = [
            'id'     => 'notice-review',
            'title'  => __('You like Rankology? Please help us by rating us 5 stars!', 'wp-rankology'),
            'desc'   => __('Support the development and improvement of the plugin by taking 15 seconds of your time to leave us a user review on the official WordPress plugins repository. Thank you!', 'wp-rankology'),
            'impact' => [
                'info' => __('Information', 'wp-rankology'),
            ],
            'link' => [
                'en'       => 'https://wordpress.org/support/view/plugin-reviews/wp-rankology?rate=5#postform',
                'title'    => __('Rate us!', 'wp-rankology'),
                'external' => true,
            ],
            'deleteable' => true,
            ...
            if (!empty($bricks_options)) {
                ...
                if (empty($bricks_options['disableSeo'])) {
                    ...
                    $args[] = [
                        ...
                        'title'  => __('Bricks theme is not correctly setup for SEO!', 'wp-rankology'),
                        'desc'   => __('You must disable "Bricks SEO meta tags" option from Bricks settings (Bricks, Settings page) to avoid any SEO issues.', 'wp-rankology'),
                        'impact' => [
                ...
                if (empty($bricks_options['disableOpenGraph'])) {
                    ...
                    $args[] = [
                        'id'     => 'notice-bricks-og',
                        'title'  => __('Bricks theme is not correctly setup for social sharing!', 'wp-rankology'),
                        'desc'   => __('You must disable "Bricks Open Graph meta tags" option from Bricks settings (Bricks, Settings page) to avoid any social sharing issues.', 'wp-rankology'),
                        'impact' => [
                            'high' => __('High impact', 'wp-rankology'),
                        ],
                        'link' => [
        ...
        $args[] = [
            'id'     => 'notice-usm',
            'title'  => __('Enable our universal SEO metabox for the Block Editor', 'wp-rankology'),
            'desc'   => __('By default, our new SEO metabox is disabled for Gutenberg. Test it without further delay!', 'wp-rankology'),
            'impact' => [
                'info' => __('Wizard', 'wp-rankology'),
            ],
            'link' => [
                'en'       => admin_url('admin.php?page=rankology-advanced#tab=tab_rankology_advanced_appearance'),
                'title'    => __('Activate it', 'wp-rankology'),
                'external' => false,
            ],
            'deleteable' => true,
            'status' => $status ? $status : false,
        ...
        $args[] = [
            'id'     => 'notice-wizard',
            'title'  => __('Configure Rankology in a few minutes with our installation wizard', 'wp-rankology'),
            'desc'   => __('The best way to quickly setup Rankology on your site.', 'wp-rankology'),
            'impact' => [
                'info' => __('Wizard', 'wp-rankology'),
            ],
            'link' => [
                'en'       => admin_url('admin.php?page=rankology-setup'),
                'title'    => __('Start the wizard', 'wp-rankology'),
                'external' => true,
            ],
            'deleteable' => true,
            'status' => $status ? $status : false,
        ...
        if (is_plugin_active('amp/amp.php')) {
            ...
            $args[] = [
                ...
                'title'  => __('Use Google Analytics with AMP plugin', 'wp-rankology'),
                'desc'   => __('Your site is using the AMP official plugin. To track users with Google Analytics on AMP pages, please go to this settings page.', 'wp-rankology'),
                'impact' => [
                    'info' => __('Medium impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if ('Divi' == $theme->template || 'Divi' == $theme->parent_theme) {
            ...
            if (! empty($divi_options)) {
                if (
                    ...
                    $args[] = [
                        'id'     => 'notice-divi-seo',
                        'title'  => __('We noticed that some SEO DIVI options are enabled!', 'wp-rankology'),
                        'desc'   => __('To avoid any SEO conflicts, please disable every SEO option from <strong>DIVI theme options page, SEO tab</strong>.', 'wp-rankology'),
                        'impact' => [
                            'high' => __('High impact', 'wp-rankology'),
                        ],
                        'link' => [
        ...
        if ('1' != get_theme_support('title-tag') && true !== wp_is_block_theme()) {
            if ('1' !== rankology_get_service('NoticeOption')->getNoticeTitleTag()) {
                ...
                $args[] = [
                    'id'     => 'notice-title-tag',
                    'title'  => __('Your theme doesn\'t use <strong>add_theme_support(\'title-tag\');</strong>', 'wp-rankology'),
                    'desc'   => __('This error indicates that your theme uses a deprecated function to generate the title tag of your pages. Rankology will not be able to generate your custom title tags if this error is not fixed.', 'wp-rankology'),
                    'impact' => [
                        'high' => __('High impact', 'wp-rankology'),
                    ],
                    'link' => [
                        'fr'       => '',
                        'en'       => '',
                        'title'    => __('Learn more', 'wp-rankology'),
                        'external' => true,
                    ],
                    'deleteable' => false,
                    'status' => true,
        ...
        if (is_plugin_active('swift-performance-lite/performance.php')) {
            if (rankology_get_service('NoticeOption')->getNoticeCacheSitemap() === "1") {
                if ('1' !== rankology_get_service('NoticeOption')->getNoticeSwift()) {
                    ...
                    $args[] = [
                        'id'     => 'notice-swift',
                        'title'  => __('Your XML sitemap is cached!', 'wp-rankology'),
                        'desc'   => __('Swift Performance is caching your XML sitemap. You must disable this option to prevent any compatibility issue (Swift Performance > Settings > Caching, General tab).', 'wp-rankology'),
                        'impact' => [
                            'high' => __('High impact', 'wp-rankology'),
                        ],
                        'link' => [
        ...
        foreach ($seo_plugins as $key => $value) {
            if (is_plugin_active($key)) {
                ...
                $args[] = [
                    ...
                    'title'  => sprintf(__('We noticed that you use <strong>%s</strong> plugin.', 'wp-rankology'), $value),
                    'desc'   => __('Do you want to migrate all your metadata to Rankology? Do not use multiple SEO plugins at once to avoid conflicts!', 'wp-rankology'),
                    'impact' => [
                        'high' => __('High impact', 'wp-rankology'),
                    ],
                    'link' => [
                        'en'       => admin_url('admin.php?page=rankology-import-export'),
                        'title'    => __('Migrate!', 'wp-rankology'),
                        'external' => false,
                    ],
                    'deleteable' => false,
                    'status' => true,
        ...
        foreach ($indexing_plugins as $key => $value) {
            if (is_plugin_active($key)) {
                ...
                $args[] = [
                    ...
                    'title'  => sprintf(__('We noticed that you use <strong>%s</strong> plugin.', 'wp-rankology'), $value),
                    'desc'   => __('To prevent any conflicts with our Indexing feature, please disable it.', 'wp-rankology'),
                    'impact' => [
                        'high' => __('High impact', 'wp-rankology'),
                    ],
                    'link' => [
        ...
        if ('enfold' == $theme->template || 'enfold' == $theme->parent_theme) {
            if ('plugin' != $avia_options_enfold['avia']['seo_robots'] || 'plugin' != $avia_options_enfold_child['avia']['seo_robots']) {
                ...
                $args[] = [
                    'id'     => 'notice-enfold',
                    'title'  => __('Enfold theme is not correctly setup for SEO!', 'wp-rankology'),
                    'desc'   => __('You must disable "Meta tag robots" option from Enfold settings (SEO Support tab) to avoid any SEO issues.', 'wp-rankology'),
                    'impact' => [
                        'low' => __('High impact', 'wp-rankology'),
                    ],
                    'link' => [
        ...
        if (rankology_get_empty_templates('cpt', 'title')) {
            ...
            $args[] = [
                ...
                'title'  => __('Global meta title missing for several custom post types!', 'wp-rankology'),
        ...
        if (rankology_get_empty_templates('cpt', 'description')) {
            ...
            $args[] = [
                ...
                'title'  => __('Global meta description missing for several custom post types!', 'wp-rankology'),
        ...
        if (rankology_get_empty_templates('tax', 'title')) {
            ...
            $args[] = [
                ...
                'title'  => __('Global meta title missing for several taxonomies!', 'wp-rankology'),
        ...
        if (rankology_get_empty_templates('tax', 'description')) {
            ...
            $args[] = [
                ...
                'title'  => __('Global meta description missing for several taxonomies!', 'wp-rankology'),
        ...
        if (! is_ssl()) {
            ...
            $args[] = [
                'id'     => 'notice-ssl',
                'title'  => __('Your site doesn\'t use an SSL certificate!', 'wp-rankology'),
                'desc'   => __('Https is considered by Google as a positive signal for the ranking of your site. It also reassures your visitors for data security, and improves trust.', 'wp-rankology') . '</a>',
                'impact' => [
                    'low' => __('Medium impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if (function_exists('extension_loaded') && ! extension_loaded('dom')) {
            ...
            $args[] = [
                'id'     => 'notice-dom',
                'title'  => __('PHP module "DOM" is missing on your server.', 'wp-rankology'),
                'desc'   => __('This PHP module, installed by default with PHP, is required by many plugins including Rankology. Please contact your host as soon as possible to solve this.', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if (function_exists('extension_loaded') && ! extension_loaded('mbstring')) {
            ...
            $args[] = [
                'id'     => 'notice-mbstring',
                'title'  => __('PHP module "mbstring" is missing on your server.', 'wp-rankology'),
                'desc'   => __('This PHP module, installed by default with PHP, is required by many plugins including Rankology. Please contact your host as soon as possible to solve this.', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
        ...
        if ('1' !== rankology_get_service('NoticeOption')->getNoticeNoIndex()) {
            if ('1' === rankology_get_service('TitleOption')->getTitleNoIndex() || '1' != get_option('blog_public')) {
                ...
                $args[] = [
                    'id'     => 'notice-noindex',
                    'title'  => __('Your site is not visible to Search Engines!', 'wp-rankology'),
                    'desc'   => __('You have activated the blocking of the indexing of your site. If your site is under development, this is probably normal. Otherwise, check your settings. Delete this notification using the cross on the right if you are not concerned.', 'wp-rankology'),
                    'impact' => [
                        'high' => __('High impact', 'wp-rankology'),
                    ],
                    'link' => [
        ...
        if ('' == get_option('blogname')) {
            ...
            $args[] = [
                ...
                'title'  => __('Your site title is empty!', 'wp-rankology'),
                'desc'   => __('Your Site Title is used by WordPress, your theme and your plugins including Rankology. It is an essential component in the generation of title tags, but not only. Enter one!', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if ('' == get_option('permalink_structure')) {
            ...
            $args[] = [
                ...
                'title'  => __('Your permalinks are not SEO Friendly! Enable pretty permalinks to fix this.', 'wp-rankology'),
                'desc'   => __('Why is this important? Showing only the summary of each article significantly reduces the theft of your content by third party sites. Not to mention, the increase in your traffic, your advertising revenue, conversions...', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if ('0' == get_option('rss_use_excerpt')) {
            ...
            $args[] = [
                ...
                'title'  => __('Your RSS feed shows full text!', 'wp-rankology'),
                'desc'   => __('Why is this important? Showing only the summary of each article significantly reduces the theft of your content by third party sites. Not to mention, the increase in your traffic, your advertising revenue, conversions...', 'wp-rankology'),
                'impact' => [
        ...
        if ('' === rankology_get_service('GoogleAnalyticsOption')->getGA4() && '1' === rankology_get_service('GoogleAnalyticsOption')->getEnableOption()) {
            ...
            $args[] = [
                'id'     => 'notice-ga-ids',
                'title'  => __('You have activated Google Analytics tracking without adding identifiers!', 'wp-rankology'),
                'desc'   => __('Google Analytics will not track your visitors until you finish the configuration.', 'wp-rankology'),
                'impact' => [
                    'medium' => __('Medium impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if ('1' == get_option('page_comments')) {
            ...
            $args[] = [
                ...
                'title'  => __('Break comments into pages is ON!', 'wp-rankology'),
                'desc'   => __('Enabling this option will create duplicate content for each article beyond x comments. This can have a disastrous effect by creating a large number of poor quality pages, and slowing the Google bot unnecessarily, so your ranking in search results.', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
                'link' => [
                    'en'       => admin_url('options-discussion.php'),
                    'title'    => __('Disable this!', 'wp-rankology'),
                    'external' => false,
                ],
                'deleteable' => true,
                'status' => $status ? $status : false,
        ...
        if (get_option('posts_per_page') < '16') {
            ...
            $args[] = [
                ...
                'title'  => __('Display more posts per page on homepage and archives', 'wp-rankology'),
                'desc'   => __('To reduce the number pages search engines have to crawl to find all your articles, it is recommended displaying more posts per page. This should not be a problem for your users. Using mobile, we prefer to scroll down rather than clicking on next page links.', 'wp-rankology'),
                'impact' => [
                    'medium' => __('Medium impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        if ('1' !== rankology_get_service('SitemapOption')->isEnabled()) {
            ...
            $args[] = [
                ...
                'title'  => __('You don\'t have an XML Sitemap!', 'wp-rankology'),
                'desc'   => __('XML Sitemaps are useful to facilitate the crawling of your content by search engine robots. Indirectly, this can benefit your ranking by reducing the crawl bugdet.', 'wp-rankology'),
                'impact' => [
                    'medium' => __('Medium impact', 'wp-rankology'),
                ],
                'link' => [
        ...
        $args[] = [
            ...
            'title'  => __('Do you have a Google My Business page? It\'s free!', 'wp-rankology'),
            'desc'   => __('Local Business websites should have a My Business page to improve visibility in search results. Click on the cross on the right to delete this notification if you are not concerned.', 'wp-rankology'),
            'impact' => [
                'high' => __('High impact', 'wp-rankology'),
            ],
            'link' => [
                'en'       => 'https://www.google.com/business/go/',
                'title'    => __('Create your page now!', 'wp-rankology'),
                'external' => true,
            ],
            'deleteable' => true,
            'status' => $status ? $status : false,
        ...
        if (null === rankology_get_service('AdvancedOption')->getAdvancedGoogleVerification() || '' === rankology_get_service('AdvancedOption')->getAdvancedGoogleVerification()) {
            $args[] = [
                ...
                'title'  => __('Add your site to Google. It\'s free!', 'wp-rankology'),
                'desc'   => __('Is your brand new site online? So reference it as quickly as possible on Google to get your first visitors via Google Search Console. Already the case? Dismiss this alert.', 'wp-rankology'),
                'impact' => [
                    'high' => __('High impact', 'wp-rankology'),
                ],
                'link' => [
                    'en'       => 'https://www.google.com/webmasters/tools/home',
                    'title'    => __('Add your site to Search Console!', 'wp-rankology'),
                    'external' => true,
                ],
                'deleteable' => true,
                'status' => $status ? $status : false,
    ...
    public function renderNotification($args) {
        ...
        if ( ! empty($impact)) {
            $html .= '<span class="rankology-impact rankology-impact-' . array_key_first($impact) . '"></span>';
        ...
        if ( ! empty($link) || true === $deleteable) {
            ...
            if (true === $deleteable && $status === true) {
                $html .= '<button id="' . $id . '" name="notice-title-tag" type="button" class="btn btnLink" data-notice="' . $id . '">' . __('Dismiss', 'wp-rankology') . '</button>';
            }
