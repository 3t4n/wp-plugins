...
class Hits
{
     ...
     * @var string
     */
    public static $rest_hits_key = 'rankology_stats_hit_rest';
    ...
    public function __construct()
    {
        ...
        if (self::is_rest_hit()) {
            ...
            # Filter Data
            add_filter('rankology_stats_current_page', array($this, 'set_current_page'));
            add_filter('rankology_stats_page_uri', array($this, 'set_page_uri'));
            add_filter('rankology_stats_track_all_pages', array($this, 'set_track_all'));
        }
