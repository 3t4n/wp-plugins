...
class ACP_Column_rkseo_gsc_ctr extends AC\Column\Meta
	implements \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-rkseo_gsc_ctr' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'CTR', 'wp-rankology' ) );
	}

	public function get_meta_key() {
		return '_rankology_search_console_analysis_ctr';
	}
	...
	public function sorting() {
		return new ACP_Sorting_Model_rkseo_gsc_ctr( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_gsc_ctr( $this );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_gsc_ctr extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_gsc_ctr extends \ACP\Export\Model {
