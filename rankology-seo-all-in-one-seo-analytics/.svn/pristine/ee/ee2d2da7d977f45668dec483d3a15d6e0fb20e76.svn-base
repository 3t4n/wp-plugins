...
function rkseo_print_section_info_xml_sitemap_general()
{
?>
...
<p>
    <pre><span class="dashicons dashicons-redo"></span><a href="<?php echo get_option('home'); ?>/sitemaps.xml" target="_blank"><?php echo get_option('home'); ?>/sitemaps.xml</a></pre>
</p>
...
function rkseo_print_section_info_html_sitemap()
{
?>
...
function rkseo_print_section_info_xml_sitemap_post_types()
{
    ?>
<div class="rkseo-section-header">
    <h2>
...
function rkseo_print_section_info_xml_sitemap_taxonomies()
{
    ?>
<div class="rkseo-section-header">
    <h2>
