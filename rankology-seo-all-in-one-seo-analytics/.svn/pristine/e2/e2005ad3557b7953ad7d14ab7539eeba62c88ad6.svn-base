...
class ACP_Column_rkseo_title extends AC\Column\Meta
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-rkseo_title' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'Meta title', 'wp-rankology' ) );
	}

	public function get_meta_key() {
		return '_rankology_titles_title';
	}

	public function editing() {
		return new ACP_Editing_Model_rkseo_title( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_rkseo_title( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_title( $this );
	}
 ...
 */
class ACP_Editing_Model_rkseo_title extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_rankology_titles_title', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_title extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_title extends \ACP\Export\Model {
