...
class ACP_Column_rkseo_redirect extends AC\Column\Meta
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-rkseo_redirect' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'Redirect?', 'wp-rankology' ) );
	}

	public function get_meta_key() {
		return '_rankology_redirections_enabled';
	}
	...
	public function editing() {
		return new ACP_Editing_Model_rkseo_redirect( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_rkseo_redirect( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_redirect( $this );
	}
 ...
 */
class ACP_Editing_Model_rkseo_redirect extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_rankology_redirections_enabled', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_redirect extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_redirect extends \ACP\Export\Model {
