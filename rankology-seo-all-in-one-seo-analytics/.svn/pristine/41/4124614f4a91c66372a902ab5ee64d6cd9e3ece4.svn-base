...
function rkseo_print_section_info_google_analytics_enable()
{
    ?>
...
function rkseo_print_section_info_google_analytics_gdpr()
{
    ?>
<div class="rkseo-section-header">
    <h2>
...
function rkseo_print_section_info_google_analytics_features()
{ ?>
...
function rkseo_print_section_info_google_analytics_custom_tracking()
{
    ?>
<div class="rkseo-section-header">
    <h2>
...
function rkseo_print_section_info_google_analytics_events()
{
?>
<hr>
...
function rkseo_print_section_info_google_analytics_advanced()
{
?>
<br>
<hr>
