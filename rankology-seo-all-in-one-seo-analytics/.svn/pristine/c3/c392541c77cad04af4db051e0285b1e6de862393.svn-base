...
use RANKOLOGY_STATS\Exclusion;
use RANKOLOGY_STATS\Hits;

class Hit extends \RANKOLOGY_STATS\RestAPI
{
    /**
     * Hit Endpoint
     *
    ...
    {
        $GLOBALS['rankology_stats_user_id'] = get_current_user_id();

        // Record Rankology Stats when Cache is enable
    ...
    public function hit_callback(\WP_REST_Request $request)
    {
        ...
        $response = new \WP_REST_Response(array(
            ...
            'message' => __('Visitor Hit recorded successfully.', 'rankology-stats'),
        ), 200);
