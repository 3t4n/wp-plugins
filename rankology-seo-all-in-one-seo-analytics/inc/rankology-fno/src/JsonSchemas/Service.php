...
class Service extends JsonSchemaValue implements GetJsonData {
    ...
    protected function getVariablesForManualSnippet($schemaManual) {
        $keys = [
            ...
            'name'                         => [
                'value'   => '_rankology_fno_rich_snippets_service_name',
                'default' => '%%post_title%%',
            ],
            'id' => [
                'default' => '%%schema_article_canonical%%',
            ],
            'serviceType'                  => '_rankology_fno_rich_snippets_service_type',
            'description'                  => [
                'value'   => '_rankology_fno_rich_snippets_service_description',
                'default' => '%%post_excerpt%%',
            ],
            'image'                        => [
                'value'   => '_rankology_fno_rich_snippets_service_img',
                'default' => '%%post_thumbnail_url%%',
            ],
            'areaServed'                   => '_rankology_fno_rich_snippets_service_area',
            'providerName'                 => '_rankology_fno_rich_snippets_service_provider_name',
            'localBusinessImage'           => '_rankology_fno_rich_snippets_service_lb_img',
            'providerMobility'             => '_rankology_fno_rich_snippets_service_provider_mobility',
            'slogan'                       => '_rankology_fno_rich_snippets_service_slogan',
            'streetAddress'                => '_rankology_fno_rich_snippets_service_street_addr',
            'addressLocality'              => '_rankology_fno_rich_snippets_service_city',
            'addressRegion'                => '_rankology_fno_rich_snippets_service_state',
            'postalCode'                   => '_rankology_fno_rich_snippets_service_pc',
            'addressCountry'               => '_rankology_fno_rich_snippets_service_country',
            'latitude'                     => '_rankology_fno_rich_snippets_service_lat',
            'longitude'                    => '_rankology_fno_rich_snippets_service_lon',
            'telephone'                    => '_rankology_fno_rich_snippets_service_tel',
            'priceRange'                   => '_rankology_fno_rich_snippets_service_price',
        ];
    ...
    public function getJsonData($context = null) {
        ...
        if (isset($variables['image']) && ! empty($variables['image'])) {
            ...
            $schema                            = rankology_get_service('JsonSchemaGenerator')->getJsonFromSchema(LocalBusiness::NAME, $contextWithVariables, ['remove_empty'=> true]);
            if (count($schema) > 1) {
        ...
        return apply_filters('rankology_fno_get_json_data_service', $data, $context);
    }
