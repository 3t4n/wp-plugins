...
class Review extends JsonSchemaValue implements GetJsonData {
    ...
    protected function getKeysForSchemaManual() {
        return [
            ...
            'itemType'     => '_rankology_fno_rich_snippets_review_item_type',
            'image'        => '_rankology_fno_rich_snippets_review_img',
            'ratingValue'  => '_rankology_fno_rich_snippets_review_rating',
            'bestRating'   => '_rankology_fno_rich_snippets_review_max_rating',
            'reviewBody'   => '_rankology_fno_rich_snippets_review_body',
            'positiveNotes' => '_rankology_fno_rich_snippets_review_positive_notes',
            'negativeNotes' => '_rankology_fno_rich_snippets_review_negative_notes',
        ];
    }
    ...
    public function getJsonData($context = null) {
        ...
        if (isset($variables['ratingValue'])) {
            ...
            $schema                            = rankology_get_service('JsonSchemaGenerator')->getJsonFromSchema(Rating::NAME, $contextWithVariables, ['remove_empty'=> true]);
            if (count($schema) > 1) {
        ...
        return apply_filters('rankology_fno_get_json_data_review', $data, $context);
    }
}
