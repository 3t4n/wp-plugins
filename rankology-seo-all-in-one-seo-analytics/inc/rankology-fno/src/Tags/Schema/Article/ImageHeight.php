...
class ImageHeight implements GetTagValue {
    ...
    public function getValue($args = null) {
        ...
        $value      = '';
        $nameFilter = 'rankology_fno_get_tag_schema_article_image_height';
        ...
        if (array_key_exists('_rankology_fno_rich_snippets_article_img_height', $schema)) {
            $value = $schema['_rankology_fno_rich_snippets_article_img_height'];
        }
