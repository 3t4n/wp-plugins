...
namespace RankologyFno\Services\Repository;
...
class SignificantKeywordsRepository {
    public $tableSignificantWords;

    public function __construct(){
        $this->tableSignificantWords = rankology_fno_get_service('TableList')->getTableSignificantKeywords();
    }
    ...
    public function getAllWordsCorrespondent($word, $postId){
        ...
        $sql .= "AND p.post_status IN ('publish', 'draft', 'future') ";
