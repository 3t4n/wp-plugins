...
namespace RankologyFno\Core;

defined('ABSPATH') or exit('Cheatin&#8217; uh?');

use Rankology\Core\Container\ContainerRankology;
use Rankology\Core\Hooks\ActivationHook;
use Rankology\Core\Hooks\DeactivationHook;
    ...
    public static function buildClasses($path, $type, $namespace = '') {
        try {
            ...
            foreach ($files as $filename) {
                ...
                $data = '\\RankologyFno\\' . $namespace . str_replace('.php', '', $filename);
