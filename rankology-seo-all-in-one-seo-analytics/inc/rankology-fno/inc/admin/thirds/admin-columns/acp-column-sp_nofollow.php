...
class ACP_Column_rkseo_nofollow extends AC\Column\Meta
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-rkseo_nofollow' );
		$this->set_group( 'rankology' );
		$this->set_label( __( 'nofollow?', 'wp-rankology' ) );
	}
	...
	public function editing() {
		return new ACP_Editing_Model_rkseo_nofollow( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_rkseo_nofollow( $this );
	}

	public function export() {
		return new ACP_Export_Model_rkseo_nofollow( $this );
	}
 ...
 */
class ACP_Editing_Model_rkseo_nofollow extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_rankology_robots_follow', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_rkseo_nofollow extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_rkseo_nofollow extends \ACP\Export\Model {
