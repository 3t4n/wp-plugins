...
<label for="rankology_gsc_domain_property">
    <input id="rankology_gsc_domain_property" name="rankology_fno_option_name[rankology_gsc_domain_property]" type="checkbox"
        <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<select id="rankology_gsc_date_range" name="rankology_fno_option_name[rankology_gsc_date_range]">
    <?php
        $dates = [
