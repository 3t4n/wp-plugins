...
<label for="rankology_breadcrumbs_enable">
    <input id="rankology_breadcrumbs_enable" name="rankology_fno_option_name[rankology_breadcrumbs_enable]" type="checkbox"
        <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_breadcrumbs_json_enable">
    <input id="rankology_breadcrumbs_json_enable" name="rankology_fno_option_name[rankology_breadcrumbs_json_enable]"
...
function rankology_breadcrumbs_separator_callback() {
    ...
    printf(
        '<input type="text" class="rankology_breadcrumbs_sep" name="rankology_fno_option_name[rankology_breadcrumbs_separator]" aria-label="' . __('Breadcrumbs Separator', 'wp-rankology') . '" placeholder="' . esc_html__('e.g. \ ', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    ); ?>
...
<select id="rankology_breadcrumbs_cpt"
    name="rankology_fno_option_name[rankology_breadcrumbs_cpt][<?php echo $taxonomy->name; ?>][cpt]">
...
<select id="rankology_breadcrumbs_tax"
    name="rankology_fno_option_name[rankology_breadcrumbs_tax][<?php echo $post_type->name; ?>][tax]">
...
<label for="rankology_breadcrumbs_remove_blog_page">
    <input id="rankology_breadcrumbs_remove_blog_page"
        name="rankology_fno_option_name[rankology_breadcrumbs_remove_blog_page]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_breadcrumbs_remove_shop_page">
    <input id="rankology_breadcrumbs_remove_shop_page"
        name="rankology_fno_option_name[rankology_breadcrumbs_remove_shop_page]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
function rankology_breadcrumbs_i18n_here_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_here]" aria-label="' . __('e.g. You are here: ', 'wp-rankology') . '" placeholder="' . esc_html__('e.g. You are here: ', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    ); ?>
...
function rankology_breadcrumbs_i18n_home_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_home]" aria-label="' . __('Home', 'wp-rankology') . '" placeholder="' . esc_html__('default: Home', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    ); ?>
<p class="description">
    <?php esc_html_e('HTML tags allowed, e.g. <code>span</code>, <code>p</code>...', 'wp-rankology'); ?>
...
function rankology_breadcrumbs_i18n_author_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_author]" aria-label="' . __('Author:', 'wp-rankology') . '" placeholder="' . esc_html__('default: Author:', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
function rankology_breadcrumbs_i18n_404_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_404]" aria-label="' . __('404 error', 'wp-rankology') . '" placeholder="' . esc_html__('default: 404 error', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
function rankology_breadcrumbs_i18n_search_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_search]" aria-label="' . __('Search results for: ', 'wp-rankology') . '" placeholder="' . esc_html__('default: Search results for: ', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
function rankology_breadcrumbs_i18n_no_results_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_no_results]" aria-label="' . __('No results', 'wp-rankology') . '" placeholder="' . esc_html__('default: No results', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
function rankology_breadcrumbs_i18n_attachments_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_attachments]" aria-label="' . __('Attachments', 'wp-rankology') . '" placeholder="' . esc_html__('default: Attachments', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
function rankology_breadcrumbs_i18n_paged_callback() {
    ...
    printf(
        '<input type="text" name="rankology_fno_option_name[rankology_breadcrumbs_i18n_paged]" aria-label="' . __('Page ', 'wp-rankology') . '" placeholder="' . esc_html__('default: Page ', 'wp-rankology') . '" value="%s" />',
        esc_html($check)
    );
}
...
<label for="rankology_breadcrumbs_separator_disable">
    <input id="rankology_breadcrumbs_separator_disable"
        name="rankology_fno_option_name[rankology_breadcrumbs_separator_disable]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_breadcrumbs_storefront">
    <input id="rankology_breadcrumbs_storefront" name="rankology_fno_option_name[rankology_breadcrumbs_storefront]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
