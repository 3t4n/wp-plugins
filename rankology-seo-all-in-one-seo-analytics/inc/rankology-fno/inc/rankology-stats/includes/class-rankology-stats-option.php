...
{
    /**
     * Get Rankology Stats Basic Option name
     *
     * @var string
     */
    public static $opt_name = 'rankology_stats';

    /**
     * Rankology Stats Option name Prefix
     *
     * @var string
     */
    public static $opt_prefix = 'rkns_';

    /**
     * Get Complete Option name with Rankology Stats Prefix
     *
     * @param $name
     * @return mixed
     */
    ...
    /**
     * Rankology Stats Default Option
     *
     * @return array
     */
    ...
    /**
     * Get Rankology Stats All Options
     *
     * @return mixed
     */
    ...
    public static function get($option_name, $default = null)
    {
        ...
        /**
         * Filters a For Return Rankology Stats Option
         *
         * @param string $option Option name.
         * @param string $value Option Value.
         * @example add_filter('rankology_stats_option_coefficient', function(){ return 5; });
         */
        return apply_filters("rankology_stats_option_{$option_name}", $options[$option_name]);
    }

    /**
     * Update Rankology-Stats Option
     *
     * @param $option
     * @param $value
     */
    ...
    /**
     * Check Rankology-stats Option Require
     *
     * @param array $item
