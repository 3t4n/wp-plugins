...
class hits_page
{
    ...
    public static function view()
    {
        ...
        // Page title
        $args['title'] = __('Overall Traffic', 'rankology-stats');
        ...
        $args['total_visits']   = (Option::get('visits') ? rankology_stats_visit('total') : 0);
        $args['total_visitors'] = (Option::get('visitors') ? rankology_stats_visitor('total', null, true) : 0);
