...
class summary
{
    ...
    {
        return array(
            'search_engine'     => __('Search Engine Referrals', 'rankology-stats'),
            'current_time_date' => __('Current Time and Date', 'rankology-stats'),
            'adjustment'        => __('(Adjustment)', 'rankology-stats')
        );
    }

    /**
     * Get Summary Hits in Rankology Stats
     *
    ...
    public static function getSummaryHits($component = array())
    {
        ...
        if (in_array('user-online', $component)) {
            if (Option::get('useronline')) {
                $data['user_online'] = array(
                    'value' => rankology_stats_useronline(),
        ...
        if (in_array('visitors', $component)) {
            if (Option::get('visitors')) {
                ...
                $data['visitors']['today'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('today', null, true))
                );
                ...
                $data['visitors']['month'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('month', null, true))
                );
                ...
                $data['visitors']['60days'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('60days', null, true))
                );
                ...
                $data['visitors']['90days'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('90days', null, true))
                );
                ...
                $data['visitors']['year'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('year', null, true))
                );
                ...
                $data['visitors']['this-year'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('this-year', null, true))
                );
                ...
                $data['visitors']['last-year'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visitor('last-year', null, true))
                );

                // Total
                $data['visitors']['total'] = array(
                    'link'  => Menus::admin_url('visitors'),
                    'value' => number_format_i18n(rankology_stats_visitor('total', null, true))
                );
        ...
        if (in_array('visits', $component)) {
            if (Option::get('visits')) {
                ...
                $data['visits']['this-year'] = array(
                    ...
                    'value' => number_format_i18n(rankology_stats_visit('this-year'))
                );

                // Last Year
                $data['visits']['last-year'] = array(
                    'link'  => Menus::admin_url('hits', array('from' => TimeZone::getTimeAgo((365 * 2)), 'to' => TimeZone::getTimeAgo(365))),
                    'value' => number_format_i18n(rankology_stats_visit('last-year'))
                );

                // Total
                $data['visits']['total'] = array(
                    'link'  => Menus::admin_url('hits'),
                    'value' => number_format_i18n(rankology_stats_visit('total'))
                );
            }
        }
        ...
        if (in_array('search-engine', $component)) {
            ...
            foreach (SearchEngine::getList() as $key => $value) {
                ...
                // Get Statistics
                $today     = rankology_stats_searchengine($value['tag'], 'today');
                $yesterday = rankology_stats_searchengine($value['tag'], 'yesterday');

                // Push to List
                $data['search-engine'][$key] = array(
                    'name'      => __($value['name'], 'rankology-stats'),
                    'logo'      => $value['logo_url'],
            ...
            $data['search-engine-total'] = array(
                ...
                'total'     => number_format_i18n(rankology_stats_searchengine('all')),
            );
        }
