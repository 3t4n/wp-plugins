...
class Country
{
    ...
    public static function getList()
    {
        ...
        # Load From global
        if (isset($RANKOLOGY_Stats->country_codes)) {
            return $RANKOLOGY_Stats->country_codes;
        }

        # Load From file
        include RANKOLOGY_STATS_DIR . "includes/defines/country-codes.php";
    ...
    public static function flag($location)
    {
        ...
        return RANKOLOGY_STATS_URL . 'assets/images/flags/' . strtolower($location) . '.svg';
    }
