...
class Referred
{
     ...
     * @var string
     */
    public static $top_referring_transient = 'rkns_top_referring';
     ...
     * @var string
     */
    public static $referral_detail_opt = 'rankology_stats_referrals_detail';
    ...
    public function __construct()
    {
        ...
        add_action('rankology_stats_truncate_table', array($this, 'deleteCacheData'));
    }
    ...
    public static function get()
    {
        ...
        return apply_filters('rankology_stats_user_referer', $referred);
    }
