...
{
    /**
     * List Of rankology-stats Mysql Table
     *
     * @var array
     */
    ...
    /**
     * Rankology Stats Table name Structure in Database
     *
     * @var string
     */
    ...
    /**
     * Get Rankology Stats Table name
     *
     * @param $tbl
     * @return mixed
     */
    ...
    public static function EmptyTable($table_name = false)
    {
        ...
        if ($table_name) {
            ...
            if ($result) {
                ...
                // add action
                do_action('rankology_stats_truncate_table', str_ireplace(self::prefix() . 'statistics_', "", $table_name));

                // Return
                return sprintf(__('%s table data deleted successfully.', 'rankology-stats'), '<code>' . $table_name . '</code>');
            }
        }

        return sprintf(__('Error, %s not emptied!', 'rankology-stats'), $table_name);
    }
