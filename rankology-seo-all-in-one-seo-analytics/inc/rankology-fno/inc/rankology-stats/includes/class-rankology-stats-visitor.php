...
class Visitor
{
    ...
    {
        return apply_filters('rankology_stats_coefficient_per_visitor', self::$coefficient);
    }
    ...
    {
        return (has_filter('rankology_stats_active_visitors')) ? apply_filters('rankology_stats_active_visitors', true) : Option::get('visitors');
    }
    ...
    public static function save_visitor($visitor = array())
    {
        ...
        do_action('rankology_stats_save_visitor', $visitor_id, $visitor, Pages::get_page_type());
    ...
    public static function record($arg = array())
    {
        ...
        if ($args['exclusion_match'] === false || $args['exclusion_reason'] == 'Honeypot') {
            ...
            if (!$same_visitor) {
                ...
                $visitor = apply_filters('rankology_stats_visitor_information', $visitor);
                ...
                if ($args['exclusion_reason'] != 'Honeypot' and $args['exclusion_reason'] != 'Robot threshold') {
                    ...
                    do_action('rankology_stats_update_visitor_hits', $visitor_id, $same_visitor);
    ...
    public static function save_visitors_relationships($page_id, $visitor_id)
    {
        ...
        do_action('rankology_stats_save_visitor_relationship', $page_id, $visitor_id, $insert_id);
    ...
    public static function PrepareData($result = array())
    {
        ...
        foreach ($result as $items) {
            ...
            $item = array(
                ...
                'date'     => date_i18n(apply_filters('rankology_stats_visitor_date_format', 'F j'), strtotime($items->last_counter)),
                'agent'    => $agent,
                'platform' => $platform,
