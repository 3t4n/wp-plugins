rkns_js.top_pages_chart_meta_box = {
    ...
    view: function (args = []) {
        ...
        //html += rkns_js.btn_group_chart('top-pages-chart', args);
        setTimeout(function () {
            rkns_js.date_picker();
        }, 1000);

        // Add Chart
        html += '<div class="o-wrap"><canvas id="' + rkns_js.chart_id('top-pages-chart') + '" height="80"></canvas></div>';
    ...
    meta_box_init: function (args = []) {
        this.top_pages_chart(rkns_js.chart_id('top-pages-chart'), args);
    },
