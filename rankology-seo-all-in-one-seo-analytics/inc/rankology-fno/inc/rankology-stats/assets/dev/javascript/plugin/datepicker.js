jQuery(document).ready(function () {
    ...
    if (datePickerBtn.length && datePickerElement.length && datePickerForm.length) {
        ...
        if (rkns_js.isset(rkns_js.global, 'request_params', 'from') && rkns_js.isset(rkns_js.global, 'request_params', 'to')) {
            const requestFromDate = rkns_js.global.request_params.from;
            const requestToDate = rkns_js.global.request_params.to;
    ...
    // Single Calendar
    const datePickerField = jQuery('.rkns-js-calendar-field');
