rkns_js.search_meta_box = {
    ...
    view: function (args = []) {
        ...
        // Add Chart
        html += '<div class="o-wrap"><canvas id="' + rkns_js.chart_id('search') + '" height="' + height + '"></canvas></div>';
    ...
    meta_box_init: function (args = []) {
        ...
        rkns_js.line_chart(rkns_js.chart_id('search'), args['title'], args['date'], datasets, {
            options: {
