...
function rankology_woocommerce_cart_page_no_index_callback() {
    $options = get_option('rankology_instant_indexing_option_namewoo');
...
<label for="rankology_woocommerce_cart_page_no_index">
    <input id="rankology_woocommerce_cart_page_no_index"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_cart_page_no_index]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_checkout_page_no_index">
    <input id="rankology_woocommerce_checkout_page_no_index"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_checkout_page_no_index]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_customer_account_page_no_index">
    <input id="rankology_woocommerce_customer_account_page_no_index"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_customer_account_page_no_index]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_product_og_price">
    <input id="rankology_woocommerce_product_og_price"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_product_og_price]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_product_og_currency">
    <input id="rankology_woocommerce_product_og_currency"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_product_og_currency]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_meta_generator">
    <input id="rankology_woocommerce_meta_generator" name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_meta_generator]"
...
<label for="rankology_woocommerce_schema_output">
    <input id="rankology_woocommerce_schema_output" name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_schema_output]"
        type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<label for="rankology_woocommerce_schema_breadcrumbs_output">
    <input id="rankology_woocommerce_schema_breadcrumbs_output"
        name="rankology_instant_indexing_option_namewoo[rankology_woocommerce_schema_breadcrumbs_output]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
