...
<p class="description">
    <?php esc_html_e( 'e.g. <code>https://www.example.com/my-blog-post/?replytocom=10#respond</code> => <code>#comment-10</code>', 'wp-rankology' ); ?>
</p>
...
<label for="rankology_advanced_advanced_category_url">
	...
	printf(__('Remove <strong>%s</strong> in your permalinks', 'wp-rankology'), $category_base); ?>
</label>

<p class="description">
	<?php esc_html_e('e.g. <code>https://example.com/category/my-post-category/</code> => <code>https://example.com/my-post-category/</code>','wp-rankology'); ?>
</p>
...
function rankology_advanced_advanced_product_cat_url_callback() {
	...
	<p class="description">
		<?php esc_html_e('e.g. <code>https://example.com/product-category/my-product-category/</code> => <code>https://example.com/my-product-category/</code>','wp-rankology'); ?>
	</p>
	...
	<?php
		...
		<div class="rankology-notice is-warning">
			<p>
				<?php esc_html_e('You need to enable <strong>WooCommerce</strong> to apply these settings.', 'wp-rankology'); ?>
			</p>
		</div>
		<?php
	}
...
function rankology_advanced_advanced_google_callback() {
	...
	printf(
'<input type="text" name="rankology_advanced_option_name[rankology_advanced_advanced_google]" placeholder="' . esc_html__('Enter Google meta value site verification', 'wp-rankology') . '" aria-label="' . __('Google site verification', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
<p class="description">
...
function rankology_advanced_advanced_bing_callback() {
	...
	printf(
'<input type="text" name="rankology_advanced_option_name[rankology_advanced_advanced_bing]" placeholder="' . esc_html__('Enter Bing meta value site verification', 'wp-rankology') . '" aria-label="' . __('Bing site verification', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
); ?>
<p class="description">
...
function rankology_advanced_advanced_pinterest_callback() {
	...
	printf(
'<input type="text" name="rankology_advanced_option_name[rankology_advanced_advanced_pinterest]" placeholder="' . esc_html__('Enter Pinterest meta value site verification', 'wp-rankology') . '" aria-label="' . __('Pinterest site verification', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
);
}
...
function rankology_advanced_advanced_yandex_callback() {
	...
	printf(
'<input type="text" name="rankology_advanced_option_name[rankology_advanced_advanced_yandex]" aria-label="' . __('Yandex site verification', 'wp-rankology') . '" placeholder="' . esc_html__('Enter Yandex meta value site verification', 'wp-rankology') . '" value="%s"/>',
esc_html($check)
);
}
...
function rankology_advanced_security_metaboxe_role_callback() {
	...
	<p>
		...
		<label
			for="rankology_advanced_security_metaboxe_role_<?php echo $key; ?>">
			<input
			id="rankology_advanced_security_metaboxe_role_<?php echo $key; ?>"
			name="rankology_advanced_option_name[rankology_advanced_security_metaboxe_role][<?php echo $key; ?>]"
	...
	<?php if (isset($options['rankology_advanced_security_metaboxe_role'][$key])) {
			esc_attr($options['rankology_advanced_security_metaboxe_role'][$key]);
		}
	}
}
...
function rankology_advanced_security_metaboxe_ca_role_callback() {
	...
	<p>
		<label
			for="rankology_advanced_security_metaboxe_ca_role_<?php echo $key; ?>">
			<input
				id="rankology_advanced_security_metaboxe_ca_role_<?php echo $key; ?>"
				name="rankology_advanced_option_name[rankology_advanced_security_metaboxe_ca_role][<?php echo $key; ?>]"
				type="checkbox" <?php if ('1' == $check) { ?>
			checked="yes"
			<?php } ?>
			value="1"/>
