...
function rankology_rich_snippets_publisher_logo_callback()
{
    ...
    <input id="rankology_rich_snippets_publisher_logo_remove" class="btn btnLink is-deletable" type="button"
           value="<?php esc_html_e('Remove', 'wp-rankology'); ?>"/>
    ...
    <div id="rankology_rich_snippets_publisher_logo_placeholder_upload" class="rankology-img-placeholder"
         data_caption="<?php esc_html_e('Click to select an image', 'wp-rankology'); ?>">
