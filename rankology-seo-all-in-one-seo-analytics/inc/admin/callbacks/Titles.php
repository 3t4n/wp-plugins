...
function rankology_titles_home_site_desc_callback()
{
    ...
    <textarea id="rankology_titles_home_site_desc" name="rankology_titles_option_name[rankology_titles_home_site_desc]"
        ...
        aria-label="<?php esc_html_e('Meta description', 'wp-rankology'); ?>"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_single_titles_callback()
{
    ...
    foreach ($postTypes as $rankology_cpt_key => $rankology_cpt_value) {
        ...
        <h3>
            ...
            <em>
                <small>(<?php echo $rankology_cpt_value->name; ?>)</small>
            </em>
        ...
        $check             = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['enable']) ? $options['rankology_titles_single_titles'][$rankology_cpt_key]['enable'] : null; ?>
                ...
                <input
                    id="rankology_titles_single_cpt_enable[<?php echo $rankology_cpt_key; ?>]"
                    data-id=<?php echo $rankology_cpt_key; ?>
                name="rankology_titles_option_name[rankology_titles_single_titles][<?php echo $rankology_cpt_key; ?>][enable]" class="toggle"
                type="checkbox"
                <?php if ('1' == $check) { ?>
                ...
                <label
                    for="rankology_titles_single_cpt_enable[<?php echo $rankology_cpt_key; ?>]">
        ...
        $toggle_txt_on  = '<span class="dashicons dashicons-visibility"></span>' . __('Click to display any SEO metaboxes / columns for this post type', 'wp-rankology');
        $toggle_txt_off = '<span class="dashicons dashicons-visibility"></span>' . __('Click to hide any SEO metaboxes / columns for this post type', 'wp-rankology'); ?>
                <script>
                    jQuery(document).ready(function($) {
                        $('input[data-id=<?php echo $rankology_cpt_key; ?>]')
                            .on('click', function() {
                ...
                <?php if (isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['enable'])) {
            esc_attr($options['rankology_titles_single_titles'][$rankology_cpt_key]['enable']);
        } ?>
        ...
        <div class="rankology_wrap_single_cpt">
            ...
            <?php
         $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['title']) ? $options['rankology_titles_single_titles'][$rankology_cpt_key]['title'] : null; ?>
            <script>
                jQuery(document).ready(function($) {
                    $('#rankology-tag-single-title-<?php echo $rankology_cpt_key; ?>')
                        .click(function() {
                            $('#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>')
                                .val(rkseo_get_field_length($(
                                    '#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>'
                                )) + $(
                                    '#rankology-tag-single-title-<?php echo $rankology_cpt_key; ?>'
                                ).attr('data-tag'));
                        });
                    $('#rankology-tag-sep-<?php echo $rankology_cpt_key; ?>')
                        .click(function() {
                            $('#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>')
                                .val(rkseo_get_field_length($(
                                    '#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>'
                    ...
                    $('#rankology-tag-single-sitetitle-<?php echo $rankology_cpt_key; ?>')
                        .click(function() {
                            $('#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>')
                                .val(rkseo_get_field_length($(
                                    '#rankology_titles_single_titles_<?php echo $rankology_cpt_key; ?>'
            ...
            <div class="wrap-tags">
                <button type="button" class="btn btnSecondary tag-title"
                    id="rankology-tag-single-title-<?php echo $rankology_cpt_key; ?>"
                    data-tag="%%post_title%%">
                    <span class="dashicons dashicons-tag"></span>
                ...
                <button type="button" class="btn btnSecondary tag-title"
                    id="rankology-tag-sep-<?php echo $rankology_cpt_key; ?>"
                    data-tag="%%sep%%">
                    <span class="dashicons dashicons-tag"></span>
                    <?php esc_html_e('Separator', 'wp-rankology'); ?>
                </button>
                ...
                <button type="button" class="btn btnSecondary tag-title"
                    id="rankology-tag-single-sitetitle-<?php echo $rankology_cpt_key; ?>"
                    data-tag="%%sitetitle%%">
                    <span class="dashicons dashicons-tag"></span>
                    <?php esc_html_e('Site Title', 'wp-rankology'); ?>
                </button>
            ...
            <div class="rankology_wrap_single_cpt">
                ...
                <?php
        $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['description']) ? $options['rankology_titles_single_titles'][$rankology_cpt_key]['description'] : null; ?>

                <script>
                    jQuery(document).ready(function($) {
                        $('#rankology-tag-single-desc-<?php echo $rankology_cpt_key; ?>')
                            .click(function() {
                                $('#rankology_titles_single_desc_<?php echo $rankology_cpt_key; ?>')
                                    .val(rkseo_get_field_length($(
                                        '#rankology_titles_single_desc_<?php echo $rankology_cpt_key; ?>'
                                    )) + $(
                                        '#rankology-tag-single-desc-<?php echo $rankology_cpt_key; ?>'
            ...
            esc_html($check)
                ...
                <div class="wrap-tags">
                    <button type="button" class="btn btnSecondary tag-title"
                        id="rankology-tag-single-desc-<?php echo $rankology_cpt_key; ?>"
        ...
        $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['noindex']); ?>

                <label
                    for="rankology_titles_single_cpt_noindex[<?php echo $rankology_cpt_key; ?>]">
                    <input
                        id="rankology_titles_single_cpt_noindex[<?php echo $rankology_cpt_key; ?>]"
                        name="rankology_titles_option_name[rankology_titles_single_titles][<?php echo $rankology_cpt_key; ?>][noindex]"
        ...
        if ('1' == $check && isset($cpt_in_sitemap[$rankology_cpt_key]) && '1' === $cpt_in_sitemap[$rankology_cpt_key]['include']) { ?>
                <div class="rankology-notice is-error is-inline">
                    <p>
                        <?php printf(__('This custom post type is <strong>NOT</strong> excluded from your XML sitemaps despite the fact that it is set to <strong>NOINDEX</strong>. We recommend that you <a href="%s">check this out here</a>.', 'wp-rankology'), admin_url('admin.php?page=rankology-xml-sitemap')); ?>
                    </p>
                </div>
                <?php }

        if (isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['noindex'])) {
            esc_attr($options['rankology_titles_single_titles'][$rankology_cpt_key]['noindex']);
        } ?>
        ...
        $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['nofollow']); ?>

                <label
                    for="rankology_titles_single_cpt_nofollow[<?php echo $rankology_cpt_key; ?>]">
                    <input
                        id="rankology_titles_single_cpt_nofollow[<?php echo $rankology_cpt_key; ?>]"
                        name="rankology_titles_option_name[rankology_titles_single_titles][<?php echo $rankology_cpt_key; ?>][nofollow]"
                        type="checkbox" <?php if ('1' == $check) { ?>
                    checked="yes"
                    <?php } ?>
                    value="1"/>

                    <?php esc_html_e('Apply nofollow links for this single post type', 'wp-rankology'); ?>
                </label>

                <?php if (isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['nofollow'])) {
            esc_attr($options['rankology_titles_single_titles'][$rankology_cpt_key]['nofollow']);
        } ?>
        ...
        $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['date']); ?>

                <label
                    for="rankology_titles_single_cpt_date[<?php echo $rankology_cpt_key; ?>]">
                    <input
                        id="rankology_titles_single_cpt_date[<?php echo $rankology_cpt_key; ?>]"
                        name="rankology_titles_option_name[rankology_titles_single_titles][<?php echo $rankology_cpt_key; ?>][date]"
                        type="checkbox" <?php if ('1' == $check) { ?>
                    checked="yes"
                    <?php } ?>
                    value="1"/>

                    <?php esc_html_e('Display date in Google search results by adding <strong>(article:published_time)</strong> and <strong>(article:modified_time)</strong> meta?', 'wp-rankology'); ?>
                </label>

                <p class="description">
                    <?php esc_html_e('Unchecking this setting doesn\'t mean that Google will not display post date in search results.', 'wp-rankology'); ?>
                </p>

                <?php if (isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['date'])) {
            esc_attr($options['rankology_titles_single_titles'][$rankology_cpt_key]['date']);
        } ?>
        ...
        $check = isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['thumb_gcs']); ?>

                <label
                    for="rankology_titles_single_cpt_thumb_gcs[<?php echo $rankology_cpt_key; ?>]">
                    <input
                        id="rankology_titles_single_cpt_thumb_gcs[<?php echo $rankology_cpt_key; ?>]"
                        name="rankology_titles_option_name[rankology_titles_single_titles][<?php echo $rankology_cpt_key; ?>][thumb_gcs]"
                        type="checkbox" <?php if ('1' == $check) { ?>
                    checked="yes"
                    <?php } ?>
                    value="1"/>

                    <?php esc_html_e('Display post thumbnail in Google Custom Search results?', 'wp-rankology'); ?>
                </label>

                <p class="description">
                    <?php esc_html_e('This option does not apply to traditional search results.', 'wp-rankology'); ?>
                </p>

                <?php if (isset($options['rankology_titles_single_titles'][$rankology_cpt_key]['thumb_gcs'])) {
            esc_attr($options['rankology_titles_single_titles'][$rankology_cpt_key]['thumb_gcs']);
        } ?>

            </div>
            <?php
        if (empty($options['rankology_titles_single_titles'][$rankology_cpt_key]['title'])) {
            $t[] = $rankology_cpt_key;
        }
    }
}
...
function rankology_titles_bp_groups_desc_callback()
{
    if (is_plugin_active('buddypress/bp-loader.php') || is_plugin_active('buddyboss-platform/bp-loader.php')) {
        $options = get_option('rankology_titles_option_name'); ?>
                ...
                <textarea
                    name="rankology_titles_option_name[rankology_titles_bp_groups_desc]"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_tax_titles_callback()
{
    ...
    foreach ($taxonomies as $rankology_tax_key => $rankology_tax_value) { ?>
                <h3>
                    <?php echo $rankology_tax_value->labels->name; ?>
                    <em>
                        <small>(<?php echo $rankology_tax_value->name; ?>)</small>
                    </em>
        ...
        ?>
                    <input
                        id="rankology_titles_tax_titles_enable[<?php echo $rankology_tax_key; ?>]"
                        data-id=<?php echo $rankology_tax_key; ?>
                    name="rankology_titles_option_name[rankology_titles_tax_titles][<?php echo $rankology_tax_key; ?>][enable]"
                    ...
                    <label
                        for="rankology_titles_tax_titles_enable[<?php echo $rankology_tax_key; ?>]">
        ...
        $toggle_txt_on  = '<span class="dashicons dashicons-visibility"></span>' . __('Click to display any SEO metaboxes for this taxonomy', 'wp-rankology');
        $toggle_txt_off = '<span class="dashicons dashicons-visibility"></span>' . __('Click to hide any SEO metaboxes for this taxonomy', 'wp-rankology');
?>
                    <script>
                        jQuery(document).ready(function($) {
                            $(' input[data-id=<?php echo $rankology_tax_key; ?>]')
                                .on('click',
                                    function() {
                    ...
                    <?php if (isset($options['rankology_titles_tax_titles'][$rankology_tax_key]['enable'])) {
    esc_attr($options['rankology_titles_tax_titles'][$rankology_tax_key]['enable']);
} ?>
        ...
        ?>
                ...
                <div class="rankology_wrap_tax">
                    ...
                    <script>
                        jQuery(document).ready(function($) {
                            $(' #rankology-tag-tax-title-<?php echo $rankology_tax_key; ?>')
                                .click(function() {
                                    $('#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>')
                                        .val(rkseo_get_field_length($(
                                            '#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>'
                                        )) + $(
                                            '#rankology-tag-tax-title-<?php echo $rankology_tax_key; ?>'
                            ...
                            $('#rankology-tag-sep-<?php echo $rankology_tax_key; ?>')
                                .click(function() {
                                    $('#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>')
                                        .val(rkseo_get_field_length($(
                                            '#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>'
                            ...
                            $('#rankology-tag-tax-sitetitle-<?php echo $rankology_tax_key; ?>')
                                .click(function() {
                                    $('#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>')
                                        .val(rkseo_get_field_length($(
                                            '#rankology_titles_tax_titles_<?php echo $rankology_tax_key; ?>'
                    ...
                    <?php printf(
            '<input type="text" id="rankology_titles_tax_titles_' . $rankology_tax_key . '" name="rankology_titles_option_name[rankology_titles_tax_titles][' . $rankology_tax_key . '][title]" value="%s"/>',
            esc_html($check)
        );
        ...
        if ('category' == $rankology_tax_key) { ?>
                    <div class=" wrap-tags">
                        <button type="button"
                            id="rankology-tag-tax-title-<?php echo $rankology_tax_key; ?>"
                        ...
                        <div class="wrap-tags">
                            ...
                            <div class="wrap-tags">
                                ...
                                <button type="button" class="btn btnSecondary tag-title"
                                    id="rankology-tag-sep-<?php echo $rankology_tax_key; ?>"
                                    data-tag="%%sep%%">
                                    <span class="dashicons dashicons-tag"></span>
                                    <?php esc_html_e('Separator', 'wp-rankology'); ?>
                                </button>
                                ...
                                <button type="button" class="btn btnSecondary tag-title"
                                    id="rankology-tag-tax-sitetitle-<?php echo $rankology_tax_key; ?>"
                                    data-tag="%%sitetitle%%">
                                    <span class="dashicons dashicons-tag"></span>
                                    <?php esc_html_e('Site Title', 'wp-rankology'); ?>
                                </button>
                            ...
                            <div class="rankology_wrap_tax">
                                ...
                                <script>
                                    jQuery(document).ready(function($) {
                                        $('#rankology-tag-tax-desc-<?php echo $rankology_tax_key; ?>')
                                            .click(function() {
                                                $('#rankology_titles_tax_desc_<?php echo $rankology_tax_key; ?>')
                                                    .val(
                                                        rkseo_get_field_length($(
                                                            '#rankology_titles_tax_desc_<?php echo $rankology_tax_key; ?>'
                                                        )) + $(
                                                            '#rankology-tag-tax-desc-<?php echo $rankology_tax_key; ?>'
                                                        )
...
?>
                                ...
                                <div class="wrap-tags">
                                    <button type="button" class="btn btnSecondary tag-title"
                                        id="rankology-tag-tax-desc-<?php echo $rankology_tax_key; ?>"
        ...
        $check = isset($options['rankology_titles_tax_titles'][$rankology_tax_key]['noindex']); ?>
                                            ...
                                            <label
                                                for="rankology_titles_tax_noindex[<?php echo $rankology_tax_key; ?>]">
                                                <input
                                                    id="rankology_titles_tax_noindex[<?php echo $rankology_tax_key; ?>]"
                                                    name="rankology_titles_option_name[rankology_titles_tax_titles][<?php echo $rankology_tax_key; ?>][noindex]"
                                                    type="checkbox" <?php if ('1' == $check) { ?>
                                                checked="yes"
                                                <?php } ?>
                                                value="1"/>
        ...
        ?>
                                            ...
                                            <label
                                                for="rankology_titles_tax_nofollow[<?php echo $rankology_tax_key; ?>]">
                                                <input
                                                    id="rankology_titles_tax_nofollow[<?php echo $rankology_tax_key; ?>]"
                                                    name="rankology_titles_option_name[rankology_titles_tax_titles][<?php echo $rankology_tax_key; ?>][nofollow]"
                                                    type="checkbox" <?php if ('1' == $check) { ?>
                                                checked="yes"
                                                <?php } ?>
                                                value="1"/>
    ...
    foreach ($postTypes as $rankology_cpt_key => $rankology_cpt_value) {
        if (! in_array($rankology_cpt_key, ['post', 'page'])) {
            $check = isset($options['rankology_titles_archive_titles'][$rankology_cpt_key]['title']) ? $options['rankology_titles_archive_titles'][$rankology_cpt_key]['title'] : null; ?>
                                        <h3><?php echo $rankology_cpt_value->labels->name; ?>
                                            <em><small>(<?php echo $rankology_cpt_value->name; ?>)</small></em>

                                            <?php if (get_post_type_archive_link($rankology_cpt_value->name)) { ?>
                                            <span class="link-archive">
                                                <span class="dashicons dashicons-redo"></span>
                                                <a href="<?php echo get_post_type_archive_link($rankology_cpt_value->name); ?>"
                                                    target="_blank">
                                        ...
                                        <div class="rankology_wrap_archive_cpt">
                                            ...
                                            <script>
                                                jQuery(document).ready(function($) {
                                                    $('#rankology-tag-archive-title-<?php echo $rankology_cpt_key; ?>')
                                                        .click(
                                                            function() {
                                                                $('#rankology_titles_archive_titles_<?php echo $rankology_cpt_key; ?>')
                                                                    .val(rkseo_get_field_length($(
                                                                        '#rankology_titles_archive_titles_<?php echo $rankology_cpt_key; ?>'
                                                                    )) + $(
                                                                        '#rankology-tag-archive-title-<?php echo $rankology_cpt_key; ?>'
                                                    ...
                                                    $('#rankology-tag-archive-sep-<?php echo $rankology_cpt_key; ?>')
                                                        .click(
                                                            function() {
                                                                $('#rankology_titles_archive_titles_<?php echo $rankology_cpt_key; ?>')
                                                                    .val(rkseo_get_field_length($(
                                                    ...
                                                    $('#rankology-tag-archive-sitetitle-<?php echo $rankology_cpt_key; ?>')
                                                        .click(function() {
                                                            $('#rankology_titles_archive_titles_<?php echo $rankology_cpt_key; ?>')
                                                                .val(rkseo_get_field_length($(
                                                                    '#rankology_titles_archive_titles_<?php echo $rankology_cpt_key; ?>'
                                            ...
                                            <?php printf(
                '<input type="text" id="rankology_titles_archive_titles_' . $rankology_cpt_key . '"
                                        name="rankology_titles_option_name[rankology_titles_archive_titles][' . $rankology_cpt_key . '][title]"
                                        value="%s" />',
                esc_html($check)
            ); ?>

                                            <div class="wrap-tags"><button type="button" class="btn btnSecondary tag-title"
                                                    id="rankology-tag-archive-title-<?php echo $rankology_cpt_key; ?>"
                                                    data-tag="%%cpt_plural%%"><span
                                                        class="dashicons dashicons-tag"></span><?php esc_html_e('Post Type Archive Name', 'wp-rankology'); ?></button>

                                                <button type="button" class="btn btnSecondary tag-title"
                                                    id="rankology-tag-archive-sep-<?php echo $rankology_cpt_key; ?>"
                                                    data-tag="%%sep%%"><span
                                                        class="dashicons dashicons-tag"></span><?php esc_html_e('Separator', 'wp-rankology'); ?></button>

                                                <button type="button" class="btn btnSecondary tag-title"
                                                    id="rankology-tag-archive-sitetitle-<?php echo $rankology_cpt_key; ?>"
                                                    data-tag="%%sitetitle%%"><span
                                                        class="dashicons dashicons-tag"></span><?php esc_html_e('Site Title', 'wp-rankology'); ?></button>
                                            ...
                                            <div class="rankology_wrap_archive_cpt">
                                                ...
                                                <script>
                                                    jQuery(document).ready(function($) {
                                                        $('#rankology-tag-archive-desc-<?php echo $rankology_cpt_key; ?>')
                                                            .click(
                                                                function() {
                                                                    $('#rankology_titles_archive_desc_<?php echo $rankology_cpt_key; ?>')
                                                                        .val(rkseo_get_field_length($(
                                                                            '#rankology_titles_archive_desc_<?php echo $rankology_cpt_key; ?>'
                                                                        )) + $(
                                                                            '#rankology-tag-archive-desc-<?php echo $rankology_cpt_key; ?>'
                                                        ...
                                                        $('#rankology-tag-archive-desc-sep-<?php echo $rankology_cpt_key; ?>')
                                                            .click(
                                                                function() {
                                                                    $('#rankology_titles_archive_desc_<?php echo $rankology_cpt_key; ?>')
                                                                        .val(rkseo_get_field_length($(
                                                        ...
                                                        $('#rankology-tag-archive-desc-sitetitle-<?php echo $rankology_cpt_key; ?>')
                                                            .click(function() {
                                                                $('#rankology_titles_archive_desc_<?php echo $rankology_cpt_key; ?>')
                                                                    .val(rkseo_get_field_length($(
                                                                        '#rankology_titles_archive_desc_<?php echo $rankology_cpt_key; ?>'
                                                ...
                                                <?php printf(
                '<textarea name="rankology_titles_option_name[rankology_titles_archive_titles][' . $rankology_cpt_key . '][description]">%s</textarea>',
                esc_html($check)
            ); ?>
                                                <div class="wrap-tags">
                                                    <?php echo rankology_render_dyn_variables('tag-description'); ?>
            ...
            $check = isset($options['rankology_titles_archive_titles'][$rankology_cpt_key]['noindex']); ?>
                                                    ...
                                                    <label
                                                        for="rankology_titles_archive_cpt_noindex[<?php echo $rankology_cpt_key; ?>]">
                                                        <input
                                                            id="rankology_titles_archive_cpt_noindex[<?php echo $rankology_cpt_key; ?>]"
                                                            name="rankology_titles_option_name[rankology_titles_archive_titles][<?php echo $rankology_cpt_key; ?>][noindex]"
                                                            type="checkbox" <?php if ('1' == $check) { ?>
                                                        checked="yes"
                                                        <?php } ?>
                                                        value="1"/>
                                                    ...
                                                    <?php if (isset($options['rankology_titles_archive_titles'][$rankology_cpt_key]['noindex'])) {
                esc_attr($options['rankology_titles_archive_titles'][$rankology_cpt_key]['noindex']);
            } ?>
            ...
            $check = isset($options['rankology_titles_archive_titles'][$rankology_cpt_key]['nofollow']); ?>
                                                    ...
                                                    <label
                                                        for="rankology_titles_archive_cpt_nofollow[<?php echo $rankology_cpt_key; ?>]">
                                                        <input
                                                            id="rankology_titles_archive_cpt_nofollow[<?php echo $rankology_cpt_key; ?>]"
                                                            name="rankology_titles_option_name[rankology_titles_archive_titles][<?php echo $rankology_cpt_key; ?>][nofollow]"
                                                            type="checkbox" <?php if ('1' == $check) { ?>
                                                        checked="yes"
                                                        <?php } ?>
                                                        value="1"/>
                                                    ...
                                                    <?php if (isset($options['rankology_titles_archive_titles'][$rankology_cpt_key]['nofollow'])) {
                esc_attr($options['rankology_titles_archive_titles'][$rankology_cpt_key]['nofollow']);
            } ?>
...
function rankology_titles_archives_author_desc_callback()
{
    $options = get_option('rankology_titles_option_name'); ?>
                                                    ...
                                                    <textarea
                                                        name="rankology_titles_option_name[rankology_titles_archives_author_desc]"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_archives_date_desc_callback()
{
    $options = get_option('rankology_titles_option_name'); ?>
                                                        ...
                                                        <textarea
                                                            name="rankology_titles_option_name[rankology_titles_archives_date_desc]"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_archives_search_desc_callback()
{
    $options = get_option('rankology_titles_option_name'); ?>
                                                            ...
                                                            <textarea
                                                                name="rankology_titles_option_name[rankology_titles_archives_search_desc]"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_archives_404_desc_callback()
{
    $options = get_option('rankology_titles_option_name'); ?>
                                                                ...
                                                                <textarea id="rankology_titles_archives_404_desc"
                                                                    name="rankology_titles_option_name[rankology_titles_archives_404_desc]"><?php esc_html_e($check); ?></textarea>
...
function rankology_titles_noindex_callback()
{
    ...
    $check = isset($options['rankology_titles_noindex']); ?>
                                                                ...
                                                                <p class="description">
                                                                    <?php printf(__('Check also the "Search engine visibility" setting from the <a href="%s">Admin Reading page</a>.', 'wp-rankology'), admin_url('options-reading.php')); ?>
                                                                </p>
