...
<div class="rankology_wrap_single_cpt">
    ...
    <label
        ...
        <input
            ...
            name="rankology_xml_sitemap_option_name[rankology_xml_sitemap_post_types_list][<?php echo $rankology_cpt_key; ?>][include]"
            type="checkbox" <?php if ('1' == $check) { ?>
        checked="yes"
        <?php } ?>
        value="1"/>
...
<h3>
    ...
    <em><small>(<?php echo $rankology_tax_value->name; ?>)</small></em>
</h3>
...
<div class="rankology_wrap_single_tax">
    ...
    <label
        for="rankology_xml_sitemap_taxonomies_list_include[<?php echo $rankology_tax_key; ?>]">
        <input
            id="rankology_xml_sitemap_taxonomies_list_include[<?php echo $rankology_tax_key; ?>]"
            name="rankology_xml_sitemap_option_name[rankology_xml_sitemap_taxonomies_list][<?php echo $rankology_tax_key; ?>][include]"
            type="checkbox" <?php if ('1' == $check) { ?>
        checked="yes"
        <?php } ?>
        value="1"/>
...
function rankology_xml_sitemap_html_mapping_callback()
{
    ...
    printf(
        '<input type="text" name="rankology_xml_sitemap_option_name[rankology_xml_sitemap_html_mapping]" placeholder="' . esc_html__('e.g. 2, 8, 18', 'wp-rankology') . '" aria-label="' . __('Enter a post, page or custom post type ID(s) to display the sitemap', 'wp-rankology') . '" value="%s"/>',
        esc_html($check)
    );
}
...
function rankology_xml_sitemap_html_exclude_callback()
{
    ...
    printf(
        '<input type="text" name="rankology_xml_sitemap_option_name[rankology_xml_sitemap_html_exclude]" placeholder="' . esc_html__('e.g. 3, 6, 10', 'wp-rankology') . '" aria-label="' . __('Exclude some Posts, Pages, Custom Post Types or Terms IDs', 'wp-rankology') . '" value="%s"/>',
        esc_html($check)
    );
}
