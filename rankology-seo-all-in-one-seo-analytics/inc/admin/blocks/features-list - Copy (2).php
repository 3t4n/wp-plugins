...
<div class="custom-plugin-wrapper">
    ...
    <div class="rankology-main-page">
        ...
        <div class="rankology-main-tabs tabs">
            <ul>
                ...
                foreach ($features as $key => $value) { ?>
                    <li class="tab <?php echo ($activeTab === 0) ? 'active' : ''; ?>" data-tab="<?php echo esc_attr($key); ?>">
        ...
        foreach ($features as $key => $value) { ?>
            <!-- Tab Content -->
            <div id="<?php echo esc_attr($key); ?>" class="rankology-tabs-content content <?php echo ($activeTab === 0) ? 'active' : ''; ?>">
                <?php 
...
function render_tab_content($features) {
    ...
    switch ($features) {
        case 'titles':
            ...
            // include_once plugin_dir_path(__FILE__) . '/../admin-pages/Title_new.php';
            break;
        case 'tab2':
            include_once plugin_dir_path(__FILE__) . 'admin-pages/Tab2.php';
            break;
        case 'tab3':
            include_once plugin_dir_path(__FILE__) . 'admin-pages/Tab3.php';
            break;
