    ...
    onReady: function () {
        ...
        const observeFBThumbnail = function () {
            let fbThumbnail = document.querySelectorAll(
                ".elementor-control-_rankology_social_fb_img .elementor-control-media__preview"
            );
        ...
        const observeTWThumbnail = function () {
            let twThumbnail = document.querySelectorAll(
                ".elementor-control-_rankology_social_twitter_img .elementor-control-media__preview"
            );
        ...
        $(document).on(
            "input",
            "input[data-setting=_rankology_social_fb_title]",
            updateFbSnippetTitle
        );
        $(document).on(
            "input",
            "textarea[data-setting=_rankology_social_fb_desc]",
            updateFbSnippetDesc
        );

        $(document).on(
            "input",
            "input[data-setting=_rankology_social_twitter_title]",
            updateTwSnippetTitle
        );
        $(document).on(
            "input",
            "textarea[data-setting=_rankology_social_twitter_desc]",
            updateTwSnippetDesc
        );
...
elementor.addControlView("rankology-social-preview", socialPreviewItemView);
