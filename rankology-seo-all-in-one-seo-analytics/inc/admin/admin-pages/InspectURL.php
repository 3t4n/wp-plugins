...
defined('ABSPATH') or exit('Please don&rsquo;t call the plugin directly. Thanks :)');
    ...
    $this->options = get_option('rankology_instant_indexing_option_nameiu');
    ...
    <form method="post" action="<?php echo admin_url('options.php'); ?>"
        ...
        <?php
        $current_tab = ' ';
        echo $this->rankology_feature_title('inspect-url');
        settings_fields('rankology_instant_indexing_option_groupiu');
        ?>
                    ...
                    <div class="nav-tab-wrapper">
                        ...
                        foreach ($plugin_settings_tabs as $tab_key => $tab_caption) {
                            ...
                            <div id="<?php echo $tab_key ?>" class="rankology-sub-content <?php if ($activeState == 1) {
                                ...
                                if ($activeState == 1) {
                                    do_settings_sections('rankology-settings-admin-inspect-url');
