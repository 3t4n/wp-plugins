...
add_settings_field(
    ...
    __('Alternative site title', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Separator', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Meta description', 'wp-rankology'), // Title
...
add_settings_section(
    ...
    'rkseo_print_section_info_single', // Callback
...
add_settings_section(
    ...
    'rkseo_print_section_info_archives', // Callback
...
add_settings_section(
    ...
    'rkseo_print_section_info_tax', // Callback
...
add_settings_field(
    ...
    __('Indicate paginated content to Google', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('noindex on paged archives', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('noindex on attachment pages', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('nosnippet', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('nositelinkssearchbox', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('noimageindex', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('noarchive', 'wp-rankology'), // Title
