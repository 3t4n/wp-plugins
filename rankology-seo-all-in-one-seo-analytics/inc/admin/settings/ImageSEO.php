...
add_settings_section(
    ...
    'rkseo_print_section_info_advanced_image', // Callback
    'rankology-settings-admin-advanced-image' // Page
);

add_settings_field(
    'rankology_advanced_advanced_image_auto_alt_editor', // ID
    __('Automatically set the image Alt text', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Automatically set the image Title', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Redirect attachment pages to post parent', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Redirect attachment pages to their file URL', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Automatically set the image Alt text from target keywords', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Automatically set the image Caption', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Automatically set the image Description', 'wp-rankology'), // Title
...
add_settings_field(
    ...
    __('Cleaning media filename', 'wp-rankology'), // Title
