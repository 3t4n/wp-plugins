<?php
/**
 * Plugin Name: Advanced Table rate shipping Free
 * Version: 2.1.4
 ...
 * Tested up to: 6.7
 * Text Domain: aco-table-rate-shipping
...
define('ACOTRS_VERSION', '2.1.4');
define('ACOTRS_FILE', __FILE__);
define('ACOTRS_METHOD_ID', 'acotrs_shipping');
define('ACOTRS_PLUGIN_NAME', 'Advanced Table rate shipping Free');
...
if (!function_exists('acotrs_init')) {
    ...
    function acotrs_init()
    {
        ...
        load_plugin_textdomain('aco-table-rate-shipping', false, $plugin_rel_path);
    }
}
