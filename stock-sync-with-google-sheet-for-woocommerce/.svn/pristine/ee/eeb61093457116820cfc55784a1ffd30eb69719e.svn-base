					...
					<div class="_wppool-popup-modal-footer">
						...
						<div class="_wppool-popup-countdown" style="display: none">
							<span class="_wppool-popup-countdown-text">
								<?php echo esc_html__( 'Deal Ends In', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
							</span>
							<div class="_wppool-popup-countdown-time">
								<div>
									<span data-counter="days">
										<?php echo esc_html__( '00', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
									</span>
									<span>
										<?php echo esc_html__( 'Days', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
									</span>
								</div>
								<span>:</span>
								<div>
									...
									<span>
										<?php echo esc_html__( 'Hours', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
									</span>
								</div>
								<span>:</span>
								<div>
									...
									<span>
										<?php echo esc_html__( 'Minutes', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
									</span>
								</div>
								<span>:</span>
								<div>
									...
									<span>
										<?php echo esc_html__( 'Seconds', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
									</span>
								</div>
							</div>
						</div>
						...
						<a class="_wppool-popup-button">
							<?php echo esc_html__( 'Upgrade to Pro', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
						</a>

						<a target="_blank" class="_wppool-popup-demo-link" href="">
							<?php echo esc_html__( 'Try a free demo', 'stock-sync-with-google-sheet-for-woocommerce' ); ?>
						</a>
					</div>
				</div>
			</div>
