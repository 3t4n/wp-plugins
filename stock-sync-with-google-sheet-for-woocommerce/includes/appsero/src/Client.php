 ...
 */
namespace StockSyncWithGoogleSheetForWooCommerce\Appsero;
...
class Client {
	 ...
	 *
	 * @return StockSyncWithGoogleSheetForWooCommerce\Appsero\Insights
	 */
	...
	public function updater() {
		...
		_deprecated_function( __CLASS__ . '::updater', '2.0', '\StockSyncWithGoogleSheetForWooCommerce\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

		// initialize the new updater
		if ( method_exists( '\StockSyncWithGoogleSheetForWooCommerce\Appsero\Updater', 'init' ) ) {
	 ...
	 *
	 * @return StockSyncWithGoogleSheetForWooCommerce\Appsero\License
	 */
