	...
	<div class="exprdawc_panel">
		...
		<div class="exprdawc_attributes">
			...
			<table class="field-options wp-list-table widefat exprdawc_field_table">
				<thead id="exprdatawc_table_header">
					<tr>
						<th></th>
						<th></th>
						<th class="exprdawc_field_label"><?php esc_html_e( 'Title', 'extra-product-data-for-woocommerce' ); ?></th>
						<th class="exprdawc_field_type"><?php esc_html_e( 'Type', 'extra-product-data-for-woocommerce' ); ?></th>
						<th class="exprdawc_field_action"><?php esc_html_e( 'Action', 'extra-product-data-for-woocommerce' ); ?></th>
					</tr>
				</thead>
