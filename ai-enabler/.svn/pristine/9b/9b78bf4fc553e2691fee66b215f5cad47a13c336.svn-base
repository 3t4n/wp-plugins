    ...
    ! function() {
        var t = {
                    ...
                    e.exports = function(e) {
                        ...
                        return t.toString = function() {
                            ...
                            for (var d = 0; d < e.length; d++) {
                                var c = [].concat(e[d]);
                                o && l[c[0]] || (void 0 !== n && (void 0 === c[5] || (c[1] = "@layer".concat(c[5].length > 0 ? " ".concat(c[5]) : "", " {").concat(c[1], "}")), c[5] = n), r && (c[2] ? (c[1] = "@media ".concat(c[2], " {").concat(c[1], "}"), c[2] = r) : c[2] = r), i && (c[4] ? (c[1] = "@supports (".concat(c[4], ") {").concat(c[1], "}"), c[4] = i) : c[4] = "".concat(i)), t.push(c))
                            }
                        }, t
                    }
                },
                ...
                736: function(e, t, r) {
                    ...
                    e.exports = function(e) {
                        return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : l && l in Object(e) ? i(e) : n(e)
                    }
                },
                833: function(e, t, r) {
                    var o = r(127),
                ...
                726: function(e, t, r) {
                    ...
                    e.exports = function(e, t, r) {
                        ...
                        return t = n(t) || 0, o(r) && (b = !!r.leading, c = (h = "maxWait" in r) ? l(n(r.maxWait) || 0, t) : c, g = "trailing" in r ? !!r.trailing : g), A.cancel = function() {
                            void 0 !== u && clearTimeout(u), m = 0, s = p = d = u = void 0
                        }, A.flush = function() {
                            return void 0 === u ? f : x(i())
                        }, A
                    }
                },
                611: function(e) {
                ...
                783: function(e, t, r) {
                    ...
                    e.exports = function(e, t, r) {
                        var n = !0,
                            l = !0;
                        if ("function" != typeof e) throw new TypeError("Expected a function");
                        return i(r) && (n = "leading" in r ? !!r.leading : n, l = "trailing" in r ? !!r.trailing : l), o(e, t, {
                            leading: n,
                            maxWait: t,
                            trailing: l
                        })
                    ...
                    e.exports = function(e) {
                        ...
                        e.exports = {
                            ...
                            merge: function e() {
                                ...
                                function r(r, i) {
                                    "object" === o(t[i]) && "object" === (void 0 === r ? "undefined" : o(r)) ? t[i] = e(t[i], r) : t[i] = r
                                }
                                for (var i = 0, n = arguments.length; i < n; i++) c(arguments[i], r);
                                return t
                            },
                            extend: function(e, t, r) {
                                return c(t, (function(t, o) {
                                    e[o] = r && "function" == typeof t ? i(t, r) : t
                                })), e
                            },
                            trim: function(e) {
                        ...
                        (function(t) {
                            ...
                            var a = {
                                ...
                                transformRequest: [function(e, t) {
                                    return i(t, "Content-Type"), o.isFormData(e) || o.isArrayBuffer(e) || o.isBuffer(e) || o.isStream(e) || o.isFile(e) || o.isBlob(e) ? e : o.isArrayBufferView(e) ? e.buffer : o.isURLSearchParams(e) ? (l(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : o.isObject(e) ? (l(t, "application/json;charset=utf-8"), JSON.stringify(e)) : e
                                }],
                        ...
                        e.exports = function(e) {
                            return new Promise((function(t, c) {
                                ...
                                if (p.open(e.method.toUpperCase(), n(e.url, e.params, e.paramsSerializer), !0), p.timeout = e.timeout, p[m] = function() {
                            ...
                            a = t.I18N = function() {
                                ...
                                return e.prototype.processConfig = function(e) {
                                    ...
                                    this.langs = f.reduce((function(e, r) {
                                        var o = r[0],
                                            i = r[1];
                                        return e[o] = t.applyLanguage.call(t, o, i), e
                                    ...
                                    if (r) {
                                        ...
                                        if (t && i)
                                            if ("object" === (void 0 === t ? "undefined" : o(t)))
                                                for (var l = 0; l < i.length; l++) n = i[l].substring(1, i[l].length - 1), r = r.replace(this.makeSafe(i[l]), t[n] || "");
                                    ...
                                    return new Promise((function(o, i) {
                                        ...
                                        return (0, n.get)(l).then((function(t) {
                                            var i = t.data,
                                                n = r.processFile(i);
                                            return r.applyLanguage.call(r, e, n), r.loaded.push(e), o(r.langs[e])
                                        })).catch((function() {
                        ...
                        function a(e) {
                            var t = new n(e),
                                r = i(n.prototype.request, t);
                            return o.extend(r, n.prototype, t), o.extend(r, t), r
                        }
                        var s = a(l);
                        s.Axios = n, s.create = function(e) {
                        ...
                        e.exports = function(e, t, r) {
                            ...
                            r.status && i && !i(r.status) ? t(o("Request failed with status code " + r.status, r.config, null, r.request, r)) : e(r)
                        }
                    }, function(e, t, r) {
                        e.exports = function(e, t, r, o, i) {
                            return e.config = t, r && (e.code = r), e.request = o, e.response = i, e
                        }
                    }, function(e, t, r) {
                        var o = r(0);
                            ...
                            if (r) n = r(t);
                                ...
                                o.forEach(t, (function(e, t) {
                                    null != e && (o.isArray(e) ? t += "[]" : e = [e], o.forEach(e, (function(e) {
                                        o.isDate(e) ? e = e.toISOString() : o.isObject(e) && (e = JSON.stringify(e)), l.push(i(t) + "=" + i(e))
                                    })))
                                })), n = l.join("&")
                            }
                        ...
                        o.prototype = new Error, o.prototype.code = 5, o.prototype.name = "InvalidCharacterError", e.exports = function(e) {
                            for (var t, r, i = String(e), n = "", l = 0, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; i.charAt(0 | l) || (a = "=", l % 1); n += a.charAt(63 & t >> 8 - l % 1 * 8)) {
                                if ((r = i.charCodeAt(l += .75)) > 255) throw new o;
                                t = t << 8 | r
                            }
                            return n
                        }
                        ...
                        e.exports = o.isStandardBrowserEnv() ? {
                            write: function(e, t, r, i, n, l) {
                                var a = [];
                                a.push(e + "=" + encodeURIComponent(t)), o.isNumber(r) && a.push("expires=" + new Date(r).toGMTString()), o.isString(i) && a.push("path=" + i), o.isString(n) && a.push("domain=" + n), !0 === l && a.push("secure"), document.cookie = a.join("; ")
                            },
                            read: function(e) {
                        ...
                        e.exports = function(e) {
                            return d(e), e.baseURL && !a(e.url) && (e.url = s(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = i(e.data, e.headers, e.transformRequest), e.headers = o.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), o.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(t) {
                                delete e.headers[t]
                            })), (e.adapter || l.adapter)(e).then((function(t) {
                                return d(e), t.data = i(t.data, t.headers, e.transformResponse), t
                            }), (function(t) {
                                return n(t) || (d(e), t && t.response && (t.response.data = i(t.response.data, t.response.headers, e.transformResponse))), Promise.reject(t)
                            }))
                        }
                    }, function(e, t, r) {
                        var o = r(0);
                ...
                892: function(e, t, r) {
                        ...
                        for (var r = {}, o = [], i = 0; i < e.length; i++) {
                            ...
                            var f = l(c),
                                u = {
                                    ...
                                    media: a[2],
                                    sourceMap: a[3]
                                }; - 1 !== f ? (n[f].references++, n[f].updater(u)) : n.push({
                                identifier: c,
                                updater: b(u, t),
                                references: 1
                            }), o.push(c)
                    ...
                    function f(e, t, r, o) {
                        var i = r ? "" : o.media ? "@media ".concat(o.media, " {").concat(o.css, "}") : o.css;
                    ...
                    function u(e, t, r) {
                        var o = r.css,
                            i = r.media,
                            n = r.sourceMap;
                        if (i ? e.setAttribute("media", i) : e.removeAttribute("media"), n && "undefined" != typeof btoa && (o += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(n)))), " */")), e.styleSheet) e.styleSheet.cssText = o;
                        else {
                    ...
                    function b(e, t) {
                        ...
                        if (t.singleton) {
                            var n = m++;
                            r = p || (p = s(t)), o = f.bind(null, r, n, !1), i = f.bind(null, r, n, !0)
                        } else r = s(t), o = u.bind(null, r, t), i = function() {
                            ! function(e) {
            ...
            function() {
                ...
                const n = {},
                    ...
                    d = function(e, t, r) {
                        ...
                        let i = ["none", "block"];
                        r && (i = i.reverse());
                        for (let r = e.length - 1; r >= 0; r--) - 1 !== e[r].textContent.toLowerCase().indexOf(t.toLowerCase()) ? (e[r].style.display = i[0], o.push(e[r])) : e[r].style.display = i[1];
                        return o
                    },
                ...
                class u {
                    constructor(e) {
                        return i(this, "stage", void 0), i(this, "controls", void 0), i(this, "formActions", void 0), i(this, "editorWrap", void 0), this.optionFields = c, this.optionFieldsRegEx = f, this.subtypes = l, this.empty = s, this.filter = d, n[e] = this, n[e]
                    }
                    onRender(e, t) {
                ...
                w.backends.fallback = function(t) {
                    ...
                    const i = ["applet", "comment", "embed", "iframe", "link", "listing", "meta", "noscript", "object", "plaintext", "script", "style", "xmp"],
                        n = e.parseHTML(t, r, !1);
                    e(n).find("*").addBack().each(((t, r) => {
                        "#text" !== r.nodeName && (r.tagName && i.includes(r.tagName.toLowerCase()) ? r.parentElement ? r.parentElement.removeChild(r) : n.includes(r) && n.splice(n.indexOf(r), 1) : r.attributes && Array.from(r.attributes).forEach((t => {
                            x(t.name, t.value) && e(r).removeAttr(t.name)
                        })))
                    }));
                    const l = r.createElement("div");
                    return e(l).html(n), l.innerHTML
                };
                const A = e => {
                ...
                function N(e, t) {
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        for (o = 0; o < n.length; o++) r = n[o], t.indexOf(r) >= 0 || Object.prototype.propertyIsEnumerable.call(e, r) && (i[r] = e[r])
                    }
                    return i
                }
                window.fbLoaded = {
                ...
                const T = function(e, t) {
                    ...
                    q = function(e, t, r) {
                        ...
                        const {
                            events: i
                        } = r, n = N(r, k), l = document.createElement(e), a = {
                            string: e => {
                                O(l, l.innerHTML + e)
                            },
                            object: e => {
                        ...
                        for (const e in n)
                            if (n.hasOwnProperty(e)) {
                                const t = M(e);
                                let r = Array.isArray(n[e]) ? Q(n[e].join(" ").split(" ")).join(" ") : n[e];
                                if (x(t, r)) continue;
                                if ("boolean" == typeof r) {
                                    if (!0 === r) {
                    ...
                    $ = e => {
                        ...
                        if (t) {
                            ...
                            for (let t = 0; t < e.length; t++) {
                                const o = z(e[t]),
                                    i = e[t].getElementsByTagName("option"),
                                    n = e[t].getElementsByTagName("userData");
                                i && i.length && (o.values = U(i)), n && n.length && (o.userData = W(n)), r.push(o)
                            }
                        }
                        return r
                    },
                    ...
                    _ = function(t, r) {
                        void 0 === r && (r = ""), Array.isArray(t) || (t = [t]), t.forEach((t => {
                            let o = "href",
                                i = t,
                                n = "";
                            if ("object" == typeof t && (o = t.type || (t.style ? "inline" : "href"), n = t.id, i = n || t.href || t.style, t = "inline" === o ? t.style : t.href), !K(i, "css")) {
                                if ("href" === o) {
                                    const e = document.createElement("link");
                                    e.type = "text/css", e.rel = "stylesheet", e.href = (r || "") + t, document.head.appendChild(e)
                                } else e(`<style type="text/css">${t}</style>`).attr("id", n).appendTo(e(document.head));
                    ...
                    ne = e => e.replace(/\s/g, "-").replace(/[^a-zA-Z0-9[\]_-]/g, ""),
                ...
                e.fn.swapWith = function(t) {
                    const r = this,
                        o = e(t),
                        i = e("<div>");
                    return r.before(i), o.before(r), i.before(o).remove(), r
                };
                var ue = fe;
                const pe = ["label", "type"];
                class me {
                    constructor(e, t) {
                        ...
                        e.id || (e.name ? e.id = e.name : e.id = "control-" + Math.floor(1e7 * Math.random() + 1)), this.id = e.id, this.type = e.type, this.description && (e.title = this.description), me.controlConfig || (me.controlConfig = {});
                        const o = this.subtype ? this.type + "." + this.subtype : this.type;
                        this.classConfig = jQuery.extend({}, me.controlConfig[this.type] || {}, me.controlConfig[o] || {}), this.subtype && (e.type = this.subtype), this.required && (e.required = "required", e["aria-required"] = "true"), this.disabled && (e.disabled = "disabled"), this.config = e, this.configure()
                    }
                    ...
                    static register(e, t, r) {
                        const o = r ? r + "." : "";
                        me.classRegister || (me.classRegister = {}), Array.isArray(e) || (e = [e]);
                        for (const r of e) - 1 === r.indexOf(".") ? me.classRegister[o + r] = t : me.error(`Ignoring type ${r}. Cannot use the character '.' in a type name.`)
                    }
                    static getRegistered(e) {
                        void 0 === e && (e = !1);
                        const t = Object.keys(me.classRegister);
                        return t.length ? t.filter((t => e ? t.indexOf(e + ".") > -1 : -1 === t.indexOf("."))) : t
                    }
                    static getRegisteredSubtypes() {
                        const e = {};
                        for (const t in me.classRegister)
                            if (me.classRegister.hasOwnProperty(t)) {
                                const [r, o] = t.split(".");
                                if (!o) continue;
                                e[r] || (e[r] = []), e[r].push(o)
                            } return e
                    ...
                    static getClass(e, t) {
                        const r = t ? e + "." + t : e;
                        return me.classRegister[r] || me.classRegister[e] || me.error("Invalid control type. (Type: " + e + ", Subtype: " + t + "). Please ensure you have registered it, and imported it correctly.")
                    }
                    static loadCustom(e) {
                        let t = [];
                        if (e && (t = t.concat(e)), window.fbControls && (t = t.concat(window.fbControls)), !this.fbControlsLoaded) {
                            for (const e of t) e(me, me.classRegister);
                    ...
                    static mi18n(e, t) {
                        ...
                        const i = this.camelCase(e),
                            n = "object" == typeof o ? o[i] || o[e] : o;
                        if (n) return n;
                        let l = r.mi18n;
                        return "object" == typeof l && (l = l[i] || l[e]), l || (l = i), h().get(l, t)
                    }
                    static active(e) {
                ...
                class he {
                    constructor(e, t, r, o) {
                        var i, n, l;
                        void 0 === t && (t = !1), void 0 === r && (r = !1), void 0 === o && (o = {}), this.preview = null !== (i = t) && void 0 !== i && i, this.disableHTMLLabels = null !== (n = r) && void 0 !== n && n, this.controlConfig = null !== (l = o) && void 0 !== l ? l : {}, this.templates = {
                            label: null,
                            help: null,
                    ...
                    configure() {}
                    build(e, t, r) {
                        this.preview && (t.name ? t.name = t.name + "-preview" : t.name = ue.nameAttr(t) + "-preview"), t.id = t.name, this.data = jQuery.extend({}, t), me.controlConfig = this.controlConfig;
                        const o = new e(t, this.preview);
                        let i = o.build();
                        if ("object" == typeof i && i.field || (i = {
                                field: i
                            }), "string" == typeof i.field) {
                            const e = this.markup("div", i.field, {});
                            1 === e.childElementCount ? i.field = e.children.item(0) : i.field = Array.from(e.children)
                        }
                        const n = this.label(),
                            l = this.help();
                        let a;
                        a = r && this.isTemplate(r) ? r : this.isTemplate(i.layout) ? i.layout : "default";
                        const s = this.processTemplate(a, i.field, n, l);
                        return o.on("prerender")(s), s.addEventListener("fieldRendered", o.on("render")), s
                    }
                    label() {
                        const e = this.data.label || "",
                            t = [this.disableHTMLLabels ? document.createTextNode(e) : ue.parsedHtml(e)];
                    ...
                    processTemplate(e) {
                        ...
                        let i = this.templates[e](...r, this.data);
                        return i.jquery && (i = i[0]), i
                    }
                    markup(e, t, r) {
                        return void 0 === t && (t = ""), void 0 === r && (r = {}), ue.markup(e, t, r)
                    }
                }
                const ge = () => null;
                h().addLanguage("en-US", {
                ...
                const ke = ["values"],
                    je = ["label", "events"],
                    Ee = ["actionButtons", "replaceFields"];
                ...
                class Ne {
                    constructor(e, t, r) {
                        this.data = p[e], this.d = n[e], this.config = xe[e], this.doCancel = !1, this.layout = t, this.handleKeyDown = this.handleKeyDown.bind(this), this.formBuilder = r, this.toastTimer = null
                    }
                    startMoving(e, t) {
                    ...
                    beforeStop(e, t) {
                        const r = this,
                            o = this.config.opts,
                            i = r.d.stage.childNodes.length - 1,
                            n = [];
                        r.stopIndex = t.placeholder.closest("ul.stage-wrap > *").index() - 1, !o.sortableControls && t.item.parent().hasClass("frmb-control") && n.push(!0), o.prepend && n.push(0 === r.stopIndex), o.append && n.push(r.stopIndex + 1 === i), r.doCancel = n.some((e => !0 === e))
                    }
                    getTypes(t) {
                        const r = {
                                type: t.attr("type")
                    ...
                    fieldOptionData(t) {
                        ...
                        return o.each((e => {
                            const t = o[e],
                                i = t.querySelectorAll("input[type=text], input[type=number], select"),
                                n = t.querySelectorAll("input[type=checkbox], input[type=radio]"),
                                l = {};
                            X(i, (e => {
                                const t = i[e],
                                    r = t.dataset.attr;
                    ...
                    xmlSave(e) {
                        ...
                        t.forEach((e => {
                            ...
                            let r = [`<field ${i=Se(e,ke),Object.entries(i).map((e=>{let[t,r]=e;return`${P(t)}="${r}"`})).join(" ")}>`];
                            var i;
                        ...
                        const i = q("form-template", I(o).join(""));
                        return r.serializeToString(i)
                    }
                    prepData(t) {
                        const r = [],
                            o = this.d,
                        ...
                        if (0 !== t.childNodes.length) {
                            ...
                            X(t.childNodes, (function(t, r) {
                                ...
                                if (!l.hasClass("disabled-field")) {
                                    ...
                                    if (a = Object.assign({}, a, i.getAttrVals(t)), a.subtype)
                                        if ("quill" === a.subtype) {
                                    ...
                                    if (d.length && (a.role = d.join(",")), a.className = a.className || a.class, a.className && "true" == l.attr("addeddefaultcolumnclass") && 1 == l.closest(this.formBuilder.rowWrapperClassSelector).children().length && a.className.includes(n.opts.defaultGridColumnClass)) {
                                        const e = de(a.className);
                                        e && e.length > 0 && e.forEach((e => {
                                            a.className = a.className.replace(e, "").trim()
                                        }))
                                    }
                                    if (a.className) {
                                        const e = new RegExp("(?:^|\\s)btn-(" + we.btn.join("|") + ")(?:\\s|$)", "g").exec(a.className);
                                        e && (a.style = e[1])
                                    }
                                    a = T(a), a.type && a.type.match(o.optionFieldsRegEx) && (a.values = i.fieldOptionData(l)), r.push(a)
                                }
                            }))
                        }
                        return r
                    ...
                    save(e) {
                        ...
                        return r.formData = i[this.config.opts.dataType](e), document.dispatchEvent(v.formSaved), r.formData
                    }
                    incrementId(e) {
                    ...
                    getAttrVals(t) {
                        const r = this.config,
                            ...
                            i = t.querySelectorAll('[class*="fld-"]');
                        return X(i, (t => {
                            const n = i[t],
                                l = B(n.getAttribute("name"));
                            o[l] = [
                                [n.attributes.contenteditable, () => "xml" === r.opts.dataType ? J(n.innerHTML) : n.innerHTML],
                    ...
                    updatePreview(t) {
                        const r = this,
                            ...
                            i = t.attr("class"),
                            n = t[0];
                        if (i.includes("input-control")) return;
                        const l = t.attr("type"),
                            a = e(".prev-holder", n);
                        let d = Object.assign({}, r.getAttrVals(n), {
                            type: l
                        });
                        l.match(o.optionFieldsRegEx) && (d.values = [], d.multiple = e('[name="multiple"]', n).is(":checked"), e(".sortable-options li", n).each((function(t, r) {
                            const o = {
                            ...
                            if (o) {
                                ...
                                r.appendChild(e), r.addEventListener("mousemove", (t => ((e, t) => {
                                    const r = t.field.getBoundingClientRect(),
                                        ...
                                        i = e.clientY - r.top - t.tt.offsetHeight - 12;
                                    t.tt.style.transform = `translate(${o}px, ${i}px)`
                                })(t, {
                                    tt: e,
                                    field: r
                                })))
                    ...
                    classNames(t, r) {
                        ...
                        if (s && n) {
                            for (let e = 0; e < a.length; e++) {
                                const t = new RegExp(`^${s}-(?:` + we.btn.join("|") + ")$");
                                a[e].match(t) && a.splice(e, 1, s + "-" + n)
                            }
                            a.push(s + "-" + n), a.push(s)
                        }
                    ...
                    dialog(e, t, r) {
                        ...
                        return t ? n.classList.add("positioned") : (t = {
                            pageX: Math.max(o, window.innerWidth || 0) / 2,
                            pageY: Math.max(i, window.innerHeight || 0) / 2
                        }, n.style.position = "fixed"), n.style.left = t.pageX + "px", n.style.top = t.pageY + "px", document.body.appendChild(n), document.dispatchEvent(v.modalOpened), -1 !== r.indexOf("data-dialog") && document.dispatchEvent(v.viewData), n
                    }
                    confirmRemoveAll(t) {
                        const r = this,
                            o = this.config,
                            i = t.target.id.match(/frmb-\d{13}/)[0],
                            ...
                            c = {
                                ...
                                pageY: s.top - d.top - 12
                            };
                        a.length ? r.confirm(l.clearAllMessage, (() => {
                            r.removeAllFields.call(r, n), o.opts.persistDefaultFields && o.opts.defaultFields ? this.addDefaultFields() : o.opts.notify.success(l.allFieldsRemoved), o.opts.onClearAll()
                        }), c) : r.dialog(l.noFieldsToClear, c)
                    }
                    addDefaultFields() {
                    ...
                    setFieldOrder(t) {
                        ...
                        return t.children().each(((t, r) => {
                            const i = e(r).data("type");
                            i && o.push(i)
                        })), Oe()("sessionStorage") && window.sessionStorage.setItem("fieldOrder", r.stringify(o)), o
                    }
                    closeAllEdit() {
                    ...
                    closeField(t, r) {
                        ...
                        if (!i) return i;
                        const n = e(".frm-holder", i),
                            l = e(".prev-holder", i);
                        let a = !1;
                        if (e(i).hasClass("editing") && (a = !0), !a) return i;
                        i.classList.toggle("editing"), e(".toggle-form", i).toggleClass("open"), r ? (l.slideToggle(250), n.slideToggle(250)) : (l.toggle(), n.toggle()), this.updatePreview(e(i));
                        const s = e(`#${t}`),
                            d = e(`#${t}-cont`);
                        d.append(s), this.removeContainerProtection(d.attr("id")), this.config.opts.onCloseFieldEdit(n[0]), document.dispatchEvent(v.fieldEditClosed);
                    ...
                    openField(t, r) {
                        ...
                        const o = document.getElementById(t);
                        if (!o) return o;
                        const i = e(".frm-holder", o),
                            n = e(".prev-holder", o);
                        let l = !1;
                        if (e(o).hasClass("editing") && (l = !0), l) return o;
                        o.classList.toggle("editing"), e(".toggle-form", o).toggleClass("open"), r ? (n.slideToggle(250), i.slideToggle(250)) : (n.toggle(), i.toggle()), this.updatePreview(e(o));
                        const a = e(`#${t}`),
                            s = e(`#${t}-cont`),
                            d = s.closest(this.formBuilder.rowWrapperClassSelector);
                        return this.formBuilder.preserveTempContainers.push(s.attr("id")), a.insertAfter(d), this.formBuilder.currentEditPanel = i[0], this.config.opts.onOpenFieldEdit(i[0]), document.dispatchEvent(v.fieldEditOpened), e(document).trigger("fieldOpened", [{
                    ...
                    showData() {
                        const e = J(this.getFormData(this.config.opts.dataType, !0)),
                            t = q("code", e, {
                    ...
                    removeField(t, r) {
                        ...
                        const i = this,
                            n = this.d.stage,
                            l = n.getElementsByClassName("form-field");
                        if (!l.length) return this.config.opts.notify.warning("No fields to remove"), !1;
                        if (!t) {
                            const e = [].slice.call(l).map((e => e.id));
                            this.config.opts.notify.warning("fieldID required to remove specific fields."), this.config.opts.notify.warning("Removing last field since no ID was supplied."), this.config.opts.notify.warning("Available IDs: " + e.join(", ")), t = e[e.length - 1]
                        }
                        ...
                        s.slideUp(r, (function() {
                            s.removeClass("deleting"), s.remove(), o = !0, i.save(), n.childNodes.length || (n.classList.add("empty"), n.dataset.content = h().current.getStarted)
                        }));
                    ...
                    processActionButtons(e) {
                        ...
                        let i = t;
                        const n = this.data;
                        i = i ? h().current[i] || i : o.id ? h().current[o.id] || ee(o.id) : "", o.id ? o.id = `${n.formID}-${o.id}-action` : o.id = `${n.formID}-action-${Math.round(1e3*Math.random())}`;
                        const l = q("button", i, o);
                        if (r)
                    ...
                    processSubtypes(e) {
                        ...
                        for (const t in e) e.hasOwnProperty(t) && me.register(e[t], me.getClass(t), t);
                        const r = me.getRegisteredSubtypes(),
                            o = Object.entries(r).reduce(((e, r) => {
                                let [o, i] = r;
                                return e[o] = t[o] && ae(t[o], i) || i, e
                            }), {}),
                            i = {};
                        for (const e in o)
                            if (o.hasOwnProperty(e)) {
                                const t = [];
                                for (const r of o[e]) {
                                    const o = me.getClass(e, r),
                                        i = o.mi18n(`subtype.${r}`) || o.mi18n(r) || r;
                                    t.push({
                                        label: i,
                                        value: r
                                    })
                    ...
                    editorUI(e, t) {
                        const r = this.d,
                            o = this.data,
                            i = e || o.formID,
                            n = "left" === (t || "") ? "controls-left" : "controls-right";
                        r.editorWrap = q("div", null, {
                            id: `${o.formID}-form-wrap`,
                            className: `form-wrap form-builder formbuilder-embedded-bootstrap ${ie()} ${n}`
                        }), r.stage = q("ul", null, {
                            id: i,
                            className: "frmb stage-wrap"
                        }), r.controls = q("ul", null, {
                            id: `${i}-control-box`,
                            className: "frmb-control"
                        });
                        const l = this.formActionButtons();
                        r.formActions = q("div", l, {
                    ...
                    processOptions(e) {
                        const t = this,
                            ...
                            i = Se(e, Ee);
                        let n = i.fieldEditContainer;
                        "string" == typeof i.fieldEditContainer && (n = document.querySelector(i.fieldEditContainer));
                        const l = [{
                            type: "button",
                            id: "clear",
                        ...
                        return i.fields = i.fields.concat(o), i.disableFields = i.disableFields.concat(o.map((e => {
                            let {
                                type: t
                            } = e;
                            return t && t
                        }))), "xml" === i.dataType && (i.disableHTMLLabels = !0), t.config.opts = Object.assign({}, {
                            actionButtons: l
                        }, {
                            fieldEditContainer: n
                        }, i), t.config.opts
                    }
                    input(e) {
                    ...
                    tmpCleanPrevHolder(t) {
                        ...
                        function n(e) {
                            ...
                            if (void 0 !== t && !1 !== t) {
                                ...
                                const i = {};
                                i.field = e, i.columnInfo = t, o.push(i)
                            }
                        }
                        return n(i), i.find("*").each((function(t, r) {
                            n(e(r))
                        })), o
                    }
                    ...
                    getDistanceBetweenPoints(e, t, r, o) {
                        const i = r - e,
                            n = o - t;
                        return Math.floor(Math.sqrt(n * n + i * i))
                    }
                    getRowClass(e) {
                        if (e) {
                    ...
                    syncBootstrapColumnWrapperAndClassProperty(t, r) {
                        ...
                        const i = e(`#className-${t}`);
                        i.val() && i.val(this.changeBootstrapClass(i.val(), r))
                    }
                }
                const Te = ["values", "type"];
                me.register("autocomplete", class extends me {
                    static get definition() {
                        return {
                            mi18n: {
                        ...
                        const e = this.config,
                            ...
                            n = {
                                focus: e => {
                                    ...
                                    if (e.target.addEventListener("keydown", i), e.target.value.length > 0) {
                                        const e = r.length > 0 ? r[r.length - 1] : null;
                                        this.showList(t, e)
                                    }
                                },
                                blur: e => {
                                    e.target.removeEventListener("keydown", i);
                                    const t = setTimeout((() => {
                    ...
                    onRender(t) {
                        if (this.config.userData) {
                            ...
                            if (r.find("li").each((function() {
                                ...
                                })), null === i) return this.config.requireValidOption ? void 0 : void t.prev().val(this.config.userData[0]);
                            t.prev().val(i.innerHTML), t.val(i.getAttribute("value"));
                            const n = t.next().get(0);
                            "none" === n.style.display ? this.showList(n, i) : this.hideList(n)
                        }
                        return t
                    }
                });
                ...
                me.register("button", De), me.register(["button", "submit", "reset"], De, "button");
                class Le extends me {
                    constructor(e, t, r) {
                    ...
                    build() {
                        let e = this.template;
                        if (!e) return me.error(`Invalid custom control type '${this.type}'. Please ensure you have registered it correctly as a template option.`);
                ...
                me.register("hidden", class extends me {
                    build() {
                ...
                class Ie extends me {
                    build() {
                        ...
                        return i[t] && (o = i[t]), {
                            field: this.markup(o, ue.parsedHtml(this.label), r),
                            layout: "noLabel"
                        }
                    }
                }
                me.register(["paragraph", "header"], Ie), me.register(["p", "address", "blockquote", "canvas", "output"], Ie, "paragraph"), me.register(["h1", "h2", "h3", "h4", "h5", "h6"], Ie, "header");
                ...
                me.register(["select", "checkbox-group", "radio-group", "checkbox"], class extends me {
                    static get definition() {
                        return {
                            inactive: ["checkbox"],
                            mi18n: {
                    ...
                    build() {
                        const e = [],
                            ...
                            c = n.replace("-group", ""),
                            f = "select" === n;
                        if ((d.multiple || "checkbox-group" === n) && (d.name = d.name + "[]"), "checkbox-group" === n && d.required) {
                            const e = this,
                        ...
                        if (delete d.title, r) {
                            ...
                            for (let t = 0; t < r.length; t++) {
                                ...
                                if (u.id = `${d.id}-${t}`, u.selected && !i || delete u.selected, void 0 !== o && u.value === o && (u.selected = !0), f) {
                                    ...
                                    let n = [o, this.markup("label", t, i)];
                                    s && (i.className = "kc-toggle", t.unshift(o, this.markup("span")), n = this.markup("label", t, i));
                                    const f = this.markup("div", n, {
                                        className: r
                                    });
                                    e.push(f)
                                }
                            ...
                            if (!f && a) {
                                ...
                                const i = {
                                    ...
                                    n = this.markup("input", null, o),
                                    a = [document.createTextNode(me.mi18n("other")), this.markup("input", null, i)],
                                    s = this.markup("label", a, {
                                        for: o.id
                                    }),
                                    f = this.markup("div", [n, s], {
                                        className: r
                                    });
                                e.push(f)
                            }
                        }
                        return this.dom = "select" == n ? this.markup(c, e, T(d, !0)) : this.markup("div", e, {
                            className: n
                        }), this.dom
                    }
                    groupRequired() {
                                ...
                                ((e, t) => {
                                    [].forEach.call(e, (e => {
                                        t ? e.removeAttribute("required") : e.setAttribute("required", "required"), ((e, t) => {
                                            const r = me.mi18n("minSelectionRequired", 1);
                ...
                me.register(["text", "file", "date", "number"], Fe), me.register(["text", "password", "email", "color", "tel"], Fe, "text"), me.register(["date", "time", "datetime-local"], Fe, "date"), me.register(["number", "range"], Fe, "number");
                const He = ["value"];
                class qe extends me {
                    static get definition() {
                        return {
                ...
                me.register("textarea", qe), me.register("textarea", qe, "textarea");
                const ze = ["value"];
                qe.register("tinymce", class extends qe {
                    configure() {
                    ...
                    onRender() {
                        ...
                        const o = this.config.userData ? this.parsedHtml(this.config.userData[0]) : void 0,
                            i = window.lastFormBuilderCopiedTinyMCE ? this.parsedHtml(window.lastFormBuilderCopiedTinyMCE) : void 0;
                        window.lastFormBuilderCopiedTinyMCE = null;
                        const n = function(e) {
                            i ? e[0].setContent(i) : o && e[0].setContent(o)
                        };
                        setTimeout((() => {
                            window.tinymce.init(t).then(n)
                        }), 0)
                    }
                }, "textarea");
                const Ue = ["value"];
                ...
                qe.register("quill", class extends qe {
                    configure() {
                        const e = {
                                modules: {
                                    toolbar: [
                    ...
                    register(e, t) {
                        ...
                        Object.keys(e).forEach((t => {
                            const r = function(r, o) {
                                this.customControl = new Le(r, o, e[t]), this.build = function() {
                        ...
                        for (const o of t) {
                            ...
                            if (o.attrs = o.attrs || {}, !t) {
                                if (!o.attrs.type) {
                                    me.error("Ignoring invalid custom field definition. Please specify a type property.");
                                    continue
                                }
                                t = o.attrs.type
                            }
                            ...
                            if (e[t]) {
                                ...
                                e.definition = o, this.customRegister[i] = jQuery.extend(o, {
                                    type: t,
                                    class: e
                                })
                            } else {
                                const e = me.getClass(t, o.subtype);
                                if (!e) {
                                ...
                                i = o.datatype ? o.datatype : `${t}-${Math.floor(9e3*Math.random()+1e3)}`, this.customRegister[i] = jQuery.extend(o, {
                                    type: t,
                                    class: e
                                })
                            }
                            this.def.i18n[r][i] = o.label, this.def.icon[i] = o.icon
                        }
                    }
                    label(e) {
                        const t = this.definition;
                        ...
                        const o = me.camelCase(e),
                            i = "object" == typeof r ? r[o] || r[e] : r;
                        if (i) return i;
                        {
                            let r = t.mi18n;
                ...
                var Je = JSON.parse('{"Rp":"formbuilder-icon-"}');
                const Ge = Je.Rp;
                class Xe {
                    constructor(e, t) {
                        this.opts = e, this.dom = t.controls, this.getRegistered = me.getRegistered, this.init()
                    }
                    init() {
                    ...
                    setupControls() {
                        const e = this.opts;
                        me.loadCustom(e.controls), this.custom = new Ve(e.templates, e.fields);
                        const t = me.getRegistered(),
                            r = this.custom.getRegistered();
                        r && jQuery.merge(t, r), this.registeredSubtypes = me.getRegisteredSubtypes(), e.sortableControls && this.dom.classList.add("sort-enabled"), this.controlList = [], this.allControls = {};
                        for (let e = 0; e < t.length; e++) {
                            const r = t[e];
                            let o, i = this.custom.lookup(r);
                            if (i) o = i.class;
                            else if (i = {}, o = me.getClass(r), !o || !o.active(r)) continue;
                            const n = i.icon || o.icon(r);
                            let l = i.label || o.label(r);
                            const a = n ? "" : i.iconClassName || `${Ge+r.replace(/-[\d]{4}$/,"")}`;
                            n && (l = `<span class="control-icon">${n}</span>${l}`);
                        ...
                        e.inputSets.length && e.inputSets.forEach(((e, t) => {
                            ...
                            const i = q("li", q("span", o), {
                                className: `input-set-control input-set-${t}`
                            });
                            i.dataset.type = r, this.controlList.push(r), this.allControls[r] = i
                        }))
                    }
                    orderFields(e) {
                        const t = this.opts,
                        ...
                        let o;
                        return Oe()("sessionStorage") && (t.sortableControls ? o = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), o ? (o = window.JSON.parse(o), o = Q(o.concat(e)), o = Object.keys(o).map((e => o[e]))) : o = Q(r), o.forEach((e => {
                    ...
                    getClass(e, t) {
                        return this.custom.getClass(e) || me.getClass(e, t)
                    }
                }
                const Qe = ["class", "className"],
                    Ze = ["multiple", "options", "label", "value", "class", "className"],
                    Ye = ["class", "className"],
                    Ke = ["tag", "content"],
                    _e = ["i18n"];
                ...
                const ot = Je.Rp,
                    {
                        rowWrapperClass: it,
                        colWrapperClass: nt,
                        tmpRowPlaceholderClass: lt,
                        invisibleRowPlaceholderClass: at
                    } = Ae,
                    {
                        rowWrapperClassSelector: st,
                        colWrapperClassSelector: dt,
                        tmpRowPlaceholderClassSelector: ct,
                        invisibleRowPlaceholderClassSelector: ft
                    } = (ut = Ae, Object.entries(ut).reduce(((e, t) => {
                        let [r, o] = t;
                        return S(S({}, e), {}, {
                            [`${r}Selector`]: `.${o}`
                        })
                ...
                function pt(e, t, o) {
                    const i = this,
                        ...
                        c = xe[l] = {};
                    let f = [];
                    i.preserveTempContainers = [], i.rowWrapperClassSelector = st, i.colWrapperClassSelector = dt, i.colWrapperClass = nt, i.fieldSelector = e.enableEnhancedBootstrapGrid ? st : "li.form-field", (e => {
                    ...
                    })(e.sanitizerOptions), o(t).closest("form").length && e.notify.warning("WARNING: FormBuilder does not support being contained with a <form> Element"), e.layout || (e.layout = he);
                    ...
                    A.sortable({
                    ...
                    }), e.allowStageSort || A.sortable("disable"), C.sortable({
                        helper: "clone",
                        opacity: .9,
                        connectWith: `#${l}, ${st}`,
                        ...
                        update: function(t, r) {
                            ...
                            o(r.item).closest(".stage-wrap") && 0 === o(r.item).closest(st).length ? (b.doCancel = !0, R(r.item)) : (D() && ge(), b.setFieldOrder(C), b.doCancel = !e.sortableControls)
                        }
                    }), C.on("mouseenter", (function() {
                        b.stageIsEmpty() || A.children(ct + ":not(:last-child)").addClass(at)
                    }));
                    const R = t => {
                    ...
                    if (e.stickyControls.enable) {
                        ...
                        0 !== t.top && (B = `top: ${t.top}px`)
                    }
                    const z = g("div", d.controls, {
                        id: `${s.formID}-cb-wrap`,
                        className: M,
                        style: B
                    });
                    e.showActionButtons && z.appendChild(d.formActions);
                    const U = g("div", "", {
                        id: `${s.formID}-gridModeHelp`,
                        className: "grid-mode-help"
                    });
                    z.appendChild(U), I.append(d.stage, z), "textarea" !== t.type ? o(t).append(I) : o(t).replaceWith(I), o(d.controls).on("click", "li", (t => {
                        let {
                            target: r
                        } = t;
                        b.stageIsEmpty() && A.find(ct).eq(0).remove();
                        const i = o(r).closest("li");
                        b.stopIndex = e.append ? A.children().length - 1 : void 0, R(i), b.save.call(b)
                    }));
                    const W = function(t, r) {
                        void 0 === r && (r = !1);
                        let i = {};
                        if (t instanceof jQuery)
                            if (i.type = t[0].dataset.type, i.type) {
                                const e = y.custom.lookup(i.type);
                                if (e) i = Object.assign({}, e);
                                else {
                                    const e = y.getClass(i.type);
                                    i.label = e.label(i.type)
                                }
                            } else {
                                const e = t[0].attributes;
                                r || (i.values = t.children().map(((e, t) => ({
                                    label: o(t).text(),
                                    value: o(t).attr("value"),
                                    selected: Boolean(o(t).attr("selected"))
                                }))));
                                for (let t = e.length - 1; t >= 0; t--) i[e[t].name] = e[t].value
                            }
                        else i = Object.assign({}, t);
                        i.name || (i.name = F(i)), r && ["text", "number", "file", "date", "select", "textarea", "autocomplete"].includes(i.type) && (i.className = i.className || "form-control");
                        const n = /(?:^|\s)btn-(.*?)(?:\s|$)/g.exec(i.className);
                        if (n && (i.style = n[1]), r) {
                            const e = setTimeout((() => {
                                document.dispatchEvent(v.fieldAdded), clearTimeout(e)
                            }), 10)
                        }
                        e.onAddField(s.lastID, i), me(i, r), e.onAddFieldAfter(s.lastID, i), d.stage.classList.remove("empty")
                    };
                    i.prepFieldVars = W;
                    const $ = function(t) {
                        (t = b.getData(t)) && t.length ? (t.forEach((e => J(e))), t.forEach((e => W(T(e)))), d.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? (c.opts.defaultFields.forEach((e => J(e))), b.addDefaultFields()) : e.prepend || e.append || (d.stage.classList.add("empty"), d.stage.dataset.content = h().get("getStarted")), (() => {
                            const t = [],
                                r = t => g("li", e[t], {
                                    className: `disabled-field form-${t}`
                                });
                            return e.prepend && !o(".disabled-field.form-prepend", d.stage).length && (t.push(!0), A.prepend(r("prepend"))), e.append && !o(".disabled-field.form-append", d.stage).length && (t.push(!0), A.append(r("append"))), b.disabledTT(d.stage), t.some((e => !0 === e))
                        })() && d.stage.classList.remove("empty"), b.save()
                    };
                    ...
                    const G = t => {
                        const {
                            ...
                            e in y.registeredSubtypes && !(e in o) && (o[e] = t.concat(["subtype"])), o["checkbox-group"] = o.checkbox, o["radio-group"] = o.checkbox;
                            const i = o[e];
                            return "radio-group" === e && Z("toggle", i), ["header", "paragraph", "button"].includes(e) && Z("description", i), r || Z("value", i), i || t
                        })(r), l = {
                            required: () => pe(t),
                            toggle: () => ie("toggle", t, {
                                first: h().get("toggle")
                            ...
                            options: () => function(e) {
                                ...
                                let o;
                                const i = [g("a", h().get("addOption"), {
                                        className: "add add-opt"
                                    })],
                                    n = [g("label", h().get("selectOptions"), {
                                ...
                                const s = g("div", i, {
                                    ...
                                    d = g("ol", o.map((function(r, o, i, n) {
                                        void 0 === n && (n = e.name);
                                        const a = c.opts.onAddOption(r, {
                                            type: t,
                                            index: o,
                                            isMultiple: l
                                        });
                                        return Te(n + "-options", a, l)
                                    })), {
                        ...
                        if (Object.keys(n).forEach((t => {
                                ...
                                if (i.definition.hasOwnProperty("disabledAttrs")) {
                                    const e = i.definition.disabledAttrs;
                                    s.push(!e.includes(a))
                                }
                                if (i.definition.hasOwnProperty("defaultAttrs")) {
                                    const e = Object.keys(i.definition.defaultAttrs);
                                    s.push(!e.includes(a))
                                }
                                if (p) {
                            ...
                            })), i.definition.hasOwnProperty("defaultAttrs")) {
                            const e = K(i.definition.defaultAttrs, t);
                            o.push(e)
                        }
                        if (p) {
                            const e = K(p, t);
                    ...
                    function K(t, r) {
                        const o = [],
                            i = {
                                ...
                                boolean: (e, t) => {
                                    let o = !1;
                                    return "checkbox" === e.type ? o = Boolean(!!t.hasOwnProperty("value") && t.value) : r.hasOwnProperty(e) ? o = r[e] : (t.hasOwnProperty("value") || t.hasOwnProperty("checked")) && (o = t.value || t.checked || !1), ie(e, rt(rt({}, t), {}, {
                                        [e]: o
                                    }), {
                                        first: n[e]
                                    })
                            ...
                            if (t.hasOwnProperty(l)) {
                                ...
                                if ("undefined" !== a) {
                                    const e = h().get(l),
                                        s = Object.assign({}, t[l]);
                                    let d = s.value;
                                    "boolean" === a ? s[l] ??= s.value : "number" === a ? s[l] ??= ce(r[l], d) : (d ??= "", s[l] ??= r[l] || d), s.value = s[l], s.label && (n[l] = Array.isArray(s.label) ? h().get(...s.label) || s.label[0] : s.label), i[a] && o.push(i[a](l, s)), n[l] = e
                                } else if ("undefined" === a && Y(r, l)) o.push(K(t[l], r));
                                else {
                                    const r = {};
                    ...
                    function _(e, t) {
                        ...
                        let l = {
                            ...
                            value: i.hasOwnProperty(e) ? i[e] : i.value || ""
                        };
                        const a = `<label for="${l.id}">${n[e]||""}</label>`;
                        return ["checkbox", "checkbox-group", "radio-group"].includes(l.type) || l.className.push("form-control"), l = Object.assign({}, i, l), `<div class="form-group ${e}-wrap">${a}<div class="input-wrap">${(()=>{if("textarea"===l.type){const e=l.value;return delete l.value,`<textarea ${L(l)}>${e}</textarea>`}return` < input $ {
                            L(l)
                        } > `})()}</div></div>`
                    }
                    ...
                    function te(e, t) {
                        const {
                            ...
                            class: a,
                            className: d
                        } = t, c = et(t, Ze), f = t.hasOwnProperty(e) ? t[e] : l || [], u = Object.keys(o).map((e => {
                            const t = {
                                    value: e
                                },
                                r = o[e],
                                i = Array.isArray(r) ? h().get(...r) || r[0] : r;
                            return (Array.isArray(f) ? f.includes(e) : e === f) && (t.selected = !0), g("option", i, t)
                        })), p = {
                            id: `${e}-${s.lastID}`,
                            title: c.description || i || e.toUpperCase(),
                            name: e,
                    ...
                    const ie = function(e, t, r) {
                            ...
                            t[e] && (i.checked = !0);
                            const n = [];
                            let l = [g("input", null, i).outerHTML];
                            return r.first && n.push(o(r.first)), r.second && l.push(" ", o(r.second)), r.content && l.push(r.content), l = g("div", l, {
                                className: "input-wrap"
                            }).outerHTML, g("div", n.concat(l), {
                        ...
                        se = e => {
                            ...
                            return t += b.input({
                                ...
                                type: "hidden",
                                className: "btn-style"
                            }).outerHTML, t += '<div class="btn-group" role="group">', we.btn.forEach((r => {
                                const o = ["btn-xs", "btn", `btn-${r}`];
                                e === r && o.push("selected");
                                const i = g("button", h().get(`styles.btn.${r}`), {
                                    value: r,
                                    type: "button",
                                    className: o.join(" ")
                                }).outerHTML;
                        ...
                        de = (e, t) => {
                            const {
                                class: r,
                                className: o
                            } = t, i = et(t, Ye), n = Number.isNaN(i[e]) ? void 0 : i[e], l = h().get(e) || e, a = {
                                type: "number",
                                value: n,
                                name: e,
                                ...
                                id: `${e}-${s.lastID}`
                            }, d = b.input(T(a)).outerHTML;
                            return g("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${d}</div>`], {
                                className: `form-group ${e}-wrap`
                            }).outerHTML
                        },
                        fe = function(e, t, r, o) {
                            ...
                            const i = r.map(((r, o) => {
                                    ...
                                    return r.value === t[e] && (i.selected = !0), i = T(i), g("option", i.label, i)
                                })),
                                l = {
                                    id: e + "-" + s.lastID,
                                    name: e,
                            ...
                            return g("div", [d, f], {
                                className: `form-group ${l.name}-wrap`,
                        ...
                        ue = function(t, r, o) {
                            ...
                            let i = r[t] || "",
                                n = h().get(t) || t;
                            "label" === t && (["paragraph"].includes(r.type) ? n = h().get("content") : i = V(i));
                            ...
                            if (![].some((e => !0 === e))) {
                                ...
                                "label" !== t || e.disableHTMLLabels ? "textarea" === r.type && "value" === t ? a += g("textarea", i, d).outerHTML : (d.value = i, d.type = "text", a += `<input ${L(d)}>`) : (d.contenteditable = !0, a += g("div", i, d).outerHTML);
                                const f = `<div class="input-wrap">${a}</div>`;
                                let u = o ? "none" : "block";
                                "value" === t && (u = r.subtype && "quill" === r.subtype && "none"), a = g("div", [c, f], {
                        ...
                        me = function(t, r) {
                            ...
                            const a = t.type || "text";
                            let c = t.label || (r ? n[a] || h().get("label") : "");
                            var f;
                            ...
                            let p = [g("a", null, {
                                type: "remove",
                                id: "del_" + s.lastID,
                                className: `del-button btn ${ot}cancel delete-confirm`,
                                title: h().get("removeMessage")
                            }), g("a", null, {
                                type: "edit",
                                id: s.lastID + "-edit",
                                className: `toggle-form btn ${ot}pencil`,
                                title: h().get("hide")
                            }), g("a", null, {
                                type: "copy",
                                id: s.lastID + "-copy",
                                className: `copy-button btn ${ot}copy`,
                                title: h().get("copyButtonTooltip")
                            })];
                            D() ? p.push(g("a", null, {
                                type: "grid",
                                id: s.lastID + "-grid",
                                className: `grid-button btn ${ot}grid`,
                                title: "Grid Mode"
                            })) : p.push(g("a", null, {
                                type: "sort",
                                id: s.lastID + "-sort-higher",
                                className: `sort-button sort-button-higher btn ${ot}sort-higher`,
                                title: "Move Higher"
                            }), g("a", null, {
                                type: "sort",
                                id: s.lastID + "-sort-lower",
                                className: `sort-button sort-button-lower btn ${ot}sort-lower`,
                                title: "Move Lower"
                            ...
                            m.push(y);
                            const x = g("div", [G(t), g("a", h().get("close"), {
                            ...
                            const O = g("li", m, {
                                ...
                                j = o(O);
                            let T;
                            if (be(j), j.data("fieldData", {
                                    attrs: t
                                }), void 0 !== b.stopIndex ? o(d.stage).children().eq(b.stopIndex).before(j) : A.append(j), o(".sortable-options", j).sortable({
                                    update: () => b.updatePreview(j)
                                }), b.updatePreview(j), D()) {
                                const t = `div.row-${l.rowUniqueId}`;
                                let r = !1;
                                A.children(t).length ? T = A.children(t) : (T = g("div", null, {
                                    id: `${O.id}-row`,
                                    className: `row row-${l.rowUniqueId} ${it}`
                                }), r = !0), E && S && (k.attr("id", T.id), k.attr("class", T.className), k.attr("style", ""), k.attr("data-row-id", l.rowUniqueId), T = k);
                                const i = g("div", null, {
                                    id: `${O.id}-cont`,
                                    className: `${l.columnSize} ${nt}`
                                });
                                E && N && ("true" === k.attr("prepend") ? o(i).prependTo(T) : o(i).insertAfter(`#${k.attr("appendAfter")}`)), N || o(i).appendTo(T), !E && r && j.after(T), j.appendTo(i), r && (Ae(T), ge(), ve(T), e.enableColumnInsertMenu && (o(T).off("mouseenter"), o(T).on("mouseenter", (function(e) {
                                    ke(o(e.currentTarget))
                                })), o(T).off("mouseleave"), o(T).on("mouseleave", (function(e) {
                                    Ee(o(e.currentTarget))
                                })))), ke(T, !0), l.addedDefaultColumnClass && j.attr("addedDefaultColumnClass", !0), b.tmpCleanPrevHolder(o(y))
                            }
                            e.typeUserEvents[a] && e.typeUserEvents[a].onadd ? e.typeUserEvents[a].onadd(O) : e.typeUserEvents["*"] && e.typeUserEvents["*"].onadd && e.typeUserEvents["*"].onadd(O), r && (e.editOnAdd && (b.closeAllEdit(), b.toggleEdit(s.lastID, !1)), O.scrollIntoView && e.scrollToFieldOnAdd && O.scrollIntoView({
                                behavior: "smooth"
                            })), D() && E && N && Be(T, !0), E = !1, S = !1, N = !1
                        };

                    function be(e) {
                        D() && e.mouseenter((function(e) {
                            Me || (Le = o(this), Re = e.pageX, Ie = e.pageY)
                        }))
                    }

                    function ge() {
                        A.find(ct + ":not(:last-child)").css("height", "1px").addClass(at)
                    }

                    function ve(e) {
                        const t = o(e).clone();
                        if (t.addClass(at).addClass(lt).html(""), t.css("height", "1px"), t.attr("class", t.attr("class").replace("row-", "")), t.removeAttr("id"), 0 === o(e).index()) {
                            const e = o(t).clone();
                            A.prepend(e), Ae(e)
                        }
                        t.insertAfter(o(e)), Ae(t), A.find(st + ":last-of-type").removeClass(at)
                    }

                    function ye() {
                        A.children(ct).remove(), A.children(st).each(((e, t) => {
                            ve(o(t))
                        })), A.find(st + ":last-of-type").removeClass(at)
                    }
                    ...
                    function Ae(e) {
                        ...
                        o(e).sortable({
                            ...
                            over: function(e) {
                                const t = o(e.target),
                                    r = t.hasClass(lt);
                                r || je(t), t.addClass("hoverDropStyleInverse"), r || (ge(), t.prev(ct).removeClass(at).css("height", "40px"), t.next(ct).removeClass(at).css("height", "40px"))
                            },
                            out: function(e) {
                                A.children(ct).removeClass("hoverDropStyleInverse"), o(e.target).removeClass("hoverDropStyleInverse")
                            },
                            placeholder: "hoverDropStyleInverse",
                            receive: function(e, t) {
                                const r = o(t.sender).attr("id") === C.attr("id"),
                                    i = o(t.item).parent().hasClass(lt),
                                    n = !i && o(t.item).parent().hasClass(it);
                                if (i)
                                    if (r) S = !0, E = !0, k = o(t.item).parent();
                                    else {
                                        const e = o(t.item),
                                            r = Se({}),
                                            i = g("div", null, {
                                                id: `${e.find("li").attr("id")}-row`,
                                                className: `row row-${r.rowUniqueId} ${it}`
                                            });
                                        o(t.item).parent().replaceWith(i), be(o(t.item)), e.appendTo(i), Ae(i), Fe(e.attr("id"))
                                    } if (n && r) {
                                    ...
                                    k.addClass(e), N = !0, E = !0, b.stopIndex = void 0
                                }
                                E && (b.doCancel = !0, R(t.item), b.save.call(b)), He(), ye();
                                const l = o(t.item).find("li");
                                l.length && (Ce(l), Oe(l), b.tmpCleanPrevHolder(o(t.item).find(".prev-holder")))
                            },
                            start: (e, t) => {
                                A.addClass("__preventColButtons"), je(t.item.closest(st))
                            },
                            stop: (e, t) => {
                                A.removeClass("__preventColButtons"), A.children(ct).removeClass("hoverDropStyleInverse"), Be(t.item.closest(st), !0)
                            },
                            update: (e, t) => {
                                Fe(t.item.attr("id"))
                            }
                    ...
                    function ke(t, r) {
                        if (void 0 === r && (r = !1), !e.enableColumnInsertMenu || A.hasClass("__preventColButtons")) return;
                        o(t).children("button.btnAddControl").remove();
                        const i = o(t).children(dt);
                        i.each(((e, t) => {
                            const n = o(t);
                            n.addClass("colWithInsertButtons"), 0 === i.index(n) && o(`<button type="button" class="formbuilder-icon-plus btnAddControl ${b.getRowClass(n.parent().attr("class"))}" prepend="true" style='visibility: ${r?"hidden":"visible"}'></button>`).insertBefore(n), o(`<button type="button" class="formbuilder-icon-plus btnAddControl ${b.getRowClass(n.parent().attr("class"))}" appendAfter="${n.attr("id")}" style='visibility: ${r?"hidden":"visible"}'></button>`).insertAfter(n)
                        }))
                    }

                    function je(e) {
                        e.find("button.btnAddControl").remove(), e.find(dt).removeClass("colWithInsertButtons")
                    }
                    ...
                    function Se(t) {
                        ...
                        if (!r.rowUniqueId) {
                            if (E && N) r.rowUniqueId = b.getRowValue(k.attr("class"));
                            else {
                                let e;
                                if (0 === f.length) e = 1;
                                else {
                    ...
                    const Te = function(e, t, r) {
                            const o = {
                                ...
                                i = {
                                    boolean: (t, r) => {
                                        ...
                                        return t && (i.checked = !!t), i.name = e, ["input", null, i]
                                    },
                                    number: e => ["input", null, {
                                        value: e,
                                        type: "number"
                            ...
                            const n = Object.entries(t).map((e => {
                                    ...
                                    return a["data-attr"] = t, a.className = a.className ? `${a.className} ${s}` : s, g(n, l, a)
                                })),
                                l = {
                                    className: `remove btn ${ot}cancel`,
                                    title: h().get("removeMessage")
                                };
                            return n.push(g("a", null, l)), g("li", n).outerHTML
                        },
                        De = [".form-elements input", ".form-elements select", ".form-elements textarea"].join(", ");
                    A.on("change blur keyup click", De, r()((e => {
                        if (e) {
                            if ([e => {
                                    let {
                                        type: t,
                        ...
                        const r = o(t.target).parents(".form-field:eq(0)"),
                            i = r[0],
                            n = i.getAttribute("type"),
                            l = o(t.target.parentElement);
                        t.preventDefault(), i.querySelector(".sortable-options").childNodes.length <= 2 && !n.includes("checkbox") ? e.notify.error("Error: " + h().get("minOptionMessage")) : l.slideUp("250", (() => {
                            l.remove(), Oe(r)
                        }))
                        ...
                        O(o, V(r), c.opts.disableHTMLLabels)
                    })), A.on("keyup", "input.error", (e => {
                        let {
                            target: t
                        } = e;
                        ...
                        const t = o(e.target).parents(".form-field:eq(0)"),
                            ...
                            i = o(e.target).val();
                        if ("" !== i)
                            if (r.length) r.attr("tooltip", i).css("display", "inline-block");
                            else {
                                const e = `<span class="tooltip-element" tooltip="${i}">?</span>`;
                        ...
                        e.target.value = ne(e.target.value), "" === e.target.value ? o(e.target).addClass("field-error").attr("placeholder", h().get("cannotBeEmpty")) : o(e.target).removeClass("field-error")
                    })), A.on("blur", "input.fld-maxlength", (e => {
                        e.target.value = le(e.target.value)
                    })), A.on("click touchstart", ".btnAddControl", (function(e) {
                        const t = o(e.currentTarget);
                        j = C.clone(), j.hover((function() {}), (function() {
                            j.remove()
                        })), j.on("click", "li", (e => {
                            let {
                                target: r
                            ...
                            N = !0, E = !0, k = t;
                            const i = o(r).closest("li");
                            b.stopIndex = void 0, R(i), b.save.call(b), j.remove()
                        })), A.append(j), 0 == t.index() ? j.css({
                            position: "fixed",
                            left: t.offset().left,
                        ...
                        const r = j.offset().top + j.outerHeight(),
                            i = o(window).scrollTop() + o(window).innerHeight();
                        r > i && j.css({
                            top: parseInt(j.css("top")) - (r - i)
                        })
                    })), A.on("click", `.${ot}copy`, (function(t) {
                        t.preventDefault();
                        const r = o(t.target).parent().parent("li"),
                            i = function(t) {
                                ...
                                const r = t.attr("id"),
                                    ...
                                    l = t.clone();
                                return o(".fld-name", l).val(n), l.find("[id]").each(((e, t) => {
                                ...
                                })), l.attr("id", s.lastID), l.attr("name", n), l.addClass("cloned"), o(".sortable-options", l).sortable(), e.typeUserEvents[i] && e.typeUserEvents[i].onclone ? e.typeUserEvents[i].onclone(l[0]) : e.typeUserEvents["*"] && e.typeUserEvents["*"].onclone && e.typeUserEvents["*"].onclone(l[0]), l
                            }(r);
                        D() ? function(e, t) {
                            const r = o(`#className-${t.attr("id")}`),
                                ...
                                n = g("div", null, {
                                    id: `${e.attr("id")}-row`,
                                    className: `row row-${i.rowUniqueId} ${it}`
                                }),
                                l = g("div", null, {
                                    id: `${e.attr("id")}-cont`,
                                    className: `${b.getBootstrapColumnClass(r.val())} ${nt}`
                                });
                            let a;
                            o(l).appendTo(n), t.parent().is("div") ? a = t.closest(st) : t.parent().is("ul") && (a = t), o(n).insertAfter(a), e.appendTo(l), Ae(n), ye(), Fe(e.attr("id"))
                        }(i, r) : i.insertAfter(r), Oe(i), b.tmpCleanPrevHolder(i.find(".prev-holder")), e.editOnAdd && b.closeField(s.lastID, !1)
                    })), D() && A.on("stageEmptied", (() => {
                        f = []
                        ...
                        if (document.addEventListener("modalClosed", (function() {
                            ...
                            b.confirm([e, t], (() => b.removeField(l)), n), a.addClass("deleting")
                    ...
                    function Be(e, t) {
                        void 0 === t && (t = !1);
                        const r = e.children(`div${dt}`).length,
                            i = Math.floor(12 / r);
                        e.children(`div${dt}`).each(((e, r) => {
                            const n = o(`#${r.id}`);
                            t || "true" != n.find("li").attr("manuallyChangedDefaultColumnClass") ? b.syncBootstrapColumnWrapperAndClassProperty(r.id.replace("-cont", ""), i) : b.showToast(`Preserving column size of field ${e+1} because you had personally adjusted it`, 4e3)
                        }))
                    }
                    ...
                    function Fe(e) {
                        if (e) {
                            ...
                            if (t.val()) {
                                const e = b.getRowClass(t.val()),
                                    r = b.getRowClass(t.closest(st).attr("class"));
                                t.val(t.val().replace(e, r)), He()
                            }
                        }
                    }
                    ...
                    function He() {
                        A.find(dt).each(((e, t) => {
                            const r = o(t);
                            r.is(":empty") && !i.preserveTempContainers.includes(r.attr("id")) && r.remove()
                        })), A.children(st).not(ct).each(((e, t) => {
                            if (0 === o(t).children(dt).length) {
                    ...
                    function qe(e) {
                        if (void 0 === e && (e = !0), e) Me = !0, b.showToast("Starting Grid Mode - Use the mousewheel to resize.", 1500), C.css("display", "none"), o(d.formActions).css("display", "none"), o(U).html("\n    <div style='padding:5px'>\n      <h3 class=\"text text-center\">Grid Mode</h3>    \n      \n      <table style='border-spacing:7px;border-collapse: separate'>\n        <thead>\n          <tr>\n            <th>Action</th>\n            <th>Result</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr>\n            <td><kbd>MOUSEWHEEL</kbd></td>\n            <td>Adjust the field column size</td>\n          </tr>    \n          <tr>\n            <td><kbd>W or &#x2191;</kbd></td> \n            <td>Move entire row up</td>\n          </tr>\n          <tr>\n              <td><kbd>S or &#x2193;</kbd></td> \n              <td>Move entire row down</td>\n          </tr>\n          <tr>\n              <td><kbd>A or &#x2190;</kbd></td>\n              <td>Move field left within the row</td>\n          </tr>\n          <tr>\n              <td><kbd>D or &#x2192;</kbd></td> \n              <td>Move field right within the row</td>\n          </tr>\n          <tr>\n            <td><kbd>R</kbd></td> \n            <td>Resize all fields within the row to be maximally equal</td>\n          </tr>\n          <tr>\n        </tbody> \n      </table>\n\n      <h5 class=\"text text-center\" style='padding-top:10px'>Current Row Fields</h5>    \n      \n      <table class='gridHelpCurrentRow'>\n        <colgroup>\n          <col width=\"100%\" />\n          <col width=\"0%\" />\n        </colgroup>\n        \n        <thead>\n          <tr>\n            <th>Field</th>\n            <th>Size</th>\n          </tr>\n        </thead>\n\n        <tbody>\n        </tbody> \n      </table>\n      \n    </div>\n    "), ze(), b.closeAllEdit(), b.toggleHighlight(Le), ge();
                        else {
                            b.showToast("Grid Mode Finished", 1500);
                            const e = Le.closest(st);
                            let t = 0;
                            e.children(`div${dt}`).each(((e, r) => {
                                const i = o(`#${r.id}`).find("li").attr("id");
                                t += b.getBootstrapColumnValue(o(`#${i}-cont`).attr("class"))
                            })), t > 12 && Be(e, !0), Me = !1, Le = null, o(U).empty(), C.css("display", "unset"), o(d.formActions).css("display", "unset")
                        }
                    }

                    function ze() {
                        o(U).find(".gridHelpCurrentRow tbody").empty(), Le.closest(st).children(`div${dt}`).each(((e, t) => {
                            const r = o(`#${t.id}`).find("li").attr("id"),
                                i = o(`#${r}`),
                                n = i.attr("type");
                            let l = o(`#label-${r}`).html();
                            "hidden" !== n && "paragraph" !== n || (l = o(`#name-${r}`).val()), l || (l = i.attr("id"));
                            let a = "";
                            Le.attr("id") === r && (a = "currentGridModeFieldHighlight"), o(U).find(".gridHelpCurrentRow tbody").append(`\n        <tr>\n          <td class='grid-mode-help-row1 ${a}'>${l}</td>\n          <td class='grid-mode-help-row2 ${a}'>\n            ${b.getBootstrapColumnValue(o(`#${r}-cont`).attr("class"))}\n          </td>\n        <tr>\n      `)
                        }))
                    }
                    if (A.on("click touchstart", ".grid-button", (e => {
                            e.preventDefault();
                            const t = o(e.target).parents(".form-field:eq(0)").attr("id");
                            Le = o(document.getElementById(t)), Re = e.pageX, Ie = e.pageY, Pe = 0, qe()
                        })), A.on("wheel", (function(e) {
                            if (0 !== e.originalEvent.deltaY && Me) {
                                e.preventDefault(), Pe += e.originalEvent.deltaY;
                                const t = 120;
                                if (Pe > 0 && Pe < t || Pe < 0 && Pe > -t) return;
                                const r = Le.closest("div"),
                                    i = b.getBootstrapColumnValue(r.attr("class")),
                                    n = Math.round(Pe / t);
                                Pe %= t;
                                const l = i + n;
                                ...
                                const a = Le.closest(st);
                                let s = l;
                                if (a.children(`div${dt}`).each(((e, t) => {
                                        const r = o(`#${t.id}`).find("li").attr("id");
                                        r != Le.attr("id") && (s += b.getBootstrapColumnValue(o(`#${r}-cont`).attr("class")))
                                    })), s > 12) return void b.showToast('<b class="formbuilder-required">There is a maximum of 12 columns per row</b>');
                                b.syncBootstrapColumnWrapperAndClassProperty(Le.attr("id"), l), Le.attr("manuallyChangedDefaultColumnClass", !0), ze(), b.toggleHighlight(Le)
                            }
                        })), o(document).keydown((e => {
                            if (Me) {
                                e.preventDefault();
                                const t = Le.closest(st);
                                switch (event.code) {
                                    case "KeyW":
                                    case "ArrowUp":
                                        je(t),
                                            function(e) {
                                                const t = e.prevAll().not(ct).not(".form-prepend").first();
                                    ...
                                    case "ArrowDown":
                                        je(t),
                                            function(e) {
                                                const t = e.nextAll().not(ft).not(".form-append").first();
                                                t.length && (o(Le.parent().parent()).swapWith(t), b.toggleHighlight(Le))
                                            }(t);
                                        break;
                                    case "KeyA":
                            ...
                            Me && b.getDistanceBetweenPoints(Re, Ie, e.pageX, e.pageY) > c.opts.cancelGridModeDistance && qe(!1)
                            ...
                            let r;
                            o(e.target).hasClass("sort-button-higher") ? (r = t.prev("li"), r.length && !r.hasClass("form-prepend") && t.insertBefore(r)) : (r = t.next("li"), r.length && !r.hasClass("form-append") && t.insertAfter(r)), b.toggleHighlight(t)
                        })), A.on("click", ".style-wrap button", (e => {
                            const t = o(e.target),
                                r = t.closest(".form-elements"),
                                i = t.val(),
                                n = o(".btn-style", r);
                            n.val(i), t.siblings(".btn").removeClass("selected"), t.addClass("selected"), Oe(n.closest(".form-field"))
                            ...
                            const t = o(e.target).closest(".form-field").attr("type"),
                                ...
                                i = o('[name="multiple"]', r),
                                n = o(".option-selected:eq(0)", r),
                                l = i.length ? i.prop("checked") : "checkbox" === n.attr("type"),
                                a = o(".sortable-options", r),
                                s = c.opts.onAddOption({
                                    selected: !1,
                                    label: "",
                                    value: ""
                                }, {
                            ...
                            a.append(Te(n.attr("name"), s, l))
                        })), A.on("mouseover mouseout", ".remove, .del-button", (e => o(e.target).closest("li").toggleClass("delete"))), $(), !0 === e.disableInjectedStyle) {
                    ...
                    return document.dispatchEvent(v.loaded), i.actions = {
                        getFieldTypes: t => t ? ae(y.getRegistered(), e.disableFields) : y.getRegistered(),
                        ...
                        setLang: e => h().setCurrent.call(h(), e).then((() => {
                            d.stage.dataset.content = h().get("getStarted"), y.init(), d.empty(d.formActions), b.formActionButtons().forEach((e => d.formActions.appendChild(e)))
                        })),
                ...
                const mt = function(e, t) {
                    const r = this,
                        o = jQuery.extend({}, ve, e, !0),
                        {
                            i18n: i
                        } = o,
                        n = et(o, _e);
                    this.i18nOpts = jQuery.extend({}, ye, i, !0);
                    const l = () => {
                ...
                jQuery.fn.formBuilder = function(e) {
                    if (void 0 === e && (e = {}), "string" != typeof e) {
                        const t = new mt(e, this);
                        return this.data("fbInstance", t.instance), t.instance
                    } {
                        const i = this.data("fbInstance");
                        if (i[e]) {
                            if ("function" == typeof i[e]) {
                                for (var t = arguments.length, r = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) r[o - 1] = arguments[o];
                                return i[e].apply(this, r)
                            }
                            return i[e]
                        }
                    }
