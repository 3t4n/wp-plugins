<?php
/**
 * Custom rest api controller to print edd addons.
 *
...
class EDDMAA_REST_Controller extends WP_REST_Controller {

	/**
	 * Register custom rest route for the addons.
	 *
	 * @return void
	 */
	...
	/**
	 * Retrieve the addons from the db.
	 *
