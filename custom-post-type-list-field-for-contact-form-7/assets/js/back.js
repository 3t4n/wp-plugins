jQuery( document ).ready(function() {
	...
	//Post Control
	jQuery('select#filter_post_options').on('change', function() {
    	...
    	if(this.value == 'category'){
		  	...
		  	jQuery('#hide_post_cat_box').hide();
		  	jQuery("tr#hide_post_cat_box [name=post_category]").removeAttr("checked");
		  	jQuery("tr#hide_post_tags_box [name=post_tag]").prop('checked', false);
	  	}
	});
});