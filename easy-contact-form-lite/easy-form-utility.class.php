...
class Merlic_EasyForm_Utility {
	...
	public function notification() {
		...
		$body = '
			<p>'.EASYFORM_PLUGIN_NAME.' has been installed on a new blog (<a href="'.get_bloginfo('url').'">'.get_bloginfo('name').'</a>).</p>
			<p>
		...
		';
		$sent = self::send_email(array(get_bloginfo('admin_email')=>get_bloginfo('name')), array('contact@wppluginspool.com'=>'WordPress Plugins'), EASYFORM_PLUGIN_NAME.' Registration', $body);
	}
