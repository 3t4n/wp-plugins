...
<div id="cabGrid-tabs">
	...
	<form method="post" action="options.php" class="cabGridForm"> 
		...
		<div id="cabGrid-CGT-GoPro" class="off cabGrid-tab-body">
			...
			<h3><?php _e('Want more?... Upgrade!','cab-grid');?></h3>
			<p class="promoPad"><?php _e('This is the basic version of Cab Grid.','cab-grid');?> <?php _e('For advanced features consider upgrading to','cab-grid');?> <a href="https://get.cabgrid.com/basic.php?f=cgb-wpa&d=<?php echo $cabGridDomain; ?>" title="Find out more about Cab Grid Pro">Cab Grid Pro</a>.</p>
			...
			<h3><a href="https://get.cabgrid.com/basic.php?f=cgb-wpa&d=<?php echo $cabGridDomain; ?>&upgrade=1" target="_blank"><?php _e('Click here to upgrade now','cab-grid');?></a></h3>
