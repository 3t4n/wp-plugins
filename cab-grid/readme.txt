=== Cab Grid ===
Contributors: nimusdigital
Tags: taxi fare calculator,price calculator,taxi,taxi booking,airport transfer
...
For more details and screenshots, see [cabgrid.com](https://cabgrid.com)
...
== Changelog ==
1.6.26 	Update CabGrid.com links to https
1.6.25 	WP 6.7.2 compatibility
1.6.24	Further improvements to CabGrid Pro compatibility tests
1.6.23	Improve CabGrid Pro compatibility tests
1.6.22 	Improve code sanitization.
		Message field allows simple HTML tags
		Styling update to prevent overlap on smaller screen
1.6.21 	WP 6.7.1 compatibility
1.6.20 	WP 6.7 compatibility
1.6.19 	WP 6.6.2 compatibility
1.6.18 	WP 6.6.1 compatibility
1.6.17 	WP 6.6 compatibility
1.6.16 	WP 6.5.5 compatibility
1.6.15 	WP 6.5.4 compatibility
1.6.14 	WP 6.5.3 compatibility
1.6.13	Adjusted version references to avoid error notification when PHP warnings enabled
1.6.12	Adjusted style loading. 
		Changed load animation to opacity (from visibility)
1.6.11	WP 6.5.2 compatibility
1.6.10	WP 6.5 compatibility
