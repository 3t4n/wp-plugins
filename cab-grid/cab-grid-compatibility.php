...
$cabGridProURI="";	//"https://cabgrid.com/tests/";
if(isset($_GET['cabGridProURI'])){
	...
	$url="https://cabgrid.com/curltest.php";
		...
		// Catching the exception and outputting its message
		echo "<br />".__("An error occurred:","cab-grid")." ".$e->getMessage();
		$pass=0;
	} catch (Error $err) {
		// Catching fatal errors
		echo "<br />".__("A fatal error occurred:","cab-grid")." ".$err->getMessage();
		$pass=0;
	}	
