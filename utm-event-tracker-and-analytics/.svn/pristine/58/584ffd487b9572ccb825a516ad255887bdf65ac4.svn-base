...
$dismiss_cache_notice = get_option('utm_event_tracker_dismiss_cache_notice') == 'yes'; ?>
...
<div id="utm-overview-container" class="wrap wrap-utm-event-tracker" data-settings='<?php echo wp_json_encode($overview_settings); ?>'>
	...
	<?php if (!$dismiss_cache_notice) : ?>
		<div class="cache-notice">
			<h3><?php esc_html_e('Warning', 'utm-event-tracker') ?></h3>
			<ul class="cache-notice-list">
				<li>If you use cache plugin please exclude this 'wordpress_utm_event_tracker_session' cookie.</li>
				<li>If your site is hosted on <strong>WP Engine</strong>, you must tell the support to allow this cookie 'wordpress_utm_event_tracker_session'.</li>
				<li>If you are using the <strong>nitropack</strong> plugin for cache, please exclude this cookie 'wordpress_utm_event_tracker_session' in app settings. <a target="_blank" href="https://ps.w.org/utm-event-tracker-and-analytics/assets/guideline-nitropack.png">see guideline</a></li>
				<li>If you are still facing issues, please open a ticket <a target="_blank" href="https://wordpress.org/support/plugin/utm-event-tracker-and-analytics/">here</a>.</li>
			</ul>

			<a class="button button-dismiss-notice" href="#" data-nonce="<?php echo esc_attr(wp_create_nonce('utm_event_tracker/dismiss_cache_notice_nonce')) ?>"><?php esc_html_e('Dismiss this notice', 'utm-event-tracker') ?></a>
		</div>
	<?php endif; ?>
