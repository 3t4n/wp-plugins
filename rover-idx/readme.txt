...
* Fix for sitemaps on multisite installations

= 3.0.0.2909 =

* Fix php error caused by 3.0.0.2908 update

= 3.0.0.2908 =

* Fix rocket_preload_exclude_urls usage
* Create sitemap index file

= 3.0.0.2907 =

* Completed WordPress 6.7.1 testing
