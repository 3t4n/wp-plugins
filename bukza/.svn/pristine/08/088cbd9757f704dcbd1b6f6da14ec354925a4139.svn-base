...
Tags: reservation, rental, booking, calendar, availability
...
[Bukza iOS](https://itunes.apple.com/us/app/bukza/id1318802236 "App Store link")
[Bukza Android](https://play.google.com/store/apps/details?id=com.bukza.workspace "Google Play link")
...
*  [https://bukza.com/news/wordpress](https://bukza.com/news/wordpress "Bukza WordPress")

Frequently Asked Questions:

*  [https://bukza.com/questions](https://bukza.com/questions "Bukza FAQ")

== Screenshots ==

1. **Online reservation calendar**
2. **Slots**
3. **Table of reservations**
4. **Calendar of reservations**
5. **Order view**
6. **Creating a reservation**
7. **Dashboard**
8. **Flexible resource settings**
9. **Widget settings**
10. **Triggers**
...
= 2.0.1 =
* In this version we fixed Bukza WordPress shortcode XSS vulnerability.
