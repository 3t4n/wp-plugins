...
class Admin
{
    ...
    */
    ...
    {
        add_menu_page('Generic Elements', 'Generic Elements', 'administrator', 'generic-elements-admin', array($this, 'generic_el_landing_page'), 'dashicons-tickets', 6);
        add_submenu_page('generic-elements-admin', __('Settings', 'generic-elements'), __('Settings', 'generic-elements'), 'manage_options', 'generic-elements-settings', array($this, 'generic_el_settings_page'));
        add_submenu_page('generic-elements-admin', __('Generic Templates', 'generic-elements'), __('Generic Templates', 'generic-elements'), 'manage_options', 'edit.php?post_type=generic_el_template');
        add_submenu_page('generic-elements-admin', __('Add Template', 'generic-elements'), __('Add Template', 'generic-elements'), 'manage_options', 'post-new.php?post_type=generic_el_template');
    }

    /**
    * Options Settings
    */
    public function generic_el_options()
    {
        //register options settings
        register_setting( 'generic-elements-settings-group', 'generic_gsap_enable_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_bootstrap_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_fontawesome_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_magnific_popup_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_odometer_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_appear_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_waypoints_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_animate_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_wow_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_swiper_option' );
	    register_setting( 'generic-elements-settings-group', 'generic_meanmenu_option' );
    }
    ...
    */
    public static function count_posts($type = 'generic_el_template', $perm = '')
    {
     ...
     /*
    * Generic Elements landing page
    */

    public function generic_el_landing_page()
    {
        $all_active_class = '';
        ...
        $total_page = 1;
        $pagination_current_url = admin_url('admin.php?page=generic-elements-settings');
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'generic-elements-settings') {
        ...
        $tabs_titles = apply_filters('generic_elements_admin_landing_tabs', array(
            [
                'title' => __('Welcome', 'generic-elements'),
                'icon' => 'magic-wand.svg',
                'file' => 'welcome-tpl'
            ],
            [
                'title' => __('Widgets', 'generic-elements'),
                'icon' => 'database.svg',
                'file' => 'review-widgets-tpl'
            ],
            [
                'title' => __('Get Premium', 'generic-elements'),
                'icon' => 'database.svg',
                'file' => 'get-premium-tpl'
            ]
        ));
        include_once GENERIC_ELEMENTS_TEMPLATES . '/landing.php';
    }

    /*
    * Generic Elements page status
    */
    public function generic_el_admin_page()
    {
        $all_active_class = '';
        $enabled_active_class = '';
        $disabled_active_class = '';
    ...
    /*
    * Generic Elements settings page
    */
    public function generic_el_settings_page()
    {
        $all_active_class = '';
        $enabled_active_class = '';
        $disabled_active_class = '';
        ...
        $tabs_titles = apply_filters('generic_elements_admin_settings_tabs', array(
            [
                'title' => __('General', 'generic-elements'),
                'icon' => 'magic-wand.svg',
                'file' => 'general-setting-tpl'
            ],
            [
                'title' => __('Features', 'generic-elements'),
                'icon' => 'database.svg',
                'file' => 'features-setting-tpl'
            ]
        ));
        include_once GENERIC_ELEMENTS_TEMPLATES . '/settings.php';
    }
