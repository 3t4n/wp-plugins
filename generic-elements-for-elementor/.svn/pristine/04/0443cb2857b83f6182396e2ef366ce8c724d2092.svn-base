...
class GenericHeading extends GenericWidget
{
    ...
    protected function heading_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('Type your title here', 'generic-elements'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => '',
                'placeholder' => esc_html__('Type your subtitle here', 'generic-elements'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => '',
                'placeholder' => esc_html__('Type your desciption here', 'generic-elements'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'gen_extra_class',
            [
                'label' => esc_html__('Wrapper Class', 'generic-elements'),
        ...
        $this->add_control(
            'gen_title_class',
            [
                'label' => esc_html__('Title Class', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('Type your css class name', 'generic-elements'),
                'dynamic' => [
        ...
        $this->add_control(
            'gen_subtitle_class',
            [
                'label' => esc_html__('Subtitle Class', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('Type your css class name', 'generic-elements'),
                'dynamic' => [
    ...
    protected function heading_content_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .generic-el-subtitle' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .generic-el-subtitle' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $gen_subtitle_class = $settings['gen_subtitle_class'];
        $gen_title_class = $settings['gen_title_class'];
        $title = wp_kses_post($settings['title']);
        $this->add_inline_editing_attributes('title', 'basic');
        $this->add_render_attribute('title', 'class', $gen_title_class . ' generic-el-title');
        ...
        <div class="generice-el-wrapper <?php echo esc_attr($gen_extra_class); ?>">
            <div class="bdevs-generic-el generic_el_heading generic-el-content">
                <?php if ($settings['sub_title']) : ?>
                    <span class="sub_title generic-el-subtitle <?php echo esc_attr($gen_subtitle_class); ?>">
