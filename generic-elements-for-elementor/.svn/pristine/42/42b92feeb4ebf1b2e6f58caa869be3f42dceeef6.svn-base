...
class Team extends GenericWidget
{
    ...
    {
        return esc_html__('Generic Team', 'generic-elements');
    }
        ...
        <section class="bdevs-generic-el bd-team-area">
            <div class="container">
                <?php if ($show_slider == 'yes') : ?>
                    <div class="bd-team-active swiper" autoplay-speed="<?php echo esc_attr($ts_slider_speed); ?>" autoplay_stop="<?php echo esc_attr($auto_nav_slide); ?>">
