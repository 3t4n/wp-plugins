...
class PostList extends GenericWidget
{
    ...
    {
        return esc_html__('Generic Post List', 'generic-elements');
    }
    ...
    public function blog_list()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Blog Wrapper', 'generic-elements'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    {
        $this->start_controls_section(
            '_section_post_content_style',
            [
                'label' => esc_html__('Blog Content', 'generic-elements'),
                'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    public function blog_meta()
    {
        ...
        $this->add_control(
            'hide_top_meta',
            [
                'label' => esc_html__('Show Top Meta', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'generic-elements'),
                'label_off' => esc_html__('Hide', 'generic-elements'),
                'return_value' => 'yes',
    ...
    public function blog_author()
    {
        ...
        $this->add_control(
            'hide_bottom_meta',
            [
                'label' => esc_html__('Show Bottom Meta', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'generic-elements'),
                'label_off' => esc_html__('Hide', 'generic-elements'),
                'return_value' => 'yes',
    ...
    public function blog_button()
    {
        ...
        $this->add_control(
            'button_icon',
            [
                'label' => esc_html__('Show Icon', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'generic-elements'),
                'label_off' => esc_html__('Hide', 'generic-elements'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:hover, {{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:focus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:hover, {{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:focus' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:hover, {{WRAPPER}} .bdevs-generic-el .gen-default-bd-blog-author-link a:focus' => 'border-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $laptop_column = $settings['laptop_column'];
        ...
        if (!empty($posts)) : ?>
            ...
            <div class="bdevs-generic-el gen-default-blog-area <?php echo esc_attr($gen_extra_class); ?>">
                <div class="row">
                        ...
                        <div class="col-xl-<?php echo esc_attr($desktop_column); ?> col-lg-<?php echo esc_attr($laptop_column); ?> col-md-<?php echo esc_attr($tablet_column); ?> col-<?php echo esc_attr($mobile_column); ?>">
                            <div class="gen-default-bd-blog mb-30">
                                ...
                                <div class="gen-default-bd-blog-text">
                                    <?php if (!empty($settings['hide_top_meta'])) : ?>
                                    ...
                                    <?php if (!empty($settings['hide_bottom_meta'])) : ?>
                                        <div class="gen-default-bd-blog-author">
                                            ...
                                            <div class="gen-default-bd-blog-author-link">
                                                <a href="<?php echo esc_url(get_the_permalink($post->ID)); ?>"><?php print esc_html($button_text ?? ''); ?>
