...
class FunFactor extends GenericWidget
{
	...
	{
		return esc_html__('Generic Fun Factor', 'generic-elements');
	}
...
?>
		...
		<div class="generice-el-wrapper <?php echo esc_attr($gen_extra_class); ?>">
			<div class="generic-el-funfact-wrapper bdevs-generic-el">
				<div class="generic-funfact-content">
					<?php if (!empty($settings['selected_icon'])) : ?>
						<div class="generic-funfact-icon">
							<?php generic_elements_render_icon($settings, 'icon', 'selected_icon', ['class' => 'bdevs-btn-icon']); ?>
						</div>
					<?php else : ?>
					...
					<?php if (!empty($settings['fun_factor_number'])) : ?>
						<h2 class="generic-funfact-number"><span class="odometer" data-count="<?php echo wp_kses_post($settings['fun_factor_data_count']); ?>"> <?php echo wp_kses_post($settings['fun_factor_number']); ?> </span><?php echo wp_kses_post($settings['fun_factor_number_sign']); ?></h2>
					<?php endif; ?>

					<?php if (!empty($settings['fun_factor_title'])) : ?>
						<span class="generic-funfact-title"> <?php echo wp_kses_post($settings['fun_factor_title']); ?> </span>
					<?php endif; ?>
				</div>
			</div>
		</div>
