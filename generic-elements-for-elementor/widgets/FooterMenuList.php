...
class FooterMenuList extends GenericWidget
{
    ...
    {
        return esc_html__('Generic Footer Menu', 'generic-elements');
    }
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors_dictionary' => [
                    'start' => '-webkit-box-pack: start; -ms-flex-pack: start; justify-content: flex-start; text-align: start',
                    'center' => '-webkit-box-pack: center; -ms-flex-pack: center; justify-content: center; text-align: center',
                    'end' => '-webkit-box-pack: end; -ms-flex-pack: end; justify-content: flex-end; text-align: end',
                ],
            ]
        );
