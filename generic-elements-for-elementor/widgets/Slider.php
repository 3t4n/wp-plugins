...
class Slider extends GenericWidget
{
    ...
    {
        return esc_html__('Generic Slider', 'generic-elements');
    }
...
?>
        ...
        <section class="bdevs-generic-el bd-slider-area">
            <div class="bd-slider-active swiper" autoplay-speed="<?php echo esc_attr($ts_slider_speed); ?>" data-swipper_autoplay_stop="<?php echo esc_attr($auto_nav_slide); ?>">
