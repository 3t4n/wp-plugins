...
class NavigationMenu extends GenericWidget
{
    ...
    protected function generic_nav_settings()
    {
        ...
        $this->add_control(
            'generic_el_mobile_bar_image',
            [
                'label'     => esc_html__('Menu Bar Image', 'generic-elements'),
                'type'      => \Elementor\Controls_Manager::MEDIA,
                'dynamic'   => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'generic_el_mobile_close_image',
            [
                'label'     => esc_html__('Menu Bar Close Image', 'generic-elements'),
                'type'      => \Elementor\Controls_Manager::MEDIA,
                'dynamic'   => [
                    'active' => true,
                ],
    ...
    protected function submenu_item_panel_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Panel width', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'devices' => ['desktop'],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Panel background', 'generic-elements'),
                'types' => ['classic', 'gradient'],
                'exclude' => ['image', 'video'],
    ...
    protected function humburger_menu_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sidebar Panel Style', 'generic-elements'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Sidebar Panel width', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'humburger_menu_expand_height',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'humburger_menu_expand_lheight',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} div.mean-container .mean-nav ul li a.mean-expand' => 'line-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function sidebar_contact_info_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'type' => \Elementor\Controls_Manager::HEADING,
                'label' => esc_html__('Sideinfo List', 'generic-elements'),
                'separator' => 'before'
            ]
        );
        ...
        $this->add_responsive_control(
            'sideinfo_contact_list_icon_width',
            [
                'label' => esc_html__('Width', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'sideinfo_contact_list_icon_height',
            [
                'label' => esc_html__('Height', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'sideinfo_contact_list_icon_lheight',
            [
                'label' => esc_html__('Line Height', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i' => 'line-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i',
            ]
        );

        $this->add_responsive_control(
            'sideinfo_contact_list_icon_radius',
            [
                'label' => esc_html__('Border Radius', 'generic-elements'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .generic-el-side-info-contact-wrapper ul li i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if (class_exists('\Generic\Elements\Generic_Navwalker_Class')) {
            $generic_nav_walker_instance = new Generic_Navwalker_Class();
        } else {
            $generic_nav_walker_instance = '';
        }
        ...
        $args = [
            ...
            'container'   => '',
            'walker'      => $generic_nav_walker_instance,
        ];
        ...
        if (!empty($settings['generic_el_mobile_bar_image']['url'])) {
            $generic_el_mobile_bar_image = !empty($settings['generic_el_mobile_bar_image']['id']) ? wp_get_attachment_image_url($settings['generic_el_mobile_bar_image']['id'], 'full') : '';
        }

        if (!empty($settings['generic_el_mobile_close_image']['url'])) {
            $generic_el_mobile_close_image = !empty($settings['generic_el_mobile_close_image']['id']) ? wp_get_attachment_image_url($settings['generic_el_mobile_close_image']['id'], 'full') : '';
        }
            ...
            <div class="generic-container">
                ...
                <div class="side-menu-icon d-xl-none">
                    <button class="side-toggle">
                        <?php if (!empty($generic_el_mobile_bar_image)) : ?>
                            <img src="<?php echo esc_url($generic_el_mobile_bar_image); ?>" alt="<?php esc_attr__('bar-image', 'generic-elements'); ?>" width="100%" height="100%" />
                        <?php else : ?>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-3 text-end">
                            <button class="side-info-close">
                                <?php if (!empty($generic_el_mobile_close_image)) : ?>
                                    <img src="<?php echo esc_url($generic_el_mobile_close_image); ?>" alt="<?php esc_attr__('bar-close-image', 'generic-elements'); ?>" width="100%" height="100%" />
                                <?php else : ?>
