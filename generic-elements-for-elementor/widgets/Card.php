...
class Card extends GenericWidget
{
    ...
    {
        return esc_html__('Generic Card', 'generic-elements');
    }
    ...
    protected function title_description_style_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .generic-el-card-body',
                'exclude' => ['image']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .generic-el-desc' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
