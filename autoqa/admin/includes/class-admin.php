...
class cauto_admin extends cauto_utils
{
    ...
    public function load_assets()
    {
        ...
        wp_register_script('cauto-admin-js', CAUTO_PLUGIN_URL.'admin/assets/admin.min.js', ['jquery'], null );
        wp_enqueue_script('cauto-admin-js');
        wp_enqueue_style('cauto-admin-css', CAUTO_PLUGIN_URL.'admin/assets/admin.min.css' , [], null);
