...
class cauto_runner extends cauto_utils
{
    ...
    public function load_global_assets()
    {
        ...
        if ( $logged_user && current_user_can('administrator') ) {
            wp_register_script('autoqa-runner-global-js', CAUTO_PLUGIN_URL.'assets/onloadrunner.min.js', ['jquery'], null );
            wp_enqueue_script('autoqa-runner-global-js');
            wp_enqueue_style('cauto-runner-global-css', CAUTO_PLUGIN_URL.'assets/runner.min.css' , [], null);
        }
    }
    ...
    public function load_assets()
    {
        ...
        wp_register_script('cauto-runner-js', CAUTO_PLUGIN_URL.'assets/runners/runner.min.js', ['jquery'], null );
        ...
        wp_enqueue_style('cauto-runner-css', CAUTO_PLUGIN_URL.'assets/runner.min.css' , [], null);
