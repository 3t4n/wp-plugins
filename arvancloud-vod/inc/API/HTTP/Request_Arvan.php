...
class Request_Arvan {
    ...
    public static function put(string $endpoint = 'channels/', string $data, string $api_key = null)
    {
    ...
    public static function head(string $endpoint = 'channels/', string $data, string $api_key = null)
    {
