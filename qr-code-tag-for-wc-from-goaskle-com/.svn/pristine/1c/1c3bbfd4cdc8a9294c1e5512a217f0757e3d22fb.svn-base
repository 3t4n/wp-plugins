...
//240225--- positions for qr code in pdf
    if (isset($options['shortcode']['qrcode_goaskle_positions_list']) && $options['shortcode']['qrcode_goaskle_positions_list']){
    	$qrcode_goaskle_positions_list = $options['shortcode']['qrcode_goaskle_positions_list'];
    } else {
...
<!-- 24 02 2025 goaskle.com qr code positions in email $qrcode_goaskle_positions_list-->      
      <tr>
        <td width="100"><?php echo __('Positions list for WC emails', 'qr-code-tag-for-wc-from-goaskle-com'); ?></td>
        <td colspan="3" width="100"><textarea type="text" name="qrct_from_goaskle_com_sc_positions_list" style="width:100%;"><?php echo esc_html($qrcode_goaskle_positions_list); ?></textarea></td>
        <td><?php echo __('<b style="color:red;">Be careful - you need to understand what are you doing to change this option!!!</b> Specify the location you need to display QR codes in woocommerce emails. Single position only. It will use woocommerce_email_footer position by default. Example: <br/>woocommerce_email_footer<br/>woocommerce_email_header<br/>woocommerce_email_order_details<br/>woocommerce_email_before_order_table<br/>woocommerce_order_item_meta_start<br/>woocommerce_order_item_meta_end<br/>woocommerce_email_after_order_table<br/>woocommerce_email_order_meta<br/>woocommerce_email_customer_details', 'qr-code-tag-for-wc-from-goaskle-com'); ?><hr></td>
      </tr>
