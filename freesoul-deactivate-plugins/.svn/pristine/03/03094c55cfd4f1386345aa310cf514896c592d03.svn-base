jQuery(document).ready(function($){
	...
	firstRowTop = table ? document.getElementById('eos-dp-setts').getElementsByTagName('tr')[2].getBoundingClientRect().top : null;
	if(plugsN > 15){
...
function eos_move_table_head(){
	...
	if(table && ('undefined' === typeof(is_single_post) || true !== is_single_post)){
		...
		window.fdp_delta = document.getElementById('eos-dp-setts').getElementsByTagName('tr')[2].getBoundingClientRect().top - firstRowTop;
