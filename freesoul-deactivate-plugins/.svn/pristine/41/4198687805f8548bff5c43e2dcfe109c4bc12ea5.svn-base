jQuery(document).ready(function($){
	...
	firstRowTop = table && parseInt(eos_dp_js.plugins_n) > 1 ? document.getElementById('eos-dp-setts').getElementsByTagName('tr')[2].getBoundingClientRect().top : null;
	if(plugsN > 15){
...
function eos_move_table_head(){
	...
	if(table && ('undefined' === typeof(is_single_post) || true !== is_single_post)){
		var prevDelta = 'undefined' !== typeof(window.fdp_delta) ? window.fdp_delta : -999999999;
		window.fdp_delta = parseInt(eos_dp_js.plugins_n) > 1 ? document.getElementById('eos-dp-setts').getElementsByTagName('tr')[2].getBoundingClientRect().top - firstRowTop : 0;
