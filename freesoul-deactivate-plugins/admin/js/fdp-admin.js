jQuery(document).ready(function($){
	...
	var tr = document.getElementById('eos-dp-setts').getElementsByTagName('tr');
...
function eos_move_table_head(){
	...
	if(table && ('undefined' === typeof(is_single_post) || true !== is_single_post)){
		var prevDelta = 'undefined' !== typeof(window.fdp_delta) ? window.fdp_delta : -999999999,tr = document.getElementById('eos-dp-setts').getElementsByTagName('tr');
