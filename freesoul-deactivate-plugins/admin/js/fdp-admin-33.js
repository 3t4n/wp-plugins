...
function fdp_update_parent(el,parent_plugin,string,single_column){
	...
	if(parent_plugin !== el.dataset.path){
		if(-1 !== el.dataset.path.indexOf('-' + string) || -1 !== el.dataset.path.indexOf(string + '-')){
			var parent_plugin_el = single_column ? jQuery('[data-path="' + parent_plugin + '"]') : jQuery(el).closest('tr').find('[data-path="' + parent_plugin + '"]'),reverseCheck = 'undefined' !== typeof(eos_dp_js.page) && ('eos_dp_mobile' === eos_dp_js.page || 'eos_dp_search' === eos_dp_js.page);
...
function fdp_update_add_ons(el,parent_plugin,strings,single_column){
	var reverseCheck = 'undefined' !== typeof(eos_dp_js.page) && ('eos_dp_mobile' === eos_dp_js.page || 'eos_dp_search' === eos_dp_js.page);
