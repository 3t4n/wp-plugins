...
Previous components now included with WordPress core:
* Adaptive width: make the Customizer proportionally larger on very large screens. <a href="https://core.trac.wordpress.org/ticket/32296">#32296</a> (merged in WordPress 4.8)
* Better contrast and focus: improve and unify color contrast and visual focus styles (merged in WordPress 4.7)
* Device Peview: buttons to preview your customized site as it will display on phones and tablets (merged in WordPress 4.5)
...
1. Visit the Customizer (Appearance -> Customize) to see the proposed changes in action.
1. Leave feedback on the proposed changes on the relevant trac tickets from the list of components in the plugin description.
...
= 0.4 =
* Remove the Adaptive Width component (added to WordPress core in version 4.8).
