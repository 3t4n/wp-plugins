...
== Description ==
HT Builder is a drag & drop theme builder plugin for Elementor Page Builder. Theme Builder is included in this plugin to build custom blog page, custom blog details page, search page, archive page, coming soon page, 404 page and custom template for header/footer.

20 Element Addons, awesome styling options. You can easily build your blog page, blog details page, search page, 404 page, unlimited header, unlimited footer layout from the elementor page builder.
...
> Includes 360 Block & 170 Landing Pages.

== WooLentor – WooCommerce Elementor Addons + Builder ==
> Don't forget to check our WooCommerce Page Builder for Elementor page Builder.
...
= Version: 1.3.1 - Date: 20-Oct-2024 =
* Fixed: Escaping and sanitizing issues in all Widgets.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.

= Version: 1.3.0 - Date: 07-Mar-2023 =
* Added: Nonce verification for recommended plugins & template library.
* Improved: Coding standards in some areas.

= Version: 1.2.9 - Date: 06-Nov-2022 =
* Compatibility with latest WordPress version.
* Site logo and site title widget responsive issues fixed.
* Minor Bug Fixed

= Version: 1.2.8 - Date: 27-Sep-2022 =
* Updated: Plugin list in the Recommendations menu

= Version: 1.2.7 - Date: 12-June-2022 =
* Demo Preview Plugins Image Update
* Demo Preview Link Update
* Minor Bug Fixed

= Version: 1.2.6 - Date: 06-June-2022 =
* Compatible with WordPress 6.0 Version
* Elementor Latest Version Problem Fixed
* Updated Widgets Icon
* Minor CSS Issue Fixed

= Version: 1.2.5 - Date: 8-Dec-2021 =
* Added: Redirect to recommendation page after activation

= Version: 1.2.4 - Date: 23-Oct-2021 =
* Fixed: Console log problem on plugin activation

= Version: 1.2.3 - Date: 02-Sep-2021 =
* Compatibility: Replaced _register_controls method for deprication

= Version: 1.2.2 - Date: 26-Jul-2021 =
* Improved: Recommendations

= Version: 1.2.1 - Date: 04-Jul-2021 =
* Fixed: Header & Footer wrapper added for layout problem with themes
* Fixed: Mobile menu color change does not work
* Fixed: SSL verify problem
* Fixed: Recommended plugin images does not load properly

= Version: 1.2.0 - Date: 26-April-2021 =
* Compatible with Elementor latest version

= Version: 1.0.9 - Date: 28-Dec-2020 =
* Admin bar showing issue solved.

= Version: 1.0.4 - Date: 24-Oct-2019 =
* Compability With WordPress 5.3

= Version: 1.0.4 - Date: 24-Oct-2019 =
* Fixed custom metabox compatibility for Elementor update version

== Installation ==
This section describes how to install the HT Builder For Elementor Page Builder Plugins for WordPress get it working.

= 1) Install =

= Install: =
1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "HT Builder".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `ht-builder` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

== Screenshots ==
1. Template Options
2. Element On/off Options
3. Blog page front end view
4. Blog Details page front end view
