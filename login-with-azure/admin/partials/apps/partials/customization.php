			...
			<div class="moazure_customization_header moazure-flex">
				<div class="moazure_attribute_map_heading">
					<b class="moazure_position">
						<?php esc_html_e( 'Customize Icons ', 'login-with-azure' ); ?>
					</b>
				</div>
		...
		">
			...
			<div class="moazure_write_custom_code_tab moazure_customize_SSO_buttons moazure-rad">
				<p style="font-weight: 600;color:red;text-align:center;font-size:initial">
					<?php esc_html_e( 'Save the settings to see the preview of the Custom CSS', 'login-with-azure' ); ?>
				</p>
				<table  class="mo_settings_table" >
					<tr>
						<td>
							<strong><?php esc_html_e( 'Custom CSS:', 'login-with-azure' ); ?></strong>
						</td>
						<td>							
						<br/>
							...
							<br/>
							<strong><?php esc_html_e( 'Example CSS:', 'login-with-azure' ); ?></strong>
<pre>
	background: #7272dc;
	height:40px;
	width:300px;
	...
	color:#fff;
					...
					<tr>
						<td>
							<strong><?php esc_html_e( 'Logout Button Text:', 'login-with-azure' ); ?> </strong>
						</td>
						<td>
					...
					<tr>
						<td></td>
						<td>
							<br><strong><?php esc_html_e( 'Example:', 'login-with-azure' ); ?></strong>
<pre>
			...
			<div class="moazure_outer_padding" style="padding: 15px 0px;">
				<table class="moazure_custom_settings_table">
					<div class="moazure_notice_label moazure-flex moazure-rad" style="margin: 0px auto;">
						<div>
							<h4 style="font-size: 1rem"><?php esc_html_e( 'Apply above customized settings to the wp-admin SSO buttons:', 'login-with-azure' ); ?>
							</h4>
						</div>
						<div>
				...
				<table class="moazure_custom_settings_table">
					<tr>
						<h4 style="font-size: 1.2em"><?php esc_html_e( 'Customize display name (special charactors are allowed.)', 'login-with-azure' ); ?></h4>
					</tr>
					<?php
					...
					<tr>
						<td>
							<strong>
								<label class="moazure_fix_fontsize"><?php esc_html_e( 'Enter text to display on your login buttons:', 'login-with-azure' ); ?></label>&nbsp;&nbsp;<?php echo esc_attr( $displayname ); ?>
							</strong>
						</td>
						<td>
				...
				<table class="moazure_custom_settings_table">
					<tr>
						<h4 style="font-size: 1.2em">
							<?php esc_html_e( 'Customize Connect with text on WP Login page', 'login-with-azure' ); ?>
						</h4>
					</tr>
					<tr>
						<div style="width: 100%;">
							<td>
								<strong>
									<label class="moazure_fix_fontsize"><?php esc_html_e( 'Enter text to show above login widget:', 'login-with-azure' ); ?></label>
								</strong>
							</td>
							<td>
				...
				<hr>
				<h4 style="font-size: 1.2em">
					<?php esc_html_e( 'Customize Text to show user after Login', 'login-with-azure' ); ?>
				</h4>
				<table class="moazure_custom_settings_table">
					<tbody>
						<tr>
							<td>
								<strong><?php esc_html_e( 'Customize Logout Text: (Anchor tags are allowed)', 'login-with-azure' ); ?></strong>
							</td>
							<td>
						...
						<tr>
							<td></td>
							<td>
								<strong><?php esc_html_e( 'Example:', 'login-with-azure' ); ?></strong>
<pre>
	Text you enter: Howdy ##user## ##Sign Out##
	Text displayed: Howdy (username)  <u>Sign Out</u>
</pre>
						...
						<tr>
							<td>
								<strong><?php esc_html_e( 'With Logout Link: (If unchecked, remove logout link)', 'login-with-azure' ); ?></strong>
							</td>
							<td>
				...
				<table class="moazure_custom_settings_table">
					<tr>
						<td></td>
						<td>
							<input type="submit" id="button_submit"name="submit" value="<?php esc_html_e( 'Save Settings', 'login-with-azure' ); ?>" style="margin:20px 0px; padding:2px 25px;" class="button button-primary button-large mo_disabled_btn" />
						</td>
					</tr>
				</table>
			</div>
