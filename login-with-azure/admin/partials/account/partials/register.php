		...
		<form name="f" method="post" action="">
			...
			<div class="moazure_table_layout moazure_outer_div" id="moazure_register">
				<div id="toggle1" class="moazure_customization_header">
					<h3 class="moazure_signing_heading" style="margin:0px;"><?php esc_html_e( 'Register with miniOrange', 'login-with-azure' ); ?> <small style="font-size: x-small;">[OPTIONAL]</small></h3> 
				</div>
				<div class="moazure_contact_heading" id="panel1">
					...
					<p style="font-size:14px;"><b><?php esc_html_e( 'Why should I register?', 'login-with-azure' ); ?> </b></p>
						<div id="help_register_desc" style="background: aliceblue; padding: 10px 10px 10px 10px;">
							<?php esc_html_e( 'You should register so that in case you need help, we can help you with step by step instructions.', 'login-with-azure' ); ?>
							<b><?php esc_html_e( 'You will also need a miniOrange account to upgrade to the premium version of the plugins.', 'login-with-azure' ); ?></b> <?php esc_html_e( 'We do not store any information except the email that you will use to register with us.', 'login-with-azure' ); ?>
						</div>
					</p>
					<table class="mo_settings_table moazure_configure_table">
						...
						<tr>
							...
							<td><br><input type="submit" name="submit" value="<?php esc_attr_e( 'Register', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn"/>
							<input type="button" name="moazure_goto_login" id="moazure_goto_login" value="<?php esc_attr_e( 'Already have an account?', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn"/></td>
						</tr>
					</table>
				</div>
			</div>
...
function moazure_show_customer_info() {
	...
	<div class="moazure_table_layout moazure_outer_div" id="moazure_register">				
			<div id="toggle1" class="moazure_customization_header">
				<h3 class="moazure_signing_heading" style="margin:0px;"><?php esc_html_e( 'Thank you for registering with miniOrange', 'login-with-azure' ); ?></h3> 
				</div>
	...
	<form name="f1" method="post" action="" id="moazure_goto_login_form">
		...
		<input type="submit" style="padding:0px 20px;" value="<?php esc_attr_e( 'Change Email Address', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn"/>
	</form>
	</td><td>
	<a href=""><input type="button" class="button button-large moazure_configure_btn" value="<?php esc_attr_e( 'Check Licensing Plans', 'login-with-azure' ); ?>" /></a>
	</td>
	</tr>
	</table>
