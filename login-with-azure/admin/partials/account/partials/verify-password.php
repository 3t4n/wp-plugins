		...
		<form name="f" method="post" action="">
			...
			<div class="moazure_table_layout moazure_outer_div" id="moazure_register">				
				<div id="toggle1" class="moazure_customization_header">
					<h3 class="moazure_signing_heading" style="margin:0px;"><?php esc_html_e( 'Login with miniOrange', 'login-with-azure' ); ?></h3> 
				</div>
				<div class="moazure_contact_heading" id="panel1">
					...
					<table class="mo_settings_table moazure_configure_table">
						...
						<tr>
							<td>&nbsp;</td>
							<td>
								<input type="submit" style="padding:0px 20px;" name="submit" value="<?php esc_attr_e( 'Login', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn" /></form>

								<input type="button" style="padding:0px 20px;" name="back-button" id="moazure_back_button" onclick="document.getElementById('moazure_change_email_form').submit();" value="<?php esc_attr_e( 'Sign up', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn" />
