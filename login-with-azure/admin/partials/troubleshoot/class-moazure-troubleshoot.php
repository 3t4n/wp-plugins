...
class MOAzure_Troubleshoot {
	...
	public static function moazure_troubleshooting() {
		...
		$app         = ( ! empty( $_REQUEST['app'] ) && 'azure-b2c' === $_REQUEST['app'] ) ? 'azure-b2c' : 'entra-id'; //phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Ignoring nonce verification because we are fetching data from URL and not on form submission.
		$esc_allowed = array(
			'a'      => array(
				'href'   => array(),
				'title'  => array(),
		...
		<?php esc_html_e( 'Troubleshooting', 'login-with-azure' ); ?>
		</h3>
		<hr class='mo-divider'><br>
		</div>
		<div class="moazure_error_faq_option">
			<div class="moazure_errorcodes_options">
				<h3 class='mo_app_heading'><?php esc_html_e( 'Error Codes', 'login-with-azure' ); ?></h3>
			</div>
			<div class="moazure_faq_options">
				<h3 class='mo_app_heading'><?php esc_html_e( 'FAQs', 'login-with-azure' ); ?></h3>
			</div>
		</div>
		<br><br>
