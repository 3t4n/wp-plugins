			...
			<?php wp_nonce_field( 'moazure_pbi_shortcode_form', 'moazure_pbi_shortcode_form_field' ); ?>
				...
				<table class="mo_settings_table moazure_configure_table">
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong moazure_position"><?php esc_html_e( 'Workspace ID', 'login-with-azure' ); ?><font style="color: red;">*</font> : </strong>
					...
					<tr class="moazure_configure_table_rows" id="moazure_display_app_name_div">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong moazure_position"><?php esc_html_e( 'Report ID', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Height (in px)', 'login-with-azure' ); ?> :</strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Width (in px)', 'login-with-azure' ); ?> :</strong>
				...
				<div class="moazure-flex" style="justify-content: space-between;">
					<div class="moazure-flex moazure-app-submit">
						<div>							
							<input type="submit" name="submit" value="<?php esc_html_e( 'Generate Shortcode', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn moazure-rad" />
						</div>
					</div>
				</div>
			</form>
