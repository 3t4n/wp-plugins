...
function moazure_add_oauth_app_page() {
	...
	$login_btn = isset( $appconfig['show_on_login_page'] ) ? $appconfig['show_on_login_page'] : 1;
		...
		<div id="toggle2" class="moazure_configure_header moazure-flex">
			<div>
				<h3 class="moazure_configure_heading">
					...
					esc_html_e( $app_type . ' SSO Configurations', 'login-with-azure' );
					?>
				</h3>
		...
		<div id="moazure_add_app">
				...
				if ( ( ! empty( $appparam ) && $apptype !== $appparam ) || ( empty( $appparam ) && 'azure-b2c' === $apptype ) ) {
					...
					<p class="moazure_upgrade_warning moazure-rad" style="text-align: center; color: red;">
						<b>
							<?php
							// phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText
							esc_html_e( 'Saving Configurations here will overwrite your configured ' . strtoupper( $apptype ) . ' application.', 'login-with-azure' );
							?>
						</b>
					</p>
					<?php
			...
			<form id="form-common" name="form-common" method="post" action="">
				...
				<table class="mo_settings_table moazure_configure_table">
					<tr class="moazure_configure_table_rows" id="moazure_display_app_name_div">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong" class="moazure_position"><?php esc_html_e( 'Display App Name', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong" class="moazure_position"><?php esc_html_e( 'Redirect / Callback URI', 'login-with-azure' ); ?><font style="color: red;">*</font> : </strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Application (client) ID', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Client Secret', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
					...
					if ( 'Azure B2C' === $app_type ) {
						...
						<tr class="moazure_configure_table_rows">
							<td class="moazure_contact_heading td_entra_app">
								<strong class="mo_strong"><?php esc_html_e( 'Tenant-Name', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
						...
						<tr class="moazure_configure_table_rows">
							<td class="moazure_contact_heading td_entra_app">
								<strong class="mo_strong"><?php esc_html_e( 'User-Flow/ Policy Name', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
								<p class="moazure_desc">
						...
						<tr class="moazure_configure_table_rows">
							<td class="moazure_contact_heading td_entra_app">
								<strong class="mo_strong"><?php esc_html_e( 'Directory (tenant) ID', 'login-with-azure' ); ?><font style="color: red;">*</font> :</strong>
					...
					<tr class="moazure_configure_table_rows">
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Scope :', 'login-with-azure' ); ?></strong>
					...
					<tr>
						<td class="moazure_contact_heading td_entra_app">
							<strong class="mo_strong"><?php esc_html_e( 'Enable Single Sign-On :', 'login-with-azure' ); ?></strong>
						...
						<td class="moazure_contact_heading td_entra_app">
							<label class="moazure_switch" style="float: left;">
								<input class="mo_input_checkbox" id="toggleSwitch" type="checkbox" name="moazure_show_on_login_page" value="1" <?php checked( $login_btn, 1 ); ?> />
					...
					<div class="moazure-flex moazure-app-submit">
						...
						<div>
							...
							if ( ! empty( $apps_list ) && ( ( empty( $appparam ) && 'azure-b2c' !== $apptype ) || $apptype === $appparam ) ) {
								?>
								<input id="moazure_test_configuration" type="button" name="button" value="<?php esc_html_e( 'Test Configuration', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn moazure-rad" onclick="moazure_testConfiguration()" />
								<?php
							}
							?>
						</div>
				...
				<p class="moazure_upgrade_warning moazure-rad moazure-center">
					...
					<b><?php esc_html_e( 'Please configure', 'login-with-azure' ); ?> <a id="moazuer_attr_map" href='<?php echo esc_attr( admin_url( 'admin.php?page=moazure_settings&tab=attributemapping&app=' . $apptype ) ); ?>'><?php esc_html_e( 'Attribute Mapping', 'login-with-azure' ); ?></a> <?php esc_html_e( 'before trying Single Sign-On.', 'login-with-azure' ); ?></b>
				</p>
			</form>
		</div>
	</div>
