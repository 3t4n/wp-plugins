...
class MOAzure_Azure_API {
	 ...
	 * Mail endpoint var.
	 *
	 * @var string var containing the endpoint to send the email.
	 */
	private $mail_ep;
	 ...
	 * API body var.
	 *
	 * @var mixed var containing the API body.
	 */
	private $api_body;
	 ...
	 */
	private $sps_all_site_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/sites?search=*&\$select=id,displayName';
	 ...
	 */
	private $sps_def_site_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/sites/root';
	 ...
	 */
	private $sps_all_drive_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/sites/%s/drives';
	 ...
	 */
	private $sps_def_drive_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/sites/%s/drive';
	 ...
	 */
	private $sps_docs_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/drives/%s/root/children';
	 ...
	 */
	private $sps_folder_items_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/sites/%s/drives/%s/items/%s/children';
	 ...
	 */
	private $sps_docs_by_path_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0%s:/children';
	 ...
	 */
	private $sps_search_drive_items_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/drives/%s/root/search(q="%s")';
	 ...
	 */
	private $sps_user_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/me';
	...
	/**
	 * Function to set graph mail endpoint.
	 *
	 * @param array $mail_config mail config parameter.
	 * @return void
	 */
	public function set_mail_ep( $mail_config ) {
		$this->mail_ep = MOAzure_Apps_Enum::RESOURCE_HOST . 'v1.0/users/' . $mail_config['mail_from'] . '/sendMail';
	}
	...
	/**
	 * Function to set Azure API body.
	 *
	 * @param mixed $body azure api body var.
	 * @return void
	 */
	public function set_api_body( $body ) {
		$this->api_body = wp_json_encode( $body );
	}
	...
	public function moazure_set_sps_defaults() {
		...
		$this->set_scope( MOAzure_Apps_Enum::RESOURCE_HOST . '.default' );
	...
	/**
	 * Function to send the email using graph API.
	 *
	 * @return array
	 */
	public function moazure_send_email() {

		$this->set_appconfig();
		$this->set_token_ep( $this->appconfig['tenant-id'] );
		$this->set_scope( MOAzure_Apps_Enum::RESOURCE_HOST . '.default' );

		$email_res = $this->moazure_ms_apps_common( '', $this->appconfig, $this->token_ep, $this->scope, $this->mail_ep, true );
	 ...
	 * @param string  $scope scope parameter.
	 * @param string  $azure_api_ep azure get endpoint parameter.
	 * @param boolean $is_ms_manual microsoft manual app parameter.
	 * @return array
	 */
	public function moazure_ms_apps_common( $ref_token, $appconfig, $token_endpoint, $scope, $azure_api_ep, $is_ms_manual = false ) {
		...
		$response = $moazure_handler->moazure_get_request( $azure_api_ep, $this->headers, $this->api_body );
