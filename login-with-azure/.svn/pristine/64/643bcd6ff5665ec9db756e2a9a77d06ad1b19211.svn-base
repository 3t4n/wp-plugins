		...
		<div id="mo_support_layout" class="mo_support_layout moazue_support_outer_div">
			<div>
				<h3 class="moazure_contact_heading moazure_configure_heading" >
					<?php esc_html_e( 'Ask any questions', 'login-with-azure' ); ?>
				</h3>
				<div style="display: flex;align-items: center;gap:6px;">
					<div style="font-size:13px;">
						<?php esc_html_e( 'Need any help? Just send us a query and we will get back to you soon.', 'login-with-azure' ); ?>
					</div>
				</div>
				<form method="post" action="">
					...
					<div class="mo_oauth_contact">
						<table class="mo_settings_table" style="display: none;">
							...
							<textarea cols="30" rows="4" placeholder="<?php esc_attr_e( 'Enter your query...', 'login-with-azure' ); ?>" name="moazure_contact_us_query" onkeypress="moazure_valid_query(this)" onkeyup="moazure_valid_query(this)" rows="4" style="resize: vertical;" onblur="moazure_valid_query(this)" required></textarea>
							...
							<div class="moazure-flex" style="gap: 1rem;">
								...
								<div class="mo_oauth_checkbox-content">
									<span class="mo_oauth_checkbox-info">
										<?php esc_html_e( 'Send Plugin Configuration', 'login-with-azure' ); ?>
						...
						<div class="mo_oauth_setup-call moazure-flex moazure-rad">
							...
							<p>
								<b>
									...
									<?php esc_html_e( 'Setup a Call/ Screen-share session', 'login-with-azure' ); ?>
								</b>
							</p>
						</div>
						<div class="moazure-rad" id="moazure_setup_call_div">
							<table class="mo_settings_table" cellpadding="2" cellspacing="2">
								<tr>
									<td>
										<strong class="mo_strong">
												<?php esc_html_e( 'Issue', 'login-with-azure' ); ?><font style="color: red;">*</font> :
										</strong>
									</td>
									<td>
								...
								<tr id="setup_guide_link" style="display: none;">
									<td colspan="2">
										<?php esc_html_e( 'Have you checked the setup guide ', 'login-with-azure' ); ?><a href="https://plugins.miniorange.com/wordpress-single-sign-on-sso-with-oauth-openid-connect" target="_blank">here</a>?
									</td>
								</tr>
								<tr id="required_mark" style="display: none;">
									<td>
										<strong class="mo_strong">
											<?php esc_html_e( 'Description', 'login-with-azure' ); ?><font style="color: red;">*</font> :
										</strong>
									</td>
									<td>
										<textarea id="issue_description" class="moazure_issue_description" onkeypress="moazure_valid_query(this)" placeholder="<?php esc_html_e( 'Enter your issue description here', 'login-with-azure' ); ?>" onkeyup="moazure_valid_query(this)" onblur="moazure_valid_query(this)" name="moazure_issue_description" rows="2" style="resize: vertical;"></textarea>
									</td>								
								</tr>
								<tr>
									<td>
										<strong class="mo_strong">
												<?php esc_html_e( 'Date', 'login-with-azure' ); ?><font style="color: red;">*</font> :
										</strong>
									</td>
									<td>
								...
								<tr>
									<td>
										<strong class="mo_strong">
											<?php esc_html_e( 'Local Time', 'login-with-azure' ); ?><font style="color: red;">*</font> :
										</strong>
									</td>
									<td>
							...
							<p>
								<?php esc_html_e( 'We are available from 3:30 to 18:30 UTC', 'login-with-azure' ); ?>
							</p>
