...
8. Configure Microsoft Graph Email
9. Send mail using Microsoft Graph API
...
= 2.1.6 =
* Invalid ID token error fix
* Fix for error on destroying session

= 2.1.5 =
* Added Outlook Email Integration
* Send Email using Microsoft Graph API

= 2.1.4 =
* XSS Vulnerability fix for Power BI
