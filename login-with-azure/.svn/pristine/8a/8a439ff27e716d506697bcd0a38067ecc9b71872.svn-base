		...
		<div class="">
			...
			<div class="no-app moazure_outer_div">
				...
				<div class="moazure-flex" style="justify-content: center; padding: 2% 5%;">
					<button id="moazure_sps_test_config" type="button" class="button button-large moazure_configure_btn moazure-rad" onclick="moazure_sps_auto_connect('<?php echo esc_attr( admin_url() ); ?>')"><?php esc_html_e( 'Connect', 'login-with-azure' ); ?></button>
				</div>
			</div>
					...
					if ( ! $is_entra_app ) {
						...
						<div class="moazure-flex" id="moazure_sps_initial" style="justify-content: center; gap: 2rem; padding: 2% 5%;">
							<form method="post" action="" name="moazure_use_entra">
								...
								<input type="submit" name="submit_use_entra" value="<?php esc_html_e( 'Use configured Entra App', 'login-with-azure' ); ?>" class="button button-large moazure_configure_btn moazure-rad" />
							</form>
