...
== Changelog ==
= 3.2.2 =
* Fix: Reflected XSS on the settings page. [Thanks to João Pedro S Alcântara (Kinorth) / 
Darius Sveikauskas / patchstack.com][06/02/2025]
= 3.2.1 =
...
== Upgrade Notice ==
= 3.2.2 =
Fix: Reflected XSS on the settings page.
= 3.2.1 =
