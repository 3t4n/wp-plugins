document.addEventListener('DOMContentLoaded', () => {
	...
	const turnServerUrl = SSSSettings.turnServerUrl;
	const turnUsername = SSSSettings.turnUsername;
	const turnPassword = SSSSettings.turnPassword;
