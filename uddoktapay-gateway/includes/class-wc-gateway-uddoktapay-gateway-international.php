...
/**
 * UddoktaPay International Payment Gateway
 *
 * @class    WC_Gateway_UddoktaPay_International
...
class WC_Gateway_UddoktaPay_International extends WC_Payment_Gateway
{
     ...
     *
     * @var UddoktaPay_Gateway_API_Handler|null
     */
    protected $api = null;
    ...
    protected function setup_properties()
    {
        ...
        $this->webhook_url = (string) add_query_arg('wc-api', get_class($this), home_url('/'));
        $this->supports = [
            'products',
        ];
    }
     ...
     *
     * @return UddoktaPay_Gateway_API_Handler
     */
    protected function get_api()
    {
        if ($this->api === null) {
            UddoktaPay_Gateway_API_Handler::$debug = $this->debug;
            UddoktaPay_Gateway_API_Handler::$api_url = $this->api_url;
            UddoktaPay_Gateway_API_Handler::$api_key = $this->api_key;

            $this->api = new UddoktaPay_Gateway_API_Handler();
        }
        return $this->api;
    }
