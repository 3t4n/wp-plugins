...
echo '
<div class="submit">
    <a href="'.esc_url(SELLSY_URL_BACK_SOUS_MENU_2).'&type=edit&contact_form_id='.esc_attr($idDuplicate).'" class="button button-primary">'.esc_html(__('Edit the new form', PLUGIN_NOM_LANG)).'</a>
    <a href="/wp-admin/admin.php?page=idSousMenu2" class="button">'.esc_html(__('Back', PLUGIN_NOM_LANG)).'</a>
</div>';
