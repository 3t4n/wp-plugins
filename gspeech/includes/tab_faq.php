			...
			<li class="gsp_faq_item">
				...
				<div class="gsp_faq_body">
					<div class="gsp_faq_body_inner">
						...
						<br /><br />
						GSpeech was created in 2012. In 2023 we introduced a <b>powerfull platform</b>: <a href="https://gspeech.io/dashboard" target="_blank">GSpeech Dashboard</a>, with support of the best AI voices(commercial plans), multiple player types, real-time translation of audio content, audios database with ability to download, detailed analytics and statystics, and with full intefration into <b>WordPress Admin Panel</b>.
					</div>
				</div>
			</li>
			<li class="gsp_faq_item">
