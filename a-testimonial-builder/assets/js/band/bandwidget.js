...
var VrBand = function () {
    ...
    var getContentUrl = function () {
        ...
        return window.location.protocol + url + '/band';
    };
    ...
    var onMessage = function (msg) {
        ...
        if (typeof msg === 'string') {
            if (msg.indexOf(msgId) != -1) {
                ...
                msg = {app: 'vr_band', cmd: 'resize', params: {height: data.height, width: data.width}};
            }
        }

        if (typeof msg.app == 'undefined' || msg.app != 'vr_band')
            return;
        switch (msg.cmd) {
            case 'resize':
                resize(msg.params);
