/**
 * VrMatrix
 * @type Object VrMatrix
 */
var VrMatrix = function () {
    ...
    var getContentUrl = function () {
        ...
        return window.location.protocol + url + '/matrix';
    };
    ...
    var onMessage = function (msg) {
        ...
        if (typeof msg === 'string') {
            if (msg.indexOf(msgId) != -1) {
                ...
                msg = {app: 'vr_matrix', cmd: 'resize', params: {height: data.height, width: data.width}};
            }
        }

        if (typeof msg.app == 'undefined' || msg.app != 'vr_matrix')
            return;
        switch (msg.cmd) {
            case 'resize':
                resize(msg.params);
