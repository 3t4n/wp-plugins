/**
 * VrHorizon
 * @type Object VrHorizon
 */
var VrHorizon = function () {
    var settings = {},
            defaults = {
                hashurl: null,
                identify: null,
    ...
    var getContentUrl = function () {
        ...
        return window.location.protocol + url + '/horizon';
    };
    ...
    var createIframe = function () {
        ...
        iframe.id = 'horizonWidgetIframe';
        iframe.src = getContentUrl() + "?token=" + settings.identify + "&domain=" + getParentDomain() + "&days=" + settings.days;
    ...
    var onMessage = function (msg) {
        ...
        if (typeof msg === 'string') {
            if (msg.indexOf(msgId) != -1) {
                ...
                msg = {app: 'vr_horizon', cmd: 'resize', params: {height: data.height, width: data.width}};
            }
        }

        if (typeof msg.app == 'undefined' || msg.app != 'vr_horizon')
            return;
        switch (msg.cmd) {
            case 'resize':
                resize(msg.params);
