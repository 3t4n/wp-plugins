...
$settings =  array(
    ...
    'description' => __('Get a bundle of features with an upgrade to WC Messaging Pro', 'wc-messaging'),
    'features' => array(
        __('Email support is available exclusively for WC Messaging Pro users', 'wc-messaging'),
    ...
    'footer' => array(
        ...
        'action' => array(
            ...
            'url' => esc_url('https://sevengits.com/plugin/wc-messaging-pro/?ref=free_support_settings')
        )
    )
);
