...
$new_settings = array(
    ...
    array(
        ...
        'introduction' => array(
            ...
            sprintf('%1$s, <a href="%3$s" target="_blank">%2$s</a> ', __('For a timely response via email from the developers who work on this plugin', 'wc-messaging'), __('upgrade to premium version', 'wc-messaging'), esc_url('https://sevengits.com/plugin/wc-messaging-pro/?utm_source=dashboard&utm_medium=support-tab-description&utm_campaign=Free-plugin'))
        ),
