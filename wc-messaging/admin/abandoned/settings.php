...
$new_settings = array(
    array(
        ...
        'desc'    => __('WC Messaging Abandoned Cart Settings', 'wc-messaging'),
    ),
    array(
    ...
    array(
        ...
        'note' => __('This will delete all expired and used coupons that were created by Woo Cart Abandonment Recovery.', 'wc-messaging'),
    ...
    array(
        ...
        'desc' => __('Allows you to trigger webhook automatically upon cart abandonment and recovery.', 'wc-messaging')
    ),
    array(
    ...
    array(
        ...
        'fields' => $this->get_settings_statuses(
            ...
            $is_editable = true,
            $actions = array('preview', 'remove', 'adandoned_coupon'),
            $has_admin_row = false

        ),
        'toggle_prefixes' => $abandoned_checker->get_abandoned_trigger_actions(),
