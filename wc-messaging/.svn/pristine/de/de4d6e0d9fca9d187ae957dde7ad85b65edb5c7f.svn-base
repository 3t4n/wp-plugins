...
* **Abandoned Cart Recovery:** Enable automated messages to recover lost sales directly from the WC Messaging Chat Dashboard.
...
* **Labels:** The new labeling feature allows users to categorize and organize customers efficiently, making it easy to filter and target specific customer groups for personalized communication and streamlined follow-up actions.
...
* **WhatsApp Interactive Flows:** Seamlessly manage multi-screen interactions, guiding customers through step-by-step processes via the chat interface.

* **Document Send/Receive:** Effortlessly share and receive documents through the WC Messaging Chat Dashboard for smoother communication.
...
* **Improvement:** Code cleaning for improve performance and maintainability

**1.3.4 - 03 FEB 2025**

* **Improvement:** Minor fixes
* **Improvement:** The plugin name and title have been corrected to comply with WhatsApp's trademark guidelines
* **Improvement:** Compatible with WooCommerce 9.6

**1.3.3 - 16 JAN 2025**

* **Improvement:**  Minor fixes
* **Improvement:** The Template Settings page has been enhanced with dedicated options for configuring admin and customer notifications
* **New:** Template message notifications can now be sent separately to admins and customers, enabling more targeted communication

**1.3.2 - 07 JAN 2025**

* **Improvement:** Renamed the "Support" tab to "Support & Premium" for better clarity

**1.3.1 - 06 JAN 2025**

* **Fix:** Resolved issues with displaying template messages
* **Improvement:** Enhanced the display for text-only templates in the template settings to avoid confusion.

**1.3.0 - 31 DEC 2024**

* **Fix:** Resolved minor issues
* **New:** Abandoned cart recovery feature to re-engage potential customers.
* **Improvement:** Compatible with WooCommerce 9.5

**1.2.2 - 15 NOV 2024**

* **Fix:** Resolved issues with custom trigger buttons
