...
trait shortcodeConstructor{
	...
	public function solwzd_wizardSelection($atts){
		...
		<div class="wizard_selection_card">
			<form class="select_wizard_form" id="'.esc_html($atts['select_wizard_form_id']).'">
					...
					<div class="form-card">
						...
						<div class="solwzd-row">
							<div class="solwzd-col-md-3 solwzd-offset-md-3 solwzd-col-sm-6 solwzd-col-6">
								<div class="box option">
									<div class="radio-round">
										<input type="radio" class="wizard_selection" id="ws1" height="50px" name="wizard_selection" value="'.esc_html($atts['form_id_lite']).'"  />
										<label for="ws1"></label>
									</div>
							...
							<div class="solwzd-col-md-3 solwzd-col-sm-6 solwzd-col-6">
								<div class="box option">
									<div class="radio-round">
										<input type="radio" class="wizard_selection" id="ws2" height="50px" name="wizard_selection" value="'.esc_html($atts['form_id_full']).'" />
										<label for="ws2"></label>
									</div>
						...
						<div class="solwzd-row">
							<div class="solwzd-col-md-6 solwzd-offset-md-3 solwzd-col-sm-12 solwzd-col-12">
								<div class="input-box sel-wizard-space-box">
									...
									<button type="button" class="select-wizard-btn arrow-btn full-wizard lite-wizard" data-swiz-event="select-path" data-swiz-value=""></button>
								</div>
							</div>
						</div>	
	...
	public function solwzd_openForm($atts){
		$openForm = '<form id="'.esc_html($atts['form_id_full']).'" class="sw_form '.esc_html($atts['class_full']).'" action="" method="POST" enctype="multipart/form-data"><input type="hidden" name="form_used" value="Full Wizard" />';
		if(get_option('sw_google_autocomplete_address') != ''){
				$openForm .= '<input type="hidden" class="sw_google_autocomplete_address" value="'.esc_html($atts['address_id_full']).'" />';
			}
		return $openForm;
	}
	
	public function solwzd_openFormLite($atts){
		$openForm = '<form id="'.esc_html($atts['form_id_lite']).'" class="sw_form '.esc_html($atts['class_lite']).'" action="" method="POST" enctype="multipart/form-data"><input type="hidden" name="form_used" value="Lite Wizard" />';
		if(get_option('sw_google_autocomplete_address') != ''){
				$openForm .= '<input type="hidden" class="sw_google_autocomplete_address" value="'.esc_html($atts['address_id_lite']).'" />';
			}
		return $openForm;
	}
	...
	public function solwzd_setHiddenFields($atts){
		$fields ='
			...
			if($atts['property_type_step'] == false){
				$fields .= '<div class="dy-error hidden"></div><input type="radio" checked class="hidden" name="describe_you" value="'.esc_html($atts['property_type']).'" />';
			}
		return $fields;
	}
		...
		$content = '<fieldset class="4 step-address calculate-panel">
						...
						<div class="solwzd-container">
							...
							<div class="solwzd-row">
								<div class="solwzd-col-md-8 solwzd-offset-md-2 solwzd-col-sm-12 solwzd-col-12">';
								if($form == 'Lite'){
									$content .= '<input type="text" placeholder="Enter Address" name="address" id="'.esc_html($atts['address_id_lite']).'" />
												<input type="hidden" name="zipcode" class="'.esc_html($atts['address_id_lite']).'_geo-zipcode" />';
								} else if($form == 'Full'){
									$content .= '<input type="text" placeholder="Enter Address" name="address" id="'.esc_html($atts['address_id_full']).'" />
												<input type="hidden" name="zipcode" class="gzipcode '.esc_html($atts['address_id_full']).'_geo-zipcode" />';
								}
								$content .= '
								<div class="solwzd-row"> 
									<div class="solwzd-col-md-12">
		...
		$content = '<fieldset class="9 padding-box-top">
					...
					<div class="form-card">
						...
						<div class="fields">
							...
							';
										if($form == 'Lite'){
											$content .= '<input type="text" placeholder="Address" name="confirmaddress" id="'.esc_html($atts['address_id_lite']).'_sw_confirm_address" />';
										} else if($form == 'Full'){
											$content .= '<input type="text" placeholder="Address" name="confirmaddress" id="'.esc_html($atts['address_id_full']).'_sw_confirm_address" />';
										}
										$content .= '
