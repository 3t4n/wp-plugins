...
define( 'SOLWZD_VERSION', '1.2.5' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file
class SolarWizard {
	
	use shortcodeConstructor;
	public $sw_db_version = "1.2.5";
	...
	public function solwzd_clean_params($string){
	...
	$atts['select_wizard_form_id'] = esc_attr($this->solwzd_clean_params($atts['select_wizard_form_id']));
	$atts['form_id_full'] = esc_attr($this->solwzd_clean_params($atts['form_id_full']));
	$atts['form_id_lite'] = esc_attr($this->solwzd_clean_params($atts['form_id_lite']));
	$atts['address_id_full'] = esc_attr($this->solwzd_clean_params($atts['address_id_full']));
	$atts['address_id_lite'] = esc_attr($this->solwzd_clean_params($atts['address_id_lite']));
	$atts['class_full'] = esc_attr($this->solwzd_clean_params($atts['class_full']));
	$atts['class_lite'] = esc_attr($this->solwzd_clean_params($atts['class_lite'])); 
