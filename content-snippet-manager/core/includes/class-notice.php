		...
		?>
            ...
            <div class="update-nag notice csm-notice">
            	...
            	<div class="csm-noticedescription">
					...
					<strong><?php _e( 'Upgrade to the Pro version of Content Snippet Manager to unlock all features, like...', 'content-snippet-manager' ); ?></strong><br/>
                ...
                <a target="_blank" href="<?php echo esc_url( CSM_UPGRADE_LINK . '/?ref=2&campaign=csm-notice' ); ?>" class="button"><?php _e( 'Upgrade now', 'content-snippet-manager' ); ?></a>
                <div class="clear"></div>
