...
class LSDRC_Menus extends LSDRC_Base
{
    ...
    public function register_menus()
    {
        ...
        add_menu_page(esc_html__('Listdomer', 'listdomer-core'), esc_html__('Listdomer', 'listdomer-core'), 'manage_options', 'listdomer', null, $icon, 59);
        ...
        add_submenu_page('listdomer', esc_html__('Support', 'listdomer-core'), esc_html__('Support', 'listdomer-core'), 'manage_options', 'https://webilia.com/support/', null, 4);

        if (!is_plugin_active('listdomer-pro/listdomer-pro.php')) add_submenu_page('listdomer', esc_html__('Go Pro', 'listdomer-core'), '<span style="color: #ffd700; font-weight: bold;">' . esc_html__('Go Pro', 'listdomer-core') . '</span>', 'manage_options', 'https://api.webilia.com/go/buy-listdomer-pro', null, 5);
    }
