 ...
 * Description:             Плагин позволяет создать XML фид для Avito Автозагрузка.
 * Version:                 2.5.8
...
// Define constants
define( 'XFAVI_PLUGIN_VERSION', '2.5.8' );
...
// $not_run = apply_filters('xfavi_f_nr', $not_run);
