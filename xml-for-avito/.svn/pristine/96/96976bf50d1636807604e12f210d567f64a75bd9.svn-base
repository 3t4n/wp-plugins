...
class XFAVI_Data {
	...
	public function __construct( $manager_name = '', $data_arr = [] ) {
		...
		$this->data_arr = [ 
			...
			[ 
				'opt_name' => 'xfavi_custom_attr_1',
				'def_val' => 'disabled',
				'mark' => 'public',
				'type' => 'select',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Значение произвольного тега 1', 'xml-for-avito' ),
					'desc' => __( 'Значение произвольного тега 1', 'xml-for-avito' ),
					'woo_attr' => true,
					'default_value' => true,
					'key_value_arr' => [ 
						[ 'value' => 'disabled', 'text' => __( 'Disabled', 'xml-for-avito' ) ]
					],
					'tag_name' => '???'
				]
			],
			[ 
				'opt_name' => 'xfavi_custom_tag_name_1',
				'def_val' => '',
				'mark' => 'public',
				'type' => 'text',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Произвольный тег 1', 'xml-for-avito' ),
					'desc' => __( 'Название тега 1', 'xml-for-avito' ),
					'placeholder' => sprintf( '%s / %s',
						__( 'Value', 'xml-for-avito' ),
						__( 'Name post_meta', 'xml-for-avito' )
					)
				]
			],
			[ 
				'opt_name' => 'xfavi_custom_attr_2',
				'def_val' => 'disabled',
				'mark' => 'public',
				'type' => 'select',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Значение произвольного тега 2', 'xml-for-avito' ),
					'desc' => __( 'Значение произвольного тега 2', 'xml-for-avito' ),
					'woo_attr' => true,
					'default_value' => true,
					'key_value_arr' => [ 
						[ 'value' => 'disabled', 'text' => __( 'Disabled', 'xml-for-avito' ) ]
			...
			[ 
				'opt_name' => 'xfavi_custom_tag_name_2',
				'def_val' => '',
				'mark' => 'public',
				'type' => 'text',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Произвольный тег 2', 'xml-for-avito' ),
					'desc' => __( 'Название тега 2', 'xml-for-avito' ),
					'placeholder' => sprintf( '%s / %s',
						__( 'Value', 'xml-for-avito' ),
						__( 'Name post_meta', 'xml-for-avito' )
					)
			...
			[ 
				'opt_name' => 'xfavi_custom_attr_3',
				'def_val' => 'disabled',
				'mark' => 'public',
				'type' => 'select',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Значение произвольного тега 3', 'xml-for-avito' ),
					'desc' => __( 'Значение произвольного тега 3', 'xml-for-avito' ),
					'woo_attr' => true,
					'default_value' => true,
					'key_value_arr' => [ 
						[ 'value' => 'disabled', 'text' => __( 'Disabled', 'xml-for-avito' ) ]
			...
			[ 
				'opt_name' => 'xfavi_custom_tag_name_3',
				'def_val' => '',
				'mark' => 'public',
				'type' => 'text',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Произвольный тег 3', 'xml-for-avito' ),
					'desc' => __( 'Название тега 3', 'xml-for-avito' ),
					'placeholder' => sprintf( '%s / %s',
						__( 'Value', 'xml-for-avito' ),
						__( 'Name post_meta', 'xml-for-avito' )
					)
			...
			[ 
				'opt_name' => 'xfavi_custom_attr_4',
				'def_val' => 'disabled',
				'mark' => 'public',
				'type' => 'select',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Значение произвольного тега 4', 'xml-for-avito' ),
					'desc' => __( 'Значение произвольного тега 4', 'xml-for-avito' ),
					'woo_attr' => true,
					'default_value' => true,
					'key_value_arr' => [ 
						[ 'value' => 'disabled', 'text' => __( 'Disabled', 'xml-for-avito' ) ]
			...
			[ 
				'opt_name' => 'xfavi_custom_tag_name_4',
				'def_val' => '',
				'mark' => 'public',
				'type' => 'text',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Произвольный тег 4', 'xml-for-avito' ),
					'desc' => __( 'Название тега 4', 'xml-for-avito' ),
					'placeholder' => sprintf( '%s / %s',
						__( 'Value', 'xml-for-avito' ),
						__( 'Name post_meta', 'xml-for-avito' )
					)
			...
			[ 
				'opt_name' => 'xfavi_custom_attr_5',
				'def_val' => 'disabled',
				'mark' => 'public',
				'type' => 'select',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Значение произвольного тега 5', 'xml-for-avito' ),
					'desc' => __( 'Значение произвольного тега 5', 'xml-for-avito' ),
					'woo_attr' => true,
					'default_value' => true,
					'key_value_arr' => [ 
						[ 'value' => 'disabled', 'text' => __( 'Disabled', 'xml-for-avito' ) ]
			...
			[ 
				'opt_name' => 'xfavi_custom_tag_name_5',
				'def_val' => '',
				'mark' => 'public',
				'type' => 'text',
				'tab' => 'wp_list_table',
				'data' => [ 
					'label' => __( 'Произвольный тег 5', 'xml-for-avito' ),
					'desc' => __( 'Название тега 5', 'xml-for-avito' ),
					'placeholder' => sprintf( '%s / %s',
						__( 'Value', 'xml-for-avito' ),
						__( 'Name post_meta', 'xml-for-avito' )
					)
	...
	/** // TODO: Перепроверить эту функцию при переходне на новое ядро.
	 * Get data for tabs.
	 * 
	 * @param string $tab_name Maybe: `wp_list_table`, `dont_compare` and so on.
	 * 
	 * @return array Example: `array([0] => opt_key1, [1] => opt_key2, ...)`.
	 */
	public function get_data_for_tabs( $tab_name = 'dont_compare' ) {
