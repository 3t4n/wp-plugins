...
final class XFAVI_Interface_Hoocked {
	...
	public function save_post_product( $post_id, $post, $update ) {
		...
		$post_meta_arr = [ 
			...
			'_xfavi_custom_type_tag_name_4',
			'_xfavi_custom_type_tag_name_5',
			'_xfavi_custom_type_tag_name_6',
			'_xfavi_custom_type_tag_name_7',
			'_xfavi_custom_type_tag_name_8',
			'_xfavi_custom_type_tag_name_9',
			'_xfavi_custom_type_tag_name_10',
			'_xfavi_custom_type_tag_name_11',
			'_xfavi_custom_type_tag_value_1',
			'_xfavi_custom_type_tag_value_2',
			'_xfavi_custom_type_tag_value_3',
			'_xfavi_custom_type_tag_value_4',
			'_xfavi_custom_type_tag_value_5',
			'_xfavi_custom_type_tag_value_6',
			'_xfavi_custom_type_tag_value_7',
			'_xfavi_custom_type_tag_value_8',
			'_xfavi_custom_type_tag_value_9',
			'_xfavi_custom_type_tag_value_10',
			'_xfavi_custom_type_tag_value_11',
			'_xfavi_cabinet_type'
		];
		...
		<div id="xfavi_added_wc_tabs" class="panel woocommerce_options_panel">
			...
			<div class="options_group">
				...
				for ( $i = 1; $i < 12; $i++ ) {
					...
					woocommerce_wp_text_input( [ 
						'id' => '_xfavi_custom_type_tag_name_' . $i,
						'label' => sprintf( '%s',
					...
					woocommerce_wp_text_input( [ 
						'id' => '_xfavi_custom_type_tag_value_' . $i,
						'label' => sprintf( '%s',
