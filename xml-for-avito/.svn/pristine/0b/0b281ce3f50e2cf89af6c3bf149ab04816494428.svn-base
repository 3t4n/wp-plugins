...
if ( ! function_exists( 'xfavi_replace_decode' ) ) {
	/**
	 * @since 3.3.16
	 *
	 * @return string
	 */
	function xfavi_replace_decode( $string, $feed_id = '1' ) {

		$string = str_replace( "+", 'xfavi', $string );
		$string = urldecode( $string );
		$string = str_replace( "xfavi", '+', $string );
		$string = apply_filters( 'xfavi_replace_decode_filter', $string, $feed_id );
		return $string;
