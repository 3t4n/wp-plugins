...
Tags: wp mail log, mail logging, mail logs, email
...
The "WordPress Email Logging - PostBox" plugin saves wp mail sent data from your WordPress.
...
* It is working as SMTP logs. We can easily check email data.
