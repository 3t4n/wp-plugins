...
class PBEML_Popup{
    ...
    public static function get_popup_data( $data ){
        ...
        <div class="tabel">
            <table>
                <tr>
                    <td class="td-4"><?php esc_attr_e('ID', 'postbox-email-logs') ?></td>
                    <td class="td-8 send-at"><?php echo esc_html( $data['id'] ) ?></td>
                </tr>
                <tr>
                    <td class="td-4"><?php esc_attr_e('Sent at', 'postbox-email-logs') ?></td>
                    <td class="td-8 send-at"><?php echo esc_html( $sent_date ) ?></td>
                </tr>
                <tr>  
                    <td class="td-4"><?php esc_attr_e('To', 'postbox-email-logs') ?></td>
                    <td class="td-8 to"><?php echo esc_html($to_email) ?></td>
                </tr>
                <tr>
                    <td class="td-4"><?php esc_attr_e('Reply-To', 'postbox-email-logs') ?></td>
                    <td class="td-8 reply-to"><?php echo esc_html($reply_to) ?></td>
                </tr>
                <tr>
                    <td class="td-4"><?php esc_attr_e('Subject', 'postbox-email-logs') ?></td>
                    <td class="td-8 subject"><?php echo esc_html($subject) ?></td>
                </tr>
                <tr>
                    <td class="td-4"><?php esc_attr_e('Status', 'postbox-email-logs') ?></td>
                    <td class="td-8 status">
                        <?php echo empty($data['error_message']) ?
                        esc_attr_e('Successfully Sent', 'postbox-email-logs') :
        ...
        <div id="pbeml-tabs">
            <ul>
                <li><a href="#tab-preview"><?php esc_attr_e('Message Preview','postbox-email-logs') ?></a></li>
                <li><a href="#tab-source"><?php esc_attr_e('Source','postbox-email-logs') ?></a></li>
                <li><a href="#tab-headers"><?php esc_attr_e('Headers','postbox-email-logs') ?></a></li>
            </ul>
            ...
            <div id="tab-source">
                <?php echo Utility\esc_html( $source );  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
            </div>
            <div id="tab-headers">
                <div class="tabel">
                    <table>
