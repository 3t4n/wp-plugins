    ...
    <div class="totalcontest-tabs-content">
        ...
        <div class="totalcontest-tab-content active">
            <div class="totalcontest-customization">
                <img src="<?php echo esc_attr(TotalContest()->env( 'url' ) . 'assets/dist/images/editor/customization.svg'); ?>" alt="Customization">
                ...
                <a href="<?php echo esc_attr(TotalContest()->env( 'links.customization' )); ?>" target="_blank" class="button button-primary button-large"><?php  esc_html_e( 'Get a quote', 'totalcontest' ); ?></a>
            </div>
        </div>
    </div>
</div>
