	...
	<div class="totalcontest-integration-steps-item">
		...
		<div class="totalcontest-integration-steps-item-content">
			...
			<div class="totalcontest-integration-steps-item-copy">
				...
				<input name="" type="text" readonly onfocus="this.setSelectionRange(0, this.value.length)" value="<?php echo esc_attr($permalink); ?>">
				<button type="button" class="button button-primary button-large" copy-to-clipboard="<?php echo esc_attr($permalink); ?>">
