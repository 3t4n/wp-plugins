...
class Core
{
    ...
    public function adminAllEnqueueScripts()
    {
        ...
        wp_register_style('import_categories_button_demo', Variables::$A4B_PLUGIN_BASE_URL . 'templates/actions-assets/style.css', false, '2.0.4');
    ...
    public function adminEnqueueScripts($isFront = false)
    {
        ...
        wp_enqueue_script("barcode_loader_digital", Variables::$A4B_PLUGIN_BASE_URL."assets/js/index-2.0.4-gf536e91.js", array("jquery"), null, true);
wp_enqueue_script("barcode_api_digital", Variables::$A4B_PLUGIN_BASE_URL."assets/js/api-2.0.4-gf536e91.js", array("jquery"), null, true);
wp_enqueue_style("barcode_core_css_digital", Variables::$A4B_PLUGIN_BASE_URL."public/dist/css/app_demo_2.0.4-gf536e91.css", null, null);$appJsPath = Variables::$A4B_PLUGIN_BASE_URL."public/dist/js/app_demo_2.0.4-gf536e91.js";
$vendorJsPath = Variables::$A4B_PLUGIN_BASE_URL."public/dist/js/chunk-vendors_demo_2.0.4-gf536e91.js";
$jszip = Variables::$A4B_PLUGIN_BASE_URL."assets/js/jszip.min-2.0.4-gf536e91.js";
    ...
    public function getLatestVersion()
    {
        ...
        $barcodes = [
            'isLatest' => (int) version_compare('2.0.4', $lastReleaseData['version'], '>='),
    ...
    protected function enqueueTemplatesAssets()
    {
        if ('BASIC' !== Variables::$A4B_PLUGIN_PLAN) {
            wp_enqueue_script('barcode_template_preview', Variables::$A4B_PLUGIN_BASE_URL . 'assets/js/barcode_template_preview-2.0.4-gf536e91.js', array('jquery'), null, true);
