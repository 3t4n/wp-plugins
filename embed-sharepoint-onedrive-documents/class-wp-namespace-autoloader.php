...
moazure_include_file( MO_SPS_PLUGIN_DIR . 'Controller' );
moazure_include_file( MO_SPS_PLUGIN_DIR . 'Wrappers' );
moazure_include_file( MO_SPS_PLUGIN_DIR . 'Observer' );
moazure_include_file( MO_SPS_PLUGIN_DIR . 'View' );
moazure_include_file( MO_SPS_PLUGIN_DIR . 'API' );
