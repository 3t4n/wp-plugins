<?php
/**
 * Holds the AdvancedSettings class instance.
 *
...
use WP_Roles;
/**
 * Class to handle advanced Settings.
 */
class AdvancedSettings {
	/**
	 * Holds the singleton instance of the AdvancedSettings.
	 *
	 * @var AdvancedSettings
	 */
	private static $instance;
	/**
	 * Returns the singleton instance of the AdvancedSettings.
	 * If the instance does not exist, it creates a new one.
	 *
	 * @return AdvancedSettings The singleton instance of the AdvancedSettings.
	 */
	...
	/**
	 * Function to display manual sync settings
	 *
	 * @return void
	 */
