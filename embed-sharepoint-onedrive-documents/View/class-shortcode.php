<?php
/**
 * Handle all the view part and tab navigation for Shortcode tab
 *
 ...
 * Class Shortcode
 *
 * Handles the display and functionality for the shortcode view.
 *
 * @package MoSharePointObjectSync\View
 */
class Shortcode {
	...
	/**
	 * Displays the tab details for the shortcode.
	 */
	...
	/**
	 * Displays the manual settings for embedding SharePoint documents.
	 */
