...
⭐ *We're excited to present the renewed version of CM Search and Replace! Featuring a brand-new, intuitive design, the plugin is now more user-friendly than ever, making it easier to create and manage your search and replace rules with precision.*
...
* Define search/replace rules for site and page titles, content, excerpts, link, comments and images.
* Support custom posts types.
* Support Regex rules.
* Support search replace based on timeframes.
...
1. Form for Creating Search and Replace Rules
2. Extended Settings (and Showcasing Pro Options)
3. Examples of Created Search and Replace Rules
4. Front-end Example
...
* Improvement in new user interface
