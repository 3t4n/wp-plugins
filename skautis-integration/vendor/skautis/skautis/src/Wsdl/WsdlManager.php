...
use Skautis_Integration\Vendor\Skautis\EventDispatcher\EventDispatcherInterface;
use Skautis_Integration\Vendor\Skautis\Config;
...
class WsdlManager
{
     ...
     * @var array
     */
    protected $aliases = ["user" => "UserManagement", "usr" => "UserManagement", "org" => "OrganizationUnit", "app" => "ApplicationManagement", "event" => "Events", "events" => "Events"];
    /**
     * Dostupné webové služby SkautISu
     *
     * @var array
     */
    protected $supportedWebServices = ["ApplicationManagement", "ContentManagement", "DocumentStorage", "Evaluation", "Events", "Exports", "GoogleApps", "Grants", "Insurance", "Journal", "Material", "Message", "OrganizationUnit", "Power", "Reports", "Summary", "Task", "Telephony", "UserManagement", "Vivant", "Welcome"];
    /**
     * @var array
     */
    ...
    {
        $this->webServiceListeners[] = ['eventName' => $eventName, 'callback' => $callback];
    }
}
