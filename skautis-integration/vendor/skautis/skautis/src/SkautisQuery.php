...
class SkautisQuery implements \Serializable
{
    ...
    {
        $data = ['fname' => $this->fname, 'args' => $this->args, 'trace' => $this->trace, 'time' => $this->time, 'result' => $this->result, 'exception_class' => \is_null($this->exception) ? "" : \get_class($this->exception), 'exception_string' => \is_null($this->exception) ? "" : (string) $this->exception];
