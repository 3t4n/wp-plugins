...
class OrderTablePage extends BasePage
{
    public function __construct()
    {
        parent::__construct();

        $this->page_id = 'ambikly-order-table-page';

        $this->page_title = esc_html__('Orders', 'ambikly');
    ...
    public function output()
    {
        ...
        <div class="wrap ambikly-admin-page <?php echo esc_attr($this->page_id) ?>">
            <a style="display: none" href="<?php echo esc_url(admin_url('admin.php?page=ambikly&sub=new-order')); ?>"
               class="page-title-action ambikly-add-new-button">
                <?php echo esc_html__('New Order', 'ambikly'); ?>
            </a>
