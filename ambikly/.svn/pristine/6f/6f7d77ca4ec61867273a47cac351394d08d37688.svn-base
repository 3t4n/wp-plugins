...
// Toggle functionality for menu items
document.querySelectorAll('.toggle-icon').forEach(function (toggleIcon) {
    toggleIcon.addEventListener('click', function (e) {
        var target = e.target;
        var parentMenuItem = target.closest('.menu-item');
        parentMenuItem === null || parentMenuItem === void 0 ? void 0 : parentMenuItem.classList.toggle('open'); // Add 'open' class to toggle visibility
    });
});
...
/******/ })()
;
//# sourceMappingURL=setting-script.js.map