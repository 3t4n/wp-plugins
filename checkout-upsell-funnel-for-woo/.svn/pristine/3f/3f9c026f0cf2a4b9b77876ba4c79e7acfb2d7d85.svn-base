...
class VICUFFW_CHECKOUT_UPSELL_FUNNEL_Admin_Upsell_Funnel {
	...
	public function save_settings() {
		...
		if ( isset( $_POST['vi-wcuf-save'] ) || isset( $_POST['vi-wcuf-check_key'] ) ) {
			...
			if ($update_prefix){
				update_option( 'viwcuf_upsell_funnel_prefix', substr( md5( gmdate( "YmdHis" ) ), 0, 10 ) );
            }
                ...
                <form class="vi-ui form" method="post">
                    ...
                    <div class="vi-ui bottom attached tab segment active" data-tab="general">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label><?php esc_html_e( 'Remove after adding', 'checkout-upsell-funnel-for-woo' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/oeemke"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'checkout-upsell-funnel-for-woo' ); ?> </a>
                                    <p class="description">
										<?php esc_html_e( 'Remove a product from the upsells list right after being added to cart', 'checkout-upsell-funnel-for-woo' ); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <label><?php esc_html_e( 'Exclude added products', 'checkout-upsell-funnel-for-woo' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/oeemke"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'checkout-upsell-funnel-for-woo' ); ?> </a>
                                    <p class="description">
										<?php esc_html_e( 'Exclude products which are already in a customer\'s cart', 'checkout-upsell-funnel-for-woo' ); ?>
                                    </p>
                                </td>
                            </tr>
	                        <?php
                                ...
                                <td>
                                    ...
                                    <select name="us_desktop_style" class="vi-ui fluid dropdown vi-wcuf-us_desktop_style" id="vi-wcuf-us_desktop_style">
										...
										foreach ( $us_style as $k => $v ) {
											echo sprintf( '<option value="%s" %s>%s</option>', esc_attr( $k ), selected( $us_desktop_style, $k ), esc_html( $v ) );
										}
										?>
                                    </select>
                                    <p class="description">
                                ...
                                <td>
                                    <select name="us_desktop_position" id="vi-wcuf-us_desktop_position" class="vi-ui fluid dropdown vi-wcuf-us_desktop_position">
										...
										foreach ( $checkout_pos as $k => $v ) {
											echo sprintf( '<option value="%s" %s>%s</option>', esc_attr( $k ), selected( $us_desktop_position, $k ), esc_html( $v ) );
										}
										?>
                                    </select>
                                    <p class="description">
                            ...
                            <tr class="vi-wcuf-us_mobile_enable-enable <?php echo esc_attr($us_mobile_enable ? '' :  'vi-wcuf-hidden' ); ?>">
                                ...
                                <td>
                                    <select name="us_mobile_style" class="vi-ui fluid dropdown vi-wcuf-us_mobile_style" id="vi-wcuf-us_mobile_style">
										<?php
										foreach ( $us_style as $k => $v ) {
											echo sprintf( '<option value="%s" %s>%s</option>', esc_attr( $k ), selected( $us_mobile_style, $k ), esc_html( $v ) );
										}
										?>
                                    </select>
                                    <p class="description">
                            ...
                            <tr class="vi-wcuf-us_mobile_enable-enable vi-wcuf-us_mobile_position-wrap <?php echo esc_attr( $us_mobile_enable && $us_mobile_style === '1' ? '' : 'vi-wcuf-hidden' ); ?>">
                                ...
                                <td>
                                    <select name="us_mobile_position" id="vi-wcuf-us_mobile_position" class="vi-ui fluid dropdown vi-wcuf-us_mobile_position">
										<?php
										foreach ( $checkout_pos as $k => $v ) {
											echo sprintf( '<option value="%s" %s>%s</option>', esc_attr( $k ), selected( $us_mobile_position, $k ), esc_html( $v ) );
										}
										?>
                                    </select>
                                    <p class="description">
                            ...
                            <tr>
                                <th>
                                    <label><?php esc_html_e( 'Custom CSS', 'checkout-upsell-funnel-for-woo' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/oeemke"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'checkout-upsell-funnel-for-woo' ); ?> </a>
                                        ...
                                        <div class="equal width fields">
                                            <div class="field">
                                                ...
                                                <select name="us_product_type[]" class="vi-ui fluid dropdown vi-wcuf-us_product_type">
                                                    ...
                                                    <option disabled>
														<?php esc_html_e( 'Products in the cart', 'checkout-upsell-funnel-for-woo' ); ?>
                                                    </option>
                                                </select>
                                                <p class="description">
                                                ...
                                                <div class="vi-ui right action labeled input">
                                                    ...
                                                    <select name="us_discount_type[]" id="vi-wcuf-us_discount_type" class="vi-ui fluid dropdown vi-wcuf-us_discount_type">
                                                        ...
                                                        <option value="2" <?php selected( $us_discount_type, '2' ) ?>>
                                                            ...
                                                            echo sprintf( esc_html__( 'Fixed(%s) regular price', 'checkout-upsell-funnel-for-woo' ), esc_html( $woo_currency_symbol ) ); ?>
                                                        </option>
                                                        ...
                                                        <option value="4" <?php selected( $us_discount_type, '4' ) ?>>
															<?php /* translators: %s: currency symbol */
                                                            echo sprintf( esc_html__( 'Fixed(%s) price', 'checkout-upsell-funnel-for-woo' ), esc_html( $woo_currency_symbol ) ); ?>
                                                        </option>
                                                    </select>
                                                </div>
                                                <p class="description">
	...
	public function admin_enqueue_scripts() {
		if ( isset( $_REQUEST['_viwcuf_settings_us'] ) && ! wp_verify_nonce( wc_clean($_REQUEST['_viwcuf_settings_us']), '_viwcuf_settings_us_action' ) ) {
			return;
		}
