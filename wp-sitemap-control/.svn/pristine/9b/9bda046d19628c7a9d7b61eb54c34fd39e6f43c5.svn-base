...
3. **Issue Pull Requests:** If you're a developer, the easiest way to get involved is to help out on [issues already reported](https://github.com/iworks/wp-sitemap-control/issues) in GitHub. Be sure to check out the [contributing guide](https://github.com/iworks/wp-sitemap-control/blob/master/contributing.md) for developers.
...
* The [iWorks Rate](https://github.com/iworks/iworks-rate) module has been updated to 2.2.2.
