...
echo '<p>';
esc_html_e( 'Would you like to boost your website sharing abilities?', 'wp-sitemap-control' );
echo '</p>';
echo '<p>';
printf(
	/* translators: %s is a plugin name with url */
	esc_html__( 'Don\'t wait, install plugin %s!', 'wp-sitemap-control' ),
...
"><?php echo esc_html( __( 'Install', 'wp-sitemap-control' ) ); ?></a></p>
