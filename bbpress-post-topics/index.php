...
Version: 2.2.9
Revision Date: 13/01/2025
Author URI: http://www.rewweb.co.uk/
Text Domain: bbpress-post-topics
License: GPL2

*/
/*  Copyright 2013-2025 David Dean, Robin Wilson,Nick Chomey
	...
	function process_topic_option( $post_ID, $post, $update ) {
		...
		if( isset( $_POST['bbpress_topic'] ) ) {
			...
			if( ! empty( $_POST['bbpress_topic']['enabled'] ) ) {
				...
				$bbppt_options ['copy_tags']=(!empty ($_POST['bbpress_topic']['copy_tags']) ? sanitize_text_field ($_POST['bbpress_topic']['copy_tags']) : '');
				...
				$bbppt_options ['use_defaults']= (!empty ($_POST['bbpress_topic']['use_defaults']) ? sanitize_text_field ($_POST['bbpress_topic']['use_defaults']) : '');
				...
				$bbppt_options['slug'] = (!empty ($_POST['bbpress_topic']['slug']) ? sanitize_text_field ($_POST['bbpress_topic']['slug']) : '');
