...
class Auth {
    ...
    public static function init() {
        ...
        if(WP::isPro()) {
            ...
            add_action('init', [__CLASS__, 'inspectRequest']);                    
            add_filter('the_content', [__CLASS__, 'filterContent'], PHP_INT_MAX, 1);
            add_filter('comments_array', [__CLASS__, 'filterComments'], PHP_INT_MAX, 1);
            add_filter('comments_open', [__CLASS__, 'allowComments'], PHP_INT_MAX, 1);            
            add_filter('em_filter_content', [__CLASS__, 'emFilterContent']);        
