...
class Revenue_Ajax {
	...
	public function get_trigger_items() {
		...
		$trigger_type = isset( $_GET['type'] ) ? sanitize_text_field( $_GET['type'] ) : '';

		$search_keyword = isset( $_GET['term'] ) ? sanitize_text_field( $_GET['term'] ) : '';
	...
	public function search_products( $term, $include_variations = false ) {
		...
		$source         = isset( $_GET['source'] ) ? sanitize_text_field( $_GET['source'] ) : '';
		$trigger_action = isset( $_GET['trigger_action'] ) ? sanitize_text_field( $_GET['trigger_action'] ) : '';
		$include_cats   = isset( $_GET['include_cats'] ) ? array_map( 'absint', $_GET['include_cats'] ) : false;
	...
	public function add_to_cart() {
		...
		// print_r('<pre>'); print_r($cart_subtotal); print_r('</pre>');
		// print_r('<pre>'); print_r($cart_total); print_r('</pre>');
