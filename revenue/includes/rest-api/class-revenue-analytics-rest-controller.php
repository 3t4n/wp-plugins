        ...
        if(defined('WPXPO_DEMO') && WPXPO_DEMO) {
            ...
            foreach (revenue()->get_campaign_types() as $campaign_type => $value) {
                $current_period_results[$campaign_type] = [
                    'date' => date("Y-m-d"),
                    'type' => $campaign_type,
                    'add_to_cart_count' => rand(50, 1000),
                    'impression_count' => rand(50, 1000),
                    'conversion_rate' => rand(50, 100),
                    'total_sales' => rand(50, 1000),
                    'orders_count' => rand(50, 1000),
                    'average_order_value' => rand(50, 1000),
                    'contribute' => rand(20, 100),
                ];
	...
	public function get_campaigns_stats( $request ) {
		...
		foreach ($current_period_results as $date => $data) {
			$current_period_results[$date] = [
				'total_sales' => rand(20,1000),
				'rejection_count' => rand(1,100),
				'add_to_cart_count' => rand(50,100),
				'impression_count' => rand(500,1000),
				'conversion_rate' => rand(1,100),
