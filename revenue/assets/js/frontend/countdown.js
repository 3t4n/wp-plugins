                ...
                countDownData.forEach((campaignID) => {
                    ...
                    let updateCountdown = function() {
                        ...
                        if (distance < 0) {
                            ...
                            $(`.revx-countdown-timer-container[data-campaign-id=${campaignID}]`).addClass('revx-d-none');
                    ...
                    //  $(`#revx-countdown-timer-${campaignID}`).removeClass('revx-d-none');
                     ...
                     $(`.revx-countdown-timer-container[data-campaign-id=${campaignID}]`).removeClass('revx-d-none');
