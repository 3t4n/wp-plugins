...
Tags: frakt,fraktkoppling,orderkoppling,WooCommerce,shipping
Contributors: Fraktjakt
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

Fraktjakt all-in-one shipping method plugin for WooCommerce.
...
Bring, Posten/PostNord, Schenker, DHL, DSV, UPS, FedEx Express, NTEX and more!

[strong]This plugin is not actively developed anymore, please refer to Krokedil's Fraktjakt integration if you need support[/strong]
Krokedil's Fraktjakt integration is a more feature rich and updated plugin that is strongly recommended for new as well as old webshops in need of active support and new features;
[https://krokedil.se/produkt/fraktjakt/](https://krokedil.se/produkt/fraktjakt/ "https://krokedil.se/produkt/fraktjakt/")
...
See Krokedil's Fraktjakt integration for a more feature rich and updated plugin
[https://krokedil.se/produkt/fraktjakt/](https://krokedil.se/produkt/fraktjakt/ "https://krokedil.se/produkt/fraktjakt/")
...
Version 2.6.0 of this plugin requires WooCommerce HPOS.
...
= 2.6.0 - Support for WooCommerce HPOS (2024-06-25) =
* BREAKING CHANGE: The plugin now supports WooCommerce new High-Performance Order Storage (HPOS).
This version requires HPOS activation to work properly.
Any webshop still relying on the older order tables, will have to use older versions of this plugin.

= 2.5.1 - Fixes for merchant control, agent selection and buttons (2023-05-10) =
* Consolidates server settings
* Adds fix for cookie params
* Removed separate set of settings for test environment (use the test settings on production server instead)
* Removed incorrect notice about cart

= 2.5.0 - Fixes for merchant control, agent selection and buttons (2023-02-27) =
* Adds fix for missing volume and weight on products while on merchant controlled shipping
* Adds fix for manage shipment button on orders
* Adds fix agent selection links in emails

= 2.4.8 - Better customer controlled shipping (2022-11-17) =
* Added a fixes and optimizations for quicker customer controlled shipping.
* Support for Fraktjakt API version 4.3.1

= 2.4.7 - Hotfix for residential addresses (2022-09-21) =
* Added a quick hotfix for better handling of residential addresses.

= 2.4.6 - API selection, Company name and Pickup optimizations (2022-09-21) =
* New: Added a Create order connection button under each order view that is missing an order connection.
* Optimization: Better error handling when various params and meta data are missing
* Optimization: Smarter selection of API for each usecase.
* Bugfix: Ignores saved login data when the admin is creating merchant controlled shipments
* Layout: Overrides selection of presenting shipping company for local pickup, so that "Own shipping" always displays its title even when the setting for presenting shipping company is disabled.
* Layout: Overrides selection of presenting distance for local pickup, so that "Own shipping" never displays estimated distance even when the setting for presenting distance is enabled.

= 2.4.5 - Better support for local pickup, B2B and various form data (2022-09-01) =
* Added better support for B2B shipping options.
* Added quick link to the plugin settings from the plugins list.
* Cleaned up presentation of "Own shipping service" (Fraktjakt's local pickup option)
* Skips order connection with Fraktjakt for orders with only virtual products.
* Retrieves saved addresses from logged in users on shipping calculations outside the address form
* Retrieves customer phone info from both shipping and billing if either is missing.
* Support for WooCommerce default local_pickup method, ignoring order connection for WooCommerce built-in pickup method.
* Layout: Avoids redundant comma when the shipping company info is deactivated.
* Support for Fraktjakt API version 4.3
* Various optimizations and fixes.

= 2.4.4 - Better support for Klarna and other weight units (2022-02-23) =
* Added a setting to enable/disable the optimization of avoiding shipping calculations outside of cart and checkout since it may cause problems with some other third party plugins.
* Added conversion and support for different weight units for products.
* Added conversion and support for different dimension units for products.
* Additional failsafe protection for the usage of the fallback option
* Support for Fraktjakt API version 4.1
* Various optimizations of code base
