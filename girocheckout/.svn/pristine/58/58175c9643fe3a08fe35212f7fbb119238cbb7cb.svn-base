<?php
class gc_sofortuw extends WC_Payment_Gateway {
  ...
  public function __construct() {
    ...
    $this->id = 'gc_sofortuw';
    $this->method_title = __('SOFORT Überweisung', 'girocheckout');
    $this->title = __('SOFORT Überweisung', 'girocheckout');
    $this->icon = plugins_url('img/gc_sofortuw.png', dirname(__FILE__));
    ...
    $this->description = __('Direct payment via online banking. Make payments the easy way with your own online banking details – fast and direct. You will be redirected to the web site of SOFORT, where you will enter your banking data and initiate the electronic wire transfer.', 'girocheckout');
  ...
  public function init_form_fields() {
    $this->form_fields = array(
        ...
        'enabled' => array(
            ...
            'type' => 'checkbox',
            'label' => __('Enable SOFORT Überweisung', 'girocheckout'),
            'default' => 'no',
        ),
        'title' => array(
            ...
            'default' => __('SOFORT Überweisung', 'girocheckout'),
            'desc_tip' => true,
        ),
        'merchantid' => array(
  ...
  public function admin_options() {
    ?>
    <h3><?php _e('SOFORT Überweisung', 'girocheckout'); ?></h3>
    <p><?php _e('GiroCheckout SOFORT-Überweisung payment', 'girocheckout'); ?></p>
