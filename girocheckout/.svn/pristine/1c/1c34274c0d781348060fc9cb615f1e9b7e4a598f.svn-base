...
class GiroCheckout_SDK_IdealSenderInfo extends GiroCheckout_SDK_AbstractApi implements GiroCheckout_SDK_InterfaceApi {

    protected $m_iPayMethod = GiroCheckout_SDK_Config::FTG_SERVICES_PAYMENT_METHOD_GIROPAY;
    protected $m_strTransType = GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_IDEAL_SENDERINFO;
     ...
     */
    protected $requestURL = "https://payment.girosolution.de/girocheckout/api/v2/ideal/senderinfo";
