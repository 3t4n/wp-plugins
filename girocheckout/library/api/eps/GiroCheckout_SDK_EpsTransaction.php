...
class GiroCheckout_SDK_EpsTransaction extends GiroCheckout_SDK_AbstractApi implements GiroCheckout_SDK_InterfaceApi {
    ...
    protected $m_iPayMethod = GiroCheckout_SDK_Config::FTG_SERVICES_PAYMENT_METHOD_EPS;
    protected $m_strTransType = GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_EPS_TRANSACTION;
