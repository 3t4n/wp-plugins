 ...
 * @subpackage FG_OpenCart_to_WooCommerce/admin/partials
 */
?>
<div id="fgoc2wc_admin_page" class="wrap">
	<h1><?php print $data['title'] ?></h1>
	
	<p><?php print $data['description'] ?></p>
	
	<div id="fgoc2wc_settings">
...
<?php default: ?>
		...
		<form id="form_import" method="post">
			...
			<?php wp_nonce_field( 'parameters_form', 'fgoc2wc_nonce' ); ?>

			<table class="form-table">
				<?php require('settings.php'); ?>
				<?php do_action('fgoc2wc_post_display_settings_options'); ?>
				...
				<?php do_action('fgoc2wc_post_display_behavior_options'); ?>
