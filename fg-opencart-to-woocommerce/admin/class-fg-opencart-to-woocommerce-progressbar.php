...
if ( !class_exists('FG_OpenCart_to_WooCommerce_ProgressBar', false) ) {
	 ...
	 */
	class FG_OpenCart_to_WooCommerce_ProgressBar {
		 ...
		 *
		 * @param    FG_OpenCart_to_WooCommerce_Admin    $plugin       Admin plugin
		 */
