 ...
 * @subpackage FG_OpenCart_to_WooCommerce_Premium/includes
 * @author     Frédéric GILLES
 */

if ( !class_exists('FG_OpenCart_to_WooCommerce_DebugInfo', false) ) {
	class FG_OpenCart_to_WooCommerce_DebugInfo {
		
		private $option_names_filter = 'fgoc2wc_get_option_names';
