        ...
        if (isset($decodedChargeResponse->data->clover_payment_status)) {
            ...
            if ('paid' === $decodedChargeResponse->data->clover_payment_status) {
                ...
                if (isset($decodedChargeResponse->error->message)) {
                    $declineReason = $decodedChargeResponse->error->message;
                } elseif (isset($decodedChargeResponse->data->decline_reason)) {
                    $declineReason = $decodedChargeResponse->data->decline_reason;
                }

                LogService::error(sprintf(
                    'Payment declined for WooCommerce order (#%d) - Reason: %s',
                    $order->get_id(),
