( function (blocks, editor, components, i18n, element ) {
	...
	registerBlockType( 'embed-block-for-tiktok/video', {
		title: i18n.__( 'TikTok Video' ),
		description: i18n.__( 'A block to embed your TikTok Videos.' ),
		icon: tiktok_icon,
		keywords: [ i18n.__( 'tiktok' ), i18n.__( 'video' ), i18n.__( 'embed' ) ],
		category: 'embed',
		attributes: {
			tiktok_url: {
	    		type: 'string',
		...
		edit: function ( props ) {
			...
			return [
				el( 'div', { className: 'components-block-description' },
					el( ServerSideRender, {
						block: 'embed-block-for-tiktok/video',
				...
				el(
					...
					el(
						components.PanelBody, {
							title: i18n.__( 'TikTok Video' ),
							className: 'block-tiktok-video',
							initialOpen: true
						},
						el(
							TextControl, {
								type: 'text',
								label: i18n.__( 'Enter the URL of the TikTok Video' ),
								value: tiktok_url,
