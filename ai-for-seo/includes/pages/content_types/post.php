...
echo "<div class='ai4seo-automated-generation-settings-wrapper'>";
    ...
    echo "<label for='ai4seo-automated-generation-new-or-existing-filter-select'>";
        echo "<span>" . esc_html__("Generate metadata for:", "ai-for-seo") . "</span> ";
...
echo "</label>";
    ...
    echo "<label for='ai4seo-toggle-automated-generation-checkbox'>";
        ...
        echo sprintf(esc_html__("Turn on bulk generation for %s.", "ai-for-seo"), esc_html($ai4seo_translated_post_type_plural));
        echo " ";
        echo sprintf(esc_html__("Approximate processing speed: %.1f %s/min.", "ai-for-seo"), esc_html(AI4SEO_APPROXIMATE_METADATA_GENERATION_SPEED), esc_html($ai4seo_translated_post_type_plural));
...
echo "<table class='widefat striped table-view-list pages ai4seo-posts-table'>";
    ...
    foreach ($ai4seo_all_posts as $ai4seo_this_post) {
        ...
        if ($ai4seo_current_automated_generation_new_or_existing_filter == "new" && $ai4seo_this_post_date_timestamp <= $ai4seo_automated_generation_new_or_existing_filter_reference_timestamp) {
            $ai4seo_is_excluded_by_new_or_existing_filter = true;
        } else if ($ai4seo_current_automated_generation_new_or_existing_filter == "existing" && $ai4seo_this_post_date_timestamp > $ai4seo_automated_generation_new_or_existing_filter_reference_timestamp) {
            $ai4seo_is_excluded_by_new_or_existing_filter = true;
        }
