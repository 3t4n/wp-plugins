...
echo "<div class='ai4seo-form ai4seo-editor-form'>";
    ...
    echo "<div class='ai4seo-modal-buttons'>";
        ...
        echo "<div id='ai4seo-modal-right-button' class='ai4seo-modal-right-button'>";
            echo "<button type='button' onclick='ai4seo_submit_ajax_modal(\"ai4seo_save_metadata_editor_values\");' class='button ai4seo-button ai4seo-success-button ai4seo-modal-submit-button'>" . esc_html__("Submit", "ai-for-seo") . "</button>";
        echo "</div>";
