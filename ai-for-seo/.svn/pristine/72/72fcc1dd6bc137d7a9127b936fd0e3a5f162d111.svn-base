...
During the first 14 days after purchasing a plan (Basic, Pro or Premium), if *AI for SEO* isn’t the best fit, simply reach out at [info@aiforseo.ai](mailto:info@aiforseo.ai)!
...
- 1.3.0: Keyphrase / keywords generation (~February 2025)
- 1.4.0: Content Optimizations (Recommended SEO-relevant improvements across all your content) (~April 2025)
- 2.0.0: Automatic blog post generator (~Q2 2025)
...
- Navigate to the plugin settings and locate the 'Sync Changes' section.
- Check the box next to your desired SEO plugin to activate syncing.
If you're using the bulk generation feature, make sure the relevant meta tags are enabled in the 'Overwrite Existing Metadata' section to replace outdated data within your existing SEO plugin.
...
Yes, just deactivate the 'Activate bulk generation' option to stop generating new metadata automatically. The same applies to the 'Activate bulk generation' option for media attributes.

= Does the bulk generation feature work for new content? =
Yes, the 'Activate bulk generation' option will generate data, both for existing content and new entries as they're created.

= Will the bulk generation feature affect existing data? =
Not by default. However, you can enable this option in the settings if needed.

= Is there any way to control what meta tags are outputted? =
Yes, in the settings, you can choose to include or exclude specific meta tags from the header output generated by our plugin. This gives you full control to customize the meta tags based on your specific requirements.
...
Yes, AI for SEO fully supports Multi-Site installations. Simply purchase a plan on your primary website and use the same username and license key across all your sub-sites.

= Can I use my already purchased subscription on another website? =
Yes, you can use your existing subscription on another website. Just enter the same username and license key on the new website to activate your subscription. Keep in mind that your subscription usage (e.g., credits) will be shared across all connected websites.
...
The plugin is optimized for maximum performance and there are no measurable effects on the backend or the frontend of your website.
...
Yes, the plugin does support multi-language websites that are based on the WPML-plugin. By using the WPML-plugin you can generate metadata and media-attributes separately for each available language.
...
= 1.2.11 =
* Enhanced license username and key management: You can now view your username and license key directly in the plugin dashboard using the "Show Licence" button.
...
= 1.2.8 =
* Added a "Lost your licence key?" link to the "Already purchased?" section on the dashboard page.
* Added 3 FAQ entries regarding what to do if you lose your licence key, how to handle third party seo plugins.
