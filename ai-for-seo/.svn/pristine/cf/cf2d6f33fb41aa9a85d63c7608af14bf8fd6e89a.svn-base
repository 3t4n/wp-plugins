...
var ai4seo_error_codes_and_messages = {
    ...
    "1115424": wp.i18n.__("Your AI for SEO account does not contain sufficient credits. Please add credits to your account.", "ai-for-seo") + "<br /><br /><a href='" + ai4seo_admin_plugin_page_url + "' target='_blank'>" + wp.i18n.__("Click here to add credits", "ai-for-seo") + "</a>",
};
...
var ai4seo_robhub_api_response_error_codes_and_messages = {
    ...
    "client has insufficient credits": wp.i18n.__("Your AI for SEO account does not contain sufficient credits. Please add credits to your account.", "ai-for-seo") + "<br /><br /><a href='" + ai4seo_admin_plugin_page_url + "' target='_blank'>" + wp.i18n.__("Click here to add credits", "ai-for-seo") + "</a>",
    "No credits left. Please buy more credits.": wp.i18n.__("Your AI for SEO account does not contain sufficient credits. Please add credits to your account.", "ai-for-seo") + "<br /><br /><a href='" + ai4seo_admin_plugin_page_url + "' target='_blank'>" + wp.i18n.__("Click here to add credits", "ai-for-seo") + "</a>",
...
let ai4seo_allowed_ajax_actions = [
    "ai4seo_toggle_automated_generation", "ai4seo_update_automated_generation_order_via_ajax", "ai4seo_update_automated_generation_new_or_existing_filter_via_ajax",
    "ai4seo_submit_licence_key", "ai4seo_display_licence_information", "ai4seo_dismiss_performance_notice",
    ...
    "ai4seo_reset_plugin_data", "ai4seo_submit_troubleshooting_form"
];
...
function ai4seo_check_response( response, additional_error_list = {}, show_generic_error = true, add_contact_us_link = true ) {
    ...
    if (additional_error_list[response.code]) {
        ...
        ai4seo_show_notification_modal(additional_error_list[response.code], response.headline);
    }
    ...
    // Check if response.code (cast to int) is in ai4seo_robhub_api_response_error_codes
        ...
        ai4seo_handle_common_robhub_api_response_errors(response.error, response.code, response.headline);
    }
    ...
    // Check if error-code exists as key in ai4seo_error_codes_and_messages
        ...
        ai4seo_show_notification_modal(ai4seo_error_codes_and_messages[response.code], response.headline);
    }

    else if (show_generic_error) {
        let error_message = (response.error ? response.error + " (" + wp.i18n.__("Error-code", "ai-for-seo") + ": #" + response.code + ")" : "");
        ...
        ai4seo_show_notification_modal(error_message, response.headline);
    }
...
function ai4seo_handle_common_robhub_api_response_errors(error_message, error_code, error_headline = "") {
    ...
    ai4seo_show_notification_modal(error_message + " (" + wp.i18n.__("API error-code", "ai-for-seo") + ": #" + error_code + "). " + wp.i18n.__("An error occurred. Please contact the plugin-developer or try again!", "ai-for-seo"), error_headline);
}

// =========================================================================================== \\

// Function to go through the selector mapping and fill the values
function ai4seo_fill_post_outputs_from_mapping(ai4seo_post_outputs = {}, only_this_selector = false) {
    ...
    for (var selector in all_selectors) {
        ...
        if (typeof ai4seo_post_outputs[endpoint] === "undefined") {
            continue;
        }
...
function ai4seo_open_ajax_modal(ajax_action, ajax_data = {}, disable_modal_submit_button = true) {
    // CHECK AJAX ACTION
    // INIT AJAX MODAL
    ...
    ai4seo_perform_ajax_call(ajax_action, ajax_data, false)
        .then(response => {
            ...
            if (disable_modal_submit_button) {
...
function ai4seo_enable_modal_submit_button() {
    if (!ai4seo_exists(".ai4seo-modal-submit-button")) {
        return;
    }

    // Define variable for the submit-button
    var submit_button = ai4seo_jQuery(".ai4seo-modal-submit-button");
...
function ai4seo_submit_ajax_modal(ajax_action, reload_page_on_success = true) {
    const container_selector = "#ai4seo-ajax-modal";

    // check for editors that don't like reloading after submitting
    if (ai4seo_is_inside_elementor_editor()) {
        reload_page_on_success = false
    }
...
function ai4seo_submit_form_via_ajax(container_selector, ajax_action, success_callback) {
    ...
    // call desired ajax action
    ai4seo_perform_ajax_call(ajax_action, {ai4seo_input_values: all_input_values})
        .then(response => {
...
function ai4seo_toggle_automated_generation(context, checked) {
    // call ajax action ai4seo_toggle_automated_generation
    ai4seo_perform_ajax_call('ai4seo_toggle_automated_generation', {context: context, checked: checked})
        .then(response => {
            window.location.reload();
        })
        .catch(error => { /* auto error handler enabled */ });
    ...
    if (checked) {
        ...
        if (ai4seo_exists(".ai4seo-seo-coverage-progress-bar:not(.ai4seo-progress-bar-finished):not(.ai4seo-green-animated-progress-bar)")) {
        ...
        if (ai4seo_exists(".ai4seo-seo-coverage-progress-bar:not(.ai4seo-started-manually):not(.ai4seo-green-animated-progress-bar)")) {
...
function ai4seo_update_automated_generation_order(context, order) {
    // call ajax action ai4seo_update_automated_generation_order_via_ajax
    ai4seo_perform_ajax_call('ai4seo_update_automated_generation_order_via_ajax', {context: context, order: order})
        .then(response => {
            ai4seo_hide_loading_icons();
        })
        .catch(error => { /* auto error handler enabled */ });
}
...
function ai4seo_update_automated_generation_new_or_existing_filter(context, new_or_existing_filter) {
    // call ajax action ai4seo_update_automated_generation_new_or_existing_filter_via_ajax
    ai4seo_perform_ajax_call('ai4seo_update_automated_generation_new_or_existing_filter_via_ajax', {context: context, new_or_existing_filter: new_or_existing_filter})
        .then(response => {
            window.location.reload();
        })
        .catch(error => { /* auto error handler enabled */ });
...
function ai4seo_submit_new_licence_key() {
    ...
    let username = ai4seo_jQuery("#ai4seo-username-input").val();

    if (username.length < 3) {
        ai4seo_show_notification_modal(wp.i18n.__("Please enter a valid username.", "ai-for-seo") + " #4510271224");
    }
    ...
    let error_list = {
        4710271224: wp.i18n.__("Please enter a valid username.", "ai-for-seo") + " #4710271224",
    ...
    // perform ajax action
    ai4seo_perform_ajax_call('ai4seo_submit_licence_key', {ai4seo_username: username, ai4seo_licence_key: licence_key}, true, error_list)
        .then(response => {
            ai4seo_show_notification_modal(wp.i18n.__("Licence key and username has been saved successfully. Reloading page now...", "ai-for-seo"), wp.i18n.__("Thank you!", "ai-for-seo"));
...
function ai4seo_confirm_display_licence_information() {
    ai4seo_show_notification_modal(wp.i18n.__("Are you sure you want to display the licence information?", "ai-for-seo"), wp.i18n.__("Please confirm", "ai-for-seo"), "<button type='button' class='ai4seo-button ai4seo-abort-button' onclick='ai4seo_hide_notification_modal();'>" + wp.i18n.__("Abort", "ai-for-seo") + "</button><button type='button' class='ai4seo-button ai4seo-success-button' onclick='ai4seo_display_licence_information();'>" + wp.i18n.__("Reveal Licence Information", "ai-for-seo") + "</button>");
}
...
function ai4seo_display_licence_information() {
    // perform ajax action
    ai4seo_perform_ajax_call('ai4seo_display_licence_information')
        .then(response => {
            // reload page
            window.location.reload();
        })
...
function ai4seo_confirm_to_reject_tos() {
    ...
    ai4seo_show_notification_modal(content, headline, reject_button + back_button);
}
...
function ai4seo_show_accept_terms_notification_modal() {
    ai4seo_show_notification_modal(wp.i18n.__("Please accept the terms of service first.", "ai-for-seo"), wp.i18n.__("Attention!", "ai-for-seo"));
...
function ai4seo_perform_ajax_call(action, data = {}, auto_check_response = true, additional_error_list = {}, show_generic_error = true, add_contact_us_link = true) {
    ...
    if (!ai4seo_allowed_ajax_actions.includes(action)) {
        ai4seo_show_notification_modal(wp.i18n.__("An error occurred! Please check your settings or contact the plugin developer.", "ai-for-seo") + " (" + wp.i18n.__("Error-code", "ai-for-seo") + ": #4317101224)");
...
function ai4seo_show_loading_icons(element) {
