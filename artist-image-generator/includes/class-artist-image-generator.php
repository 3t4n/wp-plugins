...
class Artist_Image_Generator {
	...
	private function load_dependencies() {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-artist-image-generator-service.php';
	...
	private function define_admin_hooks() {
        ...
        // Check Credits
        $this->loader->add_action('wp_ajax_get_my_credits', $plugin_admin, 'get_my_credits_ajax');
        $this->loader->add_action('wp_ajax_nopriv_get_my_credits', $plugin_admin, 'get_my_credits_ajax');
        ...
        // Add upscale button to media library
        $this->loader->add_action( 'wp_ajax_media_upscale_image', $plugin_admin, 'handle_media_upscale_image');
	...
	private function define_public_hooks() {
        ...
        // Woocommerce compatibility with AIG Credits Balance
        $woocommerce_active = is_plugin_active('woocommerce/woocommerce.php');
        if ($woocommerce_active) {
            $this->loader->add_action('woocommerce_order_status_completed', $plugin_public, 'handle_order_completed');
            $this->loader->add_action('woocommerce_account_navigation', $plugin_public, 'show_user_balance');
        }
	}
