...
?>
    <script type="text/html" id="tmpl-artist-image-generator-settings">
        <div class="aig-container aig-container-3">
            <div class="card">
                <h2 class="title">
                    <?php esc_html_e('How to start ?', 'artist-image-generator'); ?>
                </h2>
                <p>
                    To configure: <a target="_blank" title="Artist Image Generator - How to start" href="https://artist-image-generator.com/complete-step-by-step-guide-for-bloggers-and-merchants/">Follow this step by step guide</a>
                </p>
                <hr />
                <?php settings_errors(); ?>
    ...
    <script type="text/html" id="tmpl-artist-image-generator-services">
        <div class="aig-container aig-container-3">
            <div class="card">
                ...
                <ul>
                    <li> 
                        <strong><?php esc_html_e('Available credits', 'artist-image-generator'); ?></strong> :
                        <span id="aig-credits-count">loading...</span> 
                    </li>
                </ul>
