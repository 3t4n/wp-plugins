...
add_action ('before_wcfmmp_sold_by_label_product_page', 'epeken_add_kota_asal_vendor_single_product'); 
...
function epeken_add_kota_asal_vendor_single_product($vendor_id) {
 $vendor_data = epeken_get_vendor_data_user_based(get_user_by('id',$vendor_id));
 echo epeken_code_to_city($vendor_data['vendor_data_asal_kota']);
}
