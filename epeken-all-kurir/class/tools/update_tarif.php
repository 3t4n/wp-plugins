...
if(!empty (sanitize_text_field($_POST['save'])) && sanitize_text_field($_POST['save']) === 'Do Classic Checkout') {
	$shipping = WC_Shipping::instance();
        $methods = $shipping -> get_shipping_methods();
        $epeken_tikijne = $methods['epeken_courier'];	
	$epeken_tikijne -> do_classic_checkout();
 ...
 update_option('epeken_markup_tarif_intl', sanitize_text_field($_POST['woocommerce_wc_shipping_tikijne_markup_intl']));
 ...
 update_option('epeken_company_optional', sanitize_text_field($_POST['company_optional']));
 ...
 update_option('epeken_intl_payment_paypal', sanitize_text_field($_POST['epeken_intl_payment_paypal']));
