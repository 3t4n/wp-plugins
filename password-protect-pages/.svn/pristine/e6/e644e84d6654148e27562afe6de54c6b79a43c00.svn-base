=== Plugin Name ===
Contributors: jessn
Donate link: https://www.paypal.me/JessOR
Tags: password, login, protect
...
Restrict access to specific pages to only logged in users.
...
1. Navigate to Settings --> Password Protect Pages to configure the plugin options
