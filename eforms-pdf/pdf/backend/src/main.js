(function($) {
    ...
    $( document ).ready( function () {
      ...
      $("body").on("change","#pdf_creator_conditional_logic",function(e){  
        if( $(this).is(":checked")){
            $(".pdfbuilder-popup-content").removeClass("hidden");
        }else{
            $(".pdfbuilder-popup-content").addClass("hidden");
        }
      }) 
      $("body").on("click",".pdf_creator_tab_fonts li",function(e){
        e.preventDefault(); 
        $(".pdf_creator_tab_fonts li").removeClass("active");
        $(this).addClass("active");
        var tab = $(this).data("tab");
        $(".pdf_creator_tab_fonts_content").addClass("hidden");
