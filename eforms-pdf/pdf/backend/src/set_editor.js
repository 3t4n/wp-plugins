(function($) {
    ...
    $( document ).ready( function () { 
        ...
        $('body').on('click', '.upload-editor--image-ok', function(e){
            e.preventDefault();
            var input = $(this).closest("div").find(".image_url");
                var button = $(this),
                    custom_uploader = wp.media({
                title: 'Insert image',
                library : {
        ...
        $.check_row_empty = function() {
         ...
         $("body").on("click",".pdfbuilder-popup-add",function(e){
          e.preventDefault();
          $(".pdfbuilder_condition_add").click();
       ...
       $('body').on("click",".pdfbuilder_condition_add",function(e){
        ...
        $.pdfbuilder_get_logic_html = function(conditional){
            ...
            var html = '<div class="pdfcreator-logic-item" >';
                html += '<select class="pdfcreator-logic-name" name="pdfcreator_logic[conditional]['+rand_id+'][name]">';
                        html += name_logic_html;
                    html += '</select>';
                    html += '<select class="pdfcreator-logic-rule" name="pdfcreator_logic[conditional]['+rand_id+'][rule]">';
                    ...
                    html += '</select>';
                    html += '<input type="text" class="pdfcreator-logic-value" name="pdfcreator_logic[conditional]['+rand_id+'][value]" value="'+conditional.value+'">';
