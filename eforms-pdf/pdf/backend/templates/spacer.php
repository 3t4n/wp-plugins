...
add_action("pdf_builder_block","superaddons_pdf_builder_block_spacer",60);
function superaddons_pdf_builder_block_spacer(){
    ...
    <li>
        <div class="momongaDraggable" data-type="spacer">
            ...
            <div class="pdfbuilder-tool-text"><?php esc_html_e("Spacer","pdf-for-wpforms") ?></div>
        </div>
    </li>
    <?php
}
add_filter( 'pdf_builder_block_html', "superaddons_pdf_builder_block_spacer_load" );
