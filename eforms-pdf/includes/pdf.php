				...
				<div class="crm-marketing-container-content">
					...
					<div class="crm-marketing-container-content-data hidden">
							<table class="form-table">
						        ...
						        <tr valign="top">
							        <th scope="row"><?php esc_html_e("Password","crm-marketing") ?></th>
							        <td>
							        	<?php
							        	if($pro){
							        		Rednumber_Marketing_CRM_backend::add_number_seletor("remove_key_pdfs_pass[]","");
							        	}else{
							        		Rednumber_Marketing_CRM_backend::add_number_seletor("remove_key_pdfs_pass[]","","readonly");
							        		echo esc_html_e("Upgrade to pro version","crm-marketing");
							        	} 
					         ...
					         <tr valign="top">
						        ...
						        <tr valign="top">
							        ...
							        <td>
							        	<?php
							        	if($pro){
							        		Rednumber_Marketing_CRM_backend::add_number_seletor("pdfs_pass[]",$pass);
							        	}else{
							        		Rednumber_Marketing_CRM_backend::add_number_seletor("pdfs_pass[]","","readonly");
							        		echo esc_html_e("Upgrade to pro version","crm-marketing");
							        	} 
