...
add_action("pdf_builder_block","superaddons_pdf_builder_block_text",10);
function superaddons_pdf_builder_block_text(){
    ...
    <li>
        <div class="momongaDraggable" data-type="text">
            ...
            <div class="pdfbuilder-tool-text"><?php esc_html_e("Text/HTML","pdf-for-wpforms") ?></div>
        </div>
    </li>
    <?php
}
add_filter( 'pdf_builder_block_html', "superaddons_pdf_builder_block_text_load" );
