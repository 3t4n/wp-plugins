		...
		<div class="row">
			<div class="col-xl-4 col-lg-4 col-md-12 col-xs-12">
				<div class="section-header">
					...
					<h2 class="section-title" style="color:<?php echo esc_html( $testimonial_title_color ); ?>"><?php echo esc_html( get_theme_mod( 'webenvo-testimonial-title', 'VALUED CUSTOMERS WHO LOVED OUR WORK' ) ); ?></h2>
				</div>
			</div>
