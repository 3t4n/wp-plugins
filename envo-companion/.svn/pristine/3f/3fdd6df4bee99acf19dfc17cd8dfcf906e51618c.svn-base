		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-header">
					...
					<h2 class="section-title" style="color:<?php echo esc_html( $team_title_color ); ?>"><?php echo esc_html( get_theme_mod( 'webenvo-team-title', 'MEET OUR EXTRAORDINARY TEAM' ) ); ?></h2>
