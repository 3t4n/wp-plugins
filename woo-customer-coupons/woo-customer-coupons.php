 ...
 * Description: We help display beautiful coupon lists on your website, making it easy for customers to click and apply them effortlessly
 * Author: VillaTheme
...
class VIWCC_WOO_CUSTOM_COUPONS {
	...
	protected function define() {
		define( 'WOO_CUSTOM_COUPONS_VERSION', '1.3.6' );
