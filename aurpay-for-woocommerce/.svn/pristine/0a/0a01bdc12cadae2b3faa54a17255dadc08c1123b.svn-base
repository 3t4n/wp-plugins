=== AURPAY WooCommerce - Bitcoin/USDT Crypto Payment Gateway ===

Contributors: aurtech
Tags: Crypto, cryptocurrency, bitcoin, crypto pay, crypto woocommerce，USDT, bitcoin woocommerce，ethereum，pay crypto，virtual currency，bitcoin wordpress plugin，free crypto plugin，pay with bitcoin，cryptocurrency plugin，accept bitcoin，Smart contract, woocommerce crypto pay, crypto checkout, crypto button, bitcoin wordpress plugin, woocommerce crypto gateway, bitcoin lightning network
...
Earn more $2/order compare to others，Let your customer pay with BTC, ETH, USDC, USDT, DAI, 50+ cryptos. Lowest fees, Non-Custodail & No Fraud/Chargeback. Invoice, Payment Link, Payment Button.
...
= 1.0.15 =
Update: Support WordPress 6.6.2
