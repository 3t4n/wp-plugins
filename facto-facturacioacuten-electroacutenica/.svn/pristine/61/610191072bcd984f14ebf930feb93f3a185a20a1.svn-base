...
function facto_fe_seleccionar_tipo(obj) {
	//todas false
	if(jQuery('#facto_checkbox_fe').is(':checked') == false && jQuery('#facto_checkbox_fee').is(':checked') == false && jQuery('#facto_checkbox_be').is(':checked') == false && jQuery('#facto_checkbox_bee').is(':checked') == false && jQuery('#facto_checkbox_fex').is(':checked') == false) {
...
document.getElementById("facto_checkbox_fex").onclick = function(){facto_fe_seleccionar_tipo(this);};
