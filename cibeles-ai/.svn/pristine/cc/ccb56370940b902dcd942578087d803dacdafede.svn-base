...
if ( ! function_exists( 'caip_init_files_CSS' ) ) {
	function caip_init_files_CSS(){
		...
		if ( ( 'post.php' == $pagenow || 'post-new.php' == $pagenow ) || ( 'options-general.php' == $pagenow ) ) {
			...
			wp_enqueue_style('post_css',  plugin_dir_url( __FILE__ ) . 'css/main.css', '', '1.10.2', 'all');
		}
	}
}
...
if ( ! function_exists( 'caip_init_files_JS' ) ) {
	function caip_init_files_JS(){
		...
		if ( ( 'post.php' == $pagenow || 'post-new.php' == $pagenow ) && ($post->post_type == 'post' ||  $post->post_type == 'inversion' || 'wpbdp_listing' == $post->post_type)) {
			wp_enqueue_script( 'language_js', plugin_dir_url( __FILE__ ) . 'js/init_language.js', array( 'jquery' ), '1.10.2', true );
			wp_set_script_translations( 'language_js', 'cibeles-ai', plugin_basename( __DIR__ ) . '/languages/');
			
			if (caip_is_classic_editor()) {
				wp_enqueue_script( 'post_js', plugin_dir_url( __FILE__ ) . 'js/init_ai_fields.js', array( 'jquery' ), '1.10.2', true );
				...
				*/
				...
				wp_enqueue_script( 	'caip_functions',		plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Functions.js', 	array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_button',			plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Button.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_action', 			plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Action.js', 		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_titulo', 			plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Titulo.js', 		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_tag', 			plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Tag.js', 			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_resumenp', 		plugin_dir_url( __FILE__ ) 		.'js/classes/caip_ResumenP.js', 	array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script( 	'caip_multiaction',		plugin_dir_url( __FILE__ ) 		.'js/classes/caip_Multiaction.js', 	array( 'jquery' ), '1.10.2', true );
				
				wp_enqueue_script(	'caip_clickbait', 		plugin_dir_url( __FILE__ ) 		.'js/classes/clickbait.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_titularcorto', 	plugin_dir_url( __FILE__ ) 		.'js/classes/titularcorto.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_titular', 		plugin_dir_url( __FILE__ ) 		.'js/classes/titular.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_tags', 			plugin_dir_url( __FILE__ ) 		.'js/classes/tags.js',				array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_autotags', 		plugin_dir_url( __FILE__ ) 		.'js/classes/autotags.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_resumen', 		plugin_dir_url( __FILE__ ) 		.'js/classes/resumen.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_autoexcerpt',		plugin_dir_url( __FILE__ ) 		.'js/classes/autoexcerpt.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_refrito',			plugin_dir_url( __FILE__ ) 		.'js/classes/refrito.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_corrector',		plugin_dir_url( __FILE__ )	 	.'js/classes/corrector.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_introduccion',	plugin_dir_url( __FILE__ )		.'js/classes/introduccion.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_conclusion',		plugin_dir_url( __FILE__ )	 	.'js/classes/conclusion.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_youtube',			plugin_dir_url( __FILE__ )	 	.'js/classes/youtube.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_cifras',			plugin_dir_url( __FILE__ )	 	.'js/classes/cifras.js',			array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_cronologia',		plugin_dir_url( __FILE__ )		.'js/classes/cronologia.js',		array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_faq',				plugin_dir_url( __FILE__ )		.'js/classes/faq.js',				array( 'jquery' ), '1.10.2', true );
				wp_enqueue_script(	'caip_audio',			plugin_dir_url( __FILE__ )		.'js/classes/audio.js',				array( 'jquery' ), '1.10.2', true );
				...
				wp_enqueue_script( 'gutenberg_js', plugin_dir_url( __FILE__ ) . 'js/gutenberg.js', array( 'jquery' ), '1.10.2', true );
