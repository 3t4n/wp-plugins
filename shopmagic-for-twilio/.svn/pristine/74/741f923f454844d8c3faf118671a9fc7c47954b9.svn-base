...
abstract class IpAddressOptions
{
     ...
     */
    public static function create(int $cidrPrefixLength = Values::INT_NONE): CreateIpAddressOptions
    {
     ...
     */
    public static function update(string $ipAddress = Values::NONE, string $friendlyName = Values::NONE, int $cidrPrefixLength = Values::INT_NONE): UpdateIpAddressOptions
    {
...
class CreateIpAddressOptions extends Options
{
     ...
     * @param int $cidrPrefixLength An integer representing the length of the CIDR prefix to use with this IP address when accepting traffic. By default the entire IP address is used.
     */
    public function __construct(int $cidrPrefixLength = Values::INT_NONE)
    {
...
class UpdateIpAddressOptions extends Options
{
     ...
     * @param int $cidrPrefixLength An integer representing the length of the CIDR prefix to use with this IP address when accepting traffic. By default the entire IP address is used.
     */
    public function __construct(string $ipAddress = Values::NONE, string $friendlyName = Values::NONE, int $cidrPrefixLength = Values::INT_NONE)
    {
