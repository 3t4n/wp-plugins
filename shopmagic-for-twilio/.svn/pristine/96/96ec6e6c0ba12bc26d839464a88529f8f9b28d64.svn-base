...
abstract class UserConversationOptions
{
     ...
     */
    public static function update(string $notificationLevel = Values::NONE, \DateTime $lastReadTimestamp = null, int $lastReadMessageIndex = Values::INT_NONE): UpdateUserConversationOptions
    {
...
class UpdateUserConversationOptions extends Options
{
     ...
     * @param int $lastReadMessageIndex The index of the last Message in the Conversation that the Participant has read.
     */
    public function __construct(string $notificationLevel = Values::NONE, \DateTime $lastReadTimestamp = null, int $lastReadMessageIndex = Values::INT_NONE)
    {
