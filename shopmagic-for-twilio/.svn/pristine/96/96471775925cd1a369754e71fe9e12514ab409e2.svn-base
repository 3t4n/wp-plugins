...
$guzzleClient = new Client($signingKey->sid, $signingKey->secret, $sid, null, new \ShopMagicTwilioVendor\Twilio\Http\GuzzleClient(new \ShopMagicTwilioVendor\GuzzleHttp\Client()));
