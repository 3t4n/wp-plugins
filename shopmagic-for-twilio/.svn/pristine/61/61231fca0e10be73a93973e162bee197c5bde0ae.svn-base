...
abstract class SubscribedEventOptions
{
     ...
     */
    public static function create(int $schemaVersion = Values::INT_NONE): CreateSubscribedEventOptions
    {
     ...
     */
    public static function update(int $schemaVersion = Values::INT_NONE): UpdateSubscribedEventOptions
    {
...
class CreateSubscribedEventOptions extends Options
{
     ...
     * @param int $schemaVersion The schema version that the Subscription should use.
     */
    public function __construct(int $schemaVersion = Values::INT_NONE)
    {
