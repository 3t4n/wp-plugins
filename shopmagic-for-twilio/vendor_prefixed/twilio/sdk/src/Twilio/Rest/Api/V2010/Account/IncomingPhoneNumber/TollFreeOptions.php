...
abstract class TollFreeOptions
{
     ...
     */
    public static function read(bool $beta = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $phoneNumber = Values::NONE, string $origin = Values::NONE): ReadTollFreeOptions
    {
