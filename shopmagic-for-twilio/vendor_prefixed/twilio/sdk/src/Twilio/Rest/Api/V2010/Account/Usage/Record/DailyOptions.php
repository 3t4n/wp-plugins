...
abstract class DailyOptions
{
     ...
     */
    public static function read(string $category = Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null, bool $includeSubaccounts = Values::BOOL_NONE): ReadDailyOptions
    {
