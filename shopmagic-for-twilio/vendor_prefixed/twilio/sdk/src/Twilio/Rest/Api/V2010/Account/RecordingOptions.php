...
abstract class RecordingOptions
{
     ...
     */
    public static function fetch(bool $includeSoftDeleted = Values::BOOL_NONE): FetchRecordingOptions
    {
     ...
     */
    public static function read(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null, string $callSid = Values::NONE, string $conferenceSid = Values::NONE, bool $includeSoftDeleted = Values::BOOL_NONE): ReadRecordingOptions
    {
...
class FetchRecordingOptions extends Options
{
     ...
     * @param bool $includeSoftDeleted A boolean parameter indicating whether to retrieve soft deleted recordings or not. Recordings metadata are kept after deletion for a retention period of 40 days.
     */
    public function __construct(bool $includeSoftDeleted = Values::BOOL_NONE)
    {
...
class ReadRecordingOptions extends Options
{
     ...
     * @param bool $includeSoftDeleted A boolean parameter indicating whether to retrieve soft deleted recordings or not. Recordings metadata are kept after deletion for a retention period of 40 days.
     */
    public function __construct(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null, string $callSid = Values::NONE, string $conferenceSid = Values::NONE, bool $includeSoftDeleted = Values::BOOL_NONE)
    {
