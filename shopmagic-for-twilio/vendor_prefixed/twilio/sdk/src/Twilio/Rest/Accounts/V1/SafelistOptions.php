...
abstract class SafelistOptions
{
     ...
     */
    public static function delete(string $phoneNumber = Values::NONE): DeleteSafelistOptions
    {
        return new DeleteSafelistOptions($phoneNumber);
    }
    /**
     ...
     */
    public static function fetch(string $phoneNumber = Values::NONE): FetchSafelistOptions
    {
        return new FetchSafelistOptions($phoneNumber);
    }
}
class DeleteSafelistOptions extends Options
{
     ...
     * @param string $phoneNumber The phone number to be removed from SafeList. Phone numbers must be in [E.164 format](https://www.twilio.com/docs/glossary/what-e164).
     */
    public function __construct(string $phoneNumber = Values::NONE)
    {
