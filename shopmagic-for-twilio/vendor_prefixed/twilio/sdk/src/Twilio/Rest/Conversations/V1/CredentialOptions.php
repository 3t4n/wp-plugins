...
abstract class CredentialOptions
{
     ...
     */
    public static function create(string $friendlyName = Values::NONE, string $certificate = Values::NONE, string $privateKey = Values::NONE, bool $sandbox = Values::BOOL_NONE, string $apiKey = Values::NONE, string $secret = Values::NONE): CreateCredentialOptions
    {
     ...
     */
    public static function update(string $type = Values::NONE, string $friendlyName = Values::NONE, string $certificate = Values::NONE, string $privateKey = Values::NONE, bool $sandbox = Values::BOOL_NONE, string $apiKey = Values::NONE, string $secret = Values::NONE): UpdateCredentialOptions
    {
...
class CreateCredentialOptions extends Options
{
     ...
     * @param string $secret [FCM only] The **Server key** of your project from the Firebase console, found under Settings / Cloud messaging.
     */
    public function __construct(string $friendlyName = Values::NONE, string $certificate = Values::NONE, string $privateKey = Values::NONE, bool $sandbox = Values::BOOL_NONE, string $apiKey = Values::NONE, string $secret = Values::NONE)
    {
...
class UpdateCredentialOptions extends Options
{
     ...
     * @param string $secret [FCM only] The **Server key** of your project from the Firebase console, found under Settings / Cloud messaging.
     */
    public function __construct(string $type = Values::NONE, string $friendlyName = Values::NONE, string $certificate = Values::NONE, string $privateKey = Values::NONE, bool $sandbox = Values::BOOL_NONE, string $apiKey = Values::NONE, string $secret = Values::NONE)
    {
