...
class UpdateNotificationOptions extends Options
{
     ...
     * @param string $newMessageWithMediaTemplate The template to use to create the notification text displayed when a new message with media/file attachments is added to a conversation and `new_message.attachments.enabled` is `true`.
     */
    public function __construct(bool $logEnabled = Values::BOOL_NONE, bool $newMessageEnabled = Values::BOOL_NONE, string $newMessageTemplate = Values::NONE, string $newMessageSound = Values::NONE, bool $newMessageBadgeCountEnabled = Values::BOOL_NONE, bool $addedToConversationEnabled = Values::BOOL_NONE, string $addedToConversationTemplate = Values::NONE, string $addedToConversationSound = Values::NONE, bool $removedFromConversationEnabled = Values::BOOL_NONE, string $removedFromConversationTemplate = Values::NONE, string $removedFromConversationSound = Values::NONE, bool $newMessageWithMediaEnabled = Values::BOOL_NONE, string $newMessageWithMediaTemplate = Values::NONE)
    {
