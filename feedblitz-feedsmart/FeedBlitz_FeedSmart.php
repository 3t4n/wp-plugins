        ...
        class fb_feedsmart {
            ...
            */
            function admin_menu(){
                ...
                add_action('admin_head-'.$hook,function(){wp_enqueue_script('feedsmart_admin_script');});
            ...
            <form method="post" action="options.php">
                ...
                <table cellpadding="3" cellspacing="3" class="widefat" style="width: 750px;">
                    ...
                    <tbody>
                        ...
                        <tr class="alt">
                            <td>2)<td><?php _e('Once you have created your FeedBlitz feed, enter its address into the field below (https://feeds.feedblitz.com/yourfeed)');?><br /><input type="text" name="<?php echo $this->db_option;?>[feedsmart_url]" value="<?php echo $options['feedsmart_url'];?>" size="45"></td>
                        </tr>
                        <tr>
