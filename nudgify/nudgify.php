...
define('NUDGIFY_PLUGIN_VERSION', '1.3.7');
...
if (!class_exists('Nudgify')) {
    ...
    class Nudgify
    {
        ...
        public function init_woocommerce_orders()
        {
            ...
            add_action('wp_ajax_nopriv_nudgify_apply_discount', [$this, 'apply_discount'] );
            add_action('wp_ajax_nopriv_nudgify_check_discount', [$this, 'check_discount_applied'] );
