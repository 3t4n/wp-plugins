...
Tags: admin, custom, builder, page builder, layout builder, layout, page, columns, multi-column, grid, responsive, shortcode, bootstrap, image
...
2. Install Fusion : Extension - Image through the WordPress plugins screen, or upload the plugin files to the `/wp-content/plugins` directory.
3. Activate Fusion : Extension - Image through the 'Plugins' screen in WordPress
4. Visit the Fusion knowledge base and user guide at <http://agencydominion.helpscoutdocs.com/>

== Frequently Asked Questions ==

= Does the Fusion : Extension - Image plugin require the Fusion core plugin to function? =

Yes. The Fusion : Extension - Image plugin is an extension for adding an Image element to Fusion. The Fusion core plugin must be installed for this plugin to function. You can get Fusion [here](https://wordpress.org/plugins/fusion/).
...
= 1.3.1 =
* Bugfix for lazy load disable.

= 1.3.0 =
* Add option to disable lazy loading for images above the fold.

= 1.2.1 =
* Add native lazy loading.

= 1.2.0 =
* Add filter for image tag output.
...
= 1.1.5 =
* Move Ken Burns effect to Animation tab.
...
= 1.1.3 =
* Fix Internet Explorer image float bug.
...
= 1.0.1 =
* Security updates.
* Remove custom image size functionality.

= 1.0.0 =
* Fusion : Extension - Image initial launch.
