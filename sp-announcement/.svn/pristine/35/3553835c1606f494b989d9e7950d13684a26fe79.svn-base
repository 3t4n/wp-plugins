...
<style>
    .wpann_notice_container {
        display: none;
        width: 100%;
        height: <?php echo esc_attr($template_field('height') ? $template_field('height').'px' : 'auto'); ?>;
        z-index: 999;
        ...
        font-size: <?php echo esc_attr($template_field('text_font_size') ? $template_field('text_font_size').'px' : 'inherit'); ?>;
    }
    ...
    .wpann_notice_container a {
        ...
        font-size: <?php echo esc_attr($template_field('btn_text_font_size') ? $template_field('btn_text_font_size').'px' : 'inherit'); ?>;
        border-radius: 3px;
        margin-left: 15px;
        padding: 5px 15px;
