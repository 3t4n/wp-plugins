...
?>
            <div class="support-genix-lite-diagnostic-data-style">
                <style>
                    .support-genix-lite-diagnostic-data-notice,
                    .woocommerce-embed-page .support-genix-lite-diagnostic-data-notice {
                        padding-top: .75em;
                        padding-bottom: .75em;
                    }

                    .support-genix-lite-diagnostic-data-notice .support-genix-lite-diagnostic-data-buttons,
                    .support-genix-lite-diagnostic-data-notice .support-genix-lite-diagnostic-data-list,
                    .support-genix-lite-diagnostic-data-notice .support-genix-lite-diagnostic-data-message {
                        padding: .25em 2px;
                        margin: 0;
                    }
                    ...
                    .support-genix-lite-diagnostic-data-notice .support-genix-lite-diagnostic-data-buttons .button {
                        margin-right: 5px;
                        box-shadow: none;
                    }

                    .support-genix-lite-diagnostic-data-loading {
                        position: relative;
                    }

                    .support-genix-lite-diagnostic-data-loading::before {
                        position: absolute;
                        content: "";
                        width: 100%;
                        height: 100%;
                    ...
                    .support-genix-lite-diagnostic-data-disagree {
                        border-width: 0px !important;
                        background-color: transparent !important;
                        padding: 0 !important;
                    }

                    h4.support-genix-lite-diagnostic-data-title {
                        margin: 0 0 10px 0;
                        font-size: 1.04em;
                        font-weight: 600;
                    }
            ...
            <div class="support-genix-lite-diagnostic-data-script">
                <script type="text/javascript">
                    ;
                    (function($) {
                        "use strict";

                        function supportGenixLiteDissmissThanksNotice(noticeWrap) {
                            $('.support-genix-lite-diagnostic-data-thanks .notice-dismiss').on('click', function(e) {
                                e.preventDefault();
                                let thisButton = $(this),
                                    noticeWrap = thisButton.closest('.support-genix-lite-diagnostic-data-thanks');
                        ...
                        $(".support-genix-lite-diagnostic-data-list-toogle").on("click", function(e) {
                            e.preventDefault();
                            $(this).parents(".support-genix-lite-diagnostic-data-notice").find(".support-genix-lite-diagnostic-data-list").slideToggle("fast")
                        });
                        $(".support-genix-lite-diagnostic-data-button").on("click", function(e) {
                            e.preventDefault();
                            let thisButton = $(this),
                                noticeWrap = thisButton.closest(".support-genix-lite-diagnostic-data-notice"),
                                agreed = thisButton.hasClass("support-genix-lite-diagnostic-data-agree") ? "yes" : "no",
                                styleWrap = $(".support-genix-lite-diagnostic-data-style"),
                                scriptWrap = $(".support-genix-lite-diagnostic-data-script");
                            $.ajax({
                                type: "POST",
                                url: ajaxurl,
                                data: {
                                    action: "support_genix_lite_diagnostic_data",
                                    agreed: agreed,
                                    _ajax_nonce: '<?php echo wp_create_nonce('ajax-nonce'); ?>'
                                },
                                beforeSend: function() {
                                    noticeWrap.addClass("support-genix-lite-diagnostic-data-loading")
                                },
                                success: function(response) {
                                    ...
                                    noticeWrap.removeClass("support-genix-lite-diagnostic-data-loading");
                                    supportGenixLiteDissmissThanksNotice()
                                },
                                error: function() {
                                    noticeWrap.removeClass("support-genix-lite-diagnostic-data-loading")
                                },
