...
class Mapbd_wps_custom_field extends AppsBDModel
{
    ...
    public function SetFromPostData($isNew = false, $data = null)
    {
        ...
        $field_type = sanitize_text_field(APBD_PostValue('field_type', ''));
        $fld_option = sanitize_text_field(APBD_PostValue('fld_option', ''));
        $field_label = sanitize_text_field(APBD_PostValue('field_label', ''));
        $field_slug = sanitize_text_field(APBD_PostValue('field_slug', ''));
        $help_text = sanitize_text_field(APBD_PostValue('help_text', ''));
        $form_opts = sanitize_text_field(APBD_PostValue('form_opts', ''));
        $where_to_create = sanitize_text_field(APBD_PostValue('where_to_create', ''));
        $create_for = sanitize_text_field(APBD_PostValue('create_for', ''));
        $category_arr = sanitize_text_field(APBD_PostValue('category_arr', ''));
