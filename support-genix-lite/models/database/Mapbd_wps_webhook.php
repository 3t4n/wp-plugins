...
class Mapbd_wps_webhook extends AppsBDModel
{
    public $id;
    public $title;
    public $url;
    ...
    /**
     *@property id,title,url,on_tckt_create,on_client_create,on_tckt_replied,status
     */
    ...
    public function SetFromPostData($isNew = false, $data = null)
    {
        ...
        $url = esc_url_raw(APBD_PostValue('url', ''));
        $event_opts = sanitize_text_field(APBD_PostValue('event_opts', ''));
        ...
        $all__event_opts = ['on_tckt_create', 'on_tckt_replied', 'on_client_create'];
