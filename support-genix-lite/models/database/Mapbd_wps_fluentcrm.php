...
class Mapbd_wps_fluentcrm extends AppsBDModel
{
    ...
    public function SetFromPostData($isNew = false, $data = null)
    {
        ...
        $webhook_url = esc_url_raw(APBD_PostValue('webhook_url', ''));
        $list_ids = sanitize_text_field(APBD_PostValue('list_ids', ''));
        $tag_ids = sanitize_text_field(APBD_PostValue('tag_ids', ''));
        $contact_status = sanitize_text_field(APBD_PostValue('contact_status', ''));
        $trigger_events = sanitize_text_field(APBD_PostValue('trigger_events', ''));
