...
class APBDWPHasThemesNewsAPI
{

	/**
	 * Define necessary variables
	 */
	const NEWS_FEED_OPTION_KEY = 'support_genix_lite_hasthemes_news_feed_data';
	const TRANSIENT_KEY_PREFIX = 'support_genix_lite_hasthemes_api_data';

	/**
	 * Info API URL
	 */
	private static $api_url = 'https://library.shoplentor.com/wp-json/woolentor/v1/info';
	...
	private static function get_info_data($force_update = false)
	{
		...
		if ($force_update || false === $info_data) {
			...
			$response = wp_remote_get(self::$api_url, [
				'timeout' => $timeout,
				'body' => [
					'api_version' => SUPPORT_GENIX_LITE_VERSION,
