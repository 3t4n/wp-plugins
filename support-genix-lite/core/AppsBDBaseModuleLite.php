...
if (!class_exists("AppsBDBaseModuleLite")) {
    class AppsBDBaseModuleLite
    {
        public $moduleName = "";
        public $menuTitle = "";
        public $menuIcon = "";
        ...
        /**
         * AppsBDBaseModuleLite constructor.
         *
         * @param $pluginBaseName
         * @param AppsBDKarnelSupportGenixLite $kernelObject
         */
        ...
        function AddAjaxAction($actionName, $function_to_add)
        {
            ...
            add_action('wp_ajax_' . $actionName, function () use ($actionName, $function_to_add) {
                ...
                $permission = ((current_user_can('read') && Apbd_wps_settings::isAgentLoggedIn()) ? true : false);
                ...
                if ($permission) {
                    ...
                    if (!current_user_can('manage_options') && !in_array('administrator', $role_slugs)) {
                        ...
                        if ($capability && (('all' === $capability) || !current_user_can($capability))) {
                            $permission = false;
                        }
                    }
                }
