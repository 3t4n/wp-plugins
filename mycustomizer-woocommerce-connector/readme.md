...
## Changelog
**1.0.27**
* Fix api connection url.

**1.0.26**
* Cancel pending orders at Kickflip when deleted in WooCommerce.

**1.0.25**
* Create order from kickflip quote.

**1.0.24**
* Fix language detection to allow complete code.

**1.0.22**
* Quickfix on Javascript redirect to cart.

**1.0.21**
* Orders with status "On Hold" should have paymentStatus to "unpaid".
