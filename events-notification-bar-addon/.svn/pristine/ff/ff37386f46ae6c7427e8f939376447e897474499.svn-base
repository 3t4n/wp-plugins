...
if (!class_exists('ENBAFeedbackNotice')) {
    class ENBAFeedbackNotice {
        /**
         * The Constructor
         */
        public function __construct() {
            ...
            if(is_admin()){
                ...
                add_action( 'wp_ajax_enba_dismiss_notice',array($this,'dismiss_review_notice' ) );
            }
        }
	...
	public function load_script() {
		wp_register_script( 'feedback-notice-script', ENBA_URL. 'assets/admin/js/enba-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'feedback-notice-script' );
        wp_register_style( 'feedback-notice-styles',ENBA_URL.'assets/admin/css/enba-admin-feedback-notice.css' );
        wp_enqueue_style( 'feedback-notice-styles' );
    }

    public function dismiss_review_notice(){
        $rs=update_option( 'enba-ratingDiv','yes' );
    ...
    public function admin_notice_for_reviews(){
        ...
        if( !current_user_can( 'update_plugins' ) ){
         ...
         $installation_date = get_option( 'enba-installDate' );
         $alreadyRated =get_option( 'enba-ratingDiv' )!=false?get_option( 'enba-ratingDiv'):"no";
       ...
       function create_notice_content(){
        ...
        $ajax_callback='enba_dismiss_notice';
        $wrap_cls="notice notice-info is-dismissible";
        $img_path= ENBA_URL.'assets/images/enba-logo.png';
        $p_name="Event Notification Bar Addon";
        ...
        $p_link=esc_url('https://wordpress.org/support/plugin/events-notification-bar-addon/reviews/#new-post');
        ...
        <ul>
            ...
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button enba_dismiss_notice" title="%7$s">%7$s</a></li>
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button enba_dismiss_notice" title="%10$s">%10$s</a></li>
        </ul>
