...
Tags: social, share, social share plugin, post share, social share button
...
Easily enable and place the social share button in any single post or page of any WordPress website.

== Description ==
HT Social Share is a splendid WordPress Plugin for users who want to enable their website visitors to share the website posts or content on social media in an easy and simple way. As a user, you can place the social share button in any single post or page within your website. You will avail of multiple options to set the social share button. For instance, you can select Post Type, Button Styles, Button Location, social media icons etc.
So, if you are in quest of an excellent free WordPress Plugin to enable social media sharing, HT-Social Share will be second to none. Try this amazing plugin today to interact more visitors on your website through social media.
...
= Version: 1.0.6 - Date: 2022-03-11 =
* Compatibility with latest WordPress version.

= Version: 1.0.5 - Date: 2022-15-09 =
* Added: Recommendation Submenu.

= Version: 1.0.4 - Date: 2022-16-02 =
* Compatibility with latest WordPress version.

= Version: 1.0.3 - Date: 2022-09-02 =
* Compatibility with latest WordPress version.

= Version: 1.0.2 - Date: 2021-25-07 =
* Compatibility with latest WordPress version.

= Version: 1.0.1 - Date: 2021-14-03 =
* Compatibility with latest WordPress version.

= Version: 1.0.0 - Date: 2021-01-09 =
* Initial Upload.

== Installation ==
This section describes how to install the HT Social Share Plugin for WordPress get it working.

= 1) Install =
1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "HT Social Share".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload 'HT Social Share' folder to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. Go to the HT Social Share Settings Options.
2. Select post type.
3. Select style
4. Select Position
5. Select icon from icons list.

== Screenshots ==
1. Dashboard Settings Panel
2. Social Share button style one
3. Social Share button style two
4. Social Share button style three
5. Social Share button style four
