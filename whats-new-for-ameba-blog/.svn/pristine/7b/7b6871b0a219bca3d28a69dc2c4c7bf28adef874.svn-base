    ...
    function rss2html( $rss, $num, $excerpt_len )
    {
        ...
        if (!isset($rss_items) ) {
            ...
            foreach ( $rss_items as $i ) {
                ...
                $list .= '<li class="ameba-whats-new-item"><div class="ameba-whats-new-title"><a href="' . $permalink . '">' . $title . '</a></div><div class="ameba-whats-new-excerpt">' . $trimmed_description . '</div><div class="ameba-whats-new-date"><p>' . $date . '</p></div></li>';
            }
        }
        $list .= '</ul></div>';
        return $list;
