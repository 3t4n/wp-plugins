...
(function() {
	...
	<div class="atec-footer atec-center atec-fs-12">
		<span class="atec-ml-10" style="float:left;">
			<span class="atec-fs-12" title="', esc_attr__('Execution time','atec-dir-scan'), '">
			...
			if (!$mega) echo '&middot; <a class="atec-nodeco" href="',esc_url(get_admin_url().'admin.php?page=atec_group'),'">atec-',  esc_attr__('plugins','atec-dir-scan'), ' – ', esc_attr__('Group','atec-dir-scan'), '</a>';
			echo '
		</span>
