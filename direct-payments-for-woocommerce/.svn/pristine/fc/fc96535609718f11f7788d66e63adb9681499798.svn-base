...
<?php echo esc_html(wp_strip_all_tags( WC()->cart->get_total() )); ?>
</div>
</div> 
<!-- header info --> 
<!-- body main -->     
...
<tr style="border-bottom: 1px dashed #F0F0F1;">     
<td style="padding-top: 12px;padding-bottom: 12px;text-align: left;font-weight: 400;font-size: 14px;line-height: 22px;color: #646970;">Platform name:        
<span style="color: #1D2327;">    
<span class="tumazp2pname">    
</span>    
</span>
</td>     
</tr>     
<tr style="border-bottom: 1px dashed #F0F0F1;">     
<td style="padding-top: 12px;padding-bottom: 12px;text-align: left;font-weight: 400;font-size: 14px;line-height: 22px;color: #646970;">    
<span class="tumazp2ptype">    
</span>: <span style="color: #1D2327;">    
<span class="tumazp2pid">    
</span>    
</span>
</td>     
</tr>     
