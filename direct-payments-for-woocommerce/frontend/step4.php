...
?>
<!-- side bar -->
<div class="conta step digage_stylenone" id="step4" >
  ...
  <div class="rowt">
    ...
    <div class="colt tab-content" id="myTabContent">
        <!-- Bank transfer content --> 
                        ...
                        Choose your preferred <span class="digagechangepay"></span> to make payment
                            </div> 
                            <div class="text-start ppsjq"> 
                            <div class="custom-select">
                            <select id="changeSelectionSelect" class="qaarr pp"></select>
                            </div>
                            </div> 
    </div>
