...
class Category extends Widget_Base {
	...
	private function query_options() {
		...
		$this->add_control(
			'grid_layout_style',
			[
				'label' => __( 'Layout Style', 'wc-pcd' ),
				'type' => 'dpcd_image_selector',
				'options' => [
					'0' => [
						'title' => esc_html__('Style 1', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/grid-de.svg',
					],
					'1' => [
						'title' => esc_html__('Style 2', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/grid-style-2.svg',
					],
					'2' => [
						'title' => esc_html__('Style 3', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/grid-style-3.svg',
					],
					'3' => [
						'title' => esc_html__('Style 4', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/grid-style-3.svg',
					],
				],
				'default' => '0',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'0' => [
						'title' => esc_html__('Style 1', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/slider-de.svg',
					],
					'1' => [
						'title' => esc_html__('Style 2', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/slide-style-2.svg',
					],
					'2' => [
						'title' => esc_html__('Style 3', 'wc-pcd'),
						'url' => DPCD_ASSETS .'/icons/slider-style-3.svg',
					],
				],
				'default' => '0',
				'condition' => [
		...
		// 	'predesign_template',
		// 	[
		// 		'label' => esc_html__( 'Layout', 'wc-pcd' ),
		// 		'type' => Controls_Manager::SELECT,
		// 		'default' => 'predesign_default',
		// 		'options' => [
		// 			'1' => esc_html__( 'Style 1', 'wc-pcd' ),
		// 			'2' => esc_html__( 'Style 2', 'wc-pcd' ),
		// 		]
		// 	]
		// );
	...
	private function style_options(){
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pcd-category-name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
			 ...
			 'selectors' => [
				'{{WRAPPER}} .pcd-category-name' => 'font-family: {{VALUE}};',
			],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .pcd-category-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'pcd_count',
			[
				'label' => esc_html__( 'Count product', 'wc-pcd'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'slider_layout_style' => '1',
					'grid_layout_style' => ['1', '3'],
				],
			],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pcd-count-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
			'name' => 'pcd_count_typography',
			'selector' => '{{WRAPPER}} .pcd-count-text',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .pcd-count-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'shop_now_button',
			[
				'label' => esc_html__( 'Button', 'wc-pcd'),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Card Settings', 'wc-pcd'),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .pcd-single-card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .pcd-single-card' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
			 'name' => 'posts_article_border',
				'selector' => '{{WRAPPER}} .pcd-single-card',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .pcd-single-cat-grid-item .pcd-grid-cat--details',
				'fields_options' => [
					'card_background' => [
						'default' => 'classic',
					],
	...
	protected function render() {
		...
		$layout_style = isset($settings['grid_layout_style']) ? $settings['grid_layout_style'] : $settings['slider_layout_style'];
		...
		<section class="pcd-content-section pcd-position-<?php echo esc_attr($settings['content_position']); ?>">
			<?php
				$layout_type = stripslashes($settings['layout_type']);
				$layout_style = stripslashes($layout_style);

				$dpcd_path = stripslashes(DPCD_PATH);
				$template_path_base = stripslashes('/pcd-templates/elementor/template-');
				$layouts_path_base = stripslashes('/pcd-templates/elementor/layouts/');

				if ('0' === $settings['grid_layout_style'] || '0' === $settings['slider_layout_style']) {
					$template_path = $dpcd_path . $template_path_base . sanitize_file_name($layout_type) . '.php';
				} else {
					$template_path = $dpcd_path . $layouts_path_base . sanitize_file_name($layout_type) . '/layout-' . sanitize_file_name($layout_style) . '.php';
				}

				$allowed_file_types = ['php'];
				$ext = pathinfo($template_path, PATHINFO_EXTENSION);

				if (in_array($ext, $allowed_file_types) && file_exists($template_path)) {
