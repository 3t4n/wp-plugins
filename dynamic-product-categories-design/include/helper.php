...
class Helper {
    ...
    */
    ...
    public static function get_woo_child_category_by_id($parentCatId, $taxonomy = 'product_cat') {
        ...
        foreach ( $terms as $term ) {
            ...
            $output .= '<li class="'. esc_attr( $term->slug ) .'"><a href="'. esc_url( $term_link ) .'">'. esc_html( $term->name ) .'</a></li>';
        }

        echo wp_kses_post($output) . '</ul>';
