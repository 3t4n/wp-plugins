...
Tags: easy digital downloads, abandoned carts, email marketing, cart abandonment, jilt
...
Recapture is the easiest and most effective way to recover abandoned carts and do email marketing for your Easy Digital Downloads (EDD) store in WordPress.  Recommended by Jilt and Easy Digital Downloads both as the best abandoned cart recovery for EDD.

== Description ==

[Main Site](https://recapture.io/) | [Support](https://recapture.io/contact) | [Docs](https://docs.recapture.io/)

Recapture is the easiest and most effective way to recover abandoned carts and do email marketing for your Easy Digital Downloads site.  We also support [WooCommerce abandoned cart recovery](https://wordpress.org/plugins/recapture-for-woocommerce/) as well!
...
_Recapture has already helped merchants generate **over $280,000,000** in additional revenue since 2015._ We're recovering on average $1,000,000+ a week for stores like yours.

Recapture's [abandoned cart recovery for Easy Digital Downloads](https://recapture.io/abandoned-carts-easy-digital-downloads) helps your ecommerce store **recover lost revenue** from abandoned carts.  Recapture tracks when carts are abandoned on your store, then lets you send recovery emails to encourage the customers who abandoned these carts to complete the purchase.
...
Yes, a free Recapture account is required to recover abandoned carts for your Easy Digital Downloads store (we'll create one for you on install, automatically!).  You can recover up to $500 completely free, You can [learn more about Recapture pricing here](https://recapture.io/pricing/) for our paid accounts.
...
= 1.0.41 =
* Send the discount code to Recapture with the order conversion event.

= 1.0.40 =
* Fix an issue adding a Recapture admin sub-menu

= 1.0.39 =
* Disable resetting the customer's cart ID on the edd_insert_payment action to avoid duplicate carts in Recapture during an abandoned PayPal checkout flow.
* Tested against WP 6.6
...
= 1.0.37 =
* Send order contents with conversion tracking

= 1.0.36 =
* Support EDD PayPal Express Checkout

= 1.0.35 =
* Support EDD Multi Currency
...
= 1.0.33 =
* Apply discount code to the recovery URL.
