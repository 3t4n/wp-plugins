...
<?php
	...
	public function add_content_after_specific_acf_field($field)
	{
		if ($field['_name'] === 'first_n_user_visit') {
			$this->render_clear_visits_4_tour_button();
		}
	}

	protected function render_clear_visits_4_tour_button()
	{
		$action = 'clear_visits_4_tour';
		Html::render(
			'div',
			['dpit-admin-btn-wrap', 'dpit-admin-btn-wrap--clear-visits-4-tour'],
			null,
			null,
			[
				'data-msg-success' => __('Cleared', 'dp-intro-tours'),
				'data-msg-failed'  => __('Clearing failed', 'dp-intro-tours'),
				'data-title'       => __('Clear visits for this tour', 'dp-intro-tours'),
