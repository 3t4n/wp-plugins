...
class Dp_Intro_Tours_Post_Type {
	...
	public function register_intro_tour() {
		$labels = [
			...
			'add_new_item'       => __( 'Add New Tour', 'dp-intro-tours' ),
			'edit_item'          => __( 'Edit Tour', 'dp-intro-tours' ),
			'new_item'           => __( 'New Tour', 'dp-intro-tours' ),
			'all_items'          => __( 'All Tours', 'dp-intro-tours' ),
			'view_item'          => __( 'View Tour', 'dp-intro-tours' ),
			'view_items'         => __( 'View Tours', 'dp-intro-tours' ),
			'search_items'       => __( 'Search Intro Tours', 'dp-intro-tours' ),
			'not_found'          => __( 'No Tours found', 'dp-intro-tours' ),
			'not_found_in_trash' => __( 'No Tours found in the Trash', 'dp-intro-tours' ),
			'parent_item_colon'  => '',
			'menu_name'          => __( 'Tours', 'dp-intro-tours' ),
		];
		...
		$args = [
			...
			'hierarchical'        => true,
			'description'         => __( 'Tours', 'dp-intro-tours' ),
			'supports'            => [ 'title' ],
			'public'              => true,
			'show_ui'             => true,
			'show_in_menu'        => true,
