...
if (is_admin() && $plugin_base_name === 'dp-intro-tours-pro/dp-intro-tours.php' && is_plugin_active('dp-intro-tours/dp-intro-tours.php')) {
	...
	define('DP_INTRO_TOURS_V6_DOC', 'https://deeppresentation.com/how-to/intro-tour-tutorial-plugin/version-6-highlights/');
	define('DP_INTRO_TOURS_CONTACT_LINK', 'https://deeppresentation.com/contact/');
	define('DP_INTRO_TOURS_CHANGE_LOG', 'https://deeppresentation.com/plugins/dp-intro-tours/changelog/');
	define('DPIT_Z_INDEX_BASE_MAX', 16777200); // safari max
	define('DPIT_ASR_ENABLED', true); // Ask for rating
	define('DPIT_PROMO_ENABLED', true); // Promo features
	define('DPIT_PROMO_DBG', false); // ONLY FOR DEBUG !!!
