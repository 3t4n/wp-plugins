	...
	*/
	...
	public function __construct() {
		...
		*/
		...
		$this->label = __( 'Table', 'dp-intro-tours' );
		...
		*/
		...
		$this->l10n = [
		//'error' => __('Error! Please enter a higher value.', 'dp-intro-tours'),
		];
		...
		if ( ! defined( 'ACF_TABLEFIELD_FILTER_POSTMETA' )
			...
			add_filter(
				...
				function ( $x, $object_id, $meta_key, $meta_value ) {
	...
	public function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting(
			$field,
			[
				'label'         => __( 'Table Header', 'dp-intro-tours' ),
				'instructions'  => __( 'Presetting the usage of table header', 'dp-intro-tours' ),
				'type'          => 'radio',
				'name'          => 'use_header',
				'choices'       => [
					0 => __( 'Optional', 'dp-intro-tours' ),
					1 => __( 'Yes', 'dp-intro-tours' ),
					2 => __( 'No', 'dp-intro-tours' ),
				],
				'layout'        => 'horizontal',
				'default_value' => 0,
			]
		...
		acf_render_field_setting(
			$field,
			[
				'label'         => __( 'Table Caption', 'dp-intro-tours' ),
				'instructions'  => __( 'Presetting the usage of table caption', 'dp-intro-tours' ),
				'type'          => 'radio',
				'name'          => 'use_caption',
				'choices'       => [
					1 => __( 'Yes', 'dp-intro-tours' ),
	...
	*/
	...
	public function render_field( $field ) {
		...
		*/
		...
		$e .= '<div id="dpit-step-table" class="acf-table-root">';
	...
	public function update_value( $value, $post_id, $field ) {
		...
		if ( isset( $value['header'] )
			...
			// SYNCHRONIZE TOP ROW DATA WITH CHANGED AMOUNT OF BODY COLUMNS  {
