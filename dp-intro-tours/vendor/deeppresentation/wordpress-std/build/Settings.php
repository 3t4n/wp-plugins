...
class Settings
{
	...
	public static function update_setting_array_bool(string $optionId, string $optionSubFieldId, bool $value, bool $createIfNotExist = false): bool
	{
		return self::update_setting_array($optionId, $optionSubFieldId, $value ? '1' : '0', $createIfNotExist);
	}


	public static function get_setting_array_int(string $optionId, string $optionSubFieldId, int $def = 0): int
	{
		return \intval(self::get_setting_array_field($optionId, $optionSubFieldId, $def), 10);
	}

	public static function update_setting_array_int(string $optionId, string $optionSubFieldId, int $value, bool $createIfNotExist = false): bool
	{
		return self::update_setting_array($optionId, $optionSubFieldId, $value, $createIfNotExist);
	}
	...
	public static function init_setting_array(
		string $optionId,
		string $sectionId,
		string $sectionTitle,
		string $page,
		array $fields = [],
		$renderDescriptionClb = null,
		bool $cleanNotSupportedFields = false,
		$option_root_class = 'dp-settings'
	) {
		$options = get_option($optionId, null);
		if (is_null($options)) {
