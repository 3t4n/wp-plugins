...
Tags: mailchimp, wheelio for wordpress, wordpress fortune wheel, lucky wheel, wheel for wordpress
...
>[Try the Demo](http://new2new.com/?item=wordpress-lucky-wheel "Demo WordPress Lucky Wheel") | [Documents](http://docs.villatheme.com/?theme=wordpress-lucky-wheel "Documents")| [Premium version](https://1.envato.market/xDRb1) | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")

[youtube https://www.youtube.com/watch?v=cug1zt2AT3A]
...
&#9658; **Shortcode**: You can use shortcode [wordpress_lucky_wheel] to display wheel on a specific page without popup

&#9658; **Admin notification**: Able to send email to admin or to a specific address whenever a customer wins a prize.
...
/**1.0.12 - 2024.07.16**/
- Updated: Compatible with WP6.6
- Fixed: Fixed error when active

/**1.0.11 - 2024.07.04**/
- Updated: Compatible with WP6.5.5
- Updated: Update support file
- Fixed: Fixed security

/**1.0.10 - 2024.04.13**/
- Updated: Compatible with WP6.5.0
- Updated: Update support file

/**1.0.9 - 2023.09.22**/
- Updated: Compatible with WP6.3.0
- Updated: Update support file

/**1.0.8 - 2023.02.23**/
- Updated: Compatible with WP6.1.0
- Updated: Update support file
– Updated: Language file

/**1.0.7 - 2022.05.21**/
- Updated: Compatible with WP6.0.0
- Updated: Update support file
- Fixed: Fixed security
...
/**1.0.5 - 2022.03.21 **/
- Updated: Compatible with WP5.9
- Updated: Update support file

/**1.0.4.2 - 2021.08.16 **/
- Updated: Compatible with WP5.8
- Updated: Update support file
