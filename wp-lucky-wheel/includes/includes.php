...
define( 'VI_WP_LUCKY_WHEEL_PLUGINS', VI_WP_LUCKY_WHEEL_DIR . "plugins" . DIRECTORY_SEPARATOR );
...
vi_include_folder( VI_WP_LUCKY_WHEEL_PLUGINS, 'VI_WP_LUCKY_WHEEL_PLUGINS_' );