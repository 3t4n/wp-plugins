...
<?php if ( 'faire-new' === $wc_order_status ) : ?>
	<button
		...
		type="button"
		data-faire_order_id="<?php echo esc_attr( $faire_order_id ); ?>"
		data-wc_order_id="<?php echo esc_attr( $wc_order_id ); ?>"
	>
...
<?php if ( 'processing' === $wc_order_status ) : ?>
	...
	<button
		...
		data-faire_order_id="<?php echo esc_attr( $faire_order_id ); ?>"
		data-wc_order_id="<?php echo esc_attr( $wc_order_id ); ?>"
		data-wc_order_created="<?php echo esc_attr( $wc_order_created ); ?>"
		data-wc_order_updated="<?php echo esc_attr( $wc_order_updated ); ?>"
	>
