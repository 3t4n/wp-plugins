...
Contributors: Faire
Tags: Marketplace, Integration, Wholesale
...
### Third-Party Service Use Disclosure

This plugin utilizes third-party services as described below. To remain transparent and comply with WordPress guidelines, here is a full disclosure of what data is shared, the purpose of the integration, and links to the [Terms of Use](https://www.faire.com/tos) and [Privacy Policy](https://www.faire.com/privacy).

- Service URL:
  - production: https://faire.com/external-api/v2/
  - staging: https://faire-stage.com/external-api/v2/ (sandbox for testing)
- Purpose: This APIs are used to fetch product and order data from Faire’s system, integrating it into your WordPress site.
- Data Sent: Various data may be sent based on the API endpoint called, including, but not limited to, product details, or order information.
...
= 1.7.7 =
* Fix:    WordPress Security and Coding Standards.

= 1.7.6 =
* Fix:    WordPress Security and Coding Standards.
* Fix:    Fix Uncaught TypeError in Logger.

= 1.7.5 =
* Fix:    Fix Uncaught TypeError in Logger.

= 1.7.4 =
* Add:    Allow to set order sync statuses.
* Add:    Allow to set order sync since datetime.
* Add:    Faire product ID to product edit screen.
* Add:    Filter to allow map custom WooCommerce order statuses to Faire order statuses.
* Add:    Filter to suppress updating WooCommerce order status.
* Add:    Action filter to allow programmatically trigger Sync_Product and Sync_Order methods.
* Fix:    Fix inventory sync issue when orders creation setting is disabled.
* Fix:    Product sync issue when per_style_minimum_order_quantity is set on Simple product.

= 1.7.3 =
* Add:    Prevent calculating woo taxes on faire orders.
* Add:    Settings logging.
* Add:    Improve error messages.
* Change: Geo constrain logic.

= 1.7.2 =
* Fix:    CSV Download.

= 1.7.1 =
* Change: Allow to create (link) products with duplicate SKU by not setting the SKU.
* Add:    Wordpress 6.5 compatibility.
* Fix:    Installation process.
* Fix:    Is WooCommerce active for multisite install.
* Fix:    Product backorder status.
* Fix:    Product attribute mismatch during link and sync process.
* Fix:    Summary for product linking.
