...
`], ...formatTraceEntry(entry));
  ...
  **/
  ...
  axios.default = axios;
  const _hoisted_1$a = { class: "anwp-vue-api-import-wrapper" };
  const _hoisted_2$4 = { class: "mb-3" };
  const _hoisted_3$4 = {
    key: 0,
    class: "text-muted mx-2 d-inline-block"
  };
  const _hoisted_4$4 = ["onClick", "href"];
  const _hoisted_5$4 = { class: "my-3 px-3 py-3 border anwp-sl-batch-import-filter-wrapper" };
  const _hoisted_6$4 = { class: "d-flex flex-wrap" };
  const _hoisted_7$3 = ["disabled"];
  const _hoisted_8$3 = { class: "anwp-overflow-x-auto" };
  ...
  const _sfc_main$a = {
    ...
    setup(__props) {
      ...
      const AppAxios = axios.create({
        baseURL: window._slImportTool.rest_root,
        headers: {
          "X-WP-Nonce": window._slImportTool.rest_nonce
        }
      });
      ...
      const columns = ref([]);
      const appPages = ref(window._slImportTool.pages || []);
      ...
      const applyNewSettings = () => {
        ...
        localStorage.setItem(`sl-import-tool--${activePage.value}`, JSON.stringify(objectToSave));
      };
      ...
      const saveData = () => {
        ...
        const importData = (row_data) => {
          ...
          if (isInsertMode.value && "games_insert" === activePage.value) {
            ...
            const titleColName = (_b2 = columns.value.find((c2) => "name" === c2.fl_tool)) == null ? void 0 : _b2.name;
            if (!titleColName || !row_data[titleColName]) {
              maybeImportData();
              return;
            }
          } else {
            const idColName = (_c = columns.value.find((c2) => "id" === c2.fl_tool)) == null ? void 0 : _c.name;
          ...
          AppAxios.post("sports-leagues/import/" + activePage.value, {
            row_data,
      ...
      const initializeColumns = () => {
        ...
        const savedColumns = safeJsonParse(localStorage.getItem(`slimport-tool--${activePage.value}`), []);
      ...
      const statusMessage = computed(() => {
        ...
        if (isInsertMode.value) {
          if (!((_a3 = columns.value.find((c2) => "name" === c2.sl_tool)) == null ? void 0 : _a3.visible)) {
          ...
          if ((_b2 = columns.value.find((c2) => "id" === c2.sl_tool)) == null ? void 0 : _b2.visible) {
            messageObj.msg = `"${columns.value.find((c2) => "id" === c2.sl_tool).title}" column will be ignored. Maybe you want to import "External ID" field.`;
            messageObj.blockClass = "anwp-bg-blue-100 anwp-text-blue-700 anwp-border anwp-border-blue-700";
            return messageObj;
          }
        } else {
          if (!((_c = columns.value.find((c2) => "id" === c2.sl_tool)) == null ? void 0 : _c.visible) && !((_d = columns.value.find((c2) => "external_id" === c2.sl_tool)) == null ? void 0 : _d.visible)) {
            messageObj.isError = true;
            messageObj.msg = "Required instance ID or External ID column is missing! Update Import is impossible.";
            messageObj.blockClass = "anwp-bg-red-100 anwp-text-red-700 anwp-border anwp-border-red-700";
            return messageObj;
          }
          if ((_e2 = columns.value.find((c2) => "id" === c2.sl_tool)) == null ? void 0 : _e2.visible) {
            messageObj.msg = `The plugin will match and update the data by "${columns.value.find((c2) => "id" === c2.sl_tool).title}"`;
            messageObj.blockClass = "anwp-bg-blue-100 anwp-text-blue-700 anwp-border anwp-border-blue-700";
            return messageObj;
          }
          if ((_f = columns.value.find((c2) => "external_id" === c2.sl_tool)) == null ? void 0 : _f.visible) {
            messageObj.msg = `The plugin will match and update the data by "${columns.value.find((c2) => "external_id" === c2.sl_tool).title}"`;
            messageObj.blockClass = "anwp-bg-blue-100 anwp-text-blue-700 anwp-border anwp-border-blue-700";
            return messageObj;
          }
        }
      ...
      onMounted(() => {
        ...
        anwpImportJExcelTool.value.addEventListener("click", (e) => {
          var _a3, _b2;
          if ("TD" === ((_a3 = e.target) == null ? void 0 : _a3.tagName) && ((_b2 = e.target) == null ? void 0 : _b2.classList.contains("jexcel_dropdown")) && tableInstance) {
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$a, [
          createBaseVNode("div", _hoisted_2$4, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(appPages.value, (page) => {
              return openBlock(), createElementBlock(Fragment, null, [
                "players" !== page.slug ? (openBlock(), createElementBlock("small", _hoisted_3$4, "|")) : createCommentVNode("", true),
                createBaseVNode("a", {
                  ...
                  href: `admin.php?page=sl-import-tool&tool=${page.slug}`
                }, toDisplayString(page.title), 11, _hoisted_4$4)
              ], 64);
            }), 256))
          ]),
          ...
          createBaseVNode("div", _hoisted_5$4, [
            createBaseVNode("div", _hoisted_6$4, [
              createBaseVNode("button", {
                ...
                key: "sl-change-btn"
              }, " Change Import Columns ", 8, _hoisted_7$3),
            ...
            isActiveChangeStructure.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              _cache[7] || (_cache[7] = createBaseVNode("h4", { class: "mb-1 mt-3" }, "Columns order and visibility", -1)),
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        _cache[6] || (_cache[6] = createBaseVNode("svg", { class: "anwp-icon anwp-icon--s24 anwp-icon--octi anwp-drag-handler" }, [
                        ...
                        createBaseVNode("div", {
                          ...
                          column.visible ? (openBlock(), createElementBlock("svg", _hoisted_10$3, _cache[4] || (_cache[4] = [
                            createBaseVNode("use", { "xlink:href": "#icon-eye" }, null, -1)
                          ]))) : (openBlock(), createElementBlock("svg", _hoisted_11$3, _cache[5] || (_cache[5] = [
          ...
          withDirectives(createBaseVNode("div", null, [
            ...
            !(statusMessage.value && statusMessage.value.isError) ? (openBlock(), createElementBlock("div", _hoisted_12$3, [
              createBaseVNode("button", {
                type: "button",
  ...
  const useAppStore = /* @__PURE__ */ defineStore("app", () => {
    ...
    const spinnerUrl = window._slToolbox.spinner_url || "";
  ...
  const _hoisted_2$3 = { class: "text-nowrap d-flex" };
  const _hoisted_3$3 = { class: "d-inline-block anwp-w-100" };
  const _hoisted_4$3 = { class: "anwp-w-120 anwp-text-center mr-3" };
  const _hoisted_5$3 = {
    key: 0,
  ...
  const _sfc_main$9 = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return unref(appStore).appLogs.length ? (openBlock(), createElementBlock("div", _hoisted_1$9, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(appStore).appLogs, (log) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_2$3, [
                ...
                createBaseVNode("span", _hoisted_3$3, toDisplayString(log.time), 1)
              ]),
  ...
  const _hoisted_1$8 = { class: "anwp-vue-optimizer-wrapper d-sm-flex" };
  const _hoisted_2$2 = { class: "w-100 anwp-flex-grow-1 pr-5" };
  const _hoisted_3$2 = {
    key: 0,
  ...
  const _hoisted_6$2 = { class: "anwp-b-wrap anwp-w-max-500" };
  const _hoisted_7$2 = { class: "my-2 anwp-border anwp-border-gray-400 py-2 px-3 bg-white d-flex" };
  const _hoisted_8$2 = { class: "anwp-flex-grow-1" };
  const _hoisted_9$2 = { class: "mt-2 mb-1" };
  const _hoisted_10$2 = {
    key: 0,
  ...
  const _hoisted_12$2 = { class: "my-0 anwp-opacity-90 font-italic" };
  ...
  const _hoisted_18$2 = { class: "flex-shrink-1 d-flex flex-column anwp-text-nowrap text-nowrap" };
  const _sfc_main$8 = {
    __name: "AppToolbox",
    setup(__props) {
      var _a2;
      const AppAxios = axios.create({
        baseURL: window._slToolbox.rest_root,
        headers: {
          "X-WP-Nonce": window._slToolbox.rest_nonce
        }
      });
      const appStore = useAppStore();
      const pageNumber = Number((_a2 = window._slToolbox.sl_page_num) != null ? _a2 : 10);
      ...
      const runSubTask = (subtasks) => {
        AppAxios.post(
          "sports-leagues/api-toolbox-updater/" + appStore.activeRequest,
          { subtasks }
        ).then(() => {
          runNextSubTask();
        }).catch((error) => {
      ...
      const updateTasksList = () => {
        ...
        AppAxios.get("sports-leagues/api-toolbox-updater/get_toolbox_updater_tasks").then((response) => {
          var _a3;
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1$8, [
          createBaseVNode("div", _hoisted_2$2, [
            "update_tasks_list" === unref(appStore).activeRequest ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
              createBaseVNode("img", {
                src: unref(appStore).spinnerUrl,
                alt: "spinner",
                class: "mr-2"
              }, null, 8, _hoisted_4$2),
              _cache[3] || (_cache[3] = createBaseVNode("span", null, "Check database tasks to update", -1))
            ])) : createCommentVNode("", true),
            ...
            createBaseVNode("div", _hoisted_6$2, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(appStore).updaterTasks, (task) => {
                return openBlock(), createElementBlock("div", _hoisted_7$2, [
                  createBaseVNode("div", _hoisted_8$2, [
                    createBaseVNode("h4", _hoisted_9$2, [
                      createTextVNode(toDisplayString(task.title) + " ", 1),
                      unref(appStore).activeRequest === task.slug ? (openBlock(), createElementBlock("span", _hoisted_10$2, toDisplayString(unref(appStore).activeProgress), 1)) : createCommentVNode("", true),
                      createTextVNode(" - " + toDisplayString(task.total), 1)
                    ]),
                    showIDs.value ? (openBlock(), createElementBlock("p", _hoisted_11$2, toDisplayString(task.subtasks), 1)) : createCommentVNode("", true),
                    createBaseVNode("p", _hoisted_12$2, toDisplayString(task.description), 1)
                  ]),
                  createBaseVNode("div", null, [
                    "pending" === task.status && (task.slug === availableTaskToRun.value || changeOrder.value) ? (openBlock(), createElementBlock("button", {
                      ...
                      unref(appStore).activeRequest === task.slug ? (openBlock(), createElementBlock("img", {
                        ...
                        src: unref(appStore).spinnerUrl,
                        alt: "spinner"
                      }, null, 8, _hoisted_14$2)) : (openBlock(), createElementBlock("svg", _hoisted_15$2, _cache[4] || (_cache[4] = [
                        createBaseVNode("use", { "xlink:href": "#icon-chevron-right" }, null, -1)
                      ])))
                    ], 8, _hoisted_13$2)) : createCommentVNode("", true),
                    "pending" === task.status && task.slug !== availableTaskToRun.value && !changeOrder.value ? (openBlock(), createElementBlock("button", _hoisted_16$2, _cache[5] || (_cache[5] = [
                      createBaseVNode("svg", { class: "anwp-icon anwp-icon--octi anwp-icon--s16" }, [
                        createBaseVNode("use", { "xlink:href": "#icon-chevron-right" })
                      ], -1)
                    ]))) : createCommentVNode("", true),
                    "done" === task.status ? (openBlock(), createElementBlock("div", _hoisted_17$2, _cache[6] || (_cache[6] = [
  ...
  */
  ...
  const ho = (e) => {
    ...
    }, le$3 || (document.addEventListener("touchmove", se$1, be$2 ? { passive: false } : void 0), le$3 = true)) : To(o2);
  }, ko = (e) => {
    if (!e) {
      console.error(
    ...
    j$1 = j$1.filter((o2) => o2.targetElement !== e), He$2 ? (e.ontouchstart = null, e.ontouchmove = null, le$3 && j$1.length === 0 && (document.removeEventListener("touchmove", se$1, be$2 ? { passive: false } : void 0), le$3 = false)) : j$1.length || So();
  };
  function Vo(e, o2) {
  ...
  }, Ao = () => getCurrentInstance() && inject(Ye$1, Po) || H$2;
  function zo() {
...
This will fail in production.`
  ...
  const _hoisted_1$7 = { class: "anwp-vue-dashboard-wrapper sl-dashboard" };
  const _hoisted_2$1 = { class: "entry-title mb-5 d-flex align-items-center" };
  const _hoisted_3$1 = {
    key: 0,
    class: "pl-4 py-2 pr-5 anwp-border anwp-border-orange-700 anwp-bg-orange-100 position-relative d-flex align-items-center",
    style: { "max-width": "550px" }
  };
  const _hoisted_4$1 = { class: "sl-dashboard__section" };
  const _hoisted_5$1 = { class: "sl-dashboard__section-boxes" };
  const _hoisted_6$1 = { class: "sl-dashboard__section-box" };
  const _hoisted_7$1 = { class: "sl-dashboard__section-box-inside d-flex flex-column sl-dashboard__section-box-inside--mini" };
  const _hoisted_8$1 = {
    key: 0,
    class: "anwp-text-lg"
  };
  const _hoisted_9$1 = { key: 1 };
  const _hoisted_10$1 = { class: "d-flex mt-auto" };
  const _hoisted_11$1 = { class: "sl-dashboard__section mt-5" };
  const _hoisted_12$1 = { class: "sl-dashboard__section-boxes" };
  const _hoisted_13$1 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_14$1 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_15$1 = {
    key: 0,
    class: "sl-dashboard__section-box-item"
  };
  const _hoisted_16$1 = { class: "sl-dashboard__section-box-item-empty anwp-text-xs mb-4 mt-1" };
  const _hoisted_17$1 = { class: "d-flex mt-auto" };
  const _hoisted_18$1 = ["href"];
  const _hoisted_19$1 = ["href"];
  const _hoisted_20$1 = { class: "d-flex mt-auto" };
  const _hoisted_21$1 = ["href"];
  const _hoisted_22$1 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_23$1 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_24$1 = {
    key: 0,
    class: "sl-dashboard__section-box-item"
  };
  const _hoisted_25$1 = { class: "sl-dashboard__section-box-item-empty anwp-text-xs mb-4 mt-1" };
  const _hoisted_26$1 = { class: "d-flex mt-auto" };
  const _hoisted_27$1 = ["href"];
  const _hoisted_28$1 = ["href"];
  const _hoisted_29$1 = { class: "d-flex mt-auto" };
  const _hoisted_30$1 = ["href"];
  const _hoisted_31$1 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_32$1 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_33$1 = {
    key: 0,
    class: "mb-3"
  };
  const _hoisted_34$1 = {
    key: 1,
    class: "sl-dashboard__section-box-item anwp-text-orange-600 d-flex align-items-center"
  };
  const _hoisted_35$1 = {
    key: 2,
    class: "sl-dashboard__section-box-item anwp-text-orange-600 d-flex align-items-center"
  ...
  const _hoisted_37$1 = { class: "sl-dashboard__section-box-item-empty anwp-text-xs mb-4 mt-1" };
  const _hoisted_38$1 = { class: "d-flex mt-auto" };
  const _hoisted_39$1 = ["href"];
  const _hoisted_40$1 = ["href"];
  const _hoisted_41$1 = { class: "d-flex mt-auto" };
  const _hoisted_42$1 = ["href"];
  const _hoisted_43$1 = { class: "sl-dashboard__section mt-5" };
  const _hoisted_44$1 = { class: "sl-dashboard__section-boxes" };
  const _hoisted_45$1 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_46 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_47 = { class: "mr-1" };
  const _hoisted_48 = { class: "d-flex mt-auto" };
  const _hoisted_49 = ["href"];
  const _hoisted_50 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_51 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_52 = {
    class: "sl-dashboard__section-box-item",
    key: "o"
  };
  const _hoisted_53 = {
    key: 0,
    class: "sl-dashboard__section-box-item-empty anwp-text-base"
  };
  const _hoisted_54 = {
    key: 1,
    class: "anwp-font-medium"
  };
  const _hoisted_55 = { class: "d-flex mt-auto" };
  const _hoisted_56 = ["href"];
  const _hoisted_57 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_58 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_59 = {
    key: 1,
    class: "anwp-font-medium"
  };
  const _hoisted_60 = { class: "d-flex mt-auto" };
  const _hoisted_61 = ["href"];
  const _hoisted_62 = { class: "sl-dashboard__section mt-5" };
  const _hoisted_63 = { class: "sl-dashboard__section-boxes" };
  const _hoisted_64 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_65 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_66 = {
    key: 0,
    class: "sl-dashboard__section-box-item"
  };
  const _hoisted_67 = { class: "sl-dashboard__section-box-item-empty anwp-text-xs mb-4 mt-1" };
  const _hoisted_68 = { class: "d-flex mt-auto" };
  const _hoisted_69 = { class: "d-flex mt-auto" };
  const _hoisted_70 = ["href"];
  const _hoisted_71 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_72 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_73 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_74 = { class: "d-flex mt-auto" };
  const _hoisted_75 = ["href"];
  const _hoisted_76 = { class: "d-flex mt-auto" };
  const _hoisted_77 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_78 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_79 = {
    key: 0,
    class: "mb-3"
  };
  ...
  const _hoisted_82 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_83 = { class: "d-flex mt-auto" };
  const _hoisted_84 = ["href"];
  const _hoisted_85 = ["href"];
  const _hoisted_86 = { class: "d-flex mt-auto" };
  const _hoisted_87 = ["href"];
  const _hoisted_88 = { class: "sl-dashboard__section mt-5" };
  const _hoisted_89 = { class: "sl-dashboard__section-boxes" };
  const _hoisted_90 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_91 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_92 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_93 = { class: "d-flex mt-auto" };
  const _hoisted_94 = ["href"];
  const _hoisted_95 = ["href"];
  const _hoisted_96 = { class: "d-flex mt-auto" };
  const _hoisted_97 = ["href"];
  const _hoisted_98 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_99 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_100 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_101 = { class: "d-flex mt-auto" };
  const _hoisted_102 = ["href"];
  const _hoisted_103 = { class: "d-flex mt-auto" };
  const _hoisted_104 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_105 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_106 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_107 = { class: "d-flex mt-auto" };
  const _hoisted_108 = ["href"];
  const _hoisted_109 = { class: "d-flex mt-auto" };
  const _hoisted_110 = { class: "sl-dashboard__section-box d-flex flex-column" };
  const _hoisted_111 = { class: "sl-dashboard__section-box-inside d-flex flex-column h-100" };
  const _hoisted_112 = { class: "anwp-text-base mb-4 mt-1" };
  const _hoisted_113 = { class: "d-flex mt-auto" };
  const _hoisted_114 = ["href"];
  const _hoisted_115 = { class: "d-flex mt-auto" };
  const _hoisted_116 = { class: "anwp-vfm-admin-modal__content" };
  const _hoisted_117 = { class: "text-center" };
  const _hoisted_118 = ["value"];
  const _hoisted_119 = { class: "anwp-vfm-admin-modal__actions" };
  const _hoisted_120 = { class: "d-flex" };
  const _hoisted_121 = { class: "anwp-vfm-admin-modal__title d-flex flex-wrap align-items-center" };
  const _hoisted_122 = { class: "my-0" };
  const _hoisted_123 = { class: "anwp-vfm-admin-modal__content" };
  const _hoisted_124 = {
    key: 0,
    class: "anwp-b-wrap"
  };
  const _hoisted_125 = { class: "mt-3 mb-5" };
  const _hoisted_126 = ["href"];
  const _hoisted_127 = { class: "mt-3 mb-4" };
  const _hoisted_128 = ["href"];
  const _hoisted_129 = { class: "mt-3 mb-5" };
  const _hoisted_130 = ["href"];
  const _hoisted_131 = { class: "mt-3 mb-4" };
  const _hoisted_132 = ["href"];
  const _hoisted_133 = {
    key: 2,
    class: "anwp-b-wrap"
  };
  const _hoisted_134 = { class: "mt-3 mb-5" };
  const _hoisted_135 = ["href"];
  const _hoisted_136 = { class: "mt-3 mb-4" };
  const _hoisted_137 = ["href"];
  const _hoisted_138 = {
    key: 3,
    class: "anwp-b-wrap"
  };
  const _hoisted_139 = { class: "mt-3 mb-5" };
  const _hoisted_140 = ["href"];
  const _hoisted_141 = { class: "mt-3 mb-4" };
  const _hoisted_142 = ["href"];
  const _hoisted_143 = {
    key: 4,
    class: "anwp-b-wrap"
  };
  const _hoisted_144 = { class: "mt-3 mb-5" };
  const _hoisted_145 = ["href"];
  const _hoisted_146 = { class: "mt-3 mb-4" };
  const _hoisted_147 = ["href"];
  const _sfc_main$7 = {
    __name: "AppDashboard",
    setup(__props) {
      const AppAxios = axios.create({
        baseURL: window._slDashboardData.rest_root,
        headers: {
          "X-WP-Nonce": window._slDashboardData.rest_nonce
        }
      });
      const reloadOnFocus = ref(false);
      const activeRequest = ref("");
      const dataModalContext = ref("");
      const isAddDataModalOpen = ref(false);
      const isSportModalOpen = ref(false);
      const sport = ref(window.slDashboardData.dashboardData.sport || "");
      const sportModalValue = ref("");
      const slDashboardData = window.slDashboardData || {};
      const notyf2 = new Notyf();
      const sportName = computed(() => {
        var _a2, _b2;
        return sport ? (_b2 = (_a2 = slDashboardData.options.availableSports) == null ? void 0 : _a2.find((o2) => o2.value === sport.value)) == null ? void 0 : _b2.label : "";
      });
      const saveSport = () => {
        activeRequest.value = "saveSport";
        AppAxios.post(
          `sports-leagues/dashboard/save_sport`,
          {
            sport: sportModalValue.value
          }
        ).then((response) => {
          if (!response.data.success) {
            notyf2.error("Error on Save");
          } else {
            location.reload();
            isSportModalOpen.value = false;
          }
        }).catch((error) => {
          notyf2.error((error == null ? void 0 : error.message) || "Error on Save");
        }).finally(() => activeRequest.value = "");
      };
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1$7, [
          createBaseVNode("h1", _hoisted_2$1, [
            _cache[55] || (_cache[55] = createTextVNode(" Dashboard ")),
            createBaseVNode("button", {
              type: "button",
              class: "button ml-3 d-flex align-items-center",
              onClick: _cache[0] || (_cache[0] = withModifiers(($event) => _ctx.location.reload(), ["prevent"]))
            }, _cache[54] || (_cache[54] = [
              createBaseVNode("span", { class: "dashicons dashicons-image-rotate mr-2" }, null, -1),
              createTextVNode(" Refresh ")
            ]))
          ]),
          reloadOnFocus.value ? (openBlock(), createElementBlock("div", _hoisted_3$1, [
            _cache[58] || (_cache[58] = createTextVNode(" If you made any changes, reload this page. ")),
            createBaseVNode("button", {
              type: "button",
              class: "button ml-auto px-3 d-flex align-items-center",
              onClick: _cache[1] || (_cache[1] = withModifiers(($event) => _ctx.location.reload(), ["prevent"]))
            }, _cache[56] || (_cache[56] = [
              createBaseVNode("span", { class: "dashicons dashicons-image-rotate mr-2" }, null, -1),
              createTextVNode(" Reload ")
            ])),
            createBaseVNode("div", {
              class: "position-absolute anwp-cursor-pointer",
              style: { "top": "5px", "right": "2px" },
              onClick: _cache[2] || (_cache[2] = withModifiers(($event) => reloadOnFocus.value = false, ["prevent"]))
            }, _cache[57] || (_cache[57] = [
              createBaseVNode("span", { class: "dashicons dashicons-no-alt" }, null, -1)
            ]))
          ])) : createCommentVNode("", true),
          createBaseVNode("section", _hoisted_4$1, [
            _cache[61] || (_cache[61] = createBaseVNode("h3", null, "General", -1)),
            createBaseVNode("div", _hoisted_5$1, [
              createBaseVNode("div", _hoisted_6$1, [
                _cache[59] || (_cache[59] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-universal-access" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Sport ")
                ], -1)),
                createBaseVNode("div", _hoisted_7$1, [
                  sport.value ? (openBlock(), createElementBlock("div", _hoisted_8$1, toDisplayString(sportName.value), 1)) : (openBlock(), createElementBlock("div", _hoisted_9$1, "- not selected -")),
                  createBaseVNode("div", _hoisted_10$1, [
                    createBaseVNode("button", {
                      type: "button",
                      class: "button ml-auto",
                      onClick: _cache[3] || (_cache[3] = withModifiers(($event) => isSportModalOpen.value = true, ["prevent"]))
                    }, toDisplayString(sport.value ? "Change Sport" : "Select Sport"), 1)
                  ])
                ])
              ]),
              _cache[60] || (_cache[60] = createStaticVNode('<div class="sl-dashboard__section-box"><div class="sl-dashboard__section-box-header d-flex align-items-center"><div class="sl-dashboard__section-box-header-icon d-flex align-items-center"><span class="dashicons dashicons-admin-customizer"></span></div><div class="sl-dashboard__section-box-header-title"> Global Style </div></div><div class="sl-dashboard__section-box-inside d-flex flex-column sl-dashboard__section-box-inside--mini"><div>- default -</div><div class="d-flex mt-auto align-items-center"><button type="button" class="button ml-auto" disabled="true">Select Style</button></div></div></div>', 1))
            ])
          ]),
          createBaseVNode("section", _hoisted_11$1, [
            _cache[76] || (_cache[76] = createBaseVNode("h3", null, "Structure", -1)),
            createBaseVNode("div", _hoisted_12$1, [
              createBaseVNode("div", _hoisted_13$1, [
                _cache[65] || (_cache[65] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-awards" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Leagues ")
                ], -1)),
                createBaseVNode("div", _hoisted_14$1, [
                  unref(slDashboardData).options.leagues.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.leagues, (o2, index) => {
                      return openBlock(), createElementBlock(Fragment, { key: o2 }, [
                        index < 3 ? (openBlock(), createElementBlock("div", _hoisted_15$1, toDisplayString(o2), 1)) : createCommentVNode("", true)
                      ], 64);
                    }), 128)),
                    unref(slDashboardData).options.leagues.length > 3 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      _cache[62] || (_cache[62] = createBaseVNode("div", { class: "sl-dashboard__section-box-item-empty anwp-text-base" }, ".....", -1)),
                      createBaseVNode("div", _hoisted_16$1, "and " + toDisplayString(unref(slDashboardData).options.leagues.length - 3) + " other league(s) ", 1)
                    ], 64)) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_17$1, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).addNewLeague,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                        onClick: _cache[4] || (_cache[4] = ($event) => {
                          reloadOnFocus.value = true;
                        })
                      }, "All Leagues", 8, _hoisted_18$1),
                      createBaseVNode("a", {
                        href: unref(slDashboardData).addNewLeague,
                      ...
                      }, "Add New", 8, _hoisted_19$1)
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[63] || (_cache[63] = createBaseVNode("div", { class: "anwp-font-medium anwp-text-orange-600 d-flex align-items-center" }, [
                      createBaseVNode("span", { class: "dashicons dashicons-warning" }),
                      createTextVNode(" You don't have any League. ")
                    ], -1)),
                    _cache[64] || (_cache[64] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Create a New' button and add your first league (e.g.: 'Super League' or 'Premier League').", -1)),
                    createBaseVNode("div", _hoisted_20$1, [
                      ...
                      }, "Create a New League", 8, _hoisted_21$1)
                    ])
                  ], 64))
                ])
              ]),
              createBaseVNode("div", _hoisted_22$1, [
                _cache[69] || (_cache[69] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-calendar-alt" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Seasons ")
                ], -1)),
                createBaseVNode("div", _hoisted_23$1, [
                  unref(slDashboardData).options.seasons.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.seasons, (o2, index) => {
                      return openBlock(), createElementBlock(Fragment, { key: o2 }, [
                        index < 3 ? (openBlock(), createElementBlock("div", _hoisted_24$1, toDisplayString(o2), 1)) : createCommentVNode("", true)
                      ], 64);
                    }), 128)),
                    unref(slDashboardData).options.seasons.length > 3 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      _cache[66] || (_cache[66] = createBaseVNode("div", { class: "sl-dashboard__section-box-item-empty anwp-text-base" }, ".....", -1)),
                      createBaseVNode("div", _hoisted_25$1, "and " + toDisplayString(unref(slDashboardData).options.seasons.length - 3) + " other season(s) ", 1)
                    ], 64)) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_26$1, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).addNewSeason,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "Add New", 8, _hoisted_28$1)
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[67] || (_cache[67] = createBaseVNode("div", { class: "anwp-font-medium anwp-text-orange-600 d-flex align-items-center" }, [
                      createBaseVNode("span", { class: "dashicons dashicons-warning" }),
                      createTextVNode(" You don't have any Season. ")
                    ], -1)),
                    _cache[68] || (_cache[68] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Create a New' button and add your first season (e.g.: '2023' or '2022-2023').", -1)),
                    createBaseVNode("div", _hoisted_29$1, [
                      ...
                      }, "Create a New Season", 8, _hoisted_30$1)
                    ])
                  ], 64))
                ])
              ]),
              createBaseVNode("div", _hoisted_31$1, [
                _cache[75] || (_cache[75] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-buddicons-forums" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Tournaments ")
                ], -1)),
                createBaseVNode("div", _hoisted_32$1, [
                  unref(slDashboardData).options.seasons.length < 1 || unref(slDashboardData).options.leagues.length < 1 ? (openBlock(), createElementBlock("div", _hoisted_33$1, "You haven't fulfil all requirements to create a tournament. ")) : createCommentVNode("", true),
                  unref(slDashboardData).options.leagues.length < 1 ? (openBlock(), createElementBlock("div", _hoisted_34$1, _cache[70] || (_cache[70] = [
                    createBaseVNode("span", { class: "dashicons dashicons-warning" }, null, -1),
                    createTextVNode(" League required ")
                  ]))) : createCommentVNode("", true),
                  unref(slDashboardData).options.seasons.length < 1 ? (openBlock(), createElementBlock("div", _hoisted_35$1, _cache[71] || (_cache[71] = [
                    createBaseVNode("span", { class: "dashicons dashicons-warning" }, null, -1),
                    createTextVNode(" Season required ")
                  ]))) : createCommentVNode("", true),
                  unref(slDashboardData).options.tournaments.length ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.tournaments, (o2, index) => {
                      return openBlock(), createElementBlock(Fragment, { key: o2 }, [
                        index < 3 ? (openBlock(), createElementBlock("div", _hoisted_36$1, toDisplayString(o2), 1)) : createCommentVNode("", true)
                      ], 64);
                    }), 128)),
                    unref(slDashboardData).options.tournaments.length > 3 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      _cache[72] || (_cache[72] = createBaseVNode("div", { class: "sl-dashboard__section-box-item-empty anwp-text-base" }, ".....", -1)),
                      createBaseVNode("div", _hoisted_37$1, "and " + toDisplayString(unref(slDashboardData).options.tournaments.length - 3) + " other tournament(s) ", 1)
                    ], 64)) : createCommentVNode("", true)
                  ], 64)) : createCommentVNode("", true),
                  createBaseVNode("div", _hoisted_38$1, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).allTournaments,
                      class: "button button-secondary",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "All Tournaments", 8, _hoisted_39$1),
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewTournament,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Add New", 8, _hoisted_40$1)
                  ]),
                  unref(slDashboardData).options.tournaments.length < 1 && unref(slDashboardData).options.seasons.length > 0 && unref(slDashboardData).options.leagues.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
                    _cache[73] || (_cache[73] = createBaseVNode("div", { class: "anwp-font-medium anwp-text-orange-600 d-flex align-items-center" }, [
                      createBaseVNode("span", { class: "dashicons dashicons-warning" }),
                      createTextVNode(" You don't have any Tournament. ")
                    ], -1)),
                    _cache[74] || (_cache[74] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Create a New' button and add your first tournament (e.g.: 'Super League 2022-2023').", -1)),
                    createBaseVNode("div", _hoisted_41$1, [
                      ...
                      }, "Create a New Tournament", 8, _hoisted_42$1)
                    ])
                  ], 64)) : createCommentVNode("", true)
                ])
              ])
          ...
          createBaseVNode("section", _hoisted_43$1, [
            _cache[83] || (_cache[83] = createBaseVNode("h3", null, "Configuration & Statistics", -1)),
            createBaseVNode("div", _hoisted_44$1, [
              createBaseVNode("div", _hoisted_45$1, [
                _cache[80] || (_cache[80] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-admin-generic" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Sport Configurator ")
                ], -1)),
                createBaseVNode("div", _hoisted_46, [
                  unref(slDashboardData).options.configurator.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.configurator, (i2) => {
                      return openBlock(), createElementBlock("div", {
                        class: "sl-dashboard__section-box-item anwp-text-xs",
                        key: i2.label
                      }, [
                        createBaseVNode("b", _hoisted_47, toDisplayString(i2.label) + ":", 1),
                        createBaseVNode("span", null, toDisplayString(i2.data), 1)
                      ]);
                    }), 128)),
                    _cache[77] || (_cache[77] = createBaseVNode("div", { class: "sl-dashboard__section-box-item-empty anwp-text-base mb-4" }, ".....", -1))
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[78] || (_cache[78] = createBaseVNode("div", { class: "anwp-font-medium anwp-text-orange-600 d-flex align-items-center" }, [
                      createBaseVNode("span", { class: "dashicons dashicons-warning" }),
                      createTextVNode(" - no data saved - ")
                    ], -1)),
                    _cache[79] || (_cache[79] = createBaseVNode("div", { class: "mt-2 font-italic" }, 'Configurator is the basis of your sports data. Click on "Open" button to set up your sport.', -1))
                  ], 64)),
                  createBaseVNode("div", _hoisted_48, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).openSportConfig,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Open Sport Configurator", 8, _hoisted_49)
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_50, [
                _cache[81] || (_cache[81] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-admin-users" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Player Statistics Setup ")
                ], -1)),
                createBaseVNode("div", _hoisted_51, [
                  unref(slDashboardData).options.playerStats.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.playerStats, (o2, index) => {
                      return openBlock(), createElementBlock(Fragment, null, [
                        index < 3 ? (openBlock(), createElementBlock("div", _hoisted_52, toDisplayString(o2), 1)) : createCommentVNode("", true)
                      ], 64);
                    }), 256)),
                    unref(slDashboardData).options.playerStats.length > 3 ? (openBlock(), createElementBlock("div", _hoisted_53, ".....")) : createCommentVNode("", true)
                  ], 64)) : (openBlock(), createElementBlock("div", _hoisted_54, " - no data saved - ")),
                  createBaseVNode("div", _hoisted_55, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).openPlayerStats,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Open Player Statistics Setup", 8, _hoisted_56)
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_57, [
                _cache[82] || (_cache[82] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-randomize" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Game Events ")
                ], -1)),
                createBaseVNode("div", _hoisted_58, [
                  unref(slDashboardData).options.events.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(slDashboardData).options.events, (i2) => {
                    return openBlock(), createElementBlock("div", {
                      class: "sl-dashboard__section-box-item",
                      key: i2
                    }, toDisplayString(i2), 1);
                  }), 128)) : (openBlock(), createElementBlock("div", _hoisted_59, " - no data saved - ")),
                  createBaseVNode("div", _hoisted_60, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).openGameEvents,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Open Game Events Setup", 8, _hoisted_61)
                  ])
                ])
              ])
            ])
          ...
          createBaseVNode("section", _hoisted_62, [
            _cache[96] || (_cache[96] = createBaseVNode("h3", null, "Sport Data", -1)),
            createBaseVNode("div", _hoisted_63, [
              createBaseVNode("div", _hoisted_64, [
                _cache[87] || (_cache[87] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-shield" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Teams ")
                ], -1)),
                createBaseVNode("div", _hoisted_65, [
                  unref(slDashboardData).options.teams.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.teams, (o2, index) => {
                      return openBlock(), createElementBlock(Fragment, null, [
                        index < 3 ? (openBlock(), createElementBlock("div", _hoisted_66, toDisplayString(o2), 1)) : createCommentVNode("", true)
                      ], 64);
                    }), 256)),
                    unref(slDashboardData).options.teams.length > 3 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      _cache[84] || (_cache[84] = createBaseVNode("div", { class: "sl-dashboard__section-box-item-empty anwp-text-base" }, ".....", -1)),
                      createBaseVNode("div", _hoisted_67, "and " + toDisplayString(unref(slDashboardData).options.teams.length - 3) + " other team(s)", 1)
                    ], 64)) : createCommentVNode("", true)
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[85] || (_cache[85] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Team. ", -1)),
                    _cache[86] || (_cache[86] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Add New' button and add your first team.", -1)),
                    createBaseVNode("div", _hoisted_68, [
                      createBaseVNode("button", {
                        type: "button",
                        class: "button button-secondary ml-auto",
                        onClick: _cache[16] || (_cache[16] = ($event) => {
                          dataModalContext.value = "Teams";
                          isAddDataModalOpen.value = true;
                        })
                      }, "Add New")
                    ])
                  ], 64)),
                  createBaseVNode("div", _hoisted_69, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).allTeams,
                      class: "button button-secondary",
                      target: "_blank",
                      rel: "noreferrer",
              ...
              createBaseVNode("div", _hoisted_71, [
                _cache[90] || (_cache[90] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-admin-users" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Players ")
                ], -1)),
                createBaseVNode("div", _hoisted_72, [
                  unref(slDashboardData).options.playersNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("div", _hoisted_73, "You have " + toDisplayString(unref(slDashboardData).options.playersNumber.length) + " player(s)", 1),
                    createBaseVNode("div", _hoisted_74, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allPlayers,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "All Players", 8, _hoisted_75),
                      createBaseVNode("button", {
                        type: "button",
                        class: "button button-secondary ml-auto",
                        onClick: _cache[20] || (_cache[20] = ($event) => {
                          dataModalContext.value = "Players";
                          isAddDataModalOpen.value = true;
                        })
                      }, "Add New ")
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[88] || (_cache[88] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Player. ", -1)),
                    _cache[89] || (_cache[89] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Add New' button and add your first player.", -1)),
              ...
              createBaseVNode("div", _hoisted_77, [
                _cache[95] || (_cache[95] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-image-flip-horizontal" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Games ")
                ], -1)),
                createBaseVNode("div", _hoisted_78, [
                  unref(slDashboardData).options.tournaments.length < 1 || unref(slDashboardData).options.teams.length < 2 ? (openBlock(), createElementBlock("div", _hoisted_79, " You haven't fulfil all requirements to create a game. ")) : createCommentVNode("", true),
                  unref(slDashboardData).options.tournaments.length < 1 ? (openBlock(), createElementBlock("div", _hoisted_80, _cache[91] || (_cache[91] = [
                    createBaseVNode("span", { class: "dashicons dashicons-warning" }, null, -1),
                    createTextVNode(" Tournament required ")
                  ]))) : createCommentVNode("", true),
                  unref(slDashboardData).options.teams.length < 2 ? (openBlock(), createElementBlock("div", _hoisted_81, _cache[92] || (_cache[92] = [
                    createBaseVNode("span", { class: "dashicons dashicons-warning" }, null, -1),
                    createTextVNode(" Minimum 2 teams required ")
                  ]))) : createCommentVNode("", true),
                  unref(slDashboardData).options.gamesNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                    createBaseVNode("div", _hoisted_82, "You have " + toDisplayString(unref(slDashboardData).options.gamesNumber.length) + " game(s)", 1),
                    createBaseVNode("div", _hoisted_83, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allGames,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "All Games", 8, _hoisted_84),
                      createBaseVNode("a", {
                        href: unref(slDashboardData).addNewGame,
                        class: "button button-secondary ml-auto",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "Add New", 8, _hoisted_85)
                    ])
                  ], 64)) : createCommentVNode("", true),
                  unref(slDashboardData).options.gamesNumber.length < 1 && unref(slDashboardData).options.tournaments.length > 0 && unref(slDashboardData).options.teams.length > 1 ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
                    _cache[93] || (_cache[93] = createBaseVNode("div", { class: "anwp-font-medium anwp-text-orange-600 d-flex align-items-center" }, [
                      createBaseVNode("span", { class: "dashicons dashicons-warning" }),
                      createTextVNode(" You don't have any Game. ")
                    ], -1)),
                    _cache[94] || (_cache[94] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Create a New' button and add your first game.", -1)),
                    createBaseVNode("div", _hoisted_86, [
                      ...
                      }, "Create a New Game", 8, _hoisted_87)
                    ])
                  ], 64)) : createCommentVNode("", true)
                ])
              ])
          ...
          createBaseVNode("section", _hoisted_88, [
            _cache[109] || (_cache[109] = createBaseVNode("h3", null, "Optional Sport Data", -1)),
            createBaseVNode("div", _hoisted_89, [
              createBaseVNode("div", _hoisted_90, [
                _cache[99] || (_cache[99] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-editor-ol" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Standing Tables ")
                ], -1)),
                createBaseVNode("div", _hoisted_91, [
                  unref(slDashboardData).options.standingsNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("div", _hoisted_92, "You have " + toDisplayString(unref(slDashboardData).options.standingsNumber.length) + " standing table(s)", 1),
                    createBaseVNode("div", _hoisted_93, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allStandings,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "All Standings", 8, _hoisted_94),
                      createBaseVNode("a", {
                        href: unref(slDashboardData).addNewStanding,
                        class: "button button-secondary ml-auto",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "Add New", 8, _hoisted_95)
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[97] || (_cache[97] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Standing Table. ", -1)),
                    _cache[98] || (_cache[98] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Create a New' button and add your first Standing Table.", -1)),
                    createBaseVNode("div", _hoisted_96, [
                      ...
                      }, "Create a New Standing Table", 8, _hoisted_97)
                    ])
                  ], 64))
                ])
              ]),
              createBaseVNode("div", _hoisted_98, [
                _cache[102] || (_cache[102] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-groups" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Officials ")
                ], -1)),
                createBaseVNode("div", _hoisted_99, [
                  unref(slDashboardData).options.officialsNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("div", _hoisted_100, "You have " + toDisplayString(unref(slDashboardData).options.officialsNumber.length) + " official(s)", 1),
                    createBaseVNode("div", _hoisted_101, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allOfficials,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "All Officials", 8, _hoisted_102),
                      createBaseVNode("button", {
                        type: "button",
                        class: "button button-secondary ml-auto",
                        onClick: _cache[29] || (_cache[29] = ($event) => {
                          dataModalContext.value = "Officials";
                          isAddDataModalOpen.value = true;
                        })
                      }, " Add New ")
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[100] || (_cache[100] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Official. ", -1)),
                    _cache[101] || (_cache[101] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Add New' button and add your first official.", -1)),
              ...
              createBaseVNode("div", _hoisted_104, [
                _cache[105] || (_cache[105] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-groups" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Staff ")
                ], -1)),
                createBaseVNode("div", _hoisted_105, [
                  unref(slDashboardData).options.staffNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("div", _hoisted_106, "You have " + toDisplayString(unref(slDashboardData).options.staffNumber.length) + " staff", 1),
                    createBaseVNode("div", _hoisted_107, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allStaff,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, " All Staff", 8, _hoisted_108),
                      createBaseVNode("button", {
                        type: "button",
                        class: "button button-secondary ml-auto",
                        onClick: _cache[32] || (_cache[32] = ($event) => {
                          dataModalContext.value = "Staff";
                          isAddDataModalOpen.value = true;
                        })
                      }, " Add New ")
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[103] || (_cache[103] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Staff. ", -1)),
                    _cache[104] || (_cache[104] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Add New' button and add your first staff.", -1)),
              ...
              createBaseVNode("div", _hoisted_110, [
                _cache[108] || (_cache[108] = createBaseVNode("div", { class: "sl-dashboard__section-box-header d-flex align-items-center" }, [
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-icon d-flex align-items-center" }, [
                    createBaseVNode("span", { class: "dashicons dashicons-building" })
                  ]),
                  createBaseVNode("div", { class: "sl-dashboard__section-box-header-title" }, " Venues ")
                ], -1)),
                createBaseVNode("div", _hoisted_111, [
                  unref(slDashboardData).options.venuesNumber.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("div", _hoisted_112, "You have " + toDisplayString(unref(slDashboardData).options.venuesNumber.length) + " venue(s)", 1),
                    createBaseVNode("div", _hoisted_113, [
                      createBaseVNode("a", {
                        href: unref(slDashboardData).allVenues,
                        class: "button button-secondary",
                        target: "_blank",
                        rel: "noreferrer",
                      ...
                      }, "All Venues", 8, _hoisted_114),
                      createBaseVNode("button", {
                        type: "button",
                        class: "button button-secondary ml-auto",
                        onClick: _cache[35] || (_cache[35] = ($event) => {
                          dataModalContext.value = "Venues";
                          isAddDataModalOpen.value = true;
                        })
                      }, "Add New ")
                    ])
                  ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _cache[106] || (_cache[106] = createBaseVNode("div", { class: "anwp-font-medium d-flex align-items-center" }, " You don't have any Venue. ", -1)),
                    _cache[107] || (_cache[107] = createBaseVNode("div", { class: "mt-2 font-italic" }, "Click on 'Add New' button and add your first venue.", -1)),
          ...
          createVNode(unref(Ro), {
            modelValue: isSportModalOpen.value,
            "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => isSportModalOpen.value = $event),
            "z-index-fn": () => 100060,
            "focus-trap": false,
            "teleport-to": false,
            "lock-scroll": false,
            ...
            default: withCtx(() => [
              createBaseVNode("button", {
                ...
                type: "button",
                onClick: _cache[37] || (_cache[37] = ($event) => isSportModalOpen.value = false)
              }, _cache[110] || (_cache[110] = [
                createBaseVNode("svg", { class: "anwp-icon d-inline-block anwp-icon--s18 anwp-fill-current anwp-text-gray-600" }, [
                  createBaseVNode("use", { "xlink:href": "#icon-x" })
                ], -1)
              ])),
              _cache[111] || (_cache[111] = createBaseVNode("div", { class: "anwp-vfm-admin-modal__title d-flex flex-wrap align-items-center" }, [
                createBaseVNode("h4", { class: "my-0" }, " Select Sport ")
              ], -1)),
              createBaseVNode("div", _hoisted_116, [
                createBaseVNode("div", _hoisted_117, [
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => sportModalValue.value = $event)
                  }, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(slDashboardData).options.availableSports, (sport2) => {
                      return openBlock(), createElementBlock("option", {
                        value: sport2.value,
                        key: sport2.value
                      }, toDisplayString(sport2.label), 9, _hoisted_118);
                    }), 128))
                  ], 512), [
                    [vModelSelect, sportModalValue.value]
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_119, [
                createBaseVNode("div", _hoisted_120, [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[39] || (_cache[39] = withModifiers(($event) => isSportModalOpen.value = false, ["prevent"]))
                  }, " Close "),
                  createBaseVNode("button", {
                    type: "button",
                    class: "button button-primary ml-3",
                    onClick: _cache[40] || (_cache[40] = withModifiers(($event) => saveSport(), ["prevent"]))
                  }, " Save ")
                ])
              ])
            ]),
          ...
          createVNode(unref(Ro), {
            modelValue: isAddDataModalOpen.value,
            "onUpdate:modelValue": _cache[53] || (_cache[53] = ($event) => isAddDataModalOpen.value = $event),
            "z-index-fn": () => 100060,
            "focus-trap": false,
            "teleport-to": false,
            "lock-scroll": false,
            ...
            default: withCtx(() => [
              createBaseVNode("button", {
                class: "anwp-vfm-admin-modal__close button d-flex align-items-center justify-content-center anwp-cursor-pointer border-0",
                type: "button",
                onClick: _cache[42] || (_cache[42] = ($event) => isAddDataModalOpen.value = false)
              ...
              createBaseVNode("div", _hoisted_121, [
                createBaseVNode("h4", _hoisted_122, " Add " + toDisplayString(dataModalContext.value), 1)
              ]),
              createBaseVNode("div", _hoisted_123, [
                "Teams" === dataModalContext.value ? (openBlock(), createElementBlock("div", _hoisted_124, [
                  _cache[113] || (_cache[113] = createBaseVNode("div", { class: "anwp-text-base" }, " Add a team one by one in WordPress way (recommended). ", -1)),
                  createBaseVNode("div", _hoisted_125, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewTeam,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[43] || (_cache[43] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Create a New Team", 8, _hoisted_126)
                  ]),
                  _cache[114] || (_cache[114] = createBaseVNode("hr", null, null, -1)),
                  _cache[115] || (_cache[115] = createBaseVNode("div", {
                    class: "anwp-text-base",
                    style: { "max-width": "440px" }
                  }, " Use Data Import Tools (similar to Excel spreadsheets) to add a team with minimum data (multiple teams import). ", -1)),
                  createBaseVNode("div", _hoisted_127, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).importTeams,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[44] || (_cache[44] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Open Data Import Tool", 8, _hoisted_128)
                  ])
                ])) : createCommentVNode("", true),
                "Players" === dataModalContext.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  _cache[116] || (_cache[116] = createBaseVNode("div", { class: "anwp-text-base" }, " Add a player one by one in WordPress way (recommended). ", -1)),
                  createBaseVNode("div", _hoisted_129, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewPlayer,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[45] || (_cache[45] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Create a New Player", 8, _hoisted_130)
                  ]),
                  _cache[117] || (_cache[117] = createBaseVNode("hr", null, null, -1)),
                  _cache[118] || (_cache[118] = createBaseVNode("div", {
                    class: "anwp-text-base",
                    style: { "max-width": "440px" }
                  }, " Use Data Import Tools (similar to Excel spreadsheets) to add a player with minimum data (multiple players import). ", -1)),
                  createBaseVNode("div", _hoisted_131, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).importPlayers,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[46] || (_cache[46] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Open Data Import Tool", 8, _hoisted_132)
                  ])
                ], 64)) : createCommentVNode("", true),
                "Officials" === dataModalContext.value ? (openBlock(), createElementBlock("div", _hoisted_133, [
                  _cache[119] || (_cache[119] = createBaseVNode("div", { class: "anwp-text-base" }, " Add an official one by one in WordPress way (recommended). ", -1)),
                  createBaseVNode("div", _hoisted_134, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewOfficial,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Create a New Official", 8, _hoisted_135)
                  ]),
                  _cache[120] || (_cache[120] = createBaseVNode("hr", null, null, -1)),
                  _cache[121] || (_cache[121] = createBaseVNode("div", {
                    class: "anwp-text-base",
                    style: { "max-width": "440px" }
                  }, " Use Data Import Tools (similar to Excel spreadsheets) to add an official with minimum data (multiple officials import). ", -1)),
                  createBaseVNode("div", _hoisted_136, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).importOfficials,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[48] || (_cache[48] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Open Data Import Tool", 8, _hoisted_137)
                  ])
                ])) : createCommentVNode("", true),
                "Staff" === dataModalContext.value ? (openBlock(), createElementBlock("div", _hoisted_138, [
                  _cache[122] || (_cache[122] = createBaseVNode("div", { class: "anwp-text-base" }, " Add a staff one by one in WordPress way (recommended). ", -1)),
                  createBaseVNode("div", _hoisted_139, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewStaff,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[49] || (_cache[49] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Create a New Staff", 8, _hoisted_140)
                  ]),
                  _cache[123] || (_cache[123] = createBaseVNode("hr", null, null, -1)),
                  _cache[124] || (_cache[124] = createBaseVNode("div", {
                    class: "anwp-text-base",
                    style: { "max-width": "440px" }
                  }, " Use Data Import Tools (similar to Excel spreadsheets) to add a staff with minimum data (multiple staff import). ", -1)),
                  createBaseVNode("div", _hoisted_141, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).importStaff,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                    ...
                    }, "Open Data Import Tool", 8, _hoisted_142)
                  ])
                ])) : createCommentVNode("", true),
                "Venues" === dataModalContext.value ? (openBlock(), createElementBlock("div", _hoisted_143, [
                  _cache[125] || (_cache[125] = createBaseVNode("div", { class: "anwp-text-base" }, " Add a venue one by one in WordPress way (recommended). ", -1)),
                  createBaseVNode("div", _hoisted_144, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).addNewVenue,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[51] || (_cache[51] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Create a New Venue", 8, _hoisted_145)
                  ]),
                  _cache[126] || (_cache[126] = createBaseVNode("hr", null, null, -1)),
                  _cache[127] || (_cache[127] = createBaseVNode("div", {
                    class: "anwp-text-base",
                    style: { "max-width": "440px" }
                  }, " Use Data Import Tools (similar to Excel spreadsheets) to add a venue with minimum data (multiple venues import). ", -1)),
                  createBaseVNode("div", _hoisted_146, [
                    createBaseVNode("a", {
                      href: unref(slDashboardData).importVenues,
                      class: "button button-secondary ml-auto",
                      target: "_blank",
                      rel: "noreferrer",
                      onClick: _cache[52] || (_cache[52] = ($event) => {
                        reloadOnFocus.value = true;
                      })
                    }, "Open Data Import Tool", 8, _hoisted_147)
                  ])
                ])) : createCommentVNode("", true)
              ])
            ]),
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("path", { d: "M12 3.2c-4.8 0-8.8 3.9-8.8 8.8 0 4.8 3.9 8.8 8.8 8.8 4.8 0 8.8-3.9 8.8-8.8 0-4.8-4-8.8-8.8-8.8zm0 16c-4 0-7.2-3.3-7.2-7.2C4.8 8 8 4.8 12 4.8s7.2 3.3 7.2 7.2c0 4-3.2 7.2-7.2 7.2zM11 17h2v-6h-2v6zm0-8h2V7h-2v2z" }, null, -1)
        ]), 10, _hoisted_1$6);
      };
    }
  };
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("path", { d: "M20 5h-5.7c0-1.3-1-2.3-2.3-2.3S9.7 3.7 9.7 5H4v2h1.5v.3l1.7 11.1c.1 1 1 1.7 2 1.7h5.7c1 0 1.8-.7 2-1.7l1.7-11.1V7H20V5zm-3.2 2l-1.7 11.1c0 .1-.1.2-.3.2H9.1c-.1 0-.3-.1-.3-.2L7.2 7h9.6z" }, null, -1)
        ]), 10, _hoisted_1$4);
      };
    }
  };
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("path", { d: "M2 12C2 6.44444 6.44444 2 12 2C17.5556 2 22 6.44444 22 12C22 17.5556 17.5556 22 12 22C6.44444 22 2 17.5556 2 12ZM13 11V7H11V11H7V13H11V17H13V13H17V11H13Z" }, null, -1)
        ]), 10, _hoisted_1$3);
      };
    }
  };
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("svg", {
          ...
          createBaseVNode("path", { d: "M12 15.8c-3.7 0-6.8-3-6.8-6.8s3-6.8 6.8-6.8c3.7 0 6.8 3 6.8 6.8s-3.1 6.8-6.8 6.8zm0-12C9.1 3.8 6.8 6.1 6.8 9s2.4 5.2 5.2 5.2c2.9 0 5.2-2.4 5.2-5.2S14.9 3.8 12 3.8zM8 17.5h8V19H8zM10 20.5h4V22h-4z" }, null, -1)
        ]), 10, _hoisted_1$1);
      };
    }
  };
  const _hoisted_1 = { class: "anwp-vue-dashboard-wrapper sl-events" };
  const _hoisted_2 = { class: "my-4" };
  const _hoisted_3 = { class: "wp-list-table fixed striped table-view-list w-auto table table-bordered" };
  const _hoisted_4 = { class: "bg-white anwp-text-center" };
  const _hoisted_5 = {
    colSpan: "3",
    id: "sl-events-game-header-desc"
  };
  const _hoisted_6 = { class: "d-flex" };
  const _hoisted_7 = {
    colSpan: "2",
    id: "sl-events-player-list-desc"
  };
  const _hoisted_8 = { class: "d-flex" };
  const _hoisted_9 = { key: 0 };
  const _hoisted_10 = { class: "anwp-text-center" };
  const _hoisted_11 = ["src"];
  const _hoisted_12 = ["src"];
  const _hoisted_13 = { class: "anwp-text-base" };
  const _hoisted_14 = { class: "anwp-text-center" };
  const _hoisted_15 = { class: "anwp-text-center" };
  const _hoisted_16 = { class: "anwp-text-center" };
  const _hoisted_17 = { class: "anwp-text-center" };
  const _hoisted_18 = { class: "anwp-text-center" };
  const _hoisted_19 = { class: "anwp-text-center" };
  const _hoisted_20 = ["onClick"];
  const _hoisted_21 = { class: "anwp-text-center" };
  const _hoisted_22 = ["onClick"];
  const _hoisted_23 = { class: "mt-4 mb-3 d-flex align-items-center" };
  const _hoisted_24 = ["disabled"];
  const _hoisted_25 = { class: "anwp-vfm-admin-modal__actions" };
  const _hoisted_26 = { class: "d-flex" };
  const _hoisted_27 = { class: "anwp-vfm-admin-modal__title d-flex flex-wrap align-items-center" };
  const _hoisted_28 = { class: "my-0" };
  const _hoisted_29 = { class: "anwp-vfm-admin-modal__content" };
  const _hoisted_30 = { class: "d-flex flex-wrap" };
  const _hoisted_31 = ["src", "onClick"];
  const _hoisted_32 = { class: "anwp-border anwp-border-blue-600 anwp-bg-blue-100 mt-2 mb-0 p-2 d-flex align-items-center" };
  const _hoisted_33 = { class: "d-flex mt-3" };
  const _hoisted_34 = { class: "flex-column mb-4" };
  const _hoisted_35 = { class: "flex-column my-4" };
  const _hoisted_36 = { class: "d-flex" };
  const _hoisted_37 = { class: "d-flex my-2 align-items-end" };
  const _hoisted_38 = { class: "mr-2" };
  const _hoisted_39 = {
    key: 0,
    class: "d-flex align-items-end ml-auto"
  };
  ...
  const _hoisted_43 = { class: "flex-column my-4" };
  const _hoisted_44 = { class: "flex-column my-4" };
  const _hoisted_45 = { class: "d-flex" };
  const _sfc_main = {
    __name: "AppEvents",
    setup(__props) {
      const AppAxios = axios.create({
        baseURL: window.slEventsData.rest_root,
        headers: {
          "X-WP-Nonce": window.slEventsData.rest_nonce
        }
      });
      const notyf2 = new Notyf();
      const activeRequest = ref("");
      const eventOptions = ref(window.slEventsData.options || []);
      const eventTooltips = ref(window.slEventsData.tooltips || []);
      const eventIcons = window.slEventsData.icons || [];
      const mapSlugIconUrl = {};
      const removeConfirmId = ref(false);
      const isRemoveConfirmModalOpen = ref(false);
      const eventInModal = reactive({});
      const isEditModalOpen = ref(false);
      const isIconSelectMode = ref(false);
      eventIcons.forEach((icon) => {
        mapSlugIconUrl[icon.slug] = icon.url;
      });
      eventOptions.value = eventOptions.value.map((e) => {
        if ("" === e.show_in_game_header) {
          e.show_in_game_header = "no";
        }
        if ("" === e.show_in_players_block) {
          e.show_in_players_block = "no";
        }
        return e;
      });
      const editEvent = (eventId = null) => {
        if (isIconSelectMode.value) {
          isIconSelectMode.value = false;
        }
        if (null !== eventId) {
          Object.assign(eventInModal, __spreadValues({}, eventOptions.value.find((o2) => o2.id === eventId)));
        } else {
          Object.assign(
            eventInModal,
            {
      ...
      const deleteEvent = () => {
        if (false === removeConfirmId.value) {
          return;
        }
        eventOptions.value = eventOptions.value.filter((o2) => o2.id !== removeConfirmId.value);
        removeConfirmId.value = false;
        isRemoveConfirmModalOpen.value = false;
      };
      const addEvent = () => {
        const _a2 = eventInModal, { isNewEvent = false } = _a2, eventToSave = __objRest(_a2, ["isNewEvent"]);
        if (isNewEvent) {
          eventOptions.value = [...eventOptions.value, eventToSave];
        } else {
          eventOptions.value = eventOptions.value.map((o2) => o2.id === eventToSave.id ? eventToSave : o2);
        }
        isEditModalOpen.value = false;
      };
      const openRemoveConfigModal = (removeId) => {
        removeConfirmId.value = removeId;
        isRemoveConfirmModalOpen.value = true;
      };
      const saveEvents = () => {
        if ("SaveEvents" === activeRequest.value) {
          return false;
        }
        activeRequest.value = "SaveEvents";
        AppAxios.post(
          `sports-leagues/events/save_events_config`,
          {
            events: eventOptions.value
          }
        ).then((response) => {
          if (response.data.success) {
            notyf2.success("Saved Successfully");
          } else if (response.data.data) {
            if ("Nothing to Update" === response.data.data) {
              notyf2.success("Nothing to Update");
            } else {
              notyf2.error(response.data.data);
            }
          } else {
            notyf2.error("Error on Save");
          }
      ...
      const setEventIcon = (slug) => {
        Object.assign(eventInModal, __spreadProps(__spreadValues({}, eventInModal), { icon: slug, custom_icon: "", custom_icon_id: "" }));
        isIconSelectMode.value = false;
      };
      ...
      const setMediaUploaderFile = (attachment) => {
        if ("undefined" !== typeof attachment && attachment.url) {
          eventInModal.custom_icon = attachment.url;
          eventInModal.custom_icon_id = attachment.id;
          eventInModal.icon = "";
        }
      };
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("button", {
              class: "button button-secondary",
              type: "button",
              onClick: _cache[0] || (_cache[0] = ($event) => editEvent())
            }, " Add New Event ")
          ]),
          createBaseVNode("table", _hoisted_3, [
            createBaseVNode("thead", _hoisted_4, [
              _cache[17] || (_cache[17] = createBaseVNode("tr", null, [
                createBaseVNode("td", { rowSpan: "3" }, "Icon"),
                createBaseVNode("td", { rowSpan: "3" }, "Event Name"),
                createBaseVNode("td", { colSpan: "5" }, "Display Options"),
                createBaseVNode("td", { rowSpan: "3" }, "Remove"),
                createBaseVNode("td", { rowSpan: "3" }, "Edit")
              ], -1)),
              createBaseVNode("tr", null, [
                withDirectives((openBlock(), createElementBlock("td", _hoisted_5, [
                  createBaseVNode("div", _hoisted_6, [
                    _cache[15] || (_cache[15] = createTextVNode(" Game Header ")),
                  ...
                  [_directive_tooltip, { content: `<div class='anwp-b-wrap'><img class='p-2 img-fluid anwp-w-300' src='${eventTooltips.value.game_header.img}' alt='tooltip'/></div>`, html: true }]
                ]),
                withDirectives((openBlock(), createElementBlock("td", _hoisted_7, [
                  createBaseVNode("div", _hoisted_8, [
                    _cache[16] || (_cache[16] = createTextVNode(" Player List ")),
                    createVNode(_sfc_main$6, {
                      "icon-class": "ml-2 align-bottom",
                      width: "20",
                      height: "20"
                    })
                  ])
                ])), [
                  [_directive_tooltip, { content: `<div class='anwp-b-wrap'><img class='p-2 img-fluid anwp-w-300' src='${eventTooltips.value.player_list.img}' alt='tooltip'/></div>`, html: true }]
                ])
              ]),
              _cache[18] || (_cache[18] = createBaseVNode("tr", null, [
                createBaseVNode("td", null, "player"),
                createBaseVNode("td", null, "icon"),
                createBaseVNode("td", null, "time"),
                createBaseVNode("td", null, "icon"),
                createBaseVNode("td", null, "time")
              ], -1))
            ]),
            eventOptions.value.length ? (openBlock(), createElementBlock("tbody", _hoisted_9, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(eventOptions.value, (eventOption) => {
                return openBlock(), createElementBlock("tr", {
                  key: eventOption.id
                }, [
                  createBaseVNode("td", _hoisted_10, [
                    eventOption.icon && mapSlugIconUrl[eventOption.icon] ? (openBlock(), createElementBlock("img", {
                      key: 0,
                      class: "anwp-sl-edit-event-icon",
                      src: mapSlugIconUrl[eventOption.icon],
                      alt: "event icon"
                    }, null, 8, _hoisted_11)) : createCommentVNode("", true),
                    !eventOption.icon && eventOption.custom_icon ? (openBlock(), createElementBlock("img", {
                      key: 1,
                      class: "anwp-sl-edit-event-icon",
                      src: eventOption.custom_icon,
                      alt: "event icon"
                    }, null, 8, _hoisted_12)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("td", _hoisted_13, toDisplayString(eventOption.name), 1),
                  createBaseVNode("td", _hoisted_14, [
                    eventOption.show_in_game_header.split("_").includes("player") ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "icon-class": "anwp-text-green-600"
                    })) : (openBlock(), createBlock(_sfc_main$2, {
                      key: 1,
                      "icon-class": "anwp-text-red-600"
                    }))
                  ]),
                  createBaseVNode("td", _hoisted_15, [
                    eventOption.show_in_game_header.split("_").includes("icon") ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "icon-class": "anwp-text-green-600"
                    })) : (openBlock(), createBlock(_sfc_main$2, {
                      key: 1,
                  ...
                  createBaseVNode("td", _hoisted_16, [
                    eventOption.show_in_game_header.split("_").includes("time") ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "icon-class": "anwp-text-green-600"
                    })) : (openBlock(), createBlock(_sfc_main$2, {
                      key: 1,
                  ...
                  createBaseVNode("td", _hoisted_17, [
                    eventOption.show_in_players_block.split("_").includes("icon") ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "icon-class": "anwp-text-green-600"
                    })) : (openBlock(), createBlock(_sfc_main$2, {
                      key: 1,
                  ...
                  createBaseVNode("td", _hoisted_18, [
                    eventOption.show_in_players_block.split("_").includes("time") ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "icon-class": "anwp-text-green-600"
                    })) : (openBlock(), createBlock(_sfc_main$2, {
                      key: 1,
                  ...
                  createBaseVNode("td", _hoisted_19, [
                    createBaseVNode("button", {
                      onClick: ($event) => openRemoveConfigModal(eventOption.id),
                      class: "button d-flex align-items-center mx-3 anwp-text-red-600 anwp-border anwp-border-red-600",
                      type: "button"
                    }, [
                  ...
                  createBaseVNode("td", _hoisted_21, [
                    createBaseVNode("button", {
                      onClick: ($event) => editEvent(eventOption.id),
                      class: "button d-flex align-items-center mx-3",
                      type: "button"
                    }, [
          ...
          createBaseVNode("div", _hoisted_23, [
            createBaseVNode("button", {
              ...
              type: "button",
              onClick: _cache[1] || (_cache[1] = ($event) => saveEvents()),
              disabled: "SaveEvents" === activeRequest.value
            }, " Save Events ", 8, _hoisted_24),
            createBaseVNode("span", {
              class: normalizeClass(["spinner float-none ml-2 mt-0", "SaveEvents" === activeRequest.value ? "is-active" : ""])
            }, null, 2)
          ]),
          createVNode(unref(Ro), {
            modelValue: isRemoveConfirmModalOpen.value,
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isRemoveConfirmModalOpen.value = $event),
            "z-index-fn": () => 100060,
            "focus-trap": false,
            "teleport-to": false,
            "lock-scroll": false,
            ...
            default: withCtx(() => [
              createBaseVNode("button", {
                class: "anwp-vfm-admin-modal__close button d-flex align-items-center justify-content-center anwp-cursor-pointer border-0",
                type: "button",
                onClick: _cache[2] || (_cache[2] = ($event) => isRemoveConfirmModalOpen.value = false)
              }, _cache[19] || (_cache[19] = [
                createBaseVNode("svg", { class: "anwp-icon d-inline-block anwp-icon--s18 anwp-fill-current anwp-text-gray-600" }, [
                  createBaseVNode("use", { "xlink:href": "#icon-x" })
                ], -1)
              ])),
              _cache[20] || (_cache[20] = createBaseVNode("div", { class: "anwp-vfm-admin-modal__title d-flex flex-wrap align-items-center" }, [
                createBaseVNode("h4", { class: "my-0" }, " Confirm Delete ")
              ], -1)),
              _cache[21] || (_cache[21] = createBaseVNode("div", { class: "anwp-vfm-admin-modal__content" }, [
                createBaseVNode("h3", { class: "mb-2 mt-4 anwp-text-center" }, "Are you sure?"),
                createBaseVNode("p", { class: "anwp-text-center" }, "Do you really want to delete this Event?")
              ], -1)),
              createBaseVNode("div", _hoisted_25, [
                createBaseVNode("div", _hoisted_26, [
                  createBaseVNode("button", {
                    type: "button",
                    class: "button button-secondary text-capitalize ml-auto",
                    onClick: _cache[3] || (_cache[3] = withModifiers(($event) => isRemoveConfirmModalOpen.value = false, ["prevent"]))
                  }, " Close "),
                  createBaseVNode("button", {
                    type: "button",
                    class: "button anwp-text-red-600 anwp-border anwp-border-red-600 px-3 ml-3",
                    onClick: _cache[4] || (_cache[4] = withModifiers(($event) => deleteEvent(), ["prevent"]))
                  }, " Delete Event ")
                ])
              ])
            ]),
          ...
          createVNode(unref(Ro), {
            ...
            "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => isEditModalOpen.value = $event),
            "z-index-fn": () => 100060,
            "focus-trap": false,
            "teleport-to": false,
            "lock-scroll": false,
            ...
            default: withCtx(() => [
              createBaseVNode("button", {
                class: "anwp-vfm-admin-modal__close button d-flex align-items-center justify-content-center anwp-cursor-pointer border-0",
                type: "button",
                onClick: _cache[6] || (_cache[6] = ($event) => isEditModalOpen.value = false)
              }, _cache[22] || (_cache[22] = [
                createBaseVNode("svg", { class: "anwp-icon d-inline-block anwp-icon--s18 anwp-fill-current anwp-text-gray-600" }, [
                  createBaseVNode("use", { "xlink:href": "#icon-x" })
                ], -1)
              ...
              createBaseVNode("div", _hoisted_27, [
                createBaseVNode("h4", _hoisted_28, toDisplayString(isIconSelectMode.value ? "Select Icon" : "Add/Edit Event"), 1)
              ]),
              createBaseVNode("div", _hoisted_29, [
                isIconSelectMode.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  createBaseVNode("div", _hoisted_30, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(eventIcons), (icon) => {
                      return openBlock(), createElementBlock("img", {
                        class: "mr-2 mb-2 border p-1 anwp-sl-edit-event-icon anwp-cursor-pointer",
                        alt: "event icon",
                        src: icon.url,
                        key: icon.slug,
                        onClick: ($event) => setEventIcon(icon.slug)
                      }, null, 8, _hoisted_31);
                    }), 128))
                  ]),
                  createBaseVNode("div", _hoisted_32, [
                    createVNode(_sfc_main$1, {
                      "icon-class": "anwp-text-blue-500 mr-2",
                      width: 16,
                      height: 16
                    }),
                    _cache[23] || (_cache[23] = createTextVNode(" Want more icons? Feel free to ask at support forum - ")),
                    _cache[24] || (_cache[24] = createBaseVNode("a", {
                      href: "https://anwppro.userecho.com/communities/4-sports-leagues",
                      target: "_blank",
                      rel: "noreferrer"
                    }, "Sports Leagues Community", -1))
                  ]),
                  ...
                  createBaseVNode("div", _hoisted_34, [
                    _cache[25] || (_cache[25] = createBaseVNode("label", {
                      class: "d-block mb-1",
                      for: "anwp-sl-input-event-name"
                    }, "Event Name", -1)),
                    withDirectives(createBaseVNode("input", {
                      type: "text",
                      class: "w-100",
                      id: "anwp-sl-input-event-name",
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => eventInModal.name = $event)
                    }, null, 512), [
                      [vModelText, eventInModal.name]
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_35, [
                    createBaseVNode("label", _hoisted_36, [
                      _cache[26] || (_cache[26] = createTextVNode(" Event Icon ")),
                      eventInModal.icon || eventInModal.custom_icon ? (openBlock(), createElementBlock("a", {
                        key: 0,
                        href: "#",
                        class: "ml-auto text-danger",
                        onClick: _cache[9] || (_cache[9] = ($event) => {
                          eventInModal.icon = "";
                          eventInModal.custom_icon = "";
                          eventInModal.custom_icon_id = "";
                        })
                      }, "remove icon")) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_37, [
                      createBaseVNode("div", _hoisted_38, [
                        createBaseVNode("button", {
                          ...
                          class: "button button-secondary",
                          onClick: _cache[10] || (_cache[10] = ($event) => {
                            isIconSelectMode.value = true;
                          })
                        }, " Select Icon ")
                      ]),
                      createBaseVNode("div", { class: "mr-2" }, [
                        createBaseVNode("button", {
                          type: "button",
                          class: "button button-secondary",
                          onClick: openMedia
                      ...
                      eventInModal.icon && mapSlugIconUrl[eventInModal.icon] ? (openBlock(), createElementBlock("div", _hoisted_39, [
                        createBaseVNode("img", {
                          class: "anwp-sl-edit-event-icon",
                          src: mapSlugIconUrl[eventInModal.icon],
                          alt: "event icon"
                        }, null, 8, _hoisted_40)
                      ])) : createCommentVNode("", true),
                      !eventInModal.icon && eventInModal.custom_icon ? (openBlock(), createElementBlock("div", _hoisted_41, [
                        createBaseVNode("img", {
                          src: eventInModal.custom_icon,
                          alt: "event icon",
                          class: "anwp-sl-edit-event-icon"
                        }, null, 8, _hoisted_42)
                      ])) : createCommentVNode("", true)
                    ]),
                    _cache[27] || (_cache[27] = createBaseVNode("div", { class: "anwp-small" }, [
                      createBaseVNode("b", null, "Select Icon"),
                      createTextVNode(" - select from a list of predefined icons"),
                      createBaseVNode("br"),
                      createBaseVNode("b", null, "Load Custom Icon"),
                      createTextVNode(" - load custom image with a help of WordPress Media Library. ")
                    ], -1))
                  ]),
                  createBaseVNode("div", _hoisted_43, [
                    _cache[29] || (_cache[29] = createBaseVNode("label", {
                      class: "d-block mb-1",
                      for: "anwp-sl-input-event-show-game-header"
                    }, "Show in Game Header", -1)),
                    withDirectives(createBaseVNode("select", {
                      id: "anwp-sl-input-event-show-game-header",
                      class: "w-100",
                      "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => eventInModal.show_in_game_header = $event)
                    }, _cache[28] || (_cache[28] = [
                      createBaseVNode("option", { value: "no" }, "No", -1),
                      createBaseVNode("option", { value: "player_icon_time" }, "Yes: player, icon, time", -1),
                      createBaseVNode("option", { value: "player_icon" }, "Yes: player, icon", -1)
                    ]), 512), [
                      [vModelSelect, eventInModal.show_in_game_header]
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_44, [
                    _cache[31] || (_cache[31] = createBaseVNode("label", {
                      class: "d-block mb-1",
                      for: "anwp-sl-input-event-show-player-block"
                    }, "Show in Players Block", -1)),
                    withDirectives(createBaseVNode("select", {
                      id: "anwp-sl-input-event-show-player-block",
                      class: "w-100",
                      "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => eventInModal.show_in_players_block = $event)
                    }, _cache[30] || (_cache[30] = [
                      createBaseVNode("option", { value: "no" }, "No", -1),
                      createBaseVNode("option", { value: "icon_time" }, "Yes: icon, time", -1),
                      createBaseVNode("option", { value: "icon" }, "Yes: icon", -1)
                    ]), 512), [
                      [vModelSelect, eventInModal.show_in_players_block]
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_45, [
                    ...
                    createBaseVNode("button", {
                      type: "button",
                      class: "button button-secondary",
                      onClick: _cache[13] || (_cache[13] = ($event) => isEditModalOpen.value = false)
                    }, " Close ")
                  ])
                ], 64))
              ])
  ...
  }, getOffsetParent: H$1, getDocumentElement: R$1, getScale: L, getElementRects(t) {
    return __async(this, null, function* () {
  ...
  if (typeof document < "u" && typeof window < "u") {
    if (_e$2) {
      ...
      document.addEventListener("touchstart", (t) => ue$2(t), e), document.addEventListener("touchend", (t) => fe$2(t, true), e);
    } else
      window.addEventListener("mousedown", (e) => ue$2(e), true), window.addEventListener("click", (e) => fe$2(e, false), true);
  ...
  const k$1 = /* @__PURE__ */ B$1(gt, [["render", wt$1]]);
  __spreadProps(__spreadValues({}, k$1), {
    name: "VDropdown",
  ...
  const $t$1 = /* @__PURE__ */ defineComponent({
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  window.addEventListener("DOMContentLoaded", () => {
    if (document.getElementById("anwp-sl-batch-import-tool-app")) {
      const app = createApp(_sfc_main$a);
      app.component("draggable", lo);
      app.component("Toggle", b);
      app.directive("tooltip", Mt$1);
      app.mount("#anwp-sl-batch-import-tool-app");
    }
    if (document.getElementById("sl-app-toolbox--updater")) {
      const app = createApp(_sfc_main$8);
      const pinia = createPinia();
      app.use(pinia);
      app.mount("#sl-app-toolbox--updater");
    }
    if (document.getElementById("sl-admin-dashboard")) {
      const app = createApp(_sfc_main$7);
      const vfm = zo();
      app.use(vfm);
      app.mount("#sl-admin-dashboard");
    }
    if (document.getElementById("sl-admin-events")) {
      const app = createApp(_sfc_main);
      const vfm = zo();
      app.directive("tooltip", Mt$1);
      app.use(vfm);
      app.mount("#sl-admin-events");
    }
  });
})();
