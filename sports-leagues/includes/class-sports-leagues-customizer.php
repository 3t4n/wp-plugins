...
class Sports_Leagues_Customizer {
	...
	public function register_customizer_settings( $wp_customize ) {
		...
		*/
		$wp_customize->add_setting(
			'anwp-sl-customizer[general][flags]',
			[
				'default' => 'circle',
				'type'    => 'option',
			]
		...
		$wp_customize->add_control(
			...
			[
				'type'     => 'select',
				'label'    => esc_html__( 'Flags', 'sports-leagues' ),
				'section'  => 'sl_general',
				'settings' => 'anwp-sl-customizer[general][flags]',
				'choices'  => [
					'circle' => __( 'Circle', 'sports-leagues' ),
					'legacy' => __( 'Legacy', 'sports-leagues' ),
				],
			]
		);
		...
		*/
		$wp_customize->add_setting(
			'anwp-sl-customizer[game][link_player_profile]',
			[
				'default' => 'yes',
				'type'    => 'option',
			]
		...
		$wp_customize->add_control(
			...
			[
				'type'     => 'select',
				'label'    => esc_html__( 'Link To Player Profile', 'sports-leagues' ),
				'section'  => 'sl_game',
				'settings' => 'anwp-sl-customizer[game][link_player_profile]',
				'choices'  => [
					'no'  => __( 'No', 'sports-leagues' ),
					'yes' => __( 'Yes', 'sports-leagues' ),
				],
