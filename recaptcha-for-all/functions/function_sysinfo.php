...
{
    global $wpdb;
    $recaptcha_for_all_userAgentOri = recaptcha_for_all_get_ua2();
    ...
    $return  = '=== Begin System Info 5.1 (Generated ' . date('Y-m-d H:i:s') . ') ===' . "\n\n";
    ...
    $return .= 'Plugin Dir:                  ' . RECAPTCHA_FOR_ALLPATH . "\n";
    $return .= 'Table Prefix:             ' . 'Length: ' . strlen($wpdb->prefix) . '   Status: ' . (strlen($wpdb->prefix) > 16 ? 'ERROR: Too long' : 'Acceptable') . "\n";
    //$return .= 'Admin AJAX:               ' . ( recaptcha_for_all_test_ajax_works() ? 'Accessible' : 'Inaccessible' ) . "\n";
...
function recaptcha_for_all_get_ua2()
{
