...
function bill_install_mu_plugin()
{
    ...
    $recaptcha_for_all_mu_plugin_dir = WP_PLUGIN_DIR . '/recaptcha-for-all/includes/mu-plugins'; // Current path inside recaptcha_for_all
    ...
    */
    ...
    try {
        ...
        // Define the plugin file path in the recaptcha_for_all directory
        $source = $recaptcha_for_all_mu_plugin_dir . '/' . $plugin_file;
    ...
    if (isset($_REQUEST)) {
        ...
        foreach ($errors as $error) {
            ...
            if ($log_error) {
                ...
                if ($recaptcha_for_all_plugin_slug  == 'recaptcha-for-all')
                    recaptcha_for_allErrorHandler('Javascript', $errorMessage, $errorURL, $errorLine);
