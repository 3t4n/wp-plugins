...
echo esc_attr__('If you need support, please, copy and paste the info below in our', 'recaptcha-for-all'); ?> &nbsp;
<a href="https://BillMinozzi.com/support"><?php echo esc_attr__('Support Site', 'recaptcha-for-all'); ?></a>
<br><br>

<?php

recaptcha_for_all_sysinfo_display();

echo '</big>';

function recaptcha_for_all_sysinfo_display()
{
...
?>
    <textarea style="height:60vh" ; readonly="readonly" onclick="this.focus(); this.select()"><?php echo esc_attr(recaptcha_for_all_sysinfo_get()); ?></textarea>
<?php
}

function recaptcha_for_all_get_host()
{
...
function recaptcha_for_all_sysinfo_get()
{
    global $wpdb;
    global $recaptcha_for_all_userAgentOri;
    ...
    $host = gethostname();
    if ($host === false) {
        $host = recaptcha_for_all_get_host();
    }
    ...
    $return .= 'Version:                  ' . RECAPTCHA_FOR_ALLVERSION;
    $return .= "\n\n";
    ...
    $return .= "\n" . '-- User Browser' . "\n\n";
    $return .= $recaptcha_for_all_userAgentOri; // $browser;
    $return .= "\n\n";
    ...
    $return .= 'Plugin Dir:                  ' . RECAPTCHA_FOR_ALLVERSION . "\n";
    ...
    $return .= 'OS Type & Version:        ' . recaptcha_for_all_OSName();
...
function recaptcha_for_all_OSName()
{
    try {
