...
Subscription renewel fix on gold version. 

=6.0.2=    		
2024/07/08  WP6.5.4 and Woo8.9.3 
Cart function confliction fix on platinum 
...
Removed flash screen of upgrade plugin from platinum and added relative upgrade links on raffle setting page (gold and platinum) 

 
=6.0.3.1=    		
2024/09/16  WP6.5.4 and Woo 9.2.3 
Fixed email sending to winner from admin (PLT only) 

=6.0.4=		
2024/09/30  WP6.5.4 and Woo 9.2.3 
Fixed ticket printing on view tickets (PLT only) 
Fixed ticket number not showing on view tickets (Export) (PLT only) 

=6.0.4=		
2024/10/29  WP6.6 and Woo 9.3.3 
Export tickets fix (SLV)
Updates for HPOS woocommerce on bronze  
