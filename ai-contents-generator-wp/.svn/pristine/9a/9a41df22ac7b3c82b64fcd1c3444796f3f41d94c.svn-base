...
The plugin is complimentary for users subscribed to Contents.ai's Starter or Pro plan.
...
In order to use the plugin, it's necessary to have an account on Contents.ai. For unlimited access to the plugin's features, you can choose from the Starter or Pro plan > https://www.contents.ai/pricing/. Once you've selected the plan, you can enter your login credentials in the plugin's Setup page: it's now ready for use.
...
= 1.1.5 =
* Updated subscription plan names
