	...
	static function menu_settings_callback()
	{
		...
		<div class="wrap">
			...
			<div class="aiwrc-s-box">
				...
				<p>We're excited that you're interested in enhancing your creative process with the <em>Contents.ai</em> plugin, designed to deliver SEO-optimized content. Before using the plugin, you need to create an account on Contents.ai. For full access to all the plugin's capabilities, consider opting for the Starter or Pro plan at <a href="https://www.contents.ai/pricing/" target="_blank">https://www.contents.ai/pricing/</a>. After selecting the plan, simply input your access key into the plugin, and it's all set for use.</p>
