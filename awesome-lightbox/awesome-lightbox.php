 ...
 * @return $links [array]
 */
if (! function_exists('awesome_lightbox_add_custom_plugin_links')) {
	function awesome_lightbox_add_custom_plugin_links($links, $file){

		if ($file === 'awesome-lightbox/awesome-lightbox.php') {
			$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/wp-plugins/awesome-lightbox/doc/" target="_blank">Documentation</a>';
			$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/contact/" target="_blank">Contact Support</a>';
		}
		return $links;
	}
}
add_filter('plugin_row_meta', 'awesome_lightbox_add_custom_plugin_links', 10, 2);
