...
define('WPM2AWS_VERSION', '5.2.2');

define('WPM2AWS_REQUIRED_MINIMUM_WP_VERSION', '4.8');

define('SH_API_REQUIRED_MINIMUM_WP_VERSION', '5.0');

define('WPM2AWS_REQUIRED_MINIMUM_PHP_VERSION', '5.6');

define('SH_API_REQUIRED_MINIMUM_PHP_VERSION', '7.0');
...
define('WPM2AWS_PRO_LICENCE_DEFAULT_BUCKET_PREFIX', 'wpm2aws-pro');
...
if (defined('WPM2AWS_CONSOLE_API_URL_EXTERNAL') === true) {
    ...
    define('WPM2AWS_CONSOLE_API_URL', 'https://wponaws.migration.seahorse-data.com');
}

// default region - editible in future versions
define('WPM2AWS_PLUGIN_AWS_REGION', 'eu-west-1');

// default launch instance details
define('WPM2AWS_PLUGIN_AWS_LIGHTSAIL_DEFAULT_SIZE_NAME', 'Medium');
define('WPM2AWS_PLUGIN_AWS_LIGHTSAIL_DEFAULT_SIZE_GB', '4GB');

define('WPM2AWS_PLUGIN_AWS_LIGHTSAIL_TRIAL_INSTANCE_AVAILABLE_DURATION_HOURS', '6');

define('WPM2AWS_TRIAL_LICENCE_KEY', '312bf79d887ae6c6463425c2d3805e56');

// default AWS a/c no
define('WPM2AWS_PLUGIN_AWS_NUMBER', '');
...
// Add Class for plugin specific styles to admin body
...
if (get_option('wpm2aws-ssl-error-bypass') === true) {
