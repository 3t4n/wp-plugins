...
class B1_Accounting
{
    ...
    private function load_dependencies()
    {
        ...
        require_once $path . 'includes/class-b1-accounting-debugger.php';
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_b1_run_debug', $plugin_admin, 'run_debug_handler');
        $this->loader->add_action('wp_ajax_b1_run_query', $plugin_admin, 'run_query_handler');
