...
if ($_POST['gpfwcheckbox'] == 'checked') {
    ...
    if ($gpfw_object['gpfw_disable_gift_pack_to'] == '') {

        $html .= '<div class="gpfw_giftpack_note"><div class="gpfw_giftpack_val"><input type="text"  class="gpfw-gift-pack-note" name="gpfw-gift-pack-to" placeholder="' . ($gpfw_object['gpfw_gift_pack_to_placeholder'] == '' ?  __("Gift Pack To", "gift-pack-for-woocommerce") : esc_html($gpfw_object['gpfw_gift_pack_to_placeholder'])) . '"
                   value=""></div>';
    }
    
    if ($gpfw_object['gpfw_disable_gift_pack_from'] == '') {

        $html .= '<div class="gpfw_giftpack_val"><input type="text" class="gpfw-gift-pack-note" name="gpfw-gift-pack-from" placeholder="' . ($gpfw_object['gpfw_gift_pack_from_placeholder'] == '' ?  __("Gift Pack From ", "gift-pack-for-woocommerce") : esc_html($gpfw_object['gpfw_gift_pack_from_placeholder'])) . '"
                   value="" ></div>';
    }

    if ($gpfw_object['gpfw_disable_gift_pack_note'] == '') {

        $note_max_var = $gpfw_object['gpfw_enable_gift_pack_note_limit'] && !empty($gpfw_object['gpfw_choose_gift_limit']) ? $gpfw_object['gpfw_choose_gift_limit'] : '1000';

        $html .= '
            <div class="gpfw_giftpack_val"><textarea class="gpfw-gift-pack-note" name="gpfw-gift-pack-note" placeholder="' . ($gpfw_object['gpfw_gift_pack_note_placeholder'] == '' ?  __("Gift Pack Note", "gift-pack-for-woocommerce") : esc_html($gpfw_object['gpfw_gift_pack_note_placeholder'])) . '"
                   value="" minlength="5" maxlength="'.$note_max_var.'"></textarea>
        </div>';
    }
