 ...
 */
  ...
  /* Gift Wrap Label */
	...
	if( isset( $values['gpfw_gift_pack_to'] ) ) {
		$gpfw_gift_pack_message_to = __("Giftpack to","gift-pack-for-woocommerce");
	  $item->update_meta_data( $gpfw_gift_pack_message_to, $values['gpfw_gift_pack_to'] );
	}
	if( isset( $values['gpfw_gift_pack_from'] ) ) {
		$gpfw_gift_pack_message_from = __("Giftpack from","gift-pack-for-woocommerce");
	  $item->update_meta_data( $gpfw_gift_pack_message_from, $values['gpfw_gift_pack_from'] );
	}
