...
class Gift_Pack_For_Woocommerce {
	...
	public static function gpfw_get_options(){
		...
		$gpfw_disable_gift_pack_to = 'gpfw_disable_gift_pack_to' . $current_language;
		$options['gpfw_disable_gift_pack_to'] = get_option( $gpfw_disable_gift_pack_to );

		$gpfw_disable_gift_pack_from = 'gpfw_disable_gift_pack_from' . $current_language;
		$options['gpfw_disable_gift_pack_from'] = get_option( $gpfw_disable_gift_pack_from );	


		$gpfw_gift_pack_to_require = 'gpfw_gift_pack_to_require' . $current_language;
		$options['gpfw_gift_pack_to_require'] = get_option( $gpfw_gift_pack_to_require );

		$gpfw_gift_pack_from_require = 'gpfw_gift_pack_from_require' . $current_language;
		$options['gpfw_gift_pack_from_require'] = get_option( $gpfw_gift_pack_from_require );

		$gpfw_gift_pack_note_require = 'gpfw_gift_pack_note_require' . $current_language;
		$options['gpfw_gift_pack_note_require'] = get_option( $gpfw_gift_pack_note_require );


		$gpfw_gift_pack_note_limit = 'gpfw_enable_gift_pack_note_limit' . $current_language;
		$options['gpfw_enable_gift_pack_note_limit'] = get_option( $gpfw_gift_pack_note_limit );

		$gpfw_choose_gift_limit = 'gpfw_choose_gift_limit' . $current_language;
		$options['gpfw_choose_gift_limit'] = get_option( $gpfw_choose_gift_limit );
