(function ( $ ) {
	...
	$(function () {
		...
		$( document ).ready(function() {	
		    ...
		    jQuery('#gpfw_disable_gift_pack_to').change(function() {
			    if (jQuery(this).is(':checked')) {
			        jQuery('#gpfw_gift_pack_to_require').closest('.global_price_value').hide();
			    } else {
			     	jQuery('#gpfw_gift_pack_to_require').closest('.global_price_value').show();
			    }
			});

			jQuery('#gpfw_disable_gift_pack_from').change(function() {
			    if (jQuery(this).is(':checked')) {
			        jQuery('#gpfw_gift_pack_from_require').closest('.global_price_value').hide();
			    } else {
			     	jQuery('#gpfw_gift_pack_from_require').closest('.global_price_value').show();
			    }
			});

			jQuery('#gpfw_disable_gift_pack_note').change(function() {
			    if (jQuery(this).is(':checked')) {
			        jQuery('#gpfw_gift_pack_note_require').closest('.global_price_value').hide();
			        jQuery('#gpfw_enable_gift_pack_note_limit').closest('.global_price_value').hide();
			    } else {
			     	jQuery('#gpfw_gift_pack_note_require').closest('.global_price_value').show();
			        jQuery('#gpfw_enable_gift_pack_note_limit').closest('.global_price_value').show();
			    }
			});
...
jQuery( function( $ ) {
	...
	jQuery('input[name=gpfw_enable_gift_pack_note_limit]').change(function() {
	    if(this.checked) {
	        jQuery(".set_gift_pack_char_imit").show();
	    }else{
	        jQuery(".set_gift_pack_char_imit").hide();
	    }
	});
});
...
function openTab(event, tabId) {
    ...
    let contents = document.querySelectorAll('.gift_tab_content');
    contents.forEach(content => content.classList.remove('active'));
    let buttons = document.querySelectorAll('.gift_tabs .tab-button');
