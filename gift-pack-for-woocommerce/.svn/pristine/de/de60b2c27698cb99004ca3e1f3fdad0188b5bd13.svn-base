...
<div class="wrap">
    ...
    <form method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>" enctype="multipart/form-data">
        <div class="gift_tabs">
            <button type="button" class="tab-button active" onclick="openTab(event, 'gift_tab1')"><?php esc_html_e('General Settings','gift-pack-for-woocommerce'); ?> </button>
            <button type="button" class="tab-button" onclick="openTab(event, 'gift_tab2')"><?php esc_html_e('Note Settings','gift-pack-for-woocommerce'); ?> </button>
            <button type="button" class="tab-button" onclick="openTab(event, 'gift_tab3')"><?php esc_html_e('Visualization Settings','gift-pack-for-woocommerce');?></button>
        </div>
        <input type="hidden" name="action" value="save_gpfw_update_settings" />
        <div class="gift_packs_for_woocommerce">

            <div id="gift_tab1" class="gift_tab_content active"> 
                ...
                if ($current_language) {
                    $gpfw_choose_gift_limit_key = 'gpfw_choose_gift_limit' . $current_language;

                    if (isset($_POST['gpfw_choose_gift_limit'])) {
                        $updated_gift_pack_msg = sanitize_text_field($_POST['gpfw_choose_gift_limit']);
                        update_option($gpfw_choose_gift_limit_key, $updated_gift_pack_msg);
                    }

                    $gpfw_choose_gift_limit = get_option($gpfw_choose_gift_limit_key);
                } else {
                    $gpfw_choose_gift_limit = get_option('gpfw_choose_gift_limit');
                } ?>
                <div class="global_price_value set_gift_pack_char_imit" 
                     <?php echo !empty($gpfw_options['gpfw_enable_gift_pack_note_limit']) ? '' : 'style="display:none;"'; ?>>
                    <div class="gpfw_gift_pack_message backend_field_title">
                        <?php esc_html_e('Set Gift Pack Note Character Limit:', 'gift-pack-for-woocommerce'); ?><br />
                    </div>
                    <div class="gpfw_gift_value">
                        <input type="number" name="gpfw_choose_gift_limit" id="gpfw_choose_gift_limit" value="<?php echo esc_attr($gpfw_choose_gift_limit); ?>">
                    </div>
                </div>
            ...
            <div id="gift_tab2" class="gift_tab_content">
                <div class="global_price_value">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Disable Gift Pack (To):','gift-pack-for-woocommerce');?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_disable_gift_pack_to" id="gpfw_disable_gift_pack_to" value="1" <?php if($gpfw_options['gpfw_disable_gift_pack_to']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="global_price_value">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Disable Gift Pack (From):','gift-pack-for-woocommerce');?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_disable_gift_pack_from" id="gpfw_disable_gift_pack_from" value="1" <?php if($gpfw_options['gpfw_disable_gift_pack_from']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="global_price_value">
                    ...
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_disable_gift_pack_note" id="gpfw_disable_gift_pack_note" value="1" <?php if($gpfw_options['gpfw_disable_gift_pack_note']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>

                <div class="global_price_value" style="display:<?php echo ($gpfw_options['gpfw_disable_gift_pack_to']) ? 'none' : ''; ?>">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Require Gift Pack (To):','gift-pack-for-woocommerce');?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_gift_pack_to_require" id="gpfw_gift_pack_to_require" value="1" <?php if($gpfw_options['gpfw_gift_pack_to_require']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>

                <div class="global_price_value" style="display:<?php echo ($gpfw_options['gpfw_disable_gift_pack_from']) ? 'none' : ''; ?>">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Require Gift Pack(From)?:','gift-pack-for-woocommerce');?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_gift_pack_from_require" id="gpfw_gift_pack_from_require" value="1" <?php if($gpfw_options['gpfw_gift_pack_from_require']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="global_price_value" style="display:<?php echo ($gpfw_options['gpfw_disable_gift_pack_note']) ? 'none' : ''; ?>">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Required Gift Pack(Note)?:','gift-pack-for-woocommerce');?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_gift_pack_note_require" id="gpfw_gift_pack_note_require" value="1" <?php if($gpfw_options['gpfw_gift_pack_note_require']) esc_html_e('checked="checked"','gift-pack-for-woocommerce'); else '';?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <!--Enable Gift Pack Note Character Limit-->
                <div class="global_price_value char_gift_pack" style="display:<?php echo ($gpfw_options['gpfw_disable_gift_pack_note']) ? 'none' : ''; ?>">
                    <div class="global_price_title backend_field_title"><?php esc_html_e('Enable Gift Pack Note Character Limit:', 'gift-pack-for-woocommerce'); ?></div>
                    <label class="global_price_meta">
                        <input type="checkbox" name="gpfw_enable_gift_pack_note_limit" id="gpfw_enable_gift_pack_note_limit" value="1"
                        <?php if ($gpfw_options['gpfw_enable_gift_pack_note_limit']) esc_html_e('checked="checked"', 'gift-pack-for-woocommerce'); ?>>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>

            <div id="gift_tab3" class="gift_tab_content">
                ...
                <div class="gpfw_gift_pack_message backend_field_title global_price_value"><?php esc_html_e('Choose your own gift pack/wrapper images ','gift-pack-for-woocommerce');?>
                </div>
                <!-- Image Upload / Update -->
