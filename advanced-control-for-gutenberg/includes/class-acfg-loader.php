...
class ACFG_Loader
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      array    $actions    when the plugin loads.
     */
    protected $actions;
     ...
     * @since    1.0.0
     * @access   protected
     * @var      array    $filters    when the plugin loads.
     */
    protected $filters;
     ...
     *
     * @since 1.0.0
     * @param string $hook The name of the WP action.
     * @param object $component A reference to the instance action.
     ...
     * @since    1.0.0
     * @access   private
     * @param    array  $hooks            Hooks that is being registered.
     * @param    string $hook             The name the filter.
     * @param    object $component        A reference to the instance.
     * @param    string $callback         The name of the function.
     * @param    int    $priority         The priority.
     * @param    int    $accepted_args    The number of arguments.
     * @return   array  $hooks            Actions and filters registered.
     */
