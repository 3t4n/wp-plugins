	...
	<table class="form-table">
		...
		<tr valign="top">
			<th scope="row" class="titledesc">
				...
				<tr valign="top">
			<th scope="row" class="titledesc">
				<label for="name"><?php esc_html_e( 'Default Checked', 'agreeme-checkbox-for-woocommerce' ); ?></label>
				<?php echo wp_kses_post( wc_help_tip( __( 'Default Checked or Unchecked', 'agreeme-checkbox-for-woocommerce' ) ) ); ?>
			</th>
				<td class="forminp forminp-text">
					<input name="dchecked" id="dchecked" type="checkbox" value="1" <?php if('yes'==$cbx->data['dchecked'])echo "checked"; ?> />Yes/No
