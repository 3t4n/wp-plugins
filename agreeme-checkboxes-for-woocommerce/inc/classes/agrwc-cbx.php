...
class AGRWC_CB {
    ...
    public function __construct($data = null) {
        ...
        $this->data = wp_parse_args($data, array('cbx_id' => '', 'name' => '', 'products' => array(), 'locations' => array(), 'olocations' => array(),'clocation' => 'after_customer_notes',  'limit_categories' => array(), 'limit_products' => array(), 'limit_ordertotal' => '', 'conditionx' => '', 'value' => '1', 'label' => '','append_fee' => '0', 'required' => '1','dchecked' => '0', 'reqalert' => '', 'add_fee' => 0, 'fee_text' => ''));
    }
    /**
     * Get checkbox data.
     *
     ...
     * @param string $name Checkbox name.
     */
    public function set_dchecked($required) {
        $this->set_prop('dchecked', $required);
    }
	
	    public function get_dchecked() {
        return $this->get_prop('dchecked');
    }
