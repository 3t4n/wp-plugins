...
See our pricing at https://clinked.com/pricing/
...
If you don't already have an account visit our website and [sign up](https://clinked.com/pricing/) for a free trial.
...
4. Include the shortcode `[clinked-login-button portal_url="https://app.clinked.com/"]` in the desired page, where `portal_url` parameter is your account login page URL.
...
3. Activate Clinked Client Portal from your Plugins page.
4. Include the shortcode `[clinked-login portal_url="https://app.clinked.com/"]` in the desired page, where `portal_url` parameter is your account login page URL.

== Screenshots ==

1. Generated login form
2. Shortcode on a page - Admin Interface
