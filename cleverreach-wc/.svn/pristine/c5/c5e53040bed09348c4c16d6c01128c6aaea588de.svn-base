...
#### 3.4.3 - November 25, 2024

**Updates**

 - A function was added, that calls the login mask when the recipient list in the connected account is deleted
 - Performance optimization: method of retrieving emails on the blocklist has been optimized, to increase
performance for tasks related to customer updates

#### 3.4.2 - November 06, 2024

**Updates**

 - Use of React.js to extend the checkout
 - Fix buyer not created when admin is logged in on checkout
 - Fix: Set initial values for filter configuration (An example would be the resetting Wildcard to Static on the sync settings page)
 - Mark compatibility with WordPress 6.6.2 and WooCommerce 9.3.2
