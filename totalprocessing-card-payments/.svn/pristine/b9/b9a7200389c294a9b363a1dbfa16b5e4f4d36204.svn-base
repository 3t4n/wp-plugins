...
= 7.1.5 - 05-02-2025 16:35 =

* Improved the Apple Pay block validation logic to ensure that compatibility checks are performed only when necessary, improving overall efficiency.

= 7.1.4 - 04-02-2025 18:20 =

* Apple Pay checkout restriction for guest users.
* Added the ability to restrict Apple Pay checkouts to logged-in customers only.

= 7.1.3 - 15-01-2025 21:10 =

* Applepay Registration flow correction

= 7.1.2 - 13-01-2025 22:10 =

* Enhanced compatibility with Apple Pay integration and discount code, with special focus on raffle tickets extensions

= 7.1.1 - 20-12-2024 15:20 =

* Resolved bugs connected to Apple Pay integration, connected to discounts/promotions & repeat transactions.

= 7.1.0 - 02-12-2024 09:05 =
...
= 7.0.5 - 16-10-2024 14:04 =

* added missing js file

= 7.0.4 - 16-10-2024 11:40 =

* resolved conflict with Oxygen website builds and plugins payment flow
* optimised 3ds payment flow to account for varying 3ds servers
