...
class WC_Payment_Gateway_TotalProcessing_Cards extends WC_Payment_Gateway {
    ...
    public function payment_scripts_cards() {
        if($this->checkPageShouldRun() === true){
            ...
            wp_register_script( $prefix . 'tp_cards_commons', plugin_dir_url( dirname( __FILE__ ) ).'assets/js/tpJs-common.js' , ['jquery','wp-util'], $tp_pluginVer, array("in_footer" => true) );
            ...
            wp_enqueue_script($prefix . 'tp_cards_commons');
