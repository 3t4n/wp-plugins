...
class Totalprocessing_Card_Payments_And_Gateway_Woocommerce_Activator {
    ...
    public static function tpapplepay_activation() {
        if(get_option('wc_totalprocessing_applepay_permalinks_flushed') === false){
            add_option('wc_totalprocessing_applepay_permalinks_flushed', 0);
        } else {
            update_option('wc_totalprocessing_applepay_permalinks_flushed', 0);
        }
    }
}
