 ...
 * @since 1.0.0
 */
if (! function_exists('diaa_add_custom_plugin_links')) {
	function diaa_add_custom_plugin_links($links, $file)
	{
		if (!isset($plugin)){
		...
		if ($plugin == $file) {
			$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/wp-plugins/default-image-addon-for-acf/doc/" target="_blank">Documentation</a>';
			$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/contact/" target="_blank">Contact Support</a>';
		}
		return $links;
	}
}
add_filter('plugin_row_meta', 'diaa_add_custom_plugin_links', 10, 2);