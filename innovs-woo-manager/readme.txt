...
Contributors: innovs
Tags: woocommerce, cart modify, add to cart, checkout field editor, woocommerce checkout field editor, checkout manager, checkout field customizer, checkout, WooCommerce checkout, checkout form designer, checkout
...
Get full control over Add to Cart Button, Color, Label on everywhere & Add Additional Fields on checkout page, shipping page, control position of the fields, hide unwanted core fields of WooCommerce.

== Description ==

Woo Manager enables the easiest way to manage your WooCommerce store and design it with your very own choice.

[youtube https://www.youtube.com/watch?v=e7XN_1kCD8s&feature=youtu.be]
