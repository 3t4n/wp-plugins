...
export class HtmlLoanSchedule {

	//
	// create HTML schedule
	//
	static formatLoanSchedule (schedule, summary) {
		...
		this.strHTMLTitle = '<title>' + loanStrings.strs.s2012 + '</title>';
		...
		if (schedule.length > 0) {
			...
			rate = Utils.formatNumericValueWithSym(summary.nominalRate[SCHEDULE_INDEX] * 100, Locales.rateConventions, Locales.rateConventions.precision);
			...
			freq = loanStrings.strs.s416b; // monthly
			...
			num = Utils.formatNumericValueWithSym(summary.totalNDebits[SCHEDULE_INDEX], Locales.numConventions, 0);

			strUnadjustedBal = Utils.formatNumericValueWithSym(summary.unadjustedBalance, Locales.moneyConventions);
			if (summary.unadjustedBalance < 0.0) {
				// Last payment amount decreased by ' + strUnadjustedBal + ' due to rounding
				roundingMsg = loanStrings.strs.s202 + ' ' + strUnadjustedBal + ' ' + loanStrings.strs.s203;
			} else if (summary.unadjustedBalance > 0.0) {
				// Last payment amount increased by ' + strUnadjustedBal + ' due to rounding
				roundingMsg = loanStrings.strs.s204 + ' ' + strUnadjustedBal + ' ' + loanStrings.strs.s203;
			} else {
				roundingMsg = '';
			}
			...
			// Loan Summary
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + loanStrings.strs.s2052 + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + loanStrings.strs.s208 + ':</td><td class="right">' + bal + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + loanStrings.strs.s209 + ':</td><td class="right">' + num + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + loanStrings.strs.s210 + ':</td><td class="right">' + rate + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + loanStrings.strs.s211 + ':</td><td class="right">' + pmt + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + loanStrings.strs.s212 + ':</td><td class="right">' + strDate + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + loanStrings.strs.s213 + ':</td><td class="right">' + strDateFirst + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + loanStrings.strs.s214 + ':</td><td class="right">' + freq + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + loanStrings.strs.s215 + ':</td><td class="right">' + strDateLast + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label hCell">' + loanStrings.strs.s216 + ':</td><td class="right">' + totalInterest + '</td><td class="spcr">&nbsp;</td><td class="spcr">&nbsp;</td><td class="label hCell">' + loanStrings.strs.s217 + ':</td><td class="right">' + totalPI + '</td></tr>');
			...
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + loanStrings.strs.s218 + '</td></tr>');
			strSchedule.append('<tr class="empty"><td colspan="6"></td></tr>');
			...
			strSchedule.append('<tr class="label cHead"><td class="rpt6colvnarrow">#/' + loanStrings.strs.s219 + '</td><td class="rpt6colnarrow center">' + loanStrings.strs.s220 + '</td><td class="rpt6col right">' + loanStrings.strs.s221 + '</td><td class="rpt6col right">' + loanStrings.strs.s222 + '</td><td class="rpt6col right">' + loanStrings.strs.s223 + '</td><td class="rpt6colwide right">' + loanStrings.strs.s224 + '</td></tr>');
			...
			for (i = 0; i <= L; i += 1) {
				...
				if (i > 0) {
					...
					// Loan:
					periodYear = loanStrings.strs.s232 + ':';
				}
