...
function easynotify_preview( $id, $val ) {
	...
	ob_start(); 
		...
		echo '<!DOCTYPE html>';
		echo '<html><head><title>'.esc_html(ENOTIFY_NAME).' Preview</title>';
		...
		echo'<a style="display: none !important;" href="#noty-'.esc_attr($id).'" id="launcher-'.esc_attr($id).'"></a>';
		echo'<div style="display: none !important;"><div id="noty-'.esc_attr($id).'">';
