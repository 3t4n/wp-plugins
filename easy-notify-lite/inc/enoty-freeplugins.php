...
.easynotify_page_easynotify_free_plugins .plugin-card-top .column-description {
	margin-left: 140px !important;
}

body.rtl.easynotify_page_easynotify_free_plugins .plugin-card-top .column-description {
		...
		<div id="<?php echo $plugin["slug"]; ?>" class="plugin-card drop-shadow lifted">
            ...
            <?php if ( isset( $plugin["slug"] ) && $plugin["slug"] == 'easy-media-gallery' ) {echo '<div class="most_popular"></div>';} ?>
				...
				<div class="desc column-description" style="margin-right: 20px !important;">
					...
					<div class="authors"><?php echo $author; ?></div>			
				</div>
			</div>
...
jQuery(document).ready(function($) {
	...
	var theListspp = ['page-builder-wp', 'easy-media-gallery', 'contact-form-lite', 'feed-instagram-lite', 'image-slider-widget', 'gallery-lightbox-slider', 'image-carousel','icon', 'easy-notify-lite'];
