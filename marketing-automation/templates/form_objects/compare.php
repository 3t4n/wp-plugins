<?php
	...
	$product_reviews = HTTP_SERVER . DIR_WS_HTTP_CATALOG . 'product_reviews.php?';
	if (isset($_GET['osCsid'])) {
		$product_reviews .= 'osCsid=' . $_GET['osCsid'] . '&';
	}
...
<script type="text/javascript">
	...
	$(document).ready(function() { 
		$('.fancybox').click(function() { 
			...
			var product_reviews = <?php echo json_encode( $product_reviews ); ?>;

			$.fancybox.open({
				href : product_reviews + 'products_id=' + productId,
				type : 'iframe',
				padding : 5
			});
		});
