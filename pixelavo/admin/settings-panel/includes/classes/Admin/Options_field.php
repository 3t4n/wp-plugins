        ...
        $settings = array(
            ...
            'pixelavo_events' => array(
                ...
                array(
                    ...
                    'desc'  => __( 'Track subscription when a subscription is created, renewed, cancelled, or changes status.' . (!$this->woocommerce_subscription_active ? ' Note: This feature requires (WooCommerce Subscription Extension)' : ''), 'pixelavo' ),
                    'type'  => 'element',
            ...
            'pixelavo_edd_events' => array(
                ...
                array(
                    'id'  => 'edd_subscription',
                    'name'  => __( 'Track Subscription', 'pixelavo' ),
                    'desc'  => __( 'Track subscription when a subscription is created, renewed, or cancelled.' . (!$this->edd_subscription_active ? ' Note: This feature requires (WooCommerce Subscription Extension)' : ''), 'pixelavo' ),
                    'type'  => 'element',
