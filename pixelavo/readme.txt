=== Pixelavo - Facebook Pixel Conversion API (CAPI) / Server Side Tracking ===
...
== Description ==
Pixelavo is a plugin that facilitates the quick and easy connection of your Facebook pixel (Now Meta Pixel) to your online store. By utilizing the Facebook Pixel, you can gather vital information about your store's visitors, which can be leveraged to craft personalized Facebook advertisements. Consequently, this can generate additional traffic and sales for your online store. For individuals seeking to enhance their Facebook marketing campaigns with simplicity, Pixelavo serves as a valuable resource.

The plugin comes with a range of features to help you improve your marketing campaigns, including advanced tracking capabilities, conversion tracking, custom audience creation, and retargeting tools. You can use the insights gathered by Pixelavo to create targeted and effective Facebook ads, which will increase the chances of converting potential customers into actual buyers.

Pixelavo is designed to be user-friendly, making it easy for anyone to install and use. Whether you're a beginner or an experienced marketer, Pixelavo provides you with the tools you need to improve your Facebook advertising campaigns and grow your online eCommerce business.
...
Pixelavo supports tracking of numerous Facebook pixel events, including:
...
* **Purchase** [Pro]
* **Refund** [Pro]
* **Subscription** [Pro] (SubscriptionCreated, SubscriptionRenewed & SubscriptionCancelled)
* **Customize Product** (WooCommerce Only) [Pro]
* **PageScroll**
* **TimeOnPage**
* **FormSubmission** (Fluent Forms, Contact Form 7 & WPForms)
* **Download**
* **InternalLinks** [Pro]
* **ExternalLinks** [Pro]
...
1. **Woocommerce:** Pixelavo seamlessly integrates with WooCommerce, making it one of the best Facebook Pixel plugins for WooCommerce users looking to enhance Facebook Analytics and improve targeted advertising. With Pixelavo’s conversion tracking and server-side tracking capabilities, WooCommerce store owners can efficiently track key events like purchases, add-to-cart actions, and product views to optimize Facebook retargeting and boost conversion rates.
2. **Easy Digital Downloads (EDD)** Pixelavo also supports Easy Digital Downloads (EDD), allowing digital product stores to leverage Facebook Pixel Events and track conversion data with accuracy. By integrating EDD with Facebook’s Conversions API, Pixelavo enables businesses to create more effective Facebook retargeting campaigns, gather valuable analytics, and gain insights into customer behavior for better-targeted advertising and growth.
...
= Version: 1.2.5 - Date: 06-02-2025 =
* Fixed: Issue with "ViewContent" and "Purchase" events setting get reset.

= Version: 1.2.4 - Date: 28-01-2025 =
* Added: New "RemoveFromCart" event.
* Improved: UI/UX for WooCommerce and Easy Digital Downloads (EDD) events settings.
* Updated: Move "ViewContent" and "Purchase" events setting to "WooCommerce Events" page.

= Version: 1.2.3 - Date: 01-01-2025 =
* Added: New Form Submission event tracking compatibility with Fluent Forms, Contact Form 7, and WPForms.
* Improved: UI/UX for Other events settings.

= Version: 1.2.2 - Date: 02-12-2024 =
* Added: New "Download" event.

= Version: 1.2.1 - Date: 14-11-2024 =
* Tweak: Admin CSS for cross-browser compatibility.

= Version: 1.2.0 - Date: 07-11-2024 =
* Fixed: Translation issue in Options_field.php file.
