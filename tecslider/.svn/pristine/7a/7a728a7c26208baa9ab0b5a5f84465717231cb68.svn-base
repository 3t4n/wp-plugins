		...
		<div class="mwt-be-section">
			...
			<div class="mwt-be-block">
				<select name="tecslider_theme" class="mwt-shortcode-element" data-attr="slidertheme">
					...
					<option value="datefocus"><?php esc_html_e( 'Date Focused', 'tecslider' ); ?></option>
					...
					<option value="cardlayout" <?php echo esc_html( $is_disabled ); ?> ><?php esc_html_e( 'Card Layout', 'tecslider' ); ?><?php echo esc_html( $premium_only ); ?></option>
					<option value="splitlayout" <?php echo esc_html( $is_disabled ); ?> ><?php esc_html_e( 'Split Layout', 'tecslider' ); ?><?php echo esc_html( $premium_only ); ?></option>
				</select>
			</div>
		</div>
	</div>
...
<div class="mwt-row">
	<div class="mwt-col">
		<div class="mwt-be-section">
			<h2 class="mwt-be-section-header">
				<?php esc_html_e( 'Detail Height', 'tecslider' ); ?>
			</h2>
			<div class="mwt-be-block">
				<input type="number" name="tecslider_slideheight" class="mwt-shortcode-element" data-attr="slideheight" />
			</div>
		</div>
	</div>
	<div class="mwt-col mwt-p-col"></div>
	<div class="mwt-col">
		<div class="mwt-be-section">
			<h2 class="mwt-be-section-header" class="mwt-shortcode-element">
				<?php esc_html_e( 'Image height', 'tecslider' ); ?>
			</h2>
			<div class="mwt-be-block">
				<input type="number" name="tecslider_imageheight" class="mwt-shortcode-element" data-attr="imageheight" />
			</div>
		</div>
	</div>
</div>
