...
class Tecslider_Rest_API {
	...
	public function tecslider_generate_events_sliders( $request ) {
		...
		$slideheight      = isset( $attributes['slideHeight'] ) && 0 !== (int) $attributes['slideHeight'] ? $attributes['slideHeight'] : null;
		$imageheight      = isset( $attributes['imageHeight'] ) && 0 !== (int) $attributes['imageHeight'] ? $attributes['imageHeight'] : null;
