...
class Tecslider_Elementor_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$premium_options = array(
			...
			'cardlayout' . $disabled  => esc_html__( 'Card Layout', 'tecslider' ) . $premium_text,
			'splitlayout' . $disabled => esc_html__( 'Split Layout', 'tecslider' ) . $premium_text,
		);
	...
	protected function render() {
		...
		global $tecslider;
		$settings['slideHeight'] = isset( $settings['slideHeight']['size'] ) ? $settings['slideHeight']['size'] : 300;
		$settings['imageHeight'] = isset( $settings['imageHeight']['size'] ) ? $settings['imageHeight']['size'] : 300;
		$settings['ticketInfo']  = 'on' === ( isset( $settings['ticketInfo'] ) ? $settings['ticketInfo'] : 'off' ) ? true : false;
		$settings['dots']        = 'on' === ( isset( $settings['dots'] ) ? $settings['dots'] : 'off' ) ? true : false;
		$settings['newtab']      = 'on' === ( isset( $settings['newtab'] ) ? $settings['newtab'] : 'off' ) ? true : false;
		$settings['darkmode']    = 'on' === ( isset( $settings['darkmode'] ) ? $settings['darkmode'] : 'off' ) ? true : false;

		$settings['countdownTimer'] = 'on' === ( isset( $settings['countdownTimer'] ) ? $settings['countdownTimer'] : 'off' ) ? true : false;
		?>
