 ...
 * Plugin URI: http://egp.mywptrek.com
...
class MWT_Tec_Slider {
    ...
    public function super_init() {
        $this->plugin_url = path_join( WP_PLUGIN_URL, basename( __DIR__ ) );
        $this->plugin_slug = plugin_basename( __FILE__ );
        $this->plugin_path = __DIR__;
        $this->blocks_path = $this->plugin_url . '/includes/blocks';
        $this->tecslider_url = path_join( plugins_url(), basename( __DIR__ ) );
        $this->tecslider_path = __DIR__;
