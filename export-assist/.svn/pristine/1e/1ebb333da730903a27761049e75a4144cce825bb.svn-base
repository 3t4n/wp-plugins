...
/*
 ...
 Description: A simple plugin that help you to easily export wordpress data to blogger in xml file.
 Version: 1.5
 Author: shoaiyb sysa
...
?>
	...
	<div id="ew2bc_message"></div>
		...
		<div class="ew2bc_other">
			<a href="<?php _e('https://plugin.sysa.ml/export-assist/', 'export-assist' ); ?>" target="_blank" rel="noopener">
