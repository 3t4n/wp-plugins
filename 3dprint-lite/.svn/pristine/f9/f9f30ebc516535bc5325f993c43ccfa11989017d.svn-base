...
Tags: 3D, printing, 3dprinting, 3D printing, 3dprint
...
Printers, materials, coatings have "Enabled" switch and sort order field.
default_infill bugfix
...
Dropdown (New) is collapsible on item selection
If a model is not found an error message is shown

= 2.0.6.6 =

Price Debug Mode option
Price decimals bugfix
