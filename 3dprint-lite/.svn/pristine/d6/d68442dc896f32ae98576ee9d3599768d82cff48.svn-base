...
function register_3dprintlite_settings_page_callback() {
	...
	if ( isset( $_POST['p3dlite_settings'] ) && !empty( $_POST['p3dlite_settings'] ) ) {
		...
		if ( ! isset( $_POST['p3d_settings_update'] ) || ! wp_verify_nonce( $_POST['p3d_settings_update'], 'update' ) ) {
...
<div class="wrap">
	...
	<?php    wp_nonce_field( 'update', 'p3d_settings_update' ); ?>
	<div id="p3dlite_tabs">
...
?>
	...
	<div id="p3dlite_tabs">
		...
		<div id="p3dlite_tabs-0">
				...
				<p><?php esc_html_e('Available shortcodes', '3dprint-lite'); ?>:<?php echo implode(', ', array('[customer_email]','[printer_name]','[material_name]','[coating_name]','[infill]','[infill_name]', '[quantity]', '[model_file]','[unit]','[resize_scale]','[dimensions]','[estimated_price]','[estimated_price_total]','[customer_comments]','[price_requests_link]'));?></p>
				...
				<p><?php esc_html_e('Available shortcodes', '3dprint-lite'); ?>:<?php echo implode(', ', array('[printer_name]', '[quantity]', '[material_name]', '[coating_name]', '[infill]', '[infill_name]', '[model_file]', '[dimensions]', '[weight]','[price]', '[price_total]', '[admin_comments]', '[admin_delivery]'));?></p>
