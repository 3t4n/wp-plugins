...
*
* @link              https://clickdesigns.com/wp/
* @since             2.0.0
...
*/
define( 'CLICKDESIGNS_VERSION', '2.0.0' );
...
function ClickDesigns_load_data_form() {
	...
	$key = get_option('clickdesign_api');
		...
		$imgrefresh = plugins_url('assets/images/refresh.svg', __FILE__);
		      ...
		      <div class="cd-media-section">
			   <div class="cd-top-div">
				...
				<div class="cd-data-filter">
					<a href="javascript:void(0);" class="cds-btn cds_btn_refresh"><img src="'.esc_url( plugins_url('assets/images/refresh.svg', __FILE__) ).'"> Refresh</a>
		...
		</div><div class="cd-loader" style="display: none;"><img src="'.esc_url("https://cdn1.clickdesigns.com/images/loader.gif").'"></div></div>';
