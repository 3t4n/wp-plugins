...
== Upgrade Notice ==
= 7.4 =
* Changed several attribute names, to make it more clear for users. For more info please check changelog at plugin page.


== Screenshots ==
1. Knowledge Base
2. Knowledge Base WooCommerce products
3. Block (dashboard)
4. Widget (dashboard)