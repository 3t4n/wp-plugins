...
class EEL_Base {
    ...
    public function add_error_page() {
				...
				<div id="debugger" class="tab-pane active">
					...
					<div class="controller">
						<button id="toggle-controller" class="button">
							<span id="toggle-icon">▼</span> Controls
						</button>
						<div class="wpel-buttons" style="display: flex; gap: 16px;">
							<div class="debug-toggle-container">
									...
									<span class="toggle-label">Toggle Debug Mode:</span>
        ...
        public function system_info() {
			...
			$apache_modules = function_exists('apache_get_modules') ? apache_get_modules() : esc_html__('N/A', 'wpnts');
