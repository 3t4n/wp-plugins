...
Tags: regular backup, daily backup, keep backup daily, database security, free backup
...
= Tags =
offsite, sql, online backup, full backup, complete backup, mysql export, email mysql dump, db backup, database backup, email database backup, restore database backup
...
== Changelog ==
= 2.1.1 =
* Fix: Arbitrary File Download / A3: Injection. [10/02/2025][Thanks to Caesar Evan Santoso | Darius Sveikauskas]
= 2.0.9 =
* Fix: The issue at hand is the fact the file name is guessable (or enumerable) because you are relying on a time-based filename. [22/10/2024][Thanks to Joshua Chan | patchstack & WordPress Plugin Review Team]
= 2.0.8 =
...
== Upgrade Notice ==
= 2.1.1 =
Fix: Arbitrary File Download / A3: Injection.
= 2.0.9 =
