...
Tags: Tapuz, Shipment, Cargo, HFD , Chita
...
The following Shipping companies are supported:
* Cheetah Couriers
* HFD Company
* Tapuz
* Rom express
...
= 2.2.0 =
* Add REST API endpoint to update Shipos settings
* Bug and security fixes
* Update readme.txt to add new companies and comply with WordPress plugin standards

= 2.1.7 =
* Fix delivery address not saving when shipping method title was changed

= 2.1.6 =
* Add collection point to cart page
* Allow changing pickup point from order edit page

= 2.1.5 =
* Fix some issues with free shipping
* Utilize WC_Logger for debugging
* Minor bug fixes

= 2.1.4 =
* Fix an issue where order creation date was not sent to Shipos in correct format
* Fix an issue where create shipment buttons would not show
* Fix an issue where shipos pickup meta would be set even when a different shipping method was selected

= 2.1.3 =
* Fix an issue where printing label would give white screen

= 2.1.2 =
* Add order item attributes to label
