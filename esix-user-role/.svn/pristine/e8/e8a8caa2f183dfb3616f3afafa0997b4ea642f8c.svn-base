<div  style="width:50%; float left;">
			 <h2>Apply on Selected Post Type</h2>
			       <form method="POST" action="<?php echo get_site_url()?>/wp-admin/admin.php?page=sk_alowed_post_page">
			 <?php $args = array(
					   'public'   => true,
					...
					if(isset($_POST['postselect']))
					{
						...
						$pagein_type = eurm_sanitize_array($_POST['postselect']);
						update_option('kk_postoption_ff',$pagein_type);
