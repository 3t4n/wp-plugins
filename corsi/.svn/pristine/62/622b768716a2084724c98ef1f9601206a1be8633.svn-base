<?php
  /* categorie*/
	function corsi_tassonomia_categoria() {
		$labels = array(
		...
		register_taxonomy( 'corsi_cat', 'corsi', $args );
	}
	add_action( 'init', 'corsi_tassonomia_categoria', 0 );
	
	function corsi_tassonomia_tag() {
		$labels = array(
		...
		register_taxonomy( 'corsi_tag', 'corsi', $args );
	}
	add_action( 'init', 'corsi_tassonomia_tag', 0 );