    ...
    <h3><?php //_e('AWeber Subscription Settings', 'apm-child'); ?> <span style="color:#F00; font-size:13px; display:block; float:right"> *All fields are mandatory.</span></h3>
        <div style="width:50%; float:left">
            ...
            <select name="email_service_provider" id="email_service_provider">
                ...
                <option value="eShowcaseCRM" <?php if($apm_email_service_provider == "eShowcaseCRM"){?> selected="selected" <?php } ?>>eShowcase CRM</option>
                <?php /*?><option value="Sendeagle" <?php if($apm_email_service_provider == "Sendeagle"){?> selected="selected" <?php } ?>>Send Eagle</option>
                <option value="Infusionsoft" <?php if($apm_email_service_provider == "Infusionsoft"){?> selected="selected" <?php } ?>>Infusionsoft/Keap</option>
                <option value="GetResponse" <?php if($apm_email_service_provider == "GetResponse"){?> selected="selected" <?php } ?>>GetResponse</option><?php */?>
            </select>
