    ...
    <div class="inline-container-inner">
		...
		<div class="inline-row pt-4">
     	...
     	<div class="inline-row pt-4">
        				 ...
        				 <script>
                            function onSubmitForm_lwer2(event) {
                               
							   
							    event.preventDefault();
                        
                                
                                if(document.getElementById('frm_subscribers_lwer2').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_lwer2').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_lwer2').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_lwer2').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmit_lwer2");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_lwer2");
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_lwer2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers_eshowcase_crm.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmit_lwer2" onclick="onSubmitForm_lwer2(event)" value="Discover Full Details Now"></center>
                        
                        <div class="progress progress_lwer2"></div>
                        <br>
