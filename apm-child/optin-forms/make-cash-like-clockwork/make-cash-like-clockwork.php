...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>optin-forms/make-cash-like-clockwork/clk.css" media="screen">
...
<script type="application/ld+json">{
		...
		"@type": "Organization",
		"name": "Six Figures A Year"
}</script>

    <meta name="theme-color" content="#478ac9">
    <meta property="og:title" content="Lazy Way To Email Riches">
  ...
  <section class="inline-container u-section-1 d-flex flex-column align-items-center align-items-xxl-center">
    <div class="inline-container-inner">
		<div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> Calling All Frustrated Entrepreneurs – <br>Who Else Wants To <span style="font-weight: 700">Forget</span> Selling 'Low Priced' One Off Digital Products Such As eBooks And…<br>
            </p>
        </div>
		
		<div class="inline-row row-optin-landing-1 pt-4 pb-4">
            <div class="inline-col-lg-5 optin-aling-center">
                <img class="u-image u-image-contain u-image-default u-image-1" src="<?php echo APM_PLUGIN_PATH ?>optin-forms/make-cash-like-clockwork/images/nick-kate.png" alt="" data-image-width="906" data-image-height="auto">
            </div>
            <div class="inline-col-lg-7">
              <h1 class="u-custom-font u-align-center u-font-montserrat u-text u-text-black u-text-default u-title u-text-1"> Make Cash<br>
Like Clockwork</h1>
            </div> 
        </div>
		
		<div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> Using A Passive Income System That Automatically Deposits Money Into Your Bank Account Effortlessly Every Month Instead.<br>
            </p>
        </div>
		
		<div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> Just enter your details below to discover how:<br>
            </p>
        </div>
      ...
      <div class="inline-row pt-4">
            ...
            <script src="https://www.google.com/recaptcha/api.js?render=<?php echo __($recaptcha_site_key, 'apm-child')?>"></script>
        				 <script>
                            function onSubmitFormmclc2(event) {
                               
							   
							    event.preventDefault();
                        
                                
                                if(document.getElementById('frm_subscribers_mclc2').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_mclc2').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_mclc2').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_mclc2').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmitmclc2");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_mclc2");
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_mclc2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers_eshowcase_crm.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitmclc2" onclick="onSubmitFormmclc2(event)" value="Discover Full Details Now"></center>
                        
                        <div class="progress progress_mclc2"></div>
                        <br>
         ...
         <div class="inline-row">
                <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-black u-text-5"><span style="color: #000000"><a target="_blank" href="https://affiliatepromembership.com/privacy-policy/?apmchilduser=<?php echo esc_html(base64_encode( $recordCrediantial['user_email_id'] ), 'apm-child' );?>">Privacy Policy</a>:</span> We value your privacy. You can unsubscribe from receiving future emails with 1 click at any time. <br>
           </p>
         </div>
