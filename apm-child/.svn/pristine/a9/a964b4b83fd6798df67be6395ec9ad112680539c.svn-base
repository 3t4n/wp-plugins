        ...
        <div class="container d-flex flex-column align-items-center align-items-xxl-center" id="container1">
            ...
            <div class="row d-xl-flex justify-content-xl-center" id="form-container">
                <div class="col align-self-center" style="width: 100%;">
                        ...
                        <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_sasf1" method="post" action="https://affiliatepromembership.com/mi_email_subscribers_eshowcase_crm.php">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitsasf1" onclick="onSubmitFormsasf1(event)" value="Yes Please!..."></center>
                    ...
                    <p id="privacy-text"><a href="https://affiliatepromembership.com/privacy-policy/?apmchilduser=<?php echo esc_html(base64_encode( $recordCrediantial['user_email_id'] ), 'apm-child' );?>" target="_blank"><span style="text-decoration: underline;">Privacy Policy : </span></a>We promise to not use your email for spam!</p>
                </div>
            </div>
        </div>
    </section>
