			...
			@keyframes progress-p43u5e {
			   100% {
				  background-size: 100% 100%;
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_sfay2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers_eshowcase_crm.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitsfay2" onclick="onSubmitFormsfay2(event)" value="Yes I Want The Book..."></center>
