            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-7 col-xl-7 col-xxl-7 d-flex flex-column justify-content-center align-items-center" id="column-right">
                    ...
                    <h4 id="sub-headline"><span style="color: rgb(0, 0, 0);">Enter your details below to claim your FREE BOOK* of&nbsp;</span><strong><em><span style="color: rgb(0, 0, 0);">'Six Figures A Year In Info Publishing'...</span></em></strong></h4>
                        ...
                        <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_sfay1" method="post" action="https://affiliatepromembership.com/mi_email_subscribers_eshowcase_crm.php">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitsfay1" onclick="onSubmitFormsfay1(event)" value="Yes I Want The Book..."></center>
