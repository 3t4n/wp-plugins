...
final class Core extends AbstractCore {
	...
	public function init() {
		...
		$this->loader->add_filter( 'script_loader_tag', $script, 'change_js_attribute', 1, 2 );
		$this->loader->add_action( 'wp_enqueue_scripts', $script, 'head_integration', 1 );
	...
	/**
	 * Add query vars to the list of allowed query vars.
	 *
	 * @since 2.6.5
	 * @param array<string> $vars The list of allowed query vars.
	 * @return array<string> The updated list of allowed query vars.
	 */
