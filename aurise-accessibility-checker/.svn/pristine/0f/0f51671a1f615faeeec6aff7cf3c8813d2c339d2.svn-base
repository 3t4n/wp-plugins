<div class="wrap au-plugin">
    <h1><img style="width: 120px; height: 60px;" src="<?php echo (esc_url($args['plugin_settings']['url'])); ?>assets/images/admin-logo.svg" alt="<?php esc_html_e($args['plugin_settings']['name'] . ' ' . __('by WebYes', 'aurise-accessibility-checker')); ?>" width="293" height="60" /></h1>
