...
== Changelog ==
= 1.27.7 =
* Simple Pay Pro integration - extra data fields updated

= 1.27.6 =
* minor code changes

= 1.27.5 =
* Simple Pay Pro integration update (deprecated functions replaced)

= 1.27.3 =
* SureCart integration fix

= 1.27.1 =
* Added support for one time orders to SureCart

= 1.27.0 =
* Added integration with SureCart
* Improved handling of Post Affiliate Pro URL input on login form
* Allowed defining currency when triggering a recurring commission
