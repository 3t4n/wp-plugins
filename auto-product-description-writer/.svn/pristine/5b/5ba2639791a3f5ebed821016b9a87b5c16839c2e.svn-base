...
<section class="momo-be-getting-started">
	...
	<div class="momo-be-gs-block">
		<div class="momo-be-gs-block-column">
			<div class="momo-be-gs-block-column-70 momo-be-gs-center">
				<h2 class="momo-be-gs-block-header">
					<?php esc_html_e( 'Data Analysis', 'momoacgwc' ); ?>
				</h2>
				<div class="momo-be-gs-row ">
					<img src="<?php echo esc_url( $assets . 'data-analytics.png' ); ?>" alt="data-analytics" class="momo-mh-130" />
				</div>
				<div class="momo-be-gs-block-content">
					<p>
						<?php esc_html_e( 'Data analysis capabilities allow businesses to manage WooCommerce data by offering insightful, automated, and scalable solutions. With its ability to process large datasets quickly, it can analyze sales trends, customer behavior, and product performance to provide actionable insights. For instance, it can identify bestselling products, flag underperforming inventory, and suggest pricing strategies to optimize profits. ', 'momoacgwc' ); ?>
					</p>
					<p>
						<?php esc_html_e( 'Businesses can benefit from natural language interfaces, making complex data queries simple. This accessibility reduces the need for technical expertise while maximizing the value of data, helping businesses make informed, data-driven decisions in real time.', 'momoacgwc' ); ?>
					</p>
				</div>
			</div>
		</div>
