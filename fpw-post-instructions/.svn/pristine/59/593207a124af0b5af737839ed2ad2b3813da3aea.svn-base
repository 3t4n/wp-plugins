...
wp_register_script( 'fpw-fpi-script', $this->fpiUrl . '/js/fpw-fpi-script.js', array( 'jquery' ) );
wp_enqueue_script( 'fpw-fpi-script' );

wp_localize_script( 'fpw-fpi-script', 'fpw_fpi_text', array(
	'fpw_fpi_help_link_text' => esc_html( __( 'FPW Post Instructions - Help', 'fpw-post-instructions' ) ) ) );
