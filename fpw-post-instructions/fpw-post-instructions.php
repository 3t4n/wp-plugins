...
Description: Adds metaboxes to admin editing screens for posts, pages, links, and custom post types with instructions for editors.
Plugin URI: http://fw2s.com/fpw-post-instructions-plugin/
Version: 1.3.4
Author: Frank P. Walentynowicz
Author URI: http://fw2s.com/
Text Domain: fpw-post-instructions
...
if ( is_admin() ) {
	...
	$version = '1.3.4';
	new fpwPostInstructions( dirname(__FILE__), $version );
}
