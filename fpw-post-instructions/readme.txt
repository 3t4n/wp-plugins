...
Meta boxes on admin editing screens for posts, pages, links, and custom post types with instructions for editors.

== Description ==

This plugin makes meta boxes on admin editing screens for posts, pages, links, and custom post types with instructions for editors. The content of these meta boxes can be entered/modified on plugin's settings page. Two methods of editing are available - plain text (HTML codes allowed) and visual text editing.
...
= 1.3.4 =
* Removed remote request to get update info

= 1.3.3 =
* Enabled plugin language packs

= 1.3.2 =
* Removed PHP 4 compatibility code
...
Only one rich text editor can be used per settings page. This is because current editing mode switching code in WordPress does not handle multiple instances of the rich text editor.
