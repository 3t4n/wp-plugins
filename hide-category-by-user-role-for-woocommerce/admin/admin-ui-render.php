		...
		<form id="ts-wchc-form" class="card" method="post" action="options.php">
			...
			<ul class="nav nav-tabs" id="tswchc_tabs" role="tablist">
				<li class="nav-item" role="presentation">
					<button class="nav-link active" data-bs-toggle="tab" data-bs-target="#hide-role-by-cat" type="button" role="tab" aria-controls="hide-role-by-cat" aria-selected="true">
						<?php echo __('Hide by Category', 'ts-wchc'); ?>
					</button>
				</li>
				<li class="nav-item" role="presentation">
					<button class="nav-link" data-bs-toggle="tab" data-bs-target="#hide-cat-by-role" type="button" role="tab" aria-controls="hide-cat-by-role" aria-selected="false">
						<?php echo __('Hide by User Role', 'ts-wchc'); ?>
					</button>
				</li>
				<li class="nav-item" role="presentation">
					<button class="nav-link" data-bs-toggle="tab" data-bs-target="#other-settings" type="button" role="tab" aria-controls="other-settings" aria-selected="false">
						<?php echo __('Settings', 'ts-wchc'); ?>
					</button>
				</li>
			</ul>
			...
			<div class="buttons-wrapper">
				...
				<a href="#" id="reset-settings" class="btn btn-light">
					<?php echo __('Reset Settings', 'ts-wchc'); ?>
				</a>
						...
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="reset-settings-modal">
									...
									<?php echo __('This action will reset all your settings. <br><strong>Would you like to proceed?</strong>', 'ts-wchc'); ?>
								</h4>
							</div>
							<div class="modal-footer">
								<button id="clear-plugin-settings" type="button" class="btn btn-primary">
									<?php echo __('Yes', 'ts-wchc'); ?>
								</button>
								<button id="modal-btn-no" type="button" class="btn btn-light">
									<?php echo __('No', 'ts-wchc'); ?>
								</button>
							</div>
						</div>
					</div>
		...
		<div class="banner">
			...
			<div class="ts-card">
				<div class="ts-card-heading">
					<img src="<?php echo esc_html(TSWCHC_PLUGIN_URL) ?>/assets/img/Themesupport-Logo-H.svg" alt="<?php esc_attr_e('Themesupport Logo', 'ts-wchc'); ?>">
					<h6><?php esc_html_e('We do WordPress for you', 'ts-wchc'); ?></h6>
				</div>

				<div class="ts-card-body">
					<a href="https://themesupport.com" target="_blank" class="ts-card-button button button-themesupport">
						<?php esc_html_e('Contact Us', 'ts-wchc'); ?>
					</a>
					<ul>
						<li><?php esc_html_e('WordPress Hosting', 'ts-wchc'); ?></li>
						<li><?php esc_html_e('WordPress Development', 'ts-wchc'); ?></li>
						<li><?php esc_html_e('WordPress Maintenance', 'ts-wchc'); ?></li>
						<li><?php esc_html_e('WordPress Support', 'ts-wchc'); ?></li>
						<li><?php esc_html_e('Website SEO Service', 'ts-wchc'); ?></li>
						<li><?php esc_html_e('White Label Service', 'ts-wchc'); ?></li>
					</ul>
				</div>
				...
				<div class="card-footer">
					<a href="https://wordpress.org/support/plugin/hide-category-by-user-role-for-woocommerce/reviews/?rate=5#new-post" target="_blank" rel="noopener noreferrer">
						<h5><?php esc_html_e('Found the plugin helpful?', 'ts-wchc'); ?></h5>
						...
						<?php esc_html_e('Your review matters!', 'ts-wchc'); ?>
					</a>
				</div>
			</div>
