              ...
              <span class="<?php echo esc_html($key_roles); ?>">
                ...
                <small id="counter-<?php echo esc_html($key_roles); ?>" class="rules-counter">
                  <?php if ($has_rules): ?>
                    ...
                    printf(
                      esc_html(_n('%d Hidden Category', '%d Hidden Categories', $has_rules, 'ts-wchc')),
                      esc_html($has_rules)
                    );
                    ?>
                  <?php endif; ?>
          ...
          <div id="collapse-<?php echo esc_html($key_roles); ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?php echo esc_html($key_roles); ?>">
            ...
            <div class="accordion-body">
              ...
              <div class="actions-bar">
                ...
                <h6><?php echo __('Hide Categories', 'ts-wchc'); ?></h6>
              ...
              <div id="btn-group-<?php echo esc_html($key_roles); ?>" class="btn-group btn-group-xs" data-counter="counter-<?php echo esc_html($key_roles); ?>" role="group-<?php echo esc_html($key_roles); ?>" aria-label="<?php echo __('Products Categories', 'ts-wchc'); ?>">
                ...
                <?php foreach ($categories as $key_cats => $category): ?>
                  ...
                  <div class="">
                    ...
                    <label class="btn btn-outline-primary" for="<?php echo esc_html($cat_role_id); ?>">
                      ...
                      <small>| <?php echo __('ID:', 'ts-wchc'); ?> <?php echo esc_html($category->term_id); ?></small>
                    </label>
