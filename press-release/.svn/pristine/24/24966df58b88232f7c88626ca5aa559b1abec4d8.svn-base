...
Donate link: http://prwirepro.com
Tags:  press, press release, seo
...
== Description ==
A press release editor with an included free press release template. When you need to write a press release use this handy press release editor made just for your WordPress website or blog. Write a press release quickly within your wordpress panel and then quickly distribute your press release. 

Adds a new section for press releases within your wordpress dashboard, right next to your post and pages section. Publish your press releases from their own section and keep them separate from all of your post and pages. 
...
== Installation ==
1. Unzip and Upload `press-release.zip` to the `/wp-content/plugins/` directory
