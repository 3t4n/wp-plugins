 ...
 */
function cmlfnw_switch_to_main_blog_in_filter( $value ) {
 ...
 * @return mixed unfiltered array of uploaded data.
 */
function cmlfnw_restore_current_blog_in_action( $value ) {
...
function get_attachment_meta_keys() {
	...
	return apply_filters( 'cmlfnw_attachment_meta_keys', $attachment_meta_keys );
}
 ...
 */
function cmlfnw_switch_blog_in_rest( $response, $handler, $request ) {
 ...
 * @return WP_HTTP_Response The unfiltered response object.
 */
function cmlfnw_restore_blog_in_rest( $response, $handler, $request ) {
	$route = $request->get_route();
 ...
 */
function cmlfnw_filter_upload_dir( array $dirs ) : array {
 ...
 */
function cmlfnw_filter_image_downsize( $downsize, $id, $size ) {
	// Unhook this filter to avoid infite recursion.
	remove_filter( 'image_downsize', __NAMESPACE__ . '\\cmlfnw_filter_image_downsize' );
 ...
 */
function cmlfnw_rest_dispatch_requests( $response, $request ) {
 ...
 */
function cmlfnw_set_post_thumbnail( $post, $thumbnail_id ) {
	$post         = get_post( $post );
 ...
 */
function cmlfnw_filter_plupload_default_settings( array $settings ) : array {
 ...
 */
function cmlfnw_set_client_mu_cookie_path( string $auth_cookie, int $expire, int $expiration, int $user_id, string $scheme ) {
 ...
 * @return array
 */
function cmlfnw_jetpack_get_thumbnail_image( $media, int $post_id, array $args ) : array {
