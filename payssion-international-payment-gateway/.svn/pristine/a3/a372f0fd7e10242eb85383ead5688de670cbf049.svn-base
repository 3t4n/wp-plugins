...
function init_payssion_gateway() {
	...
	require_once('class-wc-gateway-payssion-afterpayus.php');
	...
	require_once('class-wc-gateway-payssion-promptpayth.php');
	...
	require_once('class-wc-gateway-payssion-rabbitlinepayth.php');
	...
	require_once('class-wc-gateway-payssion-shopeepayth.php');
	...
	require_once('class-wc-gateway-payssion-truemoneyth.php');
	...
	function add_payssion_gateway( $methods )
	{
		return array_merge($methods, 
				array(
				    ...
				    'WC_Gateway_Payssion_Afterpayus',
				    ...
				    'WC_Gateway_Payssion_Shopeepayth',
				    ...
				    'WC_Gateway_Payssion_Truemoneyth',
