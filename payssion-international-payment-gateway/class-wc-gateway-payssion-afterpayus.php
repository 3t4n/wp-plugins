 ...
 * Payssion 
 *
 * @class 		WC_Gateway_Payssion_Afterpayus
 * @extends		WC_Payment_Gateway
 * @author 		Payssion
 */
class WC_Gateway_Payssion_Afterpayus extends WC_Gateway_Payssion {
	public $title = 'Afterpay USA';
	protected $pm_id = 'afterpay_us';
