...
class WovnSettingsPage
{
    ...
    public function page_init()
    {
            ...
            // wovn_hreflang_x_default_lang
            add_settings_field(
                'wovn_hreflang_x_default_lang',
                '<i class=" dashicons-before dashicons-admin-site"></i>&nbsp;&nbsp;X-Default Hreflang Language',
                array( $this, 'wovn_hreflang_x_default_lang_callback' ),
                'wovn-setting-admin',
                'setting_section_id'
            );
    ...
    public function sanitize($input)
    {
        ...
        $lang_code_aliases_temp = array_key_exists('wovn_lang_code_aliases_temp', $input) ? $input['wovn_lang_code_aliases_temp'] : array();
    ...
    public function wovn_default_lang_callback()
    {
         ...
         * Get the settings option array and print one of its values
         */
    public function wovn_hreflang_x_default_lang_callback()
    {
        echo '<select id="wovn_hreflang_x_default_lang" name="wovn_options[wovn_hreflang_x_default_lang]">';
        print '<option value="">None</option>';
        foreach (array_values(Constants::$langs) as $lang) {
            printf(
                '<option value="%s" %s>%s</option>',
                $lang['code'],
                selected($this->wovn_options->get('wovn_hreflang_x_default_lang'), $lang['code']),
                $lang['name']
            );
        }
        print '</select>';
