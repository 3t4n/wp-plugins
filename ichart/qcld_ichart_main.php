...
function qciChart_load_all_scripts(){
  ...
  wp_register_script( 'ichart-chart-js', qcld_ichart_asset_url1 . '/js/chart.js', array('jquery') );
  //wp_enqueue_script( 'ichart-chart-js', qcld_ichart_asset_url1 . '/js/chart.js', array('jquery'));
  wp_register_script( 'ichart-plugin-deferred', qcld_ichart_asset_url1 . '/js/chartjs-plugin-deferred.js', array('jquery', 'ichart-chart-js'));
 // wp_enqueue_script( 'ichart-plugin-deferred', qcld_ichart_asset_url1 . '/js/chartjs-plugin-deferred.js', array('jquery'));
