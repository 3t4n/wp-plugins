...
if ( ! defined( 'qcld_ichart_support_path' ) ) {
    define('qcld_ichart_support_path', plugin_dir_path(__FILE__));
}

if ( ! defined( 'qcld_ichart_support_url' ) )
    define('qcld_ichart_support_url', plugin_dir_url( __FILE__ ) );

if ( ! defined( 'qcld_ichart_img_url' ) )
    define('qcld_ichart_img_url', qcld_ichart_support_url . "/images" );
...
add_action( 'admin_menu', 'qcld_ichart_show_promo_page_callback_func', 99 );
...
include_once qcld_ichart_support_path . '/qc-clr-recommendbot-support-plugin.php';
...
?>
        ...
        <div class="qcld-ichart-support qcld-support-new-page">
            ...
            <div class="qcld-plugins-lists">
                <div class="qcld-plugins-loading">
                    <img src="<?php echo esc_url(qcld_ichart_img_url); ?>/loading.gif" alt="loading">
                </div>
            </div>
        </div>
