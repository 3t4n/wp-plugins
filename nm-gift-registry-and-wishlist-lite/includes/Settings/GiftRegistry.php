...
class GiftRegistry extends Admin {
	...
	private function get_wishlist_page_desc() {
		$desc = nmgr()->is_pro ?
			__( 'Must contain the <strong>Archive</strong> block if you want to show all wishlists, or the <strong>Wishlist</strong> block to show a single wishlist.', 'nm-gift-registry' ) :
			__( 'Must contain the <strong>Archive</strong> block if you want to show all wishlists, or the <strong>Wishlist</strong> block to show a single wishlist.', 'nm-gift-registry-lite' );
