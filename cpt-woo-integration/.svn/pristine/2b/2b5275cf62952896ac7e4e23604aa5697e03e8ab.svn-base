						   ...
						   <?php } ?>
							<li class="footer-text" style="display: flex;justify-content: space-between;">
								<div class="footer text">
									<a style="margin-top:30px;color: #1677ff;display: flex;align-items: center;gap: 5px;font-weight: 600;" target="_blank" href="https://checkout.freemius.com/plugin/13672/plan/22848/licenses/1/"> Buy Now <span class="dashicons dashicons-arrow-right-alt"></span></a>
								</div>
								<div class="footer text">
									<a style="margin-top:30px;color: #1677ff;display: flex;align-items: center;gap: 5px;font-weight: 600;" target="_blank" href="https://www.wptinysolutions.com/tiny-products/cpt-woo-integration/"> Visit Our Website</a>
								</div>
