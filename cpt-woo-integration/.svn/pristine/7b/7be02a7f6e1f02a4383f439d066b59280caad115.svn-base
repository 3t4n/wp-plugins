...
class Api {
	...
	public function update_option( $request_data ) {
		...
		$the_settings['enable_product_cat'] = array_map( 'sanitize_text_field', $parameters['enable_product_cat'] ?? [] );

		$the_settings['enable_product_tag'] = array_map( 'sanitize_text_field', $parameters['enable_product_tag'] ?? [] );

		$the_settings['enable_product_attributes'] = array_map( 'sanitize_text_field', $parameters['enable_product_attributes'] ?? [] );
