...
class Fns {
	 ...
	 * @return bool
	 */
	public static function is_cat_enabled( $post_type ) {
		return self::is_enabled( $post_type, 'enable_product_cat' );
	}
	/**
	 * @param $post_type
	 *
	 * @return bool
	 */
	public static function is_tag_enabled( $post_type ) {
		return self::is_enabled( $post_type, 'enable_product_tag' );
	}
    /**
     * @param $post_type
     *
     * @return bool
     */
    public static function is_attributes_enabled( $post_type ) {
        return self::is_enabled( $post_type, 'enable_product_attributes' );
    }
	/**
	 * @return true
	 */
	...
	public static function pro_feature_list() {
		return [
			...
			[
				...
				'desc'  => 'Add Product Attributes For CPT.',
			],
			[
