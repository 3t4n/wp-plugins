...
👉 [Documentation](https://docs.wptinysolutions.com/cpt-woo-integration/) | [Get Pro](https://www.wptinysolutions.com/tiny-products/cpt-woo-integration/)  👈

[youtube https://www.youtube.com/watch?v=KvyHjlww1gg]
...
= 2.1.0 ( Feb 07, 2025 ) =
* Added: Product Cat and Tag Added
* Optimize: Admin Js Functionality More Optimize


= 2.0.10 ( January 27, 2025 ) =
* Support: Woocommerce Assets Added Admin Page

= 2.0.9 ( December 22, 2024 ) =
* Support: Up-sale And Cross Sale Support For CPT And Original Product

= 2.0.8 ( December 01, 2024 ) =
* Support: Extra Product Options
* Fixed: Ajax Product Search Admin Side Ajax Functionality

= 2.0.7 ( November 18, 2024 ) =
* Added: New shortcode for display woocommerce notice
* Fixed: Ba Book Plugin User Email.

= 2.0.6.1 ( November 10, 2024 ) =
* Organize: Notice Functionality
* Organize: Ba Books Plugin Review Summery
