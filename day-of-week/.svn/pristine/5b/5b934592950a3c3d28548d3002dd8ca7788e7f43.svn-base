...
* Tomorrow and Yesterday now added as a day option to show coming up or just missed!!
* (NEW) Can now show the whole week, weekend or weekdays as an option.
...
== Changelog ==
==1.8.1==
* (CRITICAL) Fixed a bug that was causing the plugin to fail and mess up any page in use. This has been fixed and tested. You may need to re-enter your timezone again. Sorry for the inconvenience.

==1.8.0==
* Added the ability to show the whole week, weekend or weekdays as an option.
* Cleaned up code and improve accessibility.

= 1.7.1 =
* Code cleanup and instruction readability improvements.
