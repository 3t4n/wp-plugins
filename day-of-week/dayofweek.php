...
Copyright 2023 Peachy Software LLC (email : support@peachysoftware.com)
...
function bwdow_options_page_html() {
	...
	<div class="wrap">
		...
		<form action="options.php" method="post">
			...
			$bwdow_settings      = array(
				'media_buttons' => true,
				'textarea_name' => 'bwdow_options[monday]',
				'textarea_rows' => '10',
				'wpautop'       => false,
			);
			...
			<table>
				<tr>
					<td style="width: 200px; vertical-align: top"; ><img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/peach100.png?'; ?>" alt="Image showing Peachy Software logo"></td>
					<td>
						<p><b>Thank you for using Day Of Week.</b> If you find this plugin useful, please consider leaving a review. <a href="https://wordpress.org/support/plugin/day-of-week/reviews/#new-post" target="_blank">Leave a review</a></p>
						<h2>Instructions</h2>
						<ol>
							...
							<li>There are some options. You can show a specific day or a group of days. Example - <strong><em>[showday day="Mon"]</em></strong>. Please use the three letter abbreviation of the day. Tue Thu etc.</li>
							<li><strong>NEW </strong>We have added the ability to show content for the whole week, weekdays or the weekend. Example - <strong><em>[showday day="all"] [showday day="weekdays"] [showday day="weekend"]</em></strong>.</li>
							<li> Additionally, you can now show content for tomorrow (Or yesterday!) Example - <strong><em>[showday day="tomorrow"] [showday day="yesterday"]</em></strong>. You can use "tom" or "tomorrow"</li>
						</ol>
						...
						<p>Offering multiple entries, the ability to use specific posts or pages and premium support. <strong>NEW</strong> Now including Elementor support.</p>
            ...
            <table>
                <tr>
                    <td><h3>Form Options</h3></td>
                    <td></td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 250px"><b>Time Zone</b></td>
                    <td>
                        ...
                        <select name="bwdow_options[timezone]" id="bwdow_options[timezone]">
                            <?php
                ...
                <tr>
                    <td style="vertical-align: top"><b>Allow Nested Shortcodes</b></td>
                    <td>
                        <p><select name="bwdow_options[filter]" id="bwdow_options[filter]">
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowmonday">Monday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowtuesday" class="dow_label">Tuesday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowwednesday">Wednesday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowthursday">Thursday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowfriday">Friday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowsaturday">Saturday</label></div>
			...
			<div class="dow_day">
				<div class="dow_label"><label for="bwdowsunday">Sunday</label></div>
...
function showDayShows( $bwdow_att ) {
    ...
    if ( isset( $bwdow_options['timezone'] ) ) {
	    if ( '' !== $bwdow_options['timezone'] ) {
		    $bwdow_sz_timezone = new DateTimeZone( $bwdow_options['timezone'] );
	    } else {
		    $bwdow_sz_timezone = new DateTimeZone( 'America/New_York' );
	    }
    } else {
        $bwdow_sz_timezone = new DateTimeZone( 'UTC' );
    }
	...
	if ( $bwdow_day ) {
		switch ( $bwdow_day ) {
			...
			case 'sat':
				...
				break;
			case 'all':
				$bwdow = $bwdow_options['monday'] . '<br/>' . $bwdow_options['tuesday'] . '<br/>' . $bwdow_options['wednesday'] . '<br/>' . $bwdow_options['thursday'] . '<br/>' . $bwdow_options['friday'] . '<br/>' . $bwdow_options['saturday'] . '<br/>' . $bwdow_options['sunday'];
				break;
			case 'weekdays':
				$bwdow = $bwdow_options['monday'] . '<br/>' . $bwdow_options['tuesday'] . '<br/>' . $bwdow_options['wednesday'] . '<br/>' . $bwdow_options['thursday'] . '<br/>' . $bwdow_options['friday'];
				break;
			case 'weekend':
				$bwdow = $bwdow_options['saturday'] . '<br/>' . $bwdow_options['sunday'];
				break;

		}
	} else {
		$bwdow_date_time = new DateTime( 'now', $bwdow_sz_timezone );
		$bwdow_daycode   = $bwdow_date_time->format( 'w' );
		if ( $bwdow_alternate ) {
...
add_action(
	'widgets_init',
	function () {
		register_widget( 'dayOfWeek_Widget' );
	}
);
