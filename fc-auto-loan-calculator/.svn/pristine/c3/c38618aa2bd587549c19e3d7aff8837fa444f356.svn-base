...
if ($brand_name != '' && strtolower($add_link) == 'yes') {
	$title = $brand_name . "<br>" . __('Auto Loan Calculator', 'fc-auto-loan-calculator');
} else {
	$title = __('Auto Loan Calculator', 'fc-auto-loan-calculator');
}

// rather than using exclusively a CSS solution for setting size, PHP is used as well
// so that the text displayed can vary
if (strtolower($size) == 'tiny') {
?>

	<!-- Copyright 2016-2025 AccurateCalculators.com -->

	<div id="autoloan-wrap" class="ac-calc-wrap tiny">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="autoloan-plugin" class="accuratecalculators ac-calculator tiny" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#AUTOLOANPLUGIN">
			<meta itemprop="name" content="<?php _e('Auto Loan Calculator Plugin for WordPress', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This auto loan calculator plugin creates loan payment schedules with dates.', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_AUTOLOAN_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_AUTOLOAN_DERIVATIVE_OF; ?>">
			<meta itemprop="downloadUrl" content="<?php echo FC_AUTOLOAN_DOWNLOAD_URL; ?>">
			<meta itemprop="softwareVersion" content="<?php echo FC_AUTOLOAN_VER; ?>">
			...
			<div class="calc-name">
				<?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://AccurateCalculators.com/auto-loan-calculator" target="_blank" data-bs-toggle="tooltip" data-bs-placement="right" title="' . esc_attr__('click for more features', 'fc-auto-loan-calculator') . '">' . $title . '</a>' : $title) ?>
			</div>

			<!-- start calculator inputs -->
			<label class="label" for="edPrice-al"><?php _e('Car Price?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPrice-al" maxlength="14" size="16" value=<?php echo $price ?>>

			<label class="label" for="edDwnPmt-al"><?php _e('Down Payment?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edDwnPmt-al" maxlength="14" size="16" value=<?php echo $dwn_pmt ?>>

			<label class="label" for="edPV-al"><?php _e('Loan Amount?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPV-al" maxlength="14" size="16" value=<?php echo $loan_amt ?>>

			<div class="msg"><?php _e('Enter a "0" (zero) for one unknown value above.', 'fc-auto-loan-calculator') ?></div>

			<label class="label" for="edNumPmts-al"><?php _e('Months?', 'fc-auto-loan-calculator') ?> (#):</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edNumPmts-al" maxlength="3" size="16" value=<?php echo $n_months ?>>

			<label class="label" for="edRate-al"><?php _e('Annual Interest Rate?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRate-al" maxlength="8" size="16" value=<?php echo $rate ?>>

			<label class="label<?php echo strtolower($hide_payment_method) == 'yes' ? ' ac-hidden' : ''; ?>" for="selPmtMthd-al"><?php _e('Payment Due?', 'fc-auto-loan-calculator') ?>:</label>
			<select id="selPmtMthd-al" class="calc-control<?php echo strtolower($hide_payment_method) == 'yes' ? ' ac-hidden' : ''; ?>">
				<option value="0" selected="selected"><?php _e('Period End', 'fc-auto-loan-calculator') ?></option>
				<option value="1"><?php _e('Period Start', 'fc-auto-loan-calculator') ?></option>
			</select>

			<hr class="bar" />

			<label class="label" for="edPmt-al"><?php _e('Monthly Payment', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPmt-al" maxlength="14" size="16" disabled>

			<label class="label" for="edDwnPmtPct-al"><?php _e('Down Payment Pct.', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edDwnPmtPct-al" maxlength="14" size="16" disabled>

			<label class="label" for="edInterest-al"><?php _e('Total Interest', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edInterest-al" maxlength="14" size="16" disabled>

			<label class="label" for="edTotalPI-al"><?php _e('Total P & I', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalPI-al" maxlength="14" size="16" disabled>

			<!-- end auto loan calculator -->
			...
			<div class="btn-group abbreviated">
				<div class="btn-row">
					<button type="button" id="btnCalc-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Calculate', 'fc-auto-loan-calculator') ?>"><?php _e('C', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnClear-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Clear', 'fc-auto-loan-calculator') ?>"><?php _e('Cl', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnPrint-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Print', 'fc-auto-loan-calculator') ?>"><?php _e('P', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnHelp-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Help', 'fc-auto-loan-calculator') ?>"><?php _e('H', 'fc-auto-loan-calculator') ?></button>
				</div>
				<div class="btn-row">
					<button type="button" id="btnSchedule-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Schedule', 'fc-auto-loan-calculator') ?>"><?php _e('S', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnCharts-al" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Charts', 'fc-auto-loan-calculator') ?>"><?php _e('Ch', 'fc-auto-loan-calculator') ?></button>
				</div>
			</div>
			...
			<div class="calc-footer">
				...
				<span id="CCY-al" class="localization<?php echo strtolower($hide_intl_conventions) == 'yes' ? ' ac-hidden' : ''; ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('click to change currency or date format', 'fc-auto-loan-calculator') ?>" role="button">$ : mm/dd/yyyy</span>
			</div>
		...
		<div id="zoomer-al" class="<?php echo $class; ?>">
			<span id="shrink-al" class="minus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="left" title="<?php esc_attr_e('Make me smaller.', 'fc-auto-loan-calculator') ?>"></span>
			<span id="original-al" class="cursor-pointer font-medium" role="button"><?php _e('Original Size', 'fc-auto-loan-calculator') ?></span>
			<span id="grow-al" class="plus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('Make me larger.', 'fc-auto-loan-calculator') ?>"></span>
		</div>
...
?>
	...
	<div id="autoloan-wrap" class="ac-calc-wrap small">
		<!--see CSS vars for min-width and max-width for each calculator size.-->
		<!--calculator-->
		<div id="autoloan-plugin" class="accuratecalculators ac-calculator small" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#AUTOLOANPLUGIN">
			<meta itemprop="name" content="<?php _e('Auto Loan Calculator Plugin for WordPress', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This auto loan calculator plugin creates loan payment schedules with dates.', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_AUTOLOAN_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_AUTOLOAN_DERIVATIVE_OF; ?>">
			...
			<label class="label" for="edRate-al"><?php _e('Interest Rate?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRate-al" maxlength="8" size="16" value=<?php echo $rate ?>>

			<label class="label<?php echo strtolower($hide_payment_method) == 'yes' ? ' ac-hidden' : ''; ?>" for="selPmtMthd-al"><?php _e('Payment Method?', 'fc-auto-loan-calculator') ?>:</label>

			<select id="selPmtMthd-al" class="calc-control<?php echo strtolower($hide_payment_method) == 'yes' ? ' ac-hidden' : ''; ?>">
				<option value="0" selected="selected"><?php _e('End-of-Period', 'fc-auto-loan-calculator') ?></option>
				<option value="1"><?php _e('Start-of-Period', 'fc-auto-loan-calculator') ?></option>
			</select>

			<hr class="bar" />

			<label class="label" for="edPmt-al"><?php _e('Payment Amount', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPmt-al" maxlength="14" size="16" disabled>
			...
			<div class="btn-group">
				<div class="btn-row">
					<button type="button" id="btnCalc-al" class="btn btn-primary btn-calculator"><?php _e('Calc', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnClear-al" class="btn btn-primary btn-calculator"><?php _e('Clear', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnPrint-al" class="btn btn-primary btn-calculator"><?php _e('Print', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnHelp-al" class="btn btn-primary btn-calculator"><?php _e('Help', 'fc-auto-loan-calculator') ?></button>
				</div>
				<div class="btn-row">
					<button type="button" id="btnSchedule-al" class="btn btn-primary btn-calculator"><?php _e('Schedule', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnCharts-al" class="btn btn-primary btn-calculator"><?php _e('Charts', 'fc-auto-loan-calculator') ?></button>
				</div>
			</div>
...
?>
	...
	<div id="autoloan-wrap" class="ac-calc-wrap medium">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="autoloan-plugin" class="accuratecalculators ac-calculator medium grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#AUTOLOANPLUGIN">
			<meta itemprop="name" content="<?php _e('Auto Loan Calculator Plugin for WordPress', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This auto loan calculator plugin creates loan payment schedules with dates.', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_AUTOLOAN_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_AUTOLOAN_DERIVATIVE_OF; ?>">
			...
			<label class="label" for="edNumPmts-al"><?php _e('Number of Months?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edNumPmts-al" maxlength="3" size="16" value=<?php echo $n_months ?>>

			<label class="label" for="edRate-al"><?php _e('Annual Rate?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRate-al" maxlength="8" size="16" value=<?php echo $rate ?>>
...
?>
	...
	<div id="autoloan-wrap" class="ac-calc-wrap large">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="autoloan-plugin" class="accuratecalculators ac-calculator large grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#AUTOLOANPLUGIN">
			<meta itemprop="name" content="<?php _e('Auto Loan Calculator Plugin for WordPress', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This auto loan calculator plugin creates loan payment schedules with dates.', 'fc-auto-loan-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_AUTOLOAN_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_AUTOLOAN_DERIVATIVE_OF; ?>">
			...
			<label class="label" for="edDwnPmt-al"><?php _e('Down Payment Amount?', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edDwnPmt-al" maxlength="14" size="16" value=<?php echo $dwn_pmt ?>>
			...
			<label class="label" for="edDwnPmtPct-al"><?php _e('Down Payment Percentage', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edDwnPmtPct-al" maxlength="14" size="16" disabled>

			<label class="label" for="edInterest-al"><?php _e('Total Interest', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edInterest-al" maxlength="14" size="16" disabled>

			<label class="label" for="edTotalPI-al"><?php _e('Total Principal & Interest', 'fc-auto-loan-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalPI-al" maxlength="14" size="16" disabled>
			...
			<div class="btn-group">
				...
				<div class="btn-row">
					<button type="button" id="btnSchedule-al" class="btn btn-primary btn-calculator"><?php _e('Payment Schedule', 'fc-auto-loan-calculator') ?></button>
					<button type="button" id="btnCharts-al" class="btn btn-primary btn-calculator"><?php _e('Charts', 'fc-auto-loan-calculator') ?></button>
				</div>
			</div>
			...
			<div class="modal-content ac-modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">
						<?php _e('Currency and Date Conventions', 'fc-auto-loan-calculator') ?>
					</h4>
				...
				<div class="modal-body">
					...
					?>
						...
						<div class="msg mb-6">
							<?php _e('The calculator will remember your choice. You may also change it at any time.', 'fc-auto-loan-calculator') ?>
						</div>
						<div class="msg">
							<?php _e('Clicking "Save changes" will cause the calculator to reload. Your edits will be lost.', 'fc-auto-loan-calculator') ?>
						</div>
					<?php
					}
					?>
				...
				<div class="modal-footer">
					<button id="CURRENCYDATE_cancel" type="button" class="btn btn-default" data-bs-dismiss="modal"><?php _e('Cancel', 'fc-auto-loan-calculator') ?></button>
					<button id="CURRENCYDATE_save" type="button" class="btn btn-primary" data-bs-dismiss="modal"><?php _e('Save changes', 'fc-auto-loan-calculator') ?></button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="rpt-title" class="modal-title">
						<?php _e('Cash flow forecast...', 'fc-auto-loan-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
				...
				<div class="modal-footer">
					<button id="RPT_cancel" type="button" class="btn btn-primary btn-primary-inverse px-8 py-2" data-bs-dismiss="modal">
						<?php _e('Close', 'fc-auto-loan-calculator') ?>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="chart-title" class="modal-title">
						<?php _e('Charts', 'fc-auto-loan-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="hlp-title" class="modal-title">
						<?php _e('Help', 'fc-auto-loan-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="msg-title" class="modal-title">
						<?php _e('Message', 'fc-auto-loan-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
...
<!--end auto loan calculator plugin-->