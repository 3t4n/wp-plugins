...
Donate link: https://codecanyon.net/item/advance-wp-redirect/24178351
Tags: Redirection,301,seo,404,302,
Requires PHP: 7.0
...
>[Try the Demo]( https://codecanyon.net/item/advanced-wp-redirect/24178351 "Demo") | [Documents](http://docs.xfinitysoft.com/plugins/advanced-wp-redirect/
"Documents") | [Pro Version](https://codecanyon.net/user/xfinitysoftdotcom/portfolio "Pro Version") | [Facebook Page](https://www.facebook.com/xfinitysoft)
...
&#9658; [Getting Started](http://docs.xfinitysoft.com/plugins/advanced-wp-redirect/)

### Plugin Links

&#9658; [Project Page](https://xfinitysoft.com/)
&#9658; [Documentation](http://docs.xfinitysoft.com/plugins/advanced-wp-redirect/)
&#9658; [Pro Plugins link](https://codecanyon.net/user/xfinitysoftdotcom/portfolio)
&#9658; [Report Bugs/Issues](https://xfinitysoft.com/contact-us/)

== Installation ==

1. Unzip the download package
1. Upload `WP Post Redirection` to the `/wp-content/plugins/` directory
