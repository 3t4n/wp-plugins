					...
					$.ajax(
						{
							...
							success: function (result) {
								...
								if (result !== '' && result !== 'undefined' ) {
									...
									jQuery( '#oneto_page_editor' ).val( content );
									WPEditorWidget.setEditorContent( 'oneto_page_editor' );
									...
									if (result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined') {
										...
										var html = '<label for="oneto_feature_thumbnail-button">' +
										...
										'<button type="button" class="button upload-button control-focus" id="oneto_feature_thumbnail-button">Change Image</button> ' +
