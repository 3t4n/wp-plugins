			...
			if ( REVIVESO_Admin::is_reviveso_admin_page() ) {
				...
				<div aria-live='assertive' class='notice pointer-events-none fixed inset-0 flex items-start px-4 py-6 sm:items-start sm:p-6 mt-6'>
					<div class='flex w-full flex-col items-end space-y-4 z-10'>
						<div class='pointer-events-auto flex w-full max-w-lg divide-x divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5'>
							...
							<div class='flex'>
								<div class='flex flex-col divide-y divide-gray-200'>
									<div class='flex h-0 flex-1'>
										<a href="<?php echo esc_url( $fix_url ); ?>" class='flex w-full items-center justify-center rounded-none rounded-br-lg border border-transparent px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500'><strong><?php esc_html_e( 'Fix Permalink Structure', 'revive-so' ); ?></strong></a>
									</div>
									<div class='flex h-0 flex-1'>
										<a href="<?php echo esc_url( $hide ); ?>" class='flex w-full items-center justify-center rounded-none rounded-br-lg border border-transparent px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500'><strong><?php esc_html_e( 'Dismiss Notice', 'revive-so' ); ?></strong></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="notice notice-warning">
					...
					<p style="margin-bottom: 10px;">
						<a href="<?php
						echo esc_url( $fix_url ); ?>" class="button button-secondary"><strong><?php
								esc_html_e( 'Fix Permalink Structure', 'revive-so' ); ?></strong></a>&nbsp;&nbsp;
						<a href="<?php
						echo esc_url( $hide ); ?>"><strong><?php
								esc_html_e( 'Dismiss Notice', 'revive-so' ); ?></strong></a>
					</p>
				</div> <?php
			}
		}
