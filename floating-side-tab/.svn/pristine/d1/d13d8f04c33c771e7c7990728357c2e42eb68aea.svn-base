...
(function (root, factory) {
    ...
    UniversalIconPicker.prototype = {
        ...
        _loadIconLibraries: async function (i = 0) {
            ...
            let icon_url_array = iconPickerUrl.split('js');
            let icon_url = icon_url_array[0];
            ...
            if (iconLibUrl.includes('/')) {
                ...
                iconLibUrl = icon_url + '/icons-libraries/' + iconLibUrl;
                iconLib = iconLibUrl;
            }
        ...
        _sideBarListMarkup: function (sideBarList) {
            ...
            sideBarList.forEach((item) => {
                ...
                if ('all' !== item['library-id']) {
                    ...
                    let item_title_array = item['title'].split('/');
                    let item_title = item_title_array.pop();
                    markup += '<div class="uip-modal--sidebar-tab-item' + activeClazz + '" data-library-id="' + item['library-id'] + '">' + iconTag + item_title + '</div>';
                } else {
