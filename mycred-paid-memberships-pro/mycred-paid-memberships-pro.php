	...
	class myCred_paid_membership_pro {
		...
		**/
		...
		public function on_activation() {
		    ...
		    set_transient('myCred_pmp_activation_notice', true, 5);
		}
		...
		public function display_activation_notice() {
		    ...
		    if (get_transient('myCred_pmp_activation_notice')) {
		        echo '<div class="notice notice-error is-dismissible">';
		        echo wp_kses_post(
		            __('<p><strong>myCred Paid Memberships Pro</strong> is depreciating from here and it will not be updated from now on. You can access <strong>myCred </strong> along with all the future updates on the <strong>myCred Toolkit</strong>.</p>', 'myCred_pmp')
		        );
		        echo '</div>';

		        // Delete the transient to prevent repeated notices
		        delete_transient('myCred_pmp_activation_notice');
