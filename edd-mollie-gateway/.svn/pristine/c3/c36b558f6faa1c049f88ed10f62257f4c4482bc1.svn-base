...
return array(
    ...
    'EDD_Mollie_Helper' => $baseDir . '/includes/helper.php',
    'EDD_Mollie_Install' => $baseDir . '/includes/install.php',
    'EDD_Mollie_Main' => $baseDir . '/includes/main.php',
    'EDD_Mollie_Settings' => $baseDir . '/includes/abstracts/abstract-settings.php',
    ...
    'Mollie_EDD_Gateway_Abstract' => $baseDir . '/includes/gateways/abstract-gateway.php',
    'Mollie_EDD_Gateway_Bancontact' => $baseDir . '/includes/gateways/bancontact.php',
    'Mollie_EDD_Gateway_BankTransfer' => $baseDir . '/includes/gateways/banktransfer.php',
    'Mollie_EDD_Gateway_Belfius' => $baseDir . '/includes/gateways/belfius.php',
    'Mollie_EDD_Gateway_Creditcard' => $baseDir . '/includes/gateways/creditcard.php',
    'Mollie_EDD_Gateway_DirectDebit' => $baseDir . '/includes/gateways/directdebit.php',
    'Mollie_EDD_Gateway_Eps' => $baseDir . '/includes/gateways/eps.php',
    'Mollie_EDD_Gateway_Giftcard' => $baseDir . '/includes/gateways/giftcard.php',
    'Mollie_EDD_Gateway_Giropay' => $baseDir . '/includes/gateways/giropay.php',
    'Mollie_EDD_Gateway_Ideal' => $baseDir . '/includes/gateways/ideal.php',
    'Mollie_EDD_Gateway_IngHomePay' => $baseDir . '/includes/gateways/inghomepay.php',
    'Mollie_EDD_Gateway_Kbc' => $baseDir . '/includes/gateways/kbc.php',
    'Mollie_EDD_Gateway_Mollie_Abstract' => $baseDir . '/includes/gateways/abstract-mollie.php',
    'Mollie_EDD_Gateway_MyBank' => $baseDir . '/includes/gateways/mybank.php',
    'Mollie_EDD_Gateway_PayPal' => $baseDir . '/includes/gateways/paypal.php',
    'Mollie_EDD_Gateway_Paysafecard' => $baseDir . '/includes/gateways/paysafecard.php',
    'Mollie_EDD_Gateway_Przelewy24' => $baseDir . '/includes/gateways/przelewy24.php',
    'Mollie_EDD_Gateway_Sofort' => $baseDir . '/includes/gateways/sofort.php',
    'Mollie_EDD_Helper_Api' => $baseDir . '/includes/helper/api.php',
    'Mollie_EDD_Helper_Data' => $baseDir . '/includes/helper/data.php',
    'Mollie_EDD_Helper_Settings' => $baseDir . '/includes/helper/settings.php',
    'Mollie_EDD_Helper_Url' => $baseDir . '/includes/helper/url.php',
    'Mollie_EDD_Settings_General' => $baseDir . '/includes/admin/settings-general.php',
