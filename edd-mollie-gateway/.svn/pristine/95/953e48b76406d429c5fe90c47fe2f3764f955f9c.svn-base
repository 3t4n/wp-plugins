...
class ComposerStaticInita795cfbb3710c9a7d30b28f5637b3896
{
    ...
    public static $classMap = array (
        ...
        'EDD_Mollie_Helper' => __DIR__ . '/../..' . '/includes/helper.php',
        'EDD_Mollie_Install' => __DIR__ . '/../..' . '/includes/install.php',
        'EDD_Mollie_Main' => __DIR__ . '/../..' . '/includes/main.php',
        'EDD_Mollie_Settings' => __DIR__ . '/../..' . '/includes/abstracts/abstract-settings.php',
        ...
        'Mollie_EDD_Gateway_Abstract' => __DIR__ . '/../..' . '/includes/gateways/abstract-gateway.php',
        'Mollie_EDD_Gateway_Bancontact' => __DIR__ . '/../..' . '/includes/gateways/bancontact.php',
        'Mollie_EDD_Gateway_BankTransfer' => __DIR__ . '/../..' . '/includes/gateways/banktransfer.php',
        'Mollie_EDD_Gateway_Belfius' => __DIR__ . '/../..' . '/includes/gateways/belfius.php',
        'Mollie_EDD_Gateway_Creditcard' => __DIR__ . '/../..' . '/includes/gateways/creditcard.php',
        'Mollie_EDD_Gateway_DirectDebit' => __DIR__ . '/../..' . '/includes/gateways/directdebit.php',
        'Mollie_EDD_Gateway_Eps' => __DIR__ . '/../..' . '/includes/gateways/eps.php',
        'Mollie_EDD_Gateway_Giftcard' => __DIR__ . '/../..' . '/includes/gateways/giftcard.php',
        'Mollie_EDD_Gateway_Giropay' => __DIR__ . '/../..' . '/includes/gateways/giropay.php',
        'Mollie_EDD_Gateway_Ideal' => __DIR__ . '/../..' . '/includes/gateways/ideal.php',
        'Mollie_EDD_Gateway_IngHomePay' => __DIR__ . '/../..' . '/includes/gateways/inghomepay.php',
        'Mollie_EDD_Gateway_Kbc' => __DIR__ . '/../..' . '/includes/gateways/kbc.php',
        'Mollie_EDD_Gateway_Mollie_Abstract' => __DIR__ . '/../..' . '/includes/gateways/abstract-mollie.php',
        'Mollie_EDD_Gateway_MyBank' => __DIR__ . '/../..' . '/includes/gateways/mybank.php',
        'Mollie_EDD_Gateway_PayPal' => __DIR__ . '/../..' . '/includes/gateways/paypal.php',
        'Mollie_EDD_Gateway_Paysafecard' => __DIR__ . '/../..' . '/includes/gateways/paysafecard.php',
        'Mollie_EDD_Gateway_Przelewy24' => __DIR__ . '/../..' . '/includes/gateways/przelewy24.php',
        'Mollie_EDD_Gateway_Sofort' => __DIR__ . '/../..' . '/includes/gateways/sofort.php',
        'Mollie_EDD_Helper_Api' => __DIR__ . '/../..' . '/includes/helper/api.php',
        'Mollie_EDD_Helper_Data' => __DIR__ . '/../..' . '/includes/helper/data.php',
        'Mollie_EDD_Helper_Settings' => __DIR__ . '/../..' . '/includes/helper/settings.php',
        'Mollie_EDD_Helper_Url' => __DIR__ . '/../..' . '/includes/helper/url.php',
        'Mollie_EDD_Settings_General' => __DIR__ . '/../..' . '/includes/admin/settings-general.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInita795cfbb3710c9a7d30b28f5637b3896::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInita795cfbb3710c9a7d30b28f5637b3896::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInita795cfbb3710c9a7d30b28f5637b3896::$classMap;
