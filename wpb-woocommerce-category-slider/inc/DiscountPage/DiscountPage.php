...
class WPBean_WC_Categories_Slider_DiscountPage
{
	...
	public $args = array(
		...
		'parent_slug' 			=> 'wpb-woocommerce-category-slider-about',   // for submenu only.
		'capability'  			=> 'manage_options',
		'position'    			=> 9,
		'utm_source'    		=> 'WCCategoriesSliderFreeVersion',
		'notice_exception'  	=> 'woo-cat-slider_page_wpbean-discount',
		'notice_dismiss_key' 	=> 'wpbean_wc_categories_slider_pro_discount_dismiss',
		'notice_action' 		=> 'wpbean_wc_categories_slider_discount_admin_notice_dismissed',
		'notice_meta_key' 		=> 'wpbean_wc_categories_slider_pro_discount_dismissed',
	);
