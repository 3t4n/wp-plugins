...
class class_testimonial_settings
{
	...
	public function testimonial_menu_init()
	{
		...
		add_submenu_page('edit.php?post_type=testimonial', __('testimonial Builder', 'testimonial'), __('Builder', 'testimonial'), 'manage_options', 'testimonial-builder', array($this, 'builder'));
	}
