...
?>
        ...
        <?php
            ...
            echo wp_kses_post(sprintf($field_template, $title, $input_html, $group_details));
        }
        ...
        ?>
            ...
            field-media-wrapper-<?php echo esc_attr($css_id); ?>">
                ...
                <div class="media-upload button" id="media_upload_<?php echo esc_attr($css_id); ?>"><?php echo __('Upload', $this->textdomain); ?></div>
                <div class="clear button" id="media_clear_<?php echo esc_attr($css_id); ?>"><?php echo __('Clear', 'testimonial'); ?></div>
                <div class="error-mgs"></div>
            </div>
        ...
        ?>
            <div class="item-wrap collapsible">
                <div class="header">
                    <span class="remove" onclick="confirm('Are you')">
                        <?php echo wp_kses_post($remove_text); ?>
                    </span>
                    <?php
                    if ($sortable) :
                    ?>
            ...
            field-repeatable-wrapper-<?php echo esc_attr($css_id); ?>">
                <div add_html="<?php echo esc_attr($fieldHtml); ?>" class="add-repeat-field"><i class="far fa-plus-square"></i> <?php _e('Add', 'testimonial'); ?></div>
                    ...
                    ?>
                            <div class="item-wrap <?php if ($collapsible) echo 'collapsible'; ?>" index="<?php echo esc_attr($index); ?>">
                                <?php if ($collapsible) : ?>
                                    <div class="header">
                                    <?php endif; ?>
                                    <span class="remove" onclick="confirm('Are you sure?') ? jQuery(this).parent().parent().remove() :  '';"><?php echo wp_kses_post($remove_text); ?></span>
                                    <?php if ($sortable) : ?>
                                        <span class="sort"><i class="fas fa-arrows-alt"></i></span>
                                    <?php endif; ?>
...
<?php
        ...
        public function field_custom_html($option)
        {
            ...
            echo wp_kses_post(sprintf($field_template, $title, $html, $details));
        }
    }
}
