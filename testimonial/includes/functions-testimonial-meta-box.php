...
?>
        <pre><?php //echo var_export($testimonial_options, true); 
                ?></pre>
        <?php
...
if (!function_exists('testimonial_meta_tabs_content_shortcode')) {
    ...
    ?>
        <div class="section">
            ...
            <div class="copy-to-clipboard">
                <textarea cols="50" rows="2" style="background:#bfefff" onClick="this.select();"><?php echo '<?php echo do_shortcode("[testimonial id=';
            ...
            <div class="copy-to-clipboard">
                <textarea cols="50" rows="2" style="background:#bfefff" onClick="this.select();"><?php echo '<?php echo do_shortcode("[testimonial_form id=';
                                                                                                    echo "'" . esc_attr($post_id) . "']";
                                                                                                    echo '"); ?>'; ?></textarea> <span class="copied">Copied</span>
                <p class="description">PHP Code, you can use under theme .php files.</p>
            </div>
