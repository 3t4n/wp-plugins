...
final class AdminPages
{
    ...
    private function setPages()
    {
        ...
        add_submenu_page(
            ...
            _x('Add new', 'Customize Changeset', 'admin-options-pages'),
            MenuPage::CAPABILITY,
            SubpageCreate::SLUG,
            function () {
        ...
        add_submenu_page(
            ...
            __('Settings', 'admin-options-pages'),
            MenuPage::CAPABILITY,
    ...
    private function noticeAfterCreatePages()
    {
        ...
        add_action('admin_notices', function () {
            Notice::succes(__('Saved.', 'admin-options-pages'), true);
        });
    }
    ...
    private function noticeAfterDeletePages()
    {
        ...
        add_action('admin_notices', function () {
            $message = Session::get('pages_deleted_multiple') ? __('Pages deleted.', 'admin-options-pages') : __('Page deleted.', 'admin-options-pages');
