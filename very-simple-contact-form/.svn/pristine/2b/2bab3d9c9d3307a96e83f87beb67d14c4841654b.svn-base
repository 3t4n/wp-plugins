...
function vscf_admin_init() {
	...
	add_settings_field( 'vscf-field-40', esc_attr__( 'Time trap', 'very-simple-contact-form' ), 'vscf_field_callback_40', 'vscf-spam', 'vscf-spam-section' );
...
function vscf_field_callback_1() {
	...
	<label><input type='checkbox' name='vscf-setting-1' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Do not delete form submissions and settings when uninstalling plugin.', 'very-simple-contact-form' ); ?></label>
	<?php
}
...
function vscf_field_callback_22() {
	...
	<p><?php esc_attr_e( 'Form submissions can be sent to a maximum of 5 email addresses.', 'very-simple-contact-form' ); ?></p>
	<p><?php esc_attr_e( 'Use a comma to separate multiple email addresses.', 'very-simple-contact-form' ); ?></p>
	<?php
}
...
function vscf_field_callback_37() {
	...
	<p><?php esc_attr_e( 'Email addresses are not allowed.', 'very-simple-contact-form' ); ?></p>
	<?php
}
