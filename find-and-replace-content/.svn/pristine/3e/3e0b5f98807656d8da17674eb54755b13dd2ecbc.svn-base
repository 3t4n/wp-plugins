...
Plugin Name: Find And Replace content
...
Contributors: jankimoradiya, priyankabehera155, darshan02
Tags: find, replace, findandreplace, find and replace, find & replace
Stable tag: 1.0.0
Requires at least: 3.8
Tested up to: 4.7
Donate link: https://about.me/jankimoradiya
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html


This plugin is use for content replacement in easy way by finding it in posts and pages and replace it.
