  ...
  <ContentWrapper>
    <section class="trafft-add-booking-form-section">
      <div class="trafft-add-booking-form-section__item">
        <component :is="$grid.desktop ? 'h1' : 'h2'">
        ...
        <div class="trafft-add-booking-form-section__item__form tr-mb-24">
          <div class="trafft-add-booking-form-section__item__form__label">
            ...
            <div class="flex-align-center">
              <adm-input
                class="trafft-add-booking-form-section__item__form__input"
                v-model="tenantName"
                name="trafft_option[tenantName]"
                id="tenantName"
              >
              </adm-input>
              <div class="trafft-add-booking-form-section__item__form__domain">
                <adm-select v-model="domain">
                  <adm-select-option label=".trafft.com" value=".trafft.com" />
                  <adm-select-option label=".wlbookings.com" value=".wlbookings.com" />
                </adm-select>
              </div>
            </div>
      ...
      <div class="trafft-add-booking-form-section__item">
        <img class="trafft-add-booking-form-section__item__desktop" :src="`${$trafft_img_url}/illustrations/illustration_1.jpg`" alt="" />
        <img class="trafft-add-booking-form-section__item__tablet" :src="`${$trafft_img_url}/illustrations/illustration_1_medium.jpg`" alt="" />
      </div>
    </section>
  </ContentWrapper>
</template>
...
const getOptions = () => {
  ...
  fetch(trafft_plugin.ajax_url, {
    ...
    response.json().then(data => {
      ...
      domain.value = data.tenantDomain
    })
  }).catch((error) => {
    console.error(error)
  })
...
const setOptions = () => {
  ...
  data.append('tenantDomain', domain.value)
