...
You can use this feature to create resources like equipment, rooms, or other limited items and assign them to services, employees, or specific locations.
...
v1.0.9
* Enable support for white-label domains in the plugin.

v1.0.8
* Added a 'Configure' link to enhance accessibility in the plugin list.

v1.0.7
* Fixed the issue identified in "Booking System Trafft <= 1.0.5 - Authenticated (Contributor+) Stored Cross-Site Scripting (CVE-2024-11754)" has been fixed, with thanks to the vulnerability researcher SOPROBRO from Wordfence for their responsible disclosure.

v1.0.6
* Compatibility with WordPress 6.7.1 version approved
* Other small bug fixes and stability improvements
* New features - Booking with Resources, Recurring SMS Plan
