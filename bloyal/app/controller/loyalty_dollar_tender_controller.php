		...
		class Bloyal_Loyalty_Dollar_Gateway extends WC_Payment_Gateway {
			...
			public function payment_fields() {
				...
				<fieldset>
					...
					<div id="custom_input">
						<label id="loyaltyDollarConfMessage" value="" style="color:green;"></label>
								...
								if (responseData != null && responseData != '') {
									...
									if (payment != null) {
										...
										$(document).ajaxComplete(function() {
											...
											$("#loading_resubmit").css("display", "none");
										});
										...
										if(is_logged_in_user === true) {
											...
											$('#check_loyalty_balance').click(function() {
													...
													$('#apply_loyalty_balance').click(function() {
														...
														if(response_obj.status == 'success'){
															...
															$("#loyaltyDollarConfMessage").text('Loyalty Dollar has been applied successfully.');
															$("#loyaltyDollarConfMessage").fadeOut(5000);
														}else {
														}
														$("#loyaltyDollarMessage").text(response_obj.message);
											...
											window.location = websiteDomain+"/wpbloyal"+"/my-account?ReturnUrl="+websiteDomain+"/checkout/"; // we have added this code becuase below code is not working in localhost
											
											// window.location = websiteDomain+"/wpbloyal"+"/my-account?ReturnUrl="+websiteDomain+"/checkout/";
										}
									}    
								}
								//jQuery(document.body).trigger("update_checkout");
