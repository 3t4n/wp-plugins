			...
			if ( ! empty( $response ) ) {
				...
				if ( $post_url ) {
					...
					if ( is_wp_error( $result ) ) {
						...
						update_option( 'bloyal_' . $action, wp_json_encode( $result ) );
						return $result;
					}
				}
			}
		...
		function bloyal_render_config_submenu_page() {
			...
			<html>
				<body class="key-body" id="key-body">
					...
					<!-- making bLoyal download snippets log functionality start-->
					<table class="config-table">
					<tr id="log_download">
							<td>
								<span>Click here </span>
								<a href="#" id="snipeets_download">to download bLoyal Snippets log</a>
							</td>
						...
						<tr id="log_download">
							<td>
								<span>Click here </span>
								<a href="#" id="snipeets_remove">to clean bLoyal Snippets log</a>
							</td>
						</tr>
					</table>
					<!-- making bLoyal download snippets log functionality start-->
