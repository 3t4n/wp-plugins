...
ob_end_clean();
$activation_redirect_wizard = isset(get_option('cmf_options')['cmf_footnoteAddWizardMenu']) ? get_option('cmf_options')['cmf_footnoteAddWizardMenu'] : true;
$cminds_plugin_config = array(
    ...
    'plugin-affiliate'              => '',
    'plugin-redirect-after-install' => $activation_redirect_wizard ? admin_url( 'admin.php?page=cmf_setup_wizard' ) : admin_url('admin.php?page=cmf_settings'),
