 ...
 * Defining constants
 */
if( ! defined( 'GSPORTFOLIO_VERSION' ) ) define( 'GSPORTFOLIO_VERSION', '1.6.4' );
...
function appsero_init_tracker_gs_portfolio() {
    ...
    if ( ! class_exists( 'GSPortfolioAppSero\Insights' ) ) {
        require_once GSPORTFOLIO_FILES_DIR . '/appsero/Client.php';
    }

    $client = new GSPortfolioAppSero\Client( '714ad138-6b90-4549-bc3c-e8d66d5338e4', 'GS Portfolio', __FILE__  );
