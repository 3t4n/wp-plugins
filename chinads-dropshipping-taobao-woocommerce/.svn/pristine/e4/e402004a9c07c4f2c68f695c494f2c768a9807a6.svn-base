...
class Settings {
	...
	public function video_guide() {
        ...
        <p>
            <a href="https://downloads.villatheme.com/?download=chinads-extension" target="_blank">
                <?php printf( esc_html__( 'Add %1s Extension', 'chinads-woocommerce-taobao-dropshipping' ), wp_kses_post(  TBDS_CONST['plugin_name'] ) ); //phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment ?>
            </a>
        </p>
        <div class="vi-ui fluid styled accordion vichinads-video-guide-wrap">
            <div class="title active">
                <i class="dropdown icon"></i>
                <?php esc_html_e( 'Register account', 'chinads-woocommerce-taobao-dropshipping' ); ?>
            </div>
            <div class="content active">
                <iframe width="560" height="315" allowfullscreen
                        src="https://www.youtube-nocookie.com/embed/kO9KxF4DNXE" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
            <div class="title">
                <i class="dropdown icon"></i>
                <?php esc_html_e( 'Install and use', 'chinads-woocommerce-taobao-dropshipping' ); ?>
            </div>
            <div class="content">
                <iframe width="560" height="315" allowfullscreen
                        src="https://www.youtube-nocookie.com/embed/weZk4kWoPhw" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
        </div>
		<?php
	...
	public function override_options() {
		return [
			...
			[
				'title'   => esc_html__( 'Link existing variations only', 'chinads' ),
				'type'    => 'pro_version',
				'desc'    => esc_html__( 'Do not create new variations even if the number of variations you select when overriding/reimporting a product is greater than the number of variations of target product.', 'chinads' )
			],
            [
