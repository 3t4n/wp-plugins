...
Tags: woocommerce, taobao, dropship, taobaodropship, taobao dropshiping
Requires PHP: 7.0
...
**Why should you choose Tmall – Taobao Dropshipping?**
...
>[Try the Demo](https://new2new.com/?item=chinads "Demo ChinaDS – Taobao Dropshipping for WooCommerce") | [Documents](https://docs.villatheme.com/chinads-taobao-dropshipping-for-woocommerce "Documents") | [Pro Version](https://1.envato.market/PyAWE6 "Premium Version") | [Download extension](https://downloads.villatheme.com/?download=chinads-extension "Download extension") | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")

Register account guide
[youtube https://www.youtube.com/watch?v=kO9KxF4DNXE]

Install and use
[youtube https://www.youtube.com/watch?v=V0WyiJnx8IQ]
...
[GET PRO VERSION](https://1.envato.market/PyAWE6) or [http://codecanyon.net/item/chinads-woocommerce-taobao-dropshipping/48291170](https://1.envato.market/PyAWE6)
...
&#9658; [Getting Started](https://docs.villatheme.com/?item=chinads-taobao-dropshipping-for-woocommerce)

### Plugin Links

&#9658; [Project Page](https://villatheme.com)
&#9658; [Documentation](https://docs.villatheme.com/chinads-taobao-dropshipping-for-woocommerce)
&#9658; [Report Bugs/Issues](https://villatheme.com/knowledge-base/security-is-our-priority/)

== Installation ==

1. Unzip the download package
1. Upload `chinads-taobao-dropshipping-for-woocommerce` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress

== Frequently Asked Questions ==

== Screenshots ==
1. Button import on taobao.com,tmall.com
2. Connection between your WooCommerce Store and taobao
3. List taobao products, tmall products are waitting for import
4. List taobao products, tmall products are imported to WooCommerce
...
/**2.0.7 - 2024.11.28**/
– Updated: Compatible with WC 9.4.3
– Updated: Update support class
