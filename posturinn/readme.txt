...
= 1.3.4 =
adding support for new changes in the API

= 1.3.3 =
escaping variables for administrators

= 1.3.2 =
added get_homeurl function
fix for http_host errors
fix for initial load
fix for phone number field in create shipment ui
update endpoints
improved bulk printing functionality
