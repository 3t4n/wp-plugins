...
class POSTIS_Admin {
    ...
    */
    function shipment_options() {
        ...
        // Get saved shipping method and postbox using HPOS methods
        $saved_shipping_method = $wc_order->get_meta('postis_shipping_method');
        $saved_postbox = str_replace('DPO', '', $wc_order->get_meta('postis_dpo_postbox'));
        $saved_postbox = str_replace('DNO', '', $saved_postbox);
        $saved_phone = $wc_order->get_meta('postis_dpo_phonenumber');
        ...
        // Get shipping details using HPOS methods
