...
== Changelog ==
= 1.0.24 =
* Security Fix: Only allow settings import file to change Agency Toolkit settings and not other WordPress settings.
* Bug Fix: Avoid a PHP warning by checking for an .htaccess file before attempting to read it.

= 1.0.23 =
* Confirmed: Compatibility with WordPress 6.7.

= 1.0.22 =
* Bug Fix: Bug Fix: Fixed an issue where admin emails were still being sent to administrators, despite the option being disabled, on sites with WooCommerce installed.
