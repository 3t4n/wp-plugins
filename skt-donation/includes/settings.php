...
if ( ! function_exists ( 'skt_donation_settings_page' ) ) {
  ...
  ?>
    ...
    <?php } 
        ...
        $mesg_one = gmdate('d-m-Y', strtotime($installation_plugin_date .'+362 day'));
        $mesg_two = gmdate('d-m-Y', strtotime($installation_plugin_date .'+363 day'));
        $mesg_three = gmdate('d-m-Y', strtotime($installation_plugin_date .'+364 day'));
