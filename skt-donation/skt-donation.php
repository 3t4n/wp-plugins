...
Description: SKT Donation plugin for accepting donations for NGO, non profit, charity, charitable organizations, crowdfunding, fundraisers via payment gateways PayPal across the world.
Version: 2.1 
Author: SKT Themes
...
function skt_donation_install()
{
	...
	if ( get_option('skt_donation_installation_date') == '') {
		update_option('skt_donation_installation_date', gmdate('d-m-Y'));
	}
	//PayPalForm Empty
	...
	if($sql_skt_country_type_currency){
		$insert_query = $wpdb->query("INSERT INTO $skt_country_type_currency (id, currency_stripe, type_mode, currency_sign) VALUES (138, 'BRL', 'paypal', '&#82;&#36;'),(139, 'AUD', 'paypal', '&#36;'),(140, 'CZK', 'paypal', '&#75;&#269;'),(141, 'DKK', 'paypal', '&#107;&#114;'),(142, 'EUR', 'paypal', '&#8364;'),(143, 'HKD', 'paypal', '&#36;'),(144, 'HUF', 'paypal', ' &#70;&#116;'),(145, 'INR', 'paypal', '&#8377;'),(146, 'ILS', 'paypal', '&#8362;'),(147, 'JPY', 'paypal', '&#165;'),(148, 'MYR', 'paypal', '&#82;&#77;'),(149, 'MXN', 'paypal', '&#36;'),(150, 'NOK', 'paypal', '&#107;&#114;'),(151, 'NZD', 'paypal', ' &#36;'),(152, 'PHP', 'paypal', '&#8369;'),(153, 'PLN', 'paypal', '&#122;&#322;'),(154, 'GBP', 'paypal', '-'),(155, 'RUB', 'paypal', '&#1088;&#1091;&#1073;'),(156, 'SGD', 'paypal', '&#36;'),(157, 'SEK', 'paypal', '&#107;&#114;'),(158, 'CHF', 'paypal', '&#67;&#72;&#70;'),(159, 'TWD', 'paypal', '&#78;&#84;&#36;'),(160, 'THB', 'paypal', '&#3647;'),(161, 'USD', 'paypal', '&#36;');"); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
	}
}
...
function skt_donation_deactivation(){
    ...
    // clear the permalinks to remove our post type's rules
	    ...
	    $wpdb->query($sql_country_type); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.NotPrepared
    flush_rewrite_rules();
}
