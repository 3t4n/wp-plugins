...
! defined( 'WPCCB_VERSION' ) && define( 'WPCCB_VERSION', '1.1.8' );
...
! defined( 'WPCCB_DIR' ) && define( 'WPCCB_DIR', plugin_dir_path( __FILE__ ) );
	...
	function wpccb_init() {
		...
		if ( ! class_exists( 'WPCleverWpccb' ) ) {
			class WPCleverWpccb {
				...
				function init() {
					// load text-domain
					load_plugin_textdomain( 'wpc-copy-billing-address', false, basename( WPCCB_DIR ) . '/languages/' );
				}
