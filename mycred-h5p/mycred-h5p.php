...
if ( ! class_exists( 'myCRED_H5P_Core' ) ) :
	final class myCRED_H5P_Core {
		...
		public function on_activation() {
		    ...
		    set_transient('mycred_h5p_activation_notice', true, 5);
		}
		...
		public function display_activation_notice() {
		    ...
		    if (get_transient('mycred_h5p_activation_notice')) {
		        echo '<div class="notice notice-error is-dismissible">';
		        echo wp_kses_post(
		            __('<p><strong>myCred H5P</strong> is depreciating from here and it will not be updated from now on. You can access <strong>myCred H5P</strong> along with all the future updates on the <strong>myCred Toolkit</strong>.</p>', 'mycred_h5p')
		        );
		        echo '</div>';

		        // Delete the transient to prevent repeated notices
		        delete_transient('mycred_h5p_activation_notice');
