...
class Admin_Setup{
    ...
    public function admin_page_contents() {
		...
		<?php if( time() <= strtotime( '11:59:59pm December 31 2024') ):?>
		<div class="sep-offer" style="background: #5c905c;color: #fff;padding: 10px;border-radius: 4px;max-width: 500px;margin-right:12px;">
		    ...
		    <div style="font-size: 15px;margin-top: 10px;">For a limited time, till this December 31, enjoy 25% off on Pro upgrade.<br> Use discount code <b>DC25</b> at checkout to get 25% flat discount.</div>
		</div>
		<?php endif;?>
