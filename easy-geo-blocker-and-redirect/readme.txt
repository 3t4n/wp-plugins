=== WP Easy GEO Blocker and Redirect ===
Contributors: SiteGuarding
Donate link: https://www.siteguarding.com/en/buy-service/antivirus-site-protection
Tags: geo security, geo redirect, geolocation, redirect country, security, geo, geo block, geo protection, bots, attack, hack, hacker, hacking, protection, website security, malware, protect, spam, trackback, vulnerability, wp-admin, block country, ban, ban countries, ban country, blacklist
...
WP Easy GEO Blocker and Redirect is the security plugin to limit access from unwanted counties or IP addresses. 
