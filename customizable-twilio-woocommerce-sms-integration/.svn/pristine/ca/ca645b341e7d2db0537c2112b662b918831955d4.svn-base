<?php
/**
 * @package customizable_twilio_woocommerce_sms_integration
 * @version 1.2
 */
/*
Plugin Name: Customizable Twilio WooCommerce SMS Integration
Plugin URI: http://wordpress.org/plugins/customizable-twilio-woocommerce-sms-integration/
Description: This plugin sends SMS depending upon different order status of your WooCommwerce store. It can send SMS to both buyers and admin's phone numbers. It uses Twilio SMS API to send SMS.
Author: CodeSpeedy
Version: 1.1
Author URI: https://www.codespeedy.com/
*/
// Creating our function
require_once "inc/twilio_functions.php";
///////////////////////////////////////////
add_action("admin_menu", "cspd_sms_options");
function cspd_sms_options() {
	add_submenu_page(
        'woocommerce',
        'WooCommerce OTP And SMS by Codespeedy Settings',
        '<span style="color: #e27e81;">WC Twilio SMS</span>',
        'administrator',
        'cspd-wc-twilio-sms',
        'cspd_wc_sms_settings_page' );
}
add_action('admin_init', 'cspd_wc_sms_options');
function cspd_wc_sms_options() {
	register_setting('wc_sms_option_group', 'msg_api_key');
	register_setting('wc_sms_option_group', 'msg_token');
	register_setting('wc_sms_option_group', 'admin_phone_number');
	register_setting('wc_sms_option_group', 'sender_phone_no');
...
function cspd_wc_sms_settings_page() { ?>

<div class="wrap">
 <div class="container" style="margin: 0;padding: 0;"><h2 style="font-size: 1.9em;">Customizable Twilio WooCommerce SMS Integration</h2></div>
  ...
  <div class="navitems container" style="margin: 0;padding: 0;">
	...
	<input type="text" name="msg_token" class="form-control" value="<?php echo get_option('msg_token'); ?>">
	</div>
	
	<div class="form-group">
	<label>Admin phone number to get order notification (With country code like +91): </label>
	<input type="text" name="admin_phone_number" class="form-control" value="<?php echo get_option('admin_phone_number'); ?>">
	</div>
	
	<div class="form-group">
	<label>Sender Phone Number (Twilio Phone): </label>
	<input type="text" name="sender_phone_no" class="form-control" value="<?php echo get_option('sender_phone_no'); ?>"><br/>
	</div>
	</div>
	</div>
	...
	<strong style="color: red;">This feature is available on the <a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">pro version of this plugin</a>.</strong><br/>
	<strong><a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">Buy the pro version</a></strong>
	<hr>
	SMS To Admin: <br/>
	...
	<h4>Send SMS FOR Order Refund</h4>
	<strong style="color: red;">This feature is available on the <a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">pro version of this plugin</a>.</strong><br/>
	<strong><a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">Buy the pro version</a></strong>
	<hr>
	SMS Text To Admin For Order Refund: <br/>
	<textarea name="refunded_msgtxt_admin" rows="3" style="border:solid 1px #777;cursor: not-allowed;" disabled ><?php echo get_option('refunded_msgtxt_admin', 'Order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME has refunded.'); ?></textarea><br/><br/>
    SMS To Customer For Order Refunded: <br/>
	<textarea name="refunded_msgtxt_cust" rows="3" style="border:solid 1px #777;cursor: not-allowed;" disabled > <?php echo get_option('refunded_msgtxt_cust', 'Your order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME has refunded.'); ?></textarea><br/><br/>
	<input type="checkbox" name="refunded_sendadmin_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to admin on order Refund<br/><br/>
	<input type="checkbox" name="refunded_sendcust_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to customer on order Refund<br/><br/>
	</div>
	</div>
	...
	<h4>Send SMS FOR Order On Hold</h4>
	<strong style="color: red;">This feature is available on the <a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">pro version of this plugin</a>.</strong><br/>
	<strong><a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">Buy the pro version</a></strong>
	<hr>
	SMS Text To Admin For Order On Hold: <br/>
	<textarea name="hold_msgtxt_admin" rows="3" style="border:solid 1px #777;cursor: not-allowed;" disabled ><?php echo get_option('hold_msgtxt_admin', 'Order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME is on hold.'); ?></textarea><br/><br/>
    SMS To Customer For Order On Hold: <br/>
	<textarea name="hold_msgtxt_cust" rows="3" style="border:solid 1px #777;cursor: not-allowed;" disabled > <?php echo get_option('hold_msgtxt_cust', 'Your order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME is on hold.'); ?></textarea><br/><br/>
	<input type="checkbox" name="hold_sendadmin_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to admin on order on Hold<br/><br/>
	<input type="checkbox" name="hold_sendcust_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to customer on order on Hold<br/><br/>
	</div>
	</div>
	...
	<h4>Send SMS FOR Order Pending</h4>
	<strong style="color: red;">This feature is available on the <a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">pro version of this plugin</a>.</strong><br/>
	<strong><a target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">Buy the pro version</a></strong>
	<hr>
	SMS Text To Admin For Order Pending: <br/>
	<textarea name="pending_msgtxt_admin" rows="3"  style="border:solid 1px #777;cursor: not-allowed;" disabled><?php echo get_option('pending_msgtxt_admin', 'Order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME is pending payment.'); ?></textarea><br/><br/>
    SMS To Customer For Order Pending: <br/>
	<textarea name="pending_msgtxt_cust" rows="3" style="border:solid 1px #777;cursor: not-allowed;" disabled > <?php echo get_option('pending_msgtxt_cust', 'Your order ORDER_ID of ORDER_TOTAL ORDER_CURRENCY on SITE_NAME is pending payment.'); ?></textarea><br/><br/>
	<input type="checkbox" name="pending_sendadmin_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to admin on order Pending<br/><br/>
	<input type="checkbox" name="pending_sendcust_check" value="checked" style="border:solid 1px #777;cursor: not-allowed;" disabled> Send SMS to customer on order Pending<br/><br/>
	</div>
	</div>
	...
	<div id="msgsavebtn"><?php submit_button('Save Settings'); ?></div>
     ...
     <img width="190px" src="<?php echo plugin_dir_url( __FILE__ ) . '/assets/twilio.png'; ?>"><br/>
     <p><b>To get the SMS API visit <a href="https://www.twilio.com" target="blank">twilio</a></b></p>
	 <strong><a style="color: red;" target="_blank" href="https://codecanyon.net/item/customizable-woocommerce-order-sms-notification-plugin-with-twilio-api/22485444">Buy the pro version</a></strong>
   ...
   <div class="twelve columns">
    <!-- <p>This plugin work with transactional route to send order status SMS and use OTP route to send OTP via SMS to verify the checkout.</p> -->
    <!--  <p>Buy Transactional route SMS credit if you want to send order status in SMS</p>
     <p>Buy OTP route SMS credit if you want to verify by sending OTP on checkout page.</p> -->
    ...
    <!-- <p><b>OTP_CODE</b> will include OTP code in the message when you want to send an OTO. OTP_CODE is only valid for OTP settings.</p> -->
...
add_action( 'woocommerce_order_status_failed', 'cspd_wc_msg_order_failed', 10, 1);
...
add_action( 'woocommerce_order_status_processing', 'cspd_wc_msg_order_processing', 10, 1);
add_action( 'woocommerce_order_status_completed', 'cspd_wc_msg_order_completed', 10, 1);
//add_action( 'woocommerce_order_status_refunded', 'wc_msg_order_refunded', 10, 1);
add_action( 'woocommerce_order_status_cancelled', 'cspd_wc_msg_order_cancelled', 10, 1);
...
add_action('woocommerce_checkout_process', 'cspw_wc_twilio_checkout_field_process');
  
function cspw_wc_twilio_checkout_field_process() {
    global $woocommerce;
...
// Adding JavaScript valid phone notice
add_action('woocommerce_after_order_notes', 'cspw_customise_checkout_field');
function cspw_customise_checkout_field($checkout)
{
	?>
        <h1>Test code</h1>
        <script type="text/javascript">
        	var valid_phone_txt = document.createTextNode('Enter your 10 digits phone number');
            var valid_txt_child = document.getElementById('billing_phone');
            valid_txt_child.parentNode.insertBefore(valid_phone_txt, valid_txt_child);
        </script>
	<?php
}