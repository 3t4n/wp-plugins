...
function CPIW_LoadCssAdmin(){
        if ( is_admin() && isset( $_GET['page'] ) && $_GET['page'] === 'pin-code' || isset( $_GET['page'] ) && $_GET['page'] === 'my-list-pincode-submenu-page' || isset( $_GET['page'] ) && $_GET['page'] === 'my-add-pincode-submenu-page' ) {
...
function CPIW_LoadFrontCss() {
        global $cpiw_comman;
        wp_enqueue_script( 'CPIW_front_script', CPIW_PLUGIN_DIR . '/assets/js/front.js', array( 'jquery' ), '1.0.0' );
