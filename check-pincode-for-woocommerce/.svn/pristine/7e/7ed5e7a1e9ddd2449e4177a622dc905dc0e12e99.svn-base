    			...
    			<span class="close" >&times;</span>
    			 	<div class="modalinner">
                                ...
                                <form action="" method="post">
                                	<div class="popup_main">
        	                            <div class="cpiw_popup_check_div">
                                            <?php  $location_icon = CPIW_PLUGIN_DIR . '/assets/image/location.png'; ?>
                        ...
                        <div class="cpiwc_maindiv_popup">
                            <div class="cpiwc_spinner"><img src="<?php echo esc_attr(CPIW_PLUGIN_DIR . '/assets/image/loading-load.gif'); ?>"></div>
                        </div>
