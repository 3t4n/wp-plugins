...
* Version: 1.2
* Copyright: 2023
* Text Domain:check-pincode-for-woocommerce
...
function CPIW_support_and_rating_links( $links_array, $plugin_file_name, $plugin_data, $status ) {
    ...
    $links_array[] = '<a href="https://www.plugin999.com/support/">'. __('Support', 'check-pincode-for-woocommerce') .'</a>';
    $links_array[] = '<a href="https://wordpress.org/support/plugin/check-pincode-for-woocommerce/reviews/?filter=5">'. __('Rate the plugin ★★★★★', 'check-pincode-for-woocommerce') .'</a>';
