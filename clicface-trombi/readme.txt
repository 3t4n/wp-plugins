...
A great plugin for WordPress that creates a directory of all your employees.
...
* [Clicface Organi, the Org Chart web application](https://wordpress.org/plugins/clicface-organi/)
...
Then, you can begin to add Divisions, Worksites and Employees in the directory under the **Employees** tab.

Inside the article or page you want, insert the code below in the HTML tab. The directory will appear:

* For the Free version : **[clicface-trombi]**
* For the Standard version : **[clicface-trombi-std]**
* For the Pro version : **[clicface-trombi-pro]**

== Frequently Asked Questions ==

= What are the requirements to install the Clicface Trombi plugin? =
To use Clicface Trombi, you no longer need to install Piklist! We have completely removed the dependency to this plugin.
...
To use customized fields with Clicface Trombi, we suggest you to choose the best version for you with our [comparison table](https://plugins.clicface.com/pricing/).
...
== Screenshots ==
Screenshots are available on the [Clicface Trombi plugin website](https://plugins.clicface.com/screenshots).
...
= 2.07 =
* Testing with last WordPress version 5.3

= 2.06 =
* Fixing issue with last WordPress version 5.0

= 2.05 =
* ThickBox display by default
...
* Adding social field: LinkedIn

= 1.16 =
* Adding social fields: Website, Facebook, Twitter, Youtube
...
* Adding the ability to replace the "employee" word by anything else

= 1.08 =
* Improving employee page info (return/close link)

= 1.07 =
* Improving employee page info (duplicated name)
...
== Upgrade Notice ==
= 2.01 =
You may need to revalidate the picture of each employee when upgrading to this new version.
