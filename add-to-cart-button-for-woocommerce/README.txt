...
You can customize the button’s design from the backend Dashboard easily and separately for the shop/catalog page and product page.
...
✅ Button's Text Changing Options for-
➟ Simple Products
➟ Grouped Products
➟ Variable Products
➟ Affiliate Products
➟ Booking Products
✅ Text Changing Options for pages like-
➟ Product's shop/catalog page
➟ Product/single page
✅ Button styles customizing Options for-
➟ Product's shop/catalog page
➟ Product/single page
✅ Adding icons beside the button text
✅ Defining custom width and height for the button
✅ 8 different border styles and unlimited colors
✅ Border Radius Feature to reshape the button
✅ Margin and Padding features to set offsets
✅ Placing only an icon without text
...
➟ Show
➟ Hide
✅ Replacing the button text with own words
✅ Hundreds of icons to use beside the button text.
✅ Setting custom width and height for button
✅ Placing the button in different places on the screen.
...
= Pro Features Now In Free Version 🔥 =
...
It is easy to install and use. After installing the plugin, the options will be found under the **Dashboard→ WooCommerce→ Add to Cart Button** menu.
...
After installing the plugin, all the options and features will be found under the <em>Dashboard→ WooCommerce→ Add to Cart Button</em> menu.
...
A: You will find the options menu here → '**Dashboard → WooCommerce → Add to Cart Button**'
