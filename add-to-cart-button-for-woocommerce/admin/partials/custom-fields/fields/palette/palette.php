 ...
 *
 */
if ( ! class_exists( 'ATCBW_Field_palette' ) ) {
  class ATCBW_Field_palette extends ATCBW_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="atcbw-siblings atcbw--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' atcbw--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="atcbw--sibling atcbw--palette'. esc_attr( $active ) .'">';
