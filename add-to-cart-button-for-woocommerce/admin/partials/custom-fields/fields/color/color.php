 ...
 *
 */
if ( ! class_exists( 'ATCBW_Field_color' ) ) {
  class ATCBW_Field_color extends ATCBW_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="atcbw-color"'. $default_attr . $this->field_attributes() .'/>';
