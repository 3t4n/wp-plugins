...
(function($) {
  ...
  function ATCBWAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  ATCBWAjaxChosen.prototype.init = function() {
  ...
  ATCBWAjaxChosen.prototype.events = function() {
  ...
  ATCBWAjaxChosen.prototype.search_field_focused = function() {
  ...
  ATCBWAjaxChosen.prototype.search_welcome_message = function() {
  ...
  ATCBWAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('atcbw-chosen', _this.options.data).done( function( response ) {
  ...
  ATCBWAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.atcbw-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.ATCBWChosenOrder($hidden_value, true);
  ...
  $.fn.ATCBWAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new ATCBWAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, ATCBWAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  ATCBWAbstractChosenOrder = (function() {

    function ATCBWAbstractChosenOrder() {}

    ATCBWAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    ATCBWAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    ATCBWAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    ATCBWAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    ATCBWAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    ATCBWAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    ATCBWAbstractChosenOrder.ATCBWChosenOrder = function(select, order, force) {
    ...
    return ATCBWAbstractChosenOrder;
  ...
  $.fn.extend({
    ATCBWChosenOrder: function(order, force) {
      return _ATCBWChosenOrder.ATCBWChosenOrder(this, order, force);
    }
  });

  this._ATCBWChosenOrder = (function(_super) {
    __extends(_ATCBWChosenOrder, _super);

    function _ATCBWChosenOrder() {
      _ref = _ATCBWChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _ATCBWChosenOrder.relAttributeName = 'data-option-array-index';

    _ATCBWChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _ATCBWChosenOrder.getDOMElement = function(element) {
    ...
    _ATCBWChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _ATCBWChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _ATCBWChosenOrder;

  })(ATCBWAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('atcbw-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectATCBW = FormSerializer.serializeObject;
    $.fn.serializeJSONATCBW   = FormSerializer.serializeJSON;
  }
