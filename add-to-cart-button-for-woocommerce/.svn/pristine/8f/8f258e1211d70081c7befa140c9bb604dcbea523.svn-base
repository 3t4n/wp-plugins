 ...
 *
 */
if ( ! class_exists( 'ATCBW_Field_sortable' ) ) {
  class ATCBW_Field_sortable extends ATCBW_Fields {
    ...
    public function render() {
      ...
      echo '<div class="atcbw-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="atcbw-sortable-item">';

          echo '<div class="atcbw-sortable-content">';
          ...
          ATCBW::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="atcbw-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
