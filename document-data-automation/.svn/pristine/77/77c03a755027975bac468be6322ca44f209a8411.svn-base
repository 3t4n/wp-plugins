...
This plugin is a Wordpress interface for our Docxpresso cloud service ([Get a free trial](https://docxpresso.com "Generate and manage all your documents in the cloud")). It allows
...
https://youtu.be/5i631JIesiE?rel=0
...
https://youtu.be/42acmu6dko8?rel=0
...
You may see an example on how to do it in here: [Export data to a template](https://www.docxpresso.com/news/document-and-data-automation-forwarding-data-wordpress-docxpresso-template "Document and Data Automation: Forwarding data from WordPress to a Docxpresso template").
...
* There is a new users interface within Wordpress that allow registered users to handle their documents from their Wordpress dashboard.
* The admins may control at the indidual user level which actions may be performed: only download or download and edit.

= 1.5 =

* You can now pass a token to a Docxpresso document or web form, in order to recover a previous usage, by including it as a dxoToken parameter in the query.
* Docxpresso document edition interface available directly from the admin panel so you can interact with previously generated documents.

= 1.4 =

* Editors may now select which template variables are editable from within the Wordpress end user interface.
* Seamless integration with predefined Docxpresso workflows

= 1.3 =

* Advanced users may now forward WP data to the Docxpresso template so some variables are prefilled
