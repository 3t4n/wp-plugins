<h2 class="nav-tab-wrapper">
    <a href="#" class="nav-tab nav-tab-active" id="tab_2" onclick="return false"><i
                class="fa fa-database"> </i> <?php _e('Data', 'document-data-automation'); ?></a>
</h2>
            ...
            <div id="col-left" class="dxo-col-left">
                <div class="col-wrap">
					<form id="filterUsages" name="filterUsages" action="" method="post">
                                            <?php wp_nonce_field('filter') ?>
                        <h2><i class="fa fa-search"> </i> <?php _e('Search Data', 'document-data-automation'); ?>
                        </h2>
                        <div class="inside">
                        </div>
                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Identifier', 'document-data-automation'); ?>
                                :</strong> <input class="regular-text filterData" type="text" id="filterIdentifier"
                                                  ...
                                                  value="<?php echo esc_attr($filterIdentifier) ?>"
                        ...
                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Reference', 'document-data-automation'); ?>
                                :</strong> <input class="regular-text filterData" type="text" id="filterReference"
                                                  ...
                                                  value="<?php echo esc_attr($filterReference) ?>"
                                                  placeholder="<?php _e('Reference', 'document-data-automation'); ?>"
                                                  style="width: 220px"/></p>
                        <p><input class="regular-text filterData" type="hidden" id="filterDomain"
                                  value="<?php echo $userLogin ?>"></p>
                        <p>
                            <i class="fa fa-clock-o"> </i>
                            <strong><?php _e('Time period', 'document-data-automation'); ?>:</strong>
                            <select class="filterData" id="filterPeriod" name="filterPeriod">
                                <option value=""></option>
