...
// Register the script
wp_register_script('dxo_thick', plugins_url('/js/dxo-tb.js', __DIR__));
...
wp_enqueue_script('dxo_thick', plugins_url('/js/dxo-tb.js', __DIR__));
...
echo 'trans_DXO.user = "' . __('User WP', 'document-data-automation') . '";' . PHP_EOL;
echo '</script>' . PHP_EOL;
?>
...
<?php if ($categories === NULL) {
    ...
    <div class="wrap">
        <div class="notice notice-warning inline">
            <iframe src="<?php echo $url_remote_logging; ?>" width="99%" height="55px" scrolling="no"
                    style="overflow:hidden;"><?php _e('Loading content', 'document-data-automation'); ?></iframe>
        </div>

        <div class="notice notice-error is-dismissible" id="errorDXO" style="display: none">
            <p><?php _e('It seems like the connection to Docxpresso <strong>is lost</strong>, please, <strong>reload</strong> this page.', 'document-data-automation'); ?></p>
        </div>
    ...
    <h2 class="nav-tab-wrapper">
        <a href="#" class="nav-tab nav-tab-active" id="tab_1" onclick="return false"><i
                    class="fa fa-file-o"> </i> <?php _e('Templates', 'document-data-automation'); ?></a>
        <a href="#" class="nav-tab" id="tab_2" onclick="return false"><i
                    class="fa fa-database"> </i> <?php _e('Data by template', 'document-data-automation'); ?></a>
        <a href="#" class="nav-tab" id="tab_3" onclick="return false"><i
                    class="fa fa-database"> </i> <?php _e('Browse data', 'document-data-automation'); ?></a>
    </h2>
            ...
            <div id="col-container">
                <div id="col-right">
                    <div class="col-wrap" style="margin-bottom: 25px">
                        <h2>
                            <i class="fa fa-search"> </i> <?php _e('Search Templates by name', 'document-data-automation'); ?>
                        </h2>

                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Name', 'document-data-automation'); ?>:</strong>
                            <input class="regular-text" type="text" id="filterName" value=""
                                   placeholder="<?php _e('Template name', 'document-data-automation'); ?>"
                                   style="width: 220px"/>
                            <button id="dxo_search_templates" class="button-primary" onclick="return false"><i
                                        class="fa fa-filter"> </i> <?php _e('Filter by name', 'document-data-automation'); ?>
                            </button>
                            <br/>
                            &emsp;<small><?php _e('Leave "name" empty for the complete list.', 'document-data-automation'); ?></small>
                        </p>
                    </div>
                    <div class="col-wrap">
                        <div class="inside">
                            <div style="float: right; margin-bottom: 10px">
                                <button class="button-primary" id="selectTemplateFromCategory" onclick="return false"><i
                                            class="fa fa-sitemap"> </i> <?php _e('Select template by category', 'document-data-automation'); ?>
                                </button>
                            </div>
                            <h2><i class="fa fa-file-text-o"> </i> <span
                                        id="listTemplates"><?php _e('Last used templates', 'document-data-automation'); ?></span>
                            </h2>
                            <div id="templateFilters" style="display:none; float: left">
                                <p style="margin:0"><?php _e('Filtered by name', 'document-data-automation'); ?>:
                                    <strong id="filterTemplateValue"></strong></p>
                            </div>
                            <div id="templateLoaderDXO" style="clear: left">
                                <div class="spinner is-active"
                                     style="float:none;width:auto;height:auto;padding:10px 0 10px 50px;background-position:20px 10px;"><?php _e('Loading data', 'document-data-automation'); ?></div>
                            </div>
                        </div>
                ...
                <div id="col-left">
                    ...
                    <div class="col-wrap">
                        <h2><i class="fa fa-clock-o"> </i> <?php _e('Latest templates', 'document-data-automation'); ?>
                        </h2>
                    </div>
                    <div class="col-wrap">
                        <div class="inside">
                            <div id="latestTemplatesDXO" style="clear: left">
                                <div class="spinner is-active"
                                     style="float:none;width:auto;height:auto;padding:10px 0 10px 50px;background-position:20px 10px;"><?php _e('Loading templates', 'document-data-automation'); ?></div>
                            </div>
                        </div>
                    </div>
                    <!-- /col-wrap -->
    ...
    <div id="selectionDataDXO" style="display: none">
        <div class="wrap">
            <div id="col-container">
                <div id="col-right" class="dxo-col-right">
                    <div class="col-wrap">
                        <div id="yesTemplate" style="float: right; margin-bottom: 10px; display: none">
                            <button class="button-primary" id="downloadExcel" onclick="return false"><i
                                        class="fa fa-file-excel-o"> </i> <?php _e('Download as Excel file', 'document-data-automation'); ?>
                            </button>
                        </div>
                        <h2><i class="fa fa-database"> </i> <?php _e('Usage data', 'document-data-automation'); ?></h2>
                        <div class="inside">
                            <div id="templateDataFilter" style="display:none">
                                <p><?php _e('Filtered by template', 'document-data-automation'); ?>: <strong
                                            id="filterDataTemplateValue" style="color: #0073aa;"></strong></p>
                            </div>
                ...
                <div id="col-left" class="dxo-col-left">
                    <div class="col-wrap">
                        <h2><i class="fa fa-search"> </i> <?php _e('Search Data', 'document-data-automation'); ?></h2>
                        <div class="inside">
                        </div>
                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Identifier', 'document-data-automation'); ?>
                        ...
                        <p>
                            <button id="dxo_search_data" class="button-primary" onclick="return false"><i
    ...
    <div id="selectionDataDXOGD" style="display: none">
        <div class="wrap">
            <div id="col-container">
                <div id="col-right" class="dxo-col-right">
                    <div class="col-wrap">
                ...
                <div id="col-left" class="dxo-col-left">
                    <div class="col-wrap">
                        ...
                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Identifier', 'document-data-automation'); ?>
                                :</strong> <input class="regular-text filterData" type="text" id="filterIdentifierGD"
                                                  value=""
                                                  placeholder="<?php _e('Identifier', 'document-data-automation'); ?>"
                                                  style="width: 220px"/></p>
                        <p><i class="fa fa-tag"> </i> <strong><?php _e('Reference', 'document-data-automation'); ?>
                                :</strong> <input class="regular-text filterData" type="text" id="filterReferenceGD"
                                                  value=""
                                                  placeholder="<?php _e('Reference', 'document-data-automation'); ?>"
                                                  style="width: 220px"/></p>
                        <p><i class="fa fa-user"> </i> <strong><?php _e('User', 'document-data-automation'); ?>
                                :</strong>
                            <select id="filterUserGD" name="filterUserGD" class="filterData">
                                <option value=""></option>
                                <?php
                        ...
                        <p>
                            <i class="fa fa-clock-o"> </i>
                            <strong><?php _e('Time period', 'document-data-automation'); ?>:</strong>
                            <select class="filterData" id="filterPeriodGD">
                                <option value=""></option>
                                <option value="today"><?php _e('Today', 'document-data-automation'); ?></option>
                                <option value="1week"><?php _e('Last week', 'document-data-automation'); ?></option>
                                <option value="1month"><?php _e('Last month', 'document-data-automation'); ?></option>
                        ...
                        <p>
                        <div id="dateRangeGD" style="display: none">
                            <table>
                                <tr>
                                    <td></td>
                                    <td><strong><?php _e('Day', 'document-data-automation'); ?></strong></td>
                        ...
                        <p>
                            <button id="dxo_search_general_data" class="button-primary" onclick="return false"><i
                                        class="fa fa-filter"> </i> <?php _e('Filter data', 'document-data-automation'); ?>
                            </button>
                        </p>
                    </div>
