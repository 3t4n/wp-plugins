...
<div class="editeffect wb3d_displaynone ui-widget-content" id="p_allobj" >
	...
	<label class="editeffect_label" id="width_label2"><?php esc_html_e('The result of these changes can be seen in the demo/view(Please set overflow option to hidden)', 'wb3d'); ?></label>
