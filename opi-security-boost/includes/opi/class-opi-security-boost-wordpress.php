...
class OPI_Security_Boost_WordPress extends OPI_Security_Boost {
	...
	public function __construct() {
		 ...
		 * load github class
		 */
		$filename = __DIR__ . '/class-opi-security-boost-github.php';
		if ( is_file( $filename ) ) {
			include_once $filename;
			new opi_security_boost_github();
		}
	}
	...
	public function action_shutdown() {
		 ...
		 * check indexes files
		 */
		if ( get_option( $this->last_installed_plugin_version_name, '' ) !== '1.1.0' ) {
			...
			update_option( $this->last_installed_plugin_version_name, '1.1.0' );
		}
	}
