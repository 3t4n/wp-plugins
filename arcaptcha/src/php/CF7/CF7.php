...
class CF7
{
    ...
    public function wpcf7_form_elements($form)
    {
        ...
        if (strpos($form, '[cf7-arcaptcha]') === false) {
            $form = str_replace('<input class="wpcf7-form-control wpcf7-submit has-spinner" type="submit"', '[cf7-arcaptcha]<br><input class="wpcf7-form-control has-spinner wpcf7-submit" type="submit"', $form);
        }
    ...
    public function cf7_arcaptcha_shortcode($atts)
    {
        ...
        return (
            ...
            '" data-lang="' . esc_html($arcaptcha_language) .
