...
use ARCaptcha\ElementorPro\ElementorPro;
...
function arcap_load_modules()
{
    $modules = array(
        ...
        'Digits'                    => array(
            'arcaptcha_digits_status',
            'digits/digit.php',
            'digits/digits.php'
        ),
        'ElementorPro'            => array(
            'arcaptcha_elementor-pro_status',
