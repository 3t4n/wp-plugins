...
== Changelog ==
= 2.11 =
* Fixed vulnerability escaping user input 6.7
= 2.10 =
* Fixed vulnerability escaping user input 6.7
= 2.9 =
* Fixed vulnerability issue and tested for latest wordpress version 6.7
= 2.8 =
* Tested the widget with latest wordpress version 6.5
= 2.7 =
* Tested the widget with latest wordpress version 6.0
= 2.6 =
* Tested the widget with latest wordpress version 5.9
= 2.5 =
* Tested the widget with latest wordpress version 5.8.3
= 2.4 =
* Tested the widget with latest wordpress version 5.4.2 and updated screenshots and logo
= 2.3 =
* Tested the widget with the latest wordpress version 5.0.3
= 2.2.03 =
* Updated the desciption for the insertion of API key
= 2.2.02 =
* Tested the widget with the latest wordpress version 4.9.8
= 2.2.01 =
* Made the widget backwards compatible with older php versions
= 2.2 =
* Display the correct version now
= 2.1 =
* Updated company information in the rich snippet
= 2.0 =
* Updated the rich snippet tags to comply to the latest standards
= 1.0 =
* Initial version
