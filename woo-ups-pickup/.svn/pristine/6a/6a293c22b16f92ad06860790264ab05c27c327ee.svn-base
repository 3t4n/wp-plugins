...
//            );
        ...
        if ($this->get_option('integration_active', 0)) {
            ...
            $this->form_fields['integration_api_environment'] =array(
                'title' => __('API Environment', WC_Ups_PickUps::TEXT_DOMAIN),
                'type' => 'select',
                'default' => 0,
                'options' => array(
                    'production' => __('Production', WC_Ups_PickUps::TEXT_DOMAIN),
                    'test' => __('Test', WC_Ups_PickUps::TEXT_DOMAIN),
                )
            );
