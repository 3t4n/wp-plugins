...
class FEP_Flodesk_Elementor_Pro extends \ElementorPro\Modules\Forms\Classes\Integration_Base {
    ...
    public function get_label() {
        return __( 'Flodesk', 'flodesk-for-elementor-pro' );
    }
    ...
    public function register_settings_section( $widget ) {
        $widget->start_controls_section(
            'flodesk_settings',
            [
                'label' => __( 'Flodesk', 'flodesk-for-elementor-pro' ),
                'condition' => [
    ...
    public function get_segments() {
        ...
        $segments = wp_remote_retrieve_body( wp_remote_get( "https://api.flodesk.com/v1/segments?per_page=100", array(
            'headers' => [
                'Authorization' => "Basic $api_key_base64"
            ],
        ) ) );
        ...
        $settings->add_section( \Elementor\Settings::TAB_INTEGRATIONS, 'flodesk', [
            ...
            'fields' => [
                self::OPTION_NAME_API_KEY => [
                    'label' => __( 'API Key', 'flodesk-for-elementor-pro' ),
                    'field_args' => [
                        'type' => 'text',
                        'desc' => sprintf(
