...
At [required](https://required.com/ "Team of experienced web professionals from Switzerland & Germany") we strive to create a great user experience. We thought about how to improve the WordPress admin and came to the conclusion that we need a better way to manage the core of the WordPress back-end: the admin menu.
...
An [alpha version](https://github.com/wearerequired/admin-menu-manager/releases/tag/2.0.0-alpha) was released back in 2017. Right now, work has stalled due to lack of time and resources. If you want to help out, please get in touch with us!
