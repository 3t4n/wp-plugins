			...
			<div class="quantity-break__wrapper">
				...
				if ($discount_option->message) {
					if ($discount_option->message_effect == 'blinking') { ?>
						<div class="bundle-message-blink"><?php if ($discount_option->add_messages == 'on' && $discount_option->message) esc_html_e($discount_option->message); ?></div>
					<?php } else { ?>
						<div class="bundle-message-not-blink"><?php if ($discount_option->add_messages == 'on' && $discount_option->message) esc_html_e($discount_option->message); ?></div>
				<?php }
				}
				?>
				...
				<div class="quantity-break__main">
					...
					<div class="quantity-break__content">
						...
						<div class="quantity-break__title" data-number="<?php esc_html_e($discount_option->number_of_products); ?>" data-title="<?php esc_attr_e($discount_option->title); ?>">
							<?php esc_html_e($discount_option->title); ?>
						</div>
