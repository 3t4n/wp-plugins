...
class Admin_App
{
    ...
    public function register_admin_menu()
    {
        ...
        add_submenu_page('bundler', 'Analytics', 'Analytics', $capability, 'bundler&path=analytics', [$this, 'bdlr_page'], 15);
...
?>
        ...
        <script type="text/javascript">
            function highlightSubmenu() {
                ...
                } else if (path === 'bundles' || path === 'edit-bundle' || path === 'add-bundle') {
                    document.querySelector('#toplevel_page_bundler a[href$="admin.php?page=bundler&path=bundles"]').parentNode.classList.add('current');
                } else {
...
<?php
        ...
        wp_localize_script('bdlr_main', 'bdlr_data', [
            ...
            'admin_url'       => parse_url(admin_url('admin.php'), PHP_URL_PATH),
