                    ...
                    <form method="post" novalidate="novalidate" spellcheck="false">
                        ...
                        <div class="license-input-fields">
                            <div class="license-input-key">
                                ...
                                <input type="text" value="<?php echo $this->get_input_license_value($action, $license); ?>" placeholder="<?php echo esc_attr($this->client->__trans('Enter your license key to activate')); ?>" name="license_key" <?php echo ('deactive' === $action) ? 'readonly="readonly"' : ''; ?> />
                            </div>
