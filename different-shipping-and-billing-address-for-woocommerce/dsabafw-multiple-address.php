...
include_once('main/block/block.php');
include_once('main/frontend/dsabafw-front.php');
include_once('main/frontend/dsabafw-ajax.php');



include_once('main/resources/dsabafw-load-js-css.php');

function DSABAFWP_append_support_and_faq_linkss( $links_array, $plugin_file_name, $plugin_data, $status ) {
    
  if ( strpos( $plugin_file_name, basename(__FILE__) ) ) {
    // You can still use `array_unshift()` to add links at the beginning.
    $links_array[] = '<a href="https://www.plugin999.com/support/">'. __('Support', 'different-shipping-and-billing-address-for-woocommerce-pro') .'</a>';
    $links_array[] = '<a href="https://wordpress.org/support/plugin/different-shipping-and-billing-address-for-woocommerce/reviews/?filter=5">'. __('Rate the plugin ★★★★★', 'different-shipping-and-billing-address-for-woocommerce-pro') .'</a>';
  }
  return $links_array;
}
add_filter( 'plugin_row_meta', 'DSABAFWP_append_support_and_faq_linkss', 10, 4 );