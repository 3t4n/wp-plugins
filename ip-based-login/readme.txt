...
= 2.4.1 4th January 2025 =
* Low Risk Security Fix. Thanks to WPScan Security team for reporting.

= 2.4.0 26th December 2024 =
* Security Fix that existed on Multisite setup. Thanks to WPScan Security team for reporting.
* [Bug Fix] When both Free and Pro versions were installed and either of the plugin was deleted, the plugin data was deleted from the database. It will now be removed only when the last plugin is deleted.

= 2.3.13 20th November 2024 =
* [Improvement] Added support auto detect delimiter while importing IP Ranges using a CSV file with a delimiter other than the default (,)
* [Improvement] Compatible with WordPress 6.7

= 2.3.12 27th July 2024 =
* [Improvement] Added Sample CSV file
* [Improvement] Compatible with WordPress 6.6
* [Bug Fix] Fixed some warnings

= 2.3.11 12th April 2024 =
