...
function gamipress_slicewp_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'SliceWP', 'gamipress-slicewp-integration' )] = array(
        'gamipress_slicewp_register_affiliate'    => __( 'Become an affiliate', 'gamipress-slicewp-integration' ),
        'gamipress_slicewp_new_commission'          => __( 'Earn a commission', 'gamipress-slicewp-integration' ),
        'gamipress_slicewp_commission_paid'         => __( 'Get a commission paid', 'gamipress-slicewp-integration' ),
        'gamipress_slicewp_commission_rejected'     => __( 'Get a commission rejected', 'gamipress-slicewp-integration' ),
    );
