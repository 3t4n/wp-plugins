(function( $ ) {
	...
	NewFreshmarketerAPI = function(token,orgid) {
		this.outstandingRequests = 0;
		this.token = token;
		this.orgid = orgid;
	}

	NewFreshmarketerAPI.prototype.call = function( type, appender, data, callback ) {
		var self = this;
		var options = {
	...
	NewFreshmarketerAPI.prototype.get = function( appender, callback ) {
