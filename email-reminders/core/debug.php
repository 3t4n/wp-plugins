...
function get_debuge_error( $msg , $file_name='', $line_num=''){
        ...
        $ver_num = ( ! defined('OPER_VERSION') ) ? '' : '|V:' . OPER_VERSION ;
...
/** Usage: if (  function_exists ('oper_check_post_key_max_number')) { oper_check_post_key_max_number(); } */
if ( ! function_exists( 'oper_check_post_key_max_number' ) ) {
function oper_check_post_key_max_number() {
        ...
        foreach ( $_POST as $key_name => $post_value ) {
            ...
            foreach ( $php_ini_vars as $php_ini_var ) {
                ...
                if (  $key_length > $php_ini_var_length ) {
                    ...
                    oper_show_message_in_settings(  'Your php.ini configuration limited to '
...
/** Write debuge log to file ../wp-content/upload/oper_debug.log
 * 
 * @param type $param
 */
