...
jQuery( function ( $ ) {                                                                            // Shortcut to  jQuery(document).ready(function(){ ... });
    ...
    jQuery( '.oper_is_dismissible' ).on( 'click', '.oper_dismiss', function ( event ) {             // This delegated event, can be run, when DOM element added after page loaded
...
jQuery( function ( $ ) {                                                                            // Shortcut to  jQuery(document).ready(function(){ ... });
    ...
    jQuery( '.oper_is_hideable' ).on( 'click', '.oper_dismiss', function ( event ) {                // This delegated event, can be run, when DOM element added after page loaded
