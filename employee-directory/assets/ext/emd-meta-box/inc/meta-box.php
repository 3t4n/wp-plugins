...
if ( ! class_exists( 'EMD_Meta_Box' ) )
{
	...
	class EMD_Meta_Box
	{
		...
		{
			$jqvalid_msg['required'] = __('This field is required.','empd-com');
			$jqvalid_msg['remote'] = __('Please fix this field.','empd-com');
			$jqvalid_msg['email'] = __('Please enter a valid email address.','empd-com');
			$jqvalid_msg['url'] = __('Please enter a valid URL.','empd-com');
			$jqvalid_msg['date'] = __('Please enter a valid date.','empd-com');
			$jqvalid_msg['dateISO'] = __('Please enter a valid date ( ISO )','empd-com');
			$jqvalid_msg['number'] = __('Please enter a valid number.','empd-com');
			$jqvalid_msg['digits']= __('Please enter only digits.','empd-com');
			$jqvalid_msg['creditcard']= __('Please enter a valid credit card number.','empd-com');
			$jqvalid_msg['equalTo']= __('Please enter the same value again.','empd-com');
			$jqvalid_msg['maxlength']= __('Please enter no more than {0} characters.','empd-com');
			$jqvalid_msg['minlength']= __('Please enter at least {0} characters.','empd-com');
			$jqvalid_msg['rangelength']= __('Please enter a value between {0} and {1} characters long.','empd-com');
			$jqvalid_msg['range']= __('Please enter a value between {0} and {1}.','empd-com');
			$jqvalid_msg['max']= __('Please enter a value less than or equal to {0}.','empd-com');
			$jqvalid_msg['min']= __('Please enter a value greater than or equal to {0}.','empd-com');
		...
		function show()
		{
			...
			if(isset( $this->validation ) && $this->validation){
				echo '
					...
					summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'empd-com' ) . '",';
			}
