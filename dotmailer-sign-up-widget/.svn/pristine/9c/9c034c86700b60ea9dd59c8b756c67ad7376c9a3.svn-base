...
humbug_phpscoper_expose_class('ComposerAutoloaderInitb933e4dec037358ff05515f1fd78e117', 'Dotdigital_WordPress_Vendor\ComposerAutoloaderInitb933e4dec037358ff05515f1fd78e117');
...
if (!function_exists('getHtmlAttribute')) { function getHtmlAttribute() { return \Dotdigital_WordPress_Vendor\getHtmlAttribute(...func_get_args()); } }
if (!function_exists('getMaxHistoryMonthsByAmount')) { function getMaxHistoryMonthsByAmount() { return \Dotdigital_WordPress_Vendor\getMaxHistoryMonthsByAmount(...func_get_args()); } }
...
if (!function_exists('mb_lcfirst')) { function mb_lcfirst() { return \Dotdigital_WordPress_Vendor\mb_lcfirst(...func_get_args()); } }
...
if (!function_exists('mb_ltrim')) { function mb_ltrim() { return \Dotdigital_WordPress_Vendor\mb_ltrim(...func_get_args()); } }
...
if (!function_exists('mb_rtrim')) { function mb_rtrim() { return \Dotdigital_WordPress_Vendor\mb_rtrim(...func_get_args()); } }
...
if (!function_exists('mb_trim')) { function mb_trim() { return \Dotdigital_WordPress_Vendor\mb_trim(...func_get_args()); } }
if (!function_exists('mb_ucfirst')) { function mb_ucfirst() { return \Dotdigital_WordPress_Vendor\mb_ucfirst(...func_get_args()); } }
