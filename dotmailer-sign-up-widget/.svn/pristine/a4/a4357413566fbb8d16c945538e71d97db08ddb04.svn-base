...
if (!\function_exists('Dotdigital_WordPress_Vendor\\mb_ucfirst')) {
    function mb_ucfirst(string $string, ?string $encoding = null) : string
    {
        return p\Mbstring::mb_ucfirst($string, $encoding);
    }
}
if (!\function_exists('Dotdigital_WordPress_Vendor\\mb_lcfirst')) {
    function mb_lcfirst(string $string, ?string $encoding = null) : string
    {
        return p\Mbstring::mb_lcfirst($string, $encoding);
    }
}
if (!\function_exists('Dotdigital_WordPress_Vendor\\mb_trim')) {
...
if (!\function_exists('Dotdigital_WordPress_Vendor\\mb_ltrim')) {
...
if (!\function_exists('Dotdigital_WordPress_Vendor\\mb_rtrim')) {
