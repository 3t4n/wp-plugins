...
== Changelog ==
= Version 1.4.5 =
>[Corrected bbpress plugin tips feed, Support wordpress 6.7.1, detailed document can be found at here](https://www.bbp.design/new-version-released-corrected-wordpress-tips-feed-bbpress-notification-plugin-1-4-5/)



= Version 1.4.3 =
Based on users feedback: "For Reply Notification emails, in the Body of the email, it should show the reply author, but instead it shows the name of the person who created the topic"
