...
(function ($) {
	...
	$(document).ready(function () {
		...
		var viewerHtml = '';
		if ( $('.wpgs-for').length ) {
			waitForEl('.wpgs-for .vsd-model-viewer-inline', function() {
				viewerHtml = $('.wpgs-for .vsd-model-viewer-inline').get(0).outerHTML;
			});
		}
		if ( $('.woo-variation-product-gallery').length ) {
			waitForEl('.woo-variation-product-gallery .vsd-model-viewer-inline', function() {
				viewerHtml = $('.woo-variation-product-gallery .vsd-model-viewer-inline').get(0).outerHTML;
			});
		}
		if ( $('.theme-woodmart .woocommerce-product-gallery .owl-carousel').length ) {
			waitForEl('.woocommerce-product-gallery .owl-carousel', function() {
				viewerHtml = $('.woocommerce-product-gallery .owl-carousel .vsd-model-viewer-inline').get(0).outerHTML;
			});
		}
