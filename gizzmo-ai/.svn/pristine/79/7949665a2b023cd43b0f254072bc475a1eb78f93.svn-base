(function ($$1) {
  ...
  ***************************************************************************** */
  ...
  function F(t, e, n, r, o) {
    ...
    t: if ("style" === e)
      ...
      (i = e !== (e = e.replace(/Capture$/, ""))),
        ...
        (t.l[e + i] = n),
        n
          ? r || t.addEventListener(e, i ? O : D, i)
          : t.removeEventListener(e, i ? O : D, i);
    ...
    try {
      t: if ("function" == typeof x) {
        ...
        (c.context = P),
          ...
          (S =
            null != p && p.type === b && null == p.key ? p.props.children : p),
          k(t, Array.isArray(S) ? S : [S], e, n, r, o, i, a, u, l),
          (c.base = e.__e),
          (e.__h = null),
          c.__h.length && a.push(c),
          m && (c.__E = c.__ = null),
  ...
  function I(t, e, n, r, o, i, s, a) {
    ...
    if (("svg" === m && (o = !0), null != i))
      for (; y < i.length; y++)
        if (
          (u = i[y]) &&
          (u === t || (m ? u.localName == m : 3 == u.nodeType))
        ) {
          (t = u), (i[y] = null);
          break;
        }
  ...
  var B = {
      ...
      error: "No products added yet, Please add products using the Gizzmo Chrome Extension",
    },
    z = (function () {
      function t(t) {
  ...
  function X(t, e) {
    return m(G, { content: t, parentElement: e });
  }
  var $ = (function (t) {
      function n(e) {
  ...
  var yt = (function (t) {
    ...
    return (
      e(r, t),
      (r.prototype.widths = function () {
        (this.tableElement.className =
          this.tableClassName + " " + tt("shadowTable")),
      ...
      return (
        ...
        (r.prototype.adjustWidth = function (t) {
          ...
          var s = e.clientWidth,
            ...
            u = {};
          if (n.current && i) {
            var l = m(yt, { tableRef: n });
            (l.ref = a), M(l, o.current), (u = a.current.widths());
          }
          for (
            var p = 0,
              c = r.tabularFormat(this.columns).reduce(function (t, e) {
                return t.concat(e);
              }, []);
            p < c.length;
            p++
            ...
            (h.columns && h.columns.length > 0) ||
              (!h.width && i
                ? h.id in u &&
                  ((h.width = mt(u[h.id].width)),
                  (h.minWidth = mt(u[h.id].minWidth)))
                : (h.width = mt(gt(h.width, s))));
          }
        ...
        (r.prototype.setID = function (t) {
          for (var e = 0, n = t || this.columns || []; e < n.length; e++) {
            var r = n[e];
            r.id || "string" != typeof r.name || (r.id = vt(r.name)),
              r.id ||
                ut.error(
        ...
        (t.createFromConfig = function (t) {
          ...
          return (
            t.storage instanceof Ct &&
              e.register(new Ft({ serverStorageOptions: t.server })),
            e.register(new Et({ storage: t.storage })),
            e.register(new Dt({ header: t.header })),
            e.register(new Tt()),
            e
          );
        }),
      ...
      return (
        ...
        (t.fromUserConfig = function (e) {
          ...
          return (
            ...
            r.assign({ header: wt.fromUserConfig(r) }),
            r.assign({ storage: kt.createFromUserConfig(e) }),
            r.assign({ pipeline: Ot.createFromConfig(r) }),
            r.assign({ translator: new z(e.language) }),
            r.plugin.add({
              id: "search",
              position: nt.Header,
              component: ht,
            ...
            r.plugin.add({
              ...
              props: n(
                {
                  enabled:
                    !0 === e.pagination || e.pagination instanceof Object,
                },
                e.pagination
              ),
            }),
  ...
  var Lt = (function (t) {
          ...
          return m(
            ...
            this.props.data &&
              this.props.data.rows.map(function (e) {
                return m(It, { key: e.id, row: e, header: t.props.header });
              }),
            this.props.status === bt.Loading &&
    ...
    Bt = (function (t) {
      function r(e, n) {
        var r = t.call(this, e, n) || this;
        return (
          (r.actions = new Ht(r.config.dispatcher)),
              ...
              : ((this.updateSortProcessorFn =
                ...
                (e =
                  t === Y.ServerSort
                    ...
                    : new jt({ columns: this.store.state })),
                this.config.pipeline.register(e)),
            e
          );
        }),
    ...
    zt = (function (t) {
      ...
      return (
        e(n, t),
        (n.prototype.getPageX = function (t) {
          ...
          return (
            ...
            m(
              ...
              this.isResizable() &&
                ...
                m(zt, { column: this.props.column, thRef: this.thRef })
            )
          );
        }),
        r
      ...
      return (
        ...
        (n.prototype.renderColumn = function (t, e, n, r) {
          var o = (function (t, e, n) {
            ...
            i = o.rowSpan,
            s = o.colSpan;
          return m(qt, { column: t, index: n, colSpan: s, rowSpan: i });
        }),
    ...
    Jt = (function (t) {
      function i(e, n) {
        ...
        return (
          ...
          (r.state = { status: bt.Loading, header: e.header, data: null }),
          r
        );
      }
      return (
              ...
              switch (n.label) {
                case 0:
                  this.props.config.eventEmitter.emit("beforeLoad"),
                    this.setState({ status: bt.Loading }),
                    (n.label = 1);
                case 1:
                  return (
                ...
                case 2:
                  return (
                    (t = n.sent()),
                    this.setState({ data: t, status: bt.Loaded }),
                ...
                case 3:
                  return (
                    (e = n.sent()),
                    ut.error(e),
                    this.setState({ status: bt.Error, data: null }),
                    [3, 4]
                  );
                case 4:
                  return [2];
        ...
        (i.prototype.componentDidUpdate = function (t, e) {
          e.status != bt.Rendered &&
            this.state.status == bt.Loaded &&
            (this.setState({ status: bt.Rendered }),
            ...
            m(
              "div",
              {
                ...
                className: et(
                  "gridjs",
                  tt("container"),
                  this.state.status === bt.Loading ? tt("loading") : null,
  ...
  (s.__b = function (t) {
    ...
    (s.diffed = function (t) {
      ...
      e &&
        e.__H &&
        e.__H.__h.length &&
        ((1 !== ee.push(e) && $t === s.requestAnimationFrame) ||
          (
