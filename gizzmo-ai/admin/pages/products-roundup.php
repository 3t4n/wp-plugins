...
<body class="bg-gray-100">
        ...
        <div class="three-fourths">
            <div id="action_placeholder" class="action_placeholder">
                <div class="action_placeholder_header">
                    <h4><?php echo esc_attr__("Products Roundup", 'gizzmo-ai'); ?></h4>
                </div>
                ...
                <div id="action_placeholder_msg" class="action_placeholder_msg">
                    <span><?php echo esc_attr__("Select 3 products minimum in order to start creating a Roundup.", 'gizzmo-ai'); ?></span>
                </div>
            </div>
                ...
                <ul class="steps-list">
                    <li class="active current">
                        <div id="first_step" class="label" style="border-top-left-radius: 8px;border-top-right-radius: 8px;"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 1", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Add 3 products minimum, (50 Max).", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc" >
                            <div class="list" id="roundup_products_draggable" style="display:none;padding: 10px;overflow-y: auto;width: 90%;" sortable-list="sortable-list">
                            </div>
                    ...
                    <li>
                        <div class="label" style="border-top-left-radius: 8px;border-top-right-radius: 8px;"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 2", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- SEO Keyphrase.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc" >
                        ...
                        <div class="desc">
                            ...
                            <ul class="gizzmo_list-item-list" style="margin-top: 20px;">
                                ...
                                <li class="gizzmo_list-item">
                                    <input class="theme_radio" type="checkbox" id="roundup_products_list" name="roundup_products_list" />
                                    <label for="roundup_products_list" class="gizzmo_list-title"><?php echo esc_attr__("Generate Top Page Products list", 'gizzmo-ai'); ?> <span id="roundup_products_list_addon"></span></label>
                                    <div class="gizzmo_list-description"><?php echo esc_attr__("Gizzmo will compile a clickable list of the top 10 products from your roundup and place it at the beginning of your post. This list will enhance navigation and provide quick access to the most important products featured in your content.", 'gizzmo-ai'); ?></div>
                                </li>
                                <li class="gizzmo_list-item">
                                    <input class="theme_radio" type="checkbox" id="roundup_pros_cons_list" name="roundup_pros_cons_list" />
                                    <label for="roundup_pros_cons_list" class="gizzmo_list-title"><?php echo esc_attr__("Add Pros & Cons For Each Product", 'gizzmo-ai'); ?> <span id="roundup_pros_cons_list_addon"></span></label>
                                    <div class="gizzmo_list-description"><?php echo esc_attr__("Gizzmo will generate three pros and three cons for each product included in the roundup. This will provide a balanced overview of the key advantages and disadvantages of each product.", 'gizzmo-ai'); ?></div>
                                </li>
                                <li class="gizzmo_list-item">
                                    <input class="theme_radio" type="checkbox" id="roundup_rating_reviews_list" name="roundup_rating_reviews_list" />
                                    <label for="roundup_rating_reviews_list" class="gizzmo_list-title"><?php echo esc_attr__("Add Product's Star Rating and Reviews For Each Product", 'gizzmo-ai'); ?><span id="roundup_rating_reviews_list_addon"></span></label>
                                    <div class="gizzmo_list-description"><?php echo esc_attr__("Gizzmo will retrieve and display each product's star rating and the number of reviews. This information will be embedded for each product, providing a quick reference to its overall customer feedback", 'gizzmo-ai'); ?></div>
                                </li>
                            </ul>
                    ...
                    <li>
                    <div class="label"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 4", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Monetization and Affiliate.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc" >
                        
                            <div class="key_phrase_wrapper" style="margin-top: 10px;">
                                <div class="gizzmo_input_title"><?php echo esc_attr__("Amazon Affiliate Tags:", 'gizzmo-ai'); ?> <span x-tooltip="'#affiliate_tag_tip'">(?)</span> &nbsp;&nbsp;&nbsp;<span id="affiliate_tags_addon"></span><span id="affiliate_tags_helper_section" style="padding-left:5px" class="helper_texts"><span style="padding-left:5px" class="helper_texts"></span>  </div>
                    ...
                    <li>
                    <div class="label"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 5", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Featured Image.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc">
                                ...
                                <div class="media_left-side">
                                    <div class="media_row upper-row">
                                        <div class="image-placeholder">
                                            ...
                                            <span onclick="showModal('selectfeaturedimageionModal')" style="color: rgb(255, 255, 255);border-radius: 3px;padding: 4px 20px;margin-top: -1px;background-color: rgb(90, 16, 185);display: block;cursor: pointer;position: relative;top: 38px;text-align: center;"><?php echo esc_attr__("Select Featured Image", 'gizzmo-ai'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="media_row lower-row">
                                        <div class="row-title gizzmo_input_title"  style="font-weight: 400;margin-bottom: 20px"><?php echo esc_attr__("Generate Featured AI image of :", 'gizzmo-ai'); ?> <span id="ai_image_generation_addon"></span><input placeholder="e.g a Collection of Holidy Gifts" type="text" id="ai_image_theme" style="width:280px" /></div>
                    ...
                    <li>
                        <div class="label"><button class='btn step_circle'><i></i></button>
                        <h4><b style="color:#333"><?php echo esc_attr__("STEP 6", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Finish.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc">
                            <div class="key_phrase_wrapper" style="margin-top: 10px;">
    ...
    <input type="hidden" id="main_content_type" name="main_content_type" value="Roundup">
            ...
            <div class="media_row lower-row">
                ...
                <div style="width:90%;overflow-x:auto;height: 125px;">
                    <div style="width:1200px;height:100px; text-align:left">
                        ...
                        <div id="images_placeholder_spinner_loader" style="padding-left: 320px;" >
                            <svg style="width: 100px;height: 100px;display: inline;" version="1.1" id="L9" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            viewBox="0 0 100 100" enable-background="new 0 0 0 0" xml:space="preserve">
                                <path fill="#5a10b9" d="M73,50c0-12.7-10.3-23-23-23S27,37.3,27,50 M30.9,50c0-10.5,8.5-19.1,19.1-19.1S69.1,39.5,69.1,50">
                                <animateTransform 
