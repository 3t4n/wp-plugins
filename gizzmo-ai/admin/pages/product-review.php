...
<body class="bg-gray-100">
                ...
                <div class="tab-panels" style="min-width: 585px;">
                    <section id="your_products" class="tab-panel">
                        ...
                        <div id="promotion-div" class="promotion-div" style="display:none">
                            <h2 style="font-weight:bold"><?php echo esc_attr__("Can't Find the Product You Want?", 'gizzmo-ai'); ?></h2>
        ...
        <div class="three-fourths">
            <div id="action_placeholder" class="action_placeholder">
                <div class="action_placeholder_header">
                    <h4><?php echo esc_attr__("Product Review", 'gizzmo-ai'); ?></h4>
                </div>
                ...
                <div id="action_placeholder_msg" class="action_placeholder_msg">
                    <span><?php echo esc_attr__("Select a product from the list to start creating a review.", 'gizzmo-ai'); ?></span>
                </div>
            </div>
            <div id="steps_wrapper" class="steps-widget steps_older">
                <div class="steps-meta">
                    <div id="product_review_selected" class="product_review_selected">
                        <img id="preview_product_review_img" src="" alt="Product Thumbnail" class="product-thumbnail">
                        <span id="preview_product_review_name" class="product-name"></span>
                    </div>
                </div>
                <ul class="steps-list">
                    <li class="active current">
                        <div id="first_step" class="label" style="border-top-left-radius: 8px;border-top-right-radius: 8px;"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 1", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- SEO Keyphrase and Content Theme.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc" >
                    ...
                    <li>
                        <div class="label"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 2", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Additional Content Settings.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc">
                            ...
                            <ul class="gizzmo_list-item-list" style="margin-top: 20px;">
                                ...
                                <li class="gizzmo_list-item">
                                    <input class="theme_radio" type="checkbox" id="pros_cons" name="pros_cons" />
                                    <label for="pros_cons" class="gizzmo_list-title"><?php echo esc_attr__("Generate Pros & Cons Section", 'gizzmo-ai'); ?> <span id="pros_cons_addon"></span></label>
                                    <div class="gizzmo_list-description"><?php echo esc_attr__("Create a balanced list detailing the advantages and disadvantages of the product or topic to provide a comprehensive overview.", 'gizzmo-ai'); ?></div>
                                </li>
                                <li class="gizzmo_list-item">
                                ...
                                <hr/>
                                <li class="gizzmo_list-item">
                                    <input class="theme_radio" type="checkbox" id="schemas" name="schemas" />
                                    <label for="schemas" class="gizzmo_list-title"><?php echo esc_attr__("Create SEO Schemas", 'gizzmo-ai'); ?> <span id="schemas_addon"></span></label>
                                    <div class="gizzmo_list-description"><?php echo esc_attr__("Schemas for SEO are structured data markup that helps search engines understand and display content more effectively in search results.", 'gizzmo-ai'); ?></div>
                                </li>
                                <li class="gizzmo_list-item">
                    ...
                    <li>
                        <div class="label"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 3", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Monetization and Affiliate.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc" >
                            ...
                            <div class="key_phrase_wrapper" style="margin-top: 10px;">
                                ...
                                <div class="gizzmo_input_holder">
                                    ...
                                    <span id="add_affiliate_tag"  style="color: rgb(255, 255, 255);border: 1px solid rgb(90, 16, 185);border-radius: 3px;padding: 10px 20px;margin-top: -1px;background-color: rgb(90, 16, 185);display: block;float: left;margin-left: 10px;cursor: pointer;"><?php echo esc_attr__("Add Affiliate Tag", 'gizzmo-ai'); ?></span>
                                </div>
                                <div class="gizzmo_input_title">
                    ...
                    <li>
                        <div class="label"><button class='btn step_circle'><i></i></button>
                            <h4><b style="color:#333"><?php echo esc_attr__("STEP 4", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Featured Image.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc">
                            ...
                            <div class="media_placeholder">
                                <div class="media_left-side">
                                    ...
                                    <div class="media_row lower-row">
                                        <div class="row-title gizzmo_input_title" style="font-weight: 400;"><?php echo esc_attr__("Select Featured image from Product Images", 'gizzmo-ai'); ?></div>
                                        <div class="image-row">
                                            <div class="image-container">
                                                <img id="option_image_1" class="option_image selected" src="<?php echo plugin_dir_url( __FILE__ ) . 'images/300x200_image.svg'; ?>" alt="Image 1">
                                            </div>
                                            <div class="image-container">
                                                <img id="option_image_2" class="option_image" src="<?php echo plugin_dir_url( __FILE__ ) . 'images/300x200_image.svg'; ?>" alt="Image 2">
                                            </div>
                                            <div class="image-container">
                                                <img id="option_image_3" class="option_image" src="<?php echo plugin_dir_url( __FILE__ ) . 'images/300x200_image.svg'; ?>" alt="Image 3">
                                            </div>
                                            <div class="image-container">
                                                <img id="option_image_4" class="option_image" src="<?php echo plugin_dir_url( __FILE__ ) . 'images/300x200_image.svg'; ?>" alt="Image 4">
                                            </div>
                                            <div class="image-container">
                                                <img id="option_image_5" class="option_image" src="<?php echo plugin_dir_url( __FILE__ ) . 'images/300x200_image.svg'; ?>" alt="Image 5">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="media_row lower-row">
                    ...
                    <li>
                        <div class="label"><button class='btn step_circle'><i></i></button>
                        <h4><b style="color:#333"><?php echo esc_attr__("STEP 5", 'gizzmo-ai'); ?></b> <?php echo esc_attr__("- Target Audience, Content Tone & language.", 'gizzmo-ai'); ?></h4>
                        </div>
                        <div class="desc">
                            <div class="key_phrase_wrapper" style="margin-top: 10px;">
    ...
    <input type="hidden" id="main_review_asin" name="main_review_asin" value="">
    ...
    <input type="hidden" id="main_content_type" name="main_content_type" value="Review">
    ...
    <!-- Promotion Modal -->
    <div id="promotionModel" class="modal">
        <div class="modal-content" style="display: flex">
            <div class="left_side" style="width:50%">
            <div class="pop-promotion-container">
                <span style='font-size: 40px;position: relative;top: 20px;left: 105px;'>&#127881;</span>
                <img style="margin-bottom: 9px !important;"  src="<?php echo plugin_dir_url( __FILE__ ) . 'images/gizzmo_logo.svg'; ?>" alt="Gizzmo Logo">
                <p style="color: #5a10b9;"><?php echo esc_attr__("Exclusive 24-Hour Full Access!", 'gizzmo-ai'); ?> </p>
                <p style="font-size:14px; font-weight:normal;padding-right:15px">For the next 24 hours, you’ll enjoy <b style="color: #5a10b9;">Free access to all premium features and tools</b>. Explore everything Gizzmo.ai has to offer before returning to the Free plan. Upgrade anytime to keep these powerful features!</p>
                <button type="button" class="modal-button cancel" style="color: #ffffff;border: 1px solid #5a10b9;border-radius: 3px;padding: 4px;padding-left: 20px;padding-right: 20px;background-color: #5a10b9;" onclick="closeModal('promotionModel')"><?php echo esc_attr__("Let's Start &#127873;", 'gizzmo-ai'); ?></button>
            </div>    
            </div>
            <div class="right_side"  style="width:50%">
    ...
    <script src="<?php echo plugin_dir_url( __FILE__ ) . 'js/g_gizzmo.js?v=' . filemtime( plugin_dir_path( __FILE__ ) . 'js/g_gizzmo.js' ); ?>"></script>
    <script src="<?php echo plugin_dir_url( __FILE__ ) . 'js/g_gizzmo_addons.js?v=' . filemtime( plugin_dir_path( __FILE__ ) . 'js/g_gizzmo_addons.js' ); ?>"></script>
