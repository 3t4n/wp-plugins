=== Sirve - Simple Directory Listing ===
Contributors: hasthemes,htplugins,mahamudur78,zenaulislam,tarekht,aslamhasib
Tags: sirve, listings, reviews, service, wp listings
...
Create listings of services or products smoothly with tons of customization options. Manage your product and service listings in a professional way!
...
== Changelog ==
= Version: 1.0.9 - Date: 20-11-2022 =
* Implemented "dofollow/nofollow" feature to the plugin's button.
* Security improvement for external link.

= Version: 1.0.8 - Date: 07-11-2022 =
* Compatibility with the latest WordPress version.

= Version: 1.0.7 - Date: 13-10-2022 =
* Added: Parameter has been added for shortcode style option.
* Added: Category and Tags archive page has been added. 
* Added: Grid control option has been added to plugin settings page.
* Added: Recommendation plugins Menu has been added.
* Fixed: Minor bug fixed.

= Version: 1.0.6 - Date: 07-09-2022 =
* Added: Event Taxonomy for services.
* Improved: Pagination options.

= Version: 1.0.5 - Date: 27-07-2022 =
* Added: Sirve "Except" add option.

= Version: 1.0.4 - Date: 21-04-2022 =
* Fixed: Search SVG Icon Double Slash Remove
* Modified: Taxonomy Name and Tags Label modified. 

= Version: 1.0.3 - Date: 03-01-2022 =
* Added: New Taxonomy "Tags"
* Added: Taxonomy permalink change options

= Version: 1.0.2 - Date: 28-12-2021 =
* Added: All Listing tab label change option

= Version: 1.0.1 - Date: 21-12-2021 =
* Added: Support gutenberg editor

= Version: 1.0.0 - Date: 30-11-2021 =
* Initial release

== Installation ==
This section describes how to install the Sirve plugin and get it working.
...
= OR: =
1. Unzip (if it is zipped) and Upload `sirve` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

== Screenshots ==
1. Sirve Archive Page Style 1
2. Sirve Archive Page Style 2
3. Sirve Archive Page Style 3
4. Sirve Archive Page Style 4
5. Single List 
6. Sirve List Page
7. Add New Page
8. General Settings Page
9. Style Settings Page
10. Gutenberg editor
