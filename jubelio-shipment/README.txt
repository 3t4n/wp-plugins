...
== Changelog ==
= 1.8.7 =
* Add - Add feature create awb, print label, track package, and cancel awb
= 1.8.6 =
* Fix - Fix shipping promotion
= 1.8.5 =
* Fix - Fix some bugs
= 1.8.4 =
* Fix - Change total price with price after discount
* Fix - Fix some bugs
= 1.8.3 =
* Add - Add feature multiorigin ( for jubelio store only )
= 1.8.2 =
