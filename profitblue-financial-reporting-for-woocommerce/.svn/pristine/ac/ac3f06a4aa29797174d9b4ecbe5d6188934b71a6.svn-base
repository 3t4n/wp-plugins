...
class AjaxProductsGetModal {
	...
	public static function handle() {
		...
		$download_url = admin_url() . 'admin.php?page=products&download-csv=products&period=' . $period;
		$hiddens = '';
		
		$html = '';
		$html .= '<div class="bulk-cogs-header">';
			$html .= '<h3>' . esc_html__( 'Download Product export', 'profitblue-financial-reporting-for-woocommerce' ) . '</h3>';
		$html .= '</div>';
		$html .= '<div class="bulk-cogs-body">';
			$html .= '<div class="bulk-cogs-body-item" style="grid-template-columns:1fr;">';
				$html .= '<div class="bulk-cogs-body-label">';
					$html .= '<span>' . esc_html__( 'Download the product list (XSLX)', 'profitblue-financial-reporting-for-woocommerce' ) . '</span>';
