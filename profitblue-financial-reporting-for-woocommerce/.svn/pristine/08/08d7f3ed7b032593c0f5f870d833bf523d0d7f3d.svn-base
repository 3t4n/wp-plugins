...
/**
 * ProductsPeriodsController
 */
class ProductsPeriodsController {
	 ...
	 * @return array|false
	 */
	public function get_order_period( $order_date ) {
	...
	public function create_custom_periods( $date_start, $date_end, $year ) {
		...
		$result = $this->wpdb->insert(
			$this->wpdb->prefix . 'profitblue_products_periods',
			$data
		);
	 ...
	 * @return int|false
	 */
	public function create_period( $name, $type, $year ) {
