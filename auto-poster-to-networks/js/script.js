jQuery(document).ready(function ($) {
    ...
    $('.edit-network').click(function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hsauto_details_of_bluesky_network_hs',
    ...
    $('#add-network-submit').click(function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hsauto_connect_bluesky_network_hs',
    ...
    $('#update-network-submit').click(function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hsauto_modify_blueskynetwork_details_hs',
                network_id: networkId,
                network_name: networkName,
                username: username,
                password: password,
    ...
    $('.delete-network').click(function () {
        ...
        if (confirm('Are you sure you want to delete this network?')) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'hsauto_bluesky_delete_network_hs',
                    network_id: networkId,
                    nonce: blueskyPoster.nonce,
                },
                success: function (response) {
    ...
    $('.toggle-status').on('change', function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hsauto_toggle_blueskynetwork_status_hs',
                network_id: networkId,
                status: isActive,
...
$('#action-button').on('click', function () {
    ...
    $('.network-icon.selected').each(function () {
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                action: 'hsauto_bluesky_submit_post_hs',
                nonce: blueskyPoster.nonce,
                message: message,
                media_url: mediaUrl,
        ...
        $('#edit-post-message, #edit-post-network, #edit-post-schedule-time').on('click', function (e) {
            ...
            $('.edit-post').on('click', function (e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        action: 'hsauto_driving_schedule_post_data_hs',
                        post_id: postId,
                        nonce: blueskyPoster.nonce,
                    },
                    success: function (response) {
            ...
            $('#update-post-submit').on('click', function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        action: 'hsauto_modifly_schedule_post_details_hs',
                        post_id: postId,
                        message: message,
