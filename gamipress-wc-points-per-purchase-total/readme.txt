...
GamiPress - WooCommerce Points Per Purchase Total let's you award a percent of the [WooCommerce](http://wordpress.org/plugins/woocommerce/ "WooCommerce") purchase total as [GamiPress](http://wordpress.org/plugins/gamipress/ "GamiPress") points.
...
* [WooCommerce integration](https://gamipress.com/add-ons/woocommerce-integration/)
...
* **Improvements**
* Added option to reward based on subtotal order with shipping.
