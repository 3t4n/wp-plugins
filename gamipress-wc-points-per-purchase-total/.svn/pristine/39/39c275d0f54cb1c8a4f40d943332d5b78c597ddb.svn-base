...
function gamipress_wc_points_per_purchase_total_meta_boxes() {
    ...
    gamipress_add_meta_box(
        ...
        array(
            ...
            $prefix . 'checkout' => array(
                'name' 	    => __( 'Apply percentage to the purchase:', 'gamipress-wc-points-per-purchase-total' ),
                'desc' 	    => __( 'Total: Applies the percentage to the purchase total including taxes & shipping.', 'gamipress-wc-points-per-purchase-total' )
                    . '<br>' . __( 'Subtotal: Applies the percentage to the purchase subtotal, without taxes & shipping.', 'gamipress-wc-points-per-purchase-total' ),
                'type' 	    => 'select',
                'default'   =>'total',
                'options'   => array(
                    'total'     => __( 'Total', 'gamipress-wc-points-per-purchase-total' ),
                    'subtotal'  => __( 'Subtotal', 'gamipress-wc-points-per-purchase-total' ),
                    'shipping'  => __( 'Subtotal with shipping', 'gamipress-wc-points-per-purchase-total' ),
                ),
            ),
