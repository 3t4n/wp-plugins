...
function DSOCF7_load_script_style(){
    wp_enqueue_script( 'jquery-select', DSOFCF7_PLUGIN_DIR . '/public/js/select2.min.js', array('jquery'), '2.0');
    wp_enqueue_script( 'jquery-selects', DSOFCF7_PLUGIN_DIR. '/public/js/design.js', array('jquery'), '1.0');
    
    wp_localize_script( 'jquery-selects', 'selects_ajax', array( 'ajax_urla' => DSOFCF7_PLUGIN_DIR) );

    wp_enqueue_style( 'jquery-selects-style', DSOFCF7_PLUGIN_DIR. '/public/css/select2.min.css', '', '3.0' );
