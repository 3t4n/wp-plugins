...
$mode = WaicUtils::getArrayValue($fCustom, 'mode', 'fixed');
...
<div class="wbw-settings-form row">
	...
	<div class="wbw-settings-fields col-10">
		<img src="<?php echo esc_url(WAIC_IMG_PATH . '/info.png'); ?>" class="wbw-tooltip" title="<?php esc_html_e('Choose how custom fields for the article will be assigned. Options include Fixed, where you can enter an exact value for the custom field, or Generate based on article, where the custom field value will be generated based on the article content, selected type, and desired length.', 'ai-copilot-content-generator'); ?>">
		<?php 
...
$hidden = $mode == 'generate' ? '' : ' wbw-hidden';
?>
...
<div class="wbw-settings-form row<?php echo esc_attr($hidden); ?>" data-parent-select="<?php echo esc_attr($prefix); ?>[mode]" data-select-value="generate">
	...
	<div class="wbw-settings-fields col-10">
		<img src="<?php echo esc_url(WAIC_IMG_PATH . '/info.png'); ?>" class="wbw-tooltip" title="<?php esc_html_e('Provide a description in your own words of what this field does or is used for. This will help generate the correct value for the selected custom field of the article.', 'ai-copilot-content-generator'); ?>">
		<?php 
