...
<div class="wbw-success-block">
	...
	<div class="wbw-alert-info"><?php echo sprintf(esc_html__('PRO version of %s plugin is activated and working fine!', 'ai-copilot-content-generator'), esc_html(WAIC_WP_PLUGIN_NAME)); ?></div>
</div>
<?php } else if ($isExpired) { ?>
<div class="wbw-alert-block">
	<div class="wbw-alert-title"><span>!</span> <?php echo sprintf(esc_html__('Your license for PRO version of %s plugin - expired.', 'ai-copilot-content-generator'), esc_html(WAIC_WP_PLUGIN_NAME)); ?></div>
	<div class="wbw-alert-info"><?php echo sprintf(esc_html__('You can %s to extend your license, then - click on "Re-activate" button to re-activate your PRO version.', 'ai-copilot-content-generator'), '<a href="' . esc_url($this->extendUrl) . '" target="_blank">click here</a>'); ?></div>
</div>
<?php } else { ?>
<div class="wbw-alert-block">
	<div class="wbw-alert-title"><span>!</span> <?php echo sprintf(esc_html__('Congratulations! You have successfully installed PRO version of %s plugin.', 'ai-copilot-content-generator'), esc_html(WAIC_WP_PLUGIN_NAME)); ?></div>
