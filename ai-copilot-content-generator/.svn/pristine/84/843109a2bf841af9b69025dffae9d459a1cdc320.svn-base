...
$mode = WaicUtils::getArrayValue($fTags, 'mode', 'fixed');
?>
<div class="wbw-settings-form row">
	...
	<div class="wbw-settings-fields col-10">
		<img src="<?php echo esc_url(WAIC_IMG_PATH . '/info.png'); ?>" class="wbw-tooltip" title="<?php esc_html_e('Choose how tags for the article will be assigned. Options include Fixed, where you can select existing tags, or Generate based on article, where a specified number of tags will be generated based on the article content.', 'ai-copilot-content-generator'); ?>">
		<?php 
