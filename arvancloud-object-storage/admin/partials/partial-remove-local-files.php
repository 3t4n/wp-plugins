<form method="post"
    ...
    <div id="obs-form-acceptance" class="obs-modal-wrapper">
        <div class="obs-modal obs-modal-alert" id="form-acceptance">
            ...
            <div class="obs-modal-desc-small"><?php _e('All local files will be deleted', 'arvancloud-object-storage'); ?></div>
            ...
            <div class="obs-modal-actions">
                ...
                <button name="submit-form-acceptance" class="obs-btn-danger disabled" id="submit-form-acceptance"
                        data-action="do_bulk_remove"
                        data-statusaction="get_bulk_remove_task_status"
                        onclick="return false;"> <?php _e('Delete', 'arvancloud-object-storage'); ?> </button>
            </div>
        </div>
        ...
        <div class="obs-content-wrapper" id="task-status-modal" style="display: none">
            <div class="obs-modal obs-modal-progress">
                ...
                <div class="obs-modal-desc"><?php _e('Delete process is in progress', 'arvancloud-object-storage'); ?></div>
                ...
                <div class="obs-modal-actions">
                    ...
                    <button class="obs-btn-primary" onclick="return false;"
                            data-action="stop_current_bulk_remove_task"
