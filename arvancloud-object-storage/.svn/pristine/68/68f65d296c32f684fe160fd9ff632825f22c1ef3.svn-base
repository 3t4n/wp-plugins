<form method="post"
    ...
    <div id="obs-form-acceptance" class="obs-modal-wrapper">
        <div class="obs-modal obs-modal-alert" id="form-acceptance">
            ...
            <div class="obs-modal-desc"><?php _e('Delete all remote bucket files', 'arvancloud-object-storage'); ?></div>
            <div class="obs-modal-desc-small"><?php _e('All files in your bucket will be deleted', 'arvancloud-object-storage'); ?></div>
            ...
            <div class="obs-modal-confirm d-flex items-center justify-center">
                ...
                <label for="form-acceptance-accept"><?php _e('I\'m sure of deleting files', 'arvancloud-object-storage'); ?></label>
            </div>
            ...
            <div class="obs-modal-actions">
                ...
                <button name="submit-form-acceptance" class="obs-btn-danger disabled" id="submit-form-acceptance"
                        data-action="do_empty_bucket"
                        data-statusaction="get_empty_current_bucket_task_status"
                        onclick="return false;"> <?php _e('Delete all', 'arvancloud-object-storage'); ?> </button>
            </div>
        </div>
        ...
        <div class="obs-content-wrapper" id="task-status-modal" style="display: none">
            <div class="obs-modal obs-modal-progress">
                ...
                <div class="obs-modal-desc"><?php _e('Bucket purge task is in progress', 'arvancloud-object-storage'); ?></div>
                ...
                <div class="obs-modal-actions">
                    ...
                    <button class="obs-btn-primary" onclick="return false;"
                            data-action="stop_current_bucket_emptying_task"
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        update_progress_form('get_empty_current_bucket_task_status');
