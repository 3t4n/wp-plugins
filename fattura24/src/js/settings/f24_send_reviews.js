 ...
 *
 * Script legato al box 'Come valuteresti Fattura24?'
 * nelle impostazioni generali del modulo. 
 * Salva la valutazione nel db delle opzioni
 */
...
window.addEventListener('load', () => {
    ...
    reviewBoxArray.forEach(box => {
        ...
        rating.addEventListener('click', function(){
            ...
            window.open('https://wordpress.org/support/plugin/fattura24/reviews/', '_blank');
        });
    });
...
// click sul radio button specifico
    ...
    function sendReview(ratingValue) {
        ...
        * il testo è una stringa codificata in json
        */
