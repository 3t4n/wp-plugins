 ...
 *
 * Chiamata API SaveDocument
 * aggiornamento postmeta contenenti la risposta alla chiamata
 */
...
function fatt_24_store_fattura24_doc($order, $docType, $creationTime)
{
    ...
    $err_message = sanitize_text_field($order_to_xml_result['fatt_24_error']['message']);
