...
Contributors: syarifstudio
Tags: figma converter, figma to wordpress, block animation, parallax animation, gutenberg animation
...
Animation and figma converter for gutenberg block.
...
[Figma plugin](https://www.figma.com/community/plugin/1259821200791182652)

[Figma samples file](https://www.figma.com/community/file/1219938435849951256)

[Buy Pro Version](https://payhip.com/b/Wro0l/)
...
1. Upload `advanced-addons.zip` to the `/wp-content/plugins/` directory
2. Extract the zip file
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Add animation using gutenberg editor

== Screenshots ==

1. Advanced animation timeline editor
2. Advanced animation parallax settings
