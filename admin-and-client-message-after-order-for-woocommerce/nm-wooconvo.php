...
define('WOOCONVO8_VERSION', '13.5' );
define('WOOCONVO8_SHORTNAME', 'wooconvo' );

define('WOOCONVO8_REACT_JS', 'main.66b1324c.js' );
define('WOOCONVO8_REACT_CSS', 'main.9f60532c.css' );
define('WOOCONVO8_REACT_SINGLE_JS', 'main.e0db322b.js' );
define('WOOCONVO8_REACT_SINGLE_CSS', 'main.fa094ed3.css' );
