...
#############################################################################################
    ...
    add_action('init', 'woo_fattureincloud_textdomain');
...
if (!class_exists('woo_fattureincloud')) : {
    ...
    class woo_fattureincloud
    {
        ...
        public function __construct()
        {
                ...
                add_action('admin_notices', array($this, 'wfic_display_checkout_page_blocks'));
        ...
        function wfic_display_checkout_page_blocks() {

            if ( get_transient( 'wfic_check_block_checkout') == 1) {
                echo '<div class="notice notice-error is-dismissible">';
                echo '<p>' . __( '<b>WooCommerce Fattureincloud MSG</b>: Checkout WooCommerce a blocchi da correggere come illustrato nella <a href=\'https://woofatture.com/docs/checkout\'>Documentazione</a>', 'woo-fattureincloud' ) . '</p>';
                echo '</div>';
            }
