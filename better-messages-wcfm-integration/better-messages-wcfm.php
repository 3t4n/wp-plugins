    ...
    function bpbm_wcfm_fs()
    {
        ...
        if ( !isset( $bpbm_wcfm_fs ) ) {
            ...
            if ( file_exists( dirname( plugin_dir_path( __FILE__ ) ) . '/bp-better-messages/inc/freemius/start.php' ) ) {
                ...
                if ( file_exists( dirname( plugin_dir_path( __FILE__ ) ) . '/bp-better-messages-websocket/inc/freemius/start.php' ) )   {
                    // Try to load SDK from premium parent plugin folder.
                    require_once dirname( plugin_dir_path( __FILE__ ) ) . '/bp-better-messages-websocket/inc/freemius/start.php';
                } else {
