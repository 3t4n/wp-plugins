...
use function chmod;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\ArrayDefinition;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\DecoratorDefinition;
...
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Source\DefinitionSource;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \SuperAdventCalendar\Vendor_Prefixed\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition
     */
