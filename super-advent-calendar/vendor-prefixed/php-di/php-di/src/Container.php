...
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\FactoryDefinition;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Helper\DefinitionHelper;
...
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Resolver\DefinitionResolver;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Resolver\ResolverDispatcher;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Source\DefinitionArray;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Source\MutableDefinitionSource;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Source\ReflectionBasedAutowiring;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\Source\SourceChain;
use SuperAdventCalendar\Vendor_Prefixed\DI\Definition\ValueDefinition;
use SuperAdventCalendar\Vendor_Prefixed\DI\Invoker\DefinitionParameterResolver;
use SuperAdventCalendar\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\Invoker;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\InvokerInterface;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\ParameterResolver\AssociativeArrayResolver;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\ParameterResolver\DefaultValueResolver;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\ParameterResolver\NumericArrayResolver;
use SuperAdventCalendar\Vendor_Prefixed\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \SuperAdventCalendar\Vendor_Prefixed\DI\get().
     *
