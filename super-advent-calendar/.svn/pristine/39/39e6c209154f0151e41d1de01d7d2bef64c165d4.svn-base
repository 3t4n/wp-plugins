...
namespace SuperAdventCalendar\Vendor_Prefixed\Laravel\SerializableClosure\Signers;

use SuperAdventCalendar\Vendor_Prefixed\Laravel\SerializableClosure\Contracts\Signer;
