...
use SuperAdventCalendar\Controllers\ShortcodeController;
...
return array(
	...
	ShortcodeControllerInterface::class => SuperAdventCalendar\Vendor_Prefixed\DI\autowire( ShortcodeController::class ),
