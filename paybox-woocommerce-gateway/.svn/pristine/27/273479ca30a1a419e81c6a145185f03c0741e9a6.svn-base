...
function pbx_isWoocommerceActive()
{
...
define('WC_PAYBOX_VERSION', '0.9.9.6');
...
function woocommerce_paybox_initialization()
{
    ...
    if (!class_exists($class)) {
        ...
        require_once(dirname(__FILE__).'/class/wc-paybox-iso3166-country.php');
