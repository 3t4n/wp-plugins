...
if ( isset( $_POST['submit'] ) ) {
	...
	$this->edc_save_options();
}
?>
<style> .indent {padding-left: 2em} </style>
<div class="wrap">
	<h1><?php _e( 'Enable Disable Comments Settings', 'disable-comments-rb'); ?></h1>
	<p>
		<?php _e('', 'disable-comments-rb') ;?>
	</p>
		...
		<ul>
			...
			<li>
				<label for="rb_disable_comments_off">
					...
					<strong>
						<?php _e( 'Enable all site Comments', 'disable-comments-rb'); ?>
					</strong>
				</label>
			</li>
		</ul>
