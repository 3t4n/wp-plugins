...
if (!file_exists($filekey)) {
	echo '<b>[Error: no secret key generated]</b>';
	die();
}
require('cleanfolder-key.php');	

#=============================================================================
$adv = '<b>Clean Folder</b> <a target="_blank" href="http://byrev.org/">ByREV</a> PHP Script  ...  <i><a target="_blank" href="http://publicphoto.org/">Public Domain Photos</a>  |  <a target="_blank" href="http://blackip.org/">RBL Check</a></i>';
if ( (!isset($_REQUEST['key'])) OR ($_REQUEST['key'] != PASSKEY) ) { ?>
	<html>
	<head>
	...
	<hr>
	<i><b style="background: red; color: yellow;">~~~ PASSKEY is defined in script file! ~~~</b></i>
	<div style="margin: 5px; border-top: 1px dotted #ccc; height: 4px;"> </div>
	<?=$adv;?>
	</div>
	</form>
