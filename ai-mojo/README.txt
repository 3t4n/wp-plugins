...
Contributors: wpaimojo
Requires at least: 5.0.0
Requires PHP: 7.4
Tested up to: 6.7.1
Stable tag: 0.9.4
Tags: gpt-3,gpt3,ChatGPT,AI,openai,AI21,Jurassic-1,ai writing assistance,ai content generation
...
1. You first need to sign up for an account at [OpenAI](https://beta.openai.com) or [AI21 Studio](https://studio.ai21.com) to get the API key for their AI engines (GPT-3 or Jurassic-1).
...
No you can't. You must sign up for an account at [OpenAI](https://beta.openai.com) or [AI21 Studio](https://studio.ai21.com) to get their respective API key in order to use this plugin.
...
AI Mojo will add a new menu called "AI Mojo" in your admin dashboard. From here you can configure all plugin settings there.
