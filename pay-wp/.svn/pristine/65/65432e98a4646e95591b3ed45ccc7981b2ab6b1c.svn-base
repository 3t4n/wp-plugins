...
class Inflectible
{
    ...
    {
        yield new Transformation(new Pattern('/ú([sn])$/i'), 'WPPayVendor\u\1es');
        yield new Transformation(new Pattern('/ó([sn])$/i'), 'WPPayVendor\o\1es');
        yield new Transformation(new Pattern('/í([sn])$/i'), 'WPPayVendor\i\1es');
        yield new Transformation(new Pattern('/é([sn])$/i'), 'WPPayVendor\e\1es');
        yield new Transformation(new Pattern('/á([sn])$/i'), 'WPPayVendor\a\1es');
