=== Table of content - User friendly and fully automatic way to create and display a table of contents ===
...
* German (Germany) translation provided by internetfreak, ChristopherKbel, GLassnig, K.R.Lembach
...
* Update; WordPress 6.4.3 compatibility.
