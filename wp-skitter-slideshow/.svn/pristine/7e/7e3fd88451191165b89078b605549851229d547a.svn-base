...
Plugin URI: http://skitter-slider.net
...
function init_load()
{
    ...
    wp_enqueue_script('jquery.skitter', WP_PLUGIN_URL . '/wp-skitter-slideshow/js/jquery.skitter.min.js', array('jquery'));
...
function show_skitter() 
{
  ...
  <style type="text/css">
    .skitter { 
      max-width: <?php echo $width_skitter; ?>px;
  ...
  if (!empty($skitter_images) || isset($skitter_xml)) {
    ...
    $skitter_class = 'skitter skitter-wp';

    if (strpos($options, 'dots: true') !== false) {
      $skitter_class .= ' with-dots';
    }
      
    ?>
    <div class="skitter-box">
      <div id="wp_skitter" class="<?php echo $skitter_class; ?>">
        <?php
...
<style type="text/css" rel="stylesheet" media="all">
  ...
  tr.option-box { border-top:1px solid #ddd; }
</style>
  ...
  <form method="post" action="options.php" id="form_skitter">
    ...
    <div id="tab_posts_sk" class="tab_item_sk<?php echo $tab_selected_posts;?>">
      <table class="form-table">
        ...
        <tr valign="top" class="option-box">
    ...
    <div id="setting_advanced">
      ...
      <table class="form-table">
        ...
        $data = array(
          ...
          array('label_animation', 'Label animation', 'slideUp', "slideUp, left, right, fixed"),
          array('width_label', 'Width label', "null", "300px"),
          array('easing_default', 'Easing default', 'null', "easeOutBack"),
          array('hide_tools', 'Hide numbers and navigation', "false", "true"),
        ...
        foreach($data as $linha) 
        {
          ...
          <tr valign="top" style="background-color:#fff;border-bottom:1px solid #ccc;">
            <td>Default: <strong><?php echo $linha[2];?></strong></td>
    ...
    <h3>Need help?</h3>
    <p>
      <a href="http://skitter-slider.net/options.html" target="_blank">See Skitter documentation</a>
    </p>
  </form>
</div>
<?php 
