...
namespace KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\Compatibility\Abstracts;

use KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\Interfaces\GiftCardCompatibilityInterface;
use KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\KrokedilWooCommerce;
use KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\Order\OrderLineCoupon;
use KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\OrderLineData;
/**
