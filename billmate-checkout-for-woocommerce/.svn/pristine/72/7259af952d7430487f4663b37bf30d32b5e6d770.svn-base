 ...
 */
namespace KrokedilQvicklyCheckoutDeps\Composer;

use KrokedilQvicklyCheckoutDeps\Composer\Autoload\ClassLoader;
use KrokedilQvicklyCheckoutDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('KrokedilQvicklyCheckoutDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
