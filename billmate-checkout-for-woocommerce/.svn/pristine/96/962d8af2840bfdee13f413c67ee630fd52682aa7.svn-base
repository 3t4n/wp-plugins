...
namespace KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\Tests\Compatibility\GiftCards;

use KrokedilQvicklyCheckoutDeps\Krokedil\WooCommerce\Compatibility\Giftcards\YITHGiftCards;
...
class YITHGiftCardsTest extends TestCase
{
    ...
    public function setUp() : void
    {
        ...
        $this->mock_package = $this->getMockBuilder('KrokedilQvicklyCheckoutDeps\\Krokedil\\WooCommerce\\KrokedilWooCommerce')->disableOriginalConstructor()->getMock();
