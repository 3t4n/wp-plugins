	...
	<?php
      ...
      <table width="100%" class="widefat" id="straymanage">
		...
		<tbody>
			...
			{ 
				?><tr><td colspan="4" align="center"><?php _e('No records available.', 'deal-or-announcement-with-countdown-timer'); ?></td></tr><?php 
			} 
			?>
		</tbody>
        </table>
		...
		<div>
			  <a href="<?php echo WP_deal_ADMIN_URL; ?>&amp;ac=add"><input class="button action" type="button" value="<?php _e('Add New', 'deal-or-announcement-with-countdown-timer'); ?>" /></a>
			  <a href="<?php echo WP_deal_ADMIN_URL; ?>&amp;ac=set"><input class="button action" type="button" value="<?php _e('Setting', 'deal-or-announcement-with-countdown-timer'); ?>" /></a>
			  <a target="_blank" href="<?php echo WP_deal_FAV; ?>"><input class="button action" type="button" value="<?php _e('Help', 'deal-or-announcement-with-countdown-timer'); ?>" /></a>
		</div>
		<br />
		<p class="description">
