...
if (isset($_POST['gCountform_submit']) && $_POST['gCountform_submit'] == 'yes')
{
	...
	$form['gCount'] = isset($_POST['gCount']) ? wp_filter_post_kses($_POST['gCount']) : '';
	if ($form['gCount'] == '')
	{
	...
	$form['gCountdisplay'] = isset($_POST['gCountdisplay']) ? sanitize_text_field($_POST['gCountdisplay']) : '';
	if($form['gCountdisplay'] != "YES" && $form['gCountdisplay'] != "NO")
	{
		$form['gCountdisplay'] = "YES";
	}
	
	$form['gCountmonth'] = isset($_POST['gCountmonth']) ? intval($_POST['gCountmonth']) : '';
	$form['gCountdate'] = isset($_POST['gCountdate']) ? intval($_POST['gCountdate']) : '';
	$form['gCountyear'] = isset($_POST['gCountyear']) ? intval($_POST['gCountyear']) : '';
	$form['gCounthour'] = isset($_POST['gCounthour']) ? intval($_POST['gCounthour']) : '';
	
	$form['gCountzoon'] = isset($_POST['gCountzoon']) ? sanitize_text_field($_POST['gCountzoon']) : '';
	if($form['gCountzoon'] != "AM" && $form['gCountzoon'] != "PM")
	{
		$form['gCountzoon'] = "AM";
	} 
