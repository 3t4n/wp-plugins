...
<div class="wrap">
  <div class="form-wrap">
	...
	if (isset($_POST['gCount_form_submit']) && $_POST['gCount_form_submit'] == 'yes')
	{
		...
		$deal_or_announcement_with_countdown_timer_title = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_title']));
		$deal_or_announcement_with_countdown_timer_timer_color = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_timer_color']));
		$deal_or_announcement_with_countdown_timer_timer_align = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_timer_align']));
		$deal_or_announcement_with_countdown_timer_text_color = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_text_color']));
		$deal_or_announcement_with_countdown_timer_text_align = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_text_align']));
		$deal_or_announcement_with_countdown_timer_caption = stripslashes(sanitize_text_field($_POST['deal_or_announcement_with_countdown_timer_caption']));
    ...
    <form name="ssg_form" method="post" action="">
      ...
      <select name="deal_or_announcement_with_countdown_timer_text_align" id="deal_or_announcement_with_countdown_timer_text_align">
		...
		<option value="" <?php if($deal_or_announcement_with_countdown_timer_text_align=='') { echo 'selected="selected"' ; } ?>></option>
	  </select>
