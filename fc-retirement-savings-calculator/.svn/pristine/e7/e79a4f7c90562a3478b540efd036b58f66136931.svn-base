...
Donate link: N/A
Tags: retirement calculator, retirement savings calculator, investments, retirement planning
...
The **[AC Retirement Savings Calculator (try it now!)](https://AccurateCalculators.com/calculator-plugins/retirement-savings-plugin)** creates date-based investment schedules and charts. Calculate the periodic investment amount you'll need to make to reach your retirement goal.

**Supports 90 currencies, six date formats, and 15 languages.** 

Now highly customizable via extensive configuration options.

Choose from four predefined sizes or customize via configuration options. Fully responsive with touch support.
...
__NEW:__ Upgrade to the free [AC Retirement Savings Calculator Plus](https://accuratecalculators.com/calculator-plugins/retirement-savings-plus-plugin) v2.0 for a printable investment schedule.


== Installation ==

You can either (a) upload the *fc-retirement-savings-calculator* folder with all its files to the */wp-content/plugins/* directory, or (b) unzip the plugin's zip file directly into the */wp-content/plugins/* directory.
...
1. Add the shortcode *[fcretiresavingsplugin]* in the content area of your page or post and optionally configure the shortcode parameters. WordPress v5.8 introduced the block editor. To install this plugin as a widget in WordPress v5.8 or later, first install the widget shortcode block and then copy this plugin's shortcode into it.
...
The values available for template options are the same as the shortcodes above except you must change "sc_" to "op_".
...
1. When branding, the brand name will be added before "Retirement Savings Calculator".
1. If _custom_style is set to "Yes", the plugin will load css/accurate-calculators-custom.css located in the plugin's DIST/CSS folder. You can modify the styles as needed. I suggest that you only include CSS selectors in this file that you actually change.
...
1. The modals used for showing the schedule, currency select, help, etc are Bootstrap 5 modals. If your site uses an earlier Bootstrap version, you may have issues. Please contact me.
...
I'm happy to provide support for all my plugins! If you have a question or run into an issue, please visit the WordPress plugin's [support forum](https://wordpress.org/support/plugin/fc-retirement-savings-calculator/) and post your question.  
...
1. The AC Retirement Savings Calculator's front end showing 2 of the 4 configurable sizes with different color settings.
2. Example of investment schedule showing investment dates and a detailed summary.
