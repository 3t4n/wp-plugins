...
if ($brand_name != '' && strtolower($add_link) == 'yes') {
	$title = $brand_name . "<br>" . __('Retirement Savings Calculator', 'fc-retirement-savings-calculator');
} else {
	$title = __('Retirement Savings Calculator', 'fc-retirement-savings-calculator');
}
...
?>
	...
	<div id="retire-savings-wrap" class="ac-calc-wrap tiny">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="retire-savings-plugin" class="accuratecalculators ac-calculator tiny" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#RETIRESAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Retirement Savings Calculator Plugin for WordPress', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This retirement savings calculator calculates the periodic savings amount required to reach your retirement goal.', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_RETIRESAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_RETIRESAVINGS_DERIVATIVE_OF; ?>">
			<meta itemprop="downloadUrl" content="<?php echo FC_RETIRESAVINGS_DOWNLOAD_URL; ?>">
			<meta itemprop="softwareVersion" content="<?php echo FC_RETIRESAVINGS_VER; ?>">
			...
			<!-- calculator title -->
			<div class="calc-name">
				<?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://AccurateCalculators.com/retirement-savings-calculator" target="_blank" data-bs-toggle="tooltip" data-bs-placement="right" title="' . esc_attr__('click for more features', 'fc-retirement-savings-calculator') . '">' . $title . '</a>' : $title) ?>
			</div>
			<!--no backlink option-->
			<!-- <div class="calc-name"><?php // echo $title 
																	?></div> -->

			<!-- start calculator inputs -->
			<label for="edCurrentAge-rs" class="label"><?php _e('Your Current Age?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edCurrentAge-rs" value=<?php echo $current_age ?> maxlength="3" size="16">

			<label for="edRetirementAge-rs" class="label"><?php _e('Retirement Age?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRetirementAge-rs" value=<?php echo $retire_age ?> maxlength="3" size="16">

			<label for="edPV-rs" class="label"><?php _e('Current Savings?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPV-rs" value=<?php echo $current_savings ?> maxlength="14" size="16">

			<label for="edRate-rs" class="label"><?php _e('Interest Rate (ROR)?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRate-rs" value=<?php echo $rate ?> maxlength="8" size="16">

			<label for="edFV-rs" class="label"><?php _e('Value At Retirement?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFV-rs" value=<?php echo $goal_amt ?> maxlength="14" size="16">

			<hr class="bar" />

			<label for="edCF-rs" class="label"><?php _e('Monthly Investment', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edCF-rs" maxlength="14" size="16" disabled>

			<label class="label" for="edNumPmts-rs"><?php _e('Contributions', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edNumPmts-rs" maxlength="3" size="16" disabled>

			<label class="label" for="edTotalInvested-rs"><?php _e('Total Invested', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalInvested-rs" maxlength="14" size="16" disabled>

			<label class="label" for="edInterest-rs"><?php _e('Interest Earned', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edInterest-rs" maxlength="14" size="16" disabled>

			<label class="label" for="edFinalValue-rs"><?php _e('Estimated Final Value', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFinalValue-rs" maxlength="14" size="16" disabled>

			<label class="label" for="edFVDate-rs"><?php _e('Last Deposit Date', 'fc-retirement-savings-calculator') ?>:</label>
			...
			<div class="btn-group abbreviated">
				<div class="btn-row">
					<button type="button" id="btnCalc-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Calculate', 'fc-retirement-savings-calculator') ?>"><?php _e('C', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnClear-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Clear', 'fc-retirement-savings-calculator') ?>"><?php _e('Cl', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnPrint-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Print', 'fc-retirement-savings-calculator') ?>"><?php _e('P', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnHelp-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Help', 'fc-retirement-savings-calculator') ?>"><?php _e('H', 'fc-retirement-savings-calculator') ?></button>
				</div>
				<div class="btn-row">
					<button type="button" id="btnSchedule-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Schedule', 'fc-retirement-savings-calculator') ?>"><?php _e('S', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnCharts-rs" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Charts', 'fc-retirement-savings-calculator') ?>"><?php _e('Ch', 'fc-retirement-savings-calculator') ?></button>
				</div>
			</div>
			...
			<div class="calc-footer">
				...
				<span id="CCY-rs" class="localization<?php echo strtolower($hide_intl_conventions) == 'yes' ? ' ac-hidden' : ''; ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('click to change currency or date format', 'fc-retirement-savings-calculator') ?>" role="button">$ : mm/dd/yyyy</span>
			</div>
		...
		<div id="zoomer-rs" class="<?php echo $class; ?>">
			<span id="shrink-rs" class="minus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="left" title="<?php esc_attr_e('Make me smaller.', 'fc-retirement-savings-calculator') ?>"></span>
			<span id="original-rs" class="cursor-pointer font-medium" role="button"><?php _e('Original Size', 'fc-retirement-savings-calculator') ?></span>
			<span id="grow-rs" class="plus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('Make me larger.', 'fc-retirement-savings-calculator') ?>"></span>
		</div>
...
?>
	...
	<div id="retire-savings-wrap" class="ac-calc-wrap small">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="retire-savings-plugin" class="accuratecalculators ac-calculator small" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#RETIRESAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Retirement Savings Calculator Plugin for WordPress', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This retirement savings calculator calculates the periodic savings amount required to reach your retirement goal.', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_RETIRESAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_RETIRESAVINGS_DERIVATIVE_OF; ?>">
			...
			<div class="btn-group">
				<div class="btn-row">
					<button type="button" id="btnCalc-rs" class="btn btn-primary btn-calculator"><?php _e('Calc', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnClear-rs" class="btn btn-primary btn-calculator"><?php _e('Clear', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnPrint-rs" class="btn btn-primary btn-calculator"><?php _e('Print', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnHelp-rs" class="btn btn-primary btn-calculator"><?php _e('Help', 'fc-retirement-savings-calculator') ?></button>
				</div>
				<div class="btn-row">
					<button type="button" id="btnSchedule-rs" class="btn btn-primary btn-calculator"><?php _e('Schedule', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnCharts-rs" class="btn btn-primary btn-calculator"><?php _e('Charts', 'fc-retirement-savings-calculator') ?></button>
				</div>
			</div>
...
?>
	...
	<div id="retire-savings-wrap" class="ac-calc-wrap medium">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="retire-savings-plugin" class="accuratecalculators ac-calculator medium grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#RETIRESAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Retirement Savings Calculator Plugin for WordPress', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This retirement savings calculator calculates the periodic savings amount required to reach your retirement goal.', 'fc-retirement-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_RETIRESAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_RETIRESAVINGS_DERIVATIVE_OF; ?>">
			...
			<label for="edFV-rs" class="label"><?php _e('Retirement Goal?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFV-rs" value=<?php echo $goal_amt ?> maxlength="14" size="16">
			...
			<label class="label" for="edNumPmts-rs"><?php _e('Number', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edNumPmts-rs" maxlength="3" size="16" disabled>

			<label class="label" for="edTotalInvested-rs"><?php _e('Total Amount Invested', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalInvested-rs" maxlength="14" size="16" disabled>
...
?>
	...
	<div id="retire-savings-wrap" class="ac-calc-wrap large">
		...
		<div id="retire-savings-plugin" class="accuratecalculators ac-calculator large grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#RETIRESAVINGSPLUGIN">
			...
			<label for="edRetirementAge-rs" class="label"><?php _e('Anticipated Retirement Age?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRetirementAge-rs" value=<?php echo $retire_age ?> maxlength="3" size="16">

			<label for="edPV-rs" class="label"><?php _e('Current Retirement Savings?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edPV-rs" value=<?php echo $current_savings ?> maxlength="14" size="16">

			<label for="edRate-rs" class="label"><?php _e('Annual Interest Rate (ROR)?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edRate-rs" value=<?php echo $rate ?> maxlength="8" size="16">

			<label for="edFV-rs" class="label"><?php _e('Amount At Retirement?', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFV-rs" value=<?php echo $goal_amt ?> maxlength="14" size="16">

			<hr class="bar" />

			<label for="edCF-rs" class="label"><?php _e('Monthly Investment Required', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edCF-rs" maxlength="14" size="16" disabled>

			<label class="label" for="edNumPmts-rs"><?php _e('Number of Contributions', 'fc-retirement-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edNumPmts-rs" maxlength="3" size="16" disabled>
			...
			<div class="btn-group">
				...
				<div class="btn-row">
					<button type="button" id="btnSchedule-rs" class="btn btn-primary btn-calculator"><?php _e('Savings Schedule', 'fc-retirement-savings-calculator') ?></button>
					<button type="button" id="btnCharts-rs" class="btn btn-primary btn-calculator"><?php _e('Charts', 'fc-retirement-savings-calculator') ?></button>
				</div>
			</div>
			...
			<div class="modal-content ac-modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">
						<?php _e('Currency and Date Conventions', 'fc-retirement-savings-calculator') ?>
					</h4>
				...
				<div class="modal-body">
					...
					?>
						...
						<div class="msg mb-6">
							<?php _e('The calculator will remember your choice. You may also change it at any time.', 'fc-retirement-savings-calculator') ?>
						</div>
						<div class="msg">
							<?php _e('Clicking "Save changes" will cause the calculator to reload. Your edits will be lost.', 'fc-retirement-savings-calculator') ?>
						</div>
					<?php
					}
					?>
				...
				<div class="modal-footer">
					<button id="CURRENCYDATE_cancel" type="button" class="btn btn-default" data-bs-dismiss="modal"><?php _e('Cancel', 'fc-retirement-savings-calculator') ?></button>
					<button id="CURRENCYDATE_save" type="button" class="btn btn-primary" data-bs-dismiss="modal"><?php _e('Save changes', 'fc-retirement-savings-calculator') ?></button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="rpt-title" class="modal-title">
						<?php _e('Cash flow forecast...', 'fc-retirement-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
				...
				<div class="modal-footer">
					<button id="RPT_cancel" type="button" class="btn btn-primary btn-primary-inverse px-8 py-2" data-bs-dismiss="modal">
						<?php _e('Close', 'fc-retirement-savings-calculator') ?>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="chart-title" class="modal-title">
						<?php _e('Charts', 'fc-retirement-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="hlp-title" class="modal-title">
						<?php _e('Help', 'fc-retirement-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="msg-title" class="modal-title">
						<?php _e('Message', 'fc-retirement-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
