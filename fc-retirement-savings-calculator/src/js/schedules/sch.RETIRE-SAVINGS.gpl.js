...
// RetireSavingsCalculatorStrings
...
export class HtmRetireSavingsSchedule {

	//
	// create HTML schedule
	//
	static formatRetirementSchedule (schedule, summary) {
		let L, i, strReportPage, strSchedule, rate, dep, interest, netChange, bal, totalCredits, totalNCredits, strDate, strDateFirst, strDateLast, periodYear, totalInterest, transaction, years, website;
		...
		this.strHTMLTitle = '<title>' + retireSavingsStrings.strs.s2016 + '</title>';
		...
		if (schedule.length > 0) {
			...
			rate = Utils.formatNumericValueWithSym(rsc.summary.nominalRate[SCHEDULE_INDEX] * 100, Locales.rateConventions, Locales.rateConventions.precision);
			...
			// Loan Summary
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + retireSavingsStrings.strs.s2056 + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label label_col1">' + retireSavingsStrings.strs.s2066 + ':</td><td class="right input_col1">' + totalCredits + '</td><td class="label label_col2">' + retireSavingsStrings.strs.s207 + ':</td><td class="right input_col2">' + totalNCredits + '</td></tr>');

			// strSchedule.append('<tr><td class="label hCell">Rate-of-Return (ROR):</td><td class="right">' + rate + '</td><td class="label hCell">Total Gain:</td><td class="right">' + totalInterest + '</td></tr>');
			strSchedule.append('<tr><td class="label label_col1">' + retireSavingsStrings.strs.s208 + ':</td><td class="right input_col1">' + rate + '</td><td class="label label_col2">' + retireSavingsStrings.strs.s209 + ':</td><td class="right input_col2">' + totalInterest + '</td></tr>');
			...
			strSchedule.append('<tr><td class="label label_col1">' + retireSavingsStrings.strs.s210 + ':</td><td class="right input_col1">' + strDateLast + '</td><td class="label label_col2">' + retireSavingsStrings.strs.s211 + ':</td><td class="right input_col2">' + years + '</td></tr>');
			...
			strSchedule.append('<tr class="label rpt_title center bold i"><td colspan="6">' + retireSavingsStrings.strs.s218 + '</td></tr>');
			strSchedule.append('<tr class="empty"><td colspan="6"></td></tr>');
			...
			strSchedule.append('<tr class="label cHead"><td class="rpt6colvnarrow">#/' + retireSavingsStrings.strs.s219 + '</td><td class="rpt6colnarrow center">' + retireSavingsStrings.strs.s220 + '</td><td class="rpt6col right">' + retireSavingsStrings.strs.s221 + '</td><td class="rpt6col right">' + retireSavingsStrings.strs.s222 + '</td><td class="rpt6col right">' + retireSavingsStrings.strs.s223 + '</td><td class="rpt6colwide right">' + retireSavingsStrings.strs.s224 + '</td></tr>');
