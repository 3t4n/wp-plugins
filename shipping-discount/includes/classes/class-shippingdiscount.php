...
class ShippingDiscount {
	...
	public function load_all_hooks() {
		...
		add_action( 'before_woocommerce_init', array( $this, 'add_compatibility_with_hpos' ), 10, 1 );
	 ...
	 *
	 * By default, HPOS is incompatible with this plugin. This method allows
	 * users to activate HPOS regardless of the compatibility check.
	 *
	 * @since 1.2.0
	 */
	public function add_compatibility_with_hpos() {
		// Allow activating plugins with incompatible features.
		\Automattic\WooCommerce\Utilities\FeaturesUtil::allow_activating_plugins_with_incompatible_features();

		// Allow enabling features with incompatible plugins.
