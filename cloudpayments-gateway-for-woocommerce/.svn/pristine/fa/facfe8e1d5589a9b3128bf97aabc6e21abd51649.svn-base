    ...
    public function process_payment($order_id)
    {
        ...
        if (empty($_POST['cp_card']) or $_POST['cp_card'] == 'widget') {
          if (isset($_POST['cp_save_card'])) {
            ...
            $wc_api_url = '/wc-api/cloud_payments_widget/?' . http_build_query($query);
        ...
        $this->form_fields = array(
            ...
            'kassa_taxtype'    => array(
                ...
                'options'     => array(
                    ...
                    '5'    => __('НДС 5%', 'woocommerce'),
                    '7'    => __('НДС 7%', 'woocommerce'),
                    '10'   => __('НДС 10%', 'woocommerce'),
                    '20'   => __('НДС 20%', 'woocommerce'),
                    '105'  => __('Расчетный НДС 5/105', 'woocommerce'),
                    '107'  => __('Расчетный НДС 7/107', 'woocommerce'),
