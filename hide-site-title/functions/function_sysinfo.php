...
function hide_site_title_sysinfo_get()
{
    global $wpdb;
    $hide_site_title_userAgentOri = hide_site_title_get_ua2();
    ...
    $return .= 'Version:                  ' . HIDE_SITE_TITLEVERSION;
    $return .= "\n\n";
    $return .= '-- Site Info' . "\n\n";
    ...
    $return .= "\n" . '-- User Browser' . "\n\n";
    $return .= $hide_site_title_userAgentOri; // $browser;
    $return .= "\n\n";
    $locale = get_locale();
    ...
    $return .= 'Plugin Dir:                  ' . HIDE_SITE_TITLE_PATH . "\n";
    $return .= 'Table Prefix:             ' . 'Length: ' . strlen($wpdb->prefix) . '   Status: ' . (strlen($wpdb->prefix) > 16 ? 'ERROR: Too long' : 'Acceptable') . "\n";
    //$return .= 'Admin AJAX:               ' . ( hide_site_title_test_ajax_works() ? 'Accessible' : 'Inaccessible' ) . "\n";
    ...
    $return .= 'OS Type & Version:        ' . hide_site_title_OSName();
...
function hide_site_title_OSName()
{
    try {
...
function hide_site_title_get_host()
{
...
function hide_site_title_get_ua2()
{
