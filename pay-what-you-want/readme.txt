...
Tags:				woocommerce, open price, non profit, dynamic price, pay what you want
...
This can be set based on
- All products
- For some specified categories

Price set will depend on:
- Product price
- A custom set of price
- Customer can write own price also
