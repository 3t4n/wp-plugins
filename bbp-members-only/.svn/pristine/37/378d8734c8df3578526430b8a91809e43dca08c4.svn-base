...
> * Restricts important content in a wordpress post to Logged in/Registered members only.
...
== Changelog ==
= Version 1.8.1 =
fixed a bug in "Only Protect My bbPress Pages" function
>[Resolving the Bug in 'Only Protect My bbPress Pages' Functionality](https://www.bbp.design/resolving-the-bug-in-only-protect-my-bbpress-pages-functionality-bbpress-members-only-1-8-1/)

= Version 1.7.9 =
>[new bbPress Admin Login Notification option to enhance security of bbpress forum, detailed document can be found at here](https://www.bbp.design/bbpress-members-only-1-7-9-released-bbpress-admin-can-get-login-notification-now/)
...
= Version 1.1.5 =
New option to only protect my bbPress pages, that means you can decide to only protect bbpress pages and open all other wordpress sections to guest / non-member
...
>[bbPress Members Only Plugin change log:](https://bbp.design/change-log-of-bbpress-membership-free-plugin/)
