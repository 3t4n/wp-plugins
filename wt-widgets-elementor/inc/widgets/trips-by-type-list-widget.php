 ...
 * @since 1.0.0
 */
if (!class_exists('WTWE_Trips_By_Type_List')) {
	class WTWE_Trips_By_Type_List extends Widget_Base
	{
		/**
		 * Class constructor.
		 *
		...
		public function __construct($data = array(), $args = null)
		{
			...
			wp_register_style('trips-by-type-list', plugins_url('assets/css/trips-by-type-list' . $prefixed . '.css', WTWE_PLUGIN_FILE), array());
		}
		...
		{
			return 'wp-travel-trip-by-type-list';
		}
		...
		{
			return esc_html__('Trips By Type ( List )', 'wt-widgets-elementor');
		}
		...
		{
			return array('trips-by-type-list');
		}
		...
		protected function _register_controls()
		{
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::SELECT,
					'default' => esc_html(array_key_first(\WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('itinerary_types'))),
					'options' => \WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('itinerary_types'),
					'condition' => array(
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::SELECT,
					'default' => esc_html(array_key_first(\WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('travel_locations'))),
					'options' => \WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('travel_locations'),
					'condition' => array(
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::SELECT,
					'default' => esc_html(array_key_first(\WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('activity'))),
					'options' => \WTWE\Widgets\WTWE_Trips_By_Type_List::wtwe_handle_content_type('activity'),
					'condition' => array(
			...
			$this->add_responsive_control(
				...
				array(
					...
					'default' => 'flex',
					'options' => [
						'flex' => esc_html__("List", 'wt-widgets-elementor'),
					],
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => [
    				    ...
    				    '{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .wptravel-archive-wrapper .wtwe-elementor-manage-controlClass' => 'gap: {{SIZE}}{{UNIT}};',  
					],
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .wp-travel-itinerary-items.wptravel-archive-wrapper.list-view' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .wp-travel-itinerary-items.wptravel-archive-wrapper.list-view .view-box .view-image' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .wp-travel-itinerary-items.wptravel-archive-wrapper.list-view .view-box .view-content' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-footer' => 'flex-direction: {{VALUE}}',
					),
					'condition' => [
						'trips_type_design' => 'design-2',
					],
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box'  => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box'  => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_group_control(
				...
				array(
					'name' => 'card_border',
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type, {{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box',
					)
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box'  => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box'  => 'overflow:{{VALUE}}'
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body, .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content',
				)
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body, {{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-image'     => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-img-container,{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-image',
				]
			);
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-image' => 'height: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-image img' => 'height: {{SIZE}}{{UNIT}};',
					],
				)
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .discount' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .discount' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-img-container .wtwe-trips-by-type-discount, {{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .discount',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .discount' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_control(
				'trip_sale_badge_color',
				array(
					'label' => esc_html__('Text Color', 'wt-widgets-elementor'),
					'type'	=> Controls_Manager::COLOR,
					'default'   => '#000',
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .discount' => 'color: {{VALUE}}',
						'{{WRAPPER}} .wtwe-trips-layout-list .wtwe-trips-by-type .wtwe-trips-by-type-img-container .wtwe-trips-by-type-discount' => 'color: {{VALUE}}',
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '#000',
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-list-title' => 'color: {{VALUE}}',
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .entry-title a' => 'color: {{VALUE}}',
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'	=> '{{ WRAPPER }} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-list-title, .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .entry-title a',
				)
			);
			...
			$this->add_control(
				...
				[
					...
					'size_units' => ['px', '%', 'em', 'rem'],
					'selectors' => [
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-list-trip-tag' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '#fff',
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-list-trip-tag' => 'color: {{VALUE}}',
					),
				),
			);
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'	=> '{{ WRAPPER }} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body a.wtwe-trips-by-type-list-trip-tag',
				)
			);
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '{{ WRAPPER }} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-list-trip-tag',
				)
			);
			...
			$this->add_group_control(
				...
				[
					...
					'types' => ['classic', 'gradient', 'video'],
					'selector' => '{{WRAPPER}} .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-inner-body .wtwe-trips-by-type-header .wtwe-trips-by-type-trip-category .wtwe-trips-by-type-list-trip-tag',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'size_units' => ['px', '%', 'em', 'rem'],
					'selectors' => [
						'{{WRAPPER}} .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-inner-body .wtwe-trips-by-type-header .wtwe-trips-by-type-trip-category .wtwe-trips-by-type-list-trip-tag' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'size_units' => ['px', '%', 'em', 'rem'],
					'selectors' => [
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-header .wtwe-trips-by-type-inner-header .wtwe-trips-by-type-list-trip-rating' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '#fff',
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-header .wtwe-trips-by-type-inner-header .wtwe-trips-by-type-list-trip-rating' => 'color: {{VALUE}}',
					),
				),
			);
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'	=> '{{ WRAPPER }} .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-header .wtwe-trips-by-type-inner-header .wtwe-trips-by-type-list-trip-rating',
				)
			);
			...
			$this->add_control(
				...
				[
					...
					'size_units' => ['px', '%', 'em', 'rem'],
					'selectors' => [
						'{{WRAPPER}} .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-header .wtwe-trips-by-type-inner-header .wtwe-trips-by-type-list-trip-rating' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '#777',
					'selectors' => array(
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-2 .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-content .wtwe-trips-by-type-excerpt p' => 'color: {{VALUE}}',
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .trip-desc p' => 'color: {{VALUE}}',
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'	=> '{{ WRAPPER }} .wtwe-trips-by-type-wrapper.design-2 .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-content .wtwe-trips-by-type-excerpt p, {{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .view-content .trip-desc p',
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .right-content .price-here' => 'color: {{VALUE}}',
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'	=> '{{ WRAPPER }} .wtwe-trips-by-type .wtwe-trips-by-type-body .wtwe-trips-by-type-footer .wtwe-trips-by-type-pricing .wtwe-trips-by-type-price .wtwe-trips-by-type-regular-price, {{WRAPPER}} .wtwe-trips-by-type-wrapper.design-1 .view-box .right-content .price-here',
				)
			);
...
?>
			<?php if ($settings['trips_type_design'] == "design-2") : ?>
				<div class="wtwe-trips-by-type-wrapper wtwe-trips-layout-list design-2">
					<?php
					if ($query->have_posts()) {
							...
							<div class="wtwe-trips-by-type">
								...
								<div class="wtwe-trips-by-type-body <?php if ($settings['show_body'] != 'yes') echo 'wtwe-hidden'; ?>">
										...
										<div class="wtwe-trips-by-type-header">
											<div class="wtwe-trips-by-type-inner-header">
												<div class="wtwe-trips-by-type-title-container <?php if ($settings['show_trip_title'] != 'yes') echo 'wtwe-hidden'; ?>">
													<a href="<?php esc_url(the_permalink($trip_id)) ?>" class="wtwe-trips-by-type-link">
														<h2 class="wtwe-trips-by-type-list-title"><?php esc_html(the_title()); ?></h2>
													</a>
												</div>
												<div class="wtwe-trips-by-type-list-trip-rating <?php if ($settings['show_trip_rating'] != 'yes') echo 'wtwe-hidden'; ?>">
												...
												if (is_array($trip_type_list) && count($trip_type_list) > 0) { ?>
													<?php foreach ($trip_type_list as $tax) {
														...
														if (!is_wp_error($term_link)) {
															echo '<a href="' . esc_url($term_link) . '" class="wtwe-trips-by-type-list-trip-tag">' . esc_html($tax->name) . '</a>';
														} else {
															echo '<span class="wtwe-trips-by-type-list-trip-tag">' . esc_html($tax->name) . '</span>';
														}
													?>
									...
									<div class="wtwe-trips-by-type-footer">
										...
										<?php if ($trip_price > 0 && $settings['show_price_label']  == 'yes') { ?>
											<div class="wtwe-trips-by-type-pricing">
												<div class="wtwe-trips-by-type-pricing-text <?php if ($settings['show_price_label'] != 'yes') echo 'wtwe-hidden';; ?> <?php if ($settings['card_price_position'] == 'row-reverse') echo esc_html('wtwe-price-left'); ?>">
													<?php echo esc_html($settings['price_label']); ?>
												</div>
												<div class="wtwe-trips-by-type-price <?php if ($settings['card_price_position'] == 'row-reverse') echo esc_html('wtwe-price-left'); ?>">
			...
			<?php if ($settings['trips_type_design'] == "design-1") : ?>

				<div class="wtwe-trips-by-type-wrapper wtwe-trips-layout-list design-1">
					<div class="wp-travel-itinerary-items wptravel-archive-wrapper  list-view">
						<div class="wtwe-elementor-manage-controlClass <?php
						if ($settings['show_image'] != 'yes')
							echo 'wtwe-hidden-image-class ';
						if ($settings['show_body'] != 'yes')
							echo 'wtwe-hidden-body-class ';
						if ($settings['show_trip_title'] != 'yes')
							echo 'wtwe-hidden-trip-title-class ';
						if ($settings['show_trip_rating'] != 'yes')
							echo 'wtwe-hidden-trip-rating-class ';
						if ($settings['show_excerpt'] != 'yes') 
							echo 'wtwe-hidden-trip-excerpt';
						if ($settings['show_trip_sale_badge'] != 'yes')
							echo 'wtwe-hidden-sale-badge-class';
						if ($settings['show_trip_details'] != 'yes')
							echo ' wtwe-hidden-trip-details-class ';
						?>
">
							<?php
								while ($query->have_posts()):
		...
		?>
			...
			if( typeof settings.trips_ids !='undefined' && settings.content_type=='trips_ids' ) { 
				...
				if( settings.trips_type_design == "design-2" ){
				#>
				<div class="wtwe-trips-by-type-wrapper wtwe-trips-layout-list design-2">
			...
			#>
								...
								<div class="wtwe-trips-by-type-body {{ tripBodyControlClass }}">
										...
										<div class="wtwe-trips-by-type-header">
											<div class="wtwe-trips-by-type-inner-header">
												<div class="wtwe-trips-by-type-title-container {{ tripTitleControlClass }}">
													<a href="{{ trip.permalink }}" class="wtwe-trips-by-type-link">
														<h2 class="wtwe-trips-by-type-list-title">{{{ trip.title }}}</h2>
													</a>
												</div>
												<div class="wtwe-trips-by-type-list-trip-rating {{ tripRatingControlClass }}">
											...
											<div class="wtwe-trips-by-type-trip-category {{ tripTagsControlClass }}">
												<# trip.tags.forEach( ( tax, index )=> { #>
													<div class="wtwe-trips-by-type-list-trip-tag">
														{{{ tax }}}
													</div>
													<# }); #>
											</div>
									...
									<div class="wtwe-trips-by-type-footer">
										...
										<# if ( trip.trip_price> 0 ) { #>
											<div class="wtwe-trips-by-type-pricing">
												<div class="wtwe-trips-by-type-pricing-text {{ tripPriceControlClass }} {{ tripPriceLabelControlClass }}">
													{{{ settings.price_label }}}
												</div>
												<div class="wtwe-trips-by-type-price {{ tripPriceControlClass }}">
				...
				<# } #>
					<!-- default design -->
					<# if( settings.trips_type_design=="design-1" ){ #>
						<div class="wtwe-trips-by-type-wrapper wtwe-trips-layout-list design-1">
							<div class="wp-travel-itinerary-items wptravel-archive-wrapper list-view">
								<div class = "wtwe-elementor-manage-controlClass" >
								<# Array.isArray(trips) && trips.length> 0 && trips.map(( trip, index ) => {
									if(index+1 <= settings.trips_count) { #>
										<div class="view-box">
											<div class="view-image {{ tripImageControlClass }}">
												<a href="{{trip.permalink}}" class="image-thumb">
											...
											<div class="view-content {{ tripBodyControlClass }}">
												<div class="left-content">
													<header>
														<h2 class="entry-title {{ tripTitleControlClass }}">
															<a class="heading-link" href="{{trip.permalink}}" rel="bookmark" title="{{trip.title}}">
																{{{trip.title}}}
															</a>
														</h2>
													</header>
													<div class="trip-icons {{tripDetailsControlClass}}">
														...
														<div class="trip-location">
															...
															<span>
																<a href="{{trip.trip_location}}">{{{trip.trip_location}}}</a>
													...
													<div class="trip-desc {{ tripExcerptControlClass }}">
														<p>
															{{{trip.excerpt}}}
														</p>
													</div>
												...
												<div class="right-content">
													<div class="footer-wrapper">
														<div class="trip-price">
															<span class="discount {{ tripSaleBadgeControlClass }}"> <span><?php echo esc_html__( '10.00%', 'wt-widgets-elementor' ); ?></span><?php echo esc_html__( 'Off', 'wt-widgets-elementor' ); ?>  </span>
															<span class="price-here">
																<span class="wp-travel-trip-currency"><?php echo esc_html__( '$', 'wt-widgets-elementor' ); ?></span><span class="wp-travel-trip-price-figure">{{{trip.trip_price}}}</span>
															</span>
															<del>
																<span class="wp-travel-trip-currency"><?php echo esc_html__( '$', 'wt-widgets-elementor' ); ?></span><span class="wp-travel-regular-price-figure">{{{trip.regular_price_html}}}</span>
															</del>
														</div>
														<div class="trip-rating {{ tripRatingControlClass }}">
															<div class="wp-travel-average-review">
																<div class="wp-travel-average-review" title="<?php echo esc_attr__('Rated 4 out of 5', 'wt-widgets-elementor' ); ?>">
																	<a>
																		<span style="width: 80%">
													...
													<a class="wp-block-button__link explore-btn" href="{{trip.permalink}}"><span><?php echo esc_html__( 'Explore', 'wt-widgets-elementor' ); ?></span></a>
												</div>
											</div>
										</div>
									<# } }) #>
