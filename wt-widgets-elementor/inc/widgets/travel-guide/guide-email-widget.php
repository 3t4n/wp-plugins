...
namespace WTWE\Widgets\Travel_Guide\Single_Travel_Guide_Email;
...
/**
 * Guide Email widget class.
 *
 * @since 1.0.0
 */
if (!class_exists('WTWE_Guide_Email')) {
    class WTWE_Guide_Email extends Widget_Base
    {
        ...
        {
            return 'wp-travel-guide-email';
        }

        public function get_title()
        {
            return esc_html__('Guide Email', 'wt-widgets-elementor');
        }
        ...
        protected function _register_controls()
        {
            ...
            // Colors
            $this->add_control(
                'guide-email-text-color',
                [
                    'label' => __('Color', 'wt-widgets-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#000',
                    'selectors' => [
                        '{{WRAPPER}} .wptravel-guide-email-widget' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                array(
                    ...
                    'selector' => '{{WRAPPER}} .wptravel-guide-email-widget',
        ...
        protected function _content_template()
        {
            if (is_plugin_active('wp-travel-pro/wp-travel-pro.php') && \Elementor\Plugin::$instance->editor->is_edit_mode()) {
                ?>
                <span class="wptravel-guide-email-widget"><?php echo esc_html__('info@info.com', 'wt-widgets-elementor'); ?></span>
