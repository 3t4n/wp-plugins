...
= 🆓 FREE TRAVEL THEMES COMPATIBLE WITH WT WIDGETS FOR ELEMENTOR PLUGIN =
...
== 💁‍♂️ Dedicated Support and Documentation ==
...
* Fixed fatal error issue occurring within Guide Review Form widget.
* Enhanced Guide Full Name widget.
* Minor layout fixes.

= 1.4.0. =
Release Date: 7th November 2024

* Added Guide Age widget.
* Added Guide Biography widget.
* Added Guide City widget.
* Added Guide Code widget.
* Added Guide Contact Number widget.
* Added Guide Country widget.
* Added Guide Email widget.
* Added Guide Featured Trip widget.
* Added Guide Full Name widget.
* Added Guide Gender widget.
* Added Guide Image widget.
* Added Guide Language widget.
* Added Guide Review Form widget.
* Added Guide Review widget.
* Added Guide Short Description widget.
* Added Guide Slogan widget.
* Added Guide Social Links widget.
* Added Guide Join Year widget.
