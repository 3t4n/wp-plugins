	...
	<p>
		<?php 
			printf( 
				...
				__( 'Thank you for installing %1$s!', 'digitalpush-notifications' ),
				$this->plugin->displayName 
			); ?>
		<a href="<?php echo $setting_page; ?>"><?php esc_html_e( 'Click here', 'digitalpush-notifications' ); ?></a> <?php esc_html_e( 'to configure the plugin.', 'digitalpush-notifications' ); ?>
	</p>
</div>
