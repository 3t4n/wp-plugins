...
function pickplugins_wl_ajax_get_wishlist_menu_items()
{
	...
	if (!wp_verify_nonce($nonce, 'wishlist_menu')) {
		echo "<li class='menu_item'> " . __('Sorry you are not allowed', 'wishlist') . "</li>";
		die();
	}
	...
	if (is_user_logged_in()) {
		$wishlisted_array 	= pickplugins_wl_is_wishlisted($item_id, $current_user_id);
	}
