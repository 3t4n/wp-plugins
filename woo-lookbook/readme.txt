...
Tags: ecommerce, instagram shop woocommerce, instagram shopping woocommerce, woocommerce instagram shopping, woocommerce lookbook
...
[youtube https://youtu.be/bqBdNyoC2XI]
...
- [Getting Started](http://docs.villatheme.com/?item=woocommerce-lookbook/)

### Plugin Links

- [Project Page](https://villatheme.com/extensions/woocommerce-lookbook/)
- [Documentation](http://docs.villatheme.com/?item=woocommerce-lookbook)
- [Report Bugs/Issues](https://villatheme.com/knowledge-base/security-is-our-priority/)

== Installation ==

1. Unzip the download package
1. Upload `woo-lookbook` to the `/wp-content/plugins/` directory
...
**1.1.7 - 2024.12.13**
- Fixed: The number of lookbooks displayed for shortcode woocommerce_lookbook_instagram

**1.1.6 - 2024.11.22**
– Updated: Connect Instagram with the new version of the API
...
**1.0.7.4 - 2022.01.15**
- Updated: Compatible with WooCommerce 6.1

**1.0.7.3 - 2021.08.12**
- Update: support class

**1.0.7.2 - 2020.07.23**
- Fixed: Sync from Instagram
