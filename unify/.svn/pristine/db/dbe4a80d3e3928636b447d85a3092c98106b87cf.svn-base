...
{	
	...
	{ 
		...
		$order_status_list = [ 1 => 'Processing', 2 => 'Completed'];
	...
	public static function save_settings()
	{
		...
		if (wp_verify_nonce($nonce, 'unify-settings-data'))
		{
			...
			$fields = ['enabled' => $active_gateways['codeclouds_unify'], 'title' => '', 'description' => '', 'connection' => $active_connection['active_connection'], 'shipment_price_settings' => '','default_order_status' => '','shipping_product_id' => '', 'shipping_product_offer_id' => '', 'shipping_product_billing_id' => '', 'testmode' => 'no', 'enable_debugging' => 'no'];
