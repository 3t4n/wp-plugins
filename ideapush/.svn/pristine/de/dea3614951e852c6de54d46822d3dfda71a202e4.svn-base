...
[youtube https://www.youtube.com/watch?v=yFaGNbYUiIw]

Check out the [demo page here](https://northernbeacheswebsites.com.au/ideapush-feature-requests/) and submit an idea for the plugin.
...
[youtube https://www.youtube.com/watch?v=HD18EijWSHo]
...
[Learn more about IdeaPush Pro here](https://northernbeacheswebsites.com.au/ideapush-pro/)
...
1. The main board display showing the the ideas on the left and the idea creation form on the right
2. The single idea display with quick edit functions for administrators only
3. Live searching/filtering
4. Create a board in seconds
5. Extensive notification options
6. Rename statuses
7. Change the primary color of links and icons
8. Translate the form fields
...
= 8.70 =
* New filter to change comment login link
...
= 8.65 =
* Improved mobile styling of boasrd filter area
...
= 8.61 =
* enables custom fields to be put in notifications 
* security update

= 8.60 =
* new filter which prevents flushing of rewrite rules

= 8.59 =
* Support for the WordPress API 

= 8.58 =
* Improved security when adding a board

= 8.57 =
* New filter to prevent certain user roles from creating ideas

= 8.56 =
* New filter to allow better translation of human time difference

= 8.55 =
* Allowing some HTML in privacy confirmation

= 8.54 =
* Update to comment approval

= 8.53 =
* Security update

= 8.52 =
* Extended show board to additional roles extend to single idea page

= 8.51 =
* Made admin report page fully translateable 

= 8.50 =
* Filter to extend permissions

= 8.49 =
* Fix for PDF on single idea page

= 8.48 =
* New widget to display top ideas

= 8.47 =
* New developer filter for the idea length

= 8.46 =
* Better PHP 8 Compatibility

= 8.45 =
* Ability to change status via the quick edit on the all ideas page on the backend

= 8.44 =
* Make ago translatable

= 8.43 =
* Fix for button labels on tag page

= 8.42 =
* Added the ability for PDF's to be uploaded via custom field

= 8.41 =
* Added more enhanced display of custom fields of pro version

= 8.40 =
* New filter to prevents tags being sent to JIRA

= 8.39 =
* New filter for allowing voting for alternative idea statuses
...
= 8.14 =
* New javascript rendering events (ideasRendered,headerRendered,formRendered)

= 8.13 =
* Fixes javascript issue when adding custom field in the backend
...
= 4.19 =
* Now we provide a fallback user name if the first name is not set 
* Imrpovement to author page in case of custom permalink structure 
