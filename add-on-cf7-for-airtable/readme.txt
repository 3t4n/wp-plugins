...
Tags: wpconnect, airtable, contactform7, api, forms
...
* Fix: Form edit confirmation message appearing when the form has not been modified
...
= 1.1.0 =
* Feature: Selection of the Airtable field’s type
* Feature: New tags
* Improvement: Links in the interface
