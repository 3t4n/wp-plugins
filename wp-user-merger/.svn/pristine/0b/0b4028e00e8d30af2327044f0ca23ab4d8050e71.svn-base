...
After activation there will be a settings page under Users menu. User Merger let you merge information of two users. There are two dropdowns on settings page. Select two users you want to merge. For example display name, user ID, login and email etc. It is a user friendly plugin to merge multiple user accounts.
See screenshot 1.

Then press "Merge Users" button. A warning notification will appear for confirmation. Confirm action by pressing the Yes button. 
See screenshot 2.

After pressing proceed there will be a successful message which means users has been merged successfully. 
See screenshot 3.

If you select same users, the merge action will not be performed. A warning message will appear that same users cannot be selected for merge action. 
See screenshot 4.

For detailed selection there is a toggle button that allow you to choose what information the user should include after the merge action. This is a premium feature. 
See screenshot 5.
...
3. There will now be a menu item under the users menu in wp-admin, left side bar.
...
== Changelog ==
= 1.6.1 =
* Tested for ACF using FakerPress with multiple customer role users and random values in the field group, verified after marge. 31/01/2025 [Thanks to Darren Ratcliffe]
= 1.5.7 =
...
== Upgrade Notice ==
= 1.6.1 =
Tested for ACF using FakerPress with multiple customer role users and random values in the field group, verified after marge.
= 1.5.7 =
