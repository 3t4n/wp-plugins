<?php defined( 'ABSPATH' ) or die( __('No script kiddies please!', 'wp-user-merger') );
	...
	<div class="container-fluid wpus_wrapper_div wrap">
        ...
        <h2 class="nav-tab-wrapper">
            <a class="nav-tab nav-tab-active"><i style="color:#A28906" class="fas fa-toggle-on"></i> <?php echo __('Optional', 'wp-user-merger'); ?></a>
            <a href="<?php echo admin_url('users.php?page=wpus_merger&load&t=1'); ?>" class="nav-tab"><i style="color:#089F75" class="fas fa-tablets"></i> DB <?php echo __('User Merger', 'wp-user-merger'); ?></a>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="<?php _e('Close', 'wp-user-merger'); ?>"></button>
            ...
            <?php if(!$post_status && !$merge_status && isset($_GET['load'])){ ?>
