<?php
	 ...
	 */ 
	function gen_frontpb_programmatically_create_page($title,$slug,$page_content,$post_type='page') {
		global $wpdb;
  ...
  /*Programmatically Delete page/post method*/ 
  function gen_frontpb_programmatically_delete_page($id) {
