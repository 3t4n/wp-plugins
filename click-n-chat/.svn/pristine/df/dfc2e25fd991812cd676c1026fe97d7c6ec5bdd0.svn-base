...
?>
    <div class="my-3">   
        <h1 class="wp-heading-inline">Google Analytics</h1>
    </div>
            ...
            <div class="form-wrap cnc-custom-col-gap-6">
                <div class="cnc-container cnc-bg-white cnc-shadow">
                	<div class="form-field">
                        <label for="analytic_type">Google Analytics Type: </label>
                        <select name="analytic_type" class="form-select cnc-select">
                    ...
                    <div class="form-field">
                        ...
                        <p id="name-description">
                            <b>Active: </b> Activate or Deactivate Google Analytics Script
                        </p>
                    </div>
                    <div class="form-field">
                        <label for="label">Label: </label>
                        <input name="label" type="text" id="label" value="<?php echo esc_html($click_n_chat_setting_analytics->label); ?>" placeholder="AI Chat">
                    </div>
                    <div class="form-field">
                        <label for="category">Category: </label>
                        <input name="category" type="text" id="category" value="<?php echo esc_html($click_n_chat_setting_analytics->category); ?>" placeholder="AI Auto Chat">
                    </div>
                    <div class="form-field">
                        <label for="gaid">Google Analytics ID: </label>
                        <input name="gaid" type="text" id="gaid" value="<?php echo esc_html($click_n_chat_setting_analytics->gaid); ?>" placeholder="UA-0000000-0">
                    </div>
                </div>
            </div>
        </div>
        <p class="py-1">
            <input type="submit" name="submit" id="submit" class="button button-primary" value="Update Analytics">
        </p>
        <div class="cnc-custom-gap-row">
        	<div class="form-wrap cnc-custom-col-gap-6">
                <div class="cnc-container cnc-bg-white cnc-shadow">
                	<h4>How to Find Your Google Analytics v3 (Universal Analytics) Property Tracking ID</h4>
                    <ol>
            ...
            <div class="form-wrap cnc-custom-col-gap-6">
                <div class="cnc-container cnc-bg-white cnc-shadow">
                    <h4>How to Find Your Google Analytics 4 (GA4) Data Stream Measurement ID</h4>
                    <ol>
                        <li><strong>Sign In to Google Analytics</strong>
                            <ol>
