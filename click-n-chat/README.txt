...
Contributors: Flag92
Tags: social, click to chat, whatsapp, WooCommerce, chatbot
...
Increase Your Sales & Leads with an All-in-One Social Solution & OpenAI Chatbot!

== Description ==

**Chat n Click** is a powerful WordPress plugin designed to revolutionize customer engagement on your site. Combining the best of social media integration and AI-driven chatbots, this plugin offers 20+ social platforms, customizable widgets, automated replies, and a ChatGPT AI-powered chatbot. Tailor your site’s communication style by displaying different widgets on different pages for example, use ChatGPT on the homepage and social icons on the shop page. With this versatility, you can interact with customers uniquely on each page, enhancing their journey and boosting conversions!
...
1. **Chat Popup with AI & Auto-Reply Feature**:
...
2. **WooCommerce Integration**:
   ...
   - Place widgets or icons in various positions within WooCommerce pages
   - Before Main Content, Before Product, After Product, Product Summary, After Cart Button, and more.
   - Control icon sizes and define widgets to maximize customer engagement on product pages.

3. **Social User Profiles Management**:
...
6. **User-Friendly and Accessible**:
...
7. **Enhanced Communication and Engagement**:
...
= 1.0.7 12 December 2024 =
Add AI Instructions

= 1.0.6 11 November 2024 =
Update pop style

= 1.0.5 06 November 2024 =
Update chat icon style

= 1.0.4 03 November 2024 =
New theme
