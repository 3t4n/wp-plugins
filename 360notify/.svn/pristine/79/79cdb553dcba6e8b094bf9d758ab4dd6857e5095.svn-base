    ...
    */
    ...
    private function get_send_on_fields() {
        return array(
            ...
            'desc'    => __( 'Choose when to send a WhatsApp notification message to your new contact', '360notify' ),
            'type'    => 'multicheck',
            'options' => array(
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Customer status WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we would like to personally thank you for using our services.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_lead',
                'label'   => __( 'Lead status WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for showing interest in our services. Our sales representative will contact you shortly.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_refused',
                'label'   => __( 'Contact refused status WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we sincerely apologise for not meeting your expectations. We promise to do better.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_blacklisted',
                'label'   => __( 'Contact blacklisted WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for your interest all these time, however we will need to terminate your access from our services.', '360notify' )
            ),
        );
    }
