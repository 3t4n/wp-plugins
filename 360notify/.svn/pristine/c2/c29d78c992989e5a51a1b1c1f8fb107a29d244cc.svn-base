...
class Notify_Multivendor_WCFM_Marketplace_Manager extends Abstract_Notify_Multivendor {
	...
	public function get_vendor_data_list_from_order( $order_id ) {
		...
		$this->log->add( 'NotifySMS_Multivendor', 'Raw data: ' . wp_json_encode( $vendor_data_list ) );
