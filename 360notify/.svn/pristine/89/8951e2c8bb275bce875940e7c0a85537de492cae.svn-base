    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Confirmed status WhatsApp message', '360notify' ),
            ...
            array(
                ...
                'label'   => __( 'Unconfirmed status WhatsApp message', '360notify' ),
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry to see you go, tell us how cna we improve to serve you better in the future ?', '360notify' )
            ),
        );
    }
