...
require_once NOTIFY_PLUGIN_DIR . 'includes/plugins/NotifyAssignOrders.php';
...
class NotifySupportedPlugin {
    ...
    public static function get_activated_plugins()
    {
        ...
        if(NotifyAssignOrders::plugin_activated())
            $supported_plugins[] = NotifyAssignOrders::class;
