...
class NotifyARMemberPremium implements Notify_PluginInterface, Notify_Register_Interface {
    /*
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Cancel subscription WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription has been cancelled', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_after_user_plan_change',
                'label'   => __( 'After user plan changed WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your subscription has been changed to [name]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_after_user_plan_renew',
                'label'   => __( 'After user plan renewed WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription has been renewed at [amount]', '360notify' )
            ),
        );
    }
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription will expire in 1 Day, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription will expire in 2 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription will expire in 3 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [name] subscription will expire in [reminder_custom_time] Days, renew now to keep access. - custom', '360notify' )
            ),
        );
    }
