...
class Notify_WooCommerce_Setting implements Notify_Register_Interface {
	...
	function admin_menu() {
		add_options_page( __( '360Notify', '360notify' ), __( '360Notify WhatsApp Settings', '360notify' ), 'manage_options', '360notify-woocoommerce-setting',
	...
	function get_settings_sections() {
		$sections = array(
			array(
				...
				'title' => __( '360Notify WhatsApp Settings', '360notify' )
			),
			array(
				'id'    => 'notifysms_admin_setting',
				'title' => __( 'Admin Settings', '360notify' ),
                'submit_button' => class_exists("woocommerce") ? null : '',
			),
			array(
                'id'    => 'notifysms_customer_setting',
				'title' => __( 'Customer Settings', '360notify' ),
                'submit_button' => class_exists("woocommerce") ? null : '',
			)
		);
		...
		$settings_fields = array(
			'notifysms_setting' => array(
				array(
					...
					'label' => __( 'API Key', '360notify' ),
					'desc'  => __( 'Your whatsapp apikey. Account can be registered <a href="https://app.360messenger.com" target="blank">here</a>', '360notify' ),
					'type'  => 'text',
				),
				array(//Get default country v1.1.17
					'name'    		=> 'notifysms_woocommerce_country_code',
					'label'   		=> __( 'Default country', '360notify' ),
					'class'     	=> array('chzn-drop'),
					'placeholder'	=> __( 'Select a Country', '360notify'),
					'desc'    		=> __( 'Selected country will be use as default country info for mobile number When it starts with zero. In this case, the default country code will be inserted instead of zero. ', '360notify'),
					'type'    		=> 'select',
					'options' 		=> $countries,
				...
				array(
					...
					'label'   => __( 'Export Log', '360notify' ),
					'desc'    => 'Enable </br></br><a href="' . admin_url( 'admin.php?page=notifysms-download-file&file=360MessengerWhatsApp' ) . '" class="button button-secondary">Export Log</a><div id="notify_sms[keyword-modal]" class="modal"></div>',
					'type'    => 'checkbox',
					'default' => 'off'
				)
			),
			'notifysms_admin_setting'     => array(
				array(
					...
					'label'   => __( 'Enable Suborders WhatsApp Notifications', '360notify' ),
				...
				array(
					...
					'desc'    => __( 'Choose when to send a status notification message to your admin <br> Set <strong>low stock threshold</strong> for each product under <strong>WooCommerce Product -> Product Data -> Inventory -> Low Stock Threshold</strong>', '360notify' ),
					'type'    => 'multicheck',
					'default' => array(
					...
					'options' => array(
						...
						'low_stock_product' => __(' Low stock product ', '360notify' ),
					)
				),
				array(
					'name'  => 'notifysms_woocommerce_admin_sms_recipients',
					'label' => __( 'Mobile Number', '360notify' ),
					'desc'  => __( 'Mobile number to receive new order WhatsApp notification. To send to multiple receivers, separate each entry with comma such as 0123456789, 0167888945', '360notify' ),
					'type'  => 'text',
				),
				array(
					'name'    => 'notifysms_woocommerce_admin_sms_template',
					'label'   => __( 'Admin WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="admin" data-attr-target="notifysms_admin_setting[notifysms_woocommerce_admin_sms_template]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Low Stock Product Admin WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords-low-product-stock]" data-attr-type="admin" data-attr-target="notifysms_admin_setting[notifysms_woocommerce_admin_sms_template_low_stock_product]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
					'default' => __( '[shop_name] : Your product [product_name] has low stock. Current quantity: [product_stock_quantity]. Please restock soon.', '360notify' )
                ),
			),
			'notifysms_customer_setting'  => array(
				...
				array(
					...
					'label'   => __( 'Send WhatsApp to', '360notify' ),
					'desc'    => ' ' . __( 'Choose who to send WhatsApp to', '360notify' ),
					'type'    => 'multicheck',
                    'default' => array(
						'billing-recipient'  => __('billing-recipient', '360notify' ),
					),
					'options' => array(
                        'billing-recipient'  => __('Billing Recipient', '360notify' ),
						'shipping-recipient' => __('Shipping Recipient', '360notify' ),
					)
				),
				array(
					'name'    => 'notifysms_woocommerce_send_sms',
					'label'   => __( '	Send notification on', '360notify' ),
					'desc'    => __( 'Choose when to send a status notification message to your customer', '360notify' ),
					'type'    => 'multicheck',
                    'default' => array(
						'on-hold'    => __('on-hold', '360notify' ),
						'processing' => __('processing', '360notify' ),
				...
				array(
					...
					'label'   => __( 'Default Customer WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="default" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_default]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Pending WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="pending" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_pending]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'On-hold WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="on_hold" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_on-hold]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Processing WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="processing" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_processing]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Completed WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="completed" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_completed]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Cancelled WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="cancelled" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_cancelled]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Refunded WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="refunded" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_refunded]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
				...
				array(
					...
					'label'   => __( 'Failed WhatsApp Message', '360notify' ),
					'desc'    => __('Customize your WhatsApp with <button type="button" id="notify_sms[open-keywords]" data-attr-type="failed" data-attr-target="notifysms_customer_setting[notifysms_woocommerce_sms_template_failed]" class="button button-secondary">Keywords</button>', '360notify' ),
					'type'    => 'textarea',
					'rows'    => '8',
					'cols'    => '500',
					'css'     => 'min-width:350px;',
                            ...
                            if( ! array_key_exists($processed_key, $setting_fields[$field][$i]['options']) ) {
                                ...
                                if($field == 'notifysms_customer_setting') {
                                    $setting_fields[$field][] = array(
                                        ...
                                        'label'   => "{$processed_value} Customer WhatsApp Message",
                                        ...
                                        'cols'    => '500',
                                        'css'     => 'min-width:350px;',
                                        'default' => "Your {$processed_value} WhatsApp template"
                                    );
                                }
                            }
                        }
	...
	function plugin_page() {
		...
		echo '<input type="hidden" value="' . esc_attr(join(",", $this->get_additional_billing_fields())) . '" id="notifysms_new_billing_field" />';
...
echo '</div>';
    ...
    public function display_account_balance()
    {
        ...
        try {
            ...
            $log->add("360MessengerWhatsApp", $e->getMessage(), 1);
        ...
        ?>
            ...
            ?>
                ...
                <p>
                    Your server's IP address is: <b><?php echo esc_html($client_ip_address); ?></b>
                </p>
            <?php } ?>
        <?php
    }
