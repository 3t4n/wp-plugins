    ...
    */
    ...
    public function get_setting_section_data()
    {
        return array(
            ...
            'title' => 'Five Star Restaurant Reservations',
        );
    }
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [name], your table reservation for [party] people on [date] is [post_status]', '360notify' )
            ),
            array(
            ...
            array(
                ...
                'label'   => __( 'Closed WhatsApp message', '360notify' ),
    ...
    private function get_reminder_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Send reminder to confirmed customer reservation', '360notify' ),
                'desc'    => '',
                'type'    => 'multicheck',
                'options' => array(
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [name], your table reservation for [party] people on [date] is [post_status] - custom', '360notify' )
            ),
        );
    }
