...
class Notify_Multivendor_WooCommerce_Product_Vendors_Manager extends Abstract_Notify_Multivendor {
	...
	public function get_vendor_data_list_from_order( $order_id ) {
		...
		$this->log->add( '360MessengerWhatsApp', 'Raw data: ' . wp_json_encode( $vendor_data_list ) );
