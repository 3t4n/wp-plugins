    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Transaction completed WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for your purchase of [membership_post_title] at [trans_total]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_transaction_expired',
                'label'   => __( 'Transaction expired WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your recurring transaction of [trans_total] has expired', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_transaction_pending',
                'label'   => __( 'Transaction pending WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your transaction [trans_id] is pending', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_transaction_failed',
                'label'   => __( 'Transaction failed WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your recurring transaction of [trans_total] has failed', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_transaction_refunded',
                'label'   => __( 'Transaction refunded WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry that you are not satisfied with our services, your payment of [trans_total] has been refunded', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_subscription_paused',
                'label'   => __( 'Subscription paused WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription has been paused', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_subscription_resumed',
                'label'   => __( 'Subscription resumed WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription has been resumed', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_subscription_stopped',
                'label'   => __( 'Subscription stopped WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription has stopped', '360notify' )
            ),
        );
    }
    ...
    private function get_reminder_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Send reminder to renew active subscription', '360notify' ),
                'desc'    => '',
                'type'    => 'multicheck',
                'options' => array(
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription will expire in 1 Day, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription will expire in 2 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription will expire in 3 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_post_title] subscription will expire in [reminder_custom_time] Days, renew now to keep access. - custom', '360notify' )
            ),
        );
    }
        ...
        if($enable_notifications === "on"){
            if(!empty($send_on) && is_array($send_on)) {
                if($event instanceof MeprTransaction) {
                    ...
                    $this->log->add("360MessengerWhatsApp", '$event object: ' . $event);
                    return;
                }
