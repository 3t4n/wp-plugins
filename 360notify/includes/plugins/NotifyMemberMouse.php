...
class NotifyMemberMouse implements Notify_PluginInterface, Notify_Register_Interface {
    /*
    ...
    */
    ...
    public function get_plugin_settings($with_identifier = false) {
        $settings = array(
            ...
            "notifysms_automation_sms_template_member_membership_change"   => notifysms_get_options("notifysms_automation_sms_template_member_membership_change", $this->get_option_id()),
            "notifysms_automation_sms_template_member_status_change"       => notifysms_get_options("notifysms_automation_sms_template_member_status_change", $this->get_option_id()),
            "notifysms_automation_sms_template_bundles_added_to_member"    => notifysms_get_options("notifysms_automation_sms_template_bundles_added_to_member", $this->get_option_id()),
            "notifysms_automation_sms_template_bundles_status_change"      => notifysms_get_options("notifysms_automation_sms_template_bundles_status_change", $this->get_option_id()),
            "notifysms_automation_sms_template_payment_received"           => notifysms_get_options("notifysms_automation_sms_template_payment_received", $this->get_option_id()),
            "notifysms_automation_sms_template_payment_rebill"             => notifysms_get_options("notifysms_automation_sms_template_payment_rebill", $this->get_option_id()),
            "notifysms_automation_sms_template_payment_rebill_declined"    => notifysms_get_options("notifysms_automation_sms_template_payment_rebill_declined", $this->get_option_id()),
            "notifysms_automation_sms_template_refund_issued"              => notifysms_get_options("notifysms_automation_sms_template_refund_issued", $this->get_option_id()),
        );
    ...
    private function get_send_on_fields() {
        return array(
            ...
            'desc'    => __( 'Choose when to send a WhatsApp notification message to your customer', '360notify' ),
            'type'    => 'multicheck',
            'options' => array(
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                'name'    => 'notifysms_automation_sms_template_member_membership_change',
                'label'   => __( 'Member membership change', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_member_membership_change]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your current membership is [membership_level_name]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_member_status_change',
                'label'   => __( 'Member status change', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_member_status_change]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your membership is [status_name]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_bundles_added_to_member',
                'label'   => __( 'Bundles added to member', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_bundles_added_to_member]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], [bundle_name] has been added to your account successfully', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_bundles_status_change',
                'label'   => __( 'Bundles status changed', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_bundles_status_change]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [bundle_name] is [bundle_status_name]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_received',
                'label'   => __( 'Payment received', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_payment_received]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your payment of [order_total] is successful', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_rebill',
                'label'   => __( 'Payment rebill', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_payment_rebill]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], recurring payment of [order_total] is successful', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_rebill_declined',
                'label'   => __( 'Payment rebill declined', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_payment_rebill_declined]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], recurring payment of [order_total] is unsuccessful, talk to our support', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_refund_issued',
                'label'   => __( 'Refund issued', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[notifysms_automation_sms_template_refund_issued]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry to see you go, we have refunded your payment of [order_total]', '360notify' )
            ),
        );
    }
    ...
    private function get_reminder_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Send reminder to renew membership', '360notify' ),
                'desc'    => '',
                'type'    => 'multicheck',
                'options' => array(
            ...
            array(
                ...
                'label' => '',
                'desc'  => 'Enter the custom time you want to remind your customer before membership expires in (minutes) <br> Choose when to send a WhatsApp reminder message to your customer <br> Please set your timezone in <a href="' . admin_url('options-general.php') . '">settings</a> <br> You must setup cronjob <a href="https://github.com/360messenger/cronwordpress">here</a> ',
                'type'  => 'number',
            ),
        );
    }
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            array(
                ...
                'label'   => __( '1 day reminder WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_level_name] subscription will expire in 1 Day, renew now to keep access.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_rem_2',
                'label'   => __( '2 days reminder WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_level_name] subscription will expire in 2 Days, renew now to keep access.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_rem_3',
                'label'   => __( '3 days reminder WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_level_name] subscription will expire in 3 Days, renew now to keep access.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_custom',
                'label'   => __( 'Custom time reminder WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [membership_level_name] subscription will expire in [reminder_custom_time] Days, renew now to keep access. - custom', '360notify' )
            ),
        );
    }
    ...
    private function schedule_reminders($data, $status) {
        ...
        $this->log->add("360MessengerWhatsApp", "Member ID: {$mm_user->getId()}");

        if(strtolower($mm_user->getStatusName()) != 'active') {
            $this->log->add("360MessengerWhatsApp", "member status is not active. member status: {$mm_user->getStatusName()}");
    ...
    public function send_sms_reminder($data, $status)
    {
        if( (! isset($data['member_id'])) || empty($data['member_id'])) {
            $this->log->add("360MessengerWhatsApp", '$data["member_id"] is not set or empty');
            return;
        }
        $mm_user = new MM_User($data['member_id']);
        $this->log->add("360MessengerWhatsApp", 'Converted $mm_user to an instance of MM_User');

        $this->log->add("360MessengerWhatsApp", "User ID: {$mm_user->getId()}");
