...
class NotifyFluentCRM implements Notify_PluginInterface, Notify_Register_Interface {
    /*
    ...
    */
    ...
    public function get_plugin_settings($with_identifier = false)
    {
        $settings = array(
            ...
            "notifysms_automation_sms_template_subscribed"    => notifysms_get_options("notifysms_automation_sms_template_subscribed", $this->get_option_id()),
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                'name'    => 'notifysms_automation_sms_template_subscribed',
                'label'   => __( 'Subscribed status WhatsApp message', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="customer" data-attr-target="%1$s[notifysms_automation_sms_template_subscribed]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for subscribing, trending contents will be delivered to you.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_unsubscribed',
                'label'   => __( 'Unsubscribed status WhatsApp message', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="lead" data-attr-target="%1$s[notifysms_automation_sms_template_unsubscribed]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], you have unsubscribed and will no longer receive trending contents.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_pending',
                'label'   => __( 'Pending status WhatsApp message', '360notify' ),
                'desc'    => sprintf('Customize your WhatsApp with <button type="button" id="notifysms-open-keyword-%1$s-[dummy]" data-attr-type="refused" data-attr-target="%1$s[notifysms_automation_sms_template_pending]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], would you like to opt-in to our newsletter and get trending contents delivered to you ? We promise we will not spam you.', '360notify' )
            ),
        );
    }
