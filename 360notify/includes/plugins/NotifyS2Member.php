...
class NotifyS2Member implements Notify_PluginInterface, Notify_Register_Interface {
    ...
    */
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Subscription WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for your subscription of [s2member_access_label]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment',
                'label'   => __( 'Payment received WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for your purchase of [s2member_access_label], [currency_symbol][regular] has been deducted from your account.', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_modification',
                'label'   => __( 'Payment modification WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your membership has been modified, current membership is [s2member_access_label]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_end_of_term',
                'label'   => __( 'End of term WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], [s2member_access_label] has expired', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_refund_or_reversal',
                'label'   => __( 'Refund or reversal WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your payment of [currency_symbol][-amount] for [s2member_access_label] has been refunded.', '360notify' )
            ),
        );
    }
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [s2member_access_label] will expire in 1 Day, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [s2member_access_label] will expire in 2 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [s2member_access_label] will expire in 3 Days, renew now to keep access.', '360notify' )
            ),
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [s2member_access_label] will expire in [reminder_custom_time] Days, renew now to keep access. - custom', '360notify' )
            ),
        );
    }
    ...
    public function send_sms_reminder($user, $params, $status)
    {
        ...
        $this->log->add("360MessengerWhatsApp", "send_sms_reminder params: " . $params);
    ...
    {
        $this->log->add("360MessengerWhatsApp", "send_cust_notification params: " . $params);
