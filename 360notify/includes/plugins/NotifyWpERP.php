    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'New customer WhatsApp message', '360notify' ),
            ...
            array(
                ...
                'label'   => __( 'New lead WhatsApp message', '360notify' ),
            ...
            array(
                ...
                'label'   => __( 'New opportunity WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], when would be a good time for our sales representative to schedule a call with you to discuss more on our service?', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_new_subscriber',
                'label'   => __( 'New subscriber WhatsApp message', '360notify' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for subscribing to us. We will notify you of HOT contents', '360notify' )
            ),
        );
    }
