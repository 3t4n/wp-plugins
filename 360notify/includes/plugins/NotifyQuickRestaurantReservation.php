    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [qrr_user_name], your reservation for [qrr_party] on [qrr_date_formatted] is [qrr_booking_status]', '360notify' )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_confirmed',
                'label'   => __( 'Confirmed WhatsApp message', '360notify' ),
    ...
    private function get_reminder_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Send reminder to customer before reservation', '360notify' ),
                'desc'    => '',
                'type'    => 'multicheck',
                'options' => array(
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [qrr_user_name], your reservation for [qrr_party] on [qrr_date_formatted] is [qrr_booking_status]. - custom', '360notify' )
            ),
        );
    }
