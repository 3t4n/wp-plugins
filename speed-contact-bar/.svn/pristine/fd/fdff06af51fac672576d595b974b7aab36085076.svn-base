...
* **"Perfect! Just tried it and it works!"** in [WordPress.org Support Forum](https://wordpress.org/support/topic/hide-on-desktop-show-on-mobile/#post-11917727) by immortalguru on Septemer 10, 2019
* **"Useful addition for any business. Could be crucial."** in [10 Best Free Restaurant WordPress Plugins of 2019](https://www.wpexplorer.com/free-restaurant-wordpress-plugins/) by John Hughes on June 2, 2019
* **"FANTASTIC Plugin!"** in [WordPress.org Reviews](https://wordpress.org/support/topic/fantastic-plugin-982/) by maderemark on August 10, 2018
* **"Speed Contact Bar là một bar plugin rất tốt cho mọi doanh nghiệp ..."** in [10 Plugin miễn phí tốt nhất cho Nhà Hàng năm 2018](https://dieuhau.com/plugin-mien-phi-cho-nha-hang/) by Duy Anh on May 18, 2018
* **"Speed Contact Bar is ideal when you want visitors to get in touch fast ..."** in [18 Plugins To Customize the Header And Footer Of Your Site](https://premium.wpmudev.org/blog/18-plugins-to-customize-the-header-and-footer-of-your-site/) by Claire Brotherton on April 30, 2018
...
7. **WhatsApp**, **Messenger** and **Telegram** to open an available chat client, can be displayed **with a text of your choice**
8. any further content you wish by using the filter hook `speed-contact-bar-data` (as documented in FAQ section &quot;How to add and re-order list entries by using hooks&quot;).
...
1. **Page types where to hide the bar**: You can set on which page types the bar is not displayed, e.g. start page, archive page, search results page etc.
2. **Maximal viewport width to hide the bar**: You can specify the window width up to which the bar is not displayed, e.g. in Smartphones 
3. **Minimal viewport width to hide the bar**: You can specify the window width from which the bar is not displayed, e.g. in desktop browsers
4. **Position of the bar**: You can place the bar at the **top** or **bottom** on every page
5. **Fixed position**: You can set whether it should **scroll** with the content or **stay fixed**
6. **Horizontal padding** of the contact bar
7. **Vertical padding** of the contact bar
8. **Space between bar and page content** if the bar is fixed
...
16. **Icon size**
17. **Headline visibility**: switch the headline on or off
18. **Headline text**
19. **Headline HTML tag**
20. **Headline URL** to make the headline a link
21. **Shadow under or above the bar** for a chic 3D effect
22. **Link target** of all links to open a contact link in the same window or in a new window
23. **Show contact data on small displays** instead of showing icons only
24. specify a display width as a trigger to show or to hide the bar
25. any further style you wish by using the filter hook `speed-contact-bar-style`
...
function add_speed_contact_bar_mailaddress ( $list_items ) {
	...
	$list_items[] = sprintf(
		'<li class="scb-email"><a rel="nofollow" href="%s"><img src="%sassets/images/email_%s.svg" width="%d" height="%d" alt="%s" /><span>%s</span></a></li>',
...
= 6.2 =
* Fixed conflict of multiple calls of the output buffer, reported in the [WordPress.org Forum](https://wordpress.org/support/topic/ob_get_clean-creates-conflict/)
...
= 6.7.0 =
Added WhatsApp option, new screenshots, tested with WP 5.4.2

= 6.6.1 =
Full width input fields, fixed wrong checkbox attributes, tested with WP 5.4

= 6.6.0 =
Added options for the page types to hide the bar on those pages. Tested with WP 5.3

= 6.5.1 =
Changed ID names of LI elements to class names. Adapt the CSS code of your website if necessary! Tested with WP 5.2.4

= 6.5.0 =
Added option for the minimum window width to hide the bar, achieved compatibility with WPML, tested with WP 5.2.3

= 6.4.2 =
Successfully tested with WP 5.2.1

= 6.4.1 =
Renewed mobile phone icons, fixed Instagram icon and e-mail icon, tested with WP 5.0.2

= 6.4.0 =
Added dynamic padding for the body element if fixed position of the bar is set

= 6.3.1 =
Added russian translation, set all contact bar links as nofollow, tested with WP 4.9.8

= 6.3 =
Added SMS option and spanish translation, fixed output buffer conflict, tested with WP 4.9.7

= 6.2 =
Fixed conflict of multiple calls of the output buffer, tested with WP 4.9.6
