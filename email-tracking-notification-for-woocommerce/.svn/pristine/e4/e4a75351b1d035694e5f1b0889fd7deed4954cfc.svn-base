...
<p><?php _e('The number of your package is', 'tracking_email') ?> <br /><strong><?php echo $tracking_number; ?><strong></p>
<hr>
<p><?php _e('Sent with', 'tracking_email') ?> <?php echo $tracking_carrier; ?></p>
<p style="margin-top:20px;margin-bottom:20px;">
	<a class="btn btn-block btn-outline-secondary" role="button" href="<?php echo $tracking_url; ?>"><?php _e('Track your parcel', 'tracking_email') ?></a>
</p>
