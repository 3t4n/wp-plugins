...
class SpeedSize_Settings
{
    ...
    {
        check_admin_referer('speedsize_clear_css_cache_nonce');
    ...
    public static function render_admin_settings_page()
    {
        ...
        <div class="wrap">
            ...
            <?php if (SpeedSize_Config::is_css_parsing_enabled()): ?>
                <a class="button" href="<?php echo wp_nonce_url('admin-post.php?action=speedsize_clear_css_cache', 'speedsize_clear_css_cache_nonce'); ?>">Clear CSS Parser Cache</a>
                <hr>
            <?php endif; ?>
