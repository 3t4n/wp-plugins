...
class SpeedSize_Config
{
    ...
    /**
     * @method is_using_speedsize_aicdn
     * @return boolean
     */
    public static function is_using_speedsize_aicdn()
    {
        return \strpos(self::get_speedsize_service_url(''), 'aicdn.speedsize.com') !== false ? true : false;
    }

    /**
     * @method should_pass_speedsize_params_as_query_string
     * @param  bool         $refresh    Skip self cache.
     * @return bool
     */
    public static function should_pass_speedsize_params_as_query_string($refresh = false)
    {
      if (!isset(self::$cache['should_pass_speedsize_params_as_query_string']) || $refresh) {
          self::$cache['should_pass_speedsize_params_as_query_string'] = self::is_using_speedsize_ecdn() || self::is_using_speedsize_aicdn();
      }
      return self::$cache['should_pass_speedsize_params_as_query_string'];
    }
