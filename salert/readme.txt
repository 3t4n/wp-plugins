...
= 1.2.5 =
- Compatibility check with latest WordPress version 6.3.1

= 1.2.4 =
- Fixed popup content issue
...
= 1.2.1 =
- Compatibility check with latest WordPress version 6.1.1

= 1.2.0 =
- Compatibility check with latest WordPress version 5.9

= 1.1.9 =
- Compatibility check with latest WordPress version 5.8

= 1.1.8 =
- Compatibility check with latest WordPress version 5.7

= 1.1.7 =
- Compatibility check with latest WordPress version 5.6

= 1.1.6 =
- Set default enable for Responsive
- Compatibility check with latest WordPress version 5.5.3

= 1.1.5 =
- Responsive issue fixed

= 1.1.4 =
- Added separator field for names and countries
- Compatibility check with latest WordPress version 5.4.2

= 1.1.3 =
- Fixed issue of saving data

= 1.1.2 =
- Fixed Background preview issue
- Minor improvements

= 1.1.1 =
- Removed Shortcode attributes
- Added Popup enable/disable option
- Fixed Box Shadow issue
- Improve Backed Preview
...
= 1.0.9 =
- Added Link to Fake Products
- Fixed z-index issue for popup

= 1.0.8 =
- Added Image Style Option
- Minor css improvements

= 1.0.7 =
- PHP warning issue fixed for latest update

= 1.0.6 =
- Minor warning issue fixed
- Added Time Period Option
- Added ago Text Option
...
= 1.0.3 =
- Added option for close button
- Improved some CSS

= 1.0.2 =
- Changed backend user interface
- Added option for box shadow
