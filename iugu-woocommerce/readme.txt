...
= 3.2.0 = 
* Melhoria: Adicionado compatibilidade com HPOS (High-Performance Order Storage on WooCommerce)
* Correção: Adicionado compatibilidade com o DDI

= 3.1.14 = 
* Correção: Adicionado compatibilidade com o plugin "Conditional Checkout Fields for WooCommerce"

= 3.1.13 = 
* Correção: Alterado o link do boleto de "bank_slip_url" para novas faturas criadas

= 3.1.12 = 
* Correção: Removido warnings
* Correção: Adicionado mensagem de incompatibilidade com "High-performance order storage"

= 3.1.11 = 
* Correção: Correção de data para o carnê
