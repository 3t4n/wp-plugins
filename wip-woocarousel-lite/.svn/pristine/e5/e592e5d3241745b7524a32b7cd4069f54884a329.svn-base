						...
						case 'navigation': ?>
							...
							<div id="WIP_plugin_panel_tabs">
								...
								<ul>
                                    ...
                                    <li><a target="_blank" href="<?php echo esc_url('https://demo.themeinprogress.eu/woocarousel/free-version/');?>"><?php esc_html_e( 'Documentation', 'wip-woocarousel-lite'); ?></a></li>
							...
							if (isset($value['type'])) :
								...
								case 'import_export': ?>
									...
									<div class="WIP_plugin_panel_box">
									    ...
									    <label><?php _e( "Current plugin settings","wip-woocarousel-lite"); ?></label>
									...
									<div class="WIP_plugin_panel_box">
									    ...
									    <label><?php esc_html_e( "Reset plugin settings","wip-woocarousel-lite"); ?></label>
									...
									<div class="WIP_plugin_panel_box">
									    ...
									    <label><?php esc_html_e( "Import plugin settings","wip-woocarousel-lite"); ?></label>
