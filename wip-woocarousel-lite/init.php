...
if( !class_exists( 'wip_woocarousel_lite_init' ) ) {
	...
	?>
		...
		<div class="error">
			<p><?php esc_html_e( 'WIP WooCarousel Lite is enabled but inactive. WooCommerce must be installed and activated for the plugin to function properly.', 'wip-woocarousel-lite' ); ?></p>
		</div>
