    ...
    class GAS_Give_Square_fonly {
        ...
        public function gas_location_dropdown(){
            ...
            if( $_REQUEST['post']){
                ...
                $wp_giveform_meta = $wpdb->get_results(
                    $wpdb->prepare(
                        "SELECT meta_key, meta_value FROM wp_give_formmeta WHERE form_id = %s",
                        sanitize_text_field($_REQUEST['post'])
                    )
                );					
        ...
        public function gas_square_product_settings_fields() {
            ...
            $settings = array(
                array(
                    'name' => esc_html(__('Apply Settings', 'give-square')),
                    'desc' => esc_html(__('Select individually setting to use seperate settings for this specific form', 'give-square')),
                    'id' => 'oauth_preferences',
                    'class' => 'oauth_preferences',
                    'type' => 'radio_inline',
                    'default' => 'custom',
                    'options' => array(
                        'general' => esc_html(__('Globally', 'give-square')),
                        'custom' => esc_html(__('Individually', 'give-square')),
                    )
                ),
                array(
                    'name' => esc_html(__('Mode', 'give-square')),
