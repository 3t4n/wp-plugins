...
class appalify_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'hidden':
				...
				$html .= '<input id="' . esc_attr( $field['id'] ) . '" type="' . esc_attr( $field['type'] ) . '" name="' . esc_attr( $option_name ) . '" placeholder="' . esc_attr( $field['placeholder'] ) . '" value="' . esc_attr( $data ) . '"' . esc_attr($min) . '' . esc_attr($max) . '/>' . "\n";
				break;
			...
			case 'checkbox':
				...
				$html .= '<input id="' . esc_attr( $field['id'] ) . '" type="' . esc_attr( $field['type'] ) . '" name="' . esc_attr( $option_name ) . '" ' . esc_attr($checked) . '/>' . "\n";
				break;
			...
			case 'select':
				...
				foreach ( $field['options'] as $k => $v ) {
					...
					$html .= '<option ' . esc_attr(selected( $selected, true, false )) . ' value="' . esc_attr( $k ) . '">' . esc_attr($v) . '</option>';
				}
				$html .= '</select> ';
				break;
			...
			case 'image':
				...
				$html .= '<input id="' . esc_attr($option_name) . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'appalify' ) . '" data-uploader_button_text="' . __( 'Use image', 'appalify' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'appalify' ) . '" />' . "\n";
				$html .= '<input id="' . esc_attr($option_name) . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'appalify' ) . '" />' . "\n";
	...
	public function display_meta_box_field( $field = array(), $post = null ) {
		...
		echo esc_attr($field); //phpcs:ignore
	}
