...
if (! function_exists('xero_deactivate_feedback')) {
	function xero_deactivate_feedback($data) {
...
?>
		<div class="xero-feedback-wrapper" id="<?php echo esc_attr($plugin_deactivate_id); ?>" style="display:none;">
			<div class="xero-feedback-card">
				...
				<form method="get" class="xero-notice-data">
					...
					<div class="xero-feedback-tabs">
						<div class="xero-checkbox-group">
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="switching-domain" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
										...
										<span
											class="xero-checkbox-label"><?php esc_html_e('Switching Domain', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="couldnt-understand" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
										...
										<span
											class="xero-checkbox-label"><?php esc_html_e('Couldn\'t understand', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="found-a-better-plugin" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
		...
		c12.322-12.327,12.322-32.307-0.005-44.634L1579.829,1125.662z" />
										...
										<span
											class="xero-checkbox-label"><?php esc_html_e('Found a better plugin', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="missing-a-specific-feature" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
	...
	C499.5,480.7,531.3,438.3,499.5,385.4z M298.4,438.3h-84.7v-84.7h84.7V438.3z M298.4,311.3h-84.7V120.7h84.7V311.3z" />
										...
										<span
											class="xero-checkbox-label"><?php esc_html_e('Missing a specific feature', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="not-working" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
		...
		C442.303,271.102,426.367,287.057,406.663,287.057z" />
										...
										<span
											class="xero-checkbox-label"><?php esc_html_e('Not working', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
							<div class="xero-checkbox">
								<label class="xero-checkbox-wrapper">
									<input type="checkbox" class="xero-checkbox-input" name="others" />
									<span class="xero-checkbox-tile">
										<span class="xero-checkbox-icon">
											<svg width="192" height="192" fill="currentColor" viewBox="0 0 32 32" id="icon"
												...
												<rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;"
													class="xero-icon-others-1" width="32" height="32" />
											</svg>
										</span>
										<span
											class="xero-checkbox-label"><?php esc_html_e('Others', 'data-collector-insights'); ?></span>
									</span>
								</label>
							</div>
						</div>
					</div>
					<div class="xero-feedback-comments">
						<label>
							<?php esc_html_e('What is the main reason for deactivating?', 'data-collector-insights'); ?>
						</label>
						<textarea name="xero-feedback-input-comments" rows="4"></textarea>
					</div>
					<div class="xero-feedback-actions">
						...
						<div>
							...
							<button name="xero_status_sub_and_dea" value="skip" type="button"
								class="xero-feedback-submit-btn button button-secondary"
