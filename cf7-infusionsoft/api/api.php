...
if(!class_exists('vxcf_infusionsoft_api')){
    
class vxcf_infusionsoft_api extends vxcf_infusionsoft{
...
public function get_tags(){ 
  ...
  $tags_all=array();
     if(is_array($res) && isset($res['tags']) && is_array($res['tags'])){
     $tags_all=$res['tags'];
       if(!empty($res['next'])){
...
<methodCall>
  ...
  <params>
    ...
    <param>
      <value><string>".htmlentities($extra['description'])."</string></value>
    </param>
    <param>
      <value><string>".htmlentities($extra['notes'])."</string></value>
    </param>
  </params>
</methodCall>";
break;
