...
return [
	...
	'gateway_settings' => [
		...
		'type'        => 'title',
		'description' => __('These are the gateway settings to allow you to connect with the Dojo gateway. <a target="_blank" href="https://docs.dojo.tech/development-resources/portal">Read more</a>', 'woocommerce-dojo'),
	],
	...
	'webhook_title' => [
        ...
        'type'        => 'title',
        'description' => sprintf(
            __('Add the following webhook endpoint <strong style="background-color:#ddd;">&nbsp;%s&nbsp;</strong> to your <a target="_blank" href="https://developer.dojo.tech">Dojo Developer portal</a> (opens in a new tab) (if there isn\'t one already).<br>This will enable you to receive notifications on the payment statuses. <a target="_blank" href="https://docs.dojo.tech/plugins/woocommerce/configure#step-3-add-a-webhook-endpoint">Read more</a>.', 'woocommerce-dojo'),
            WC_Dojo_Utils::get_dojo_webhook_url()
        ),
    ],
    ...
    'additional_plugin_options' => [
        'title'       => __('Additional Options', 'woocommerce-dojo'),
        'type'        => 'title',
    ],
