<?php
	...
	class Feedaty_Woocommerce_Rating {
		...
		private function define_admin_hooks() {
			...
			$this->loader->add_action( 'woocommerce_product_options_pricing', $plugin_admin, 'deploy_ean_for_simple' );
			$this->loader->add_action( 'woocommerce_variation_options_pricing', $plugin_admin, 'deploy_ean_for_variable', 10, 3 );
			$this->loader->add_action( 'save_post', $plugin_admin, 'save_ean_field' );
			$this->loader->add_action( 'woocommerce_save_product_variation', $plugin_admin, 'save_ean_field', 10, 2 );
			...
			//$this->loader->add_action( 'feedaty_cron', $plugin_admin, 'send_merchant_info' );
			//$this->loader->add_action( 'feedaty_cron_daily', $plugin_admin, 'send_merchant_info' );
			//$this->loader->add_action( 'cron_logger', $plugin_admin, 'cron_logger' );
			$this->loader->add_action( 'init', $plugin_admin, 'setup_cron' );
		}
