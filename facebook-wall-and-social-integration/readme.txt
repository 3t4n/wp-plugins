...
Contributors: mitsol
Tags: Facebook, Facebook posts, Facebook wall, Facebook page, Facebook Feed, Events, Shortcode, Social, Status, Posts, Facebook wall, Plugin, Custom, Facebook group, Social media, Seo, Responsive 
...
Formerly known as **Facebook wall and social integration** allows you to display completely customizable Facebook feed of any public Facebook page or group in your website.

== Description == 
Mitsol Social Post Feed (Formerly **Facebook wall and social integration**) shows **facebook page/group feed/wall posts** in your website.You will only have to put facebook id of page or group and access token in the plugin settings. Graph API is used to get page/group feed content from facebook. If you face any problems in running it just read [doc](http://extensions.techhelpsource.com/facebook_wall_documentation_wordpress.htm) & contact us.
...
A perfect display of your Facebook page/group content in your business/personal websites, view customer reviews to know what our customer says. Post ideas about the plugin in [pro version website](http://extensions.techhelpsource.com/forum "pro version website forum") & [follow me](https://twitter.com/mitsol12 "follow me") on twitter for update of changes. 

= Features =

* **Graph API usage** for page/group feeds
...
= How do I find the ID of my Facebook page or group? =
...
2. Configuring the Mitsol Social Post Feed plugin
...
= 1.6 =
* Another layout has been added to show picture at left, 3 picture sizes(thumb, half, full) per layout can be set to give more layouts(pro)
* Facebook reactions(haha, wow, angry...) counts has been added (pro) 
* Fixes on FB API latest changes regarding maximum 100 posts per display, other small fixes. 
* Now a page access token is must for showing FB PAGE posts with comments if token used from the FB application which created after November 7,2017. New page access token generation link has been added as summarized all in documentation (pro) 
= 1.7 =
* It's now up to date with facebook's breaking changes for app review, everything summarized in documentation.
* Access token generation tab added within plugin's settings page 
* Added fix for field removal of video type of post 
= 1.8 =
* Facebook removed some fields from Graph API version 3.3, so token used by newly created app after 30th April, 2019 should not throw errors now.
* other minor fixes 
= 1.9 =
* Up to date with facebook's removal of some fields used within Graph API
* Updated for the facebook's new app type feature and added permissions
* other minor fixes 
= 1.10 =
* Updated for Facebook graph API changes on likes and other fields
* other minor fixes 
= 1.11 =
* Some security fixes and code reviews 
