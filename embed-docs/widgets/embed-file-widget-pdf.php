 ...
 * @since 2.0.2
 */
class Elementor_embed_file_Widget_pdf extends \Elementor\Widget_Base {
		...
		$this->add_control(
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => __( 'https://a1office-cdn.a1office.co/wp-content/uploads/2022/09/Embed-Docs-Plugin.pdf', 'elementor' ),
					'show_external' => true,
					'default' => [
						'url' => 'https://a1office-cdn.a1office.co/wp-content/uploads/2022/09/Embed-Docs-Plugin.pdf',
						'is_external' => true,
						'nofollow' => true,
					],
					'dynamic' => [
