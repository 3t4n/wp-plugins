 ...
 *
 * The argument should be in the form: Dc_login\Namespace. The
...
function dcl_autoload( $class_name ) {
	...
	if ( file_exists( $filepath ) ) {
		...
		error_log( "The file attempting to be loaded at $filepath does not exist." );
	}
}