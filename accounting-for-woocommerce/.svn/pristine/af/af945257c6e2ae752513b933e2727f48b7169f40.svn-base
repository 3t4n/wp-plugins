...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/wordpress/plugin/accounting-for-woocommerce/vdp)
...
- Simplier setting for Piece Number
- default value for piecedate
- Fix warning for undeclared vars
- Fix textdomain in some strings

### 1.6.7

- fix Reflected Cross-Site Scripting, reported by vgo0

### 1.6.6

- Do not apply coupon ratio on shipping line
- Add `woocommerce_accounting_book_code` hook filter

### 1.6.5

- Fix rounding on coupons
- Fix shipping taxes amount in some cases
