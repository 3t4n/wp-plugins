...
/**
 * Get book code for order
 * 
 * @param object $order
 * 
 * @return string
 */
function woocommerce_accounting_get_book_code_for_order($order): string{
    global $original_book_code;
    global $book_code_status;
	...
	return apply_filters('woocommerce_accounting_book_code', $book_code, $order);
}
