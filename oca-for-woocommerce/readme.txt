...
= 3.2.7 =
* Fixed rare error that could occur with the tracking form shortcode

= 3.2.6 =
* Added hook wc_oca_process_order

= 3.2.5 =
* Added hook wc_oca_order_process_request_data
* Added hook wc_oca_order_cancel_request_data

= 3.2.4 =
* Added hook wc_oca_order_process_failed

= 3.2.3 =
* Fixed error with a test order not canceling in some rare cases

= 3.2.2 =
* Bumped compatibility with WooCommerce and WordPress
