 ...
 * @since 1.0.0
 */
class BdevsEffect3 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect3';
    }

    public function get_title() {
        return __( 'Effect 3', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 3', 'hover-effects-addons-for-elementor' ),
            ]
        );
    ...
    public function render() {
        ...
        <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect3 <?php echo esc_attr($settings['hover_direction']); ?>"><a href="<?php echo esc_url($settings['link']); ?>">
        <div class="img">
