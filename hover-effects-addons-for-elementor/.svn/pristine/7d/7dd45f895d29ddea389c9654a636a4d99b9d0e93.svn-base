 ...
 * @since 1.0.0
 */
class BdevsEffect5 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect5';
    }

    public function get_title() {
        return __( 'Effect 5', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 5', 'hover-effects-addons-for-elementor' ),
            ]
        );
    ...
    public function render() {
        ...
        ?>
          ...
          <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect5"><a href="<?php echo esc_url($settings['link']); ?>">
          <div class="img">
