 ...
 * @since 1.0.0
 */
class BdevsEffect7 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect7';
    }

    public function get_title() {
        return __( 'Effect 7', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 7', 'hover-effects-addons-for-elementor' ),
            ]
        );
    ...
    public function render() {
        ...
        ?>
            <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect7 <?php echo esc_attr($settings['hover_direction']); ?>"><a href="<?php echo esc_url($settings['link']); ?>">
                    <div class="img">
