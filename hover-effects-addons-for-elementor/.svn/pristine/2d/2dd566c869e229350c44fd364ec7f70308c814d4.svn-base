 ...
 * @since 1.0.0
 */
class BdevsEffect2 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect2';
    }

    public function get_title() {
        return __( 'Effect 2', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 2', 'hover-effects-addons-for-elementor' ),
            ]
        );
   ...
   $this->add_control(
    ...
    public function render() {
        ...
        ?>
          ...
          <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect2 <?php echo esc_attr($settings['hover_direction']); ?>"><a href="<?php echo esc_url($settings['link']); ?>">
          <div class="img">
