<?php
namespace HowerEffectsElementor\Widget;
 ...
 * @since 1.0.0
 */
class BdevsEffect6 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect6';
    }

    public function get_title() {
        return __( 'Effect 6', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 6', 'hover-effects-addons-for-elementor' ),
            ]
        );
        ...
        $this->add_control(
            'scale_effect',
            [
                'label' => esc_html__( 'Scale Effect', 'hover-effects-addons-for-elementor' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'scale_up' => esc_html__( 'Scale Up', 'hover-effects-addons-for-elementor' ),
                    'scale_down' => esc_html__( 'Scale Down', 'hover-effects-addons-for-elementor' ),
                    'scale_down_up' => esc_html__( 'Scale Down Up', 'hover-effects-addons-for-elementor' ),
                ],
                'default' => 'scale_up', // Default effect
            ]
        );
    ...
    public function render() {
        ...
        ?>
            <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect6 <?php echo esc_attr($settings['scale_effect']); ?>"><a href="<?php echo esc_url($settings['link']); ?>">
            <div class="img">
