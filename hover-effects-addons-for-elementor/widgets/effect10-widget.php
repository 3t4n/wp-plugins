 ...
 * @since 1.0.0
 */
class BdevsEffect10 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect10';
    }

    public function get_title() {
        return __( 'Effect 10', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 10', 'hover-effects-addons-for-elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'top_to_bottom', // Default direction
            ]
    );  
    ...
    <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect10 <?php echo esc_attr($settings['hover_direction']); ?>"><a href="<?php echo esc_url($settings['link']); ?>">
                <div class="img">
