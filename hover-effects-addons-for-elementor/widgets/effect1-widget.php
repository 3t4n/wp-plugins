 ...
 * @since 1.0.0
 */
class BdevsEffect1 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect1';
    }

    public function get_title() {
        return __( 'Effect 1', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 1', 'hover-effects-addons-for-elementor' ),
            ]
        );
    ...
    public function render() {
        ...
        ?>
                        <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect1">
                        ...
                        <?php endif; ?>
                                ...
                                <div class="info">
                                    <div class="info-back">
                                        ...
                                        <p><?php echo esc_html($settings['description']); ?></p> <!-- Fixed spelling -->
                                    </div>
                                </div>
                            </a>
                        </div>
