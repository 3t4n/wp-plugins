 ...
 * @since 1.0.0
 */
class BdevsEffect8 extends \Elementor\Widget_Base {

    public function get_name() {
        return 'bdevs-hover-effect8';
    }

    public function get_title() {
        return __( 'Effect 8', 'hover-effects-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Effect 8', 'hover-effects-addons-for-elementor' ),
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label'       => esc_html__( 'Description', 'hover-effects-addons-for-elementor' ),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [ 'active' => true ],
                'default'     => esc_html__( 'This is description', 'hover-effects-addons-for-elementor' ),
                'label_block' => true,
            ]
        );
    ...
    public function render() {
        ...
        <div class="item-hover circle <?php echo $settings['show_colored'] === 'yes' ? 'colored' : ''; ?> effect8 <?php echo esc_attr($settings['hover_direction']); ?>">
