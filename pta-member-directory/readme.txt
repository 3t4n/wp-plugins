...
*   Added security checks to the server side function that processes the drag and drop sorting positions, to ensure that sort order is not getting manipulated by a malicious user. This was a minor vulnerability that was fixed, but only affected the sort order of positions.
*   Tested with WordPress version 6.7.1 and PHP 8.3.13

**Version 1.7.0**

*   Changed sanitizing function for contact form messages so that line breaks are not stripped out.
*   Tested with WordPress version 5.8.0 and PHP 7.4.19

**Version 1.6.10**

*   Tested up to WordPress version 5.5.1
*   Minor code cleanup and add missing doc blocks (prep for new features)
*   Begin to remove "PTA" from plugin title and various text throughout the plugin and help tabs
*   No operational changes

**Version 1.6.9**

*   Fixed bug in capability check for user to view when hide from public is checked and minimum level to view is Contributor
*   Updated tested up to value

**Version 1.6.8**

*   Modifications to the way the directory table is displayed when used in conjunction with the Member Directory DataTables extension. The DataTables extension makes your table responsive, sortable, searchable, and pages the results.
*   Minor typo fix
