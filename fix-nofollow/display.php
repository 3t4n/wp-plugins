    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){           
           jQuery("#select_page").change(function(){               
               window.location.href ="admin.php?page=fix-nofollow/customfields.php&pageno=" + jQuery(this).val();
           });
        });
    </script>
    <?php endif;?>
...
?>
<h2>Showing links for <?php echo count($fixnf_data) ?> post(s)</h2>
<?php
endif; ?>
