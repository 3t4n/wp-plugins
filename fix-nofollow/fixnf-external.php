...
{
	$exclude_urls = '';
	if(isset($_REQUEST['fixnf_exclude_urls']))
		$exclude_urls = $_REQUEST['fixnf_exclude_urls'];
	
        $custom_fields = '';
	if(isset($_REQUEST['sel_custom_fields']))
		$custom_fields = $_REQUEST['fixnf_custom_fields'];
	update_option('fixnf_exclude_urls', $exclude_urls);	
	update_option('fixnf_custom_fields', $custom_fields);	
	$msg = 'Successfully saved the options';	
}
else
{
	$exclude_urls = get_option('fixnf_exclude_urls');	
	$custom_fields = get_option('fixnf_custom_fields');	
}
