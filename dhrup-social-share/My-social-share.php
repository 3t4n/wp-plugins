...
Description: Basic Social Share Plugin
Version: 1.0
Author: Dhrup IT Solutions

*/

function dhp_scripts_social(){
    wp_enqueue_style('Social', plugins_url( '/css/style.css' , __FILE__ ), false, '2.2', 'all' );
}
add_action("wp_enqueue_scripts","dhp_scripts_social");



function dhrup_social_share_menu_item()
{
  add_submenu_page("options-general.php", "Dhrup Social Share", "Dhrup Social Share", "manage_options", "social-share", "dhrup_social_share_page"); 
}

add_action("admin_menu", "dhrup_social_share_menu_item");




function dhrup_social_share_page()
{
   ?>
      <div class="wrap">
...
function dhrup_social_share_settings()
{
...
add_action("admin_init", "dhrup_social_share_settings");



function add_dhrup_social_share_icons($content)
		{
		    $html = "<div class='social-share-wrapper'><div class='share-on'>Share on: </div><ul class='dshare'>";
...
add_shortcode("dpsocial", "add_dhrup_social_share_icons");
