...
<table cellpadding="0" cellspacing="0" border="0" class="fixed striped awcshm-horizonal-table">
	<tbody>
		<tr>
			<th width="130" valign="middle"><?php echo esc_html__( 'Transport Type', 'alopeyk-shipping' ); ?></th>
			<td valign="middle">
				<?php echo isset($data['type_name']) ? esc_html($data['type_name']) : '—'; ?>
			</td>
		</tr>
		<tr>
			<th width="130" valign="middle"><?php echo esc_html__( 'Shipping Time', 'alopeyk-shipping' ); ?></th>
			<td valign="top">
				<?php echo isset($data['scheduled_at']) ? esc_html(wp_date('j F Y (g:i A)', strtotime($data['scheduled_at']))) : esc_html__('Now', 'alopeyk-shipping'); ?>
			</td>
		</tr>
		<?php
			if ( isset( $data['orders'] ) && $orders = $data['orders'] ) {
				$count = count( $orders );
				$label = $count > 1 ? esc_html__( 'Orders', 'alopeyk-shipping' ) : esc_html__( 'Order', 'alopeyk-shipping' );
		?>
		<tr>
		...
		?>
		<tr>
			<th width="130" valign="middle"><?php echo esc_html__( 'Has Return', 'alopeyk-shipping' ); ?></th>
			<td valign="top">
				<?php echo isset( $data['shipping']->has_return ) && $data['shipping']->has_return ? esc_html__( 'yes', 'alopeyk-shipping' ) : esc_html__( 'no', 'alopeyk-shipping' ); ?>
			</td>
		</tr>
		<tr>
			<th width="130" valign="middle"><?php echo esc_html__( 'Cost', 'alopeyk-shipping' ); ?></th>
			<td valign="top">
			<?php 
		...
		<tr>
			<th width="130" valign="middle"><?php echo esc_html__( 'Order Point', 'alopeyk-shipping' ); ?></th>
			<td valign="top">
		...
		?>
				<tr>
					<th width="130" valign="middle"><?php echo esc_html__( 'Discount Code Value', 'alopeyk-shipping' ); ?></th>
					<td valign="top">
						<?php 
					...
					?>
						<span class="remove-discount-coupon"><a href="#"><?php echo esc_html__( '(Remove)', 'alopeyk-shipping' ); ?></a></span>
					</td>
				</tr>
				<tr>
					<th width="130" valign="middle"><?php echo esc_html__( 'Final Cost', 'alopeyk-shipping' ); ?></th>
					<td valign="top">
						<?php 
