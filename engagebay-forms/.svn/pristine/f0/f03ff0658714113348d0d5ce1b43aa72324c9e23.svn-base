...
if ( defined( 'ELEMENTOR_VERSION' ) ) {
	add_action( 'elementor/widgets/register', 'engagebay_forms_register_new_widgets' );
}

function engagebay_forms_register_new_widgets( $widgets_manager ) {
	require_once "includes/class-engagebay-forms-elementor-widget.php";
	$widgets_manager->register( new Engagebay_Forms_Elementor_Widget() );
}
    ...
    <div class="wrap">
		...
		if ( $rest_api ) {
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a href="?page=engage-bay&tab=landing-pages"
                   class="nav-tab <?php if ( $active_tab == 'landing-pages' ) {
					   echo 'nav-tab-active';
				   } ?>"><?php _e( 'Landing Pages', 'sandbox' ); ?></a>
                <a href="?page=engage-bay&tab=email-templates"
                   class="nav-tab <?php if ( $active_tab == 'email-templates' ) {
					   echo 'nav-tab-active';
...
function engagebay_forms_page() {
	...
	if ( empty( $email ) ) {
		...
		?>
		<?php $api_url = 'https://app.engagebay.com/dev/api/panel/forms?page_size=1000';
                    ...
                    <div class="board-display open">
                        ...
                        <div class="board-btm-display">
                            <div class="board-pad-text">
                                Capture leads and dramatically improve your conversions by using our beautiful forms.
                                Our forms are simple to create, and they are stylish and responsive. <br>
                            </div>

                            <div class="">
                                <div class="">
                                    <p class="ab-pad-top-20 sm-mr-20 ab-inline-block">
                                    <form action="https://<?php echo $domain; ?>.engagebay.com/user-login#forms"
                ...
                <div class="data min-height-60vh row center">
                    <div class="board-pad-display col-md-9">
                        <div class="board-display open">
                            ...
                            <div class="board-btm-display">
                                <div class="board-pad-text">
                                    Capture leads and dramatically improve your conversions by using our beautiful
                                    forms. Our forms are simple to create, and they are stylish and responsive. <br>
                                </div>
                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <form action="https://<?php echo $domain; ?>.engagebay.com/user-login#forms"
                                            ...
                                            <input type="hidden" name="email" value="<?php echo $email; ?>">
                                            <input type="hidden" name="password" value="<?php echo $password; ?>">
                                            <input type="submit" class="btn btn-space btn-warning"
                                                   value="Create Inline Forms">
                                        </form>
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="mainLeftbox col-md-12">
                    <div class="">
                        <h1 class="wp-heading-inline">
                            ...
                            <div class="float_r">
                                <a href="https://<?php echo $domain; ?>.engagebay.com/home#lead-grabbers"
                                   target="_blank"
                                   class="btn" return false;">Create Inline Forms</a>
                                <a href="javascript:void(0)" target="_blank" class="page-refresh"
                                   onClick="window.location.href=window.location.href"><?php echo "<img src='" . plugins_url( '/images/refresh-icon.png', __FILE__ ) . "' title='Refresh'/>"; ?> </a>
                            </div>
                        </h1>
                    </div>
                            ...
                            <div class="table-row">
                                ...
                                <div class="inside">
                                    <a href="<?php echo $url_form; ?>"
                                       target="_blank"><?php echo "<img src='" . plugins_url( '/images/preview.svg', __FILE__ ) . "' title='Preview' width='25px' />"; ?> </a>
                                    <a href="https://<?php echo $domain; ?>.engagebay.com/home#forms/<?php echo $v['id']; ?>/edit"
                                       target="_blank"><?php echo "<img src='" . plugins_url( '/images/edit.svg', __FILE__ ) . "' title='Edit' width='18px'/>"; ?> </a>
                                </div>
                            </div>
							<?php ++ $i;
						} ?>
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                <p>Capture leads and dramatically improve your conversions by using our beautiful forms.
                                    Our forms are simple to create, and they are stylish and responsive. By displaying
                                    the right message at the right place, these forms can help you significantly grow
                                    your subscriber list and capture the most relevant and useful leads on your site
                                    across any device your visitor is using. The forms are completely customizable, so
                                    they can easily slot into your current website theme and style.</p>
                            </div>
                        </div>
                    </div>
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                ...
                                <iframe src="https://www.youtube.com/embed/rOKsN8qZlUA?autoplay=1&rel=0" width="100%"
                                        height="200px">
                                </iframe>
                            </div>
                        </div>
...
function engagebay_landing_page() {
	...
	if ( empty( $email ) ) {
		...
		?>
		<?php $api_url = 'https://app.engagebay.com/dev/api/panel/landingPage?page_size=1000';
		$response      = wp_remote_get( $api_url,
			array(
				'timeout'   => 40,
				'method'    => 'GET',
            ...
            <div class="data min-height-60vh row center">
                <div class="board-pad-display col-md-9">
                    <div class="board-display open">
                        ...
                        <div class="board-btm-display">
                            <div class="board-pad-text">
                                Choose from our wide selection of landing page templates to create the one which fits
                                your needs in no time. <br>
                            </div>
                            <div class="row">
                                <div class="col-xs-6 col-xs-offset-3">
                                    <p class="ab-pad-top-20 sm-mr-20 ab-inline-block">
                                    <form action="https://<?php echo $domain; ?>.engagebay.com/user-login#landingpages"
                                          method="post" target="_blank">
                                        <input type="hidden" name="command" value="login">
                                        <input type="hidden" name="email" value="<?php echo $email; ?>">
                                        <input type="hidden" name="password" value="<?php echo $password; ?>">
			...
			if ( ! $result ) {
                ...
                <div class="data min-height-60vh row center">
                    <div class="board-pad-display col-md-9">
                        <div class="board-display open">
                            ...
                            <div class="board-btm-display">
                                <div class="board-pad-text">
                                    Choose from our wide selection of landing page templates to create the one which
                                    fits your needs in no time. <br>
                                </div>
                                <div class="">
                                    <div class="">
                                        <p class="ab-pad-top-20 sm-mr-20 ab-inline-block">
                ...
                <div class="mainLeftbox col-md-12">
                    <div class="">
                        <h1 class="wp-heading-inline">
                            ...
                            <div class="float_r">
                                <a href="https://<?php echo $domain; ?>.engagebay.com/home#add-landingpage"
                                   target="_blank" class="btn" return false;">Create Landing Page</a>
                                <a href="javascript:void(0)" target="_blank" class="page-refresh"
                                   onClick="window.location.href=window.location.href"><?php echo "<img src='" . plugins_url( '/images/refresh-icon.png', __FILE__ ) . "' title='Refresh'/>"; ?></a>
                            </div>
                        </h1>
                    ...
                    <div class="table-view">
						...
						foreach ( $result as $k => $v ) {
                            ...
                            <div class="table-row">
                                ...
                                <div class="inside">
                                    <a href="https://<?php echo $domain; ?>.engagebay.com/landingpage/<?php echo $v->id; ?>"
                                       target="_blank" class="thickbox"
                                       id="preview"><?php echo "<img src='" . plugins_url( '/images/preview.svg', __FILE__ ) . "' title='Preview' width='25px'/>"; ?> </a>
                                    <a href="https://<?php echo $domain; ?>.engagebay.com/home#landingpage/<?php echo $v->id; ?>"
                                       target="_blank"><?php echo "<img src='" . plugins_url( '/images/edit.svg', __FILE__ ) . "' title='Edit' width='18px'/>"; ?> </a>
                                </div>
                            </div>
							<?php ++ $i;
                ...
                <div class="mainrightbox">
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                <p>Choose from our wide selection of landing page templates to create the one which fits
                                    your needs in no time. Or, if you prefer to create your own from scratch, build it
                                    in less than two minutes using our simple to use and straightforward landing page
                                    builder. Customize and optimize the page further to maximize visitor engagement,
                                    lead capture and conversion to customers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                <p>Watch our quick tour :</p>
                                <iframe width="100%" height="200" src="https://www.youtube.com/embed/9zSJT1rkHVk"
            ...
            <div class="row center min-height-60vh">
                ...
                <div class="board-pad-display col-md-9">
                    <div class="board-display open">
                        ...
                        <div class="board-btm-display">
                            <div class="board-pad-text">
                                Popups helps you engage website visitors, capture leads and grow your email lists. Use
                                EngageBay to design different varieties of clean, responsive and conversion-optimized
                                web popups. <br>
                            </div>
                            ...
                            <div class="">
                                <div class="">
                                    <div class="">
                                        <p class="ab-pad-top-20 sm-mr-20 ab-inline-block">
                                        <form action="https://<?php echo $domain; ?>.engagebay.com/user-login#lead-grabbers"
                                              method="post" target="_blank">
                                            <input type="hidden" name="command" value="login">
                                            <input type="hidden" name="email" value="<?php echo $email; ?>">
                                            <input type="hidden" name="password" value="<?php echo $password; ?>">
                                            <input type="submit" class="btn btn-space btn-warning"
                                                   value="Create Popup Forms">
                                        </form>
                                        </p>
                                    </div>
                                </div>
			...
			if ( ! $result ) {
                ...
                <div class="row center data min-height-60vh">
                    ...
                    <div class="board-pad-display col-md-9">
                        <div class="board-display open">
                            ...
                            <div class="board-btm-display">
                                <div class="board-pad-text">
                                    Popups helps you engage website visitors, capture leads and grow your email lists.
                                    Use EngageBay to design different varieties of clean, responsive and
                                    conversion-optimized web popups. <br>
                                </div>
                ...
                <div class="mainLeftbox col-md-12">
                    <div class="">
                        <h1 class="wp-heading-inline">
                            ...
                            <div class="float_r">
                                <a href="https://<?php echo $domain; ?>.engagebay.com/home#lead-grabbers"
                                   target="_blank" class="btn" return false;">Create Popup Forms</a>
                                <a href="javascript:void(0)" target="_blank" class="page-refresh"
                                   onClick="window.location.href=window.location.href"><?php echo "<img src='" . plugins_url( '/images/refresh-icon.png', __FILE__ ) . "' title='Refresh'/>"; ?></a>
                            </div>
                        </h1>
						...
						foreach ( $result as $k => $v ) {
                            ...
                            <div class="table-row">
                                ...
                                <div class="inside">
                                    <a href="<?php echo $url_form; ?>"
                                       target="_blank"><?php echo "<img src='" . plugins_url( '/images/preview.svg', __FILE__ ) . "' title='Preview' width='25px'/>"; ?> </a>
                                    <a href="https://<?php echo $domain; ?>.engagebay.com/home#lead-grabbers/<?php echo $v->id; ?>/edit"
                                       target="_blank"><?php echo "<img src='" . plugins_url( '/images/edit.svg', __FILE__ ) . "' title='Edit' width='18px'/>"; ?> </a>
                                </div>
                            </div>
							<?php ++ $i;
                ...
                <div class="mainrightbox">
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                <p>Popups helps you engage website visitors, capture leads and grow your email lists.
                                    Use EngageBay to design different varieties of clean, responsive and
                                    conversion-optimized web popups. Customize where they appear, when they appear, and
                                    how they look to create the perfect web popup the way you want. Displaying the right
                                    popup at the right time can help significantly grow your subscriber list and boost
                                    conversion rates. Send automated opt-in confirmation emails and autoresponders to
                                    welcome the leads after their subscription is confirmed. Send periodic engaging
                                    emails to further nurture your leads. Email marketing is the most proven profitable
                                    marketing channel returning $38 for every $1 spent.</p>
                            </div>
                        </div>
                    </div>
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="video-trigger">
                                <p>Watch our quick tour</p>
                                <iframe width="100%" height="200" src="https://www.youtube.com/watch?v=YMaSmho0YNY"
                                        frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
    ...
    <div class="data min-height-60vh row center">
        <div class="board-pad-display col-md-9">
            <div class="board-display open">
                ...
                <div class="board-btm-display">
                    <div class="board-pad-text">
                        Design beautiful and engaging emails and run email marketing campaigns at the click of a button.
                        <br>
                    </div>
                    <div class="row">
                        <div class="">
...
<div class="data min-height-60vh row center">
	...
	<?php
        ...
        <div class="mainLeftbox col-md-12">
            <div class="">
                <h1 class="wp-heading-inline">
                    ...
                    <div class="float_r">
                        <a href="https://<?php echo $domain; ?>.engagebay.com/home#add-email-template" target="_blank"
                           class="btn" return false;">Create Email Templates</a>
                        <a href="javascript:void(0)" target="_blank" class="page-refresh"
                           onClick="window.location.href=window.location.href"><?php echo "<img src='" . plugins_url( '/images/refresh-icon.png', __FILE__ ) . "' title='Refresh'/>"; ?></a>
                    </div>
                </h1>
            ...
            <div class="table-view">
				...
				foreach ( $result as $k => $v ) {
                    ...
                    <div class="table-row">
                        <div class="header hard-hide"><img src='<?php echo $thumbnail; ?>' title='Preview'
                                                           style="border-radius: 52px;" width='60px' height='60px'/>
                        </div>
                        <div>
                            <h2 class="heading"><?php echo ucfirst( $v->name ); ?> </h2>
                            <span>Created on <?php echo date( 'd-m-Y', $v->created_time ); ?></span>
                        ...
                        <div class="inside">
                            <a href="https://<?php echo $domain; ?>.engagebay.com/home#email-template/<?php echo $v->id; ?>"
                               class="" id=""
                               target="_blank"><?php echo "<img src='" . plugins_url( '/images/preview.svg', __FILE__ ) . "' title='Preview' width='25px'/>"; ?> </a>
                            <a href="https://<?php echo $domain; ?>.engagebay.com/home#email-template/<?php echo $v->id; ?>"
                               target="_blank"><?php echo "<img src='" . plugins_url( '/images/edit.svg', __FILE__ ) . "' title='Edit' width='18px'/>"; ?> </a>
        ...
        <div class="mainrightbox">
            <div class="postbox">
                ...
                <div class="inside">
                    <div class="video-trigger">
                        <p>Design beautiful and engaging emails and run email marketing campaigns at the click of a
                            button. Our simple to use software helps you effortlessly build emails and measure their
                            performance, making your next email marketing campaign engaging. You will get better
                            click-through rates each time. Our email marketing solution transforms your email results
                            into a marketing channel that continues to deliver a return on investment (ROI), time and
                            time again.</p>
                    </div>
                </div>
            </div>
            <div class="postbox">
                ...
                <div class="inside">
                    <div class="video-trigger">
                        <p>Watch our quick tour:</p>
                        <iframe width="290" height="200" src="https://www.youtube.com/embed/SMsO1PfRGw4" frameborder="0"
	...
	if ( isset( $email ) ) {
		...
		if ( $domain == '' && $rest_api == '' ) {
			...
			wp_redirect( '?page=engage-bay&tab=web-pop' );
		}
	}
	$rest_api = ( sanitize_text_field( get_option( 'engagebay_rest_api' ) ) );
	$domain   = ( sanitize_text_field( get_option( 'engagebay_domain' ) ) );
    ...
    <div class="be-wrapper be-login">
                ...
                <div class="splash-container">
                    <div class="panel">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <input class="form-control" type="email"
                                               pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,20}$" name="email"
                                               autocomplete="off" placeholder="Work Email" value="<?php echo $email; ?>"
                                               required>
                                    </div>
                                </div>
                                <div class="form-group">
                       ...
                       style='display: none;' id='gif' title='Landing Pages'/>"; ?>
                                        ...
                                        <!--                                            <a><img class="gsuite-img"-->
                                        <!--                                                    src="https://d2p078bqz5urf7.cloudfront.net/cloud/dev/assets/img/google-favicon.png"/></a>-->
                                        <!--                                            <a class="gsuite-btn-text"-->
                                        <!--                                               href="https://app.engagebay.com/oauth?wordpressPlugin=yes&wordpressPluginURL=-->
										<?php //echo admin_url( 'admin.php?page=engage-bay' ); ?><!--">SIGN-->
                                        <!--                                                IN WITH G SUITE</a>-->
                                        <!--                                        </div>-->
                                    </div>
                                </div>
                    ...
                    <div class="alert text-center">
                        <div>
                            ...
                            <div>Don't have an account? <a
                                        href="https://app.engagebay.com/signup"><?php _e( 'Sign Up', 'sandbox' ); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="splash-inner-container">
            <div class="panel">
                ...
                <hr>
                <div class="account-engagebay-label text-center">You are now connected with EngageBay. Need help? <a
                            class="" href="https://www.engagebay.com/support" rel="noopener noreferrer" target="_blank"><span>Contact us</span></a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form name="loginForm" id="loginForm" class="" action="#" method="post">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" name="siteurl" autocomplete="off"
                                           disabled="disabled" placeholder="siteurl" value="<?php echo $domain; ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" name="siteurl" autocomplete="off"
                                           disabled="disabled" placeholder="siteurl" value="<?php echo $email; ?>"
                                           required>
                                </div>
                                <div><a href="admin.php?page=engage-bay&tab=settings&edit=domain">Click to Edit
                                        details</a></div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="loginForm" name="loginForm" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <input class="form-control" type="name" name="name" autocomplete="name"
                                               placeholder="Name"
                                               title="Name should be between 1-30 characters in length. Both letters and numbers are allowed but it should start with a letter. Cannot contain special characters."
                                               minlength="1" maxlength="30" required=""
                                               pattern="^[a-zA-Z][a-zA-Z0-9 ]{1,30}$">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="position-relative">
                                        ...
                                        <input class="form-control user-email-field" id="register_email" type="email"
                                               name="email" required autocapitalize="off" minlength="6" maxlength="50"
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <input class="form-control" type="url" name="website" autocomplete="url"
                                               placeholder="Website URL" value="<?php echo $base_siteurl; ?>"
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <input class="form-control" type="password" name="password" pattern=".{4,20}"
                                               autocomplete="off" placeholder="Password"
                                               title="Enter at least 4 characters." required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="xs-pt-20 md-pt-20">
        ...
        <div class="be-content">
            <div class="main-content container-fluid">
                <div class="splash-container">
                    <div class="panel">
                        <div class="panel-heading">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/0oPsBkeoYKI"
                                    frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
    ...
    <div class="stunning-header stunning-header-bg-violet index-stunning-header">
        <div class="container">
            <div class="xs-pt-20 text-center">
                ...
                <div class="font-size-20 board-pad-text">Hello <span
                            class="text-capitalize"></span><?php echo ucfirst( $nicename ); ?></div>
            </div>
...
function engagebay_page_post_box( $post ) {
	...
	$domain   = ( sanitize_text_field( get_option( 'engagebay_domain' ) ) );
	$email    = ( sanitize_email( get_option( 'engagebay_email' ) ) );
	$api_url  = 'https://app.engagebay.com/dev/api/panel/landingPage?page_size=1000';
	$response = wp_remote_get( $api_url,
		array(
			'timeout'   => 40,
			'method'    => 'GET',
...
function engagebayform( $atts, $content, $tag ) {
	if ( isset( $atts['id'] ) ) {
		...
		$domain = ( sanitize_text_field( get_option( 'engagebay_domain' ) ) );
		$email  = ( sanitize_email( get_option( 'engagebay_email' ) ) );
		if ( $domain != '' && $email != '' && $js_api != '' ) {
			return "
            <script>
                var EhAPI = EhAPI || {}; 
                EhAPI.after_load = function() {
                    EhAPI.set_account('$js_api', '$domain');
                    EhAPI.execute('rules');
                };
                (function(d, s, f) {
        ...
        <div class='engage-hub-form-embed' id='eh_form_$id' data-id='$id'></div>";
		}
	}
}
...
function engagebay_forms_dependencies() {
	if ( isset( $_POST['name'] ) ) {
		wp_register_script( 'engagebay_refresh', plugins_url( 'js/refresh.js', __FILE__ ) );
	}
}
