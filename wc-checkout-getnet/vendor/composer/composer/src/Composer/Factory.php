...
use CoffeeCode\Composer\Repository\FilesystemRepository;
...
class Factory
{
    ...
    public function createComposer(IOInterface $io, $localConfig = null, $disablePlugins = false, ?string $cwd = null, bool $fullLoad = true, bool $disableScripts = false)
    {
        ...
        if ($fullLoad) {
            ...
            if (false === $disablePlugins && false === $disableScripts && !class_exists('CoffeeCode\Composer\InstalledVersions', false) && file_exists($installedVersionsPath = $config->get('vendor-dir').'/composer/installed.php')) {
                ...
                if (class_exists('CoffeeCode\Composer\InstalledVersions')) {
