 ...
 */
    class WC_Admin_Fortnox_Hub_Settings extends WC_Settings_Page
    {
        ...
        public function new_user_option()
        {
            ...
            // Skip stock check on variable parent
            WC_FH()->logger->add(sprintf('new_user_option: Skip stock check on variable parent'));
            update_option('fortnox_wc_product_update_variable_parent_skip_stock_check', 'yes');
        ...
        public function get_settings($current_section = '')
        {
            ...
            if ('payment_options' == $current_section) {
                        ...
                        $section_settings = array(
                            ...
                            array(
                                ...
                                'options' => array(
                                    ...
                                    'custom_remark' => __('Add a custom text as remark', 'woo-fortnox-hub'),
                                ),
                            ...
                            get_option('fortnox_invoice_payment_remark_' . $payment_method) == 'custom_remark' ? array(
                                'title' => __('Custom remark', 'woo-fortnox-hub'),
                                'type' => 'text',
                                'default' => '',
                                'desc' => __('Enter the custom remark', 'woo-fortnox-hub'),
                                'id' => 'fortnox_invoice_payment_custom_remark_' . $payment_method,
                            ) : array(),
                ...
                $initial_settings = array(
                    ...
                    array(
                        'title' => __('Send error email', 'woo-fortnox-hub'),
                        'default' => '',
                        'desc' => __('Send an email to the Fortnox user when a sync error occurs.', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_send_error_email',
                    ),
                    array(
                    ...
                    array(
                        'title' => __('Disable improved cURL', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'desc' => __('Disable improved cURL support for Fortnox API requests', 'woo-fortnox-hub'),
                        'default' => '',
                        'id' => 'fortnox_hub_dont_use_improved_curl',
                    ),
                    array(
                        'title' => __('Log requests', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'desc' => __('Log requests to Fortnox API', 'woo-fortnox-hub'),
                        'default' => '',
                        'id' => 'fortnox_hub_log_requests',
                    ),
                    array(
                    ...
                    array(
                        'title' => __('WPML default currency', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'desc' => __('Use the default currency for WPML', 'woo-fortnox-hub'),
                        'default' => '',
                        'id' => 'fortnox_wpml_default_currency',
                    ),
                    array(
                        'type' => 'sectionend',
                        'id' => 'fortnox_advanced_options',
                    ...
                    //fortnox_skip_shipping_in_description
                    array(
                        'title' => __('Skip shipping in row description', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'desc' => __('Skip the term "Shipping" in row description on Fortnox Order/Invoice', 'woo-fortnox-hub'),
                        'default' => '',
                        'id' => 'fortnox_skip_shipping_in_description',
                    ),
                    array(
                    ...
                    array(
                        'title' => __('Use new warehouse API', 'woo-fortnox-hub'),
                        'default' => '',
                        'desc' => __('Use the new warehouse API to get stock levels and item summaries', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_warehouse_use_new_api',
                    ),
                    ...
                    wc_string_to_bool(get_option('fortnox_wc_product_update_variable_parent')) ? array(
                        'title' => __('Skip stock check on variable parent', 'woo-fortnox-hub'),
                        'default' => 'yes',
                        'desc' => __('Skip stock check on variable parent when syncing to Fortnox', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_wc_product_update_variable_parent_skip_stock_check',
                    ) : array(),
                    wc_string_to_bool(get_option('fortnox_wc_product_update_variable_parent')) ? array(
                        'title' => __('Use only variant name when syncing variable product', 'woo-fortnox-hub'),
                        'default' => '',
                        'desc' => __('Use only the variant name when syncing a variable product to Fortnox instead of the parent product name', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_wc_product_update_variable_parent_enrich_only_variant',
                    ) : array(),
                    array(
                    ...
                    array(
                        'title' => __('Skip delivery date', 'woo-fortnox-hub'),
                        'default' => '',
                        'desc' => __('Skip delivery date when creating Fortnox orders/invoices', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_skip_delivery_date',
                    ),
                    array(
                    ...
                    //fortnox_customer_type
                    array(
                        'title' => __('Force customer type', 'woo-fortnox-hub'),
                        'type' => 'select',
                        'default' => '',
                        'desc' => __('Force the customer type to B2B or B2C', 'woo-fortnox-hub'),
                        'options' => array(
                            '' => __('Don\'t force customer type', 'woo-fortnox-hub'),
                            'B2B' => __('B2B', 'woo-fortnox-hub'),
                            'B2C' => __('B2C', 'woo-fortnox-hub'),
                        ),
                        'id' => 'fortnox_customer_type',
                    ),
                    ...
                    array(
                        'title' => __('Use additional variant identifier', 'woo-fortnox-hub'),
                        'default' => '',
                        'desc' => __('Use additional variant identifier when creating a Fortnox article from a WooCommerce product.', 'woo-fortnox-hub'),
                        'type' => 'checkbox',
                        'id' => 'fortnox_hub_products_additional_variant_identifier',
                    ),
                    array(
                    ...
                    array(
                        'title' => __('Sync to Fortnox daily', 'woo-fortnox-hub'),
                        'default' => '',
                        'type' => 'checkbox',
                    ...
                    array(
                        'title' => __('Sync from Fortnox daily', 'woo-fortnox-hub'),
                        'default' => '',
                        'type' => 'checkbox',
                        'desc' => __('Update all products in WooCommerce on a daily basis. Useful to to ensure that WooCommerce is always updated with correct data from Fortnox.', 'woo-fortnox-hub'),
                        'id' => 'fortnox_daily_sync_from_fortnox',
                    ),
                    array(
                ...
                if (get_option('fortnox_enable_admin_options') === 'yes') {
                    $settings = array_merge($settings, array(
                        ...
                        (get_option('fortnox_hub_use_v2_api') === 'yes') ? array(
                            'title' => __('Tenant UUID', 'woo-fortnox-hub'),
                            'type' => 'text',
                            'default' => '',
                            'desc' => __('The tenant UUID to use when communicating with Fortnox Hub API v2 API', 'woo-fortnox-hub'),
                            'id' => 'fortnox_tenant_uuid',
                        ) : array(),
                        //Use V2 API
                        array(
                        ...
                        (get_option('fortnox_hub_use_v2_api') === 'yes') ? array(
                            'title' => __('Accelerate connection', 'woo-fortnox-hub'),
                            'type' => 'checkbox',
                            'default' => '',
                            'desc' => __('Will accelerate the connection to Fortnox API', 'woo-fortnox-hub'),
                            'id' => 'fortnox_hub_accelerate_connection',
                        ) : array(),
                        array(
