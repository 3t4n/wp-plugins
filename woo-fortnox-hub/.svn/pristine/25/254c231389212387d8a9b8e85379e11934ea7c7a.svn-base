...
if (!class_exists('WCFH_Util', false)) {
    class WCFH_Util
    {
        ...
        public static function refunded_not_synced($order)
        {
            $refund_ids = array();
        ...
        public static function maybe_sync_variants($product){
            ...
            if (wc_string_to_bool(get_option('fortnox_wc_product_update_variable_parent_skip_stock_check'))) {
                $manage_stock = true;
            } else {
        ...
        public static function generate_variant_identifier($product_name, $product){
            ...
            if (get_option('fortnox_hub_products_additional_variant_identifier') == 'yes') {
        ...
        public static function get_regular_price($product)
        {
            ...
            if ($woocommerce_wpml && get_option('fortnox_wpml_default_currency') == 'yes') {
                // Remove price filter
        ...
        public static function set_sale_price($product, $price)
        {
            global $woocommerce_wpml;
