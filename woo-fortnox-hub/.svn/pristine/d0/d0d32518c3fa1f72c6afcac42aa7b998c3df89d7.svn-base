...
if (!class_exists('Woo_Fortnox_API_Hooks_And_Filters', false)) {
    ...
    class Woo_Fortnox_API_Hooks_And_Filters
    {
        ...
        public function __construct()
        {
            ...
            add_filter('fortnox_get_stockpoints', array($this, 'get_stockpoints'), 10, 1);
        ...
        public function get_stockpoints($stockpoints, $force_refresh = false)
        {

            $stockpoints = false;

            try {
                $stockpoints = get_fortnox_hub_transient('fortnox_stockpoints');
                if (!is_array($stockpoints) || $force_refresh) {
                    $stockpoints = WC_FH()->fortnox->warehouse_stockpoints();
                    set_fortnox_hub_transient('fortnox_stockpoints', $stockpoints, DAY_IN_SECONDS);
                }
        ...
        public function clear_cache()
        {
            ...
            delete_fortnox_hub_transient('fortnox_stockpoints');
