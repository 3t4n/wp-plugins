...
if (!class_exists('Woo_Fortnox_Hub_Document_Handler', false)) {
    ...
    class Woo_Fortnox_Hub_Document_Handler
    {
        ...
        public function processing_document($order_id)
        {
            ...
            if (apply_filters('fortnox_do_not_process_document', false, $order_id)) {
                return;
            }
            ...
            $refund_ids = WCFH_Util::refunded_not_synced($order);      
        ...
        public function processing_document_order($order_id)
        {
            ...
            if (apply_filters('fortnox_do_not_process_document_order', false, $order_id)) {
                return;
            }
        ...
        {
            if (apply_filters('fortnox_do_not_process_document_cancelled', false, $order_id)) {
                return;
            }
        ...
        public function fully_refunded_document($order_id, $refund_id)
        {
            ...
            if (apply_filters('fortnox_do_not_process_document_fully_refunded', false, $order_id)) {
                return;
            }
        ...
        public function partially_refunded_document($order_id, $refund_id)
        {
            ...
            if (apply_filters('fortnox_do_not_process_document_partially_refunded', false, $order_id)) {
                return;
            }
        ...
        public function completed_document($order_id)
        {
            ...
            if (apply_filters('fortnox_do_not_process_document_completed', false, $order_id)) {
                return;
            }
        ...
        public function document_set_warehouse_ready($order_id) {
            ...
            if (apply_filters('fortnox_do_not_process_document_set_warehouse_ready', false, $order_id)) {
                return;
            }
    ...
    Woo_Fortnox_Hub_Document_Handler::get_instance();
}
