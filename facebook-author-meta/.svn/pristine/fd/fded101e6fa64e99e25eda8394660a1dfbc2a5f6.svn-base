...
Tags: facebook, author, author-by, news feed, facebook meta, facebook posts author, facebook seo, Author Meta for Facebook , fb author profile link, AUTHOR'S FACEBOOK PROFILE LINK, author profile, fb profile link
...
== Description ==
This is a simple plugin that allows you to set **author name** that appears in **facebook news feeds**, when someone shares it on facebook. See screenshots and live demo.
= LATEST UPDATE =
Now you can set **author's facebook profile link** as **author name** for posts in news feeds. SEE LIVE DEMO and SCREENSHOTS

= How it Works =
* To enable **author's facebook profile link** setting, Goto **`Profile >> Facebook Profile Link (Author Meta for Facebook )`** and enter the full **url** of your **facebook profile**. This option sets the profile link as author's name for single **post/pages**. 
* For non-single pages like categories, date archives, tags, hompage etc
  Goto **`Settings >> Author Meta for Facebook `** and fill the last field with the **fb profile link**.
* If you have multiple auhtor's then each author must fill the field **`Profile >> Facebook Profile Link (Author Meta for Facebook )`** with facebook profile link.
...
1. By default this plugin automatically sets the **author name** for all **post/pages** etc. i.e. for all **single** post/pages.
	...
	* You can set your own custom author name for all **post/pages** here **Settings >> Author Meta for Facebook **.
...
= Note: =
* If you want to set **same author name** for whole website/blog  goto ***Settings >> Author Meta for Facebook *** and fill both the fields with **same author name**.
...
* Upload the **Author Meta for Facebook ** plugin to your blog, Activate it, and you're done!
* Goto **Settings >> Author Meta for Facebook ** to configure.
...
= 1.2.2 =
* tested with wordpress v 5.2.1
* documentation made simple and easier

= 1.2.1 =
* tested for latest version of wp
* minor changes
* [article:author meta not echoed when fb field is field]-->fixed

= 1.2 =
* old users must read instructions before updating
* bit change in structure(for fb profile link)
* removed unnecessary code
* configured for multi-author sites when using **Facebook Profile Link** as author name
