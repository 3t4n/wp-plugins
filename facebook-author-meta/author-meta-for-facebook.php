<?php
/**
 * Plugin Name: Author Meta for Facebook
 * Plugin URI: https://wordpress.org/plugins/author-meta-for-facebook/
...
<ul><li>The first option set the author name for all posts, pages, etc (i.e. single pages)</li><li>The second option sets the author name for all other pages such as archives, hompage, tags, category etc.
 ...
 </li><li>GOTO <code>Profile >> Facebook Profile Link (Facebook Author Meta)</code> and fill it with FB profile link.
 </li> </ul>
...
{
    ?>
        <h3>Facebook Profile Link (Facebook Author Meta)</h3>
