...
class Integration_Divi {
    ...
    public function init() {
        ...
        $this->name           = 'gs-bookshowcase-divi';
        $this->plugin_dir_url = GS_BOOKS_PLUGIN_URI . '/includes/integrations/assets/divi';

        add_action( 'et_builder_modules_loaded', 'GS_BOOKS\divi_widget_class' );
    ...
    public function editor_style() {
        ...
        <style>
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_bookshowcase:before {
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_bookshowcase {
                height: 67px;
            }
    ...
    public function wp_hook_enqueue_scripts() {
        ...
        if ( et_core_is_fb_enabled() ) {
            ...
            wp_enqueue_script( "{$this->name}-builder", $bundle_url, ['react-dom'], GS_BOOKS_VERSION, true );
...
function divi_widget_class() {
    ...
    class Divi_Widget extends \ET_Builder_Module {                
        ...
        public $slug       = 'gs_book_showcase';
        public $vb_support = 'on';        
        public function init() {                    
            $this->name = 'Book Showcase';
        }
        ...
        public function get_fields() {
            ...
            return array(
                'shortcode'     => array(
                    'label'           => esc_html__( 'Select Shortcode', 'gsbookshowcase' ),
                    'type'            => 'select',
                    'option_category' => 'basic_option',
                    'description'     => 'Show Books by Book Showcase Plugin',
                ...
                '__shortcode' => array(
                    'type'                => 'computed',
                    'computed_callback'   => array( 'GS_BOOKS\Divi_Widget', 'get_shortcode' ),
        ...
        static function get_shortcode( $args ) {
            ...
            return do_shortcode( sprintf( '[gs_bookshowcase id="%s" /]', esc_attr($args['shortcode']) ) );
