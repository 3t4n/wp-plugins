...
class Prd_Options_Front
{
	...
	public function front_fields_show()
	{
		...
		if (empty(Prd_General_Functions::get_product_options($product_id))) {
		...
		<div style="margin-bottom: 15px;">
			...
			<p class="real_time_product_sub_total_calculation" data-prod_title="<?php echo esc_attr($product->get_title()); ?>"
				data-prod_price="<?php echo esc_attr($price); ?>"
				data-currency_sym="<?php echo esc_attr(get_woocommerce_currency_symbol()); ?>"></p>
