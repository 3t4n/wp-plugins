...
function custom_woocommerce_product_custom_fields($tabs)
{
    ...
    if (!str_contains('variable grouped group', $product->get_type())) {
        ...
        $tabs['role_base_price_product_level'] = array(
            'label' => __('Role Base Pricing', 'product-restrictions'), // Navigation Label Name
        ...
        $tabs['ct_rbpaqp_mmq_restriction_product_level'] = array(
            'label' => __('Min Max Quantity', 'product-restrictions'), // Navigation Label Name
        ...
        $tabs['ct_rbpaqp_hpav_hide_prdct_nd_var'] = array(
            'label' => __('Hide Product', 'product-restrictions'), // Navigation Label Name
    ...
    $tabs['ct_rbpaqp_hpaatcb_hide_product'] = array(
        'label' => __('Hide Price And Add To Cart Button', 'product-restrictions'), // Navigation Label Name
...
function ct_hpav_product_level()
{
    ...
    <div id="role_base_price_product_level" class="panel woocommerce_options_panel">
        <h2> <?php echo esc_html__('Role Base Pricing Setting', 'product-restrictions'); ?> </h2>
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'label' => __('Enable Role Base Pricing Setting', 'product-restrictions'),
                'desc_tip' => 'true',
                'description' => __('Enable checkbox to set setting.', 'product-restrictions'),
    ...
    <div id="ct_rbpaqp_mmq_restriction_product_level" class="panel woocommerce_options_panel">
        <h2> <?php echo esc_html__('Min Max Quantity Setting', 'product-restrictions'); ?> </h2>
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'label' => __('Enable Min Max Quantity Setting', 'product-restrictions'),
                'desc_tip' => 'true',
                'description' => __('Enable checkbox to set setting.', 'product-restrictions'),
    ...
    <div id="ct_rbpaqp_hpaatcb_hide_product" class="panel woocommerce_options_panel">
        <h2> <?php echo esc_html__('Hide Price And Add To Cart Button Setting', 'product-restrictions'); ?> </h2>
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'label' => __('Enable Hide Price And Add To Cart Button', 'product-restrictions'),
                'desc_tip' => 'true',
                'description' => __('Enable checkbox to set setting.', 'product-restrictions'),
    ...
    <div id="ct_rbpaqp_hpav_hide_prdct_nd_var" class="panel woocommerce_options_panel">
        <h2> <?php echo esc_html__('Hide Product And Variation Setting', 'product-restrictions'); ?> </h2>
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'label' => __('Enable Hide Product ,And Variation Setting', 'product-restrictions'),
                'desc_tip' => 'true',
                'description' => __('Enable checkbox to set setting.', 'product-restrictions'),
    ...
    <div id="ct_rbpaqp_hpav_hide_prdct_nd_var" class="panel woocommerce_options_panel">
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'label' => __('Enable Hide Variation Setting', 'product-restrictions'),
                'desc_tip' => 'true',
                'description' => __('Enable checkbox to set setting.', 'product-restrictions'),
