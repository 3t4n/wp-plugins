...
add_settings_field(
	...
	esc_html__('Minimum Quantity Error Messages', ' product-restrictions'), // The label to the left of the option interface element.
...
function ct_rbpaqp_mmq_min_qty_error_message()
{
	...
	<textarea cols="60" rows="6"
		name="ct_rbpaqp_mmq_min_qty_error_message"><?php echo esc_attr($min_error_message); ?></textarea>
	<p><?php echo esc_html__('Set minimum quantity error message..Use variable {min_qty} to show user Minimum quantity limit', 'product-restrictions'); ?>
	</p>
...
add_settings_field(
	...
	esc_html__('Maximum Quantity Error Messages', ' product-restrictions'), // The label to the left of the option interface element.
...
function ct_rbpaqp_mmq_max_qty_error_message()
{
	...
	<textarea cols="60" rows="6"
		name="ct_rbpaqp_mmq_max_qty_error_message"><?php echo esc_attr($min_error_message); ?></textarea>
	<p><?php echo esc_html__('Set maximum quantity error message..Use variable {max_qty} to show user maximum quantity limit', 'product-restrictions'); ?>
	</p>
...
add_settings_field(
	...
	esc_html__('Cart Page Minimum Quantity Error Messages', ' product-restrictions'), // The label to the left of the option interface element.
...
function ct_rbpaqp_mmq_min_qty_error_message_crt_pg()
{
	...
	<textarea cols="60" rows="6"
		name="ct_rbpaqp_mmq_min_qty_error_message_crt_pg"><?php echo esc_attr($min_error_message); ?></textarea>
	<p><?php echo esc_html__('Set minimum quantity error message..Use variable {min_qty} to show user Minimum quantity limit', 'product-restrictions'); ?>
	</p>
...
add_settings_field(
	...
	esc_html__('Cart Page Maximum Quantity Error Messages', ' product-restrictions'), // The label to the left of the option interface element.
...
function ct_rbpaqp_mmq_max_qty_error_message_crt_pg()
{
	...
	<textarea cols="60" rows="6"
		name="ct_rbpaqp_mmq_max_qty_error_message_crt_pg"><?php echo esc_attr($min_error_message); ?></textarea>
	<p><?php echo esc_html__('Set maximum quantity error message.Use variable {max_qty} to show user maximum quantity limit. ', 'product-restrictions'); ?>
	</p>
