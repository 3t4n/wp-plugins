...
Contributors: HasThemes, devitemsllc, aslamhasib, zenaulislam, tarekht, madhusudandev
Tags: Film Studio, Elementor, Film Production, Movie Maker, Trailer.
...
== Description ==
WP Film Studio is a WordPress Movie Maker/Production Plugin  which allows you to display unlimited movies and trailers in your website. This plugin facilitates you with multiple options to attach the details & archive pages of the movies to your website. This plugin also supports Elementor page builder. Using the Elementor addons you will be able to place the movies or trailers anywhere on the pages according to your sweet will. Don't worry, these actions take no time. 

Remember, you are dealing with Entertainment. So, design and outlook is the most important thing what you have to be very careful of. And we care a lot about those things, whatsoever. 

 A theme using WP Film Studio Plugin : [Live Demo](https://thethemedemo.com/ftage/home-video-slider/)
> ## Download Our Film Studio WordPress Theme
> Ftage - Movie Production & Film Studio WordPress Theme only at $69
> [Purchase Now](https://themeforest.net/cart/configure_before_adding/20705434)


**New Feature Added:**
* Film Campaign Option
* Campaign Details Page
* Campaign Elementor Addons
...
* Movie/Trailer Custom Post Type
* Trailer Show In Popup Video
* Elementor Addons Added
* Elementor Addons Option
* Show Movie And Trailer Option
* Movie/Trailer Show Category Wise
* Two Style Movie/Trailer For Display
* All The Content Color and Typography Option
* Play/Link icon or Image Select Option
* Play/Link Style Option
* Show Item Option in Desktop, Tablet, Mobile
* Title And Hover Background Color Option
* Carousel Option
* Carousel Arrow Button Icon Select Option
* Carousel AutoPlay Control Option.
* Autoplay Speed Control Option.
* Carousel Show/Hide Option
* Fully Responsive and Mobile Ready.
...
* Movie Poster and Details Image option
* Related Movie Show/Hide Option in Details Page

<a href="https://wordpress.org/plugins/elementor/">Elementor</a> page builder is required to use addons in this plugin.

WP Film Studio - WordPress Movie and Trailer plugin has the following third-party resources:
...
= Version: 1.3.6 - Date: 07-08-2024 =
* Added: Option to add play icon size in WP Film Trailer Widget
* Fixed: SVG icon color change issue in WP Film Trailer Widget
* Fixed: Carousel Arrow Icon color change issue in WP Film Trailer Widget
* Fixed: Carousel Arrow Icon color change issue in WP Film Trailer Widget
* Tested: Compatibility with the latest version of WordPress
* Tested: Compatibility with the latest version of Elementor

= Version: 1.3.5 - Date: 12-02-2023 =
* Added: Nonce verification for recommended plugins
* Improved: Coding standards in some areas

= Version: 1.3.4 - Date: 07-11-2022 =
* Compatibility With The WordPress Latest Version

= Version: 1.3.3 - Date: 15-09-2022 =
* Added: Recommendation Submenu 

= Version: 1.3.2 - Date: 07-07-2022 =
* Compatibility with Elementor Latest Version
* Compatibility With WordPress Latest Version

= Version: 1.3.1 - Date: 27-03-2022 =
* Compatibility With the Elementor Latest Version
* Replace register_widget_type with register.
* Replace widgets_registered with register.

= Version: 1.3 - Date: 09-01-2022 =
* Compatibility With the Elementor Latest Version
* Updated the icofont latest version

= Version: 1.2.16 - Date: 07-11-2021 =
* Compatibility With Elementor Latest Version

= Version: 1.2.15 - Date: 21-08-2021 =
* Compatibility With Elementor Latest Version
* Updated All Elements title icon

= Version: 1.2.14 - Date: 26-07-2021 =
* Compatibility With WordPress Latest Version
* Compatibility With Elementor Latest Version

= Version: 1.2.13 - Date: 24-04-2021 =
* Compatible with Elementor Version 3.2.1

= Version: 1.2.12 - Date: 14-03-2021 =
* Custom Post Type Name Change option added

= Version: 1.2.11 - Date: 14-03-2021 =
* Compatible with WordPress 5.7 Version

= Version: 1.2.10 - Date: 14-01-2021 =
* Movie Category and Movie Publish Date Show/Hide Option added

= Version: 1.2.9 - Date: 03-01-2021 =
* Compatible with WordPress 5.6 Version
* Movie details page Elementor Support.
* Campaign details page Elementor Support.


= Version: 1.2.8 - Date: 07-10-2020 =
* Compatible with WordPress 5.5.1 Version

= Version: 1.2.6 - Date: 15-06-2020 =
* Update  PHP Version
* Elementor Editor Problem solved in addons



== Installation ==
This section describes how to install the WP Film Studio -  WordPress Movie and Trailer plugin and get it working.

= 1) Install =

= Modern Way: =
1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "WP Film Studio".
3. Install, then Activate it.

= Old Way: =
1. Unzip (if it is zipped) and Upload `wpfilm-studio` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. After install and activate the plugin you will get a notice to install CMB2 Plugin ( If already install it then do not show notice. ).
2. To install the plugin click on the "Button" Install CMB2.
3. After install and activate the both plugin you will get a Dashboard Menu(WpFilm).

== Screenshots ==
1. Movie/Trailer Style 1
2. Movie/Trailer Style 2
3. Movie Details Page
4. Movie Page Option
5. Movie/Trailer Option
6. Movie/Trailer Style 
