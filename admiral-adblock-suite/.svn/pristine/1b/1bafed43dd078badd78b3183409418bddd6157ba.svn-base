...
Your property ID is located on your Property Overview page at [getadmiral.com](https://app.getadmiral.com). If you don't already have an Admiral account create one, complete the signup process, and a Property ID will be provided.
