...
(ENGLISH)
Plugin that allows you to receive payments by Multibanco (ATM) references, Payshop, MB Way and Cofidis Pay. It also allows to send SMS messages with multibanco and payshop references (using WooCommerce &#45; APG SMS Notifications plugin or SMS Orders Alert/Notifications for WooCommerce).
...
Cofidis Pay allows you to make payments in installments of 3 to 12 times without interest.  
...
4. Vai a "Woocommerce"->"Configura&ccedil;&otilde;es" escolhe a aba "Pagamentos" clica na hiperliga&ccedil;&atilde;o "Multibanco (By LUSOPAY)" ou / e "Payshop (by LUSOPAY)" ou / e "MB Way (By LUSOPAY)" ou / e "Cofidis Pay (By LUSOPAY)".
...
4. Go to "Woocommerce" -> "Settings" tab and choose the "Payments". Click the link "Multibanco (By LUSOPAY)" e / ou "Payshop (By LUSOPAY)" e / ou "MB Way (By LUSOPAY)" ou / e "Cofidis Pay (By LUSOPAY)".
...
- Corrigimos incompatibilidades com a versão 8.2 PHP.

= 4.0.8 =

- Corrigimos um bug no backoffice no detalhe das encomendas.


= 4.0.7 =

- Remo&ccedil;&atilde;o do m&eacute;todo de pagamento "Transfer&ecirc;ncia Simplificada".
- Inser&ccedil;&atilde;o de um bloco com os dados de pagamento, por exemplo no caso do Multibanco mostra a refer&ecirc;ncia associada a essa encomenda.
- Nas encomendas virtuais quando recebia o pagamento o estado passava para "Em processamento" agora passa para "Conclu&iacute;do".

= 4.0.6 =

- Removemos uma informa&ccedil;&atilde;o errada no menu das configura&ccedil;&otilde;es no m&eacute;todo de pagamento Payshop. 
- Corrigimos um erro de compatibilidade com a vers&atilde;o 8.6.0 do woocommerce chamada wc_get_log_file_path.
...
- Fixed incompatibilities with 8.2 PHP version. 
...
- Simplified Transfer payment method was removed.
- Admin Order Details Update.
- In virtual orders, when payment was received, the status would change to 'Processing,' but now it changes to 'Completed'.

= 4.0.6 =

- Removed on Payshop menu a wrong information. 
- Fixed a compatibility error with woocommerce 8.6.0 version called wc_get_log_file_path.
