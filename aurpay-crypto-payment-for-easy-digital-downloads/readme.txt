...
Contributors: Aurpay
Tags: easy digital downloads, edd, bitcoincash, bitcoin cash, bitcoins, cryptocurrency, btc, coinbase, bitpay, ecommerce, paypal, accept bitcoin, payment, payment gateway, digital downloads, download, downloads, e-commerce, e-downloads, e-store, wp ecommerce, litecoin, dogecoin, dash，Crypto, cryptocurrency, crypto payment, erc20, cryptocurrency, bitcoin, bitcoin lighting network, ethereum, crypto pay, smooth withdrawals, cryptocurrency payments, low commission, pay with meta mask, payment button, invoice, crypto woocommerce，bitcoin woocommerce，ethereum，pay crypto，virtual currency，bitcoin wordpress plugin，free crypto plugin, bitcoin lightning network,
...
Pay with Crypto For EasyDigitalDownloads, Let your customer pay with ETH, USDC, USDT, DAI, lowest fees, non-custodail & no fraud/chargeback, 50+ cryptos. Invoice, payment link, payment button.
...
[Sign up](https://dashboard.aurpay.net/#/login?cur_url=/integration&platform=EASYDIGITALDOWNLOADS)

[youtube https://youtu.be/zLLLjBnuc3g]



### 🔥 Features: What's unique about Aurpay Crypto Payment.
...
You can place a test order in [Demo store.](https://example-wp.aurpay.net/downloads/)
...
4. **[Sign up](https://dashboard.aurpay.net/#/login?cur_url=/integration&platform=EASYDIGITALDOWNLOADS)** an Aurpay account to get "Publickey".
...
Join hundreds of successful WordPress and EasyDigitalDownloads sellers who have chosen Aurpay as their global growth partner. Start accepting crypto in just one minute and experience the immediate benefits of our managed platform.

Learn more about **[Partner Program!](https://aurpay.net/partner/)**

* **[Register a partner account](https://dashboard.aurpay.net/#/login?cur_url=/home)** and earn a percentage of transaction-based profits.
* Use our easy sign-up referral link to attract merchants.
* Enjoy lifetime rewards. Manage your merchants in the partner dashboard – the more merchants you bring, the greater the rewards you earn!
...
= 1.2.2 =
New: Adapt to WordPress 6.7.2 version.

= 1.2.1 =
Update: Add some introductory words.

= 1.2.0 =
Update: Fix bug for version compatibility.
New: Adapt to WordPress 6.6.2 version.
New: Adapt to Edd 3.3.4 version.

= 1.1.6 =
New: Adapt to WordPress 6.6 version.

= 1.1.5 =
New: Adapt to WordPress 6.4 version.
...
= 1.1.1 =
Update: Fix bug for plugin conflicts.
Update: Increasing compatibility.

= 1.1.0 =
New: Adapt to WordPress 6.2 version.

= 1.0.9 =
Update: Optimizing Experience and Process.
New: Add Logging Feature.
New: Add Key Verification.

= 1.0.8 =
Update: Optimizing page text.
...
= 1.0.6 =
Update: Fix bug for error handling.
New: Add Aurpay Crypto Payment logo for page.

= 1.0.5 =
Update: Remove error message when order is complete.

= 1.0.4 =
Update: Fix bug for user checkout page.

= 1.0.3 =
New: Add error log for aurpay crypto payment.

= 1.0.2 =
New: Add payment error message.
...
= 1.0.0 =
New: Initial realease, Aurpay Crypto Payment for Easy Digital Downloads merchants.
