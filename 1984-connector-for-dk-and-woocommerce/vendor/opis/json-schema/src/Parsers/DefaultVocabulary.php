...
use NineteenEightyFour\NineteenEightyWoo\Opis\JsonSchema\Parsers\Keywords\{
    FiltersKeywordParser,
    SlotsKeywordParser
};
use NineteenEightyFour\NineteenEightyWoo\Opis\JsonSchema\Parsers\Pragmas\{CastPragmaParser, GlobalsPragmaParser,
    MaxErrorsPragmaParser, SlotsPragmaParser};
use NineteenEightyFour\NineteenEightyWoo\Opis\JsonSchema\Parsers\KeywordValidators\PragmaKeywordValidatorParser;
