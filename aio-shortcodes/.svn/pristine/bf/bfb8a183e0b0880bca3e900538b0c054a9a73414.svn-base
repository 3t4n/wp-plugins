 ...
 * Description: Displays the title of the specified page with additional options for case and custom classes.
 * Example usage: [aio_page_title id="456" link="yes" new_window="yes" case="capitalize" class="custom-class"]
 */
