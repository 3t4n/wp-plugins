...
You no longer need a [Google API Key](http://code.google.com/apis/ajaxfeeds/signup.html "Google API Key") to get it to work. If you own an API key, you can use it. But providing a key is optional.
...
* You may save your own [Google API Key](http://code.google.com/apis/ajaxfeeds/signup.html "Google API Key") at the plugin's option-panel and add the blogroll-widget to your blog's sidebar.
