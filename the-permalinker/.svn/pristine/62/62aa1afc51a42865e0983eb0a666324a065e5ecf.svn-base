...
Version: 1.9.0
Description: Dynamically insert permalinks and template URI URLs via convenient and flexible shortcodes. <a href="options-general.php?page=permalinker_help">Need help?</a>
*/
