<?php
/*
	Plugin Name: Aweber Forms by Optin Cat
	Plugin URI: https://fatcatapps.com/optincat
	Description: Aweber Optin Cat Helps You Get More Email Subscribers. Create Beautiful Campaign Monitor Opt-In Forms In Less Than 2 Minutes.
	Author: Fatcat Apps
	Version: 2.6.0
	License: GPL v2
...
define( 'FCA_EOI_PLUGIN_SLUG', 'aweber-wp' );
define( 'FCA_EOI_PLUGIN_BASENAME', plugin_basename( __FILE__ ) );
define( 'FCA_EOI_VER', '2.6.0' );
