<?php
            ...
            <div class="fcpfw_container" >
                ...
                echo FCPFW_comman();
                        ...
                        <div class='fcpfw_coupon'>
                            <div class='fcpfw_apply_coupon_link' style="color: <?php echo esc_html($fcpfw_comman['fcpfw_apply_cpn_ft_clr']); ?>">
                                <a href='#' id='fcpfw_apply_coupon'>
                                    ...
                                    ?> 
                                        <?php echo esc_html($fcpfw_comman['fcpfw_apply_cpn_txt']); ?>
                                </a>
                            ...
                            <div class="fcpfw_coupon_field">
                                ...
                                <span class="fcpfw_coupon_submit" style="background-color: <?php echo esc_html($fcpfw_comman[ 'fcpfw_applybtn_cpn_bg_clr']); ?>; color: <?php echo esc_html($fcpfw_comman['fcpfw_applybtn_cpn_ft_clr']); ?>;"><?php echo esc_html($fcpfw_comman['fcpfw_apply_cpn_apbtn_txt']); ?></span>
                            </div>
                            ...
                            ?>
                                <ul class='fcpfw_applied_cpns'>
                                    <?php
                                        ...
                                        ?>    
                                        <li class='fcpfw_remove_cpn' cpcode='<?php echo esc_html($cpns); ?>'><?php echo esc_html($cpns); ?><span class='dashicons dashicons-no'></span></li>
                    ...
                    <div class="fcpfw_footer">
                        <div class="fcpfw_ship_txt" style="color: <?php echo esc_html($fcpfw_comman['fcpfw_ship_ft_clr']); ?>;font-size: <?php echo esc_html($fcpfw_comman['fcpfw_ship_ft_size'])."px" ?>;"><?php echo esc_html($fcpfw_comman['fcpfw_ship_txt']); ?></div>
                        <?php

                        ?>
                        <div class="fcpfw_button_fort fcpfw_dyamic_<?php echo esc_html($fcpfw_comman['fcpfw_footer_button_row']); ?>">
                        <?php  if($fcpfw_comman['fcpfw_cart_option']== "yes") { ?>
                            <a  class="fcpfw_bn_1" href="<?php if(!empty($fcpfw_comman['fcpfw_orgcart_link'])){echo esc_html($fcpfw_comman['fcpfw_orgcart_link']); }else{  echo wc_get_cart_url(); }?>" style="background-color: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_clr']); ?>;margin: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_mrgin']);?>px;color: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_txt_clr']); ?>;">
                                <?php echo esc_html($fcpfw_comman['fcpfw_cart_txt']); ?>
                            </a>
                        <?php } ?>
                        <?php  if($fcpfw_comman['fcpfw_checkout_option'] == "yes"){ ?>
                            <a class="fcpfw_bn_2" href="<?php if(!empty($fcpfw_comman['fcpfw_orgcheckout_link'])){echo esc_html($fcpfw_comman['fcpfw_orgcheckout_link']);}else{echo wc_get_checkout_url();} ?>" style="background-color: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_clr']); ?>;margin: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_mrgin']); ?>px;color: <?php echo esc_html($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']); ?>;">
                                <?php echo esc_html($fcpfw_comman['fcpfw_checkout_txt']); ?>
                            </a>
                        <?php } ?>
                        <?php  if($fcpfw_comman['fcpfw_conshipping_option'] == "yes"){ ?>
                            <a class="fcpfw_bn_3" href="<?php echo esc_html($fcpfw_comman['fcpfw_conshipping_link']); ?>" style="background-color: <?php echo esc_html($fcpfw_comman[ 'fcpfw_ft_btn_clr']); ?>;margin: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_mrgin']);?>px;color: <?php echo esc_html($fcpfw_comman['fcpfw_ft_btn_txt_clr']); ?>;">
                                <?php echo esc_html($fcpfw_comman['fcpfw_conshipping_txt']); ?>
                            </a>
                        <?php } ?>
                        </div>
                    </div>
        ...
        function FCPFW_craete_cart(){
            ...
            <style>
                ...
                .fcpfw_cart_basket{
                    ...
                    max-height: <?php echo esc_html($fcpfw_comman[ 'fcpfw_basket_icn_size'])."px" ?>;
                    max-width: <?php echo esc_html($fcpfw_comman[ 'fcpfw_basket_icn_size'])."px" ?>;
                    background-color: <?php echo esc_html($fcpfw_comman['fcpfw_basket_bg_clr']); ?>;
                    margin-bottom: <?php echo esc_html($fcpfw_comman['fcpfw_basket_off_vertical']);?>px;
                    margin-right: <?php echo esc_html($fcpfw_comman['fcpfw_basket_off_horizontal']);?>px;
                }
                .fcpfw_container .fcpfw_header_title{
                    color: <?php echo esc_html($fcpfw_comman['fcpfw_head_ft_clr']); ?>;
                    font-size: <?php echo esc_html($fcpfw_comman['fcpfw_head_ft_size'])."px"; ?>;
                }
                ...
                .cart_box svg {
                    fill : <?php echo esc_html($fcpfw_comman[ 'fcpfw_basket_clr']); ?> ;
                }
                .fcpfw_remove svg {
                fill : <?php echo esc_html($fcpfw_comman[ 'fcpfw_delect_icon_clr']); ?> ;

                }
                .fcpfw_cart_icon svg{
                fill : <?php echo esc_html($fcpfw_comman[ 'fcpfw_header_cart_icon_clr']); ?> ;
                }
                .fcpfw_close_cart svg{
                fill : <?php echo esc_html($fcpfw_comman[ 'fcpfw_header_close_icon_clr']); ?> ;
                }
                #fcpfw_apply_coupon svg{
                fill : <?php echo esc_html($fcpfw_comman[ 'fcpfw_apply_cpn_icon_clr']); ?> ;
                }
                           ...
                           $_product = apply_filters( 'woocommerce_cart_item_product', $values['data'], $values, $item );
                            ...
                            if($fcpfw_comman['fcpfw_loop_delete']=='yes'){
                                ...
                                $html .= apply_filters('woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="fcpfw_remove"  aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s">'.$fcpfw_delete_icon.'</a>', 
                                        ...
                                        esc_html__('Remove this item', 'floating-cart-product-for-woocommerce'),
                                        esc_html( $product_id ),
        ...
        function FCPFW_single_added_to_cart_event(){
            ...
            <div class="fcpfw_coupon_response" style="left: calc(100% - <?php echo esc_html($fcpfw_sidecart_width) ; ?>);">
                <div class="fcpfw_inner_div" style="width:<?php echo esc_html($fcpfw_sidecart_width); ?>;">
                    <span id="fcpfw_cpn_resp" style="width:<?php echo esc_html($fcpfw_sidecart_width) ; ?>;"></span>
                </div>w
            </div>
            <?php
        }
