...
use NativeRent\Common\SDK\Config;
use NativeRent\Common\SDK\WordPress\Client as WordPressClient;
		...
		$this->container
			...
			->bind(
				...
				function () {
					...
					$api = new APIClient(
						new WordPressClient( new WP_Http() ),
						new Config(
					...
					return new NRentService( $api, $options );
				}
			)
			->bind(
				CronManager::class,
