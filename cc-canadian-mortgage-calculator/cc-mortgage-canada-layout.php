...
<input type="hidden" id="<?php echo $id; ?>-currency" value="<?php echo esc_attr($currency); ?>"> 
<div class="CCMC-Widget CCMC-Widget-<?php echo $id; ?>">
        ...
        <div class="CCMC-rowdiv">
            <div class="CCMC-leftdiv">
                <label for="<?php echo $id; ?>-purchase-price">Purchase price <?php echo esc_attr($currency); ?> :</label>
            </div>
        ...
        <div class="CCMC-rowdiv">
            <div class="CCMC-leftdiv">
                <label for="<?php echo $id; ?>-down-payment">Down payment <?php echo esc_attr($currency); ?> :</label>
            </div>
			<div class="CCMC-rightdiv">
