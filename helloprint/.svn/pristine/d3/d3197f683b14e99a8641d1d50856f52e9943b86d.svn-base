        ...
        <table class="form-table" role="presentation">
                <tbody>
                        ...
                        <tr class="example-class">
                                ...
                                <td>
                                        <div class="example-class">
                                             <input type="text" class="regular-text" id="hp_tier_name" name="name" value="<?php echo esc_attr($name);?>" required="true" />
                                     </div>
                             </td>
                        </tr>
                                ...
                                <td>
                                        <div class="example-class">
                                                <div class="wphp-input-group">
                                                        <div class="wphp-input-group-area"><input class="regular-text hp-default-markup-text" id="default_markup" name="default_markup" type="number" value="<?php echo esc_attr($default_markup);?>" min="1" required="true" max="100" ></div>
                                                ...
                                                <div class="first-hp-single-scaled" >
                                                        ...
                                                        <tr>
                                                                <td  class="hp-single-scale-sub-div">
                                                                        <div class="wphp-input-group">
                                                                                <div class="wphp-input-group-icon"><?php echo wp_kses($currency_symbol, true);?></div>
                                                                                <div class="wphp-input-group-area"><input class="hp_number" name="scaled_price[]" type="number" value="<?php echo (!empty($scalings[0]->price)) ? wp_kses($scalings[0]->price, true) : '';?>" min="0" ></div>
                                                                                <div class="wphp-input-group-icon"><?php echo wp_kses(_translate_helloprint('and above', "helloprint"), true) ?></div>
                                                                        </div>
                                                                </td>
                                                                <td  class="hp-single-scale-sub-div">
                                                                        <div class="wphp-input-group">
                                                                                <div class="wphp-input-group-area"><input class="hp_percentage" name="scaled_margin[]" type="number" value="<?php echo (!empty($scalings[0]->margin)) ? wp_kses($scalings[0]->margin, true) : '';?>" min="1" max="100" ></div>
                                                                                <div class="wphp-input-group-icon">%</div>
                                                                        </div>
                                                                </td>
                                                    ...
                                                    <div class="row wphp-single-scaled-price" >
                                                        ...
                                                        <tr>
                                                                <td  class="hp-single-scale-sub-div">
                                                                        <div class="wphp-input-group">
                                                                                <div class="wphp-input-group-icon"><?php echo wp_kses($currency_symbol, true);?></div>
                                                                                <div class="wphp-input-group-area"><input class="hp_number" name="scaled_price[]" type="number" value="<?php echo (!empty($scale->price)) ? wp_kses($scale->price, true) : '';?>" min="0" ></div>
                                                                                <div class="wphp-input-group-icon"><?php echo wp_kses(_translate_helloprint('and above', "helloprint"), true) ?></div>
                                                                        </div>
                                                                </td>
                                                                <td  class="hp-single-scale-sub-div">
                                                                        <div class="wphp-input-group">
                                                                                <div class="wphp-input-group-area"><input class="hp_percentage" name="scaled_margin[]" type="number" value="<?php echo (!empty($scale->margin)) ? wp_kses($scale->margin, false) : '';?>" min="1" max="100" ></div>
                                                                                <div class="wphp-input-group-icon">%</div>
                                                                        </div>
                                                                </td>
