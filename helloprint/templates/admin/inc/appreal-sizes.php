        ...
        <table class="form-table" role="presentation">
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if(esc_attr($option['isUnisex']) == true):?>
                            <td>
                            <input class="regular-text helloprint_custom_option_input_preset_field helloprint_preset_appreal_size" data-name="appreal_sizes" data-keytype="quantity" data-keyvalue="<?php echo esc_attr($value);?>" id="helloprint_preset_quantity_<?php echo esc_attr($value);?>" name="appreal_sizes[quantity][<?php echo esc_attr($value);?>]" type="number" value="<?php echo !empty($args["default_options"]["quantity"][esc_attr($value)]) ? esc_attr($args["default_options"]["quantity"][esc_attr($value)]) : 0;?>" min="0"  >
                            </td>
                        <?php else: ?>
                            <td>
                            <input class="regular-text helloprint_custom_option_input_preset_field helloprint_preset_appreal_size" data-name="appreal_sizes" data-keytype="men" data-keyvalue="<?php echo esc_attr($value);?>" id="helloprint_preset_men_<?php echo esc_attr($value);?>" name="appreal_sizes[men][<?php echo esc_attr($value);?>]" type="number" value="<?php echo !empty($args["default_options"]["men"][esc_attr($value)]) ? esc_attr($args["default_options"]["men"][esc_attr($value)]) : 0;?>" min="0"  >
                            
                            </td>
                            <td>
                            <input class="regular-text helloprint_custom_option_input_preset_field helloprint_preset_appreal_size" data-name="appreal_sizes" data-keytype="women" data-keyvalue="<?php echo esc_attr($value);?>" id="helloprint_preset_women_<?php echo esc_attr($value);?>" name="appreal_sizes[women][<?php echo esc_attr($value);?>]" type="number" value="<?php echo !empty($args["default_options"]["women"][esc_attr($value)]) ? esc_attr($args["default_options"]["women"][esc_attr($value)]) : 0;?>" min="0"  >
                            </td>
                        <?php endif;?>
