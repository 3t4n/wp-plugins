...
<input type="hidden" name="hp_variant_key" value="<?php echo ($product_type == "hp" && !empty($helloprint_variant_key)) ? wp_kses($helloprint_variant_key, false) : ''; ?>" id="helloprint_pod_available_variant_key" />
<input type="hidden" value="<?php echo ($product_type == "hp" && !empty($default_quantity)) ? wp_kses($default_quantity, false) : ''; ?>" id="old_helloprint_pod_default_quantity" />
<input type="hidden" value="<?php echo ($product_type == "hp" && !empty($default_service_level)) ? wp_kses($default_service_level, false) : ''; ?>" id="old_helloprint_pod_service_level" />
<input type="hidden" value="<?php echo (!empty($helloprint_product_id)) ? wp_kses($helloprint_product_id, false) : ''; ?>" id="helloprint_pod_old_hp_product_id" />
<input type="hidden" value='<?php echo (!empty($product_attributes)) ? "[" . wp_json_encode(json_decode($product_attributes)) . "]" : ""; ?>' id="helloprint_pod_old_hp_attributes" />
<table class="form-table" role="presentation">
    <tbody>
        ...
        <tr class="example-class">
            ...
            <td>
                <div class="example-class">
                    <input type="url" class="regular-text helloprint_order_preset_public_url" id="order_preset_public_url" name="order_preset_public_url" value="<?php echo (!empty($file_url) && $is_public_url) ? wp_kses($file_url, false) : '';?>" <?php echo (!empty($file_name)) ? " disabled " : "";?> >
                </div>
            </td>
        </tr>
    </tbody>
