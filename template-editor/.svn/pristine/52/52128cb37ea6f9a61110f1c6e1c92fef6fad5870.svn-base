...
= Additional Core Block Options =

- Option to enable expandable submenus to the Navigation Block modal.
- Option to add full block link option to Group and Cover Blocks.
- Option to close other Details Blocks when selected one is opened giving the Details Block basic accordion functionality.
