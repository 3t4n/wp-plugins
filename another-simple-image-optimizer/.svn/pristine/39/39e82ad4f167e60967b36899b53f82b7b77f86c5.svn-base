...
add_action('admin_init', function() {
    ...
    add_action('manage_media_custom_column', function ($name, $id) {
        ...
        // Don't show "Optimize" link if `proc_open` is disabled
        if (!ASIO_CAN_PROC_OPEN) return;
        ...
        elseif (defined('ASIO_ALLOW_FORCE_OPTIMIZE_IMAGES') && ASIO_ALLOW_FORCE_OPTIMIZE_IMAGES) {
