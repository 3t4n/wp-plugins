...
class HTML_Tag_Replace_Core {
    ...
    */
    ...
    function html_tag_and_class_replace_scripts(){
        ...
        wp_enqueue_script( 'html_tag_and_class_replace_js', HTMLTagReplace_URL.'/assets/admin/js/admin.js', array('jquery'), HTMLTagReplace_VERSION, true );
    ...
    */
    ...
    function html_tag_replace_front_custom_scripts(){
        wp_enqueue_script( 'my_replace_js', HTMLTagReplace_URL.'/assets/app/js/replace.js', array('jquery'), HTMLTagReplace_VERSION, true );
