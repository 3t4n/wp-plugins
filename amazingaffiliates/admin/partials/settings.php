                        ...
                        <?php foreach($settings[$setting_group_key] as $setting) : ?>
                            ...
                            <?php $setting_slug = 'amazingaffiliates_settings_' . $setting_group_key . '_' . $setting['name']; ?>
                                ...
                                <?php if($setting["type"] == "separator") : ?>
                                    ...
                                    <tr style="border-bottom:1px dotted gray;" ><td scope="row" colspan="3" style="font-size:150%;"><?php echo esc_html( $setting["display"] ); ?></td></tr>
                                    
                                <?php else : ?>
                                    
                                    <tr data-saved-value="<?php echo esc_attr( get_option($setting_slug) ); ?>" class="<?php echo esc_attr( $setting_group_key . '_group' ); ?>">
                                        ...
                                        if( empty( $value ) ) $value = $setting["default"];
