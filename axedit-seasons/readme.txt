=== WP Seasons ===
Contributors: ldaines
Donate link: https://www.axedit.fr/wp-seasons/
Tags: season
...
WordPress Seasons is a simple plugin to automatically show specific text according to the season.
...
The simplest way to install is to click on 'Plugins' then 'Add' and type 'WordPress Seasons' in the search field.
