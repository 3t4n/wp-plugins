...
class SitePressLanguageSwitcher {
	...
	function language_selector_widget_init(){ 
        wp_register_sidebar_widget( 'icl_lang_selector_sidebar', __('Language Selector', 'sitepress'), 'language_selector_widget', 'icl_languages_selector');
		wp_register_widget_control( 'icl_lang_selector_wiget', __('Language Selector', 'sitepress'), array(&$this, 'set_widget') );
