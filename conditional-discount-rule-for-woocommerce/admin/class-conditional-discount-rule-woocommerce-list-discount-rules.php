...
class Class_Pi_Cdrw_List{
    ...
    private $tab_name = "Discount rules";

    private $setting_key = 'pi_cdrw_list';
    ...
    function listShippingMethod(){
        ...
        include plugin_dir_path( __FILE__ ) . 'partials/listDiscountRule.php';
    }
    ...
    function deletePost(){
        ...
        if(!wp_verify_nonce($submitted_value, 'cdrw-delete-'.$this->post_id)){
            wp_safe_redirect(  admin_url( '/admin.php?page=pisol-cdrw' )  );
...
new Class_Pi_Cdrw_List($this->plugin_name);