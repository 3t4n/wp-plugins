...
class Pi_cdrw_selection_rule_width{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('Max Product Width','conditional-discount-rule-woocommerce'),
            'group'=>'cart_related',
...
new Pi_cdrw_selection_rule_width(PI_CDRW_SELECTION_RULE_SLUG);