...
class Pi_cdrw_selection_rule_selected_delivery_day{
    ...
    function ajaxCall(){
        ...
        if(self::datePluginInstalled()){
            ...
            echo Pi_cdrw_selection_rule_main::createSelect($this->days(), $count,$this->condition,  "multiple",null,'static');
        }else{
    ...
    function savedDropdown($html, $values, $count){
        if(self::datePluginInstalled()){
            $html = Pi_cdrw_selection_rule_main::createSelect($this->days(), $count, $this->condition,  "multiple", $values,'static');
            return $html;
        }
    ...
    function conditionCheck($result, $package, $logic, $values){
        ...
        return  apply_filters('pisol_cdrw_selected_day_filter', $or_result, $values);
    }
}

new Pi_cdrw_selection_rule_selected_delivery_day(PI_CDRW_SELECTION_RULE_SLUG);