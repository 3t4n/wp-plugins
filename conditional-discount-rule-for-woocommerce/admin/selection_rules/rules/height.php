...
class Pi_cdrw_selection_rule_height{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('Max Product Height','conditional-discount-rule-woocommerce'),
            'group'=>'cart_related',
...
new Pi_cdrw_selection_rule_height(PI_CDRW_SELECTION_RULE_SLUG);