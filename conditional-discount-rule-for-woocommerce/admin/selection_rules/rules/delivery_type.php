...
class Pi_cdrw_selection_rule_delivery_type{
    ...
    function ajaxCall(){
        ...
        if(self::datePluginInstalled()){
            ...
            echo Pi_cdrw_selection_rule_main::createSelect($this->deliveryTypes(), $count, $this->condition,  "",null,'static');
        }else{
    ...
    function savedDropdown($html, $values, $count){
        if(self::datePluginInstalled()){
            $html = Pi_cdrw_selection_rule_main::createSelect($this->deliveryTypes(), $count, $this->condition,  "", $values,'static');
            return $html;
        }
...
new Pi_cdrw_selection_rule_delivery_type(PI_CDRW_SELECTION_RULE_SLUG);
