...
class Pi_cdrw_selection_rule_user{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('User','conditional-discount-rule-woocommerce'),
            'group' => "user_related",
    ...
    function savedDropdown($html, $values, $count){
        $html = Pi_cdrw_selection_rule_main::createSelect($this->savedUsers($values), $count, $this->condition,  "multiple", $values,'dynamic');
        return $html;
    }
...
new Pi_cdrw_selection_rule_user(PI_CDRW_SELECTION_RULE_SLUG);