...
class Pi_cdrw_selection_rule_length{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('Max Product Length','conditional-discount-rule-woocommerce'),
            'group'=>'cart_related',
...
new Pi_cdrw_selection_rule_length(PI_CDRW_SELECTION_RULE_SLUG);