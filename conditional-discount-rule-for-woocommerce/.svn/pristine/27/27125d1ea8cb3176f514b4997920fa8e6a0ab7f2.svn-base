...
class Pi_cdrw_selection_rule_country{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('Country','conditional-discount-rule-woocommerce'),
    ...
    function ajaxCall(){
        ...
        echo Pi_cdrw_selection_rule_main::createSelect($this->allCountries(), $count, $this->condition,  "multiple",null,'static');
        die;
    }

    function savedDropdown($html, $values, $count){
        $html = Pi_cdrw_selection_rule_main::createSelect($this->allCountries(), $count, $this->condition,  "multiple", $values,'static');
        return $html;
    }
...
new Pi_cdrw_selection_rule_country(PI_CDRW_SELECTION_RULE_SLUG);