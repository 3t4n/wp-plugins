(function ($) {
    ...
    function pisol_cdrw_select_rule_main() {
        this.init = function () {
            this.slug = 'cdrw';
            this.counter();
            this.addRule();
        ...
        this.counter = function () {
            this.count = window.pi_cdrw_metabox;
        }
        ...
        this.checkConditionCount = function () {
            var count = jQuery("#pisol-rules-container-cdrw > .row").length;
            if (count <= 0) {
    ...
    jQuery(function ($) {
        var pisol_cdrw_select_rule_main_obj = new pisol_cdrw_select_rule_main();
        pisol_cdrw_select_rule_main_obj.init();
    });

    function pisol_cdrw_conditionChange() {
        this.init = function () {
            this.slug = 'cdrw';
            var parent = this;
        ...
        this.conditionValues = function (condition) {
            ...
            jQuery.post(window.ajaxurl,
                { action: 'pi_cdrw_value_field_' + condition_val, count: count },
                function (data) {
    ...
    jQuery(function ($) {
        var pisol_cdrw_conditionChange_obj = new pisol_cdrw_conditionChange();
        pisol_cdrw_conditionChange_obj.init();
    });
