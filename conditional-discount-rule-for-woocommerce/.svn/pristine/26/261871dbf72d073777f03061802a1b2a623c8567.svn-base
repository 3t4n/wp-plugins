...
v1.0.1
*/
if(!class_exists('pisol_cdrw_conditional_discount_review')){
class pisol_cdrw_conditional_discount_review{
...
new pisol_cdrw_conditional_discount_review('Conditional discount rule for WooCommerce', 'conditional-discount-rule-for-woocommerce', PI_CDRW_BUY_URL, PI_CDRW_PRICE);
}