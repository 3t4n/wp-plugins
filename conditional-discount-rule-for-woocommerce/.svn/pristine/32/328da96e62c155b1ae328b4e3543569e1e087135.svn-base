...
class Pi_cdrw_selection_rule_shipping_class{
    ...
    function addRule($rules){
        $rules[$this->condition] = array(
            'name'=>__('Shipping Class','conditional-discount-rule-woocommerce'),
            'group'=>'cart_related',
    ...
    function ajaxCall(){
        ...
        echo Pi_cdrw_selection_rule_main::createSelect($this->allShippingClasses(), $count, $this->condition,  "multiple",null,'static');
        die;
    }

    function savedDropdown($html, $values, $count){
        $html = Pi_cdrw_selection_rule_main::createSelect($this->allShippingClasses(), $count, $this->condition,  "multiple", $values,'static');
        return $html;
    }
...
new Pi_cdrw_selection_rule_shipping_class(PI_CDRW_SELECTION_RULE_SLUG);