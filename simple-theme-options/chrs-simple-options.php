...
Description:    Add site-wide tracking codes and conversion pixels. Additionally, manage all your social media links, and display them on your site using shortcodes.
Version:		1.7.5
...
define('CHRSOP_VERSION', '1.7.5');
define('CHRSOP_REQUIRED_WP_VERSION', '6.7.1');
...
{
    wp_enqueue_style('chrs_options', plugin_dir_url(__FILE__) . '/css/styles.css', '1.7.5');
