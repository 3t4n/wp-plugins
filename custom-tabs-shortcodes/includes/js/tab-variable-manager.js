...
jQuery(document).ready(function ($) {
	...
	$('#td_is_daily').click(function(){

		if( !$(this).is(":checked") ){

			$('#button-more').css("display", "inline-block");
			$('#button-less').css("display", "inline-block");
			...
			$('#button-less').css("display", "none");

			

			if($('#tab_count').val() < 7){

				while($('#tab_count').val() < 7){
			...
			$('.tab-name').each(function(){
				$('[name=tab_0_name]').val(lunes);
				$('[name=tab_1_name]').val(martes);
				$('[name=tab_2_name]').val(miercoles);
				$('[name=tab_3_name]').val(jueves);
				$('[name=tab_4_name]').val(viernes);
				$('[name=tab_5_name]').val(sabado);
				$('[name=tab_6_name]').val(domingo);
