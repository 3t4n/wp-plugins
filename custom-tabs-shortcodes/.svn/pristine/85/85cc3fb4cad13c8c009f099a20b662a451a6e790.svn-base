...
Tags: tab,tabs,custom,daily,week
Donate link: https://paypal.me/CodeComas
...
* Choose if you want to have a custom daily tab.
...
= 1.2 =
- Fixed responsive for small devices.

= 1.1 =
- Checkbox to convert normal custom tabs, to daily custom tabs.
- Minor bug fixing
