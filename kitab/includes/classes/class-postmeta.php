...
<label for="kitab_disable_ads">
    <input type="checkbox" name="kitab_disable_ads" id="kitab_disable_ads" value="1"
        <?php checked($disable_ads, true); ?>>
    ...
    public function get_book_fields()
    {
        ...
        $fields = array(
            ...
            'kitab_pdf_link' => array(
                ...
                'text' => esc_html__('Download PDF', 'kitab'),
                'type' => 'url',
            ...
            'kitab_epub_link' => array(
                ...
                'text' => esc_html__('Download EPUB', 'kitab'),
                'type' => 'url',
