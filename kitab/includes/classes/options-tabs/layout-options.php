    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <select name="<?php echo esc_attr($this->option_name); ?>[layout_position]">
                    <option value="above" <?php selected('above', $selected_layout_position); ?>>
                        <?php esc_html_e('Above Content', 'kitab'); ?></option>
                    <option value="below" <?php selected('below', $selected_layout_position); ?>>
                        <?php esc_html_e('Below Content', 'kitab'); ?></option>
                    <option value="both" <?php selected('both', $selected_layout_position); ?>>
                        <?php esc_html_e('Above and Below', 'kitab'); ?></option>
                    <option value="manually" <?php selected('manually', $selected_layout_position); ?>>
                        <?php esc_html_e('Manually', 'kitab'); ?></option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <select name="<?php echo esc_attr($this->option_name); ?>[display_as]">
                    <option value="dl" <?php selected('dl', $selected_display_as); ?>>
                        <?php esc_html_e('Data List', 'kitab'); ?></option>
                    <option value="table" <?php selected('table', $selected_display_as); ?>>
                        <?php esc_html_e('Table', 'kitab'); ?></option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php
                        ...
                        ?>
                <label>
                    <input type="checkbox" name="<?php echo esc_attr($this->option_name); ?>[show_thumbnail]"
                        value="yes" <?php checked('yes', $selected_show_thumbnail); ?>>
        ...
        <tr>
            <th scope="row"><?php esc_html_e('Show Font Awesome Icons', 'kitab'); ?>
                <p class="kitab-tooltip">
                    <span
                        class="description"><?php esc_html_e('Must have font awesome library on theme or plugin.', 'kitab'); ?></span>
            ...
            <td>
                <?php
                        ...
                        ?>
                <label>
                    <input type="checkbox" name="<?php echo esc_attr($this->option_name); ?>[show_font_awesome]"
                        value="yes" <?php checked('yes', $selected_show_font_awesome); ?>>
                    <?php esc_html_e('Yes', 'kitab'); ?>
                </label>
            </td>
            <!-- <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label>
                    <input type="checkbox" name="<?php echo esc_attr($this->option_name); ?>[show_fields][]"
                        value="<?php echo esc_attr($key); ?>" <?php checked(in_array($key, $selected_show_fields)); ?>>
