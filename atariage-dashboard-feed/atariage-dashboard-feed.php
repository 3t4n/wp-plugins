...
Plugin URI: https://doc4design.com/atariage-dashboard-feed/
    ...
    if ( !empty($rss->items) ) {
         ...
         foreach ($rss->items as $item ) {
                 ...
                 if($widget_options['showtime']) {
                    $trlink .=  "<div class='rss-date'>".date("F j, Y", strtotime($item['pubdate']))."</div>";
                 } else {
                    echo '';
                 }
...
<p><?php _e('This plugin was developed by <a href="https://doc4design.com">Doc4 Design</a>' ); ?></p>
