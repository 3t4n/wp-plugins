 ...
 * 
 * GMADAPTIVE->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Gm_Adaptive_Css_Grid_Columns_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		GMADAPTIVE
 * @subpackage	Classes/Gm_Adaptive_Css_Grid_Columns_Settings
...
class Gm_Adaptive_Css_Grid_Columns_Settings{
	...
	/**
	 * Our Gm_Adaptive_Css_Grid_Columns_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = GMADAPTIVE_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'GMADAPTIVE/settings/get_plugin_name', $this->plugin_name );
	}
}
