 ...
 *
 */
if ( ! class_exists( 'Chat_Whatsapp_Fields' ) ) {
  abstract class Chat_Whatsapp_Fields extends CHAT_WHATSAPP_Abstract {
    protected $field;
    protected $value;
    protected $unique;
    protected $where;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="chat-whatsapp-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="chat-whatsapp-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="chat-whatsapp-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="chat-whatsapp-help"><span class="chat-whatsapp-help-text">'. $this->field['help'] .'</span><i class="icofont-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="chat-whatsapp-error-text">'. $this->field['_error'] .'</div>' : '';
