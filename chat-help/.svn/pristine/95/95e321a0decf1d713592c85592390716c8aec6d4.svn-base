...
class CustomButtonsTemplates
{
	...
	public function ctw_button_s1()
	{
		...
		if ($atts['visibility'] === 'only-desktop') {
			...
			$button_visibility = 'wHelp-show-everywhere';
		}
...
?>
		<div class="button-wrapper">
			<button
				style="--color-primary: <?php echo esc_attr($primaryColor) ?>; --color-secondary: <?php echo esc_attr($secondaryColor) ?>"
				<?php
				if ($avl_timezone) {
				?>
	...
	?>
		...
		<div class="button-wrapper">
			<a style="--color-primary: <?php echo esc_attr($primaryColor) ?>; --color-secondary: <?php echo esc_attr($secondaryColor) ?>; --padding: <?php echo esc_attr($padding) ?>;" href="https://wa.me/<?php echo esc_attr($number); ?>" class="wHelp-button-2 wHelp-btn-bg <?php echo esc_attr($button_sizes); esc_attr($button_visibility); esc_attr($button_rounded); ?>">
