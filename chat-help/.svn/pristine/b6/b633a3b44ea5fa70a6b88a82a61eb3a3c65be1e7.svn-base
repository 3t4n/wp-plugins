...
class FormTemplate
{
	 ...
	 * @since 1.0.0
	 */
	public static function formTemplate($options, $bubble_type, $random, $whatsapp_message_template, $whatsapp_number)
	{
		...
		<div class="wHelp__popup animation<?php echo esc_attr($animation) ?> ">
			...
			<?php
			include Helpers::chat_whatsapp_locate_template('items/single-template-header.php');
			include Helpers::chat_whatsapp_locate_template('items/form.php');
			?>
