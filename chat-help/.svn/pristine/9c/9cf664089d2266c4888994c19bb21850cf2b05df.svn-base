...
Plugin URI: 	https://themeatelier.net/downloads/whatsapp-chat-help/
...
RequiresWP:     4.0
RequiresPHP:    7.0
UpdateURI:      https://themeatelier.net/downloads/whatsapp-chat-help/
RequiresPlugins: another-plugin/another-plugin.php
*/
...
define('CHAT_WHATSAPP_VERSION', '2.1.3');
