...
if ( ! class_exists( 'Chat_Whatsapp_Field_sortable' ) ) {
  class Chat_Whatsapp_Field_sortable extends Chat_Whatsapp_Fields {
    ...
    public function render() {
      ...
      echo '<div class="chat-whatsapp-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="chat-whatsapp-sortable-item">';

          echo '<div class="chat-whatsapp-sortable-content">';
          ...
          CHAT_WHATSAPP::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="chat-whatsapp-sortable-helper"><i class="icofont-drag"></i></div>';
