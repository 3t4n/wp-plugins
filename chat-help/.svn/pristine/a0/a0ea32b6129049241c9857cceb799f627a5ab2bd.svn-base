...
if ( ! class_exists( 'CHAT_WHATSAPP_Abstract' ) ) {
  abstract class CHAT_WHATSAPP_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        CHAT_WHATSAPP::$css = apply_filters( "CHAT_WHATSAPP_{$this->unique}_output_css", CHAT_WHATSAPP::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'Chat_Whatsapp_Field_' . $field_type;
            ...
            if ( class_exists( $field_class ) ) {
              ...
              if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  CHAT_WHATSAPP::$css .= $instance->output();
                }
