...
; (function ($, window, document, undefined) {
  ...
  // Field: section_tab
  //
  $.fn.chat_whatsapp_field_group_field_section_tab = function () {
    return this.each(function () {
  ...
  $.fn.CHAT_WHATSAPP_siblings = function () {
    return this.each(function () {
      ...
      var $this = $(this),
        $siblings = $this.find('.chat-whatsapp--sibling:not(.chat-whatsapp-pro-only)'),
        multiple = $this.data('multiple') || false;
      $this.find('.chat-whatsapp--sibling.chat-whatsapp-pro-only').find('input').prop('disable', true)
    ...
    return this.each(function () {
      ...
      $this.on({
        mouseenter: function () {
          ...
          offset_left = (CHAT_WHATSAPP.vars.is_rtl) ? ($this.offset().left + 30) : ($this.offset().left + 30);
      ...
      $('body').on('mouseleave', '.chat-whatsapp-tooltip', function () {
        if ($tooltip !== undefined) {
          $tooltip.remove();
        }
      });
  ...
  $.fn.chat_whatsapp_reload_script = function (options) {
    ...
    return this.each(function () {
      ...
      if (!$this.data('inited')) {
        ...
        $this.children('.chat-whatsapp-field-section_tab').chat_whatsapp_field_group_field_section_tab();
        ...
        $this.children('.chat-whatsapp-field-layout_preset').find('.chat-whatsapp-siblings').CHAT_WHATSAPP_siblings();
  ...
  // Pro only tag.
  $('.chat-help-pagination-type li:nth-child(n+2) input').attr('disabled', true)
