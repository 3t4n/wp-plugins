 ...
 *
 */
if ( ! class_exists( 'Chat_Whatsapp_Field_sorter' ) ) {
  class Chat_Whatsapp_Field_sorter extends Chat_Whatsapp_Fields {
    ...
    public function render() {
      ...
      echo '<div class="chat-whatsapp-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="chat-whatsapp-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="chat-whatsapp-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="chat-whatsapp-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="chat-whatsapp-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="chat-whatsapp-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="chat-whatsapp-disabled">';
