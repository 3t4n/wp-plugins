...
if ( ! class_exists( 'Chat_Whatsapp_Field_background' ) ) {
  class Chat_Whatsapp_Field_background extends Chat_Whatsapp_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['background_color'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="chat-whatsapp--title">'. esc_html__( 'From', 'chat-help' ) .'</div>' : '';

        CHAT_WHATSAPP::field( array(
          'id'      => 'background-color',
          'type'    => 'color',
      ...
      if ( ! empty( $args['background_gradient_color'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="chat-whatsapp--title">'. esc_html__( 'To', 'chat-help' ) .'</div>' : '';
      ...
      if ( ! empty( $args['background_gradient_direction'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="chat-whatsapp---title">'. esc_html__( 'Direction', 'chat-help' ) .'</div>' : '';
