  ...
  class Chat_Whatsapp_Field_media extends Chat_Whatsapp_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="chat-whatsapp-image-preview"'. wp_kses_post($preview_style) .'>';
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name( '[url]' ) ) .'" value="'. esc_attr( $this->value['url'] ) .'" class="chat-whatsapp--url'. esc_attr( $hidden_url ) .'" readonly="readonly"'. wp_kses_post($this->field_attributes()) . wp_kses_post($placeholder) .' />';
