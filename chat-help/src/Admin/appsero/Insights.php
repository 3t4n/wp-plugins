...
class Insights {
    ...
    public function __construct( $client, $name = null, $file = null ) {
        ...
        if ( is_object( $client ) && is_a( $client, 'WhatsHelpAppSero\Client' ) ) {
            $this->client = $client;
        }
    }
    ...
    public function admin_notice() {
        ...
        if ( empty( $this->notice ) ) {
            $notice = sprintf( $this->client->chat_whatsapp_trans( 'Want to help make <strong>%1$s</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.' ), $this->client->name );
        } else {
            $notice = $this->notice;
        }
        ...
        $notice .= ' (<a class="' . $this->client->slug . '-insights-data-we-collect" href="#">' . $this->client->chat_whatsapp_trans( 'what we collect' ) . '</a>)';
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . $this->client->chat_whatsapp_trans( 'Allow' ) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . $this->client->chat_whatsapp_trans( 'No thanks' ) . '</a>';
        echo '</p></div>';
    ...
    private function get_uninstall_reasons() {
        $reasons = array(
			array(
				...
				'text'        => $this->client->chat_whatsapp_trans( "Couldn't understand" ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Would you like us to assist you?' ),
			...
			array(
				...
				'text'        => $this->client->chat_whatsapp_trans( 'Found a better plugin' ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Which plugin?' ),
			...
			array(
				...
				'text'        => $this->client->chat_whatsapp_trans( "Missing a specific feature" ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Could you tell us more about that feature?' ),
			...
			array(
				'id'          => 'is-not-working',
				'text'        => $this->client->chat_whatsapp_trans( 'Not working' ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Could you tell us a bit more whats not working?' ),
			...
			array(
				...
				'text'        => $this->client->chat_whatsapp_trans( "Not what I was looking" ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Could you tell us a bit more?' ),
			...
			array(
				...
				'text'        => $this->client->chat_whatsapp_trans( "Didn't work as expected" ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'What did you expect?' ),
			...
			array(
				'id'          => 'other',
				'text'        => $this->client->chat_whatsapp_trans( 'Others' ),
				'placeholder' => $this->client->chat_whatsapp_trans( 'Could you tell us a bit more?' ),
    ...
    <div class="wd-dr-modal-wrap">
        ...
        <div class="wd-dr-modal-body">
            ...
            <p class="wd-dr-modal-reasons-bottom">
                <?php
                       echo sprintf(
	                       $this->client->chat_whatsapp_trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Appsero handles your data.'),
