...
class ChatWhatsapp
{
    ...
    public function chat_whatsapp_action_links(array $links)
    {
        $new_links = array(
			...
			sprintf('<a target="_blank" href="https://wordpress.org/support/plugin/chat-help/">' . esc_html__('Support', 'chat-help') . '</a>'),
			sprintf('<a style="font-weight: bold;color:#118c7e" target="_blank" href="https://themeatelier.net/downloads/whatsapp-chat-help/">' . esc_html__('Go Pro', 'chat-help') . '</a>'),
		);
