...
if (! class_exists('dashboard_widget_PRO')) {
    class dashboard_widget_PRO
    {
        ...
        public function Top_IPs_Blocked()
        {
            ...
            //Solve SQL Injection Error by using prepare
            $query = $wpdb->prepare(
                "SELECT ip, country, country_code, count(*) as count FROM {$wpdb->prefix}WPLFLA_log_block_ip GROUP BY ip ORDER BY 4 DESC LIMIT %d",
                10
            );
            $login_failed_option = $wpdb->get_results($query);
?>
                ...
                ?>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <img width="18px" src="<?php echo esc_url(WPLFLA_PLUGIN_URL . '/assets/images/flags/' . strtolower($country_code)); ?>.png">&nbsp;<?php echo esc_html($log->country); ?>
                                </td>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php esc_html_e($logs->username . '/'); ?><a target="_blank" href="https://www.wp-buy.com/product/wp-limit-failed-login-attempts-pro/"><?php esc_html_e('Upgrade to PRO'); ?></a> <br /><small><?php
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                if ($user_info) {
                                                                                                                                                                                                                                ?><span class="<?php if (user_can($user_info, "administrator")) {
                                                                                                                                                                                                                                        echo 'color_red';
                                                                                                                                                                                                                                    }; ?>"><?php
