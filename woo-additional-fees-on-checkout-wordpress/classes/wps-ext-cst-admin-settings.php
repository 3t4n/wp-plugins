...
class WPS_EXT_CST_Admin_Settings
{
	public static function register_admin_settings(){
		add_settings_section("wps-ext-cst-option-section", "Additional Fees Settings<p class='error'>You are using Basic, Free version, get the Premium, Exclusive version @ <b>19 USD</b> only, for limited time.</p>", null, "wps-ext-cst-options");
			            	...
			            	<tbody>
								...
								<tr id="incTax-1" class="incTax">
									...
									<td>
										...
										<p class="error">Available with premium version @ <b>19 USD only</b>, for limited time.<a target="_blank;" href="https://www.wpsuperiors.com/woocommerce-additional-fees-on-checkout/"><br/>Buy Now</a>.</p>
									</td>
								</tr>
