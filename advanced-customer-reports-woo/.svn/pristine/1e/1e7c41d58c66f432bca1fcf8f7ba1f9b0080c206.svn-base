...
Tags: customer reports, woocommerce, reports, customers, analytics
...
If you have any suggestions for additional functionality, need any help, or have found a bug, please create a <a href="https://wordpress.org/support/plugin/advanced-customer-reports/#new-topic-0">support ticket</a>.
...
= Version 1.1.5 - 20th December 2024 =
- Fix: Fixed an issue with reports not generating for some sites.
- Fix: Fixed an issue with the customer list not loading for some sites.
- Other: Updated to Freemius SDK 2.10.1
- Other: Tested with WooCommerce 9.5.1
- Other: Tested with WordPress 6.7.1

= Version 1.1.4 - 22nd September 2024 =
