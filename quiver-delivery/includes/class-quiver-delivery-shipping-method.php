...
if (class_exists('Quiver_Delivery_Shipping_Method', false)) {
    return;
}
...
class Quiver_Delivery_Shipping_Method extends WC_Shipping_Method
{
    ...
    private $METHOD_ID = 'quiver-delivery';
    ...
    public function __construct($instance_id = 0)
    {
        ...
        $this->method_title = __('Quiver Delivery', 'quiver-delivery');
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            'api_key' => array(
                'title'             => __('API Key', 'quiver-delivery'),
                'type'              => 'text',
                'description'       => __('This can be found by visiting app.quiver.co.uk and navigating to the Settings page.', 'quiver-delivery'),
                'desc_tip'          => true,
                'default'           => '',
                'placeholder'        => '',
            ),
    ...
    private function backOrderedDate($backOrderedStr) {
        ...
        $today = gmdate('Y-m-d');
        return gmdate('Y-m-d', strtotime($today. $dateIncrement));
    }
