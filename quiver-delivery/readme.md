...
Donate link:
Tags: Quiver, WooCommerce Shipping, WooCommerce Fulfilment, Same Day, Carrier
...
When installed on WooCommerce store, this plugin uses Quiver's API suite to book deliveries. A customer's order + shipping details are used to call the API.

Please consult Quiver's privacy policy, https://quiver.co.uk/privacy, for more details.
...
- Fixed WordPress compatibility Issue
