		...
		<div class="mo-ms-tab-content">
			<div >
				...
				<h1><b>Configure Microsoft Graph Application</b></h1>
					<h1><a href="https://plugins.miniorange.com/wordpress-power-bi-embed" target="_blank" style="padding-left:5px;font-size: small;"> (Setup Guide) </a><h1>
				</div>
	...
	private function mo_epbr_display__client_config() {
		...
		<script>
			function showAttributeWindow(){
				...
				var myWindow = window.open("<?php echo esc_url( $this->mo_epbr_get_test_url() ); ?>", "TEST User Attributes", "scrollbars=1 width=800, height=600");
			}
		</script>
		<?php
	}
