...
<div class="row mb-4">
	<div class="col-12 col-lg-6">
		<div class="form-group mb-2">
			<label for="personalizewp_form[name]"><?php esc_html_e( 'Rule Name', 'personalizewp' ); ?> <span class="required">*</span></label>
			<p class="description"><?php esc_html_e( 'Choose a name that describes the conditions for your rule.', 'personalizewp' ); ?></p>
...
<div class="row mb-4">
	<div class="col-12 col-lg-6">
		<div class="form-group mb-2 category-dropdown">
			...
			<p class="description">
				<?php esc_html_e( 'If you would like to associate your rule with a category, you can choose one from the dropdown below.', 'personalizewp' ); ?>
				<?php
				printf(
					/* translators: 1: %s expands to a website link to /wp-admin/admin.php?page=personalizewp/categories, 2: </a> closing tag. */
					esc_html__( 'For more options, you can %1$screate a new category%2$s.', 'personalizewp' ),
					'<a href="' . esc_url( PERSONALIZEWP_ADMIN_CATEGORIES_INDEX_URL ) . '" target="_blank">',
					'</a>'
				);
				?>
			</p>
			...
			<select id="personalizewp_form[category_id]" name="personalizewp_form[category_id]" class="chosen-select form-control <?php echo ( $this->getError( 'category_id' ) ? esc_attr( 'is-invalid' ) : '' ); ?>">
				<?php
				$options = [ 0 => __( '-- Select a category --', 'personalizewp' ) ] + PersonalizeWP_Category::list();
...
<div class="row">
	<div class="col-12 col-xl-10">
		<div class="form-group mb-2">
			<label><?php esc_html_e( 'Conditions', 'personalizewp' ); ?> <span class="required">*</span></label>
			<p class="description"><?php esc_html_e( 'All conditions within a single rule are matched using AND logic. This means that ALL conditions have to be met for the rule to be True. If you have multiple conditions and one condition is not met, the rule will be False. There is no limit to the number of conditions you can add.', 'personalizewp' ); ?></p>
