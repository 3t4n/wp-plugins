...
https://www.youtube.com/watch?v=iLa-zNyRTtY

**[How to use this plugin](https://medium.com/@anasakdev/create-scrolling-spline-animation-in-wordpress-7a10de0d83cc)**
...
- **Responsive options**: currently the only responsive functionality in plugin is to show or hide the animation block on different devices, to access that settings click on the animation block and see the right sidebar and scroll down until you see "responsive settings" checkbox enable it and add your settings there.
...
= 1.0.3 =
* Removed scripts conflicting with wordpress.org 

= 1.0.2 =
* Spline model not loading issue fix
* some other fixes

= 1.0.1 =
* Animation state undo fixed
* Readme updated
