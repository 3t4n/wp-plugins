...
class WC_Gateway_Mixplatpayment extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('Миксплат: банковская карта и другие способы', 'woocommerce-gateway-mixplatpayment-payments');
        $this->method_description = __('Покупатель сможет выбрать один из подключённых способов оплаты (картой, СБП и прочие) в платёжной форме.', 'woocommerce-gateway-mixplatpayment-payments');

        $this->defaultTitle       = __('Миксплат', 'woocommerce-gateway-mixplatpayment-payments');
        $this->defaultDescription = __('Банковской картой и другими подключёнными способами', 'woocommerce-gateway-mixplatpayment-payments');

        $this->title       = __('Миксплат', 'woocommerce-gateway-mixplatpayment-payments');
        $this->description = __('Банковской картой и другими подключёнными способами', 'woocommerce-gateway-mixplatpayment-payments');
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title'        => [
                ...
                'default'     => __('Миксплат', 'woocommerce-gateway-mixplatpayment-payments'),
                'desc_tip'    => true,
            ],
            'description'  => [
            ...
            'product_nds'             => [
                ...
                'options' => [
                    ...
                    'vat5'  => __('НДС 5%', 'woocommerce-gateway-mixplatpayment-payments'),
                    'vat7'  => __('НДС 7%', 'woocommerce-gateway-mixplatpayment-payments'),
                    'vat105' => __('НДС чека по расчетной ставке 5/105', 'woocommerce-gateway-mixplatpayment-payments'),
                    'vat107' => __('НДС чека по расчетной ставке 7/107', 'woocommerce-gateway-mixplatpayment-payments'),
                ],
                'default' => 'vat20',
            ],
            'delivery_nds'            => [
            ...
            'payment_method'          => [
                ...
                'options' => [
                    ...
                    'prepayment'         => __('частичная предоплата', 'woocommerce-gateway-mixplatpayment-payments'),
    ...
    private function getPaymentRequestData($order)
    {
        ...
        $data = apply_filters('woocommerce_mixplatpayment_payment_request_data', [
            ...
            'payment_form_id'     => !empty($this->form_id) ? intval($this->form_id) : null,
