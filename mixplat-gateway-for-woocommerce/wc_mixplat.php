 ...
 * Description: Прием платежей для WooCommerce с помощью банковских карт (интернет-эквайринг), СБП, SberPay, Mir Pay и мобильных платежей.
 * Version: 1.0.8
 * Author: Миксплат
...
class WC_Mixplatpayment
{
    ...
    {
        include_once __DIR__ . '/includes/MixplatPayment.php';

        $payment_method_registry->register(new MixplatPayment());
    }
    ...
    function mixplatpayment_menu()
    {
        ...
        add_menu_page(__('Платежные транзакции', 'woocommerce-gateway-mixplatpayment-payments'), __('Миксплат: транзакции', 'woocommerce-gateway-mixplatpayment-payments'), 'manage_woocommerce', 'mixplatpayment', [$this, "mixplatpayment_transactions"], $icon, '55.6');
    }
