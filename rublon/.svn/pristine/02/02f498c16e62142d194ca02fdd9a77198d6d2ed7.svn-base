...
Contributors: rublon
Tags: multi-factor authentication, two-factor authentication, security, MFA, 2FA
...
Rublon MFA is a multi-factor authentication (MFA) solution that protects your organization’s data and access to networks, servers, and applications. Rublon MFA provides MFA for cloud apps, VPNs, servers, and Microsoft technologies using authentication methods like [Mobile Push](https://rublon.com/product/mobile-push/), [SMS Passcode](https://rublon.com/product/sms-passcodes/), [QR Code](https://rublon.com/product/qr-codes/), [WebAuthn/U2F Security Keys](https://rublon.com/product/security-keys/), and more.

Rublon MFA is easy to use, affordable, and scalable. It helps reduce compliance risk, improve user experience, and reduce costs. Rublon MFA is compatible with a variety of technologies, including but not limited to [VPN](https://rublon.com/docs/#vpn), [Remote Desktop Services (RDS)](https://rublon.com/doc/rds/), [Outlook Web App (OWA)](https://rublon.com/doc/owa/), [LDAP](https://rublon.com/product/ldap-mfa/), [RADIUS](https://rublon.com/product/radius-mfa/), and [WordPress](https://rublon.com/doc/wordpress/).

### Start your [Free 30-Day Trial](https://admin.rublon.net/auth/register) and see how easy it is to get started with Rublon MFA.

### To learn more, visit [www.rublon.com](https://rublon.com/).

> #### Recommended by Security Experts and Industry Professionals
> *"The fact that I could speak instantly with tech support while evaluating was super important. Connecting with Rublon technicians via remote sessions was SUPER handy to assist with setting things up." &mdash; **Chris D., Manager of GIS/IT*** <br><br>
> *"We were able to get Rublon MFA installed, tested, and in use in under a day across all offices." &mdash; **Ethan M. Hospital & Health Care*** <br><br>
> *"Product was absolutely superb for integrating MFA into our RDS solution very easy to use and the moblie app was brilliant for our end users." &mdash; **Scott L., IT Network Manager*** <br><br>
> *"we tested a trial version, it was very easy to set up. we got the pricing immediately. other suppliers did not even replied to my email yet and i already implemented Rublon" &mdash; **Mihail B., Logistics Manager*** <br><br>
> *"I searched for a tool for a very specific security need and Rublon filled that need perfectly. Not only does it work every single time as expected, the support and setup are amazing! Highly recommended." &mdash; **Charles D., Financial Services*** <br><br>
> [Read More](https://rublon.com/customers/)
...
Rublon Multi-Factor Authentication (MFA) adds an extra layer of security on top of your usual login & password WordPress logins. First, a user enters their username and password as always. Then, Rublon displays the [Rublon Prompt](https://rublon.com/guide/rublon-prompt). The user can select one of the available authentication methods, such as Mobile Push or WebAuthn/U2F Security Key. After selecting and completing the authentication method, the user gains access to WordPress.
...
Rublon Multi-Factor Authentication is an all-in-one package that contains Rublon MFA for WordPress and dozens of other products, applications, and integrations. You can start a Free Rublon Trial and enjoy all features for 30 days. If you only want to protect one WordPress account, you will never have to pay! For more information, visit our [Pricing page](https://rublon.com/pricing).

= How Can I Protect My WordPress Account With Rublon MFA? =
Simply install the Rublon for WordPress plugin and activate it. Then, create a new WordPress application in the Rublon Admin Console and copy the values of the System Token and Secret Key. For full detailed instructions (including screenshots), refer to our [Documentation](https://rublon.com/doc/wordpress).

= Does Rublon MFA Support Phone-Based, Out-Of-Band Multi-Factor Authentication? =
Yes! Just install the Rublon Authenticator mobile app on your phone (available for [Android](https://play.google.com/store/apps/details?id=com.rublon.authenticator&hl=en) and [iOS](https://apps.apple.com/us/app/rublon-authenticator/id1434412791)). After entering your WordPress login credentials, you will be prompted to verify your account in one of the following ways:
...
1. Rublon Multi-Factor Authentication (MFA) in progress
2. Select the authentication method on the Rublon Prompt
3. Confirm your identity by clicking an Email Link
4. Confirm your identity by scanning the QR Code using the Rublon Authenticator mobile app
5. Confirm your identity by approving a Mobile Push notification using the Rublon Authenticator mobile app
6. Confirm your identity by entering a Mobile Passcode (TOTP) generated by the Rublon Authenticator mobile app
7. Confirm your identity by entering a one-time code sent in an SMS text message
8. Confirm your identity using a WebAuthn/U2F Security Key
9. Confirm your identity using YubiKey OTP
10. Make Rublon remember your device on consecutive logins
11. Identity has been confirmed.
12. Connect Rublon Multi-Factor Authentication (MFA) with your application in the Rublon Admin Console using the System Token and Secret Key
...
I have read and agree to the [Terms of Service](https://legal.rublon.com/tos) and [Privacy Policy](https://legal.rublon.com/privacy) before installing the Rublon WordPress Plugin.
