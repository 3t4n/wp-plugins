...
! defined( 'WPCAS_VERSION' ) && define( 'WPCAS_VERSION', '2.4.3' );
                                            ...
                                            <td>
												...
												if ( ! empty( $post_types ) ) {
													foreach ( $post_types as $post_type ) {
														?>
                                                        <input type="checkbox" name="wpcas_settings[search_post_types][]" value="<?php echo esc_attr( $post_type->name ); ?>" <?php checked( in_array( $post_type->name, $search_post_types ) ); ?>/>
