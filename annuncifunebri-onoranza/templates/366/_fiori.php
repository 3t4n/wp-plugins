        ...
        <form action="." method="post" id="annfu_fiori_form">
            ...
            <div id="annfu_fiori_form_inner">
                ...
                <p class="mb-3">Scegli la tua composizione floreale da inviare alla famiglia in segno di vicinanza, noi
                    penseremo a consegnarla presso la casa funeraria o il luogo dove riposa la salma.<br/>
                    <span class="annfu_error">La consegna sarà garantita se l'ordine ci perverrà almeno 24 ore prima del
					servizio funebre (giorni festivi esclusi)</span>
                </p>
