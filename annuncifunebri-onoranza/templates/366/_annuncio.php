            ...
            <div class="annfu_annuncio">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="annfu_annuncio_onoranza_funebre mb-3"><?php echo $annuncio['chiusuraOnoranzaFunebre'] ?></div>

                        <div class="annfu_buttons_wrapper">
                            <a href="#annfu_form_cordoglio_wrapper"
                               class="mr-3 btn btn-block btn-outline-primary annfu_vai_a_form_cordogli">
                                <i class="fas fa-pencil-alt"></i> Scrivi un messaggio di cordoglio
                            </a>
                            <?php if ($annuncio['abilitatoFotoCordogli']): ?>
                                <a href="#annfu_form_foto"
                                   class="mr-3 btn btn-block btn-outline-primary annfu_vai_a_form_cordogli annfu_open_tab_foto">
                                    <i class="fas fa-image"></i> Invia una foto</a>
                            <?php endif; ?>
                            <?php if (count($annuncio['fiori'])): ?>
                                <a href="#annfu_form_fiori"
                                   class="btn btn-block btn-outline-primary annfu_vai_a_form_cordogli annfu_open_tab_fiori">
                ...
                <div class="row justify-content-center my-3 annfu_box_info_wrapper">
                    <?php if ($annuncio['luogoRiposo']): ?>
                        <div class="annfu_camera_ardente_wrapper col-lg-3 col-md-6 mb-3 p-3">
                            <h5 class="mb-3 bordered">Camera ardente</h5>
                            <div class="annfu_data_ora_chiusura">
                                <i class="far fa-calendar-alt"></i>
                                <?php if ($annuncio['dataChiusura']): ?>
                                    fino al <?php echo $annuncio['dataChiusuraIta'] ?>
                                    <?php echo $annuncio['oraChiusura'] != '00:00' ? 'ore ' . $annuncio['oraChiusura'] : '' ?>
                                <?php else: ?>
                            ...
                            <div>
                                ...
                                <?php if (filter_var($annuncio['luogoRiposoLink'], FILTER_VALIDATE_URL)): ?>
                                    <a href="<?php echo $annuncio['luogoRiposoLink'] ?>" target="_blank" class="btn btn-outline-primary">
                    ...
                    <?php if ($annuncio['dataRosario'] || $annuncio['luogoRosario']): ?>
                        <div class="annfu_rosario_wrapper col-lg-3 col-md-6 mb-3 p-3">
                            ...
                            <?php if ($annuncio['luogoRosario']): ?>
                                <div class="annfu_luogo_rosario annfu_link_luogo btn btn-outline-primary">
                    ...
                    <div class="annfu_funerale_wrapper col-lg-3 col-md-6 mb-3 p-3">
                        ...
                        <?php if($annuncio['luogoCerimonia']): ?>
                            <div class="annfu_luogo_funerale annfu_link_luogo btn btn-outline-primary">
                                <i class="fas fa-church"></i>
                    ...
                    <?php if ($annuncio['dataSepoltura'] || $annuncio['luogoSepoltura']): ?>
                        <div class="annfu_sepoltura_wrapper col-lg-3 col-md-6 mb-3 p-3">
                            ...
                            <?php if ($annuncio['luogoSepoltura']): ?>
                                <div class="annfu_luogo_sepoltura annfu_link_luogo btn btn-outline-primary">
                ...
                <div class="annfu_annuncio_streaming_avviso mt-3 text-center">
