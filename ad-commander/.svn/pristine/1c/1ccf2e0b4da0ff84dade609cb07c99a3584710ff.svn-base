		...
		if ( ! ProBridge::instance()->is_pro_loaded() ) {
			...
			$html .= $this->start_div( Util::ns( 'addons' ), array( 'display' => false ) ) .
				$this->start_div( array( Util::ns( 'addon-features' ), Util::ns( 'pro-features' ) ), array( 'display' => false ) ) .
					...
					Html::abtn( self::pro_upgrade_url( array( 'utm_medium' => 'button' ) ), __( 'Upgrade to Pro', 'ad-commander' ) ) .
		...
		if ( ! AddonBridge::instance()->is_addon_loaded( 'tools' ) ) {
			...
			$html .= $this->start_div( Util::ns( 'addons' ), array( 'display' => false ) ) .
				$this->start_div( Util::ns( 'addon-features' ), array( 'display' => false ) ) .
					Html::h3( __( 'Ad Commander Tools', 'ad-commander' ) ) .
					Html::ul( $lis, Util::ns( 'addon' ) ) .
					$this->start_div( 'adcmdr-btn-group', array( 'display' => false ) ) .
					Html::abtn( AddonBridge::addon_url( 'tools' ), __( 'Download Add-on', 'ad-commander' ) ) .
					$this->end_div( array( 'display' => false ) ) .
				$this->end_div( array( 'display' => false ) ) .
			$this->end_div( array( 'display' => false ) );
		}

		if ( ! AddonBridge::instance()->is_addon_loaded( 'scrnsa' ) ) {
			$p  = esc_html__( "Screen Stay Awake prevents your website visitor's screen from turning off. The Screen Wake Lock API is used and no visitor prompt is required.", 'ad-commander' );
			$p .= '<br /><br />';
			$p .= esc_html__( 'This plugin is great for recipe websites and other how-to websites where a visitor would prefer their screen stay on.', 'ad-commander' );

			$html .= $this->start_div( Util::ns( 'addons' ), array( 'display' => false ) ) .
				$this->start_div( Util::ns( 'addon-features' ), array( 'display' => false ) ) .
					Html::h3( __( 'Screen Stay Awake', 'ad-commander' ) ) .
					Html::p( $p ) .
					$this->start_div( 'adcmdr-btn-group', array( 'display' => false ) ) .
					Html::abtn( AddonBridge::addon_url( 'scrnsa' ), __( 'Download Plugin', 'ad-commander' ) ) .
					$this->end_div( array( 'display' => false ) ) .
				$this->end_div( array( 'display' => false ) ) .
			$this->end_div( array( 'display' => false ) );
		}
