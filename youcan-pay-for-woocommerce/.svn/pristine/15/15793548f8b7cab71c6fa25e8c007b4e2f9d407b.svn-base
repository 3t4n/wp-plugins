 ...
 */
define( 'WC_YOUCAN_PAY_VERSION', '3.1.0' ); // WRCS: DEFINED_VERSION.
define( 'WC_YOUCAN_PAY_MIN_PHP_VER', '8.1.0' );
define( 'WC_YOUCAN_PAY_MIN_WC_VER', '6.7.1' );
define( 'WC_YOUCAN_PAY_FUTURE_MIN_WC_VER', '6.7.1' );
...
add_action('init', 'load_youcan_pay_translations');

function load_youcan_pay_translations() {
