...
<h3 class="accordion-section-title hndle" tabindex="1"><button type="button" class="accordion-trigger" aria-expanded="true" aria-controls="target-1"><div class="accordion-title emd"><span class="accordion-title-text"><?php esc_html_e('People', 'campus-directory'); ?></span><span class="dashicons dashicons-arrow-down" aria-hidden="true"></span></div></button></h3>
