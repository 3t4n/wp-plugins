...
<h2 id="credit-cards" style="margin-top:40px;"><?php esc_html_e( 'My Credit Cards', 'woocommerce-payeezy' ); ?></h2>
<div class="woocommerce-message payeezy-success-message"><?php esc_html_e( 'Your request has been successfully processed.', 'woocommerce-payeezy' ); ?></div>
<div class="woocommerce-error payeezy-error-message"><?php esc_html_e( 'There was an error processing your request.', 'woocommerce-payeezy' ); ?></div>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="#" data-id="<?php echo esc_attr( $card->ID ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'delete_card_nonce' ) ); ?>" class="delete-card"><?php esc_html_e( 'Delete', 'woocommerce-payeezy' ); ?></a>
			</td>
		</tr>
		<?php endforeach; ?>
	</tbody>
...
<p><a href="#" class="button add-card"><?php esc_html_e( 'Add New Card', 'woocommerce-payeezy' ); ?></a></p>

<h3 class="add-card-heading"><?php esc_html_e( 'Add Credit Card', 'woocommerce-payeezy' ); ?></h3>
	...
	<form type="post" action="", id="payeezy-cc-form">
		<fieldset id="payeezy-cc-fields">
			...
			<p class="form-row form-row-wide">
				<label for="payeezy-card-number"><?php esc_html_e( 'Card Number ', 'woocommerce-payeezy' ); ?><span class="required">*</span></label>
			...
			<p class="form-row form-row-first">
				<label for="payeezy-card-expiry"><?php esc_html_e( 'Expiry (MM/YY) ', 'woocommerce-payeezy' ); ?><span class="required">*</span></label>
			...
			<p class="form-row form-row-last">
				<label for="payeezy-card-cvc"><?php esc_html_e( 'Card Code ', 'woocommerce-payeezy' ); ?><span class="required">*</span></label>
			...
			<p class="form-row form-row-wide make-default">
				<label for="payeezy-make-default">
					<input id="payeezy-make-default" class="input-checkbox wc-credit-card-form-make-default" type="checkbox" name="payeezy-make-default" />
					<span><?php esc_html_e( 'Make Default? ', 'woocommerce-payeezy' ); ?></span>
				</label>
			</p>
			<p class="form-row form-row">
				<input type="submit" value="Submit" class="button" />
				<a href="#" class="cc-form-cancel"><?php esc_html_e( 'Cancel ', 'woocommerce-payeezy' ); ?></a>
			</p>
		</fieldset>
	</form>
</div>
