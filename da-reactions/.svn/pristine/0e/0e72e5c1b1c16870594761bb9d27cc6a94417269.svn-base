...
class Options
{
     ...
     */
    public function __construct( $options_name, $blog_id = null)
    {
    ...
    public function getOption($option_name, $default_value = null) {
        ...
        return isset($this->options[ $option_name ]) ? $this->options[ $option_name ] : $default_value;
    }
    /**
    ...
    public function setOption($option_name, $value = null) {
        ...
        $this->options = array_merge($this->options, [$option_name => $value]);
    }
    /**
