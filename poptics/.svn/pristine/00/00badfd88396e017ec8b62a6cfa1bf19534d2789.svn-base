...
class Menu {
    ...
    public function register_admin_menu() {
        ...
        $menu_items = array(
            ...
            [
                'id'         => 'ab-testing',
                'title'      => __( 'A/B Testing (PRO)', 'poptics' ),
                'link'       => '/ab-testing',
