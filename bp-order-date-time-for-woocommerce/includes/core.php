...
if ( !class_exists( 'BP_Plugin_Core' ) ) {
    class BP_Plugin_Core {
        ...
        public function codeixer_admin_scripts() {
            //wp_enqueue_style( 'ci-admin', BV_BDFW_ASSETS . '/css/ci-admin.css' );
        }
        ...
        public function bp_admin_menu() {
            add_menu_page( 'Bright Plugins', 'Bright Plugins', 'manage_options', 'brightplugins', null, BV_BDFW_ASSETS . '/img/bp-logo-icon.png', 60 );
        ...
        public function codeixer_license() {?>
            ...
            <h2><?php _e( 'Bright Plugins License Activation', 'bp-woopick-delivery' )?></h2>

        	<p class="about-description"><?php _e( 'Enter your Purchase key here, to activate the product, and get full feature updates and premium support.', 'bp-woopick-delivery' )?></p><?php
