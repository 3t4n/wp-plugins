...
//				console.log(row);
    ...
    $body.on('click','#one-column', function(){
        $('.view-button.active').removeClass('active');
        $(this).addClass('active')
        $('.block tbody tr').removeClass('two-columns');
        $('.block tbody tr').addClass('one-column');
    });
    $body.on('click','#responsive', function(){
        $('.view-button.active').removeClass('active');
        $(this).addClass('active')
        $('.block tbody tr').removeClass('one-column');
        $('.block tbody tr').removeClass('two-columns');
    });

    $body.on('click','#show-enabled', function(){
        if($(this).hasClass('active')){
            $(this).removeClass('active');
            $('.block').removeClass('only-enabled');
        } else {
            $('.filter-enabled-button.active').removeClass('active');
            $('.block').removeClass('only-disabled');
            $(this).addClass('active');
            $('.block').addClass('only-enabled');
        }
    });
