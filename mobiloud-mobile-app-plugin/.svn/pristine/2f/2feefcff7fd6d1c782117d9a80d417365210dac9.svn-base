...
Contributors: 50pixels, psac50, xsvet, vitorargos, mobileappdev
Tags: mobile app, application, mobile, native app, android app, ios app, ipad app, iphone app, app builder, wordpress mobile app, mobile app plugin, convert to app, MobiLoud
...
== Description ==
**[MobiLoud](https://www.mobiloud.com?ref=plugindesc) lets you turn your WordPress site into mobile apps for iOS and Android that require no work to maintain.**

*Install the [MobiLoud mobile app plugin](https://www.mobiloud.com/wordpress-mobile-app) and get a free preview of your app.*

= What is MobiLoud? =

[MobiLoud](https://www.mobiloud.com/wordpress-mobile-app) makes it easy to convert any WordPress site into native mobile apps for iOS and Android that automatically update with your website. You also get to work with a team of experts handling everything related to your app for you.  
...
https://vimeo.com/354094380

https://vimeo.com/354094639

https://vimeo.com/332400724

[Read more reviews at MobiLoud.com](https://www.mobiloud.com/reviews/?ref=plugindesc)

--

= How Does it Work? =

We have two platforms - [News](https://www.mobiloud.com/wordpress-news-app), and [Canvas](https://www.mobiloud.com/canvas).
...
[Canvas](https://www.mobiloud.com/canvas) is perfect for community sites, startups, social platforms, deals sites, eLearning businesses, and in general any mobile optimized site based on WordPress. 
...
[News](https://www.mobiloud.com/wordpress-news-app) is a custom app building service specifically designed for WordPress based digital publishers. Major publishing brands like Foreign Policy and Business Insider use News to provide a superior mobile user experience to their readers - and you can too!
...
Need a custom app? Email us at [sales@mobiloud.com](mailto:sales@mobiloud.com).
...
Whether you go with News or Canvas - the process is the same.

It starts with a [demo call with one of our team members](https://www.mobiloud.com/demo/?ref=plugindesc). We go over the platform in depth, share example apps with you - and outline a plan for bringing your apps live. 
...
Next our team will get to work building the apps for iOS and Android. You'll be able to test the apps within two to three weeks to make sure you're happy with the look and performance. 

After a round of thorough testing, we'll handle submitting and publishing the apps to Google Play and the App Store. 

Finally, our team takes care of all ongoing updates and maintenance of the apps month after month.
...
News and Canvas allow you to integrate the power and flexibility of the web into your mobile apps. Anything you can build on WordPress you can have in your apps too. 

The flexibility doesn't stop with integrating themes, plugins, and widgets. 

We also give you access to a code editor that allows you to customize and style parts of the app how you see fit and create a truly custom app (or we can do it for you!).
...
We're obsessed with the small but important details. 

We customize everything from the push notification icons that will pop up on users' screens, to the native splash screens and App Store icons - personally taking care of all the details that usually get skipped over or templated. 

= A Service, Not Just a Tool = 

We take a very proactive approach to customer service. 

You'll know our team members by name, and will always be able to count on fast, helpful support. We're real people that you can chat with directly via email - but also on the phone or Zoom whenever necessary. 
...
We have no long-term contracts, and you can cancel within 60 days and receive a full refund. 

If you don't like the apps or decide that you don't want to go through with the project within that period - you get your money back.  

Since we oversee both the app build and publishing process we can guarantee that your apps will be approved on the stores. 

We've been through the process 1200+ times, so we know what we're doing!


== Installation ==
1. [Request a demo](https://www.mobiloud.com/demo/?ref=plugindesc) or [sign up](https://www.mobiloud.com/pricing/?ref=plugindesc)
...
Canvas creates hybrid apps that display your web application or website within a native "wrapper". While the native format is ideal in the case of news - for many web apps [Canvas beats native development](https://www.mobiloud.com/blog/canvas-is-enough).
= Should I download and install this plugin? =
You should download and activate this plugin if you are a MobiLoud customer. To learn more about MobiLoud and start the process, [book a demo](https://www.mobiloud.com/demo/?ref=plugindesc)
...
Unlike AppPresser we offer a 60-day money back guarantee, so you can try our service with no risk! To read more about how MobiLoud Canvas compares to AppPresser, check [this article](https://www.mobiloud.com/help/knowledge-base/mobiloud-different-apppresser) out.  

= Who is MobiLoud for? = 
[MobiLoud](https://www.mobiloud.com/?ref=plugindesc) is a mobile app development service for WordPress-based businesses. 
...
Need help with custom development? Get in touch with our team at [support@mobiloud.com](mailto:support@mobiloud.com), we can help.
...
Yes you can. Our code editor allows you to inject custom CSS into the app to style most of its elements. We occasionally offer a source code license to modify the app's native platform code, but this is rarely needed for customizations. Get in touch with us at [support@mobiloud.com](mailto:support@mobiloud.com) to know more.
= How do I know which is right for me - News or Canvas? =
If you're a publisher, News is likely for you. For anything else - Canvas likely has you covered. To find out for sure [book a free demo with one of our team](https://www.mobiloud.com/demo/?ref=plugindesc)
...
= 4.0.2 =
Recommended update for bug fixes, security updates and enhancements
