		...
		<div class="cqpim-dash-item-full grid-item">
			<div class="cqpim_block quote_layout">
				<div class="cqpim_block_title">
					...
					<div class="actions">
						<a class="cqpim_button cqpim_small_button border-green-sharp font-light-violet rounded_2 sbold" href="<?php echo esc_url( get_the_permalink() ); ?>?pto-page=contract-print" target="_blank"><?php esc_html_e('VIEW PRINTABLE VERSION', 'projectopia-core'); ?></a>
					</div>
				</div>					
