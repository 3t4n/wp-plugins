	...
	<div class="masonry-grid">
		...
		<div class="cqpim-dash-item-double grid-item">
			<div class="cqpim_block">
				...
				<a class="cqpim_button cqpim_button_link font-white bg-blue block mt-10 rounded_2 block" href="<?php echo esc_url( get_the_permalink() ); ?>?pto-page=print" target="_blank"><?php esc_html_e('View Printable Invoice', 'projectopia-core') ; ?></a>
				<a class="cqpim_button cqpim_button_link font-white bg-blue block mt-10 rounded_2 block" href="<?php echo esc_url( get_the_permalink() ); ?>?download_pdf=1"><?php esc_html_e('Download PDF Invoice', 'projectopia-core') ; ?></a>				
			</div>
		</div>		
	</div>
