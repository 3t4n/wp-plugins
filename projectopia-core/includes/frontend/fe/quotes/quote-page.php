	...
	if ( isset( $_GET['sub'] ) && isset( $_GET['pto-page'] ) && 'quote' === sanitize_text_field(wp_unslash($_GET['pto-page'])) && 'messages' === sanitize_text_field(wp_unslash($_GET['sub'])) ) {
		...
		<div class="cqpim_block quote_layout">
			<div class="cqpim_block_title">
				...
				<div class="actions">
					<a class="cqpim_button cqpim_small_button border-green-sharp font-green-sharp rounded_2 sbold" href="<?php echo esc_url( get_the_permalink() ); ?>?pto-page=print" target="_blank"><?php esc_html_e('VIEW PRINTABLE VERSION', 'projectopia-core'); ?></a>
				</div>
			</div>
