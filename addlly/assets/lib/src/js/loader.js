    ...
    class y {
        ...
        _detect() {
            this._detected ||
                ...
                (this._isElectronRenderer = typeof process < "u" && typeof process.versions < "u" && typeof process.versions.electron < "u" && process.type === "renderer"),
                (this._isWebWorker = typeof u.global.importScripts == "function"),
                (this._isElectronNodeIntegrationWebWorker = this._isWebWorker && typeof process < "u" && typeof process.versions < "u" && typeof process.versions.electron < "u" && process.type === "worker"));
        }
        static _isWindows() {
...
(function (u) {
    class y {
        ...
        static getHighPerformanceTimestamp() {
            return (
                this.PERFORMANCE_NOW_PROBED || ((this.PERFORMANCE_NOW_PROBED = !0), (this.HAS_PERFORMANCE_NOW = u.global.performance && typeof u.global.performance.now == "function")),
        ...
        static validateConfigurationOptions(r) {
            ...
            if (
                ...
                r.nodeCachedData &&
                    ...
                    (typeof r.nodeCachedData.writeDelay != "number" || r.nodeCachedData.writeDelay < 0) && (r.nodeCachedData.writeDelay = 1e3 * 7),
    ...
    class p {
        constructor(r, c) {
            if (
                ...
                this.options.baseUrl === "" && this.options.nodeRequire && this.options.nodeRequire.main && this.options.nodeRequire.main.filename && this._env.isNode)
            ) {
        ...
        moduleIdToPaths(r) {
            ...
            if (!u.Utilities.endsWith(c, ".js") && !u.Utilities.isAbsolutePath(c)) {
                ...
                for (let t = 0, e = a.length; t < e; t++)
                    (this.isBuild() && a[t] === "empty:") || (u.Utilities.isAbsolutePath(a[t]) || (a[t] = this.options.baseUrl + a[t]), !u.Utilities.endsWith(a[t], ".js") && !u.Utilities.containsQueryString(a[t]) && (a[t] = a[t] + ".js"));
        ...
        _verifyCachedData(e, i, s, n, l) {
            !n ||
                ...
                setTimeout(() => {
                    ...
                    n.equals(d) ||
                        (l.getConfig().onError(new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${s}' now, but a RESTART IS REQUIRED`)),
                        this._fs.unlink(s, (o) => {
...
(function (u) {
    ...
    class c {
        ...
        _onLoadError(t, e) {
            ...
            this._modules2[t] || (this._modules2[t] = new m(t, this._moduleIdProvider.getStrModuleId(t), [], () => {}, null, null));
            let s = [];
                ...
                for (let i = 0, s = e.length; i < s; i++) {
                    ...
                    if (this._hasDependencyPath(n.id, t.id)) {
                        (this._hasDependencyCycle = !0),
                            console.warn("There is a dependency cycle between '" + this._moduleIdProvider.getStrModuleId(n.id) + "' and '" + this._moduleIdProvider.getStrModuleId(t.id) + "'. The cyclic path follows:");
