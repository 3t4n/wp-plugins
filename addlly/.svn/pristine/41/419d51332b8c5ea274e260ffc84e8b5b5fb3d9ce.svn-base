!(function () {
    !(function () {
        ...
        var _ = [
                    ...
                    (i.prototype.clone_empty = function () {
                        ...
                        (n.prototype.__add_column = function () {
                            var t,
                                ...
                                n = "";
                            this.__indent_size && e >= this.__indent_size && ((e -= (t = Math.floor(e / this.__indent_size)) * this.__indent_size), (n = new Array(t + 1).join(this.__indent_string))),
                ...
                function (t) {
                    t.exports.Token = function (t, e, n, _) {
                        (this.type = t),
                            (this.text = e),
                            (this.comments_before = null),
                            (this.newlines = n || 0),
                            (this.whitespace_before = _ || ""),
                            (this.parent = null),
                            (this.next = null),
                            (this.previous = null),
                            (this.opened = null),
                ...
                function (t) {
                    ...
                    function n(t, e) {
                        var n,
                            _ = {};
                        for (n in (t = i(t))) n !== e && (_[n] = t[n]);
                        if (e && t[e]) for (n in t[e]) _[n] = t[e][n];
                        return _;
                    }
                    function i(t) {
                        var e,
                ...
                function (t) {
                    ...
                    (e.prototype.restart = function () {
                        ...
                        (e.prototype.read = function (t, e, n) {
                            var _,
                                i = "";
                            return t && (_ = this.match(t)) && (i += _[0]), !e || (!_ && t) || (i += this.readUntil(e, n)), i;
                        }),
                        (e.prototype.readUntil = function (t, e) {
                            var n = this.__position,
                                t = ((t.lastIndex = this.__position), t.exec(this.__input));
                            return t ? ((n = t.index), e && (n += t[0].length)) : (n = this.__input_length), (e = this.__input.substring(this.__position, n)), (this.__position = n), e;
                        }),
                        ...
                        (e.prototype.get_regexp = function (t, e) {
                            var n = null,
                                e = e && _ ? "y" : "g";
                            return "string" == typeof t && "" !== t ? (n = new RegExp(t, e)) : t && (n = new RegExp(t.source, e)), n;
                        }),
                ...
                function (t, e, n) {
                    ...
                    (_.prototype.tokenize = function () {
                        ...
                        for (var t, e = new s(o.START, ""), n = null, _ = [], i = new r(); e.type !== o.EOF; ) {
                            for (t = this._get_next_token(e, n); this._is_comment(t); ) i.add(t), (t = this._get_next_token(e, n));
                            i.isEmpty() || ((t.comments_before = i), (i = new r())),
                                (t.parent = n),
                                this._is_opening(t) ? (_.push(n), (n = t)) : n && this._is_closing(t, n) && (((t.opened = n).closed = t), (n = _.pop()), (t.parent = n)),
                                ((t.previous = e).next = t),
                                this.__tokens.add(t),
                                (e = t);
                        }
                        ...
                        (_.prototype._create_token = function (t, e) {
                            return new s(t, e, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
                        }),
                ...
                function (t, e, n) {
                    ...
                    ((i.prototype = new _()).__set_whitespace_patterns = function (t, e) {
                        ...
                        (i.prototype.__split = function (t, e) {
                            for (var n = (t.lastIndex = 0), _ = [], i = t.exec(e); i; ) _.push(e.substring(n, i.index)), (n = i.index + i[0].length), (i = t.exec(e));
                            return n < e.length ? _.push(e.substring(n, e.length)) : _.push(""), _;
                        }),
                ...
                function (t) {
                    ...
                    (e.prototype.get_directives = function (t) {
                        ...
                        for (var e = {}, n = ((this.__directive_pattern.lastIndex = 0), this.__directive_pattern.exec(t)); n; ) (e[n[1]] = n[2]), (n = this.__directive_pattern.exec(t));
                        return e;
                    }),
                ...
                function (t, e, n) {
                    ...
                    ((s.prototype = new _())._create = function () {
                        ...
                        (s.prototype.read_options = function (t) {
                            var e,
                                n = this._create();
                            for (e in i) n._disabled[e] = -1 === t.templating.indexOf(e);
                            return n._update(), n;
                        }),
                ...
                function (t, e, n) {
                    function p(t, e) {
                        (this.indent_level = 0), (this.alignment_size = 0), (this.max_preserve_newlines = t.max_preserve_newlines), (this.preserve_newlines = t.preserve_newlines), (this._output = new _(t, e));
                    }
                    function s(t, e) {
                        var n = null,
                            _ = null;
                        return e.closed
                            ? ("script" === t ? (n = "text/javascript") : "style" === t && (n = "text/css"),
                              ...
                              (n =
                                  (function (t) {
                                      for (var e = null, n = t.next; n.type !== u.EOF && t.closed !== n; ) {
                                          if (n.type === u.ATTRIBUTE && "type" === n.text) {
                                              n.next && n.next.type === u.EQUALS && n.next.next && n.next.next.type === u.VALUE && (e = n.next.next.text);
                                              break;
                                          }
                                          n = n.next;
                                      }
                                  ...
                                  ? (_ = "css")
                                  : -1 < n.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/)
                                  ? (_ = "javascript")
                                  : -1 < n.search(/(text|application|dojo)\/(x-)?(html)/)
                                  ? (_ = "html")
                                  : -1 < n.search(/test\/null/) && (_ = "null"),
                              _)
                            : null;
                    }
                    var i = n(20).Options,
                    ...
                    (p.prototype.current_line_has_match = function (t) {
                        ...
                        (p.prototype.print_preserved_newlines = function (t) {
                            var e = 0;
                            t.type !== u.TEXT && t.previous.type !== u.TEXT && (e = t.newlines ? 1 : 0), this.preserve_newlines && (e = t.newlines < this.max_preserve_newlines + 1 ? t.newlines : this.max_preserve_newlines + 1);
                        ...
                        (p.prototype.deindent = function () {
                            0 < this.indent_level && (this.indent_level--, this._output.set_indent(this.indent_level, this.alignment_size));
                        }),
                    ...
                    (d.prototype.get_parser_token = function () {
                        ...
                        (f.prototype.beautify = function () {
                            ...
                            for (
                                ...
                                o.type === u.TAG_OPEN || o.type === u.COMMENT
                                    ? (i = a = this._handle_tag_open(s, o, i, _, r))
                                    : o.type === u.ATTRIBUTE || o.type === u.EQUALS || o.type === u.VALUE || (o.type === u.TEXT && !i.tag_complete)
                                    ? (a = this._handle_inside_tag(s, o, i, _))
                                    : o.type === u.TAG_CLOSE
                                    ? (a = this._handle_tag_close(s, o, i))
                                    : o.type === u.TEXT
                                    ? (a = this._handle_text(s, o, i))
                                    : o.type === u.CONTROL_FLOW_OPEN
                                    ? (a = this._handle_control_flow_open(s, o))
                                    : o.type === u.CONTROL_FLOW_CLOSE
                                    ? (a = this._handle_control_flow_close(s, o))
                                    : s.add_raw_token(o),
                                    (_ = a),
                                    (o = r.next());
                        ...
                        (f.prototype._handle_control_flow_close = function (t, e) {
                            var n = { text: e.text, type: e.type };
                            return t.deindent(), e.newlines ? t.print_preserved_newlines(e) : t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0), t.print_token(e), n;
                        }),
                        (f.prototype._handle_tag_close = function (t, e, n) {
                            var _ = { text: e.text, type: e.type };
                            return (
                                (t.alignment_size = 0),
                                (n.tag_complete = !0),
                                t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0),
                                n.is_unformatted
                                    ? t.add_raw_token(e)
                                    : ("<" === n.tag_start_char && (t.set_space_before_token("/" === e.text[0], !0), this._is_wrap_attributes_force_expand_multiline && n.has_wrapped_attrs && t.print_newline(!1)), t.print_token(e)),
                        ...
                        (f.prototype._handle_inside_tag = function (t, e, n, _) {
                            ...
                            return (
                                ...
                                n.is_unformatted
                                    ? t.add_raw_token(e)
                                    : "{" === n.tag_start_char && e.type === u.TEXT
                                    ? t.print_preserved_newlines(e)
                                        ? ((e.newlines = 0), t.add_raw_token(e))
                                        : t.print_token(e)
                                    : (e.type === u.ATTRIBUTE ? t.set_space_before_token(!0) : (e.type === u.EQUALS || (e.type === u.VALUE && e.previous.type === u.EQUALS)) && t.set_space_before_token(!1),
                                      e.type === u.ATTRIBUTE &&
                                          "<" === n.tag_start_char &&
                                          ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (t.traverse_whitespace(e), (i = i || 0 !== e.newlines)),
                                          this._is_wrap_attributes_force &&
                                              n.attr_count >= this._options.wrap_attributes_min_attrs &&
                                              (_.type !== u.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) &&
                                              (t.print_newline(!1), (i = !0))),
                                      t.print_token(e),
                        ...
                        (f.prototype._handle_text = function (t, e, n) {
                            var _ = { text: e.text, type: "TK_CONTENT" };
                            return n.custom_beautifier_name ? this._print_custom_beatifier_text(t, e, n) : n.is_unformatted || n.is_content_unformatted ? t.add_raw_token(e) : (t.traverse_whitespace(e), t.print_token(e)), _;
                        }),
                        (f.prototype._print_custom_beatifier_text = function (t, e, n) {
                            ...
                            if ("" !== e.text) {
                                    ...
                                    r =
                                        ("javascript" === n.custom_beautifier_name && "function" == typeof this._js_beautify
                                            ...
                                            : "html" === n.custom_beautifier_name &&
                                              (i = function (t, e) {
                                                  return new f(t, e, _._js_beautify, _._css_beautify).beautify();
                                              }),
                                ...
                                if (((s = s.replace(/\n[ \t]*$/, "")), "html" !== n.custom_beautifier_name && "<" === s[0] && s.match(/^(<!--|<!\[CDATA\[)/))) {
                                    ...
                                    (a = r + n[1] + "\n"), (s = n[4]), n[5] && (o = r + n[5]), (s = s.replace(/\n[ \t]*$/, "")), (n[2] || -1 !== n[3].indexOf("\n")) && (n = n[3].match(/[ \t]+$/)) && (e.whitespace_before = n[0]);
                                }
                                (s =
                                    s &&
                                    (i
                                        ? (((n = function () {
                                          ...
                                          i(r + s, new n()))
                                        : r + (s = (i = e.whitespace_before) ? s.replace(new RegExp("\n(" + i + ")?", "g"), "\n") : s).replace(/\n/g, "\n" + r))),
                                    a && (s = s ? a + s + "\n" + o : a + o),
                                    t.print_newline(!1),
                                    s && ((e.text = s), (e.whitespace_before = ""), (e.newlines = 0), t.add_raw_token(e), t.print_newline(!0));
                            }
                        }),
                        (f.prototype._handle_tag_open = function (t, e, n, _, i) {
                            var s = this._get_tag_open_token(e);
                            if (
                                ((!n.is_unformatted && !n.is_content_unformatted) || n.is_empty_element || e.type !== u.TAG_OPEN || s.is_start_tag
                                    ? (t.traverse_whitespace(e), this._set_tag_position(t, e, s, n, _), s.is_inline_element || t.set_wrap_point(), t.print_token(e))
                                    : (t.add_raw_token(e), (s.start_tag_token = this._tag_stack.try_pop(s.tag_name))),
                                s.is_start_tag && this._is_wrap_attributes_force)
                            )
                                for (var r, a = 0; (r = i.peek(a)).type === u.ATTRIBUTE && (s.attr_count += 1), (a += 1), r.type !== u.EOF && r.type !== u.TAG_CLOSE; );
                            return (
                                (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (s.alignment_size = e.text.length + 1),
                            ...
                            (this.parent = t || null),
                                ...
                                e
                                    ? ((this.tag_start_char = e.text[0]),
                                      ...
                                      "<" === this.tag_start_char
                                          ...
                                          : ((n = e.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
                                            ...
                                            (e.text.startsWith("{{#>") || e.text.startsWith("{{~#>")) &&
                                                ">" === this.tag_check[0] &&
                                                (">" === this.tag_check && null !== e.next ? (this.tag_check = e.next.text.split(" ")[0]) : (this.tag_check = e.text.split(">")[1]))),
                                      ...
                                      (t = 2),
                                      "{" === this.tag_start_char && 3 <= this.text.length && "~" === this.text.charAt(2) && (t = 3),
                                      (this.is_end_tag = this.is_end_tag || ("{" === this.tag_start_char && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(t))))))
                                    : (this.tag_complete = !0);
                        },
                        o =
                            ((f.prototype._get_tag_open_token = function (t) {
                                t = new g(this._tag_stack.get_parser_token(), t);
                                return (
                                    ...
                                    (t.is_content_unformatted = !t.is_empty_element && r(t.tag_check, this._options.content_unformatted)),
                                    (t.is_inline_element = r(t.tag_name, this._options.inline) || (this._options.inline_custom_elements && t.tag_name.includes("-")) || "{" === t.tag_start_char),
                                    t
                                );
                            }),
                            (f.prototype._set_tag_position = function (t, e, n, _, i) {
                                n.is_empty_element ||
                                    (n.is_end_tag
                                        ? (n.start_tag_token = this._tag_stack.try_pop(n.tag_name))
                                        : (this._do_optional_end_element(n) && !n.is_inline_element && t.print_newline(!1),
                                          this._tag_stack.record_tag(n),
                                          ("script" !== n.tag_name && "style" !== n.tag_name) || n.is_unformatted || n.is_content_unformatted || (n.custom_beautifier_name = s(n.tag_check, e)))),
                                    r(n.tag_check, this._options.extra_liners) && (t.print_newline(!1), t._output.just_added_blankline() || t.print_newline(!0)),
                                    n.is_empty_element
                                        ? ("{" === n.tag_start_char && "else" === n.tag_check && (this._tag_stack.indent_to_tag(["if", "unless", "each"]), (n.indent_content = !0), t.current_line_has_match(/{{#if/) || t.print_newline(!1)),
                                          ("!--" === n.tag_name && i.type === u.TAG_CLOSE && _.is_end_tag && -1 === n.text.indexOf("\n")) ||
                                        ...
                                        ? ((e = !1),
                                          (e =
                                              ...
                                              (!n.is_inline_element && !(_.is_inline_element || _.is_unformatted) && !(i.type === u.TAG_CLOSE && n.start_tag_token === _) && "TK_CONTENT" !== i.type)),
                                          (e = n.is_content_unformatted || n.is_unformatted ? !1 : e) && t.print_newline(!1))
                                        : ((n.indent_content = !n.custom_beautifier_name),
                                          ...
                                          n.is_inline_element || n.is_unformatted || ("TK_CONTENT" === i.type && !n.is_content_unformatted) || t.print_newline(!1),
                        ...
                        if (!t.is_empty_element && t.is_start_tag && t.parent)
                            return (
                                "body" === t.tag_name
                                    ...
                                    ? (n = (n = n || this._tag_stack.try_pop("dt", ["dl"])) || this._tag_stack.try_pop("dd", ["dl"]))
                                    : "p" === t.parent.tag_name && -1 !== o.indexOf(t.tag_name)
                                    ? ((e = t.parent.parent) && -1 !== m.indexOf(e.tag_name)) || (n = n || this._tag_stack.try_pop("p"))
                                    : "rp" === t.tag_name || "rt" === t.tag_name
                                    ? (n = (n = n || this._tag_stack.try_pop("rt", ["ruby", "rtc"])) || this._tag_stack.try_pop("rp", ["ruby", "rtc"]))
                                    : "optgroup" === t.tag_name
                                    ? (n = n || this._tag_stack.try_pop("optgroup", ["select"]))
                                    : "option" === t.tag_name
                                    ? (n = n || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]))
                                    : "colgroup" === t.tag_name
                                    ? (n = n || this._tag_stack.try_pop("caption", ["table"]))
                                    : "thead" === t.tag_name
                                    ? (n = (n = n || this._tag_stack.try_pop("caption", ["table"])) || this._tag_stack.try_pop("colgroup", ["table"]))
                                    : "tbody" === t.tag_name || "tfoot" === t.tag_name
                                    ? (n =
                                          (n = (n = (n = n || this._tag_stack.try_pop("caption", ["table"])) || this._tag_stack.try_pop("colgroup", ["table"])) || this._tag_stack.try_pop("thead", ["table"])) ||
                                          this._tag_stack.try_pop("tbody", ["table"]))
                                    : "tr" === t.tag_name
                                    ? (n = (n = (n = n || this._tag_stack.try_pop("caption", ["table"])) || this._tag_stack.try_pop("colgroup", ["table"])) || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"]))
                                    : ("th" !== t.tag_name && "td" !== t.tag_name) ||
                                      (n = (n = n || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])) || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"])),
                    ...
                    function _(t, e) {
                        ...
                        (this.__patterns = {
                            ...
                            this._options.indent_handlebars &&
                                ((this.__patterns.word = this.__patterns.word.exclude("handlebars")), (this.__patterns.word_control_flow_close_excluded = this.__patterns.word_control_flow_close_excluded.exclude("handlebars"))),
                            (this._unformatted_content_delimiter = null),
                            this._options.unformatted_content_delimiter && ((t = this._input.get_literal_regexp(this._options.unformatted_content_delimiter)), (this.__patterns.unformatted_content_delimiter = e.matching(t).until_after(t)));
                    }
                    var i = n(9).Tokenizer,
                        s = n(9).TOKEN,
                        r = n(13).Directives,
                        ...
                        h = new r(/<\!--/, /-->/);
                    ((_.prototype = new i())._is_comment = function (t) {
                        return !1;
                    }),
                        (_.prototype._is_opening = function (t) {
                            return t.type === p.TAG_OPEN || t.type === p.CONTROL_FLOW_OPEN;
                        }),
                        (_.prototype._is_closing = function (t, e) {
                            return (
                                (t.type === p.TAG_CLOSE && e && (((">" === t.text || "/>" === t.text) && "<" === e.text[0]) || ("}}" === t.text && "{" === e.text[0] && "{" === e.text[1]))) ||
                                (t.type === p.CONTROL_FLOW_CLOSE && "}" === t.text && e.text.endsWith("{"))
                            );
                        }),
                        (_.prototype._reset = function () {
                        ...
                        (_.prototype._get_next_token = function (t, e) {
                            ...
                            return null === n
                                ...
                                : this._read_open_handlebars(n, e) ||
                                      ...
                                      this._read_control_flows(n, e) ||
                                      this._read_raw_content(n, t, e) ||
                                      this._read_content_word(n, e) ||
                        ...
                        (_.prototype._read_comment_or_cdata = function (t) {
                            ...
                            return (
                                "<" === t &&
                                    ("!" === this._input.peek(1) && ((n = this.__patterns.comment.read()) ? (_ = h.get_directives(n)) && "start" === _.ignore && (n += h.readIgnored(this._input)) : (n = this.__patterns.cdata.read())),
                                    n && ((e = this._create_token(p.COMMENT, n)).directives = _)),
                                e
                            );
                        }),
                        (_.prototype._read_processing = function (t) {
                            ...
                            return (
                                "<" === t &&
                                    (n = "!" !== (t = this._input.peek(1)) && "?" !== t ? n : (n = this.__patterns.conditional_comment.read()) || this.__patterns.processing.read()) &&
                        ...
                        (_.prototype._read_open = function (t, e) {
                            var n = null,
                                _ = null;
                            return (
                                (e && e.type !== p.CONTROL_FLOW_OPEN) ||
                                    ("<" === t && ((n = this._input.next()), "/" === this._input.peek() && (n += this._input.next()), (n += this.__patterns.element_name.read()), (_ = this._create_token(p.TAG_OPEN, n)))),
                                _
                            );
                        }),
                            ...
                            return (
                                (e && e.type !== p.CONTROL_FLOW_OPEN) ||
                                    (this._options.indent_handlebars &&
                                        ...
                                        (_ =
                                            "!" === this._input.peek(2)
                                                ? ((n = (n = this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars.read()), this._create_token(p.COMMENT, n))
                                                : ((n = this.__patterns.handlebars_open.read()), this._create_token(p.TAG_OPEN, n)))),
                                _
                            );
                        }),
                        (_.prototype._read_control_flows = function (t, e) {
                            var n = "",
                                _ = null;
                            if (!this._options.templating.includes("angular") || !this._options.indent_handlebars) return _;
                            if ("@" === t) {
                                if ("" === (n = this.__patterns.angular_control_flow_start.read())) return _;
                                for (var i = n.endsWith("(") ? 1 : 0, s = 0; !n.endsWith("{") || i !== s; ) {
                                    var r = this._input.next();
                                    if (null === r) break;
                                    "(" === r ? i++ : ")" === r && s++, (n += r);
                                }
                                _ = this._create_token(p.CONTROL_FLOW_OPEN, n);
                            } else "}" === t && e && e.type === p.CONTROL_FLOW_OPEN && ((n = this._input.next()), (_ = this._create_token(p.CONTROL_FLOW_CLOSE, n)));
                            return _;
                        }),
                            ...
                            return (
                                e &&
                                    ...
                                    ("<" === e.text[0] && (">" === t || ("/" === t && ">" === this._input.peek(1)))
                                        ? ((n = this._input.next()), "/" === t && (n += this._input.next()), (_ = this._create_token(p.TAG_CLOSE, n)))
                                        : "{" === e.text[0] && "}" === t && "}" === this._input.peek(1) && (this._input.next(), this._input.next(), (_ = this._create_token(p.TAG_CLOSE, "}}")))),
                                _
                            );
                        }),
                        (_.prototype._read_attribute = function (t, e, n) {
                            ...
                            return (
                                n &&
                                    "<" === n.text[0] &&
                                    ("=" === t
                                        ? (_ = this._create_token(p.EQUALS, this._input.next()))
                                        : '"' === t || "'" === t
                                        ? ((n = this._input.next()), (n += ('"' === t ? this.__patterns.double_quote : this.__patterns.single_quote).read()), (_ = this._create_token(p.VALUE, n)))
                                        : (t = this.__patterns.attribute.read()) && (_ = e.type === p.EQUALS ? this._create_token(p.VALUE, t) : this._create_token(p.ATTRIBUTE, t))),
                                _
                            );
                        }),
                        ...
                        (_.prototype._read_raw_content = function (t, e, n) {
                            var _ = "";
                            if (n && "{" === n.text[0]) _ = this.__patterns.handlebars_raw_close.read();
                                ...
                                if ("script" === n || "style" === n) {
                                    ...
                                    _ = this._input.readUntil(new RegExp("</" + n + "[\\n\\r\\t ]*?>", "ig"));
                                } else this._is_content_unformatted(n) && (_ = this._input.readUntil(new RegExp("</" + n + "[\\n\\r\\t ]*?>", "ig")));
                            }
                            return _ ? this._create_token(p.TEXT, _) : null;
                        }),
                        (_.prototype._read_content_word = function (t, e) {
                            var n = "";
                            if (
                                (n =
                                    (n = this._options.unformatted_content_delimiter && t === this._options.unformatted_content_delimiter[0] ? this.__patterns.unformatted_content_delimiter.read() : n) ||
                                    (e && e.type === p.CONTROL_FLOW_OPEN ? this.__patterns.word_control_flow_close_excluded : this.__patterns.word).read())
                            )
                                return this._create_token(p.TEXT, n);
                        }),
                        (t.exports.Tokenizer = _),
                        (t.exports.TOKEN = p);
                },
        ...
        var t = (function t(e) {
            ...
            n = i[e] = { exports: {} };
            return _[e](n, n.exports, t), n.exports;
        })(18);
        e = t;
    })();
    var e,
        ...
        ? define(["require", "./beautify", "./beautify-css"], function (t) {
              ...
              return {
                  html_beautify: function (t, e) {
                      return i(t, e, n.js_beautify, _.css_beautify);
                  },
              };
          })
        : "undefined" != typeof exports
        ? ((n = require("./beautify.js")),
          (_ = require("./beautify-css.js")),
