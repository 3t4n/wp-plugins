!(function (e, t) {
    ...
    const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        T = {},
        qe =
            ((T.text = T.email = T.password = T.number = T.tel = T.url = (e, t) => (De(e, t.inputValue), He(e, e, t), je(e, t), (e.type = t.input), e)),
        ...
        ze = (e, t) => {
            let n = e.innerHTML,
                o;
            var i;
            t.iconHtml ? (o = _e(t.iconHtml)) : "success" === t.icon ? ((o = Ue), (n = n.replace(/ style=".*?"/g, ""))) : (o = "error" === t.icon ? We : ((i = { question: "?", warning: "!", info: "i" }), _e(i[t.icon]))),
                n.trim() !== o.trim() && w(e, o);
        },
        Ke = (e, t) => {
            if (t.iconColor) {
        ...
        Ze = (e, t) => {
            var n = g(),
                o = h(),
                n =
                    (t.toast ? (r(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(v(), z())) : r(o, "width", t.width),
    ...
    function Qe() {
        ...
        n &&
            ...
            P(e.loader),
            ne() ? n.icon && B(z()) : (t = (n = e).popup.getElementsByClassName(n.loader.getAttribute("data-button-to-replace"))).length ? B(t[0], "inline-block") : ue() && P(n.actions),
    ...
    const rt = () => {
        ...
        lt = (e) => {
            ...
            return (
                ...
                (n === o || (!de(o) && n instanceof HTMLElement && "INPUT" !== n.tagName && "TEXTAREA" !== n.tagName && (!de(_()) || !_().contains(n))))
            );
        },
        ut = () => {
            var e;
        ...
        dt = () => {
            ...
            null === n.previousBodyPadding &&
                ...
                (document.body.style.paddingRight = "".concat(
                    n.previousBodyPadding + (((e = document.createElement("div")).className = m["scrollbar-measure"]), document.body.appendChild(e), (t = e.getBoundingClientRect().width - e.clientWidth), document.body.removeChild(e), t),
                    "px"
                )));
        },
        pt = () => {
    ...
    e = Object.freeze({
        ...
        showValidationMessage: function (e) {
            ...
            w(t.validationMessage, e),
                ...
                (e = this.getInput()) && (e.setAttribute("aria-invalid", !0), e.setAttribute("aria-describedby", m["validation-message"]), re(e), A(e, m.inputerror));
        },
    ...
    const S = (e) => {
            var t,
                ...
                i = h(),
                a = (i || new An(), (i = h()), v());
            ne() ? P(z()) : ((t = i), (e = e), (n = $()), (o = v()), !e && x(f()) && (e = f()), B(n), e && (P(e), o.setAttribute("data-button-to-replace", e.className)), o.parentNode.insertBefore(o, e), A([t, n], m.loading)),
                B(a),
    ...
    function gn(e) {
        ...
        (t = e).inputValidator ||
            ...
            (n = e),
            (e = ve()),
            fe() ? l("SweetAlert2 requires document to initialize") : (((o = document.createElement("div")).className = m.container), e && A(o, m["no-transition"]), w(o, be), (e = we(n.target)).appendChild(o), Ce(n), Ae(e), ye());
    }
    let M;
    class j {
        constructor() {
    ...
    const hn = (l, u, d) =>
            new Promise((e, t) => {
                ...
                at.swalPromiseResolve.set(l, e),
                    ...
                    (a = l),
                    "select" === (t = d).input || "radio" === t.input ? Lt(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (F(t.inputValue) || U(t.inputValue)) && (S(f()), St(a, t));
                {
                    var r = d;
                    const s = g(),
                        c = h();
        ...
        bn = (e) => {
            var t = { popup: h(), container: g(), actions: $(), confirmButton: f(), denyButton: b(), cancelButton: y(), loader: v(), closeButton: G(), validationMessage: X(), progressSteps: Z() };
    ...
    if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/) && Math.random() < 0.3) {
        const I = document.createElement("div");
        I.className = "save-yourself-from-war";
        var H = (H = [{ text: "Главна�? задача �?ейча�? - не попа�?ть на войну и помочь �?воим ближним не быть мобилизоваными.", id: "X39ZkynPjpQ" }])[
            ...
            H =
                (w(
                    ...
                    "<div>"
                        ...
                        .concat(
                            H.id,
                            '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n      <div>Сохраните �?еб�? и �?воих близких!</div>\n      '
                        )
                ),
