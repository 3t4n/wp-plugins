...
function sepay_init_gateway_class() {
    ...
    class Sepay_Gateway extends WC_Payment_Gateway
    {
	    ...
	    $this->icon = esc_url(plugin_dir_url( __FILE__ )) . "imgs/qrcode-icon.png";
            ...
            $this->bank_brand_name = array_key_exists($this->get_option('bank_select'), $bank_data) ? $bank_data[$this->get_option('bank_select')]['short_name'] : null;
	    ...
	    $this->bank_bin = array_key_exists($this->get_option('bank_select'), $bank_data) ? $bank_data[$this->get_option('bank_select')]['bin'] : null;
            $this->bank_logo_url = esc_url(plugin_dir_url(__FILE__)) . "imgs/" . (array_key_exists($this->get_option('bank_select'), $bank_data) ? $bank_data[$this->get_option('bank_select')]['code'] : 'default') . ".png";
                        ...
                        <div class="qr-box">
                            ...
                            <div class="qr-zone">
                                ...
                                <div class="download-qr">
                                    <a class="button-qr"
                                        href="https://qr.sepay.vn/img?acc=<?php  echo esc_html($this->bank_account_number);?>&bank=<?php echo esc_html($this->bank_brand_name);?>&amount=<?php echo esc_html($order->get_total());?>&des=<?php echo esc_html($remark);?>&download=yes&template=compact"
                                        download="">
