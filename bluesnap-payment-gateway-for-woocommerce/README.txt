...
Tags: WooCommerce, BlueSnap, payment, gateway, Apple Pay, Credit Card, Google Pay, ACH, 3D Secure 
Requires at least: 5.5
Tested up to: 6.7
Requires WooCommerce: 8.5.0
Requires PHP: 7.4
Stable tag: 3.3.0
...
* WooCommerce Subscriptions: 5.0 or later 
...
1. Set up your BlueSnap API Credentials(https://developers.bluesnap.com/v8976-Basics/docs/api-credentials). Make note of your API user key and password; you need them in later steps. 
...
>**Note**: You can find your BlueSnap information (API credentials, Merchant ID, and more) for the following settings in your BlueSnap Merchant Console in **Settings > API Settings**. 
  ...
  * **API User Key and API Password** &mdash; Enter your API User Key and Password for your BlueSnap account. Use your sandbox credentials if you chose Enable Test Mode above. Use your production credentials if you did not chose Enable Test Mode above. 
...
== Changelog ==
= 3.3.0 =
* Updated Hosted Payment Fields from v4 to v5.
* Updated tested up to WooCommerce 9.4.

= 3.2.0 = 
* General improvements and bug fixes.
* Fix - Rounding issues with currencies different than the default one.
* Fix - Issue with the multi-currency shortcode.
* Updated tested up to WordPress v6.7 and WooCommerce 9.3.2.
