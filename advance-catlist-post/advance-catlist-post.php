...
function advance_catlist_post_register_settings() {
    register_setting('advance_catlist_post_settings_group', 'default_number_of_posts', 'intval');
    register_setting('advance_catlist_post_settings_group', 'show_date', 'sanitize_text_field');
    register_setting('advance_catlist_post_settings_group', 'show_new_gif', 'sanitize_text_field');
    register_setting('advance_catlist_post_settings_group', 'new_gif_post_count', 'intval');
}
        ...
        <div class="addons-grid">
            <div class="addon-card">
                <div class="addon-icon" style="display: flex; justify-content: space-between;">
                    <img src="<?php echo esc_url(plugin_dir_url(__FILE__) . 'assets/images/FlexiShare-pro.png'); ?>" alt="FlexiShare Pro">
