...
if ( ! function_exists( 'corner_ad_settings_page_form' ) ) {
	function corner_ad_settings_page_form() {
		...
		if ( isset( $_POST['corner_ad_edition_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['corner_ad_edition_nonce'] ) ), __FILE__ ) ) {
			...
			if ( ! empty( $_POST['corner_ad_name'] ) ) {
				...
				$corner_ad_extra = array(
					...
					'optimized_images'  => ( isset( $_POST['corner_ad_optimized_images'] ) ) ? 1 : 0,
					'fixed'		  => isset( $_POST['corner_ad_fixed_position'] ) ? 1 : 0
				);
		...
		$output .= '              </td>
                                ...
                                <tr valign="top">
									<th>' . esc_html__( 'Optimize the images', 'corner-ad' ) . '</th>
									<td>
										<input aria-label="' . esc_attr__( 'Optimize the images', 'corner-ad' ) . '" type="checkbox" name="corner_ad_optimized_images" ' . ( ( ! isset( $corner_ad_extra['optimized_images'] ) || $corner_ad_extra['optimized_images'] ) ? 'checked' : '' ) . ' />
									</td>
								</tr>
                                <tr valign="top">
                                ...
                                <tr valign="top">
									<th>' . esc_html__( 'Fixed position', 'corner-ad' ) . '</th>
									<td>
										<input aria-label="' . esc_attr__( 'Fixed position', 'corner-ad' ) . '" type="checkbox" name="corner_ad_fixed_position" ' . ( ! empty( $corner_ad_extra['fixed'] )  ? 'checked' : '' ) . ' />
									</td>
								</tr>
                                <tr valign="top">
