...
* Includes a new attribute in the plugin settings to allow loading the original images or optimized ones based on the Ad size.
* Removes deprecated jQuery code.

= 1.2.0 =

* Incorporates the Fixed Position attribute, enabling the element to remain fixed and consistently visible, even during scrolling.