...
/**
 * Displays section for main settings of the plugin
 *
 * @return void
 */
function protect_login_lla_section() {
...
/**
 * Display section for advanced options like Revers proxy.
 *
 * @return void
 */
function protect_login_advanced_option_section() {
...
/**
 * Displays section for setting of minimal password strength
 *
 * @return void
 */
function protect_login_password_section() {
 ...
 * @return void
 */
function protect_login_2fa_section() {
