 ...
 * @param array|bool|int|string $option_value Option value. Must be serializable if non-scalar. Expected to not be SQL-escaped.
 *
 * @return void
 */
function protect_login_update_option_on_mulitsite( string $option_name, $option_value ) {
