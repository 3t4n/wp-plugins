...
define('AFFILIATE_POWER_VERSION', '2.5.0');
...
class Affiliate_Power {
    ...
    static function prepare() {
		...
		self::$lite_optin_html = sprintf(__('<img src="%s" alt="E-Book" style="float:left; width:100px;"><div style="margin-left:120px"><h3>Premium Lite</h3><p>Use Affiliate Power Premium with the permanently free lite version. All you need is your email. The lite version is limited to 100 sales per month. You can always upgrade to an unlimited license.<br><a href="https://www.affiliatepowerplugin.com/premium/" target="_blank">More information about Affiliate Power Premium</a></p><form method="post" target="_blank" action="https://www.affiliatepowerplugin.com/affiliate-power-premium-lite/"><input type="hidden" name="submit_ap_register" value="1"><input type="text" placeholder="email" value="" name="email"> <input class="button-primary" type="submit" value="Use Premium now"></form> </div>', 'affiliate-power'), plugins_url('img/affiliate-power-premium.png', __FILE__));
		self::$lite_optin_html = apply_filters('affiliate_power_lite_optin_text', self::$lite_optin_html);
    }
