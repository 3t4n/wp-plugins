...
class Affiliate_Power_Api_Adcell {
	...
	static public function checkLogin($username, $password) {
		...
		$report_url = 'https://api.adcell.org/api/v2/affiliate/statistic/byCommission?token='.$token.'&startDate='.$StartDate.'&endDate='.$EndDate.'&rows=1&page=1';
	...
	static public function downloadTransactions($fromTS, $tillTS) {
		...
		$json_url = 'https://api.adcell.org/api/v2/affiliate/statistic/byCommission?token='.$token.'&startDate='.$StartDate.'&endDate='.$EndDate.'&rows=1000&page=1';
    ...
    static private function getToken($username, $password) {
        $json_url = 'https://api.adcell.org/api/v2/user/getToken?userName='.$username.'&password='.$password;
