...
Tags: Facebook, Facebook Like Box, Facebook Widget, Social Friends, Social Media, Like box, Facebook, Plugin, Facebook Plugin, Facebook Page Plugin, Crunchify, Crunchify.com
...
Social Friends is a WordPress Social Plugin that enables Facebook Page owners to attract and gain Likes from their own website. This is the simplest way to bring Facebook Page Plugin functionality to WordPress with many more Options like Background color, Border color.
...
> Bug reports for Social Friends are [welcomed on GitHub](https://github.com/Crunchify/Facebook-Members). Please note GitHub is _not_ a support forum and issues that aren't properly qualified as bugs will be closed.
...
4. Configure the options under Admin Panel `Settings -> Social Friends`.
5. Done and Ready.
...
* Please add `<!--social-friends-->` to any page/post under HTML section.

= How can I get Social Friends to blog's sidebar? =
* Go to `Appearance -> Widgets -> Social Friends` and add it into Sidebar.
...
2. Admin Panel: Page/Post Likebox Options
3. Facebook Page likebox on Site Post
4. Widget - only like button
5. Widget - like button with only friends face
6. Widget - like button with friends face and header image
7. Widget - like button with friends face, header image and timeline tab
...
= 7.5 =
* Compatibility with WordPress version 4.9.6

= 7.2 =
* Added Tabs feature: You could specify timeline, events, messages
* Updated Screenshots
