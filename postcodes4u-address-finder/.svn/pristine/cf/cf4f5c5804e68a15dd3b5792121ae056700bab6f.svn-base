<?php
/** POSTCODES4u - Modified Gravity Forms class-gf-fields.php
 * 
 *  Description: Changes class   '$_fields = array();' property from Private to Protected so call can ne inherited from
 *
 *  Modified to Gravity Forms Version 2.5.10 - Checked to 2.9.0
 *   Initially created 2018.05.31
 *   Checked 2024.11.13
 *  KRF 3X Software
 * 
 *************************************************************************************/
...
class GF_Fields {
	...
	/* =============================================================================== */
	/* Postcodes4u Fix - Change '_fields' From Private To Protected - 2018.05.31 */
	//  was... private static $_fields = array();
	//  
