...
class Oxygen {
	...
	public function oxygen_load_scripts() {
		...
		wp_enqueue_script( 'oxygen_js', OXYGEN_PLUGIN_URL . 'js/oxygen.js', array(), false,true);
		wp_enqueue_style( 'oxygen_styles_css', OXYGEN_PLUGIN_URL . 'assets/oxygen_styles.css', array(), null );
    ...
    public function oxygen_load_settings() {
        wp_enqueue_script( 'oxygen_settings_js', OXYGEN_PLUGIN_URL . 'js/oxygen_settings.js', array(),false,true );
	    wp_enqueue_style( 'oxygen_styles_css', OXYGEN_PLUGIN_URL . 'assets/oxygen_styles.css', array(), null );
