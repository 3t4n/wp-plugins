				...
				?>
					<div class="fic-notice notice notice-success is-dismissible">
						...
						<p class="button-group">
							...
							<a href="<?php echo esc_url( admin_url( 'options-writing.php?ben_rating_notice_dismiss=1' ) ); ?>" class="button"><strong>I already did</strong></a>
							<a href="<?php echo esc_url( admin_url( 'options-writing.php?ben_rating_notice_dismiss=1' ) ); ?>" class="button"><strong>Don't show this notice again!</strong></a>
						</p>
					</div>
				<?php
			}
