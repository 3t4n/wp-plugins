	...
	class BEN_Init extends Block_Editor_Navigator {
		...
		public function enqueue_admin_scripts() {
			wp_register_script(
				...
				$this->settings['plugin_url'] . 'assets/dist/js/block-editor-navigator.min.js',
				array(
					'jquery',
					'wp-plugins',
					'wp-edit-post',
			...
			wp_register_style(
				'block-editor-navigator',
				$this->settings['plugin_url'] . 'assets/dist/css/block-editor-navigator.min.css',
				array(),
				'1.0',
				'all'
			);
		...
		public function add_action_links( $links, $file_path ) {
			if ( $file_path === $this->settings['plugin_basename'] ) {
				$links['settings'] = '<a href="' . esc_url( admin_url( 'options-writing.php' ) ) . '">Settings</a>';
						...
						<div class="ben">
							<div class="ben-block-editor-ui">
								...
								<form name="ben-block-editor" id="ben-block-editor" type="post">
									<input type="hidden" name="ben-current-post-type" id="ben-current-post-type" value="<?php echo esc_attr( $post->post_type ); ?>">
									<input type="hidden" name="ben-current-post-id" id="ben-current-post-id" value="<?php echo esc_attr( $post->ID ); ?>">
