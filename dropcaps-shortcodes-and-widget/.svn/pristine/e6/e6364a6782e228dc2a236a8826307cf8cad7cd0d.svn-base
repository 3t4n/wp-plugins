...
if( !function_exists( 'otw_dcsw_init' ) ){
	...
	function otw_dcsw_init(){
		...
		$otw_dcsw_shortcode_object->shortcodes['dropcap'] = array( 'title' => esc_html__('Dropcaps', 'otw_dcsw'),'enabled' => true,'children' => false, 'parent' => false, 'order' => 3,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_dcsw_plugin_url.'include/otw_components/otw_shortcode/', 'dialog_text' => $otw_dcsw_dialog_text  );
...
if( !function_exists( 'otw_dcsw_init_admin_menu' ) ){
	...
	function otw_dcsw_init_admin_menu(){
		...
		add_menu_page(__('Dropcaps Shortcode And Widget', 'otw_dcsw'), esc_html__('Dropcaps Shortcode And Widget', 'otw_dcsw'), 'manage_options', 'otw-dcsw-settings', 'otw_dcsw_settings', $otw_dcsw_plugin_url.'images/otw-sbm-icon.png');
		add_submenu_page( 'otw-dcsw-settings', esc_html__('Settings', 'otw_dcsw'), esc_html__('Settings', 'otw_dcsw'), 'manage_options', 'otw-dcsw-settings', 'otw_dcsw_settings' );
