                ...
                editor.windowManager.open({
                    ...
                    body: [
                        ...
                        },
                        {
                            ...
                            name: 'parameters',
                            label: 'Parameters:',
                            html: linkcentral_tinymce_data.can_use_premium_code__premium_only ? '' : '<a href="admin.php?page=linkcentral-settings#linkcentral-premium" target="_blank" class="linkcentral-premium-tag">Premium</a>',
