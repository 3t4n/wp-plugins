...
class LinkCentral_Post_Type {
    ...
    public function render_meta_box( $post ) {
        ...
        ?></h4>
        <table class="linkcentral-form-table form-table" id="linkcentral-link-attributes">
            <tr>
    ...
    public function render_how_to_use_meta_box( $post ) {
        ...
        */
        ...
        printf( 
            ...
            wp_kses( __( 'Please see the <a href="%s" target="_blank">overview</a> for instructions on how to insert a link into your content.', 'linkcentral' ), array(
                'a' => array(
                    'href'   => array(),
                    'target' => array(),
                ),
            ) ),
            esc_url( admin_url( 'admin.php?page=linkcentral-settings#linkcentral-usage' ) )
         );
        ?>
            </p>
        </div>
