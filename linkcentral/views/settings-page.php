...
?>
                ...
                <tr class="linkcentral-configure-row linkcentral-configure-row-first" data-parent="ga4">
                    <th scope="row">
...
?></a>
                ...
                <tr class="linkcentral-configure-row linkcentral-configure-row-last" data-parent="ga4">
                    <th scope="row">
...
?></a></li>
                            ...
                            <hr>
                            <a class="linkcentral-buy-now" href="https://www.designforwp.com/linkcentral" target="_blank" rel="noopener noreferrer"><?php 
