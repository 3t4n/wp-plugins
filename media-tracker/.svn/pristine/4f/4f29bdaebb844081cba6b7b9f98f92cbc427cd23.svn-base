...
Tags: tracker, unused, media cleaner, duplicate
...
**🔥 Cleaner: Find media files that are not in use on any posts, pages, or other content. This feature helps you keep your site clutter-free by highlighting files that can be safely removed.
...
== Screenshots ==
1. Example of media tracking report.
2. Unused media cleaner interface.
3. Find dupliacte image
