...
Donate link:
Tags: product table, wc product table, quick order table, woocommerce product table, wc table view, woocommerce
Requires at least: 4.9
Tested up to: 6.7
Stable tag: 1.2.4

== Description ==
WooCommerce Product Table plugin helps you to showcase the products in a table layout. Gone are those days where the default grid layouts ruled WooCommerce stores. The WooCommerce product tables plugin makes the tables easily responsive and customizable to be integrated with a simple shortcode.
...
[youtube https://www.youtube.com/watch?v=66dOCsIt3eE&rel=0]
...
🔗 [Backend Demo](https://wpt-free.demo2.acowebs.com/wp-admin/admin.php?page=awcpt_admin_ui#/) (Check out how the plugin works in the front-end website)
🔗 [Frontend Demo](https://wpt-free.demo2.acowebs.com/) (Watch out how the plugin works in back-end)
...
🔗 [Backend Demo](https://wpt.demo2.acowebs.com/wp-admin/admin.php?page=awcpt_admin_ui#/) (Check out how the plugin works in the front-end website)
🔗 [Frontend Demo](https://wpt.demo2.acowebs.com/) (Watch out how the plugin works in back-end)

== Why Acowebs? ==
Acowebs has the expert team who delivers WordPress and Shopify plugins to the customers with end-to-end approach in enhancing the User experience. Our Shopify and WordPress developers have in-depth experience in contributing the users with the WooCommerce plugins that have high-end competitive edge.  We develop amazing WooCommerce and WordPress plugins at your ease and ensure they offer unparalleled Customer experience. Since we are an award-winning software development company, we focus to fuel your WooCommerce stores with stunning plugins. Our solutions hold the strength and support of 50,000 + users and the services spread across 130+ countries. 
...
== OTHER USEFUL LINKS == 
🔹 [Find all PRO features](https://acowebs.com/woocommerce-product-table/)
🔹 [Find Our Other Plugins](https://profiles.wordpress.org/acowebs/#content-plugins).
...
3.  Add New Table
4.  Add New Column
5.  Edit Column Properties
6.  Table Basic Configurations
7.  Table Filters
8.  Add New Table Filter
9.  Edit Table Filter
10. Table Design Settings
11. Table Column Responsive Settings
12. Custom CSS
...
* WooCommerce 8.5.x Support
= 1.2.3 =
* WordPress 6.4.x Support
* WooCommerce 8.4.x Support
= 1.2.2 =
...
= 1.0.9 =
* WooCommerce 6.1.x and 6.2.x Support
= 1.0.8 =
* WooCommerce 5.9.x and 6.0.x Support
