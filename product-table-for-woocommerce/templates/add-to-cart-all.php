...
$gcart_btn_html .= '<input type="checkbox" name="awcpt_cartall_checkbox"  id="awcpt-cart-all-checkbox-' . esc_attr($table_id) . '" class="awcpt-universal-checkbox awcpt-cart-all-checkbox" />';
