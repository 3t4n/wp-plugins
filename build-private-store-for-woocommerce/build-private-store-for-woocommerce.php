...
include_once('main/backend/bpsfw-backend-action.php');
include_once('main/backend/bpsfw-user-table-column.php');
include_once('main/backend/bpsfw-userlist.php');
include_once('main/backend/bpsfw-userlist-action.php');

include_once('main/frontend/bpsfw-frontend.php');
include_once('main/frontend/bpsfw-frontend-validation.php');
include_once('main/frontend/bpsfw-frontend-comman.php');
...
function BPSFWP_support_and_rating_links( $links_array, $plugin_file_name, $plugin_data, $status ) {
...
add_filter( 'plugin_row_meta', 'BPSFWP_support_and_rating_links', 10, 4 );