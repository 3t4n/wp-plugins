...
class Terms_Popup_On_User_Login_User_Edit {
    ...
    function show_user_profile_accepted_field($user) {
        ...
        $user_accepted_check = $user_state_manager->has_accepted_terms_atsomepoint();
        $user_accepted_token = $user_state_manager->get_visitor_token();
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <label for="tpul_user_accepted_checkbox"><?php _e("User Accepted Terms at some point", 'terms-popup-on-user-login'); ?></label>
                    <br />
            ...
            <tr>
                ...
                <td>
                    ...
                    <label for="tpul_user_accepted_latest_checkbox"><?php _e("User Accepted Latest Terms", 'terms-popup-on-user-login'); ?></label>
                    <br />
            ...
            <tr>
                <th><label for="tpul_user_accept_token"><?php _e("User Accepted Proof Token for Latest Terms", 'terms-popup-on-user-login'); ?></label></th>
                <td>
                    <?php if ($this->license_is_active) : ?>
                        <input size="100" class="tpul_user_accept_token" type="text" id="tpul_user_accept_token" name="tpul_user_accept_token" aria-describedby="tpul_user_accept_token_desc" value="<?php echo $user_accepted_token; ?>" disabled>
                        <br />
                    <?php endif; ?>
                    <p class="description">
                        <?php
                        ...
                        if (!$this->license_is_active) {
                            _e(' This is a premium feature. This is a token saved on the user\'s browser and on your website as proof. It is stored when a user accepted your TOS before he logged in, ie: at checkout or on the login page. ', 'terms-popup-on-user-login');
                            echo ' <a href="/wp-admin/options-general.php?page=terms_popup_on_user_login_options&tab=general_options">';
                            _e('Activate Key.', 'terms-popup-on-user-login');
                            echo "</a>";
                        } else {
                            _e("This is a token saved on the user's browser and on your website as proof. It is stored when a user accepted your TOS before he logged in, ie: at checkout or on the login page.", 'terms-popup-on-user-login');
                        }
                        ?>
                    </p>
                </td>
