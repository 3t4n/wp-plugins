    ...
    public function expost_log_CSV($generate_file_type = "report") {
        ...
        if ($generate_file_type == "report") {
            ...
            foreach ($users as $user) {
                ...
                $user_accepted_terms  = $user_state_manager->did_user_accept();
                ...
                if (!empty($user_accepted_terms)) {
                    ...
                    } elseif ($user_accepted_terms == -2) {
                        $values['Latest_Terms_Accepted'] =  "latest terms declined";
                    } elseif ($user_accepted_terms == -1) {
                        $values['Latest_Terms_Accepted'] =  "terms declined";
                    } elseif ($user_accepted_terms == 1) {
                        $values['Latest_Terms_Accepted'] =  "terms were reset after acceptance";
                    } else {
                        $values['Latest_Terms_Accepted'] =  "";
                    }
