...
class TPUL_Modal_Options {
    ...
    public function get_content_from_url() {
        if (!empty($this->options['terms_modal_content_from_url'])) {
            return $this->options['terms_modal_content_from_url'];
        }
        return '';
    }

    public function get_loginpage_paths() {
        if (!empty($this->options['terms_modal_loginpage_paths'])) {
            return $this->options['terms_modal_loginpage_paths'];
        }
        return '';
    }

    public function get_customurl_paths() {
        if (!empty($this->options['terms_modal_customurls'])) {
            return $this->options['terms_modal_customurls'];
        }
        return '';
    }
    ...
    public function get_font_size() {
        if (!empty($this->options['terms_modal_font_size'])) {
            return $this->options['terms_modal_font_size'];
        }
        return '';
    }

    public function get_asset_placement() {
        if (!empty($this->options['terms_modal_asset_placement'])) {
            return $this->options['terms_modal_asset_placement'];
        }
        return '';
    }

    public function get_terms_modal_pageid() {
        if (!empty($this->options['terms_modal_pageid'])) {
            return $this->options['terms_modal_pageid'];
        }
        return '';
    }

    public function get_terms_version() {
        if (!empty($this->options['terms_modal_version'])) {
            return $this->options['terms_modal_version'];
        }
        return '';
    }

    public function is_show_on_every_login() {
        if (!empty($this->options['terms_modal_show_every_login'])) {
            return true;
        }
        return false;
    }
