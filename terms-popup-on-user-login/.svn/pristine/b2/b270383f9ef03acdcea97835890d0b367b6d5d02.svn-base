...
class Terms_Popup_On_User_Utils {
    ...
    function tpul_add_settings_link($links) {
        $settings_link = '<a href="/wp-admin/options-general.php?page=terms_popup_on_user_login_options">' . __('Settings', 'terms-popup-on-user-login') . '</a>';
