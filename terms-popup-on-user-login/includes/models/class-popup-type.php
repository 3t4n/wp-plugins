...
class TPUL_Popup_Type {
    ...
    private $all_popup_types = [
        ...
        'terms_and_conditions_modal_customurl',
    ...
    public function is_modal_on() {
        ...
        if (
            ...
            ($this->popup_type == 'terms_and_conditions_modal_customurl') ||
    ...
    public function is_modal_customurl() {

        if ($this->popup_type == 'terms_and_conditions_modal_customurl') {
            return true;
        }
        return false;
    }
