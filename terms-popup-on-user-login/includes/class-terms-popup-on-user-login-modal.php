...
class Terms_Popup_On_User_Login_Modal {
    ...
    public function insert_modal_must_accept_terms() {
        ...
        echo "<div class='ftlp_modal modal micromodal-slide' id='modal-accept-terms' aria-hidden='true'>";
        ...
        echo TPUL_Terms_Content_Service::get_the_default_terms_content(true);
         ...
         */
        if (
            $this->popup_type->is_login_modal() ||
        ...
        if ($this->popup_type->is_woo_modal()) {
            ...
            $data_attribtes = [
                $data_logout,
                $data_decline_url, //$data_accept_url, 
            ];
    ...
    function add_slug_body_class($classes) {
        ...
        /**
         * Add class if user accepted terms
         */
        ...
        if (!empty($user_id)) {
            ...
            if ($did_user_accept) {
                $classes[] = 'tpulUserAcceptedTerms';
            } else {
                $classes[] = 'tpulUserDidNotAcceptTerms';
            }
        }
    ...
    function add_admin_slug_body_class($classes) {
    ...
    function location_tracking_body_class($classes) {
        ...
        if ($gen_options->get_track_location()) {
            // check if calsses is string or array
            if (is_array($classes)) {
    ...
    private function __get_body_allowed_html() {
        ...
        $allowed_tags = TPUL_Terms_Content_Service::__get_body_allowed_html();
    ...
    function __get_body_class_to_add() {
        ...
        if (!isset($this->generals_options['modal_to_show'])) {
            return '';
        }
        ...
        switch ($this->generals_options['modal_to_show']) {
            ...
            case 'terms_and_conditions_modal_include_admin':
                return 'terms-popup-on-user-login-accept-terms-include-admin';
                break;
            ...
            case 'terms_and_conditions_modal_onloginpage':
                return 'terms-popup-on-loginpage';
                break;

            case 'terms_and_conditions_modal_anypageeveryone':
                return 'terms-popup-on-any-page-everyone';
                break;

            case 'terms_and_conditions_modal_customurl':
                return 'terms-popup-on-customurl';
                break;
