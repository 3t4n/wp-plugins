...
use MuzaPayDeps\Swift_Message;
use MuzaPayDeps\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\MuzaPayDeps\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
