...
use MuzaPayDeps\Monolog\Formatter\LineFormatter;
use MuzaPayDeps\Monolog\Formatter\FormatterInterface;
use MuzaPayDeps\Monolog\Logger;
use MuzaPayDeps\Monolog\Utils;
use MuzaPayDeps\PhpConsole\Connector;
use MuzaPayDeps\PhpConsole\Handler as VendorPhpConsoleHandler;
use MuzaPayDeps\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('MuzaPayDeps\PhpConsole\Connector')) {
