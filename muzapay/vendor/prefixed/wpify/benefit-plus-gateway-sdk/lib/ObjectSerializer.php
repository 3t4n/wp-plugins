...
use MuzaPayDeps\GuzzleHttp\Psr7\Utils;
use MuzaPayDeps\BenefitPlusGatewaySdk\Model\ModelInterface;
/**
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\BenefitPlusGatewaySdk\Model\\' . $data->{$discriminator};
    ...
    {
        return \MuzaPayDeps\GuzzleHttp\Psr7\Query::build($data, $encoding_type);
    }
}
