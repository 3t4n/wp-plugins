...
namespace MuzaPayDeps\Wpify\CustomFields\Implementations;

use WP_Query;
use WP_Screen;
use MuzaPayDeps\Wpify\CustomFields\Api;
use MuzaPayDeps\Wpify\CustomFields\Helpers;
use MuzaPayDeps\Wpify\CustomFields\Parser;
use MuzaPayDeps\Wpify\CustomFields\Sanitizer;
    ...
    private function normalize_item(array $args = array())
    {
        ...
        if (!empty($args['post_type'])) {
            ...
            foreach ($args['post_type'] as $post_type) {
                ...
                $post_type_names[] = empty($post_type->labels->singular_name) ? __('Item', 'muzapay') : $post_type->labels->singular_name;
            }
