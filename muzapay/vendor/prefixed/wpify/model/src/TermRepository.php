...
class TermRepository extends Repository
{
    ...
    {
        $args = array_merge(array('hide_empty' => \true), $args);
        return $this->find($args);
    }
    /**
    ...
    {
        return $this->find(array('taxonomy' => $model->taxonomy ?? $this->taxonomy(), 'hierarchical' => \true, 'hide_empty' => \false, 'child_of' => $model->id));
    }
    /**
    ...
    {
        return $this->find(array_merge($args, array('include' => $ids)));
    }
}
