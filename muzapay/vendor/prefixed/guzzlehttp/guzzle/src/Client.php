...
namespace MuzaPayDeps\GuzzleHttp;

use MuzaPayDeps\GuzzleHttp\Cookie\CookieJar;
use MuzaPayDeps\GuzzleHttp\Exception\GuzzleException;
use MuzaPayDeps\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \MuzaPayDeps\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
