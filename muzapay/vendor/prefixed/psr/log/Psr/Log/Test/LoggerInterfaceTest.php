...
namespace MuzaPayDeps\Psr\Log\Test;

use MuzaPayDeps\Psr\Log\LoggerInterface;
use MuzaPayDeps\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('MuzaPayDeps\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('MuzaPayDeps\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('MuzaPayDeps\Psr\Log\Test\DummyTest', array('__toString'));
        }
