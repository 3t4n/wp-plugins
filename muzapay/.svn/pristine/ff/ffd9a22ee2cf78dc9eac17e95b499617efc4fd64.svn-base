...
use MuzaPayDeps\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use MuzaPayDeps\Monolog\Logger;
use MuzaPayDeps\Monolog\Formatter\FormatterInterface;
use MuzaPayDeps\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use MuzaPayDeps\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use MuzaPayDeps\Elasticsearch\Client;
use MuzaPayDeps\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use MuzaPayDeps\Elastic\Elasticsearch\Client as Client8;
/**
