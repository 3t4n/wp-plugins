...
class Config extends Module {
	...
	function __construct() {
		...
		$this->email_notifications = apply_filters( 'amem/email/notifications', array(
			'welcome_email' => array(
				...
				'body'          => 'Hi {display_name},<br /><br />' .
													 ...
													 'Thanks,<br />' .
													 '{site_name}',
				'description'   => __('Whether to send the user an email when his account is automatically approved', 'advanced-members'),
				'recipient'   	=> 'user',
				'default_active' => true
			),
			'checkmail_email' => array(
				...
				'body'          => 'Hi {display_name},<br /><br />' .
													 ...
													 'Thanks, <br />' .
													 '{site_name}',
				'description'   => __('Send the user an email when his account needs e-mail activation. (This option always on)', 'advanced-members'),
				'recipient'   	=> 'user',
				'default_active' => true,
				'force_active' 	=> true,
			),
			'deletion_email' => array(
				...
				'body'          => 'Hi {display_name},<br /><br />' .
													 ...
													 'Thanks,<br />' .
													 '{site_name}',
				'description'   => __('Whether to send the user an email when his account is deleted', 'advanced-members'),
				'recipient'   => 'user',
				'default_active' => true
			),
			'resetpw_email' => array(
				...
				'body'          => 'Hi {display_name},<br /><br />' .
													 ...
													 'Thanks,<br />' .
													 '{site_name}',
				'description'   => __('Send an email when users changed their password (This option always on)', 'advanced-members'),
				'recipient'   => 'user',
				'default_active' => true,
				'force_active' 	=> true,
			),
			'changedpw_email' => array(
				...
				'body'          => 'Hi {display_name},<br /><br />' .
													 ...
													 'Thanks,<br />' .
													 '{site_name}',
				'description'   => __('Whether to send the user an email when he requests to reset password (Recommended, please keep on)', 'advanced-members'),
				'recipient'   => 'user',
				'default_active' => true,
			),
			// Disabled
			...
			// 										 'Thanks,<br />' .
			// 										 '{site_name}',
			// 	'description'   => __('Whether to send the user an email when he updated their account', 'advanced-members'),
			// 	'recipient'     => 'user',
			// 	'default_active'=> true
			// ),
		...
		$this->amem_default_form_meta = array(
			'register' 	=> array(
				...
				'amem_form_select_type' => 'registration',
				'amem_form_regist_role' => 'subscriber',
				'amem_form_regist_status' => 'approve',
				'amem_form_after_registration' => 'redirect_home',
				'amem_form_description' => '',
				'amem_core_form' => 'register',
				'amem_form_num_of_submissions' => 0,
				'form_num_of_views' => 0
			),
			'login' 		=> array(
				'form_key' => 'form_' . uniqid(),
				'amem_form_select_type' => 'login',
				'amem_form_after_login' => 'redirect_home',
				'amem_form_description' => '',
		...
		$this->amem_default_fields = array(
			'register' => array(
				array(
					...
					'type'		=> 'username',
					'content' => 'a:12:{s:10:"aria-label";s:0:"";s:4:"type";s:8:"username";s:12:"instructions";s:0:"";s:8:"required";i:0;s:17:"conditional_logic";i:0;s:7:"wrapper";a:3:{s:5:"width";s:0:"";s:5:"class";s:0:"";s:2:"id";s:0:"";}s:13:"default_value";s:0:"";s:10:"allow_edit";i:0;s:9:"maxlength";s:0:"";s:11:"placeholder";s:2:"ID";s:7:"prepend";s:0:"";s:6:"append";s:0:"";}',
				),
				array(
				...
				array(
					...
					'type'		=> 'user_email',
					'content' => 'a:11:{s:10:"aria-label";s:0:"";s:4:"type";s:10:"user_email";s:12:"instructions";s:0:"";s:8:"required";i:0;s:17:"conditional_logic";i:0;s:7:"wrapper";a:3:{s:5:"width";s:0:"";s:5:"class";s:0:"";s:2:"id";s:0:"";}s:13:"default_value";s:0:"";s:15:"set_as_username";i:0;s:11:"placeholder";s:19:"Your E-mail Address";s:7:"prepend";s:0:"";s:6:"append";s:0:"";}',
				),
			),
			'login'	=> array(
				array(
		...
		$this->core_pages = array(
			'register' => array( 'label' => __( 'User Registration', 'advanced-members' )),
			'login' => array( 'label' => __( 'User Login', 'advanced-members' )),
	...
	function get_core_pages() {
		if ( !did_action( 'amem/core/pages' ) )// prevent duplicates
