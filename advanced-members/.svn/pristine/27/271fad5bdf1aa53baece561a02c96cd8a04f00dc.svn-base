...
class Blocks extends Module {
	...
	public function register_blocks() {
		...
		$file = amem_get_path('assets/build/blocks/blocks/form') . '/block.json';

		register_block_type(
			amem_get_path('assets/build/blocks/blocks/form'),
			array(
		...
		return array_merge(
			array(
				array(
					...
					'title' => __( 'Advanced Members for ACF Blocks', 'advanced-members' ),
				),
			),
			$categories
		);
	...
	function block_editor_assets() {
		...
		$assets_file = amem_get_path('assets/build/blocks/blocks.asset.php');
		...
		$assets =
			...
			: [
				...
				'version' => filemtime( amem_get_path('assets/build/blocks/blocks.js') ),
			];

		wp_enqueue_script(
			'amemblocks',
			amem_get_url('assets/build/blocks/blocks.js'),
			$assets['dependencies'],
			$assets['version'],
			true
		);
		...
		// wp_enqueue_style(
		// 	'amemblocks',
		// 	amem_get_url('assets/build/blocks/blocks.css)',
		// 	array( 'wp-edit-blocks' ),
		// 	filemtime( amem_get_path('assets/build/blocks/blocks.css') )
		// );
