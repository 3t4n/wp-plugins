...
if ( ! class_exists( 'AMem\Files' ) ) {
	...
	class Files extends Module {
		...
		function setup_paths() {
			...
			$this->upload_basedir = $this->upload_dir['basedir'] . '/advanced-members/';
			$this->upload_baseurl = $this->upload_dir['baseurl'] . '/advanced-members/';
		...
		function is_temp_upload( $url ) {
			...
			$url = explode( '/advanced-members/temp/', $url );
			if ( isset( $url[1] ) ) {
