...
class PasswordReset extends Module {
	...
	function messages($messages) {
		$errors = [
			...
			'pwreset_password_changed' => __( 'You have successfully changed password.', 'advanced-members' ),
			...
			'pwreset_unkownerror' => __( 'Unknown error occured while reset password. Please request a new link below.', 'advanced-members' ),
		];
