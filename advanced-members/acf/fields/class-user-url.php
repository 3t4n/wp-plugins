...
class amem_field_user_url extends amem_field_url {
	...
	function initialize() {
		// vars
		$this->name       = 'user_url';
		$this->label      = __( 'Website (Members)', 'advanced-members' );
		$this->category = 'Members';
		$this->description = __( 'Website url of user. Synced to `url` user meta.', 'advanced-members' );
		$this->preview_image = amem_get_url('/assets/images/field-type-previews/field-preview-url.png');
		$this->defaults   = array(
			'default_value' => '',
			'placeholder'   => '',
			'prepend'       => '',
