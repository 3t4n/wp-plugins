...
<div class="advanced-members-field">
	...
	acf_render_field_wrap(
		array(
			...
			'instructions' => __( "Set the name that appears from the text. By default, this will be the name of your WordPress site.", 'advanced-members' ),
		),
		'div',
		'field'
	);
	...
	acf_render_field_wrap(
		array(
			...
			'instructions' => __( 'Set email activation link expiry time limit in days.', 'advanced-members' ),
			'default_value' => '1',
			'ui'           => 1,
		),
		'div'
