...
class wpda_contdown_extend_popup_page {
    ...
    public function controller_page() {
		...
		<script>
			...
			var countdown_extended_plugin_url="<?php echo esc_url(wpda_contdown_extend_plugin_url); ?>";
		...
		<div id="countdown_extended_enable" class="field switch">
			<label for="radio1" class="cb-enable <?php if ($enable_disable == 'on') {
            echo 'selected';
        }
        ?>"><span>Enable</span></label>
			<label for="radio2" class="cb-disable <?php if ($enable_disable == 'off') {
            echo 'selected';
        }
