...
class wpdevart_countdown_extend_frontend {
	...
	public function include_scripts() {
		...
		wp_enqueue_script('wpdevart_countdown_extendex_standart', esc_url(wpda_contdown_extend_plugin_url) . 'includes/frontend/js/front_timer.js');
		wp_enqueue_style('FontAwesome');
		wp_enqueue_style('wpdevart_countdown_extend_front', esc_url(wpda_contdown_extend_plugin_url) . 'includes/frontend/css/front_end.css');
	}
