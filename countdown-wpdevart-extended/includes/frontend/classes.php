...
class wpdevart_countdown_forntend_stanadart_view extends wpdevart_countdown_forntend_main {
	...
	public function create_countdown() {
		...
		$params_array["top_html_text"] = isset($this->timer["top_countdown_show_html"]) ? wp_kses_post($this->timer["top_countdown_show_html"]) : '';
		$params_array["bottom_html_text"] = isset($this->timer["bottom_countdown_show_html"]) ? wp_kses_post($this->timer["bottom_countdown_show_html"]) : '';
