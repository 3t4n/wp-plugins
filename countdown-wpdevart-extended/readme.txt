...
Donate link: https://wpdevart.com/wordpress-countdown-extended-version/
Tags: countdown, countdown widget, countdown timer,  WooCommerce countdown, WooCommerce Sales Countdown
...
WordPress Countdown and CountUp, WooCommerce Sales Timer plugin is a great tool. You can easily create countdown and countup timers for WordPress your website. 

== Description ==

https://www.youtube.com/watch?v=1zaWuLZaWCc
...
*   [Extended version Demo](https://demo.wpdevart.com/countdown-extended)
...
You can upgrade the plugin to [Countdown Extended Pro](https://wpdevart.com/wordpress-countdown-extended-version/) to add some features.
...
### If you found any bug in our plugin or have a question contact us using the [support forum](https://wordpress.org/support/plugin/countdown-wpdevart-extended/).
...
https://www.youtube.com/watch?v=tLD86mWLJJI

https://www.youtube.com/watch?v=72Qg8sUulSk

https://www.youtube.com/watch?v=d9QExKb8x5g
...
https://www.youtube.com/watch?v=xvR4UuS3egU
...
*  New plugin added to the list from the admin menu.
...
*  Added new featured plugin in admin menu.

= 1.3.8 =

*  Added Romanian translation files.

= 1.3.9 =

*  Changed the icons for the following featured plugins - lightbox, gallery.

= 1.4.0 =

*  Added new design for the featured plugins page.
...
*  Added new language - Finnish.

= 1.4.7 =

*  Added new language - Welsh.

= 1.4.8 =

*  Added new language - Hawaiian.

= 1.4.9 =

*  Changed the title style of the admin page.

= 1.5.0 =

*  Added new language - Bengali.

= 1.5.1 =

*  Added new language - Latvian.
...
*  Edited list of recommended plugins.
