(function (blocks, element) {
    ...
    var icon_iamge = el("img", {
        width: 24,
        height: 24,
        src: window["wpda_countdown_extended_gutenberg"]["other_data"][
            "icon_src"
        ],
    ...
    blocks.registerBlockType("wpdevart-countdownextended/countdown-extended", {
        ...
        edit: function (props) {
            ...
            var timer_options = new Array(),
                theme_options = new Array();
            ...
            for (var key in wpda_countdown_extended_gutenberg["timers"]) {
                ...
                timer_options.push(
                    el(
                        "option",
                        { value: "" + key + "", selected: selected_option },
                        wpda_countdown_extended_gutenberg["timers"][key]
                    )
                );
            }
            for (var key in wpda_countdown_extended_gutenberg["themes"]) {
                ...
                theme_options.push(
                    el(
                        "option",
                        { value: "" + key + "", selected: selected_option },
                        wpda_countdown_extended_gutenberg["themes"][key]
                    )
                );
            }
            ...
            return el(
                ...
                el(
                    "div",
                    { className: "wpdevart_gutenberg_timer_main_div" },
                    ...
                    el(
                        "select",
                        {
                            className: "wpdevart_gutenberg_timer_css",
                            onChange: function (value) {
                                var select = value.target;
                                props.setAttributes({
                                    timer: select.options[select.selectedIndex]
                                        .value,
                                });
                            },
                        },
                    ...
                    el(
                        "select",
                        {
                            className: "wpdevart_gutenberg_theme_css",
                            onChange: function (value) {
                                var select = value.target;
                                props.setAttributes({
                                    theme: select.options[select.selectedIndex]
                                        .value,
                                });
                            },
                        },
        ...
        save: function (props) {
            return (
                "[wpda_contdown_extend timer_id=" +
                props.attributes.timer +
                "  theme_id=" +
