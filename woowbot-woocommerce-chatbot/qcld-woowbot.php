...
define('QCLD_WOOCHATBOT_VERSION', '4.0.6');
...
class QCLD_Woo_Chatbot
{
    ...
    public function qc_woowbot_promotion_notice(){
        ...
        $promotion_img = QCLD_WOOCHATBOT_IMG_URL . "/newyear24-woowbot.jpg";
        ?>
        <div id="promotion-wpchatbots" data-dismiss-type="qcbot-feedback-notice" class="notice is-dismissible qcbot-feedback" style="background: #e80607">
            <div class="">
    ...
    public function qcld_woo_chatbot_frontend_scripts(){
        ...
        if(get_option('woo_chatbot_icon') != 'custom.png'){ 
            $chatbot_icon = QCLD_WOOCHATBOT_IMG_URL . '/' . get_option('woo_chatbot_icon') ; 
        }else{
            $chatbot_icon = ((!empty(get_option('wp_chatbot_custom_icon_path'))) && !is_404(get_option('wp_chatbot_custom_icon_path'))) ? get_option('wp_chatbot_custom_icon_path') : QCLD_WOOCHATBOT_IMG_URL . '/icon-0.png';
        }
