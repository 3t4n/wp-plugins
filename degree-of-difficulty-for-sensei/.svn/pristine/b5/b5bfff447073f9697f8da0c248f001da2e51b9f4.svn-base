...
add_action( 'plugins_loaded', 'dds_wp_term_images' );
 ...
 * @since 0.2.0
 */
function dds_wp_term_images_init() {
	new DDS_WP_Term_Images( __FILE__ );
}
add_action( 'init', 'dds_wp_term_images_init', 88 );
