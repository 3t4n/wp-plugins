...
if ( function_exists( 'add_term_meta' ) && ! class_exists( 'DDS_WP_Term_Meta_UI' ) ) :
/**
...
class DDS_WP_Term_Meta_UI {
	...
	public function __construct( $file = '' ) {
		...
		if ( empty( $this->taxonomies ) ) {
			// Limit to Difficulty taxonomy.
			// $this->taxonomies = $this->get_taxonomies();
			$this->taxonomies = array( Degree_of_Difficulty_for_Sensei()->slug );
		}
