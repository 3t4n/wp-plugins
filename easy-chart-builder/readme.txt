...
= 1.4 =
Fixed sort ordering of labels in legend for horizontal bar charts

= 1.3 =
added new attribute for placing currency text to right of value: currencyright.  Defaults to "false", so just add currencyright="true"
