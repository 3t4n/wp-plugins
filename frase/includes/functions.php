...
if ( ! function_exists( 'frase_plugin_default_options' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_default_options() {
		$default_theme_options = array(
			'setting1'  => esc_html__( 'Default Setting 1', 'frase' ),
			'setting2'  => esc_html__( 'Default Setting 2', 'frase' ),
			'setting3'  => false,
			'setting4'  => true,
			'setting5'  => 'option-1',
			'deleteAll' => false,
		...
		return apply_filters( 'frase_plugin_default_options', $default_theme_options );
	}
endif;

if ( ! function_exists( 'frase_plugin_get_options' ) ) :
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_get_options( $key = '' ) {
		$options = get_option( FRASE_PLUGIN_OPTION_NAME );

		$default_options = frase_plugin_default_options();
...
if ( ! function_exists( 'frase_plugin_update_options' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_update_options( $key_or_data, $val = '' ) {
		if ( is_string( $key_or_data ) ) {
			$options                 = frase_plugin_get_options();
			$options[ $key_or_data ] = $val;
		} else {
			$options = $key_or_data;
		}
		update_option( FRASE_PLUGIN_OPTION_NAME, $options );
	}
endif;


if ( ! function_exists( 'frase_plugin_file_system' ) ) {
	/**
	 *
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_file_system() {
...
if ( ! function_exists( 'frase_plugin_parse_changelog' ) ) {
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_parse_changelog() {

		$wp_filesystem = frase_plugin_file_system();

		$changelog_file = apply_filters( 'frase_plugin_changelog_file', FRASE_PLUGIN_PATH . 'readme.txt' );
...
if ( ! function_exists( 'frase_plugin_get_white_label' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function frase_plugin_get_white_label( $key = '' ) {
		$plugin_name = apply_filters(
			'frase_plugin_white_label_plugin_name',
			esc_html__( 'Frase', 'frase' )
		);

		$options = apply_filters(
			'frase_plugin_white_label',
			array(
				/*
				'admin_menu_page' => array(
					'page_title' => esc_html__( 'Frase Settings Page', 'frase' ),
					'menu_title' => esc_html__( 'Frase Settings', 'frase' ),
					'menu_slug'  => FRASE_PLUGIN_PLUGIN_NAME,
					'icon_url'   => FRASE_PLUGIN_URL . 'assets/img/logo-20.png',
					'position'   => null,
				),*/
				'dashboard'       => array(
					'logo'   => FRASE_PLUGIN_URL . 'assets/img/logo.png',
					'notice' => sprintf(
						/* translators: %s is the plugin name */
						esc_html__(
							'Congratulations on choosing the %s.',
							'frase'
						),
						$plugin_name
					),
				...
				'landingPage'     => array(
					'banner'        => array(
						...
						'leadText'   => sprintf(
							/* translators: %s is the plugin name */
							esc_html__(
								'Congratulations! You have successfully installed %s',
								'frase'
							),
							$plugin_name
						),
						'normalText' => sprintf(
							/* translators: %s is the plugin name */
							esc_html__(
								'If you have any questions or need assistance, please do not hesitate to contact us for support.',
								'frase'
							),
							$plugin_name,
						),
						'buttons'    => array(
							array(
								...
								'text'    => esc_html__( 'Get support', 'frase' ),
								'url'     => 'https://help.frase.io',
								'variant' => 'primary',
							)
						),
						'image'      => FRASE_PLUGIN_URL . 'assets/img/featured-image.png',
					...
					'identity'      => array(
						...
						'buttons' => array(
							array(
								'text'    => esc_html__( 'Visit site', 'frase' ),
								'url'     => 'https://frase.io',
								'variant' => 'primary',
							),
							array(
					...
					'contact'       => array(
						'title'  => esc_html__( 'Contact Information', 'frase' ),
						'info'   => array(
							array(
								...
								'title'   => esc_html__( 'Support', 'frase' ),
								'text'    => esc_html__( 'Get Support', 'frase' ),
								'url'     => 'https://help.frase.io',
								'variant' => 'link',
							),
							array(
								...
								'title'   => esc_html__( 'Contact', 'frase' ),
								'text'    => esc_html__( 'Contact Us', 'frase' ),
								'url'     => 'https://frase.io/contact-us/',
								'variant' => 'link',
							),
							array(
								...
								'title' => esc_html__( 'Location', 'frase' ),
								'text'  => esc_html__( 'Birmingham, AL', 'frase' ),
							),
						),
						'social' => array(
							/*array(
					...
					'bannerColumns' => array(
						/*array(
							...
							'title' => esc_html__( 'Activate Plugin', 'frase' ),
						),
						array(
							...
							'title' => esc_html__( 'Login settings', 'frase' ),
						),
						array(
							...
							'title' => esc_html__( 'Dashboard settings', 'frase' ),
						),*/
					),
					'normalColumns' => array(
						/*array(
							...
							'title'      => esc_html__( 'Knowledge base', 'frase' ),
							'content'    => esc_html__(
								'The utilization of this plugin can be facilitated by perusing comprehensive and well-documented articles.',
								'frase'
							),
							'buttonText' => esc_html__( 'Visit knowledge base', 'frase' ),
							'buttonLink' => 'https://github.com/codersantosh/frase',

						),
						array(
							'icon'       => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/><path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6m0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5"/></svg>',
							'title'      => esc_html__( 'Community', 'frase' ),
							'content'    => sprintf(
								esc_html__(
							...
							'buttonText' => esc_html__( 'Visit community page', 'frase' ),
							'buttonLink' => 'https://github.com/codersantosh/frase',
						),
						array(
							...
							'title'      => esc_html__( '24x7 support', 'frase' ),
							'content'    => sprintf(
								esc_html__(
							...
							'buttonText' => esc_html__( 'Create a support thread', 'frase' ),
							'buttonLink' => 'https://github.com/codersantosh/frase',
						...
						array(
							...
							'title'      => esc_html__( 'Video guide', 'frase' ),
							'content'    => sprintf(
								esc_html__(
							...
							'buttonText' => esc_html__( 'View video guide', 'frase' ),
							'buttonLink' => 'https://github.com/codersantosh/frase',
					...
					'topicLinks'    => array(
						...
						'title'   => esc_html__( 'Quick links to settings', 'frase' ),
						'columns' => array(
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Settings 1', 'frase' ),
							...
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Advanced settings', 'frase' ),
					...
					'changelog'     => array(
						...
						'title'   => esc_html__( 'Changelog', 'frase' ),
						'content' => frase_plugin_parse_changelog(),
					),
				),
			)
		);
