...
class ACOQVW_Backend {
  ...
  <div class="' .esc_attr($this->token). '_loader"><p>' . esc_html__('Acowebs Woocommerce Quick View Plugin is loading Please wait for a while..', 'quick-view-for-woocommerce') . '</p></div>
</div>'
        );
    }
