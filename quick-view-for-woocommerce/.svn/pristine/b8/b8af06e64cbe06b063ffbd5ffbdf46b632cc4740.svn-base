...
class ACOQVW_Public
{
            ...
            if (isset($button_style) && !empty($button_style)) {
                switch($button_style){
                    case 'icon': 
                        ...
                        break;
                    case 'label':
                        $button_label = esc_html__($trigger['acoqvw_buttonLabel'], 'quick-view-for-woocommerce');
                        break;
                    case 'icon_label':
                        ...
                        break;
                    case 'label_icon':
                        $button_label = esc_html__($trigger['acoqvw_buttonLabel'],'quick-view-for-woocommerce')."<span class='acoqvw_trigger_icon'>".$media->get_icon('eye')."</span>";
                        break;
                }
            }
    ...
    public function show_view_detail_button() {
        ...
        $button_output="<a href='".get_permalink( $product->get_id() )."' class='button acoqvw_view_details_button'>".esc_html__($label,'quick-view-for-woocommerce')."</a>";
        
        echo wp_kses_post(apply_filters('acoqvw_view_detail_button_html', $button_output, $label, $product));
    }
    ...
    function acoqvw_enqueue_custom_style() {
        ...
        if( $custom_css ) {
            ...
            wp_add_inline_style( $handle, wp_kses_post($custom_css));
        }
    }
}