 ...
 * Description:       Boost speed and Core Web Vitals with smart image optimization and auto WebP generation.
 * Version:           1.7.2
...
define( 'STILLBE_IQ_REQUIRED_EXT_PLUGIN_VER',       '1.1.1' );

// Download URL of Extends Plugin
define( 'STILLBE_IQ_REQUIRED_EXT_PLUGIN_URL',       'https://still-be.com/download/still-be-image-quality-control-extends-v1.1.1.zip' );
...
// SSIM 計算用 Class
// require_once( __DIR__. '/includes/class/class-stillbe-ssim.php' );
