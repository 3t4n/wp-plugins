...
<div class="wrap">
    ...
    <h1><?php esc_html_e('WP Login Attempts', 'wp-login-attempts'); ?></h1>

    <div class="notice wla--notice">
        <div>
            <h3><?php esc_html_e('WP Login Attempts', 'wp-login-attempts'); ?></h3>
            ...
            <div class="e-notice__actions">
                <a href="https://wp-plugins.galaxyweblinks.com/wp-plugins/wp-login-attempts/doc/" class="e-button--cta cta-secondary" target="_blank"><span>Documentation</span></a>
            </div>
    ...
    <div class="wla-content-sec">
            ...
            <form action="options-general.php?page=wp-login-attempts&setingid=attempt-set" method="post" id="loginlockout">
                ...
                <table class="form-table">
                    ...
                    <tr class="wla-hide-login-attmpt">
                        ...
                        <td>
                            <input class="disable_login_attmpt" id="disable_login_attmpt" type="checkbox" name="disable_login_attmpt" value="true" <?php if (get_option('wla_disable_login_attmpt') == 'true') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                        </td>
                    </tr>
        ...
        <div id="reCaptcha-set" class="w3-container city w3-animate-zoom" style="display:none">
            <form action="options-general.php?page=wp-login-attempts&setingid=reCaptcha-set" onload="getUrlParameter('reCaptcha-set')" method="post">
                ...
                <div class="wla_lim_tab_sub_label">
                    <h4><?php _e('General', 'wp-login-attempts'); ?></h4>
                </div>
                <table class="form-table">
                    <tr valign="top">
                ...
                <div class="wla_lim_tab_sub_label">
                    <h4><?php _e('Authentication', 'wp-login-attempts'); ?></h4>
                </div>
