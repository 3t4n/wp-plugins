 ...
 * @return $links [array]
 */
function wla_add_custom_plugin_links($links, $file)
{
	if ($file === 'wp-login-attempts/wp-login-attempts.php') {
		$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/wp-plugins/wp-login-attempts/doc/" target="_blank">Documentation</a>';
		$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/contact/" target="_blank">Contact Support</a>';
	}
	return $links;
}

add_filter('plugin_row_meta', 'wla_add_custom_plugin_links', 10, 2);