...
class Anber_elementor_addon_carousel_slider extends Widget_Base {
    ...
    public function get_script_depends() {
        return ['anber-owl-carousel-script'];
    }

    public function get_style_depends() {
        return ['adon-comon-style', 'anber-carousel-style', 'anber-owl-carousel'];
    }
    ...
    protected function render() {
       ...
       $anber_settings = $this->get_settings();
        
       include dirname(__FILE__) . '/anber_carousel_slider_1.php';
    }
}
