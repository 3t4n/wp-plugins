                            ...
                            <div class="apps-blog-post-box-meta-114 d-flex gap-10">
                                <?php if (isset($anber_settings['show_postdate']) && 'yes' === $anber_settings['show_postdate']) : ?>
                                    <span class="date d-flex gap-10 py-20">
                                        ...
                                        <span class="date-text"> <?php echo esc_html(get_the_date('M/d/ Y')); ?></span>
                                    </span>
                                <?php endif; ?>
...
$anber_inline_script2 = "
    jQuery(document).ready(function ($) {
        $('#anber-post-carousel').owlCarousel({
            ...
            navText: [" . wp_json_encode($anber_next_icon_html2) . ", " . wp_json_encode($anber_previous_icon_html2) . "],
            autoplay: true,
...
if (\Elementor\Plugin::instance()->editor->is_edit_mode()) {
    echo wp_get_inline_script_tag($anber_inline_script2);
} else {
    wp_add_inline_script('anber-owl-carousel-script', $anber_inline_script2);
}