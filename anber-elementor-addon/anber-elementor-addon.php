...
function anber_elementor_adon_widgets_dependencies() {  
    ...
    wp_register_script('anber-owl-carousel-script', plugins_url('assets/js/owl.carousel.min.js', __FILE__), array('jquery'), '1.0.1', true);  
    wp_enqueue_script('anber-owl-carousel-script');  
    wp_script_add_data('anber-owl-carousel-script', 'defer', true); 
    ...
    wp_register_style('anber-owl-carousel-style', plugins_url('assets/css/owl.carousel.min.css', __FILE__), array(), '1.0.1');  
   wp_enqueue_style('anber-owl-carousel');  
