...
= 1.1.2 =
* fixed "live field options from zendesk" issue.

= 1.1.1 =
* fixed "payment event for stripe" issue.

= 1.1.0 =
* fixed "zendesk id and link tags" issue.

= 1.0.9 =
* fixed "save zendesk account" issue.

= 1.0.8 =
* fixed "debug xss" issue.

= 1.0.7 =
* Fixed "send to zendesk on payment completion" feature.
