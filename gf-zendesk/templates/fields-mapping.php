...
if ( ! defined( 'ABSPATH' ) ) {
 ...
 <div  class="vx_div">
   <div class="vx_head">
<div class="crm_head_div"> <?php esc_html_e('4. Map Form Fields to Zendesk Fields.', 'gravity-forms-zendesk-crm'); ?></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"><i class="fa crm_toggle_btn vx_action_btn fa-minus"></i></div>
...
<?php
 if(! $required){   
?>
<i class="vx_remove_btn vx_remove_btn vx_action_btn fa fa-trash-o" title="<?php esc_html_e('Delete','gravity-forms-zendesk-crm'); ?>"></i>
<?php } ?>
<i class="fa crm_toggle_btn vx_action_btn vx_btn_inner <?php echo $btn_icon ?>" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"></i>
</div>
...
<div class="more_options crm_panel_content" style="display: <?php echo $display ?>;">
  ...
  <span class="crm-desc-name-div"><?php echo esc_html__('Name:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-name"><?php echo esc_html($v['name']); ?></span> </span>
  <?php if($this->post('type',$v) !=""){ ?>
    <span class="crm-desc-type-div">, <?php echo esc_html__('Type:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-type"><?php echo esc_html($v['type']) ?></span> </span>
<?php
   }
  if($this->post('maxlength',$v) !=""){ 
   ?>
   <span class="crm-desc-len-div">, <?php echo esc_html__('Max Length:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-len"><?php echo esc_html($v['maxlength']); ?></span> </span>
  <?php 
  }
    if($this->post('eg',$v) !=""){ 
   ?>
   <span class="crm-eg-div">, <?php echo esc_html__('e.g:','gravity-forms-zendesk-crm')." ";?><span class="crm-eg"><?php echo $v['eg']; ?></span> </span>
  <?php 
  }
  ?>
   </div> 
...
?>
<div class="entry_row">
<div class="entry_col1 vx_label"><?php esc_html_e('Field API Name','gravity-forms-zendesk-crm') ?></div>
<div class="entry_col2">
<input type="text" name="meta[map][<?php echo $k ?>][name_c]" value="<?php echo esc_attr($v['name_c']) ?>" placeholder="<?php esc_html_e('Field API Name','gravity-forms-zendesk-crm') ?>" class="vx_input_100">
</div>
<div class="crm_clear"></div>
</div> 
<?php             
...
?>
<div class="entry_row">
<div class="entry_col1 vx_label"><label  for="vx_type_<?php echo $k ?>"><?php esc_html_e('Field Type','gravity-forms-zendesk-crm') ?></label></div>
<div class="entry_col2">
...
<textarea name='meta[map][<?php echo $k?>][value]'  id="vx_value_<?php echo $k ?>" placeholder="<?php esc_html_e("Custom Value",'%dd%')?>" class="vx_input_100 vxc_field_input"><?php $h=$this->post2($k,'value',$map); echo htmlentities($h); ?></textarea>
...
<div class="crm_panel_head2">
<div class="crm_head_div"><span class="crm_head_text crm_text_label">  <?php esc_html_e('Custom Field', 'gravity-forms-zendesk-crm');?></span> </div>
<div class="crm_btn_div">
<i class="vx_remove_btn vx_action_btn fa fa-trash-o" title="<?php esc_html_e('Delete','gravity-forms-zendesk-crm'); ?>"></i>
<i class="fa crm_toggle_btn vx_action_btn vx_btn_inner fa-minus" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"></i>
</div>
<div class="crm_clear"></div> </div>
...
?>
  ...
  <div class="crm-panel-description">
  <span class="crm-desc-name-div"><?php echo esc_html__('Name:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-name"></span> </span>
  <span class="crm-desc-type-div">, <?php echo esc_html__('Type:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-type"></span> </span>
  <span class="crm-desc-len-div">, <?php echo esc_html__('Max Length:','gravity-forms-zendesk-crm')." ";?><span class="crm-desc-len"></span> </span>
   <span class="crm-eg-div">, <?php echo esc_html__('e.g:','gravity-forms-zendesk-crm')." ";?><span class="crm-eg"></span> </span>
...
<div class="entry_row">
<div class="entry_col1 vx_label"><label  for="vx_type"><?php esc_html_e('Field Type','gravity-forms-zendesk-crm') ?></label></div>
<div class="entry_col2">
...
<div class="crm_clear"></div>
  ...
  <div class="clear"></div>
   ...
   <div class="crm_panel crm_panel_100">
<div class="crm_panel_head2">
<div class="crm_head_div"><span class="crm_head_text ">  <?php esc_html_e("Add New Field", 'gravity-forms-zendesk-crm');?></span> </div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn vx_btn_inner fa-minus" style="display: none;" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"></i></div>
<div class="crm_clear"></div> </div>
<div class="more_options crm_panel_content" style="display: block;">
...
echo '<option value="'.esc_attr($k).'" '.$disable.'>'.esc_html($v['label']).'</option>';  
 ...
 <button type="button" class="button button-default" style="vertical-align: middle;" id="xv_add_custom_field"><i class="fa fa-plus-circle" ></i> <?php esc_html_e('Add Field','gravity-forms-zendesk-crm')?></button>
...
var crm_fields=<?php echo json_encode($json_fields); ?>;
  ...
  <div class="vx_div">
   <div class="vx_head">
<div class="crm_head_div"> <?php esc_html_e('5. When to Send Entry to Zendesk.', 'gravity-forms-zendesk-crm'); ?></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"><i class="fa crm_toggle_btn vx_action_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  </div>
  ...
  <?php esc_html_e('Send Entry', 'gravity-forms-zendesk-crm'); ?>
  </span></legend>
  <label for="crm_manual_export">
  ...
  if(self::$is_pr){
      ...
      $events_arr['4']=__( 'When form submission is Complete.', 'gravity-forms-zendesk-crm');
  }
  ...
  <div class="vx_col1">
  <label for="crm_optin">
  <?php esc_html_e("Opt-In Condition", 'gravity-forms-zendesk-crm'); ?>
  ...
  <label for="crm_optin">
  <?php esc_html_e("Enable", 'gravity-forms-zendesk-crm'); ?>
  </label>
  </div>
  <div style="clear: both;"></div>
  ...
  <?php esc_html_e('OR','gravity-forms-zendesk-crm') ?>
  </div>
  <?php } ?>
  ...
  <?php if($sno_i>1){ ?>
  <div class="vx_filter_label">
  <?php esc_html_e('AND','gravity-forms-zendesk-crm') ?>
  </div>
  <?php } ?>
  ...
  <input type="text" class="vxc_filter_text" placeholder="<?php esc_html_e('Value','gravity-forms-zendesk-crm') ?>" value="<?php echo $this->post('value',$s_v) ?>" name="meta[filters][<?php echo $filter_k ?>][<?php echo $s_k ?>][value]">
  </div>
  <?php if( $sno_i>1){ ?>
  ...
  <button class="button button-default button-small vx_add_and" title="<?php esc_html_e('Add AND Filter','gravity-forms-zendesk-crm'); ?>"><i class="vx_icons-s vx_trash_and fa fa-hand-o-right"></i>
  <?php esc_html_e('Add AND Filter','gravity-forms-zendesk-crm') ?>
  </button>
  <?php if($sno>1){ ?>
  <a href="#" class="vx_trash_or">
  <?php esc_html_e('Trash','gravity-forms-zendesk-crm') ?>
  </a>
  <?php } ?>
  </div>
  </div>
  ...
  <?php
                      ...
                      ?>
  <div class="vx_btn_div">
  <button class="button button-default  vx_add_or" title="<?php esc_html_e('Add OR Filter','gravity-forms-zendesk-crm'); ?>"><i class="vx_icons vx_trash_and fa fa-check"></i>
  <?php esc_html_e('Add OR Filter','gravity-forms-zendesk-crm') ?>
  </button>
  </div>
  </div>
  <!--------- template------------>
  ...
  <div class="vx_filter_field vx_filter_field3">
  <input type="text" class="vxc_filter_text" placeholder="<?php esc_html_e('Value','gravity-forms-zendesk-crm') ?>" name="value">
  </div>
  <div class="vx_filter_field vx_filter_field4"><i class="vx_icons vx_trash_and vxc_tips fa fa-trash-o"></i></div>
  <div style="clear: both;"></div>
  </div>
  <div class="vx_btn_div">
  <button class="button button-default button-small vx_add_and" title="<?php esc_html_e('Add AND Filter','gravity-forms-zendesk-crm'); ?>"><i class="vx_icons vx_trash_and  fa fa-hand-o-right"></i>
  <?php esc_html_e('Add AND Filter','gravity-forms-zendesk-crm') ?>
  </button>
  <a href="#" class="vx_trash_or">
  <?php esc_html_e('Trash','gravity-forms-zendesk-crm') ?>
...
?>
  ...
  <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_notes"><?php esc_html_e('Entry Notes ', 'gravity-forms-zendesk-crm');  gform_tooltip('vx_entry_notes');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_notes" class="crm_toggle_check" name="meta[entry_notes]" value="1" <?php echo !empty($meta['entry_notes']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_notes"><?php esc_html_e('Add notes to Zendesk when added in Gravity Forms.', 'gravity-forms-zendesk-crm'); ?></label>
...
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"></i></div>
<div class="crm_clear"></div> 
  </div>                    
    <div class="vx_group">
  <div class="vx_row">
  <div class="vx_col1">
  <label for="crm_primary_field"><?php esc_html_e('Select Primary Key','gravity-forms-zendesk-crm') ?></label>
 ...
 <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_update"><?php esc_html_e('Update Entry ', 'gravity-forms-zendesk-crm');?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_update" class="crm_toggle_check" name="meta[update]" value="1" <?php echo !empty($meta['update']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_update"><?php esc_html_e('Do not update entry, if already exists', 'gravity-forms-zendesk-crm'); ?></label>
...
<?php
  ...
  <div class="vx_col1">
  <label for="vx_reply">
  <?php esc_html_e('Ticket reply', 'gravity-forms-zendesk-crm'); ?>
  </label>
  </div>
  <div class="vx_col2">
  ...
  <label for="vx_reply">
  <?php esc_html_e('Do not add description as ticket reply, if ticket already exists', 'gravity-forms-zendesk-crm'); ?>
  </label>
  </div>
  <div style="clear: both;"></div>
  </div>
  ...
  <?php esc_html_e('Ticket Description', 'gravity-forms-zendesk-crm'); ?>
  </label>
  </div>
  <div class="vx_col2">
  ...
  <label for="vx_private_ticket">
  <?php esc_html_e('Add Ticket Description as Private Note', 'gravity-forms-zendesk-crm'); ?>
  </label>
  </div>
  <div style="clear: both;"></div>
  </div> 
...
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  </div>
  ...
  <div class="vx_col1">
  <label for="crm_note">
  <?php esc_html_e("Add Note ", 'gravity-forms-zendesk-crm'); ?>
  ...
  <?php esc_html_e( 'Note Fields ', 'gravity-forms-zendesk-crm' ); gform_tooltip("vx_note_fields") ?>
  </label>
  </div>
  <div class="vx_col2 entry_col2">
  <textarea name="meta[note_val]"  placeholder="<?php esc_html_e("{field-id} text",'gravity-forms-zendesk-crm')?>" class="vx_input_100 vxc_field_input" style="height: 60px"><?php
...
<?php echo $options ?>
  ...
  <?php esc_html_e( 'Disable Note ', 'gravity-forms-zendesk-crm' ); gform_tooltip("vx_disable_note") ?>
  </label>
  </div>
  <div class="vx_col2">
  ...
  <label for="crm_disable_note">
  <?php esc_html_e('Do not Add Note if entry already exists in Zendesk', 'gravity-forms-zendesk-crm'); ?>
  </label>
...
<div class="vx_row">
   <div class="vx_col1">
  <label for="crm_sel_status"><?php esc_html_e('Select Status ','gravity-forms-zendesk-crm'); gform_tooltip('vx_status'); ?></label>
</div> <div class="vx_col2">
  ...
  <?php echo $this->gen_select($status_list,$meta['status'],__('Select Status','gravity-forms-zendesk-crm')); ?>
   ...
   <div class="clear"></div>
       ...
       <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_notes"><?php esc_html_e('Is Private ', 'gravity-forms-zendesk-crm');  ?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="vx_priv"  name="meta[is_private]" value="1" <?php echo !empty($meta['is_private']) ? 'checked="checked"' : ''?> autocomplete="off"/>
    <label for="vx_priv"><?php esc_html_e('Add Ticket Description as Internal Note', 'gravity-forms-zendesk-crm'); ?></label>
...
?>
  ...
  <button type="submit" title="<?php esc_html_e('Save Feed','gravity-forms-zendesk-crm'); ?>" name="<?php echo esc_attr($this->id) ?>_submit" class="button button-primary button-hero"> <i class="vx_icons vx vx-arrow-50"></i> <?php echo empty($fid) ? esc_html__("Save Feed", 'gravity-forms-zendesk-crm') : esc_html__("Update Feed", 'gravity-forms-zendesk-crm'); ?> </button>
  </div>
