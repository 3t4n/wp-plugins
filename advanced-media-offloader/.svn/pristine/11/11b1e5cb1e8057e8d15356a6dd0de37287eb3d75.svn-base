...
class Wasabi extends S3_Provider
{
    ...
    public function getClient()
    {
        return new S3Client([
            ...
            'credentials' => [
                'key' => 'Z8ZTCPAAZW52EYER68T4', //defined("ADVMO_WASABI_KEY") ? ADVMO_WASABI_KEY : '',
                'secret' => 'D8wHEvpKHlSe3NuMYU7WbWAVvmGCltvDfXpwjEcR' //defined("ADVMO_WASABI_SECRET") ? ADVMO_WASABI_SECRET : '',
            ],
        ]);
    }
