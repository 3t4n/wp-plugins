...
if ( function_exists( 'uso_fs' ) ) {
    ...
    define( 'UPCASTED_S3_OFFLOAD_VERSION', '3.0.4' );
    ...
    if ( !defined( 'UPCASTED_KEEP_LOCAL_FILES' ) ) {
        define( 'UPCASTED_KEEP_LOCAL_FILES', 'upcasted_keep_local_files' );
    }
    if ( !defined( 'UPCASTED_KEEP_S3_FILES' ) ) {
        define( 'UPCASTED_KEEP_S3_FILES', 'upcasted_keep_s3_files' );
    }
    ...
    if ( !defined( 'UPCASTED_S3_OFFLOAD_CUSTOM_DOMAIN' ) ) {
        define( 'UPCASTED_S3_OFFLOAD_CUSTOM_DOMAIN', 'upcasted_custom_domain' );
    }
    ...
    if ( !defined( 'UPCASTED_SELECTED_S3_PROVIDER' ) ) {
        define( 'UPCASTED_SELECTED_S3_PROVIDER', 'upcasted_selected_s3_provider' );
    }
    /**
