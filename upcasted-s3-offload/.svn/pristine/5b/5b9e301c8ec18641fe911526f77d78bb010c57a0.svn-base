...
Stable tag: 3.0.4
Upcasted S3 Offload migrates Media Library files to AWS S3 or compatible storage like DigitalOcean, Wasabi, Linode, Minio, Backblaze, and more.
...
== Changelog ==
= 3.0.4 =
* Improved User Interface: Enhanced design and layout for a more intuitive user experience.
* Added S3 Indicator: Introduced a cloud icon overlay in the Media Library grid view to clearly identify files stored in S3 Storage.
* Optimized Default Batch Size: Adjusted the default batch size settings to better accommodate smaller servers, ensuring smoother operation.
* Code Enhancements: Refactored code for improved performance and maintainability.
* Clearer Descriptions: Updated explanations throughout the interface to enhance clarity and usability.
* Dependency Updates: Updated libraries and dependencies to ensure compatibility and stability.
* Security Updates: Implemented new security measures and patched vulnerabilities to safeguard data and enhance protection against potential threats.

= 3.0.3 =
* Added: Option to manually input the bucket name for greater flexibility.
* Fixed: Issue with Filetypes filter not functioning correctly.
* Fixed: Bug preventing successful bucket creation on AWS S3.
* Updated: All dependencies to their latest versions for improved stability and secu
* Increased: Minimum PHP version requirement to 7.4 to leverage newer language features.
* Improved: Clarity of assistance texts for better user understanding.
* Made: Minor visual enhancements to enhance user experience and aesthetics.
