<?php
	/**
	 * AfterPay Direct Debit payment method for Austria
	 *
	 * @category   Class
 ...
 * AfterPay Direct Debit payment method for Austria
 *
 * @class    WC_Gateway_Afterpay_At_Directdebit
 * @extends  WC_Gateway_Afterpay_Base_Rest
 * @package  Arvato_AfterPay
 * @author   AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_At_Directdebit extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_at_directdebit';
		$this->method_title = __( 'Riverty Austria Direct Debit', 'afterpay-payment-gateway-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_at_directdebit_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Austria Direct Debit', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row" style="margin-top:15px">
				...
				<label style="display:inline">
					<?php echo $this->get_tracking_text('direct_debit', 'at'); ?>
				</label>
			</p>
