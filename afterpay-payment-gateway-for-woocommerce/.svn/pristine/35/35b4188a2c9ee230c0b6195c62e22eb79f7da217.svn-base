<?php
/**
 * AfterPay Installments payment method for Germany
 *
 * @category   Class
 ...
 * AfterPay Installments payment method for Germany
 *
 * @class      WC_Gateway_Afterpay_De_Installments
 * @extends    WC_Gateway_Afterpay_Base_Rest
 * @package    Arvato_AfterPay
 * @author     AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_De_Installments extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_de_installments';
		$this->method_title = __( 'Riverty Germany Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_de_installments_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Germany Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row" style="margin-top:15px">
				...
				<label style="display:inline">
					<?php echo $this->get_tracking_text('fix_instalments', 'de'); ?>
				</label>
			</p>
