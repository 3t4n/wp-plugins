<?php
/**
 * AfterPay Direct Debit payment method for Netherlands using REST
 *
 * @category   Class
 ...
 * AfterPay Direct Debit payment method for Netherlands using REST
 *
 * @class       WC_Gateway_Afterpay_Nl_Directdebit_Rest
 * @extends     WC_Gateway_Afterpay_Base_Rest
 * @package     Arvato_AfterPay
 * @author      AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Nl_Directdebit_Rest extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_directdebit_rest';
		$this->method_title = __( 'Riverty Netherlands Direct Debit', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Veilig achteraf betalen (eenmalige machtiging)';
		...
		$country_code 			    = ( $current_locale	 == 'nl' ) ? 'nl_nl/' : 'en_nl/';
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_nl_directdebit_rest_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands Direct Debit', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
