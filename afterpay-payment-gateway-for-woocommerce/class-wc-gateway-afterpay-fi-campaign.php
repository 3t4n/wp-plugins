<?php
/**
 * AfterPay Campaign invoice payment method for Finland
 *
 * @category   Class
 ...
 * AfterPay Campaign invoice payment method for Finland
 *
 * @class    WC_Gateway_Afterpay_Fi_Campaign
 * @extends  WC_Gateway_Afterpay_Base_Rest
 * @package  Arvato_AfterPay
 * @author   AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Fi_Campaign extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_fi_campaign';
		$this->method_title = __( 'Riverty Finland Campaign invoice', 'afterpay-payment-gateway-for-woocommerce' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_fi_campaign_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Finland Campaign invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<?php endif; ?>
			<p class="form-row">
				<label for="<?php echo esc_attr( $this->id ); ?>_ssn"><strong>Viimeistele tilauksesi syöttämällä henkilötunnus (11 merkkiä): <span class="required">*</span></strong></label>
				<input type="input" class="input-text" name="<?php echo esc_attr( $this->id ); ?>_ssn" placeholder="PPKKVV-XXXX"/>
			</p>
			<div class="clear"></div>
