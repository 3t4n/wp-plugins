...
if ( ! class_exists( 'GF_Engage_Admin_Notice' ) ) {
	/**
	 * GF_Engage_Admin_Notice notice class, to easily handle admin notices
	 */
	class GF_Engage_Admin_Notice {
		/**
		 * Notice text.
		 *
		 * @var $notice
