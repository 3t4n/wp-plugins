...
class NodeInfoProvider
{
     ...
     *
     * @param string|null $path The path within the `configs` array to retrieve. If null,
     ...
     *
     * @param string|null $path               The path to locate the specific repeater field mapping
