...
final class MailChimpServices
{
    ...
    public function addRemoveTag($module, $email, $listId, $tags)
    {
        ...
        $apiEndpoints = $this->baseURL() . "/lists/{$listId}/members/{$subscriber_hash}/tags";
    ...
    public function generateFieldMap($fieldMap, $addressFieldMapData, $additionalData)
    {
        ...
        $doubleOptIn = !empty($additionalData['addDoubleOptIn']) && $additionalData['addDoubleOptIn'] === 'yes' ? true : false;
