...
<tr>
  ...
  <td>
		...
		<small><?php Echo $this->t('Enable this feature to redirect the user to the term if the search query matches a term title exactly.') ?></small>
	</td>
</tr>
...
<tr>
    ...
    <small><?php Echo $this->t('The minimum number of characters a user must type before suggestions will be shown.') ?></small>
  </td>
</tr>
...
<tr>
    ...
    <small><?php Echo $this->t('The delay in milliseconds between when a keystroke occurs and when suggestions will be shown.') ?></small>
  </td>
</tr>
</table>
