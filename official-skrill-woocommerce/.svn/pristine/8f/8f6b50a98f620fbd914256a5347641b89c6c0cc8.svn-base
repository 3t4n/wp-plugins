...
define('SKRILL_PLUGIN_VERSION', '1.0.65');
...
function skrill_init_payment_gateway()
{
    ...
    function skrill_add_payment_methods($payment_methods)
    {
        ...
        $payment_methods[] = 'Gateway_Skrill_MBK';
    ...
    function rudr_gateway_block_support()
    {
        ...
        require_once __DIR__ . '/includes/checkout-block/skrill_acc_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_aci_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_adb_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_ali_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_aob_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_blk_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_epy_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_ewltid_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_ewltkr_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_ewltph_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_flexible_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_idl_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_mae_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_mbw_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_msc_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_mub_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_ntl_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_obt_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_pch_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_pgf_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_pli_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_psc_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_pwy_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_sft_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_spx_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_vsa_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_wlt_woocommerce_block_support.php';
        require_once __DIR__ . '/includes/checkout-block/skrill_mbk_woocommerce_block_support.php';

        // registering the PHP class we have just included
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Acc_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Aci_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Adb_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Ali_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Aob_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Blk_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Epy_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Ewltid_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Ewltkr_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Ewltph_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Flexible_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Idl_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Mae_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Mbw_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Msc_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Mub_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Ntl_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Obt_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Pch_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Pgf_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Pli_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Psc_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Pwy_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Sft_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Spx_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Vsa_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Wlt_Gateway_Blocks());
            }
        );
        add_action(
            'woocommerce_blocks_payment_method_type_registration',
            function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                $payment_method_registry->register(new Skrill_Mbk_Gateway_Blocks());
            }
        );
    }
}
