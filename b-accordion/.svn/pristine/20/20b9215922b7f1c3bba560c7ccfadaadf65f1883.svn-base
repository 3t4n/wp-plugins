=== B Accordion - Add Horizontal / Vertical Accordion in WordPress ===
...
Easily create stylish and fully customizable accordions for your WordPress site. Perfect for FAQs, toggle sections, or content organization. Supports responsive design, smoothly, and dynamic content. No coding required—just add, and customization!
...
= 1.0.8 - 15 Jan, 2025 =
* Same page using multiple accordion
...
= 1.0.5 - 15 Nov, 2024 =
* Fix horizontal content not display.
