...
function wpsc_get_important_date_multi_colors( $categories = array() ) {
    ...
    // Six Colors
    if ( $num_categories === 6 ) {
        if ( $categories[0] === $categories[1] && $categories[1] === $categories[2] && $categories[2] === $categories[3] && $categories[3] === $categories[4] && $categories[4] === $categories[5] ) {}
        else {
            $background  = 'data:image/svg+xml;base64,' . base64_encode( sprintf( '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="100" width="100"><polygon points="0,0 50,50 0,50" style="fill:%s;stroke:none;" /><polygon points="0,0 50,0 50,50" style="fill:%s;stroke:none;" /><polygon points="50,0 100,0 100,50 50,50" style="fill:%s;stroke:none;" /><polygon points="50,50 100,50 100,100" style="fill:%s;stroke:none;" /><polygon points="50,50 100,100 50,100" style="fill:%s;stroke:none;" /><polygon points="0,50 50,50 50,100 0,100" style="fill:%s;stroke:none;" /></svg>', $all_categories[$categories[0]]['bgcolor'], $all_categories[$categories[1]]['bgcolor'], $all_categories[$categories[2]]['bgcolor'], $all_categories[$categories[3]]['bgcolor'], $all_categories[$categories[4]]['bgcolor'], $all_categories[$categories[5]]['bgcolor'] ) );
            $css = sprintf( "background:url('%s') center no-repeat;background-size:%s;-ms-background-size:%s;-o-background-size:%s;-moz-background-size:%s;-webkit-background-size:%s;color:#fff;", $background, '100% 100%', '100% 100%', '100% 100%', '100% 100%', '100% 100%' );
        }
    }
    ...
    // Seven Colors
    if ( $num_categories === 7 ) {
        if ( $categories[0] === $categories[1] && $categories[1] === $categories[2] && $categories[2] === $categories[3] && $categories[3] === $categories[4] && $categories[4] === $categories[5] && $categories[5] === $categories[6] ) {}
        else {
            $background  = 'data:image/svg+xml;base64,' . base64_encode( sprintf( '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="100" width="100"><polygon points="0,0 50,50 0,50" style="fill:%s;stroke:none;" /><polygon points="0,0 50,0 50,50" style="fill:%s;stroke:none;" /><polygon points="50,0 100,0 50,50" style="fill:%s;stroke:none;" /><polygon points="100,0 100,50 50,50" style="fill:%s;stroke:none;" /><polygon points="50,50 100,50, 100,100" style="fill:%s;stroke:none;" /><polygon points="50,50 100,100 50,100" style="fill:%s;stroke:none;" /><polygon points="0,50 50,50 50,100 0,100" style="fill:%s;stroke:none;" /></svg>', $all_categories[$categories[0]]['bgcolor'], $all_categories[$categories[1]]['bgcolor'], $all_categories[$categories[2]]['bgcolor'], $all_categories[$categories[3]]['bgcolor'], $all_categories[$categories[4]]['bgcolor'], $all_categories[$categories[5]]['bgcolor'], $all_categories[$categories[6]]['bgcolor'] ) );
            $css = sprintf( "background:url('%s') center no-repeat;background-size:%s;-ms-background-size:%s;-o-background-size:%s;-moz-background-size:%s;-webkit-background-size:%s;color:#fff;", $background, '100% 100%', '100% 100%', '100% 100%', '100% 100%', '100% 100%' );
        }
    }
    ...
    // Eight Colors
    if ( $num_categories === 8 ) {
        if ( $categories[0] === $categories[1] && $categories[1] === $categories[2] && $categories[2] === $categories[3] && $categories[3] === $categories[4] && $categories[4] === $categories[5] && $categories[5] === $categories[6] && $categories[6] === $categories[7] ) {}
        else {
            $background  = 'data:image/svg+xml;base64,' . base64_encode( sprintf( '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="100" width="100"><polygon points="0,0 50,50 0,50" style="fill:%s;stroke:none;" /><polygon points="0,0 50,0 50,50" style="fill:%s;stroke:none;" /><polygon points="50,0 100,0 50,50" style="fill:%s;stroke:none;" /><polygon points="100,0 100,50 50,50" style="fill:%s;stroke:none;" /><polygon points="50,50 100,50, 100,100" style="fill:%s;stroke:none;" /><polygon points="50,50 100,100 50,100" style="fill:%s;stroke:none;" /><polygon points="50,50 50,100 0,100" style="fill:%s;stroke:none;" /><polygon points="0,100 0,50 50,50" style="fill:%s;stroke:none;" /></svg>', $all_categories[$categories[0]]['bgcolor'], $all_categories[$categories[1]]['bgcolor'], $all_categories[$categories[2]]['bgcolor'], $all_categories[$categories[3]]['bgcolor'], $all_categories[$categories[4]]['bgcolor'], $all_categories[$categories[5]]['bgcolor'], $all_categories[$categories[6]]['bgcolor'], $all_categories[$categories[7]]['bgcolor'] ) );
            $css = sprintf( "background:url('%s') center no-repeat;background-size:%s;-ms-background-size:%s;-o-background-size:%s;-moz-background-size:%s;-webkit-background-size:%s;color:#fff;", $background, '100% 100%', '100% 100%', '100% 100%', '100% 100%', '100% 100%' );
        }
    }
