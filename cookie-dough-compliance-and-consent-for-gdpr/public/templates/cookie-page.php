...
/**
 * The template for the front page cookie
 *
 * @link       https://webdeclic.com/
 * @since      1.0.0
 *
 * @package    Cookie_Dough_Consent
 * @subpackage Cookie_Dough_Consent/public/templates
 */
...
$main_refuseall_text                        = isset($settings_array['main-refuseall-text']) ? $settings_array['main-refuseall-text'] : cdc_cookie_default_values('main-refuseall-text');
...
$mandatory_refuseall_text                   = isset($settings_array['mandatory-refuseall-text']) ? $settings_array['mandatory-refuseall-text'] : cdc_cookie_default_values('mandatory-refuseall-text');
...
$optional_refuseall_text                    = isset($settings_array['optional-refuseall-text']) ? $settings_array['optional-refuseall-text'] : cdc_cookie_default_values('optional-refuseall-text');
