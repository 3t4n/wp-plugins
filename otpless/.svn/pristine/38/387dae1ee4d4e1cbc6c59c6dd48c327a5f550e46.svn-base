    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <div class="container-center-horizontal">
                <div class="wordpress screen">
                            ...
                            <div class="welcomeContainer">
                                ...
                                <div>
                                    <div style="text-decoration: underline;cursor: pointer;"
                                        onclick="manuallyUpdateCred()">Enter
                    ...
                    <div class="frame-52983161 title2-m" id="main-part">
                        ...
                        <div class="frame-529831">
                            ...
                            <div class="frame-52983145">
                                ...
                                <div class="pre">
                                    <div class="divoverflow-x-auto">
                                        <div class="code">
                                            <?php
                                                $checked = isset($this->otpless_options['clientId']) ? 
                                                    $this->otpless_options['clientId'] : 
                                                    sanitize_text_field($_GET['clientId'] ?? '');
                                ...
                                <div class="pre">
                                    <div class="divoverflow-x-auto">
                                        <div class="code">
                                            <?php 
                                                $checked = isset($this->otpless_options['clientSecret']) ? 
                                                    $this->otpless_options['clientSecret'] : 
                                                    sanitize_text_field($_GET['clientSecret']);
                            ...
                            <div class="frame-529831">
                                <div class="integrate-via-shortcode title2-m">OTPLESS Sign in on checkout page</div>
                                <div class="not-signed-in">
                                    <div class="frame-481156">
                                        <p class="copy-paste-the-below body1-m">OTPLESS Sign in on checkout page</p>
                                        <p class="activate-this-will-r body1-m">
                                            Activate and add Shortcode this will replace your existing sign in option
                                            with
                                            OTPLESS
                                            Sign in
                                        </p>
                                    ...
                                    <div class="mybutton-2">
                                        <?php
							 	$checked = isset($this->otpless_options['checkout_login']) ? checked($this->otpless_options['checkout_login'], true, false) : 'true';
								$value = isset($this->otpless_options['checkout_login']) ? $this->otpless_options['checkout_login'] : '0';
                                  	?>
                                        <label class="switch">
                                            <?php 
                                      echo ' <input type="hidden" name="otpless_option_name[checkout_login]" value="0">
							   <input class="regular-text submit-input" type="checkbox" name="otpless_option_name[checkout_login]" value="1" id="checkout_login" ' . checked($value, '1', false) . '>';
                                    ?>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="not-signed-in">
                                    <div class="pre">
                                        <div class="divoverflow-x-auto">
                                            <div class="code">
                                                <div class="otpless_signin valign-text-middle">[otpless_button_signin]
                                                </div>
                                            </div>
                                ...
                                <div class="frame-52983145">
                                    ...
                                    <div class="pre">
                                        <div class="divoverflow-x-auto">
                                            ...
                                            <img class="copy"
                                                src="<?php echo plugin_dir_url( __FILE__ ) .'/image/copy.svg'; ?>"
                                                alt="copy" onclick="handleCopyClick()" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                const hasDetails = !!((clientId.value || clientSecret.value) || (getQueryParam(
                        "clientId") &&
                ...
                const handleCopyButtonClick = () => {
                    navigator.clipboard.writeText("[otpless_button_signin]");
                    document.getElementById("clipboard")
                        .innerHTML = "Copied";
                };
...
<?php
    ...
    public function otpless_sanitize($input)
    {
        ...
        if (isset($input['checkout_login'])) {
            $sanitary_values['checkout_login'] = sanitize_text_field($input['checkout_login']);
        }
