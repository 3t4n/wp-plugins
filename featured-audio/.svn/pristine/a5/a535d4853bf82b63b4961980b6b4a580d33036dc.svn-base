...
For a more comprehensive way to manage *music* with WordPress, particularly if you need to include sheet music alongisde audio, see the <a href="https://wordpress.org/plugins/sheet-music-library/">Sheet Music Library</a> plugin.
...
1. Add featured audio to your posts and pages, and optionally add the featured audio playlist or recent audio playlist widget to a sidebar.
1. Developers can add support for additional post types and customize the display of featured audio in themes. You can also customize the display with custom CSS in the customizer.
