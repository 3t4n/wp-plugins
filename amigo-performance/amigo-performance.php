 ...
 * Description:       Boost your website’s performance with Amigo Performance, the all-in-one solution for optimizing website speed and improving loading times. Designed to enhance Google PageSpeed Insights and GTmetrix scores, this powerful plugin ensures a lightning-fast, high-performing website for better user experience and improved SEO rankings.
 * Version:           2.0
 * Author:            Amigo Dheena
