...
if (!$gengo_editing_language) {
	...
	<li><a href='#gengo_set_default' ><?php _e('Set default', GENGO_DOMAIN) ?></a> | </li>
	<li><a href='#gengo_uninstall' ><?php _e('Uninstall', GENGO_DOMAIN) ?></a></li>
	</ul>
	<div class="wpcontent">
	<?php
	if ($language_count) {
...
<h3><?php echo $gengo_add_edit_title ?></h3>
...
include GENGO_PATH . 'gengo_languages.php';
...
<p style="float: left;"><label for="gengo_recognised_languages"><?php _e('Language:', GENGO_DOMAIN) ?><br /><select name="gengo_recognised_languages" id="gengo_recognised_languages" onchange="gengo_select_language(<?php echo $append ?>)"><?php echo $gengo_code_list ?></select></p>
<p style="clear: left; float: left;"><label for="gengo_language"><?php _e('Name:', GENGO_DOMAIN) ?></label><br /><input type="text" name="gengo_language" id="gengo_language" value="<?php echo $gengo_language; ?>" onkeyup="gengo_update_definition(<?php echo $append ?>)" /></p>
<p style="float: left; margin-left: 10px;"><label for="gengo_language_code"><?php _e('Code:', GENGO_DOMAIN) ?></label><br /><input type="text" name="gengo_language_code" id="gengo_language_code" style="width: 30px;" onkeyup="gengo_update_definition(<?php echo $append ?>);" value="<?php echo $gengo_code; ?>" /></p>
<p style="float: left; margin-left: 10px;"><label for="gengo_language_locale"><?php _e('Locale:', GENGO_DOMAIN) ?></label><br /><input type="text" name="gengo_language_locale" id="gengo_language_locale" style="width: 70px;" onkeyup="gengo_update_definition(<?php echo $append ?>);" value="<?php echo $gengo_locale; ?>" /></p>
...
<script type="text/javascript">addLoadEvent(function () { gengo_update_definition(<?php echo $append ?>) });</script>
<?php
if (!$gengo_editing_language) {
	if (current_user_can('set_blog_default_language')) {
		if (count($gengo->languages) > 1) {
			...
			<h3><?php _e("Set Blog Default Language", GENGO_DOMAIN); ?></h3>
			<a name="gengo_set_default"></a>
	...
	if (current_user_can('uninstall_gengo')) {
		...
		<h3><?php _e("Uninstall Gengo", GENGO_DOMAIN); ?></h3>
		<a name="gengo_uninstall"></a>
