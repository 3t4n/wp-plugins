...
== Highlight ==
This plugin is relying on a 3rd party Software as a Service -- FlexPlat: https://flexplat.com to generate Manifest and Service Workers related files.  The Terms and Conditions is located at: https://www.termsfeed.com/live/f1e8d2bc-1615-4aa9-bddb-24dcde10b50b
...
= 4.3.0
(Tue., Nov. 12, 2024)
* Bug Fix: Screenshots can not be personalized.

= 4.2.0
(Sat., Nov. 02, 2024)
* Bug Fix: Admin Service Worker tab can not show Dynamic Site & Staic Site
