											...
											<div class="booking-edit-date-changes">
												...
												<?php 
													...
													foreach( $prices as $price ) { 
														...
														<?php 
															if ($price->vat) {
																foreach ($price->vat as $vat) {
																	$vat_deducted = $price->price - $vat->amount;
																} ?>
																<input type="hidden" value="<?php echo $vat_deducted; ?>" name="<?php echo $price->name; ?>_vat_deducted">
															<?php }
														?>
												<?php } ?>
												...
												if ($booking_date != $date) { ?>
													<div class="flex-row align-items-baseline flex-nowrap">
														...
														<p id="booking_edit_price_wording">
															...
															<?php } else { ?>
																<span id="booking_edit_no_total_changes">
																	There will be no changes to your total
																</span>
															<?php } ?>
														</p>
													</div>
