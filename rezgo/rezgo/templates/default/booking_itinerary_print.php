					...
					<div class="header-itinerary-info">
						...
						<div class="name-value-container">
							<span class="value">
								...
								<?php echo esc_html($site->countryName($itinerary_array->contact->country)); ?>
							</span>
						</div>
													...
													<span class="value">
														<?php if ($location_name[$booking->item_id]) { ?>
															<div id="rezgo-receipt-map-location">
																<strong><i class="far fa-map-marker"></i><?php echo esc_html($location_name[$booking->item_id]); ?></strong>	
																<br>
																<i class="far fa-location-arrow"></i><?php echo esc_html($location_address[$booking->item_id]); ?>
															</div>
														<?php } ?>
