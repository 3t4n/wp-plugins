...
= 4.16 =
* Added VAT display to tour page and booking receipt
* Added VAT breakdown during checkout/booking flow
* Updated layout of the billing information fields on the checkout page
* Bug fixes
...
= 4.15 =
* Added support for showing price tier descriptions
* Updated jquery.validate library
* Various Bug fixes
...
= 4.14 =
* Various Bug fixes
* Added new 'Thank You' page after booking is completed
...
= 4.13 =
* Bug fixes
* Added support for Protecht (Enhanced Refund Protection)
...
= 4.12.0 =
* Added support for Customer Booking Edit
* Added support for Square gateway
* UI updates
* Bug fixes

= 4.11.2 =
* Updated Stripe implementation
* UI updates
* Bug fixes
...
= 4.11 =
* Added Meta Pixel tracking support
* Added support for price tier resource
...
= 4.10.1 =
* Various multisite bug fixes

= 4.10 =
* Added waiver initials support
* Updated booking receipt template
* Various bug fixes

= 4.9 =
* Added Availability Hold support
* Added new Google Analytics tracking events
* Various Bug fixes
...
= 4.8 =
* Updated to Bootstrap ver. 5.2.1
* Updated various JS libraries
* Added new Google Analytics tracking events
* Added support for legacy templates
* UI and functionality improvements
* Various bug fixes
...
* Updated form fields to one column on payment page
* Updated billing form and payment method on gift card purchase page

= 4.6.1 =
* Bug fixes

= 4.6 =
* Added setting to toggle overwriting of WordPress page titles
* Added support for tips on payment step
* Added order total to submit bar on payment page
* Added link to itinerary on order summary view
* Added itinerary view and printable version
* Added loader on package options
* Bug fixes

= 4.5.2 =
* Bug fix for open items on order view

= 4.5.1 =
* Bug fixes

= 4.5 =
* Added Google GTM/GA4 support
* Added cross-sell on package
* Added age range display
* Reduced API calls
* Contents pages cleanup
* Bug fixes
...
= 4.4 =
* Added 'Buy as a Gift' feature
* Updated gift card pages
* Added support to URL with booking source (preparation for Google Things to do)
* Reworked 3DS return with Stripe
* Updated error response for Stripe
* UI improvements
* Bug fixes
...
= 4.3.3 =
* Added a master list for wp_kses()

= 4.3.2 =
* bug fixes

= 4.3.1 =
* fixes to allowed tags for wp_kses()

= 4.3 =
* Added support for variable start times
* Added support for max PAX
* Added promo code to list page
* Added new ticket template
* Improved tag list UI
* Changed tag search wording
* Various bug fixes
...
= 4.1.18 =
* added wp_kses() filter to booking receipts

= 4.1.17 =
* additional fix to allowed tags for wp_kses()
...
= 4.1.8 =
* Added support for WordPress HTTP API
* Bug fixes
