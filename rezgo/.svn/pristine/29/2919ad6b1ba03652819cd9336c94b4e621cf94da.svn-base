...
<html id="rezgo_html">
	...
	<head>
		...
		<!-- Font awesome 5 -->
		<link href="<?php echo $this->path; ?>/css/font-awesome/css/all.min.css" rel="stylesheet">
	...
	<body style="background-color: #FFF;">
		<div class="container-fluid rezgo-container rezgo-print-version">
			...
			<div class="div-order-booking">
				<h3 class="rezgo-confirm-complete print-header">Your order <?php echo esc_html($trans_num); ?> contains <?php echo esc_html(count((array)$order_bookings)); ?> booking<?php echo ((count((array)$order_bookings) != 1) ? 's' : '')?></h3>
			</div>
								...
								<table class="table rezgo-billing-cart">
									...
									<?php foreach($site->getBookingPrices() as $price) { ?>
										<tr>
											...
											<td class="text-end"><?php echo esc_html($site->formatCurrency($price->total)); ?></td>
										</tr>
										<?php if($price->vat) { ?>
									...
									<tr class="rezgo-tr-subtotal">
										...
										<td class="text-end"><?php echo esc_html($site->formatCurrency($booking->sub_total)); ?></td>
									</tr>
									...
									<tr class="rezgo-tr-subtotal summary-total">
										...
										<td class="text-end"><strong><?php echo esc_html($site->formatCurrency($booking->overall_total)); ?></strong></td>
									</tr>
									...
									<?php if($site->exists($booking->overall_paid)) { ?>
										<tr>
											...
											<td class="text-end"><strong><?php echo esc_html($site->formatCurrency($booking->overall_paid)); ?></strong></td>
										</tr>
										<tr>
											<td colspan="3" class="text-end"><span class="push-right"><strong>Total&nbsp;Owing</strong></span></td>
											<td class="text-end"><strong><?php echo esc_html($site->formatCurrency(((float)$booking->overall_total - (float)$booking->overall_paid))); ?></strong></td>
										</tr>
									<?php } ?>
								</table>
							</table>
			...
			<div class="row">
				<div class="col-12 rezgo-cancellation-policy-address p-helper" id="rezgo-order-company-info">
