...
class Afmb_Dashboard {
    ...
    public function add_menu() {
        add_menu_page(
            __('Afftra', 'affiliat-marketing-blocks'),
            __('Afftra', 'affiliat-marketing-blocks'),
            'manage_options',
            'afftra-blocks',
    ...
    public function enqueue_scripts($screen) {
        if ('toplevel_page_afftra-blocks' !== $screen) {
            return;
        }
        wp_enqueue_style('afftra-blocks', AFMB_URL_FILE . 'inc/dashboard/assets/css/dashboard.css', array(), '1.0.0', 'all');
    }
                    ...
                    <div class="inner-header">
                        ...
                        <div class="header-info">
                            <button class="version">
                                <?php echo esc_html('Version 1.0.0', 'affiliate-marketing-blocks'); ?>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="welcome-area">
                        <div class="welcome-text">
                            <h2 class="welcome-title">
                                <?php echo esc_html('Welcome to Afftra', 'affiliate-marketing-blocks'); ?>
                            </h2>
                            <p class="welcome-desc">
                                <?php echo esc_html("A powerful collection of custom Gutenberg blocks designed to help you showcase affiliate products in a sleek, modern, and eye-catching style directly within the WordPress editor.", 'affiliate-marketing-blocks'); ?>
                            </p>
                            <a href="https://wpafftra.gutenbergkits.com/" target="_blank" class="share-idea-btn">
                                <?php echo esc_html('Get Started', 'affiliate-marketing-blocks'); ?>
                            </a>
                        </div>
                        <div class="welcome-msg">
                            <div class="welcome-box">
                                <h3 class="box-title">
                                    <?php echo esc_html('Share your design idea', 'affiliate-marketing-blocks'); ?>
                                </h3>
                                <p class="box-desc">
                                    <?php echo esc_html('We are always looking for new ideas to improve our products. Share your design idea with us.', 'affiliate-marketing-blocks'); ?>
                                </p>
                                <a href="https://gutenbergkits.com/contact" target="_blank" class="share-idea-btn">
                                    <?php echo esc_html('Share Idea', 'affiliate-marketing-blocks'); ?>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="content-area">
                        <div class="video-area">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/HglinjEygx0?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                        <div class="plugin-info">
                            <div class="afftra-card">
                                <h4 class="card-title">
                                    <?php echo esc_html('Rate Plugin', 'affiliate-marketing-blocks'); ?>
                                </h4>
                                <p class="card-desc">
                                    <?php echo esc_html('Enjoying Afftra Blocks? Please consider leaving a 5-star review to help others discover the plugin.', 'affiliate-marketing-blocks'); ?>
                                </p>
                                <a href="https://wordpress.org/support/plugin/affiliate-marketing-blocks/reviews/" target="_blank" class="card-btn">
                                    <?php echo esc_html('Support Us', 'affiliate-marketing-blocks'); ?>
                                </a>
                            </div>
                            <div class="afftra-card">
                                <h4 class="card-title">
                                    <?php echo esc_html('Get Support', 'affiliate-marketing-blocks'); ?>
                                </h4>
                                <p class="card-desc">
                                    <?php echo esc_html('Need help with Afftra Blocks? Our support team is here to help you.', 'affiliate-marketing-blocks'); ?>
                                </p>
                                <a href="https://wordpress.org/support/plugin/affiliate-marketing-blocks/" target="_blank" class="card-btn">
                                    <?php echo esc_html('Get Support', 'affiliate-marketing-blocks'); ?>
                                </a>
                            </div>
                        </div>
