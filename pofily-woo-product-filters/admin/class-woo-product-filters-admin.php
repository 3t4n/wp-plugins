...
class VIWCPF_Woo_Product_Filters_Admin {
	...
	public function enqueue_scripts() {
		...
		if ( ( $current_screen == 'viwcpf_filter_block' ) || ( $current_screen == 'edit-viwcpf_filter_block' ) || ( $current_screen == 'viwcpf_filter_menu' ) || ( $current_screen == 'edit-viwcpf_filter_menu' ) || ( $current_screen == 'toplevel_page_viwcpf-woocommerce-product-filters' ) || ( $current_screen == 'pofily_page_viwcpf-woocommerce-product-filters-settings' ) ) {
			/*wp_enqueue_script( $this->viwcpf_woo_product_filters.'-js-form', VIWCPF_FREE_DIR_URL . 'admin/js/form.js', array( 'jquery' ), $this->version, true );*/
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-accordion', VIWCPF_FREE_DIR_URL . 'assets/js/accordion.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-checkbox', VIWCPF_FREE_DIR_URL . 'assets/js/checkbox.js', array( 'jquery' ) , $this->version, true);
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-dropdown', VIWCPF_FREE_DIR_URL . 'assets/js/dropdown.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-transiton', VIWCPF_FREE_DIR_URL . 'assets/js/transition.min.js', array( 'jquery' ), $this->version, true );
			/*wp_enqueue_script( $this->viwcpf_woo_product_filters.'-js-accordion', VIWCPF_FREE_DIR_URL . 'admin/js/accordion.min.js', array( 'jquery' ), $this->version, true );*/
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-tab', VIWCPF_FREE_DIR_URL . 'assets/js/tab.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-address', VIWCPF_FREE_DIR_URL . 'assets/js/address.min.js', array( 'jquery' ) , $this->version, true);
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-dimmer', VIWCPF_FREE_DIR_URL . 'assets/js/dimmer.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-modal', VIWCPF_FREE_DIR_URL . 'assets/js/modal.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-select', VIWCPF_FREE_DIR_URL . 'assets/js/select2.js', array( 'jquery' ) , $this->version, true);
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-dataTable', VIWCPF_FREE_DIR_URL . 'assets/js/jquery.dataTables.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-sematic-dataTable', VIWCPF_FREE_DIR_URL . 'assets/js/dataTables.semanticui.min.js', array( 'jquery' ), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . '-js-iris', admin_url( 'js/iris.min.js' ), array(
				'jquery-ui-draggable',
				'jquery-ui-slider',
				'jquery-touch-punch'
			), $this->version, true );
			wp_enqueue_script( $this->viwcpf_woo_product_filters . 'wp-color-picker-alpha', VIWCPF_FREE_DIR_URL . 'assets/js/wp-color-picker-alpha.min.js', array( 'wp-color-picker' ), $this->version, true );
		...
		if ( ( $current_screen == 'viwcpf_filter_block' ) || ( $current_screen == 'edit-viwcpf_filter_block' ) ) {
			...
			$i18n_params = array(
				...
				'i18n_price_symbol'                        => esc_html( '(' . get_woocommerce_currency_symbol() . ')' ),
			);
	...
	public function viwcpf_search_term() {
		...
		$key_search = sanitize_text_field( $_POST['keysearch'] );//phpcs:ignore WordPress.Security.NonceVerification.Missing
		$tax_search = sanitize_text_field( $_POST['tax_search'] );//phpcs:ignore WordPress.Security.NonceVerification.Missing
		if ( $key_search === '-1' ) {
	...
	public function viwcpf_refresh_block_filter() {
		...
		$exclude_str_id = sanitize_text_field( $_POST['exclude_str_id'] );//phpcs:ignore WordPress.Security.NonceVerification.Missing
		$items          = '';
