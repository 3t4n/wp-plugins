            ...
            <div class="vi-ui field">
                <div class="vi-ui labeled input fluid">
                    ...
                    <input type="text" name="filter_block_name" id="filter_block_name"
                           placeholder="<?php echo esc_attr( 'Name of filter' ) ?>"
                           value="<?php echo esc_attr( isset( $viwcpf_filter_block['name'] ) ? $viwcpf_filter_block['name'] : '' ) ?>"
                           required>
                </div>
            </div>
        ...
        <div class="vi-ui row two no-wrap item_row">
            ...
            <div class="column fourteen wide column_field">
                ...
                <select name="viwcpf_filter_tax" id="viwcpf_filter_tax"
                        ...
                        data-counts='<?php echo wp_json_encode( $array_product_tax ); ?>'>
					<?php
                    ...
                    <table id="terms_list" class="vi-ui celled table" style="width:100%">
						...
						if (
							...
							foreach ( $arr_term_id as $term_item_id ) {
								...
								?>
                                <tr data-term_id="<?php echo esc_html( $term_item_id ); ?>"
                                    data-term_name="<?php echo esc_html( $item_term_label ); ?>">
                                        ...
                                        <div class="wrap_td">
                                            <div class="vi-ui input">
                                                <input type="text"
                                                       ...
                                                       placeholder="<?php echo esc_attr( 'New Label' ) ?>"
                                                >
                                            </div>
                                        </div>
                                    </td>
