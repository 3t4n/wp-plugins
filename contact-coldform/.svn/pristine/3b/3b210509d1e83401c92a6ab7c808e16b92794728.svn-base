<?php // Contact Coldform - WP Resources Panel

if (!function_exists('add_action')) die();

function coldform_wp_resources() {
	
	$plugin_project = esc_html__('Contact Coldform', 'contact-coldform');
	...
	$array = array(
		...
		0  => '<a target="_blank" rel="noopener noreferrer" href="https://plugin-planet.com/bbq-pro/" title="Premium WP Plugin: BBQ Pro">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-bbq-pro.jpg" alt="BBQ Pro - BBQ Firewall" />
				</a>',
		...
		3  => '<a target="_blank" rel="noopener noreferrer" href="https://plugin-planet.com/usp-pro/" title="Premium WP Plugin: USP Pro">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-usp-pro.jpg" alt="USP Pro - Unlimited Front-End Forms" />
				</a>',
			
		4  => '<a target="_blank" rel="noopener noreferrer" href="https://digwp.com/" title="Take your WordPress Skills to the Next Level">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-digging-into-wordpress.jpg" alt="Digging Into WordPress" />
				</a>',
				
		5  => '<a target="_blank" rel="noopener noreferrer" href="https://wp-tao.com/" title="Learn the Way of WordPress">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-tao-of-wordpress.jpg" alt="The Tao of WordPress" />
				</a>',
				
		6  => '<a target="_blank" rel="noopener noreferrer" href="https://wp-tao.com/wordpress-themes-book/" title="WordPress Themes In Depth">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-wp-themes-in-depth.jpg" alt="WordPress Themes In Depth" />
				</a>',
				
		7  => '<a target="_blank" rel="noopener noreferrer" href="https://htaccessbook.com/" title="Optimize and Secure with .htaccess">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-htaccess-made-easy.jpg" alt=".htaccess made easy" />
				</a>',
				
		8  => '<a target="_blank" rel="noopener noreferrer" href="https://plugin-planet.com/ga-google-analytics-pro/" title="Connect Google Analytics to WordPress">
					<img width="125" height="125" src="'. $plugin_url .'images/250x250-ga-pro.jpg" alt="GA Google Analytics Pro" />
				</a>',
				
		9  => '<a target="_blank" rel="noopener noreferrer" href="https://books.perishablepress.com/downloads/wizards-collection-sql-recipes-wordpress/" title="Wizard&rsquo;s SQL Recipes for WordPress">
	...
	$title1 = esc_html__('Perishable Press Books', 'contact-coldform');
	$title2 = esc_html__('Plugin Planet: Pro WordPress Plugins', 'contact-coldform');
	$title3 = esc_html__('Donate via PayPal, credit card, or cryptocurrency', 'contact-coldform');
	
	$link1 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url1 .'" title="'. $title1 .'">'. esc_html__('books',    'contact-coldform') .'</a> ';
	$link2 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url2 .'" title="'. $title2 .'">'. esc_html__('plugins',  'contact-coldform') .'</a>, ';
	$link3 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url3 .'" title="'. $title3 .'">'. esc_html__('donation', 'contact-coldform') .'</a>. ';
	
	$message  = esc_html__('Thank you for using', 'contact-coldform') .' '. $plugin_project .'! ';
	$message .= esc_html__('Please show support by purchasing one of my', 'contact-coldform') . $link1;
	$message .= esc_html__('or', 'contact-coldform') . $link2 . esc_html__('or by making a', 'contact-coldform') . $link3;
	$message .= esc_html__('Your generous support helps to ensure future development of', 'contact-coldform') .' '. $plugin_project .' ';
	$message .= esc_html__('and is greatly appreciated.', 'contact-coldform');
	
	$donate = esc_html__('Any size donation helps me to continue developing this free plugin and other awesome WordPress resources.', 'contact-coldform');
	...
	<div id="project-wrap">
		...
		<div class="project-blurb">
			<p><strong><?php esc_html_e('Please Donate', 'contact-coldform'); ?></strong></p>
			<p><?php echo $donate; ?></p>
			<ul>
				<li><a target="_blank" rel="noopener noreferrer" href="<?php echo $url3; ?>" title="<?php echo $title3; ?>"><?php esc_html_e('Make a donation&nbsp;&raquo;', 'contact-coldform'); ?></a></li>
			</ul>
		</div>
	</div>
