<?php
    ...
    if( $wp_query->have_posts() ) :
        $post_count = 0;while( $wp_query->have_posts() ) :
            ...
            if( $post_count == 1 ){?> 
            <div class="ne-df-50 abs-excerpt anim-fade bgtitle">    
            ...
            <div class="ne-df-25 abs-excerpt anim-fade smtitle">    
                      <div class="ne-d-flex no-overflow ne-v-center post-item <?php echo Khobish_Helper::xl_post_format_icon();?>">
                      <?php if ( has_post_thumbnail() ) : ?>
                          <div class="ft-thumbwrap no-overflow">
                            <a href="<?php the_permalink();?>">
