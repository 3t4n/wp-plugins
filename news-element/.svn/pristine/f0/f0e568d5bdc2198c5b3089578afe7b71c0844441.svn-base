...
class khobish_mag16 extends Widget_Base {
	...
	protected function register_controls() {
        ...
        do_action('newsmag_flex_list', $this,'thb_','.smtitle .post-item');
        ...
        do_action('newsmag_flex_list', $this,'sb_','.bgtitle .post-item');
        ...
        do_action('newsmag_post_title_style', $this,'tt_','.bgtitle .entry_title');
        ...
        do_action('newsmag_post_title_style', $this,'st_','.smtitle .entry_title');
        ...
        do_action('newsmag_overlay_tax_style', $this,'bgct_');
