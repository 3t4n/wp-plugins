...
class khobish_backgrngd extends Widget_Base {
	...
	public function get_title() {
		return __( 'Background Grid', 'news-element' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            'lxwid',
            [
                'label' =>   esc_html__( 'Odd Column width', 'news-element' ),
                'type' =>  Controls_Manager::NUMBER,
                'default' => '33.33',
                 'selectors' => [  
                        '{{WRAPPER}} .ne-gutter .ne-df-50.khbsmgrid' => 'flex:0 0 {{VALUE}}%;width:{{VALUE}}%;',
                 ],
            ] 
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ne-gutter .ne-df-50' => 'padding: {{SIZE}}{{UNIT}} 0 0 {{SIZE}}{{UNIT}};',                    
                ],
            ]
        );
        ...
        do_action('newsmag_flex_list', $this,'s1_','.post-item');
        ...
        do_action('newsmag_overlay_tax_style', $this,'bgct');
...
if ( defined( 'ELEMENTOR_VERSION' ) && version_compare( ELEMENTOR_VERSION, '3.5.0', '>=' ) ) {
    $widgets_manager->register(new \News_Element\Widgets\khobish_backgrngd());
} else {
    $widgets_manager->register_widget_type(new \News_Element\Widgets\khobish_backgrngd());
}
