...
<?php
    if( $wp_query->have_posts() ) :
        while( $wp_query->have_posts() ) :
            ...
            if( $i == 0 ) :
            ?> 
            <div class="ne-df-66 anim-fade first bgtitle">
...
<?php
    if( $wp_query->have_posts() ) :
        while( $wp_query->have_posts() ) :
            ...
            if( $i == 2 ) :
            ?>
            <div class="ne-df-33 anim-fade second smtitle">
...
?>
        ...
        <?php
            if( $wp_query->have_posts() ) :
                while( $wp_query->have_posts() ) :
                    ...
                    ?> 
                    <div class="ne-df-100 anim-fade third bgtitle">
        ...
        <?php
            if( $wp_query->have_posts() ) :
                while( $wp_query->have_posts() ) :
                    ...
                    if( $i == $breakn + 1 ) :
                    ?> 
                    <div class="ne-df-50 fourth bgtitle anim-fade">
                        <div class="post-item no-overflow ne-d-flex ne-v-center <?php echo Khobish_Helper::xl_post_format_icon();?>">
                          <?php if ( has_post_thumbnail() ) : ?>
                              <div class="ft-thumbwrap no-overflow <?php echo Khobish_Helper::xl_post_format_icon();?>">
                                  <a href="<?php the_permalink();?>">
    ...
    <div class="ne-df-100 list anim-fade">
        <?php
            if( $wp_query->have_posts() ) :
                while( $wp_query->have_posts() ) :
                    $wp_query->the_post(); 
                    ...
                    ?> 
                        ...
                        <div class="post-item bgtitle no-overflow ne-d-flex ne-v-center <?php echo Khobish_Helper::xl_post_format_icon();?>">
                          <?php if ( has_post_thumbnail() ) : ?>
                              <div class="ft-thumbwrap no-overflow <?php echo Khobish_Helper::xl_post_format_icon();?>">
                                  <a href="<?php the_permalink();?>">
                                  <span class="icon"></span>
