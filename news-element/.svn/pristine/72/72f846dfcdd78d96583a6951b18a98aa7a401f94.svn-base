...
?>
      ...
      <?php if( $wp_query->have_posts() ) :
          while( $wp_query->have_posts() ) :
              ...
              if( $i <= 0 ) :
              ?>
              <div class="ne-df-100 firstblock anim-fade">
        ...
        <?php
            if( $wp_query->have_posts() ) :
                while( $wp_query->have_posts() ) :
                    $wp_query->the_post();                           
                    if( $i > 1 ) : ?>                                     
                    <div class="ne-df-50 secondblock anim-fade">

                      <div class="ne-d-flex abs-excerpt no-overflow post-item ne-v-center <?php echo Khobish_Helper::xl_post_format_icon();?>">
                          <?php if ( has_post_thumbnail() ) : ?>
                              <div class="ft-thumbwrap no-overflow">
                                <a href="<?php the_permalink();?>">
                                  <span class="icon khbmedia"></span>
