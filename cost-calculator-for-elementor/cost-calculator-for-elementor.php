<?php
/**
 * Plugin Name: Cost Calculator for Elementor
 * Plugin URI: https://add-ons.org/plugin/elementor-forms-cost-calculator/
 * Description: Create forms with field values calculated based in other form field values for Elementor
 * Version: 1.3.3
 * Author: add-ons.org
 * Requires Plugins: elementor
 * Text Domain: cost-calculator-for-elementor
...
class Eelementor_Cost_Calculator_Init {
    ...
    function add_form_pro(){
        ...
        include ELEMENTOR_COST_CALCULATOR_PLUGIN_PATH."superaddons/check_purchase_code.php";
        new Superaddons_Check_Purchase_Code( 
            array("plugin" => "cost-calculator-for-elementor/cost-calculator-for-elementor.php",
                "id"=>"1529",
                "pro"=>"https://add-ons.org/plugin/elementor-forms-cost-calculator/",
                "plugin_name"=> "Cost Calculator For Elementor",
...
if(!class_exists('Superaddons_List_Addons')) {  
    include ELEMENTOR_COST_CALCULATOR_PLUGIN_PATH."add-ons.php"; 
}