...
class Core {
	...
	public function init( $plugin_info ) {
		...
		$this->plugins_list     = array(
			'woo-limited-offer'     => array(
				'title'     => 'Woo Limited Offer',
				...
				'pro_link'  => 'https://grandplugins.com/product/woo-limited-offer/?utm_source=free&utm_medium=sidebar&utm_content=' . $this->plugin_info['name'],
			),
			...
			'woo-order-splitter'     => array(
				'title'     => 'Woo Order Splitter',
				'desc'      => 'Divides an order into orders based on categories, weight, dimensions, and shipping classes......',
				'thumbnail' => 'woo-order-splitter.webp',
				'pro_link'  => 'https://grandplugins.com/product/woo-order-splitter/?utm_source=free&utm_medium=sidebar&utm_content=' . $this->plugin_info['name'],
			),
			'wp-db-controller'     => array(
				'title'     => 'WP DB Controller',
				'desc'      => 'Manage your WordPress database with ease. List tables, edit rows, delete rows, empty tables, rename tables, and export data all from your website dashboard......',
				'thumbnail' => 'wp-db-controller.webp',
				'pro_link'  => 'https://grandplugins.com/product/wp-db-controller/?utm_source=free&utm_medium=sidebar&utm_content=' . $this->plugin_info['name'],
			),
	...
	public function premium_link( $links ) {
		if ( ! empty( $this->plugin_info['pro_link'] ) ) {
			$links[] = '<a target="_blank" href="' . esc_url_raw( $this->plugin_info['pro_link'] ) . '" ><b style="color:#59c767;font-weight:bolder;">' . esc_html__( 'Pro version' ) . '</b></a>';
		}
		return $links;
	}
