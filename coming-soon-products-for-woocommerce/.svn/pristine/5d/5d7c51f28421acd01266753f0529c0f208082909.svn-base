							...
							<div class="row my-5">
								<div class="col-3">
									<h6 class="col-12 mb-3">
										<?php esc_html_e( 'Z-Index', 'woo-coming-soon-products' ); ?>
										<span><?php $core->new_keyword( 'New', false ); ?></span>
										<span><?php $core->pro_btn(); ?></span>
									</h6>
								</div>
								<div class="col-9">
									<input disabled type="number" value="" class="text-center mx-auto edit edit-badge-angle" name="<?php echo esc_attr( $plugin_info['name'] . '[badge][badge_zindex]' ); ?>" >
								</div>
							</div>
