...
class ComingSoonFrontend extends ComingSoon {
	...
	public function get_coming_soon_section() {
		...
		self::disable_duplicated_content_hooked();

		// 1) Coming Soon Text.
		self::coming_soon_text( $product_id, $settings );

		self::retrieve_duplicated_content_hooked();
	...
	/**
	 * Disable Duplicated Content Hooked.
	 * 
	 * @return void
	 */
	private static function disable_duplicated_content_hooked() {
	...
	/**
	 * Retrieve Duplicated Content Hooked.
	 * 
	 * @return void
	 */
	private static function retrieve_duplicated_content_hooked() {
		if ( is_plugin_active( 'add-to-any/add-to-any.php' ) ) {
			$priority = apply_filters( 'addtoany_content_priority', 98 );
