		...
		<form id="aicw-form" class="inline-fields" method="POST" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
			<div class="aicw-form__content">
				...
				<div class="form-field">
					...
					<p class="description">
						<?php esc_html_e( 'Enter the minimum words to generate the article content. Leave empty for default.', 'ai-content-writer' ); ?>
					</p>
				</div>
				...
				<div class="form-field">
					...
					<div class="input-group">
						<input type="number" name="max_tokens" id="max_tokens" class="regular-text" placeholder="Example: 1000"/>
					</div>
					<p class="description">
						<?php esc_html_e( 'Enter the maximum tokens for the ChatGPT API. Leave empty for default.', 'ai-content-writer' ); ?>
					</p>
				</div>
				<div class="form-field">
			...
			<div class="aicw-form__aside">
				...
				<div class="aicw__sidebar">
					...
					<div class="aicw__sidebar__footer">
