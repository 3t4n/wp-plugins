...
class MLMSoftPlugin
{
    ...
    /**
     * Const TRANSLATION_DOMAIN changed from 'mlmsoft_v3_plugin' to 'mlmsoft-integration'.
     *
     * @since 3.8.4
     */
    const TRANSLATION_DOMAIN = 'mlmsoft-integration';
    ...
    public function __construct()
    {
        ...
        load_plugin_textdomain( 
            ...
            false, 
            dirname( plugin_basename( MLMSOFT_V3_PLUGIN_FILE) ) . '/languages' 
        );
    }
    ...
    public static function translate($message, $params = [])
    {
         ...
         * @since 3.8.4
         */
        $filtered_message = apply_filters('mlmsoft_integration_translate', null, $message, $params);
        
        if ( ! is_null($filtered_message) ) {
