...
class MLMSoftEWalletGateway extends WC_Payment_Gateway
{
    ...
    {
        /**
         * @since 3.6.7 Added `key` prop.
         * @since 3.7.2 Added `simple-number-input` prop.
         */        
        $props = [
            'key' => time(),
            'simple-number-input' => false
        ];
        
        /**
         * Filters the properties for EWallet payment component.
         *
         * @since 3.7.2
         *
         * @param array $props Array of properties.
         */
        $props = apply_filters('mlmsoft_integration_ewallet_payment_component_props', $props);
        
        $this->componentLoader->showComponent('e-wallet-payment', $props);
    }

    public function process_payment($order_id)
    {
        /**
         * @since 3.7.1 Added filter.
         */
