      ...
      <div class="col-md-12 mt-30">
        <div class="sortCard ">
          <div class="sortdWizrd">
            ...
            <h5 class="sortHed-1">
              <span style="font-size:4em;"> Welcome</span>
            </h5>
            ...
            <form action="<?php echo wp_kses_data($console_url); ?>/onboard/get-started" method="post" id="getstartedform">
              ...
              <input type="hidden" name="logo_url" class="logourl" value="<?php if (is_array($image)) {
              ...
              <input type="hidden" name="og_data" class="og_data" value='<?php if (isset($resultog)) {
                                                                            echo esc_attr($resultog);
                                                                          } ?>'>
