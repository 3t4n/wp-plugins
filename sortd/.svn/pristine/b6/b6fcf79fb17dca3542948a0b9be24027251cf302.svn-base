...
<style type="text/css">
  ...
  .copyTxt {
    background: -moz-linear-gradient(left, rgba(255, 255, 255, 0.65) 26%, rgba(255, 255, 255, 1) 98%, rgba(255, 255, 255, 1) 100%);
    /* FF3.6-15 */
    background: -webkit-linear-gradient(left, rgba(255, 255, 255, 0.65) 26%, rgba(255, 255, 255, 1) 98%, rgba(255, 255, 255, 1) 100%);
    /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to right, rgba(255, 255, 255, 0.65) 26%, rgba(255, 255, 255, 1) 98%, rgba(255, 255, 255, 1) 100%);
                ...
                <?php if (isset($project_domains->data->acm_validation_data) && !empty($project_domains->data->acm_validation_data[0]->ResourceRecord->Name) && !empty($project_domains->data->acm_validation_data[0]->ResourceRecord->Value)) { ?>
                  ...
                  <table class="table cNmtable">
                    ...
                    <tbody>
                      <tr>
                        <td class="txtFlw">
                          <p class="copyname"><?php echo wp_kses_data($project_domains->data->acm_validation_data[0]->ResourceRecord->Name); ?></p> <span class="copied1" style="display:none">copied</span><span class="copyTxt coname tooltiptext" title="Copy"><i class="bi bi-back"></i></span>
                        </td>
                        <td>CNAME</td>
                        <td class="txtFlw">
                          <p class="copyvalue"><?php echo wp_kses_data($project_domains->data->acm_validation_data[0]->ResourceRecord->Value); ?></p><span class="copied" style="display:none">copied</span> <span class="copyTxt covalue tooltiptext" title="Copy"><i class="bi bi-back"></i></span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="cNam">
                ...
                <table class="table cNmtable">
                  ...
                  <tbody>
                    <tr>
                      <td class="txtFlw">
                        <p class="copyname"><?php echo wp_kses_data($project_domains->data->public_host); ?></p> <span class="copied1" style="display:none">copied</span><span class="copyTxt coname tooltiptext" title="Copy"><i class="bi bi-back"></i></span>
                      </td>
                      <td>CNAME</td>
                      <td class="txtFlw">
                        <p class="copyvalue"><?php echo wp_kses_data($project_domains->data->public_host_cname); ?></p><span class="copied" style="display:none">copied</span> <span class="copyTxt covalue tooltiptext" title="Copy"><i class="bi bi-back"></i></span>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<script>
  <?php echo wp_kses_data($chatbot_dashboard_data->data); ?>
</script>
