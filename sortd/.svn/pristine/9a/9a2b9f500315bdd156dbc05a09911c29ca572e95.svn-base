                            ...
                            <div class="check-bxFld">
                                <?php foreach ($v['taxonomy_type'] as $key => $value) { ?>
                                    ...
                                    ?>
                                            ...
                                            <input type="checkbox" <?php if ($value['taxonomy_slug'] === 'category' || $value['taxonomy_slug'] === 'post_tag') {
                                                                        echo 'disabled';
                                                                    } ?> name="custom_taxonomy_name" id="custom_taxonomy_id_<?php echo wp_kses_data($value['taxonomy_slug']); ?>" data-current_user="<?php echo esc_attr($current_user); ?>" data-wp_domain="<?php echo esc_attr($wp_domain); ?>" data-project_slug="<?php echo esc_attr($project_slug); ?>" data-postname="<?php echo wp_kses_data($v['postype_name']) ?>" class="custom_taxonomy_class" data-taxonomyname="<?php echo wp_kses_data($valueV) ?>" data-postslug="<?php echo wp_kses_data($v['postype_slug']) ?>" data-taxonomyslug="<?php echo wp_kses_data($value['taxonomy_slug']); ?>">
