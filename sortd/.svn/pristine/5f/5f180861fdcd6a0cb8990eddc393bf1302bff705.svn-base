          ...
          <div class="afterStartSetup finalsetup" style="display:none">
            ...
            <div class="setupAction bdr2" style="display:none">
              <div class="msgbox oneSetCongrt">
                ...
                <button class="nextSet btn-ad-blu speedBtn NextSpeedBtn">Next</button>
                <input type="hidden" id="hiddenpageinsightsnonce" value="<?php echo wp_kses_data(wp_nonce_url(admin_url() . "admin.php?page=sortd-settings&section=pageinsights", SORTD_NONCE)); ?> ">
