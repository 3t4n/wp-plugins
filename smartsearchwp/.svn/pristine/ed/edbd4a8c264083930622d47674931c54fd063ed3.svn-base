...
You can find more information about OpenAI by following this link: [OpenAI](https://openai.com/) and consult their privacy policy here: [OpenAI privacy policy](https://openai.com/policies/terms-of-use)
...
**OpenAI Integration**: Powered by ChatGPT3.5 & ChatGPT4o for quick and natural responses.
...
4. Ensure that you have an API key from OpenAI to use the chatbot.
5. Generate and activate the embeddings for the pages and posts you want to use.
6. Customize the chatbot's context by selecting the pages and posts you want to include or exclude.
7. Ensure that CURL and allow_url_fopen are enabled on your server.
8. Enjoy the chatbot on your website!
