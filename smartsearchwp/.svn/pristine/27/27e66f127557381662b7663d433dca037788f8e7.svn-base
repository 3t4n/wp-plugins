...
define( 'WDGPT_CHATBOT_VERSION', '2.5.1' );

// Définition de la constante globale pour le mode debug
if ( ! defined( 'WDGPT_DEBUG_MODE' ) ) {
    define( 'WDGPT_DEBUG_MODE', get_option( 'wdgpt_debug_mode', 'off' ) === 'on' ? true : false );
}
