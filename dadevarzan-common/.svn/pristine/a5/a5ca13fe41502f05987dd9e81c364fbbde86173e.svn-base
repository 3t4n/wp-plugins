...
class DV_DadevarzanShortCode
{
    ...
    {
        add_shortcode( 'dv-powered-by', array($this,'add_poweredby_shortcode') );
    }

    public function add_poweredby_shortcode( $attributes )
    {
        ...
        switch ( $array['category'] ) {
            ...
            case 'company':
                ...
                $url = 'https://www.dadevarzan.com/web-design/company/';
                break;
        ...
        return '
                <p class="dadevarzan-powered-by">'.$title.__('by', 'dadevarzan-wp-common').'  
                    <a href="https://www.dadevarzan.com/" rel="nofollow" target="_blank">'.__('Dadevarzan Co.', 'dadevarzan-wp-common').'</a>&nbsp;
                        <svg version="1.1" id="dv_power_by_layer_1" class="power-by-image-container" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="703.784px" height="155.305px" viewBox="0 0 703.784 155.305" style="enable-background:new 0 0 703.784 155.305;"
                     xml:space="preserve">
                    <path  class="dv-logo dv-dadevarzan" d="M332.087,62.928c22.708-0.618,38.415,0.518,51.692,8.843c4.035,2.53,8.203,6.484,10.525,10.704
                        ...
                        c5.814-17.524,16.223-29.061,32.746-35.833c3.212-1.317,6.781-1.912,10.292-2.792c1.793-0.155,3.587-0.31,5.38-0.465
                        ...
                        <path class="dv-logo dv-arm" d="M670.556,53.714c-3.869,14.433-10.086,23.951-15.555,27.937c0.903,5.03,2.631,6.836,2.089,18.186
                        c5.314-5.185,16.187-6.733,28.014-3.173c12.15-13.388,13.736-28.401,12.691-32.348C696.403,61.259,676.011,53.018,670.556,53.714z
                         M671.949,100.842c-10.751,0.148-14.6,6.534-20.275,16.638c-5.41,10.394-9.787,21.927-9.905,20.74
                        c-0.58-5.804,9.441-26.823,9.364-42.33c0.493-18.162-12.446-28.966-17.476-31.598c-1.857,1.393-16.226,7.423-17.27,31.365
                        c0.396,17.044,9.247,35.424,9.441,42.872c-2.487-1.819-9.856-29.825-22.829-36.449c-12.922-4.466-25.001,3.992-28.246,2.012
                        c1.102,3.453-1.099,16.956,1.78,23.371c2.571,6.806,8.166,9.608,15.886,11.231c5.391,1.2,12.708-0.706,18.009,1.229
                        c7.313,2.554,23.371,16.096,23.371,16.096s9.34-8.313,19.811-14.471c8.493-4.624,12.171-1.408,20.507-2.708
                        c4.943-1.031,13.118-2.762,16.483-10.37c3.692-6.81,0.866-21.107,2.089-24.299C689.082,105.473,682.766,100.644,671.949,100.842z
                         M610.581,99.682c-1.776-20.026,10.996-36.32,20.662-40.86c6.074-2.853,15.013,7.893,15.013,7.893s13.771-14.44,21.746-22.984
                        c3.781-4.051,5.217-4.554,5.649-8.977c-2.306-19.155-40.563-38.44-68.874-25.073c-29.812,14.076-44.838,52.762-20.585,86.673
                        C600.409,90.78,610.396,99.675,610.581,99.682z M608.956,42.803c13.209-8.97,23.566,1.616,24.532,2.941
                        c0.422,0.579-0.193,1.973-1.161,3.173c-0.695,0.861-13.347,15.013-19.192,20.198c-1.663,1.177-3.037,0.82-3.56,0.464
                        C607.657,68.274,596.827,53.029,608.956,42.803z"/>
