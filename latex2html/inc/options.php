...
if(!class_exists('l2h_default_options_class')) {
    class l2h_default_options_class implements l2h_default_options_interface
    {
        ...
        public static $mathjax_config = "MathJax.Hub.Config({
          tex2jax: {
            inlineMath : [['$', '$'], ['\\\\(', '\\\\)']],
            displayMath: [['$$', '$$'], ['\\\\[', '\\\\]']],
            processEscapes: true
        ...
        public static $latex_cmd = '\\newcommand{\\eps}{\\varepsilon}
        \\newcommand{\\RR}{\\mathbb{R}}
        \\newcommand{\\rd}{\\operatorname{d}}
        \\newcommand{\\set}[1]{\\left\\{#1\\right\\}}';
        
        public static $latex_style = '.latex_thm, .latex_lem, .latex_cor, .latex_defn, .latex_prop, .latex_rem{
        ...
        public static $bibdata_examp = '@article {EinsteinInfeldHoffmann1938Gravitational,
