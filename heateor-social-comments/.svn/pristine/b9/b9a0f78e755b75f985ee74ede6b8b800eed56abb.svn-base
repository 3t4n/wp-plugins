...
Tags: social comments, social commenting, facebook comments, vkontakte comments, vkontakte commenting, disqus comments, google+ comments, comments notification, facebook comment notification, comment moderation, comments, wordpress comments, social plugin
Requires at least: 2.5.0
Tested up to: 6.7
Stable tag: 1.6.3
License: GPLv2 or later

Integrate Facebook Comments, Vkontakte Comments and/or Disqus Comments along with default comment form at your WordPress website

== Description ==
**Note:**
If you want to integrate only Facebook Comments, you should install <a target="_blank" href="https://wordpress.org/plugins/fancy-facebook-comments/">Fancy Comments</a> instead.
...
3. **Disqus Comments**: Disqus Comments active in tabbed interface
4. **Stacked Interface**: Disqus Comments and Facebook Comments active in stacked layout

== Changelog ==
= 1.6.3 =
* [Improvement] Updated the Facebook SDK being used throughout the plugin to the version 17.0
