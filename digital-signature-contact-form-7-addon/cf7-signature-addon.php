 ...
 * @wordpress-plugin
 * Plugin Name:       Contact Form 7 digital signature add-ons by ApproveMe.com
 * Plugin URI:
 * Description:       Contact Form 7 digital signature add-ons
 * Version:           1.8.2
 * Author:            ApproveMe.com
 * Author URI:        https://www.approveme.com/contact-form-7-signature-plugin/?utm_source=wprepo&utm_medium=link&utm_campaign=contact-form-7
 * License:           GPLv2+
 ...
 * Define constants
 */
define( 'CF7_WPESIGNATURE_VER', '1.8.1' );
...
require_once( plugin_dir_path( __FILE__ ) . 'admin/includes/esig-cf7-function.php' );
...
//if (is_admin()) {
    ...
    add_action( 'plugins_loaded', array( 'esignCf7RatingWidget', 'get_instance' ) );
