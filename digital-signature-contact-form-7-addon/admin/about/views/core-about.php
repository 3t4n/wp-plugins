                    ...
                    <header class="about-header-container">
                        ...
                        <div class="right-section">
                            ...
                            if (!$esigStatus || $esigStatus == 'no_wpe') {
                                ...
                                $headerOneURL = 'https://www.approveme.com/' . esc_attr($about_options['plugin-slug']) . "-special-pricing/?utm_campaign=wprepo";
                ...
                <div id="approveme-about-container">
                    <div class="hero-text">
                        ...
                        switch ($esigStatus) {
                            ...
                            case 'no_wpe':
                            default:
                                echo 'Connect your ' . esc_attr($single_name) . ' with the #1 document signing tool built for WordPress websites.';
                                break;
                        }
                        ?>
                            ...
                            ?>
                                ...
                                case 'wpe_active_pro':
                                    ...
                                    if ($esigStatus == 'wpe_active_basic') {
                                        ...
                                        $extraCTA = '<a href="' . esc_url($about_options['main-cta']) . '" class="button-border" title="Learn more about this integration">Learn more about this integration</a>';
                                    } else {
                                ...
                                ?>
                                    <p>
                                        ...
                                        Meet WP E-Signature, an easy-to-use, reliable WordPress plugin that gives you the eSignature & Contact form 7 automation tools you need to protect your business (while saving you a ton of money and time).
                                    </p>
                    ...
                    <div class="flex-container">
                        ...
                        <div class="right-col center">
                            ...
                            <br />
                            <a href="<?php echo esc_attr($about_options['main-cta']); ?>/&utm_medium=snipbar&utm_source=<?php echo esc_attr($single_name_without_space); ?>#letschat" target="_blank" class="button-border-block" align="center">Got a question?</a>
