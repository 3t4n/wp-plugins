...
📋 [**DEMO & DESCRIPTION**](https://avirtum.com/ifolders-ultimate-folders-manager-for-wordpress/) 📋
🔥 [**DON’T DELAY, BE PRO TODAY!!!**](https://1.envato.market/getifolders) 🔥

[youtube https://youtu.be/90xmu-3dPjA]
...
* [WP Bakery](https://wpbakery.com/) - create any layout with intuitive way
...
= 2.8.0 =
* Fix: compatibility with the WooCommerce Advanced Bulk Edit plugin
* Mod: removed uninstall functionality; users should use the plugin tools to delete all data
...
= 2.6.0 =
* Fix: issue where the empty list in the Elementor Display Conditions was not functioning as expected
