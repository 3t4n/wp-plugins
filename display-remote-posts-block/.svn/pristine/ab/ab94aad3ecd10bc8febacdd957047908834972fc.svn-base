...
if (!class_exists('drpbCommon')) {
	...
	class drpbCommon {
        ...
        public static $plugin_name = 'Display Remote Posts Block';
        public static $plugin_prefix = 'drpb';
        public static $plugin_text_domain = 'display-remote-posts-block';
		...
		public static function plugin_version() {
            ...
            return display_remote_posts_block_class::$version;
