...
class Accessibility_Onetap_Settings_Options {
	...
	public function register_admin_menu_page() {
		add_menu_page(
			...
			'dashicons-universal-access-alt',  // URL icon SVG.
			30 // $position.
		);
		...
		$settings_fields = array(
			'onetap_settings' => array(
				array(
					...
					'site_description'  => __( 'Choose your preferred language for the plugin’s interface.', 'accessibility-onetap' ),
					'desc'              => '',
					'type'              => 'select',
				...
				array(
					...
					'site_description'  => __( 'Set your own branding colors to personalize the plugin’s appearance.', 'accessibility-onetap' ),
					'desc'              => '',
					'type'              => 'color',
				...
				array(
					...
					'site_description'  => __( 'Adjust the position of widgets to fit your layout preferences.', 'accessibility-onetap' ),
					'desc'              => '',
					'min'               => 0,
					'max'               => 1000,
					'step'              => 1,
			...
			'onetap_modules'  => array(
				...
				array(
					...
					'status'            => true,
					'callback'          => 'callback_template_checkbox',
					'default'           => Accessibility_Onetap_Config::get_module( 'align_text' ),
					'sanitize_callback' => 'sanitize_text_field',
				),
				array(
					'name'              => 'text-magnifier',
