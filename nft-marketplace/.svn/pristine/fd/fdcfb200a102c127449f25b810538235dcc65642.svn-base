									...
									<form enctype="multipart/form-data" method="post" action="" class="mo_nft_upload_metadata_form" style="overflow-y: auto;">
										...
										<div class="form-row">
											...
											<div class="mo-nft-form-group col-md-12">
												...
												<textarea type="text" name="collection_name" id="collection_name" maxlength="1000"><?php echo isset( $collection_name[0] ) ? esc_attr( $collection_name[0] ) : ''; ?></textarea>
											</div>
											<div class="mo-nft-form-group col-md-12">
												<label>
													<h5>Enter Collection description</h5>
												</label>
												<textarea type="text" name="collection_description" id="collection_description" maxlength="1000"><?php echo isset( $collection_description[0] ) ? esc_attr( $collection_description[0] ) : ''; ?></textarea>
											</div>
											<div class="mo-nft-form-group col-md-12">
												<label>&nbsp;</label>
