...
use MoNft\View\MoNftPremiumPlan;
use MoNft\view\DemoTrial;
...
if ( ! class_exists( 'MoNft\Base\BaseStructure' ) ) {
	...
	class BaseStructure {
		...
		public function admin_menu() {
			...
			$premium_plan_logo = $mo_nft_plugin_dir_url . 'classes/resources/images/prem.png';
			$slug              = 'mo_nft_settings';
			...
			add_submenu_page(
				$slug,
				'License',
				'<div style="color:orange;display:flex;align-items:center;gap:5px;"><img src="' . esc_url( $premium_plan_logo ) . '" alt="miniOrange Premium Plans Logo" style="height:16px;width:16px;">' . __( 'Premium Plans', 'miniOrange NFT Marketplace' ) . '</div>',
				'administrator',
				'?page=mo_nft_settings&tab=licensing'
			);
		}
...
<div class="mo-nft-header-wrap">		
	...
	<div class="container-fluid">
		...
		<div>
		<a href="<?php echo esc_url( $mo_nft_plugin_admin_url ) . 'admin.php?page=mo_nft_settings&tab=licensing'; ?>"  class=" mo-nft-premium-plan-btn btn" id="mo-nft-premium-plan"><b>Premium Plans</b><img class="mo-nft-premium-plan-logo" src="<?php echo( esc_url( $premium_plan_logo ) ); ?>" height="24px"/></a>
		<a href="<?php echo esc_url( $mo_nft_plugin_admin_url ) . 'admin.php?page=mo_nft_settings&tab=demo_trial_request'; ?>" class=" mo-nft-btn btn" id="mo-nft-setup-guide">Demo Trial Request<img class="mo-nft-redirect_ic" src="<?php echo( esc_url( $redirect_ic ) ); ?>" height="24px"/></a>
		<a href="<?php echo esc_url( \MoNft\Constants::SET_UP_GUIDE_LINK ); ?>" target="_blank" class=" mo-nft-btn btn" id="mo-nft-setup-guide">Set Up Guide<img class="mo-nft-redirect_ic" src="<?php echo( esc_url( $redirect_ic ) ); ?>" height="24px"/></a>
		<a href="<?php echo esc_url( \MoNft\Constants::WEB3_SUITE_LINK ); ?>" target="_blank" class=" mo-nft-btn btn" id="mo-nft-other-solutions">Other Web3 Solutions<img class="mo-nft-redirect_ic" src="<?php echo( esc_url( $redirect_ic ) ); ?>" height="24px"/></a>
		</div>
	</div>
	</nav>				
</div>
...
<div class="mo-nft-support-div">
	<div>
		<div class="monft-help-container">
			<span class="span1">
				<div class="need">
				<span class="span2"></span>
					<div class="div11" style="text-align: center;">
					<div class="div12" style="position: relative;">
						<a href="#" class="close-icon" style="position: absolute; top: 5px; right: 10px; font-size: 13px;">&#10006;</a> <!-- Close icon -->
						<span style="font-family:Trebuchet MS, Helvetica, sans-serif;color:#333333;">
							Hello there! 
						</span>
						<br>
			...
			<div class="container mo_nft_container">
				<div class="row">
					...
					<div class="col-9 mo-nft-tab-content">
						...
						$licensing                  = new MoNftPremiumPlan();
						$demo_trial                 = new DemoTrial();
						...
						switch ( esc_attr( $currenttab ) ) {
							...
							case 'licensing':
									$licensing->render_licensing_ui();
								break;

							case 'demo_trial_request':
									$demo_trial->render_demo_trial_ui();
								break;
