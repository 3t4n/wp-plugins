			...
			<script>
				...
				function getChainDetails(chain, chainSymbol) {
					...
					switch (chain) {
						...
						ChainDetails["name"] = "Polygon";
						ChainDetails["chainId"] = "0x89";
						ChainDetails["url"] =
							"https://polygon-mainnet.infura.io";
						ChainDetails["currName"] = "Matic";
						ChainDetails["blockUrl"] = "https://polygonscan.com/";
						break;
						case "amoy":
						if (!chainSymbol) {
							ChainDetails["chainSymbol"] = "MATIC";
						}
						ChainDetails["name"] = "Amoy";
						ChainDetails["chainId"] = "0x13882";
						ChainDetails["url"] =
							"https://rpc-amoy.polygon.technology";
						ChainDetails["currName"] = "Matic";
						ChainDetails["blockUrl"] = "https://amoy.polygonscan.com/";
						break;
						case "Goerli":
						if (!chainSymbol) {
