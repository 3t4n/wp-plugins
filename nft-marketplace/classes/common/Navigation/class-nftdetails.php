...
if ( ! class_exists( 'MoNft\Navigation\NftDetails' ) ) {
	...
	class NftDetails {
		...
		public function view() {
			...
			$chain_currency           = ( 'amoy' === $chain ? 'Matic' : 'Eth' );
			$nft_owner                = 'No Owner';
			if ( ! empty( $token_id ) ) {
					$headers = array(
					...
					} elseif ( 'Polygon' === $chain || 'amoy' === $chain ) {
            ...
            <div class="container" style="margin-top:6%;">
               ...
               <div class="flex-container">
                  <div class="left-section">
                     ...
                     <!-- Example content -->
                     <div>';
						$content     .= '<img class="nft-image" src="' . ( ! empty( $token_id ) ? esc_attr( $image_cid ) : esc_attr( $attachment_url ) ) . '" /> 
                     </div>
                  </div>
