...
* **Supported Blockchains ->** ***Sepolia*** (Ethereum testnet) and ***Amoy*** (Polygon testnet).
...
= 3.2.1 =
* Added Demo trial option.
* Fixed minor bugs related to NFT filtering
* UI Improvements
* Added Amoy Blockchain support
