...
Contributors: autoglot
Tags: translation, localization, automatic translation, translate, machine translation, multilingual, languages, seo, ai, artificial intelligence, website translation, multilanguage, international
...
1. Download our plugin from the [official WordPress plugin storage](https://wordpress.org/plugins/autoglot/) and install it on your site.
1. Register in our [Autoglot Control Panel](https://cp.autoglot.com/signup) and receive your unique API key.
1. Finally, add this API key to your Autoglot plugin and choose as many languages as you want for your new multilingual website!
...
1. **Shortcode**. Alternatively, you can use a [ag_switcher] shortcode to add a language switcher to your website posts, pages, popups, etc. See FAQ section for more information about shortcode options.
1. **Popup**. Finally, you can enable a popup language switcher. This will add a floating box to your website. By clicking on this box, users will see a popup window with language switcher. This is the best solution if you don't want to add widgets or shortcodes to your website.
...
1. Create an account in your Control Panel at [https://cp.autoglot.com/signup](https://cp.autoglot.com/signup). You will already have an initial translation balance that can be used to check the functionality of our plugin.
1. Find and copy your Access Key from your Autoglot Control Panel. This looks like “AG_XXXXXXXXXXXXXXXXXXXXX”. This key should be kept secret and never shared with anyone.
1. Paste your Access Key in your Autoglot settings page in your WordPress website or blog.
1. Choose your default language and any number of languages you want your site or blog translated to. We recommend starting with only one language to check your website functionality and then add additional languages if you need them.
1. Enable Autoglot plugin. You can choose translation to be available for site administrator only.  In this way, your visitors will not see the live translation until you check and make sure your website or blog looks good.
1. You can modify additional settings like hreflangs tags, sitemap files, external links, and so on.
1. Choose one or more options of how users can switch languages: widgets, shortcodes, or floating box with popup window.
1. Enjoy your new websites! Autoglot will create a separate version of your website in every new language with a unique easily scannable and crawlable URLs.
...
- For more information, please check our [pricing page](https://autoglot.com/pricing/).

= What is a "Translation Balance"? =

- This is number of words you can translate. You can check and replenish your translation balance via your [control panel](https://cp.autoglot.com/) using a credit card. For pricing information, please check our [pricing page](https://autoglot.com/pricing/).
...
1. [ag_switcher type = "flagslist"] – large flags.
1. [ag_switcher type = "languageflagslist"] – list of languages with flags.
1. [ag_switcher type = "languagelist"] – list of languages without flags (default).
...
We currently support these languages. The more languages are coming soon. If you have special requests, do not hesitate to [contact our support](https://autoglot.com/contact-support/).
...
= 2.5.11 =
Improvements in "Links Modifier" tool

= 2.5.7 =
Improved support of WooCommerce
...
= 2.2.1 =
Improved support of caching plugins

= 2.1.1 =
Improvements in language switcher: new "neutral" flags and language names in own languages

= 2.0.5 =
Major update! Greatly improved page parsing, processing and translation.

== Screenshots ==

1. Copy your API key from your Autoglot Control Panel and enable translation
2. Choose as many languages as you need for translation
3. Add a widget with language selector
4. Enjoy new visitors on your SEO optimized translated multilingual website
...
= 2.5.0 (06/12/2024) =
**Autoglot Introduces Basic Support of WooCommerce!**
...
= 2.4.0 (04/09/2024) =
**Autoglot Introduces "URL Translation" for better SEO and UX!**
