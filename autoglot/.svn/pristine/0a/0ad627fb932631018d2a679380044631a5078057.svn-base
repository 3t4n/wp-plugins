...
class autoglot_consts {
    ...
    */
    const LANGUAGES = array(
        'af' => array("name" => "Afrikaans", "oname" => "Afrikaans", "flag" => "af", "locale" => "af_ZA"),
        'sq' => array("name" => "Albanian", "oname" => "Shqip", "flag" => "al", "locale" => "sq_AL"),
        ...
        'bn' => array("name" => "Bengali", "oname" => "বাংলা", "flag" => "bd", "locale" => "bn_BD"),
        ...
        'jw' => array("name" => "Javanese", "oname" => "ꦧꦱꦗꦮ", "flag" => "id", "locale" => "jv_ID"),
        'kk' => array("name" => "Kazakh", "oname" => "Қазақ тілі", "flag" => "kz", "locale" => ""),
        'ko' => array("name" => "Korean", "oname" => "한국어", "flag" => "kr", "locale" => "ko_KR"),
        'ky' => array("name" => "Kyrgyz", "oname" => "Кыргыз", "flag" => "kg", "locale" => "ky_KY"),
        ...
        'ur' => array("name" => "Urdu", "oname" => "اردو", "flag" => "pk", "locale" => ""),
    ...
    const LANGUAGE_SWITCHER_POSITIONS = array(
				'bottomright',//default
				'bottomleft',
				'topright',
				'topleft',
    ...
    const PHP_EXTENSIONS = ['php', 'html', 'htm', 'phtml', 'asp', 'aspx', 'cgi', 'jsp', 'jspx'];
}

//Define for autoglot plugin version
define('AUTOGLOT_PLUGIN_VER', '2.5.11');
