...
/*        if($default1)
    ...
    function __construct(&$autoglot) {
        ...
        $option = get_option('autoglot_translation_floatbox_position', array(autoglot_consts::LANGUAGE_SWITCHER_POSITIONS[0]));
        $this->floatbox_position = in_array($option[0], autoglot_consts::LANGUAGE_SWITCHER_POSITIONS, true)?$option[0]: "";
