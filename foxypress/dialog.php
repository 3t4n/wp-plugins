...
<script type="text/javascript" language="javascript">
	...
	function InsertCategory()
	{
		...
		FoxyPressDialog.InsertCategoryListing(document.getElementById('foxy_category_listing').value, document.getElementById('foxy_show_image').value, document.getElementById('foxy_show_thumbs').value, document.getElementById('foxy_show_description').value, document.getElementById('foxy_show_addtocart').value, document.getElementById('foxy_paging_items').value, document.getElementById('foxy_paging_itemsperrow').value, document.getElementById('foxy_show_moredetail').value, document.getElementById('foxy_order').value, document.getElementById('foxy_orderby').value);
	}
...
function ShowCategoryListing()
{
    ...
    <form method="POST" name="foxy_inventory_listing_frm" id="foxy_inventory_listing_frm">
    	<table class="center">
            ...
            <tr>
            	<td><span class="DialogHeading"><?php _e('Show Product Image', 'foxypress'); ?>:</span> </td>
            	<td>
                	<select id="foxy_show_image" name="foxy_show_image">
            ...
            <tr>
             	<td><span class="DialogHeading"><?php _e('Show Product Thumbnail Images', 'foxypress'); ?>:</span> 
             	<p><small><em>Only applicable if Show Product Image is</em> Yes</small></p></td>
            	<td>
                	<select id="foxy_show_thumbs" name="foxy_show_thumbs">
                    	<option value="0"><?php _e('No', 'foxypress'); ?></option>
                        <option value="1"><?php _e('Yes', 'foxypress'); ?></option>
                    </select>
                </td>
            ...
            <tr>
            	<td><span class="DialogHeading"><?php _e('Show Product Description', 'foxypress'); ?>:</span> </td>
            	<td>
                	<select id="foxy_show_description" name="foxy_show_description">
                        <option value="1"><?php _e('Yes', 'foxypress'); ?></option>
                    	<option value="0"><?php _e('No', 'foxypress'); ?></option>
                    </select>
                </td>
            ...
            <tr>
            	<td><span class="DialogHeading"><?php _e('Order By', 'foxypress'); ?>:</span> </td>
            	<td>
                	<select id="foxy_orderby" name="foxy_orderby">
                    	<option value="post_title"><?php _e('Product Name', 'foxypress'); ?></option>
                        <option value="post_date"><?php _e('Date Created', 'foxypress'); ?></option>
                        <option value="post_modified"><?php _e('Date Modified', 'foxypress'); ?></option>
                        <option value="ID"><?php _e('Post ID', 'foxypress'); ?></option>
                        <option value="sort_order"><?php _e('Inventory Order', 'foxypress'); ?></option>
                    </select>
                </td>
            </tr>

            <tr>
            	<td><span class="DialogHeading"><?php _e('Order', 'foxypress'); ?>:</span> </td>
            	<td>
                	<select id="foxy_order" name="foxy_order">
                    	<option value="ASC"><?php _e('ASC', 'foxypress'); ?></option>
                        <option value="DESC"><?php _e('DESC', 'foxypress'); ?></option>
                    </select>
                </td>
            </tr>
