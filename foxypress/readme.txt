...
= 0.4.11 =
* Bugfix: Shortcode fix for descriptions.

= 0.4.10 =
* Feature: Added the ability to show/hide product description, image, thumbnails for product shortcodes and cleaned up overall shortcode functionality.

= 0.4.9 =
* Feature: Updated all pages of the FoxyPress back-end styling to not only be more responsive, but match WordPress a bit better.

= 0.4.8 =
* Bugfix: FoxyPress 2.0 Compability while still using Colorbox for images
* Feature: Custom Order form now pulls dynamically from FoxyCart Store customer list
* Feature: Customer list now present from FoxyCart Store with ability to filter and view transactions for that customer.

= 0.4.7.2 =
* Bugfix: WordPress 4.0 compatibility. Media attachments fix.

= 0.4.7 =
* Updated: Shortcode for product list can now be ordered by name, date created, date updated, ID, and menu order in ascending or descending order. (Default of alphabetical ascending)
* Bugfix: WordPress 4.0 compatibility. Shortcode button previously did not display on WYSIWYG editor.
...
* Updated: Product database export from the Import/Export page will now include all product images for each product.

= 0.4.5 =
* Bugfix: FoxyPress store template caching was not working with Version 1.1
