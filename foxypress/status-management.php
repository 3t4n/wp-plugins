            ...
            <form id="statusForm" name="statusForm" method="POST">
            	<table style="float:left; width:650px">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" value="1" <?php echo (($drStatus->foxy_transaction_status_email_flag == "1") ? "checked='checked'"  : "") ?> id="foxy_sm_status_email_flag" name="foxy_sm_status_email_flag" /> <p><small>If this is checked, the customer will be emailed when the status on their transaction is changed to this status</small></p></td>
                    </tr>
                    <tr>	
                    ...
                    <tr>	
                        ...
                        <td>
                            ...
                            <script type="text/javascript">
								CKEDITOR.replace( 'foxy_sm_status_email_body',{width:"350"} );
							</script>
                        </td>
                    </tr>
                    <!--<tr>
            ...
            <div style="float: left; width: 98%; clear: both;" class="inside">
                <table cellspacing="5" cellpadding="5">
                    <tr>
                        ...
                        <td><input type="submit" name="foxy_sm_new_status_submit" id="foxy_sm_new_status_submit" class="button button-primary bold" value="<?php _e('Save','foxypress'); ?> &raquo;" /></td>
                    </tr>
                </table>
            </div>
