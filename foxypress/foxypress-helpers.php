...
/***************************************************************************************************/
/**
 * Get all product information of a certain product, given a product ID.
 * 
 * @param int $inventory_id Product ID of the product to return
 * @param bool $legacy_images Boolean to retrieve inventory images through an old method by the post they're attached to
 *
 * @return array A sorted array of found products and corresponding pagination based on results and items per page.
 */
...
/**
 * Get the quantity sold of a certain product
 * 
 * @param int $inventory_id An product's inventory id 
 *
 * @return int The quantity sold for that product
 */
...
/**
 * Gets all products in a certain category and returns a sorted array of products and pagination.
 * 
 * @param int $category_id ID of category of products to retrieve
 * @param int $items_per_page Number of items to display per page on results page (default 999999)
 * @param int $page_number Page number to begin search results on (default 1)
 *
 * @return array A sorted array of found products and corresponding pagination based on results and items per page.
 */
 ...
 * @param int $items_per_page Number of items to display per page on results page (default 999999)
 * @param int $page_number Page number to begin search results on (default 1)
 * @param string $onlyShowActive if equal to "1", only active products will be displayed (default 1)
 *
 * @return array A sorted array of found products and corresponding pagination based on results and items per page.
 */
...
/**
 * Searches all products based on a search term and returns a sorted array of products and pagination.
 * 
 * @param string $search_term Term to search products on
 * @param int $items_per_page Number of items to display per page on results page (default 999999)
 * @param int $page_number Page number to begin search results on (default 1)
 *
 * @return array A sorted array of found products and corresponding pagination based on results and items per page.
...
/**
 * Closes the product add to cart form.
 *
 * @return string to close the add to cart form
 */
...
/**
 * Creates and returns an HTML string of the product form for adding to cart, including hidden property fields.
 * 
 * @param int $inventory_id ID of the product for the current add to cart form
 * @param string $form_id #ID of the current product form in the DOM
 * @param bool $include_quantity_field boolean to decide whether or not to include the quantity textbox field on the front end
 *
 * @return string Returns a string of html for the product form for adding to cart, including hidden property fields
 */
function foxypress_GetProductFormStart($inventory_id, $form_id = "foxypress_form", $include_quantity_field = true)
{
	...
	$form  = "<form action=\"https://" . $foxyStoreURL . "/cart\" method=\"POST\" class=\"foxycart\" accept-charset=\"utf-8\" id=\"" . $form_id . "\">"
			.
			(
...
/**
 * Returns a sorted array of categories with products
 *
 * 
...
/**
 * Returns an array of attributes (id, name and image) about a certain category
 * 
 * @param int $category_id ID of category to retrieve attributes for
 *
 * @return array Array of ID, name and category image for the category
 */
...
/**
 * Returns the number of inventory products in a certain category
 * 
 * @param int $category_id ID of the category to retrieve product inventory count
 *
 * @return int Number or products in a certain category
 */
 ...
 *
 * @return bool|array Returns an Array of related item IDs, or false if no related items are available
 */
 ...
 *
 * @return string Returns a comma separated string of category_ids
 */
...
/**
 * Creates and returns an HTML string of the product tracking form.
 *
 * @return string HTML string of tracking module for the store
 */
 ...
 * Returns a sorted array of child categories of the given $parent_category
 * 
 * @param string $dropdowndisplay if not empty, will display an animated style mini cart
 * @param string $hideonzero if equal to "1", an extra div (#fc_minicart) will be added
 *
 * @return string HTML string of mini cart widget
 */
...
/**
 * Returns an array of transactions for a certain user
 * 
 * @param string $user_email Email of the user whose transaction information will be returned
 * @param string $type Past or Current transaction information
 *
 * @return array Array of transaction information or null if user has no transactions
 */
 ...
 * Returns a sorted array of child categories of the given $parent_category
 * 
 * @param int $transaction ID of a certain transaction to retrieve and return information about
 *
 * @return array of items and their details (code, name, price, options) in a certain transaction, or null if there are none.
 */
...
/**
 * Returns an affiliate banner based on a provided banner ID
 * 
 * @param int $banner_id ID of certain banner to retrieve and return information about
 *
 * @return array Array of banner attributes
 */
 ...
 * Returns all banners
 * 
 * @return array Array of results of all banners
 */
...
/**
 * Returns a boolean as to whether or not a user is an affiliate or not
 * 
 * @param int $user_id ID of a certain user
 *
 * @return bool If a user is an affiliate or not
 */
...
/**
 * Returns a boolean as to whether or not a user is a referral or not
 * 
 * @param int $user_id ID of a certain user
 *
 * @return bool If a user is an referral or not
 */
...
/**
 * Returns an array of affiliate stats from a provided affiliate ID
 * 
 * @param int $affiliate_id ID of a certain affiliate user
 *
 * @return array Array of affiliate stats from a provided affiliate ID
 */
