...
<?php
	...
	{
		$sub_token_url = "https://" . $foxyStoreURL . "/cart?sub_token=" . $foxyXMLResponse->subscription->sub_token;		
		$output = "<div style=\"padding: 10px;\">
					...
					<form method=\"post\" id=\"subscriptions\">
						<div class=\"postbox\">
...
<?php
	...
	$SearchResults = foxypress_curlPostRequest($foxyAPIURL, $foxyData);
	$foxyXMLResponse = simplexml_load_string($SearchResults, NULL, LIBXML_NOCDATA);	
	$output = "<form method=\"post\" id=\"subscriptions\">
					<div class=\"postbox\">
