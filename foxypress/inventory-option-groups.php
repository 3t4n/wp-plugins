                ...
                <div style="float: left; width: 98%; clear: both;" class="inside">
                    <table cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td><input type="submit" name="option_group_save" id="option_group_save" class="button button-primary bold" value="<?php _e('Save','foxypress'); ?> &raquo;" /></td>
                        </tr>
                    </table>
                </div>
                        ...
                        echo("<tr>
                                <td>
									<form name=\"foxy_edit_option_group_form\" id=\"foxy_edit_option_group_form\" method=\"POST\">
										...
										<input type=\"submit\" class=\"button-primary\" id=\"foxypress_edit_option_save\" name=\"foxypress_edit_option_save\" value=\"" . __('Save', 'foxypress') . "\" />
									</form>
								</td>
