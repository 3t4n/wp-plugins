...
function foxypress_inventory_category_postback()
{
	global $wpdb;
		...
		wp_register_script( 'touch-punch', plugins_url() . '/foxypress/js/jquery.ui.touch-punch.min.js', array('jquery-ui-sortable'), false, true);
        	...
        	<?php
				...
				if(!empty($items))
				{
					...
					<form id="foxy_order_items" name="foxy_order_items" method="POST">
						<input type="submit" id="foxy_order_items_save" name="foxy_order_items_save" value="<?php _e('Update Order', 'foxypress'); ?> &raquo;"  class="button button-primary bold" />
