...
function import_export_page_load()
{
	...
	<div class="wrap">
    	...
    	<?php 
			...
			<div class="fp-import-export-container">
			  ...
			  <form method="POST" enctype="multipart/form-data" id="frmImport" name="frmImport">
			  	...
			  	<input type="submit" name="file_submit" class="button-primary" id="file_submit" value="<?php _e('Import Preview', 'foxypress'); ?>" /> 
			  </form>		
			</div>
			<?php
					else:
			...
			<div class="import-preview fp-import-export-container">
			  ...
			  <p>
				  <form method="POST" enctype="multipart/form-data" id="frmImport" name="frmImport">
				  	<input type="submit" name="verify_import" id="verify_import" class="button-primary" value="<?php _e('Import', 'foxypress'); ?>" /> 
				  </form>
			  </p>
			  <h3>Categories</h3>
    	...
    	<div class="fp-import-export-container">
    	  ...
    	  <form method="POST" enctype="multipart/form-data" id="frmImport" name="frmImport">
    	  	<input type="file" name="file_import" id="file_import" />
    	  	<input type="submit" name="file_submit" id="file_submit" value="<?php _e('Import Preview', 'foxypress'); ?>"  class="button-primary"/>
    	  </form>
    	</div>
    	<?php
    			else:
		...
		<div class="settings_widefat">
	        ...
	        <div class="fp-import-export-container">
				...
				<form method="POST" id="frmExport" name="frmExport">
	            	<input class="button-primary" type="submit" name="export_submit" id="export_submit" value="<?php _e('Export', 'foxypress'); ?>" />
	                <?php
