...
function foxypress_manage_emails_page_load() 
{
	...
	?>
	        <div class="wrap">
	        	...
	        	<table cellpadding="10" style="float:left; width:650px" id="email_template">
	        		<tr>
					...
					<tr>
						...
						<td>
                            ...
                            <script type="text/javascript">
								CKEDITOR.replace( 'content', {width:"350"} );
							</script>
                        </td>
			        </tr>
					<tr>
						<td>&nbsp;</td>
						<td><input type="submit" class="button-primary" name="foxy_em_save" id="foxy_em_save" value="<?php _e('Save', 'foxypress'); ?>" /></td>
			        </tr>
					</form>
				</table>
