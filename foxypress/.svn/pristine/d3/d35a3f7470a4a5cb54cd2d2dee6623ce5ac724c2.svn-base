 ...
 * 
 * @param string $product_code Code for inventory product
 * @param int $product_quantity Quantity for inventory product
 * @param string $store_domain Domain URL of store
...
/**
 * Return XML of request
 * 
 * @param string $error Potential error
 *
