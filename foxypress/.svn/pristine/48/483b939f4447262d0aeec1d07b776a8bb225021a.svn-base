...
**************************************************************************/
	...
	function foxypress_templates_page_load()
	{
		...
		$isSupported=true;
		if(get_option('foxycart_storeversion')!="0.7.2" && get_option('foxycart_storeversion')!="1.0" && get_option('foxycart_storeversion')!="1.1"){
			$isSupported=false;
	?>	
	...
	function template_postback()
	{
		...
		if(get_option('foxycart_storeversion')!="1.0" && get_option('foxycart_storeversion')!="1.1"){$isTwigSupported=false;}
		if($PageAction == "cart")
		{
		?>
