...
= 0.7.2 (2024/12/22) =
* Add: Immediate post checks to ensure drafts are enabled and option labels update based on settings.
* Add: Remove All Posting Times button in PostTimeSelect, displayed conditionally with a new hasDefaults check.
* Fix: Improved error handling in Settings by refactoring optionError state to use strings.
* Fix: Formatting issues in the NekoButton component within CreatePostModal.
* Fix: Resolved code error for Pinterest posts.
* Add: Option to delete all drafts when a draft update error occurs.

= 0.7.1 (2024/11/04) =
* Add: Placeholders for templates.
