...
//		$this->charge_prior_authorized_transactions = 'yes' === $this->get_option( 'charge_prior_authorized_transactions', 'no');
        ...
        add_action ('woocommerce_before_order_object_save', array($this, 'update_amount_on_order_update'), 10, 150);
	}
...
//
        ...
        $args = apply_filters('pgabfw_cc_request_data', $args, 'cc', $order);
	...
	public function process_response( $response, $order ) {
        ...
        do_action('pgabfw_cc_success_payment', $order, 'cc');
    ...
    public function update_amount_on_order_update($order): void
    {
        ...
        try {
            ...
            remove_action ('woocommerce_before_order_object_save', array($this, 'update_amount_on_order_update'), 10, 150);
            do_action('pgabfw_before_transaction_update', $order);
            add_action ('woocommerce_before_order_object_save', array($this, 'update_amount_on_order_update'), 10, 150);
