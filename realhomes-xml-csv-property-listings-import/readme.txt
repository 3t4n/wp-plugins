...
= 1.1.5 =
* improvement: added lot size fields
* improvement: added energy performance fields
* improvement: added video fields
* bug fix: add-on section doesn't appear in PHP 8.2+
