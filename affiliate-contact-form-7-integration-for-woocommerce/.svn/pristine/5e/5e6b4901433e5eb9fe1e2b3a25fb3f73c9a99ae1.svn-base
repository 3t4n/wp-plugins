	...
	class AFWC_CF7_Registration_Form {
		...
		public function add_tag_generator() {
			...
			foreach ( $fields as $field_key => $field ) {
				wpcf7_add_tag_generator(
					...
					sprintf( esc_html_x( 'Affiliate Registration Form: %s', 'Affiliate registration tag name', 'affiliate-contact-form-7-integration-for-woocommerce' ), $field ),
		...
		public function before_send_mail( $contact_form = null, &$abort = false, $submission = null ) {
			...
			if (
				...
				$abort = true;
				$submission->set_response( _x( 'Passwords do not match.', 'Password mismatch message', 'affiliate-contact-form-7-integration-for-woocommerce' ) );
				return;
			}
		...
		public function registration_response( $messages = array() ) {
			...
			$afwc_messages = array(
				'afwc_successfully_registered_without_auto_approved' => array(
					'description' => _x( 'The user\'s request is successfully submitted and is now awaiting review for approval as an affiliate as Approval method setting is disabled', 'cf7: affiliate successfully registered with out auto approved response description', 'affiliate-contact-form-7-integration-for-woocommerce' ),
					'default'     => $afwc_submissions->get_message( 'success_without_auto_approved' ),
				),
				'afwc_successfully_registered_with_auto_approved' => array(
					'description' => _x( 'The user is successfully registered as an affiliate as Approval method setting is enabled', 'cf7: affiliate successfully registered with auto approved response description', 'affiliate-contact-form-7-integration-for-woocommerce' ),
					'default'     => _x( 'Congratulations, you are successfully registered as our affiliate. Visit My Account > Affiliate to find more details about the affiliate program.', 'cf7: affiliate successfully registered with auto approved response default message', 'affiliate-contact-form-7-integration-for-woocommerce' ),
				),
				'afwc_pending_affiliate'    => array(
					'description' => _x( 'The user have already signed up for affiliate program and their request is pending for review', 'cf7: pending affiliate response description', 'affiliate-contact-form-7-integration-for-woocommerce' ),
					'default'     => $afwc_submissions->get_message( 'pending' ),
				),
				'afwc_rejected_affiliate'   => array(
					'description' => _x( 'The user\'s request to signup for affiliate program was rejected previously', 'cf7: rejected affiliate response description', 'affiliate-contact-form-7-integration-for-woocommerce' ),
					'default'     => ! empty( $afwc_admin_contact_email )
									? sprintf(
										/* translators: affiliate manager mail */
										_x( 'Your previous request to join our affiliate program has been declined. Please contact %s for more details.', 'cf7: rejected affiliate response default message', 'affiliate-contact-form-7-integration-for-woocommerce' ),
										$afwc_admin_contact_email
									)
									: _x( 'Your previous request to join our affiliate program has been declined. Please contact the store admin for more details.', 'cf7: rejected affiliate response default message', 'affiliate-contact-form-7-integration-for-woocommerce' ),
				),
				'afwc_registered_affiliate' => array(
					'description' => _x( 'The user is already registered as an affiliate', 'cf7: already registered affiliate response description', 'affiliate-contact-form-7-integration-for-woocommerce' ),
			...
			if ( ! empty( $args['version'] ) && 2 === intval( $args['version'] ) ) {
				...
				<header class="description-box">
					<h3>
						...
						printf(
							...
							esc_html_x( '%s field form-tag generator', 'cf7 field title', 'affiliate-contact-form-7-integration-for-woocommerce' ),
				...
				<div class="control-box">
					<fieldset>
						<legend id="tag-generator-panel-<?php echo esc_attr( $type ); ?>-type-legend">
							<?php echo esc_html_x( 'Field type', 'cf7 field type', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
						</legend>
						...
						<label>
							...
							<?php echo esc_html_x( 'This is a required field.', 'cf7 required field', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
						</label>
					</fieldset>
					...
					<fieldset>
						<legend>
							<label for="<?php echo esc_attr( $content . '-name' ); ?>">
								<?php echo esc_html_x( 'Name', 'cf7 name attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							</label>
						</legend>
						<div>
					...
					<fieldset>
						<legend>
							<?php echo esc_html_x( 'Default value', 'cf7 default value label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
						</legend>
						<div>
							...
							<label>
								...
								<?php echo esc_html_x( 'Use this text as the placeholder of the field', 'cf7 default value description', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							</label>
						</div>
					</fieldset>
					...
					if ( 'number' === $type ) {
						...
						<fieldset>
							<legend>
								<?php echo esc_html_x( 'Range', 'cf7 number range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							</legend>
							<div>
								<label>
									<?php echo esc_html_x( 'Min', 'cf7 minimum range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
									<input type="number" data-tag-part="option" data-tag-option="min:" value="<?php echo esc_attr( $min_value ); ?>" />
								</label>
								&ndash;
								<label>
									<?php echo esc_html_x( 'Max', 'cf7 maximum range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
					...
					<fieldset>
						<legend>
							<label for="<?php echo esc_attr( $content . '-id' ); ?>">
								<?php echo esc_html_x( 'Id attribute', 'cf7 id attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							</label>
						</legend>
						<div>
					...
					<fieldset>
						<legend>
							<label for="<?php echo esc_attr( $content . '-class' ); ?>">
								<?php echo esc_html_x( 'Class attribute', 'cf7 class attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							</label>
						</legend>
						<div>
				...
				<footer class="insert-box">
					<div class="flex-container">
						<input type="text" class="code" readonly="readonly" onfocus="this.select()" data-tag-part="tag" aria-label="<?php echo esc_attr_x( 'The form-tag to be inserted into the form template', 'cf7 form-tag aria-label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>">
						<button type="button" class="button button-primary" data-taggen="insert-tag"><?php echo esc_html_x( 'Insert Tag', 'cf7 inserting tag', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></button>
					</div>
					<p class="mail-tag-tip">
						<?php
						printf(
							/* translators: %s: mail-tag corresponding to the form-tag */
							esc_html_x( 'To use the user input in the email, insert the corresponding mail-tag %s into the email template.', 'Guide for cf7 mail tag installations', 'affiliate-contact-form-7-integration-for-woocommerce' ),
				...
				<div class="control-box">
					<table class="form-table">
						<tbody>
							<tr>
								<th scope="row"><?php echo esc_html_x( 'Field type', 'cf7 field type', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></th>
								<td>
									<fieldset>
									<legend class="screen-reader-text"><?php echo esc_html_x( 'Field type', 'cf7 field type', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></legend>
									<label><input type="checkbox" name="required" /> <?php echo esc_html_x( 'Required field', 'cf7 required field', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label>
									</fieldset>
								</td>
							</tr>
							<tr>
								<th scope="row"><label for="<?php echo esc_attr( $content . '-name' ); ?>"><?php echo esc_html_x( 'Name', 'cf7 name attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label></th>
								<td><input type="text" name="name" class="tg-name oneline" id="<?php echo esc_attr( $content . '-name' ); ?>" value="<?php echo esc_attr( $args['id'] ); ?>" /></td>
							</tr>
							<tr>
								<th scope="row"><label for="<?php echo esc_attr( $content . '-values' ); ?>"><?php echo esc_html_x( 'Default value', 'cf7 default value label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label></th>
								<td>
									<input type="text" name="values" class="oneline" id="<?php echo esc_attr( $content . '-values' ); ?>" /><br />
									<label><input type="checkbox" name="placeholder" class="option" /> <?php echo esc_html_x( 'Use this text as the placeholder of the field', 'cf7 default value description', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label>
								</td>
							</tr>
							<th scope="row"><?php echo esc_html_x( 'Range', 'cf7 number range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></th>
							<?php
							if ( 'number' === $type ) {
								// Set minimum value for parent id.
								$min_value = ( 'afwc_parent_id' === $id ) ? '1' : '';
								...
								<td>
									<fieldset>
										<legend class="screen-reader-text"><?php echo esc_html_x( 'Range', 'cf7 number range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></legend>
										<label>
											<?php echo esc_html_x( 'Min', 'cf7 minimum range label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>
							...
							<?php } ?>
							<tr>
								<th scope="row"><label for="<?php echo esc_attr( $content . '-id' ); ?>"><?php echo esc_html_x( 'Id attribute', 'cf7 id attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label></th>
								<td><input type="text" name="id" class="idvalue oneline option" id="<?php echo esc_attr( $content ); ?>" /></td>
							</tr>
							<tr>
								<th scope="row"><label for="<?php echo esc_attr( $content . '-class' ); ?>"><?php echo esc_html_x( 'Class attribute', 'cf7 class attribute label', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?></label></th>
				...
				<div class="insert-box">
					...
					<div class="submitbox">
						<input type="button" class="button button-primary insert-tag" value="<?php echo esc_html_x( 'Insert Tag', 'cf7 inserting tag', 'affiliate-contact-form-7-integration-for-woocommerce' ); ?>" />
					</div>
					...
					<p class="description mail-tag">
						<label for="<?php echo esc_attr( $content . '-mailtag' ); ?>">
							...
							printf( esc_html_x( 'To use the value input through this field in a mail field, you need to insert the corresponding mail-tag (%s) into the field on the Mail tab.', 'Guide for cf7 mail tag installations', 'affiliate-contact-form-7-integration-for-woocommerce' ), '<strong><span class="mail-tag"></span></strong>' );
							?>
