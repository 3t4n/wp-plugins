								...
								'google_setting' => array(
									...
									'fields' => array(
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Directions API, Geocoding API, Maps JavaScript API, Maps Static API and Places API.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=maps-backend.googleapis.com,geocoding-backend.googleapis.com,directions-backend.googleapis.com,static-maps-backend.googleapis.com,places-backend.googleapis.com&keyType=CLIENT_SIDE&reusekey=true'),
										...
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Geocoding API and Places API.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=geocoding-backend.googleapis.com,places-backend.googleapis.com&keyType=CLIENT_SIDE&reusekey=true') . ' ' . sprintf(__('Then check geolocation <a href="%s">response</a>.', 'W2DC'), admin_url('admin.php?page=w2dc_debug')),
