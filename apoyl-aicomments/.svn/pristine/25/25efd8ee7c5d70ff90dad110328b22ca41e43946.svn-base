...
Tags: DeepSeek,百度GPT,AI文章,马甲跟评,活跃人气
...
* 支持发完文章或更新文章后，文章后自动实现AI回复AI跟评，帮助平台活跃人气
* 支持最新DeepSeek-V3、DeepSeek-R1、百度大模型
* 必须自行注册[深度求索DeepSeek平台](https://platform.deepseek.com/api_keys) 或者 [百度大模型](https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application)并自行申请API Key和Secret Key，能正常访问百度大模型接口
...
当然需要。
= 如何使用 ? =
开启此插件后，请必须自行注册[深度求索DeepSeek平台](https://platform.deepseek.com/api_keys) 或者 [百度大模型](https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application)并自行申请API Key和Secret Key，填入后台即可
= 如何咨询我 ? =
