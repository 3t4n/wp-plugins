 ...
 * Description: 基于DeepSeek大模型DeepSeek-V3、推理模型DeepSeek-R1、百度大模型ERNIE-4.0-、GPT-3.5、GPT-4，通过prompt一句话标题描述智能创造一篇高质量的文章，可智能生成文章、AI一键改写内容、AI一键润色内容，为管理者提供大量参考内容。
 * Version:     1.8.0
 * Author:      凹凸曼
...
define('APOYL_AIARTICLE_VERSION','1.8.0');
