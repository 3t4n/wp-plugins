...
Contributors: apoyl
Donate link:
Tags: DeepSeek,百度GPT,AI文章,ERNIE-4.0-Turbo-8K,gpt-3.5-turbo,gpt-4-turbo,gpt-4o
...
* 支持编辑器下面输入一句话生成文章，AI智能创作文章；简单来讲通过大模型一键自动生成文章内容
* 支持最新DeepSeek、百度、OpenAI大模型
* 支持新文章内容改写，旧文章内容重写，一键AI内容改写+
* 支持新文章内容润色，旧文章内容润色，一键AI内容润色，让文章更加丰富
* 新增支持自定义大模型：如DeepSeek-V3、DeepSeek-R1、百度大模型ERNIE-4.0-Turbo-8K、gpt-3.5-turbo、gpt-4-turbo、gpt-4o
* 必须自行注册[深度求索DeepSeek平台](https://platform.deepseek.com/api_keys) 或者 [百度大模型](https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application) 或者OpenAI，能正常访问百度或OpenAI接口
...
1. Upload `apoyl-aiarticle` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

方法一：
自己网站后台插件-》安装插件里搜索：凹凸曼  找到插件 AI生成文章

方法二：
1.上传apoyl-aiarticle到你的站点目录下安装
...
== Changelog ==
= 1.8.0 =
* 新增支持大模型版本：DeepSeek-V3 DeepSeek-R1
...
= 1.4.0 =
* 新增支持自定义大模型：如百度大模型ERNIE-4.0-Turbo-8K、gpt-3.5-turbo、gpt-4-turbo、gpt-4o
