...
if (isset($_POST['apoyl-aiarticle-wpnonce']) && check_admin_referer($options_name, 'apoyl-aiarticle-wpnonce')) {
        ...
        $arr_options = array(
            ...
            'deepseekapikey' => sanitize_text_field($_POST['deepseekapikey']),
            'deepseeksecretkey' => sanitize_text_field($_POST['deepseeksecretkey']),
        );
    	...
    	<form
    		...
    		<table class="form-table">
    			<tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" class="regular-text"
                                   value="5" id="openllm" name="openllm" <?php if(isset($arr['openllm'])) checked( '5', $arr['openllm'] ); ?> ><?php _e('DeepSeek-R1','apoyl-aiarticle'); ?>
                            <input type="radio" class="regular-text"
                                   value="6" id="openllm" name="openllm" <?php if(isset($arr['openllm'])) checked( '6', $arr['openllm'] ); ?> ><?php _e('DeepSeek-V3','apoyl-aiarticle'); ?>
                            <input type="radio" class="regular-text"
                    ...
                    <tr>
                        <th><label><?php esc_html_e('deepseekapikey','apoyl-aiarticle'); ?></label></th>
                        <td><input type="text" class="regular-text" value="<?php echo esc_attr($arr['deepseekapikey']); ?>" id="deepseekapikey" name="deepseekapikey">
                            <p class="description"><?php esc_html_e('deepseekapikey_desc','apoyl-aiarticle'); ?></p>
                        </td>
                    </tr>

                    <tr>
                        <th><label><?php esc_html_e('deepseeksecretkey','apoyl-aiarticle'); ?></label></th>
                        <td><input type="text" class="regular-text" value="<?php echo esc_attr($arr['deepseeksecretkey']); ?>" id="deepseeksecretkey" name="deepseeksecretkey">
                            <p class="description"><?php esc_html_e('deepseeksecretkey_desc','apoyl-aiarticle'); ?></p>
                        </td>
                    </tr>
    			</tbody>
    		</table>
