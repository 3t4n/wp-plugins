...
/**
 * Viewmodel for enabling custom post ty pes.
 * 
 * @since   1.0.0
 */

 class CWF_Enable_CPT_ViewModel {
    ...
    public function validate() {
         ...
         */
        if( ! isset( $_POST['cwf_enable_cpt_nonce_field'] ) 
            || ! wp_verify_nonce( $_POST['cwf_enable_cpt_nonce_field'], 'cwf_enable_cpt' ) ) {
