...
<div class="wrap cwf-page-container">
    <?php
        if( $this->edit_cpt_viewmodel->success || $this->edit_cpt_viewmodel->success === 1 ) {
            ?>
                <div class="cwf-notification-updated cwf-cpt-notice">
                    <p class="cwf-notification"><?php esc_html_e( 'Your custom post type has been successfully updated!', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?></p>
                </div>
            <?php
        }
        elseif( $this->edit_cpt_viewmodel->success === false ) {
            ?>
                <div class="cwf-notification-error cwf-cpt-notice">
                    <p class="cwf-notification"><?php esc_html_e( 'An error occurred while trying to update your custom post type!', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?></p>
                </div>
            <?php
        }
    ?>
    <h1 class="wp-heading-inline"><?php esc_html_e( sprintf( 'Edit Custom Post Type: %s', $this->edit_cpt_viewmodel->cpt->post_type_key ), CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?></h1>
    <?php
        if( ! empty( $this->edit_cpt_viewmodel->validation_summary ) ) {
            ?>
                <div class="error notice cwf-cpt-notice">
                    ...
                    <ul class="cwf-validation-summary">
                        <?php
                            foreach( $this->edit_cpt_viewmodel->validation_summary as $validation_error ) {
    ...
    ?>
    <p><em><?php esc_html_e( sprintf( 'Use this form to update the details for the "%s" Custom Post Type', $this->edit_cpt_viewmodel->cpt->post_type_key ), CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?></em></p>
    <form id="cwf-edit-cpt" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
        <input type="hidden" name="action" value="cwf_edit_cpt" />
        <input type="hidden" name="id" value="<?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_id ); ?>" />
        <div id="poststuff">
            <div id="postbox-container" class="postbox-container cwf-cpt-postbox-container">
                <div class="meta-box-sortables ui-sortable" id="normal-sortables">
                                ...
                                <th scope="row">
                                    <label for="post-type-key" class="cwf-tooltip"><?php esc_html_e( 'Post Type Key', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?><span class="cwf-required-asterisk">*</span>
                                        <span class="cwf-tooltip-text">(Required) Post type key. Must not exceed 20 characters and may 
                                            only contain lowercase alphanumeric characters, dashes, and underscores. (e.g. 'book').
                                            Editing the post type key will automatically migrate all posts to the new post type.</span>
                                    </label>
                                </th>
                                <td>
                                    <input name="post-type-key" type="text" maxlength="20" class="regular-text cwf-slug<?php echo esc_attr( $this->edit_cpt_viewmodel->validation_errors['post-type-key'] ? ' cwf-has-error' : '' ); ?>" 
                                    placeholder="" value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_key ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_key ); ?>" required />
                                    <p class="cwf-field-validation"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-key'] ) ? '' : $this->edit_cpt_viewmodel->validation_errors['post-type-key'] ); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="post-type-label-singular" class="cwf-tooltip"><?php _e( 'Label (Singular)', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?><span class="cwf-required-asterisk">*</span>
                                        <span class="cwf-tooltip-text">(Required) Name of the post type in singular form. (e.g. 'Book')</span>
                                    </label>
                                </th>
                                <td>
                                    <input name="post-type-label-singular" type="text" class="regular-text<?php echo esc_attr( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-label-singular'] ) ? '' : ' cwf-has-error' ); ?>" 
                                    placeholder="" value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->singular_name ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->singular_name ); ?>" required />
                                    <p class="cwf-field-validation"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-label-singular'] ) ? '' : $this->edit_cpt_viewmodel->validation_errors['post-type-label-singular'] ); ?></p>
                                    <div class="cwf-populate-checkbox"><input name="post-type-label-singular-all" tabindex="-1" type="checkbox" value="true" <?php echo esc_html( empty( $this->edit_cpt_viewmodel->post_type_label_singular_all ) ? '' : ( $this->edit_cpt_viewmodel->post_type_label_singular_all ? 'checked' : '' ) ); ?> /><?php esc_html_e( 'Use term for all singular labels', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?></div>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <input name="post-type-label" type="text" class="regular-text<?php echo esc_attr( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-label'] ) ? '' : ' cwf-has-error' ); ?>" 
                                    placeholder="" value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_label ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_label ); ?>" required />
                                    <p class="cwf-field-validation"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-label'] ) ? '' : $this->edit_cpt_viewmodel->validation_errors['post-type-label'] ); ?></p>
                                    <div class="cwf-populate-checkbox"><input name="post-type-label-all" tabindex="-1" type="checkbox" value="true" <?php echo esc_html( empty( $this->edit_cpt_viewmodel->post_type_label_all ) ? '' : ( $this->edit_cpt_viewmodel->post_type_label_all ? 'checked' : '' ) ); ?>/><?php esc_html_e( 'Use term for all plural labels', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN );?> </div>
                                </td>
                            </tr>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->add_new ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->add_new ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->add_new_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->add_new_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->edit_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->edit_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->new_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->new_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->view_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->view_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->view_items ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->view_items ); ?>" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->search_items ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->search_items ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->not_found ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->not_found ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->not_found_in_trash ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->not_found_in_trash ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->parent_item_colon ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->parent_item_colon ); ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->all_items ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->all_items ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->archives ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->archives ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->attributes ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->attributes ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->insert_into_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->insert_into_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->uploaded_to_this_item ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->uploaded_to_this_item ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->featured_image ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->featured_image ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->set_featured_image ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->set_featured_image ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->remove_featured_image ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->remove_featured_image ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->use_featured_image ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->use_featured_image ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->menu_name ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->menu_name ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->filter_items_list ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->filter_items_list ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->items_list_navigation ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->items_list_navigation ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->items_list ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->items_list ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->item_published ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->item_published ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->item_published_privately ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->item_published_privately ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->item_reverted_to_draft ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->item_reverted_to_draft ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->item_scheduled ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->item_scheduled ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_labels->item_updated ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_labels->item_updated ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <textarea name="post-type-description" max-length="500" rows="5" class="regular-text" placeholder=""><?php echo esc_textarea( empty( $this->edit_cpt_viewmodel->cpt->post_type_description ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_description ); ?></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="form-table" role="presentation">
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_is_public ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_is_public ? "checked" : "" ) ); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        ...
                                        <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_is_hierarchical ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_is_hierarchical ? "checked" : "" ) ); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        ...
                                        <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_exclude_from_search ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_exclude_from_search ? "checked" : "" ) ); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        ...
                                        <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_is_publicly_queryable ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_is_publicly_queryable ? "checked" : "" ) ); ?>>
                                    </td>
                                </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_show_in_ui ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_show_in_ui ? "checked" : "" ) ); ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_show_in_menu ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_show_in_menu ? "checked" : "" ) ); ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_show_in_nav_menus ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_show_in_nav_menus ? "checked" : "" ) ); ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_show_in_admin_bar ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_show_in_admin_bar ? "checked" : "" ) ); ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_show_in_rest ) ? "" : ( $this->edit_cpt_viewmodel->cpt->post_type_show_in_rest ? "checked" : "" ) ); ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_rest_base ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_rest_base ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_rest_controller_class ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_rest_controller_class ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <input name="post-type-menu-position" type="number" min="5" max="100" step="1" class="regular-text<?php echo esc_attr( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-menu-position'] ) ? '' : 'cwf-has-error' ); ?>" 
                                            placeholder="" value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_menu_position ) ? "" : $this->edit_cpt_viewmodel->cpt->post_type_menu_position ); ?>" />
                                            <p class="cwf-field-validation"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-menu-position'] ) ? '' : $this->edit_cpt_viewmodel->validation_errors['post-type-menu-position'] ); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <div class="cwt-cpt-dashicon-container<?php echo esc_attr( empty( $this->edit_cpt_viewmodel->cpt->validation_errors['post-type-menu-icon'] ) ? '' : 'cwf-has-error' ); ?>">
                                                <?php 
                                                    $i = 1; 
                                                    foreach( $this->edit_cpt_viewmodel->dashicons as $key => $value ) { ?>
                                                    <div>
                                                        <label title="<?php echo esc_attr( $key ); ?>">
                                                            ...
                                                            <?php
                                                                if( $value == $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ) {
                                                                    echo esc_html( 'checked' );
                                                                }
                                                                else if($key == "Post" && empty( $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ) ){
                                                                    echo esc_html( 'checked' );
                                                                }
                                                            ?>/>
                                            ...
                                            <div id="cwf-upload-container">
                                                <button id="cwf-upload-icon" class="cwf-media-upload-button<?php echo esc_attr( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-menu-icon'] ) ? '' : 'cwf-has-error' ); ?>" type="button"
                                                ...
                                                <input id="cwf-icon-url-input" name="post-type-menu-icon" type="hidden" value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ) ? 'dashicons-admin-post' : $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ); ?>" />
                                            </div>
                                            <div id="cwf-icon-url-container"><span id="cwf-icon-url"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ) ? 'dashicons-admin-post' : basename( $this->edit_cpt_viewmodel->cpt->post_type_menu_icon ) ); ?></span></div>
                                            <p class="cwf-field-validation"><?php echo esc_html( empty( $this->edit_cpt_viewmodel->validation_errors['post-type-menu-icon'] ) ? '' : $this->edit_cpt_viewmodel->validation_errors['post-type-menu-icon'] ); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <select name="post-type-capability-type" class="regular-text">
                                                <option value="post" <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_capability_type == 'post' ? 'selected' : '' ); ?>>Post</option>
                                                <option value="page" <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_capability_type == 'page' ? 'selected' : '' ); ?>>Page</option>
                                            </select>                            
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["title"] ? 'checked' : '' ); ?>/>Title</label></div>
                                            <div><label for="post-type-supports-editor"><input name="post-type-supports-editor" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["editor"] ? 'checked' : '' ); ?>/>Editor</label></div>
                                            <div><label for="post-type-supports-thumbnail"><input name="post-type-supports-thumbnails" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["thumbnail"] ? 'checked' : '' ); ?>/>Thumbnails</label></div>
                                            <div><label for="post-type-supports-comments"><input name="post-type-supports-comments" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["comments"] ? 'checked' : '' ); ?>/>Comments</label></div>
                                            <div><label for="post-type-supports-revisions"><input name="post-type-supports-revisions" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["revisions"] ? 'checked' : '' ); ?>/>Revisions</label></div>
                                            <div><label for="post-type-supports-trackbacks"><input name="post-type-supports-trackbacks" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["trackbacks"] ? 'checked' : '' ); ?>/>Trackbacks</label></div>
                                            <div><label for="post-type-supports-author"><input name="post-type-supports-author" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["author"] ? 'checked' : '' ); ?>/>Author</label></div>
                                            <div><label for="post-type-supports-excerpt"><input name="post-type-supports-excerpt" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["excerpt"] ? 'checked' : '' ); ?>/>Excerpt</label></div>
                                            <div><label for="post-type-supports-page-attributes"><input name="post-type-supports-page-attributes" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["page-attributes"] ? 'checked' : '' ); ?>/>Page Attributes</label></div>
                                            <div><label for="post-type-supports-custom-fields"><input name="post-type-supports-custom-fields" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["custom-fields"] ? 'checked' : '' ); ?>/>Custom Fields</label></div>
                                            <div><label for="post-type-supports-post-formats"><input name="post-type-supports-post-formats" type="checkbox" value="true"
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_supports["post-formats"] ? 'checked' : '' ); ?>/>Post Formats</label></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <div id="custom-support-container" class="cwf-tag-container">
                                                <?php 
                                                    if( ! empty( $this->edit_cpt_viewmodel->cpt->post_type_custom_supports ) ) {
                                                        foreach( $this->edit_cpt_viewmodel->cpt->post_type_custom_supports as $custom_support ) {
                                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_has_archive ? 'checked' : '' ); ?> 
                                            data-children="<?php echo htmlspecialchars( json_encode( array( 'post-type-archive-slug-row') ), ENT_COMPAT ); ?>" />
                                        </td>
                                    </tr>
                                    <tr id="post-type-archive-slug-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_has_archive ? '' : 'display:none;' ); ?>">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_archive_slug ) ? '' : $this->edit_cpt_viewmodel->cpt->post_type_archive_slug ); ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_rewrite ? 'checked' : '' ); ?> class="cwf-conditional"
                                    ...
                                    <tr id="post-type-rewrite-slug-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_rewrite ? '' : 'display:none;' ); ?>">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_rewrite_rules['slug'] ) ? '' : $this->edit_cpt_viewmodel->cpt->post_type_rewrite_rules['slug'] ); ?>" />
                                        </td>
                                    </tr>
                                    <tr id="post-type-rewrite-with-front-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_rewrite ? '' : 'display:none;' ); ?>">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_rewrite_rules['with-front'] ? 'checked' : '' ); ?> />
                                        </td>
                                    </tr>
                                    <tr id="post-type-rewrite-feeds-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_rewrite ? '' : 'display:none;' ); ?>">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_rewrite_rules['feeds'] ? 'checked' : '' ); ?>/>
                                        </td>
                                    </tr>
                                    <tr id="post-type-rewrite-pages-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_rewrite ? '' : 'display:none;' ); ?>">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_rewrite_rules['pages'] ? 'checked' : '' ); ?>/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_query_var ? 'checked' : '' ); ?>
                                            data-children="<?php echo htmlspecialchars( json_encode( array( 'post-type-query-var-slug-row' ) ), ENT_COMPAT ); ?>"/>
                                        </td>
                                    </tr>
                                    <tr id="post-type-query-var-slug-row" style="<?php echo esc_attr( $this->edit_cpt_viewmodel->cpt->post_type_query_var ? '' : 'display:none;' ); ?>"">
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            value="<?php echo esc_html( empty($this->edit_cpt_viewmodel->cpt->post_type_query_var_slug) ? '' : $this->edit_cpt_viewmodel->cpt->post_type_query_var_slug ); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_can_export ? 'checked' : '' ); ?>/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            ...
                                            <?php echo esc_html( $this->edit_cpt_viewmodel->cpt->post_type_delete_with_user ? 'checked' : '' ); ?>/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <div class="cwf-multiselect regular-text">
                                                ...
                                                <div id="cpt-taxonomy-checkboxes">
                                                    <?php
                                                        foreach( $this->edit_cpt_viewmodel->available_taxonomies as $available_taxonomy ) {
                                                            ?>
                                                                <label>
                                                                    ...
                                                                    <?php echo esc_html( empty( $this->edit_cpt_viewmodel->cpt->post_type_taxonomies ) ? '' : ( in_array( $available_taxonomy->name, $this->edit_cpt_viewmodel->cpt->post_type_taxonomies ) ? 'checked' : '' ) ); ?>/>
                    ...
                    <div>
                        <?php wp_nonce_field( 'cwf_edit_cpt', 'cwf_edit_cpt_nonce_field' ); ?>
                        <p class="submit">
                            <input type="submit" name="submit" id="submit" class="button button-primary" value="<?php esc_html_e( 'Update Custom Post Type', CUSTOM_WP_FRAMEWORK_TEXT_DOMAIN ); ?>"/>
                        </p>
                    </div>
