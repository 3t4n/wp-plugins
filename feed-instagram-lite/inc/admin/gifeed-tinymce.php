...
if ( strstr( $_SERVER['REQUEST_URI'], 'wp-admin/post-new.php' ) || strstr( $_SERVER['REQUEST_URI'], 'wp-admin/post.php' ) ) {
    ...
    function gifeed_editor_add_init()
    {
        ...
        if ( get_post_type( get_the_ID() ) != 'ginstagramfeed' ) {
            ...
            $tinymcedata = array(
                'feeds'      => gifeed_get_list_of_feeds(),
                'sc_nonce'   => wp_create_nonce( 'gifeed_get_feed' ),
    ...
    // ADD MEDIA BUTOON
    add_action( 'media_buttons', 'gifeed_shortcode_button' );

}

function gifeed_shortcode_button()
{

    $img = plugins_url( 'img/wp-dashboard-icon.png', __FILE__ );
    printf( '<a class="thickbox button" id="ifeed_gut_shorcode-button" title="Shortcode Generator" style="outline: medium none !important; cursor: pointer;" >
	<img src="'.$img.'" alt="Instagram Lite" width="20" height="20" style="position:relative; top:-3px"/>Instagram Lite</a>', '#' );
...
<div id="gifeedmodal" style="display:none;">
    <div id="tinyfeed">
        ...
        <div class="gifeed_button">
            <input type="button" value="Insert Shortcode" name="gifeed_insert_scrt" id="gifeed_insert_scrt"
        ...
        <div style="display:inline-block;vertical-align: top;">
            ...
            <ul class="gifeed_pro_demo_list">
                <li><a href="https://demo.ghozylab.com/plugins/instagram-feed-plugin/#!/eleganmasonry"
                        target="_blank">Elegant Instagram Masonry</a></li>
                <li><a href="https://demo.ghozylab.com/plugins/instagram-feed-plugin/#!/simpleblue"
                        target="_blank">Simple Blue Gallery</a></li>
                <li><a href="https://demo.ghozylab.com/plugins/instagram-feed-plugin/#!/classic3col"
                        target="_blank">Classic 3 Columns</a></li>
                <li><a href="https://demo.ghozylab.com/plugins/instagram-feed-plugin/#!/thumbnails"
                        target="_blank">Thumbnails Gallery</a></li>
            </ul>
            <div class="clearfix"></div>
        </div>
        <div style="vertical-align: bottom; float: right; position: relative; right:50px;">
            <img src="<?php echo plugins_url( 'img/tinymce/goto_pro_version.png', __FILE__ ); ?>" alt="Pro Version"
