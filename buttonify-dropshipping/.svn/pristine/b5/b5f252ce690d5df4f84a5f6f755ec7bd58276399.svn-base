...
require_once 'Buttonify_OptionsManager.php';

class Buttonify_InstallIndicator extends Buttonify_OptionsManager
{


    const  OPTION_INSTALLED = 'buttonify__installed';
    const  OPTION_VERSION = 'buttonify__version';
