...
Contributors: codebrainbv, Cashflows
...
Cashflows is a simple and secure way to take payments online. When connecting Cashflows Gateway to WooCommerce, you will connect into all of the functionality that comes with our extension. Shoppers are directed to a customisable Hosted Payment Page where they securely complete their payment and we take care of the rest. Once the payment is successfully completed, the shopper is directed automatically back to your WooCommerce site.
...
We have the most flexible remittance and settlement options in the payments services industry. We can help your business find a settlement program that allows you quick access to your completed transactions. If timely Cashflow for you is a critical success factor, then you owe it to yourself to talk with Cashflows. We want to help you have better business opportunities because you have the cashflow to do it.

= When we are ready for paymemt options beyond cards, how do we proceed =

Tell us what your future payment processing needs are - we are ready to expand our payment selection to address customers demands. We want to hear from you, so that we can provide payment solutions that allow you to convert orders into purchases. With our own payments gateway standing
...
The world has made ecommerce the fastest growing sector of the economy regardless of where you are located.  With recent events, this story will only be accelerating. The way that we can help you put your customers at ease is with some of the options available in our plugin.  
...
3. Use either our inline payment processing or relying on our customizable hosted payment page, we can safely complete the payment, helping keep your conversion rate high for your webshops.
...
* Checked compatibility with WooCommerce 9.4.2

= 2.1.9.3 =
* Fixed an issue where the PaymentJob wasnt attached to the order meta data.
* Checked compatibility with WooCommerce 9.1.4


= 2.1.9.2 =
* Compatibility for Woocommerce HPOS.
* Fixed an issue where the PaymentJob wasnt attached to the order meta data.
* Checked compatibility with WooCommerce 9.1.2.
* Checked compatibility with Wordpress Multisite.
