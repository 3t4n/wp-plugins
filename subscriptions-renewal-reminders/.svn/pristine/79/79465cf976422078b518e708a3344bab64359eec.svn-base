    ...
    <div class="renew-rem-tab-content">
      ...
      ?>
        ...
        ?>
          <br>
          <br>
          <div class="re-compare-bar-tabs-sync"><?php echo esc_html__('Synchronize Subscription data to Renewel Reminders Plugin Manually here! . If you have manually changed the subscription dates, please run the manual sync. This ensures that the renewal reminder data is updated with the correct subscription dates, keeping everything in sync.', 'subscriptions-renewal-reminders'); ?></div>
          <br>
