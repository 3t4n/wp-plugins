...
Tags: gravity-forms, payment-gateway, ecommerce, online-payments, credit-card-payments
...
== Changelog ==
= 1.5.7 [2024-07-15] =
* Tidy up the tags and other information in readme.txt

= 1.5.6 [2024-04-10] =
* Fix: single shipping field bug fix
...
= 1.4.0 [2014-09-09] =
* Tested with Wordpress 4.0 and Gravity Forms 1.8.13 and everything looks fine.
...
* Implemented fix to ensure that WordPress SEO does not break operation of this plugin.
