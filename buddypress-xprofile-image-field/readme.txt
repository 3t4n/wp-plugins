...
This plugin requires BuddyPress minimum version 1.5 and has been tested up to BuddyPress version 14.2.1
...
= 3.0.1 =
* fix the issue raised in https://wordpress.org/support/topic/uncaught-error-call-to-undefined-function-bp_xprofile_get_field_type/
