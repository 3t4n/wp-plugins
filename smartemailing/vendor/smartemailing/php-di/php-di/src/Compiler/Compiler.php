...
use function chmod;
use SmartemailingDeps\DI\Definition\ArrayDefinition;
use SmartemailingDeps\DI\Definition\DecoratorDefinition;
...
use SmartemailingDeps\DI\DependencyException;
use SmartemailingDeps\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use SmartemailingDeps\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
