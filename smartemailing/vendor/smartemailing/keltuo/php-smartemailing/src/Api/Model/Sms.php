...
class Sms extends AbstractModel implements ModelInterface
{
    ...
    #[ArrayShape(['tag' => "string", 'sms_id' => "int", 'tasks' => "SmartemailingDeps\\SmartEmailing\\Api\\Model\\Bag\\TaskBag"])]
    public function toArray(): array
    {
        return ['tag' => $this->getTag(), 'sms_id' => $this->getSmsId(), 'tasks' => $this->getTaskBag()];
    }
}
