...
class PurposeConnections extends AbstractSearch
{
    ...
    {
        return [self::ID, self::CREATED_AT, self::CONTACT_ID, self::VALID_FROM, self::VALID_TO, self::PURPOSE_ID, self::DETAILS];
    }
    ...
    {
        return [self::ID, self::CREATED_AT, self::CONTACT_ID, self::VALID_FROM, self::VALID_TO, self::PURPOSE_ID];
    }
}
