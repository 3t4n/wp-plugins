...
class ContactList extends AbstractModel
{
    ...
    public function __construct(?string $name = null, ?string $publicName = null, ?string $senderName = null, ?string $senderEmail = null, ?string $replyTo = null)
    {
        $this->setName($name);
    ...
    {
        return \array_filter(['name' => $this->getName(), 'publicname' => $this->getPublicName(), 'sendername' => $this->getSenderName(), 'senderemail' => $this->getSenderEmail(), 'replyto' => $this->getReplyTo()], static fn($item) => !\is_null($item));
    }
}
