...
class Campaign extends AbstractModel
{
    ...
    #[ArrayShape(['email_id' => "int", 'sender_credentials' => "SmartemailingDeps\\SmartEmailing\\Api\\Model\\Contact\\SenderCredentials", 'confirmation_thank_you_page_url' => "null|string", 'valid_to' => "null|string", 'replace' => "SmartemailingDeps\\SmartEmailing\\Api\\Model\\Bag\\ReplaceBag"])]
    public function toArray(): array
    {
        return \array_filter(['email_id' => $this->getEmailId(), 'sender_credentials' => $this->getSenderCredentials(), 'confirmation_thank_you_page_url' => $this->getConfirmationThankYouPageUrl(), 'valid_to' => $this->getValidTo(), 'replace' => $this->getReplaceBag()], static fn($item) => !\is_null($item));
    }
}
