...
class Email extends AbstractModel
{
    ...
    public function __construct(string $name, string $title, ?string $htmlBody = null, ?string $textBody = null, ?bool $template = null, ?int $footerId = null)
    {
        $this->setName($name);
        $this->setTitle($title);
    ...
    #[ArrayShape(['name' => "string", 'title' => "string", 'htmlbody' => "null|string", 'textbody' => "null|string", 'template' => "int|null", 'footer_id' => "int|null"])]
    public function toArray(): array
    {
        return ['name' => $this->getName(), 'title' => $this->getTitle(), 'htmlbody' => $this->getHtmlBody(), 'textbody' => $this->getTextBody(), 'template' => (int) $this->isTemplate(), 'footer_id' => $this->getFooterId()];
    }
}
