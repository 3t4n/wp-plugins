...
class CustomEmail extends AbstractModel
{
    ...
    public function __construct(SenderCredentials $senderCredentials, string $tag, int $emailId, ?TaskBag $taskBag = null)
    {
    ...
    #[ArrayShape(['tag' => "string", 'email_id' => "int", 'tasks' => "SmartemailingDeps\\SmartEmailing\\Api\\Bag\\TaskBag", 'sender_credentials' => "SmartemailingDeps\\SmartEmailing\\Api\\Model\\SenderCredentials"])]
    public function toArray(): array
    {
        return ['tag' => $this->getTag(), 'email_id' => $this->getEmailId(), 'tasks' => $this->getTaskBag(), 'sender_credentials' => $this->getSenderCredentials()];
    }
}
