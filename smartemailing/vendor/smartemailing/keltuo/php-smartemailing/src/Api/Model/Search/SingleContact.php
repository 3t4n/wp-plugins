...
class SingleContact extends AbstractSearch
{
    ...
    {
        return [self::ID, self::LANGUAGE, self::BLACKLISTED, self::EMAIL_ADDRESS, self::NAME, self::SURNAME, self::TITLES_BEFORE, self::TITLES_AFTER, self::BIRTHDAY, self::NAME_DAY, self::POSTAL_CODE, self::NOTES, self::PHONE, self::CELLPHONE, self::REAL_NAME];
    }
