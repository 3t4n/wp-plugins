...
use SmartemailingDeps\SmartEmailing\Api\Model\Search\ContactCustomFields as SearchContactCustomFields;
use SmartemailingDeps\SmartEmailing\Api\Model\Search\CustomFields as SearchCustomField;
use SmartemailingDeps\SmartEmailing\Api\Model\Search\SingleCustomFields as SearchSingleCustomField;
/**
...
class CustomFields extends AbstractApi
{
    ...
    {
        return new Response($this->delete($this->replaceUrlParameters('customfields/:id', ['id' => $idCustomField])));
    }
    /**
    ...
    public function getSingle(int $idCustomField, ?SearchSingleCustomField $search = null): Response
    {
        ...
        return new Response($this->get($this->replaceUrlParameters('customfields/:id', ['id' => $idCustomField]), $search->getAsQuery()));
    }
}
