...
namespace SmartemailingDeps\SmartEmailing\Test\Unit\Util;
...
class HelpersTest extends TestCase
{
    ...
    {
        return [['test@email.cz'], ['test.test1@email.cz'], ['test_email-email@email.cz']];
    }
    public function dateProvider(): array
    {
        return [['4.10.2021 00:00:00'], ['04.10.2021 00:00:00'], ['00:00:00 04.10.2021']];
    }
}
