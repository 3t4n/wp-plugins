 ...
 */
namespace SmartemailingDeps\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'SmartemailingDeps\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'SmartemailingDeps\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'SmartemailingDeps\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'SmartemailingDeps\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'SmartemailingDeps\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'SmartemailingDeps\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
