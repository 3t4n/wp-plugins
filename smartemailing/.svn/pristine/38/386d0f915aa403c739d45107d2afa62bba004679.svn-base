...
class Purposes extends AbstractSearch
{
    ...
    {
        return [self::ID, self::CREATED_AT, self::LAWFUL_BASIS, self::NAME, self::DURATION, self::NOTES];
    }
    protected function getSortAllowedValues(): array
    {
        return [self::ID, self::CREATED_AT, self::LAWFUL_BASIS, self::NAME, self::NOTES];
    }
}
