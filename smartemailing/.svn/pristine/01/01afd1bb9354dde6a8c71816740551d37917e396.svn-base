...
use SmartemailingDeps\GuzzleHttp\Handler\CurlHandler;
use SmartemailingDeps\GuzzleHttp\Handler\CurlMultiHandler;
use SmartemailingDeps\GuzzleHttp\Handler\Proxy;
use SmartemailingDeps\GuzzleHttp\Handler\StreamHandler;
