...
use SmartemailingDeps\SmartEmailing\Api\Model\Search\ContactLists as ContactListSearch;
/**
...
class ContactLists extends AbstractApi
{
    ...
    {
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id/added-contacts', ['id' => $idContactList])));
    }
    /**
    ...
    {
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id/distribution', ['id' => $idContactList])));
    }
    /**
    ...
    {
        $search ??= new ContactListSearch();
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id', ['id' => $idContactList]), $search->getAsQuery()));
    }
    /**
    ...
    {
        return new Response($this->post($this->replaceUrlParameters('contactlists/:id/truncate', ['id' => $idContactList])));
    }
    /**
    ...
    {
        return new Response($this->put($this->replaceUrlParameters('contactlists/:id', ['id' => $idContactList]), $contactList->toArray()));
    }
    /**
    ...
    {
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id/contacts', ['id' => $idContactList])));
    }
    /**
    ...
    {
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id/contacts/confirmed', ['id' => $idContactList])));
    }
    /**
    ...
    {
        return new Response($this->get($this->replaceUrlParameters('contactlists/:id/contacts/unsubscribed', ['id' => $idContactList])));
    }
}
