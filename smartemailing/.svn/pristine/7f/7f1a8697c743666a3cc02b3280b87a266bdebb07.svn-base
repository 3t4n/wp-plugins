 ...
 */
namespace SmartemailingDeps\Symfony\Component\String;

use SmartemailingDeps\Symfony\Component\String\Exception\ExceptionInterface;
use SmartemailingDeps\Symfony\Component\String\Exception\InvalidArgumentException;
use SmartemailingDeps\Symfony\Component\String\Exception\RuntimeException;
/**
    ...
    public function toCodePointString(string $fromEncoding = null): CodePointString
    {
        ...
        try {
            try {
                ...
                if (!\function_exists('iconv') && !\function_exists('SmartemailingDeps\iconv')) {
                    throw $e;
                }
