...
namespace SmartemailingDeps\SmartEmailing\Test\Unit\Api\Model\Search;

use SmartemailingDeps\PHPUnit\Framework\TestCase;
use SmartemailingDeps\SmartEmailing\Api\Model\Search\AbstractSearch;
use SmartemailingDeps\SmartEmailing\Exception\AllowedTypeException;
use SmartemailingDeps\SmartEmailing\Test\Mock\AbstractSearchMock;
class AbstractSearchTest extends TestCase
{
    ...
    {
        $limitAndOffset = ['limit' => $this->abstractClass->getLimit(), 'offset' => $this->abstractClass->getOffset()];
        ...
        $this->assertEquals(array_merge(['expand' => ['customfields'], 'type' => 'actiontype'], $limitAndOffset), $this->abstractClass->toArray());
    }
    ...
    public function testJsonSerialize()
    {
        ...
        $this->abstractClass->setActionTypeAllowedValue(['actiontype']);
        $this->abstractClass->selectByType('actiontype');
        $this->assertEquals(array_merge(['expand' => ['customfields'], 'type' => 'actiontype'], $limitAndOffset), $this->abstractClass->jsonSerialize());
