...
class DoubleOptInSettings extends AbstractModel
{
    ...
    #[ArrayShape(['campaign' => "SmartemailingDeps\\SmartEmailing\\Api\\Model\\Contact\\Campaign", 'silence_period' => "null|\\SmartEmailing\\Api\\Model\\Contact\\SilencePeriod", 'send_to_mode' => "string"])]
    public function toArray(): array
    {
        return ['campaign' => $this->getCampaign(), 'silence_period' => $this->getSilencePeriod(), 'send_to_mode' => $this->getSendToMode()];
    }
}
