...
class Settings extends AbstractModel
{
     ...
     */
    protected bool $preserveUnSubscribed = \true;
    /**
    ...
    public function __construct(bool $update = \true, bool $addNameDays = \true, bool $addGenders = \true, bool $addSalutations = \true, bool $preserveUnSubscribed = \true, bool $skipInvalidEmails = \false, ?DoubleOptInSettings $doubleOptInSettings = null)
    {
    ...
    #[ArrayShape(['update' => "bool", 'add_namedays' => "bool", 'add_genders' => "bool", 'add_salutions' => "bool", 'preserve_unsubscribed' => "bool", 'skip_invalid_emails' => "bool", 'double_opt_in_settings' => "null|\\SmartEmailing\\Api\\Model\\Contact\\DoubleOptInSettings"])]
    public function toArray(): array
    {
        return \array_filter(['update' => $this->isUpdate(), 'add_namedays' => $this->isAddNameDays(), 'add_genders' => $this->isAddGenders(), 'add_salutions' => $this->isAddSalutations(), 'preserve_unsubscribed' => $this->isPreserveUnSubscribed(), 'skip_invalid_emails' => $this->isSkipInvalidEmails(), 'double_opt_in_settings' => $this->getDoubleOptInSettings()], static fn($item) => !\is_null($item));
    }
}
