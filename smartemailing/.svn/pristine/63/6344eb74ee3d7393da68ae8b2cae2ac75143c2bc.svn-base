...
class SmartEmailingApi {
	 ...
	 * @return void
	 */
	public function update_lists( $dont_redirect = false ): void {
	...
	public static function get_order_statuses(): array {
		return array(
			...
			'canceled'   => __( 'Cancelled', 'smartemailing' ),
	...
	public function maybe_show_notice(): void {
		$process = filter_input( INPUT_GET, 'se-lists-updated', FILTER_SANITIZE_STRING );
