...
class NewsletterStats extends AbstractSearch
{
    ...
    {
        return [self::ID, self::EMAIL_ID, self::SMS_ID, self::NAME, self::SENT, self::OPENED, self::CLICKED, self::UNSUBSCRIBE, self::BOUNCED, self::UNOPENED, self::UNOPENED_PERC, self::OPENED_PERC, self::CLICKED_PERC, self::CLICKED_PERC_ABS, self::UNSUBSCRIBE_PERC, self::UNSUBSCRIBE_PERC_ABS, self::BOUNCED_PERC, self::START, self::FINISH];
    }
    protected function getFilterAllowedValues(): array
    {
        return [self::ID, self::EMAIL_ID, self::SMS_ID, self::NAME];
    }
}
