...
use SmartemailingDeps\GuzzleHttp\Cookie\CookieJar;
use SmartemailingDeps\GuzzleHttp\Exception\GuzzleException;
use SmartemailingDeps\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \SmartemailingDeps\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
