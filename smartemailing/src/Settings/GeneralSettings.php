...
class GeneralSettings extends AbstractSettings {
	...
	public function setup() {
		...
		$items = array(
			array(
				...
				/* translators: %s: link to SmartEmailing API keys */
			...
			array(
				...
				'type'  => 'button',
				'url'   => add_query_arg( array( 'action' => 'se_update_lists' ), admin_url( 'admin.php' ) ),
			),
			array(
				'type'  => 'title',
			...
			array(
				...
				'type'  => 'title',
				'title' => __( 'Form settings', 'smartemailing' ),
			),
			array(
				'id'      => self::FORM_STYLE,
				'type'    => 'select',
				'title'   => __( 'Form style', 'smartemailing' ),
				'options' => [
					[
						'label' => __( 'SmartEmailing', 'smartemailing' ),
						'value' => Templates::RENDER_SMARTEMAILING,
					],
					[
						'label' => __( 'Wordpress', 'smartemailing' ),
		...
		if ( smartemailing_plugin_is_active( 'woocommerce/woocommerce.php' ) ) {
			$woo_settings = array(
				...
				array(
					...
					'title'       => __( 'Bulk upload existing customers', 'smartemailing' ),
					'description' => __(
				...
				array(
					...
					'title'       => __( 'Bulk upload existing orders', 'smartemailing' ),
					'description' => __(
	...
	public function is_settings_page() {
		...
		return is_admin() && $page === 'smartemailing';
	}
}
