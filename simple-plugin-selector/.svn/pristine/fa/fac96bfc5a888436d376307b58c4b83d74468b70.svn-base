...
Once activated, the plugin will copy its plugin filter file to the /wp-content/mu-plugins directory. Code in mu-plugins runs before normal plugins are loaded. That's why the plugin filter file must be run from there.
