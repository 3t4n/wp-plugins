...
Donate link:
Tags: payment, gate, pays, pays.cz
...
* Secure payments
* Support for most recent WooCommerce features such as HPOS or checkout blocks
...
= 2.6 =
* Tested and marked HPOS support
* Compatibility with checkout blocks

= 2.5 =
* Send customer invoicing name with Pays payment initialization to comply with a new legal regulation
