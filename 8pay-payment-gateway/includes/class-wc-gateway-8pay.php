...
class WC_Gateway_8Pay extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = '8Pay Network';
    $this->method_sub_title  = 'Accept any kind of crypto payments';
    ...
    add_filter('woocommerce_gateway_title', array($this, 'add_subtitle_to_gateway_title'), 10, 2);
  ...
  public function add_subtitle_to_gateway_title($title, $gateway_id) {
  if ($gateway_id === $this->id) {
    $title .= $this->method_sub_title;
  }
    return $title;
  }
