...
jQuery(document).ready(function(){
    ...
    function showopvalie(){
        ...
        if(gift_con == "custom") {
            ...
            jQuery('.fgw_child_div_custom input[type="number"]').attr("required", "required");
        }
        if(gift_con == "price") {
            ...
            jQuery('.fgw_child_div_category').hide();
            jQuery('.fgw_child_div_price input[type="number"]').attr("required", "required");
        }
        if(gift_con == "category") {
            ...
            jQuery('.fgw_child_div_category input[type="number"]').attr("required", "required");
        }
    }
    ...
    jQuery("body").on('click', '.fgfw-button-primary', function() {
        console.log("hello");
        jQuery('#pro-version-message').show();
        return false;
      });
      jQuery('#pro-version-message').hide();
});
