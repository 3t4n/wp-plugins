...
function Insert_Reset_Password_Form($atts) {
	...
	$ReturnString .= "<input type='hidden' name='Username' value='" . esc_attr( $User->Username ) . "'>";
	$ReturnString .= "<div id='ewd-feup-register-username-div' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Email ) . ": " . esc_html( $User->Username ) . "</div>";
	...
	$ReturnString .= "</div>";
	$ReturnString .= "<div class='feup-pure-control-group'><label for='submit'></label><input type='submit' class='ewd-feup-submit feup-pure-button feup-pure-button-primary' name='Edit_Password_Submit' value='" . esc_attr( $submit_text ) . "'></div>";
	$ReturnString .= "</div>";
	$ReturnString .= "</form>";
