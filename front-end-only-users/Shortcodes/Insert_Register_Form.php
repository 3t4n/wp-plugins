...
function Insert_Register_Form($atts) {
	...
	$feup_required_field_symbol = " <span class='ewd-feup-req-symbol'>".esc_html( get_option("EWD_FEUP_Required_Field_Symbol") )."</span>";
	...
	if ($Allow_Level_Choice == "Yes" and !isset($_POST['level'])) {
		...
		$ReturnString .= "<h3>" . esc_html( $feup_Label_Level_Select_Message ) . "</h3>";
		...
		$ReturnString .= "<label for='level' id='ewd-feup-register-level' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Level ) . ": </label>";
		$ReturnString .= "<select class='ewd-feup-select-input' name='level'>";
		foreach ($Levels as $Level) {
			$ReturnString .= "<option value='" . esc_attr( $Level->Level_ID ) . "'>" . esc_html( $Level->Level_Name ) . "</option>";
		}
		$ReturnString .= "</select>";
		$ReturnString .= "</div>";
		$ReturnString .= "<input type='submit' name='Register_Level_Select' value='Select " . esc_attr( $feup_Label_Level ) . "' />";
		$ReturnString .= "</form>";
		$ReturnString .= "</div>";
	...
	if (!isset($ConfirmationSuccess)) {	
		...
		$ReturnString .= "<form action='#' method='post' id='ewd-feup-register-form' class='feup-pure-form feup-pure-form-aligned' enctype='multipart/form-data'>";
		$ReturnString .= "<input type='hidden' name='ewd-feup-check' value='" . esc_attr( sha1(md5($Time.$Salt)) ) . "'>";
		$ReturnString .= "<input type='hidden' name='ewd-feup-time' value='" . esc_attr( $Time ) . "'>";
		$ReturnString .= "<input type='hidden' name='ewd-feup-action' value='register'>";
		$ReturnString .= "<input type='hidden' name='ewd-feup-post-id' value='" . esc_attr( $post->ID ) . "'>";
		...
		if ($Username_Is_Email == "Yes") {
			$ReturnString .= "<label for='Username' id='ewd-feup-register-username-div' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Email ) . ":".$feup_required_field_symbol."</label>";
			if (isset($_POST['Username'])) {
				$ReturnString .= "<input type='email' class='ewd-feup-text-input' name='Username' value='" . esc_attr( $_POST['Username'] ) . "' required>";
			} else {
				$ReturnString .= "<input type='email' class='ewd-feup-text-input' name='Username' placeholder='" .	esc_attr( $feup_Label_Email ) . "...' required>";
			}
		} else {
			$ReturnString .= "<label for='Username' id='ewd-feup-register-username-div' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Username ) . ": </label>";
			...
			else {$ReturnString .= "<input type='text' class='ewd-feup-text-input' name='Username' placeholder='" . 	esc_attr( $feup_Label_Username_Placeholder ) . "...' required>";}
		}
		$ReturnString .= "</div>";
		$ReturnString .= "<div id='ewd-feup-password-div' class='feup-pure-control-group'>";
		$ReturnString .= "<label for='Password' id='ewd-feup-register-password-div' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Password ) . ":".$feup_required_field_symbol."</label>";
		...
		$ReturnString .= "<label for='Repeat Password' id='ewd-feup-register-password-confirm-div' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Repeat_Password ) . ":".$feup_required_field_symbol."</label>";
		...
		$ReturnString .= "<label for='Password Strength' id='ewd-feup-password-strength' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Password_Strength ) . ": </label>";
		$ReturnString .= "<span id='ewd-feup-password-result'>" . esc_html( $feup_Label_Too_Short ) . "</span>";
		$ReturnString .= "</div>";
		...
		foreach ($Fields as $Field) {
			...
			if ($Field->Field_Type == "label") {
				$ReturnString .= "<div id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-label'><span>". esc_html( $Field->Field_Name ) . "</span><span class='ewd-feup-label-description'>".esc_html( $Field->Field_Description )."</span></div>";
			} else {
				$ReturnString .= "<label for='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-field-label'>" . esc_html( $Field->Field_Name ). ":" . $Req_Symbol . "</label><div class='ewd-feup-register-field-instructions'>";
			}
			
			if ($Field->Field_Type == "text") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-text-input' type='text' value='" . esc_attr( $Value ) . "' placeholder='" . $Field->Field_Name . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "mediumint") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-text-input' type='number' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "email") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-text-input' type='email' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "tel") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-text-input' type='tel' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "url") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-text-input' type='url' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "date") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-date-input' type='date' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "datetime") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-datetime-input' type='datetime-local' value='" . esc_attr( $Value ) . "' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "picture") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-date-input' type='file' value='' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "file") {
				$ReturnString .= "<input name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-date-input' type='file' value='' " . $Req_Text . "/>";
			}
			elseif ($Field->Field_Type == "textarea") {
				$ReturnString .= "<textarea name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-textarea' " . $Req_Text . ">" . esc_textarea( $_POST[str_replace(" ", "_", $Field->Field_Name)] ) . "</textarea>";
			} 
			elseif ($Field->Field_Type == "select" or $Field->Field_Type == "countries") { 
				...
				$ReturnString .= "<select name='" . esc_attr( $Field->Field_Name ) . "' id='ewd-feup-register-input-" . esc_attr( $Field->Field_ID ) . "' class='ewd-feup-select'>";
			 	foreach ($Options as $Option) {
					...
					$ReturnString .= ">" . esc_html( $Option ) . "</option>";
				}
				$ReturnString .= "</select>";
			} 
			elseif ($Field->Field_Type == "radio") {
				...
				foreach ($Options as $Option) {
					...
					$ReturnString .= "<input type='radio' name='" . esc_attr( $Field->Field_Name ) . "' value='" . esc_attr( $Option ) . "' class='ewd-feup-radio' " . $Req_Text . " ";
					...
					$ReturnString .= ">" . esc_html( $Option )  . "<br/>";
					$Counter++;
				} 
			} 				
			...
			if ($Field->Field_Type !== "label") {
				$ReturnString .= "<span class='ewd-feup-label-description'>".esc_html( $Field->Field_Description )."</span>";
				$ReturnString .= "</div>";
		...
		$ReturnString .= "<div class='feup-pure-control-group'><label for='submit'></label><input type='submit' class='ewd-feup-submit feup-pure-button feup-pure-button-primary' name='Register_Submit' value='" . esc_attr( $submit_text ) . "'></div>";
		$ReturnString .= "</form>";
		$ReturnString .= "</div>";
	}
	else {
		$ReturnString = "<div class='ewd-feup-email-confirmation'>";
		if ($ConfirmationSuccess == "Yes") {$ReturnString .= esc_html( $feup_Label_Confirm_Email_Message );}
		if ($ConfirmationSuccess == "No") {$ReturnString .= esc_html( $feup_Label_Incorrect_Confirm_Message );}
		$ReturnString .= "</div>";
	}
