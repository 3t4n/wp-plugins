...
function Insert_Forgot_Password_Form($atts) {
	...
	if (!isset($Time)) { $Time = "";}
	$ReturnString .= "<input type='hidden' name='ewd-feup-check' value='" . esc_attr( sha1(md5($Time.(isset($Salt)?$Salt:""))) ) . "'>";
	$ReturnString .= "<input type='hidden' name='ewd-feup-time' value='" . esc_attr( $Time ) . "'>";
	$ReturnString .= "<input type='hidden' name='ewd-feup-reset-email-url' value='". esc_attr( $reset_email_url )."'>";
	$ReturnString .= "<input type='hidden' name='ewd-feup-action' value='forgot-password'>";
	$ReturnString .= "<input type='hidden' name='ewd-feup-reveal-no-username' value='".esc_attr( $reveal_no_username )."'>";
	$ReturnString .= "<div class='feup-pure-control-group'>";
	$ReturnString .= "<label for='Email' id='ewd-feup-reset-password' class='ewd-feup-field-label'>" . esc_html( $feup_Label_Email ) . ": </label>";
	...
	$ReturnString .= "<div class='feup-pure-control-group'><label for='submit'></label><input type='submit' class='ewd-feup-submit feup-pure-button feup-pure-button-primary' name='Reset_Password_Submit' value='" . esc_attr( $submit_text ) . "'></div>";
	$ReturnString .= "</form>";
	$ReturnString .= "</div>";
