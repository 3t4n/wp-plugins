...
function Insert_Login_Logout_Toggle($atts) {
	...
	elseif (isset($_POST['Logout_Submit'])) {
		...
		$ReturnString .= "<label for='Logout_Submit'></label><input type='submit' class='ewd-feup-submit feup-pure-button feup-pure-button-primary' name='Logout_Submit' value='" . esc_attr( $feup_Label_Logout ) . "'>";
		$ReturnString .= "</div>";
		$ReturnString .= "</form>";
		$ReturnString .= "</div>";
