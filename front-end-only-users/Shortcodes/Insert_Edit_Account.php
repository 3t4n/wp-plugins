...
function Insert_Edit_Account_Form($atts) {
	...
	if ($feup_Label_Require_Login_Message == "") {$feup_Label_Require_Login_Message =  __('You must be logged in to access this page.', 'front-end-only-users');}
		...
		if($Username_Is_Email == "Yes") {
			...
			$ReturnString .= "<label for='Username' id='ewd-feup-register-username-div' class='ewd-feup-field-label ewd-feup-login-label'>" . esc_html( $feup_Label_Email ) . ": </label>";
			$ReturnString .= "<input type='email' class='ewd-feup-text-input' name='Username' value='" . esc_attr( $User->Username ) . "'>";
			$ReturnString .= "</div>";
		} else {
			$ReturnString .= "<div class='feup-pure-control-group'>";
			$ReturnString .= "<label for='Username' id='ewd-feup-register-username-div' class='ewd-feup-field-label ewd-feup-login-label'>" . esc_html( $feup_Label_Username ) . ": </label>";
			$ReturnString .= "<input type='text' class='ewd-feup-text-input' name='Username' value='" . esc_attr( $User->Username ) . "'>";
			$ReturnString .= "</div>";
		}
		$ReturnString .= "<div class='feup-pure-control-group'>";
		$ReturnString .= "<label for='Password' id='ewd-feup-login-password-div' class='ewd-feup-field-label ewd-feup-login-label'>" . esc_html( $feup_Label_Password ) . ": </label>";
		$ReturnString .= "<input type='password' class='ewd-feup-text-input ewd-feup-password-input' name='User_Password' value=''>";
		$ReturnString .= "</div>";
		$ReturnString .= "<div class='feup-pure-control-group'>";
		$ReturnString .= "<label for='Repeat-Password' id='ewd-feup-register-password-confirm-div' class='ewd-feup-field-label ewd-feup-login-label'>". esc_html( $feup_Label_Repeat_Password ) .  ": </label>";
