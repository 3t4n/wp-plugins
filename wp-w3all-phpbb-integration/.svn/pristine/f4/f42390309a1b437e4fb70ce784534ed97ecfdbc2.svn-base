...
= 2.9.2 =
*Release Date - 02 Feb, 2025*
Fix bug and Add: option "Add users in phpBB if they do not exist, when the user logs in to WordPress", useful if you don't want to transfer users from WordPress to phpBB when the integration starts. Users will be added to phpBB when they log in to WordPress. 
https://www.axew3.com/w3/forums/viewtopic.php?t=2002
