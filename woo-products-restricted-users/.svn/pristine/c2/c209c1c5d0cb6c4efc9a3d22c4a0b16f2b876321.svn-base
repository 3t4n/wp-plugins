...
class WPRU_Metabox {
	...
	public function __construct() {
		...
		$this->meta_fields = $this->meta_fields();
	}
	...
	public function meta_fields(){
		return array(
			...
			array(
				...
				'type' => 'select',
				'options' => array(
					'view' => __( 'Only users in the list can see this product or products, the other will be redirected to homepage', 'wpru' ),
					'buy' => __( 'Only users in the list can see and buy this product or products, the others users could see it but they could not buy it', 'wpru' ),
				),
			),
			array(
				'label' => 'Users',
