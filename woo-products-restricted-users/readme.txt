...
= 0.6.1 =
*   Fixed a problem that created a crash

= 0.6 =
*   Restrictions can now be specified at the product category level to make the job more straightforward when you want to restrict entire categories
*   Ready for WooCommerce 9.7
*   Ready for Word 6.7.1
...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/woo-products-restricted-users)
