...
Tags: magento, woocommerce, import, migration, dropshipping
...
= 3.44.2 =
* Fixed: Warning: Undefined array key "visibility"
...
* Fixed: Deprecated: Creation of dynamic property FG_Magento_to_WooCommerce_Modules_Check::$plugin is deprecated
...
= 3.22.0 =
* New: Add a spinner during importing data, emptying WordPress content and saving parameters
