...
function minds_gift_woocommerce_cart_coupon()
{
    ...
    $apply_giftcard_text = get_option('apply_giftcard_label', 'Apply Giftcard');
    ...
    ?>
        ...
        ?>
            <div class="minds-redeem-div">
                ...
                <?php if($in_cart == false){ ?><a class="button" onclick="applyGiftCard()" id="applyGiftCard" ><?php echo $apply_giftcard_text; ?></a><?php }else{ ?><a class="button inactiveLink" id="applyGiftCard" ><?php echo $apply_giftcard_text; ?></a><?php } ?>
                </p>
            </div>
            <?php
                echo wp_get_inline_script_tag('
