...
if($redirect == "true"){
    ...
    if($access){
        ...
        if(isset($_POST["apply_giftcard_label"]) && (sanitize_text_field($_POST["apply_giftcard_label"]) != "")){
            update_option('apply_giftcard_label', $_POST["apply_giftcard_label"]);
        }
        $apply_giftcard_label = get_option('apply_giftcard_label', 'Apply Giftcard');
        ?>
        <div class="minds-container">
            <img src="<?php echo plugin_dir_url(dirname( __FILE__ )) . 'assets/images/99minds-logo.png'; ?>" class="minds-logo">
            <h2>99minds Admin Panel</h2>
            ...
            <form id="99minds-setup" method="post">
                <p>
                    <label>Label for Apply Giftcard Button:</label>
                </p>
                <p>
                    <input type="text" id="apply-giftcard-label" name="apply_giftcard_label" value="<?php echo $apply_giftcard_label; ?>" required>
                </p>
                <p>
