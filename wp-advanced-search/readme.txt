...
Tags: moteur de recherche, search engine, autocorrection, autocompletion, advanced search
License: GPLv2 or later
Requires at least: 2.5
Tested up to: 6.6.2
Stable Tag: 3.3.9.3

Moteur de recherche complet et puissant enti&egrave;rement modulable (complete and powerful search engine, fully scalable).
...
= Version 3.3.9.3 (04/11/2024) =
- Suppression d'anciens fichiers inutiles pour limiter des probl&egrave;mes de s&eacute;curit&eacute; (Deleting old unnecessary files for security reasons)

= Version 3.3.9.1 (04/08/2023) =
- Correction d'une petite faille de s&eacute;curit&eacute; (Fix a small security breach)
- Correction d'une erreur pour la gestion du multisite (Fix a small error for multisite)

= Version 3.3.8 (21/12/2022) =
- R&eacute;paration d'un souci de comptabilit&eacute; avec MySQL 8 ou PHP 8 (Fixed a problem of compatibility with MySQL 8 or PHP 8)
...
- Ajout d'une option pour g&eacute;rer l'affichage de r&eacute;sultats issus d'une ou plusieurs cat&eacute;gories sp cifiques (Added an option to control the display of results from one or more specific categories)
