...
Description: Moteur de recherche avancé (mise en surbrillance, trois types de recherche, styles, paginations...). (<em>Plugin adds a advanced search engine for WordPress with a lot of options (three type of search, bloded request, three method for pagination, relevancy algorithm...</em>).
...
// Version du plugin
$WP_Advanced_Search_Version = "3.3.9.3";
