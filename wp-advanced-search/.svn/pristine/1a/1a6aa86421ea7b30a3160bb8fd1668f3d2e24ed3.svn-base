...
function WP_Advanced_Search_Callback_Pagination() {
	...
	if(isset($_POST['wp_advanced_search_action']) && $_POST['wp_advanced_search_action'] == __('Enregistrer' , 'wp-advanced-search')) {
		if(isset($_POST['wp_advanced_search_update_paginate_nonce'])) {
			if(wp_verify_nonce($_POST['wp_advanced_search_update_paginate_nonce'], 'wp_advanced_search_update_paginate_nonce')) {
        ...
        <form method="post" action="">
       	<div class="block">
            ...
            <div class="col">
                ...
                <p class="tr">
                    <input value="<?php echo esc_html($select->paginationFirstPage); ?>" name="wp_advanced_search_pagination_firstpage" id="wp_advanced_search_pagination_firstpage" type="text" />
                    <label for="wp_advanced_search_pagination_firstpage"><strong><?php _e('Texte pour "première page"','wp-advanced-search'); ?></strong></label>
                </p>
                <p class="tr">
                    <input value="<?php echo esc_html($select->paginationLastPage); ?>" name="wp_advanced_search_pagination_lastpage" id="wp_advanced_search_pagination_lastpage" type="text" />
                    <label for="wp_advanced_search_pagination_lastpage"><strong><?php _e('Texte pour "dernière page"','wp-advanced-search'); ?></strong></label>
                </p>
                <p class="tr">
                    <input value="<?php echo esc_html($select->paginationPrevText); ?>" name="wp_advanced_search_pagination_prevtext" id="wp_advanced_search_pagination_prevtext" type="text" />
                    <label for="wp_advanced_search_pagination_prevtext"><strong><?php _e('Texte pour "précédent"','wp-advanced-search'); ?></strong></label>
                </p>
                <p class="tr">
                    <input value="<?php echo esc_html($select->paginationNextText); ?>" name="wp_advanced_search_pagination_nexttext" id="wp_advanced_search_pagination_nexttext" type="text" />
			...
			<input type="hidden" name="wp_advanced_search_update_paginate_nonce" value="<?php echo wp_create_nonce('wp_advanced_search_update_paginate_nonce'); ?>"/>
			<?php } ?>
