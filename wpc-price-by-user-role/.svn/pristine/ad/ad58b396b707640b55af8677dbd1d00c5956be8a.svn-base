...
<div class="wpclever_settings_page wrap">
    ...
    <div class="wpclever_settings_page_desc about-text">
        <p>
            ...
            <br/>
            <a href="<?php echo esc_url( WPCPU_REVIEWS ); ?>"
               target="_blank"><?php esc_html_e( 'Reviews', 'wpc-price-by-user-role' ); ?></a> |
            <a href="<?php echo esc_url( WPCPU_CHANGELOG ); ?>"
               target="_blank"><?php esc_html_e( 'Changelog', 'wpc-price-by-user-role' ); ?></a> |
            <a href="<?php echo esc_url( WPCPU_DISCUSSION ); ?>"
               target="_blank"><?php esc_html_e( 'Discussion', 'wpc-price-by-user-role' ); ?></a>
        </p>
    </div>
    ...
    <div class="wpclever_settings_page_nav">
        <h2 class="nav-tab-wrapper">
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcpu&tab=settings' ) ); ?>"
               class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
				<?php esc_html_e( 'Settings', 'wpc-price-by-user-role' ); ?>
            </a>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcpu&tab=premium' ) ); ?>"
            ...
            <div class="wpclever_settings_page_content_text">
                <p>Get the Premium Version just $29!
                    <a href="https://wpclever.net/downloads/wpc-price-by-user-role?utm_source=pro&utm_medium=wpcpu&utm_campaign=wporg"
                       target="_blank">https://wpclever.net/downloads/wpc-price-by-user-role</a>
                </p>
