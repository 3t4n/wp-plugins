...
class AdminFormFields {
	public static function get_form_fields($payment_method, $titles): array {
		$fields = [
			...
			'logo_size_unit' => [
				'title'       => esc_html__('Logo Size Unit', $payment_method . '-wc'),
				'type'        => 'select',
				'options'     => [
					'%'  => esc_html__('Percentage (%)', $payment_method . '-wc'),
					'px' => esc_html__('Pixels (px)', $payment_method . '-wc'),
				],
				'description' => esc_html__('Select the unit for logo size', $payment_method . '-wc'),
				'desc_tip'    => true,
				'default'     => 'px',
			],
			'logo_size_value' => [
				'title'       => esc_html__('Logo Size', $payment_method . '-wc'),
				'type'        => 'number',
				'description' => esc_html__('Enter the size value for the logo', $payment_method . '-wc'),
				'desc_tip'    => true,
				'default'     => '180',
				'custom_attributes' => [
					'min'  => '1',
			...
			'enabled_country' => [
				...
				'options'     => [
					...
					'SG' => esc_html__('Singapore', $payment_method . '-wc'),
				],
...
//			],
			'place_order_text' => [
				...
				'type'        => 'text',
				'description' => esc_html__('This is the text for place order button. Use {total} to display the cart total amount (e.g., "Pay {total}" will show as "Pay RM 50.00").', $payment_method . '-wc'),
				'desc_tip'    => true,
				'default'     => esc_html__('Pay with ' . ucfirst($titles['title']), $payment_method . '-wc'),
				'placeholder' => esc_html__('Enter text for place order button (e.g., Pay {total})', $payment_method . '-wc'),
			],
		];
		...
		return array_merge($fields, [
			...
			'additional_charge_name' => [
				'title'       => esc_html__('Fee Name', $payment_method . '-wc'),
				'type'        => 'text',
				'description' => esc_html__('Enter the name of the fee that will be displayed to customers', $payment_method . '-wc'),
				'desc_tip'    => true,
				'default'     => esc_html__('Bayarcash Processing Fee', $payment_method . '-wc'),
			],
