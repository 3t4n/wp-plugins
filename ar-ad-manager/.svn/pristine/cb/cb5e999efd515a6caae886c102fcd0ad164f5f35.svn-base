...
class Partials_Ar_Ad_Manager_Adzones_Meta_Box extends \Partials_Ar_Ad_Manager_Meta_Box_Abstract
{
    ...
    public function render_meta_box_content($post)
    {
        ...
        <div class="ar-ad-manager-box">
            ...
            <?php $adzoneTextColor = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_adzone_text_color", true); ?>


            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Adzone Text Color', 'ar-ad-manager');?></h4>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <div class="mdl-textfield mdl-js-textfield mdl-js-color-textfield">
                        <input
                            class="mdl-color__input"
                            type="color"
                            value="<?php echo $adzoneTextColor ?: '#5e5e5e'; ?>"
                        >
                        <input
                            class="mdl-color__input"
                            type="text"
                            id="adzone_text_color"
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[adzone_text_color]"
                            value="<?php echo $adzoneTextColor ?: '#5e5e5e'; ?>"
                        >
                    </div>
                </div>
                ...
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <div class="mdl-textfield mdl-js-textfield mdl-js-color-textfield">
                        <input
                            class="mdl-color__input"
                            type="color"
                            value="<?php echo $adzoneBgc ?: '#f0f8ff'; ?>"
                        >
                        <input
                            class="mdl-color__input"
                            type="text"
            ...
            <div class="mdl-grid">
                <?php $isAdzoneBorderTransparent = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_is_adzone_border_transparent", true); ?>

                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Set adzone border transparent', 'ar-ad-manager');?></h4>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="is_adzone_border_transparent">
                        <input
                            type="checkbox"
                            id="is_adzone_border_transparent"
                            class="mdl-switch__input"
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[is_adzone_border_transparent]"
                            <?php echo ($isAdzoneBorderTransparent === 'true') ? 'checked' : ''; ?>
                        >
                        <span class="mdl-switch__label"></span>
                    </label>
                </div>
                ...
                <input
                    type="hidden"
                    id="is_adzone_border_transparent-hidden"
                    name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[is_adzone_border_transparent]"
                    value="<?php echo esc_html($isAdzoneTransparent); ?>"
                >
            </div>

            <?php $adzoneBorder = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_adzone_border_color", true); ?>

            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Adzone Border Color', 'ar-ad-manager');?></h4>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <div class="mdl-textfield mdl-js-textfield mdl-js-color-textfield">
                        <input
                            class="mdl-color__input"
                            type="color"
                            value="<?php echo $adzoneBorder ?: '#ddf0ff'; ?>"
                        >
                        <input
                            class="mdl-color__input"
                            type="text"
                            id="adzone_border_color"
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[adzone_border_color]"
                            value="<?php echo $adzoneBorder ?: '#ddf0ff'; ?>"
                        >
                    </div>
                </div>
