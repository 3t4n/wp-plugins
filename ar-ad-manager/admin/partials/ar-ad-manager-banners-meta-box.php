...
class Partials_Ar_Ad_Manager_Banners_Meta_Box extends \Partials_Ar_Ad_Manager_Meta_Box_Abstract
{
    ...
    public function render_meta_box_settings($post)
    {
        ?>
        <div class="ar-ad-manager-box">
            <?php $overflowHidden = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_banner_overflow_hidden", true); ?>

            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Set overflow hidden', 'ar-ad-manager');?></h4>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="banner-overflow-hidden">
                        <input
                            type="checkbox"
                            id="banner-overflow-hidden"
                            class="mdl-switch__input"
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[banner_overflow_hidden]"
                            <?php echo ($overflowHidden === 'true') ? 'checked' : ''; ?>
                        >
                        <span class="mdl-switch__label"></span>
                    </label>
                </div>
                ...
                <input
                    type="hidden"
                    id="banner-overflow-hidden-hidden"
                    name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[banner_overflow_hidden]"
                    value="<?php echo esc_html($overflowHidden); ?>"
                >
            </div>
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
            ...
            <?php $countryList = file_get_contents(plugin_dir_path( __FILE__ ) . 'files/countries.json'); ?>
            <?php $countryList = json_decode($countryList, true); ?>

            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Countries', 'ar-ad-manager');?></h4>
                    <p><?php echo esc_html__('Select countries if you only want to show this banner for specific countries.', 'ar-ad-manager');?></p>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <div class="mdl-textfield mdl-js-textfield">
                        <?php $countrySelectedValues = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_banner_countries", true); ?>
                        <?php $countrySelectedValues = $countrySelectedValues ? explode(',', $countrySelectedValues) : []; ?>

                        <select
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[banner_countries][]"
                            id="banner_countries"
                            multiple
                        >
                            <?php foreach ($countryList as $country): ?>
                                <option value="<?php echo esc_html($country['code']); ?>" <?php echo (in_array($country['code'], $countrySelectedValues)) ? 'selected' : ''; ?>>
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--2-col mdl-cell--12-col-tablet">
                    <h4><?php echo esc_html__('Exclude Countries', 'ar-ad-manager');?></h4>
                    <p><?php echo esc_html__('Select countries if you don\'t want to show this banner only for certain countries.', 'ar-ad-manager');?></p>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <div class="mdl-textfield mdl-js-textfield">
                        <?php $excludeCountrySelectedValues = get_post_meta($post->ID, Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX . "_banner_exclude_countries", true); ?>
                        <?php $excludeCountrySelectedValues = $countrySelectedValues ? explode(',', $excludeCountrySelectedValues) : []; ?>

                        <select
                            name="<?php echo esc_html(\Partials_Ar_Ad_Manager_Meta_Box_Abstract::AR_AD_MANAGER_FIELD_PREFIX); ?>[banner_exclude_countries][]"
                            id="banner_exclude_countries"
                            multiple
                        >
                            <?php foreach ($countryList as $country): ?>
                                <option value="<?php echo esc_html($country['code']); ?>" <?php echo (in_array($country['code'], $excludeCountrySelectedValues)) ? 'selected' : ''; ?>>
                                    <?php echo esc_html($country['name']); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
