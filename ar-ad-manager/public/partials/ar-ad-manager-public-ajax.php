...
class Partials_Ar_Ad_Manager_Public_Ajax
{
    ...
    {
        add_action('wp_ajax_ar_ad_manager_zone_data', [$this, "ar_ad_manager_adzone_data"]);
        add_action('wp_ajax_nopriv_ar_ad_manager_zone_data', [$this, "ar_ad_manager_adzone_data"]);
    }
        ...
        foreach ($adzoneIdsArray as $adzoneId) {
            try {
                ...
                $adzoneResult[] = [
                    ...
                    'available_banners' => $adzoneData['all_available_banners']
                ];
            } catch (Exception $e) {
                $adzoneResult[] = [
                    'id' => $adzoneId,
