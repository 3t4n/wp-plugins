...
The Accepted Payment Methods plugin is a straightforward, lightweight solution for displaying visually appealing icons on your website.
...
**The image set for various payment icons can be found [here](https://iconduck.com/sets/payment-icons)**
