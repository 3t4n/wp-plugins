...
class EmailTemplate extends SettingSimpleGrouped
{
	...
	public function tagsEmailForCustomer()
	{
		...
		$list = [
			...
			'first_name' => __eva('First name'),
			'last_name' => __eva('Last name'),
			...
			'area_table_assigned' => __eva('Area/Table assigned to user'),
			...
			'cancel_reason' => $pro.__eva('Cancel reason'),
	...
	public function tagsEmailForAdministrator()
	{
		$list = [
			...
			'cancel_reason' => __eva('User cancel reason'),
		];
