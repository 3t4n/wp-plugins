...
require_once ALEXR_PLUGIN_DIR_APP . 'database/db-workflows.php';
require_once ALEXR_PLUGIN_DIR_APP . 'database/db-workflow-steps.php';
require_once ALEXR_PLUGIN_DIR_APP . 'database/db-workflow-instances.php';
require_once ALEXR_PLUGIN_DIR_APP . 'database/db-workflow-step-executions.php';
...
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Enums/WorkflowStatus.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Enums/WorkflowInstanceStatus.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Enums/WorkflowStepExecutionStatus.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Enums/WorkflowTriggerType.php';
...
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Settings/Traits/AvailabilityWeekdaysHelpers.php';
...
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Models/Workflow.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Models/WorkflowStep.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Models/WorkflowInstance.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Models/WorkflowStepExecution.php';
...
// Workflows
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/WorkflowTrigger.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/WorkflowExecutor.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Templates/NoShowWorkflowCreator.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/WorkflowActionFactory.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/WorkflowAction.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/AddTagsAction.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/RemoveTagsAction.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/SendEmailAction.php';
require_once ALEXR_PLUGIN_DIR_APP . 'Alexr/Workflows/Actions/WaitAction.php';
