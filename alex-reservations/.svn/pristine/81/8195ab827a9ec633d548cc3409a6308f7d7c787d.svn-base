			...
			[
				...
				'fields' => [[
					...
					'value' => [
						...
						'all_tables_covers' => $all_tables_covers,
						'list_of_tables' => $this->list_of_tables,

						'list_of_tables_weekdays' => [
							'overwrite_list_of_tables' => $this->overwrite_list_of_tables,
							'mon_overwrite_list_of_tables' => $this->mon_overwrite_list_of_tables,
							'mon_list_of_tables' => $this->mon_list_of_tables,
							'tue_overwrite_list_of_tables' => $this->tue_overwrite_list_of_tables,
							'tue_list_of_tables' => $this->tue_list_of_tables,
							'wed_overwrite_list_of_tables' => $this->wed_overwrite_list_of_tables,
							'wed_list_of_tables' => $this->wed_list_of_tables,
							'thu_overwrite_list_of_tables' => $this->thu_overwrite_list_of_tables,
							'thu_list_of_tables' => $this->thu_list_of_tables,
							'fri_overwrite_list_of_tables' => $this->fri_overwrite_list_of_tables,
							'fri_list_of_tables' => $this->fri_list_of_tables,
							'sat_overwrite_list_of_tables' => $this->sat_overwrite_list_of_tables,
							'sat_list_of_tables' => $this->sat_list_of_tables,
							'sun_overwrite_list_of_tables' => $this->sun_overwrite_list_of_tables,
							'sun_list_of_tables' => $this->sun_list_of_tables
						],
						'cannot_duplicate_tables' => $this->cannot_duplicate_tables,
						'skip_block_tables' => $this->skip_block_tables,
					]
				]]
			]
		];

		// Para sobreescribir availability mode por dias de la semana. NO LO USO
		/*
		$availability_weekdays = [
			'only_for_class' => Shift::class,
			'attribute' => 'availability_weekdays',
			'stacked' => true,
			'class' => 'block',
			'name' => __eva('Customize the reservation mode for each weekday'),
			'helpText' => __eva('Only use this to override the default reservation mode'),
			//'component' => 'overwrite-reservation-mode',
			'component' => 'group-field',
			'fields' => [
				[
					'component' => 'edit-reservation-mode',
					'value' => [
						'overwrite_reserve_mode' => $this->overwrite_reserve_mode, // Overwrite in general

						// Monday
						'mon_reserve_mode' => $this->mon_reserve_mode, // Overwrite or not
						'mon_availability_type' => $this->mon_availability_type,
						'mon_availability_total' => $this->mon_availability_total,
						'mon_availability_slots' => [
							'mon_availability_slots' => $this->mon_availability_slots,
							'mon_availability_slots_limit_new_covers' => $this->mon_availability_slots_limit_new_covers,
						],
						'mon_all_tables_covers' => $all_tables_covers,
						'mon_list_of_tables' => $this->mon_list_of_tables,
						'mon_cannot_duplicate_tables' => $this->mon_cannot_duplicate_tables,

						// Tuesday
						'tue_reserve_mode' => $this->tue_reserve_mode,
						'tue_availability_type' => $this->tue_availability_type,
						'tue_availability_total' => $this->tue_availability_total,
						'tue_availability_slots' => [
							'tue_availability_slots' => $this->tue_availability_slots,
							'tue_availability_slots_limit_new_covers' => $this->tue_availability_slots_limit_new_covers,
						],
						'tue_all_tables_covers' => $all_tables_covers,
						'tue_list_of_tables' => $this->tue_list_of_tables,
						'tue_cannot_duplicate_tables' => $this->tue_cannot_duplicate_tables,

						// Wednesday
						'wed_reserve_mode' => $this->wed_reserve_mode,
						'wed_availability_type' => $this->wed_availability_type,
						'wed_availability_total' => $this->wed_availability_total,
						'wed_availability_slots' => [
							'wed_availability_slots' => $this->wed_availability_slots,
							'wed_availability_slots_limit_new_covers' => $this->wed_availability_slots_limit_new_covers,
						],
						'wed_all_tables_covers' => $all_tables_covers,
						'wed_list_of_tables' => $this->wed_list_of_tables,
						'wed_cannot_duplicate_tables' => $this->wed_cannot_duplicate_tables,

						// Thursday
						'thu_reserve_mode' => $this->thu_reserve_mode,
						'thu_availability_type' => $this->thu_availability_type,
						'thu_availability_total' => $this->thu_availability_total,
						'thu_availability_slots' => [
							'thu_availability_slots' => $this->thu_availability_slots,
							'thu_availability_slots_limit_new_covers' => $this->thu_availability_slots_limit_new_covers,
						],
						'thu_all_tables_covers' => $all_tables_covers,
						'thu_list_of_tables' => $this->thu_list_of_tables,
						'thu_cannot_duplicate_tables' => $this->thu_cannot_duplicate_tables,

						// Friday
						'fri_reserve_mode' => $this->fri_reserve_mode,
						'fri_availability_type' => $this->fri_availability_type,
						'fri_availability_total' => $this->fri_availability_total,
						'fri_availability_slots' => [
							'fri_availability_slots' => $this->fri_availability_slots,
							'fri_availability_slots_limit_new_covers' => $this->fri_availability_slots_limit_new_covers,
						],
						'fri_all_tables_covers' => $all_tables_covers,
						'fri_list_of_tables' => $this->fri_list_of_tables,
						'fri_cannot_duplicate_tables' => $this->fri_cannot_duplicate_tables,

						// Saturday
						'sat_reserve_mode' => $this->sat_reserve_mode,
						'sat_availability_type' => $this->sat_availability_type,
						'sat_availability_total' => $this->sat_availability_total,
						'sat_availability_slots' => [
							'sat_availability_slots' => $this->sat_availability_slots,
							'sat_availability_slots_limit_new_covers' => $this->sat_availability_slots_limit_new_covers,
						],
						'sat_all_tables_covers' => $all_tables_covers,
						'sat_list_of_tables' => $this->sat_list_of_tables,
						'sat_cannot_duplicate_tables' => $this->sat_cannot_duplicate_tables,

						// Sunday
						'sun_reserve_mode' => $this->sun_reserve_mode,
						'sun_availability_type' => $this->sun_availability_type,
						'sun_availability_total' => $this->sun_availability_total,
						'sun_availability_slots' => [
							'sun_availability_slots' => $this->sun_availability_slots,
							'sun_availability_slots_limit_new_covers' => $this->sun_availability_slots_limit_new_covers,
						],
						'sun_all_tables_covers' => $all_tables_covers,
						'sun_list_of_tables' => $this->sun_list_of_tables,
						'sun_cannot_duplicate_tables' => $this->sun_cannot_duplicate_tables,
					]
				],
			]
