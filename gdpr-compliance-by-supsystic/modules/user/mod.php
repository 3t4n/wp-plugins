<?php
class userGdprsup extends moduleGdprsup {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameGdprsup::_()->getModule('adminmenu')->getMainCap() );
    }
	public function getCurrentUserPosition() {
		if($this->isAdmin())
			return GDPRSUP_ADMIN;
		else if($this->getCurrentID())
			return GDPRSUP_LOGGED;
		else 
			return GDPRSUP_GUEST;
	}
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameGdprsup::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbGdprsup::get('SELECT * FROM #__users 
