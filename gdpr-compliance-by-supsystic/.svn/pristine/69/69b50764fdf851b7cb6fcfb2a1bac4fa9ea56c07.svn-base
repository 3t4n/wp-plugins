<?php
abstract class viewGdprsup extends baseObjectGdprsup {
    /* 
     * @deprecated
     */
    protected $_tpl = GDPRSUP_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameGdprsup::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameGdprsup::_()->getModule( $this->_code )->getController()->getModel($code);
	}
