...
final class Init {
	...
	public function elementor_missing_notice() {
		echo '<div class="notice notice-error"><p><strong>Advanced News Ticker for Elementor</strong> requires Elementor. Please install Elementor to use this plugin.</p></div>';
	}
