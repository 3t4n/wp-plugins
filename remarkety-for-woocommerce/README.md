...
Tags: email marketing, sms marketing, abandoned cart, email automation, newsletters,
...
== Changelog ==
1.6.2
Bugfix - In cart view page, prevent issues on undefined user

1.6.1
Update plugin tags

1.6.0
Support WordPress 6.7.1 / WooCommerce 9.4.2
