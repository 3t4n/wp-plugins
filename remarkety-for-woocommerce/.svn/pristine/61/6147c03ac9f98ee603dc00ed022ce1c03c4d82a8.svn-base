...
/*  Copyright 2024  Remarkety Inc  (email : sales@remarkety.com)
    ...
    class remarkety_for_woocommerce
    {
        ...
        private function get_cart_content()
        {
            if (is_user_logged_in()) {
                ...
                if (empty($session_customer) || empty($session_customer['id']) || empty($session_customer['email'])) {
            ...
            $data = [
                ...
                "customer" => [
                    "id" => isset($session_customer['id']) ? $session_customer['id'] : null,
                    "email" => isset($session_customer['email']) ? $session_customer['email'] : null,
