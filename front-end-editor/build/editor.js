...
(function() {
  ...
  FrontEndEditor.hover = (function() {
    ...
    function hover(target) {
      ...
      this.target.mousemove((function(_this) {
        return function(ev) {
          return _this.position_vert(ev.pageY);
        };
      })(this));
      this.target.mouseover((function(_this) {
        return function(ev) {
    ...
    hover.prototype.not_editing = function($content) {
      ...
      this.container.bind('mouseover.autohide', (function(_this) {
        return function() {
          return _this.lock = true;
        };
      })(this));
      this.container.bind('mouseout.autohide', (function(_this) {
        return function() {
          _this.lock = false;
          return _this.hide();
        };
      })(this));
      return this.target.bind('mouseout.autohide', (function(_this) {
        return function(ev) {
          return _this.hide();
        };
      })(this));
  ...
  FrontEndEditor.fieldTypes.input = (function(_super) {
    ...
    input.prototype.create_form = function() {
      ...
      return this.form.keypress((function(_this) {
        return function(ev) {
  ...
  FrontEndEditor.fieldTypes.image_base = (function(_super) {
    ...
    image_base.prototype.start_editing = function() {
      ...
      return jQuery('#TB_iframeContent').load((function(_this) {
        return function(ev) {
          var $thickbox, iframe;
    ...
    image_base.prototype.thickbox_load = function($thickbox) {
      return $thickbox.delegate('.media-item :submit', 'click', (function(_this) {
        return function(ev) {
          var $button, data;
  ...
  FrontEndEditor.fieldTypes.image = (function(_super) {
    ...
    image.prototype.start_editing = function() {
      ...
      return jQuery('<a id="fee-img-revert" href="#">').text(FrontEndEditor.data.image.revert).click((function(_this) {
        return function(ev) {
          _this.ajax_set(-1);
          return false;
        };
      })(this)).insertAfter('#TB_ajaxWindowTitle');
    };
