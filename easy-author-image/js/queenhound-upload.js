jQuery(document).ready(function($){
	$('#author_profile_picture_button').click(function() {
		...
		tb_show('Upload an author profile picture! (from the Author Avatar plugin at Queenhound.com)', 'media-upload.php?referer=profile&amp;type=image&amp;TB_iframe=true&amp;post_id=0', false);
		return false;
	});
	...
	window.send_to_editor = function(html) {
		...
		var image_url = $('<div/>').html(html).find('img').attr('src');
		//alert(html);
