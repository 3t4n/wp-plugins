...
Tags: woocommerce, wpc, save-for-later
Tested up to: 6.7
Version: 3.3.2
Stable tag: 3.3.2
...
* Updated: Compatible with WordPress 6.6 & WooCommerce 9.3

= 3.2.4 =
* Added: Show button on archive/single page

= 3.2.3 =
* Fixed: Output of the shortcode [woosl_btn]

= 3.2.2 =
* Fixed: Minor CSS/JS issues in the backend

= 3.2.1 =
* Updated: Compatible with WordPress 6.5 & WooCommerce 8.8

= 3.2.0 =
* Added: Save for later column on Users table

= 3.1.2 =
* Updated: Compatible with WordPress 6.4 & WooCommerce 8.4
