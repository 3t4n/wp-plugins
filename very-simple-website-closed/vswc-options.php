...
function vswc_field_callback_16() {
	...
	<label><input type='checkbox' name='vswc-setting-16' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Do not delete settings when uninstalling plugin.', 'very-simple-website-closed' ); ?></label>
	<?php
}
...
function vswc_field_callback_1() {
	...
	<p><?php esc_attr_e( 'Logged in administrators can preview the landing page.', 'very-simple-website-closed' ); ?></p>
	<?php
}
...
function vswc_field_callback_23() {
	...
	<p><?php esc_attr_e( 'This image will cover whole screen.', 'very-simple-website-closed' ) ?></p>
	<?php
}
...
function vswc_field_callback_17() {
	...
	<p><?php esc_attr_e( 'The width of the logo image in pixels.', 'very-simple-website-closed' ); ?></p>
	<?php
}
...
function vswc_field_callback_21() {
	...
	<p><?php echo '<code>body</code> <code>#vswc</code> <code>.vswc-logo</code> <code>#vswc h1.vswc-title</code> <code>.vswc-content</code> <code>#vswc p</code>'; ?></p>
	<?php
}
...
<div class="wrap">
	...
	if ($preview == 'yes') { ?>
		<p style="padding:5px 10px;border-bottom:5px solid #008000;background:#00a32a;color:#fff;font-size:1.2em;"><?php esc_attr_e( 'Preview mode', 'very-simple-website-closed' ); ?></p>
	<?php } elseif (in_array('yes', $days)) { ?>
		<p style="padding:5px 10px;border-bottom:5px solid #008000;background:#00a32a;color:#fff;font-size:1.2em;"><?php esc_attr_e( 'Website is closed on selected days.', 'very-simple-website-closed' ); ?></p>
	<?php }	?>
