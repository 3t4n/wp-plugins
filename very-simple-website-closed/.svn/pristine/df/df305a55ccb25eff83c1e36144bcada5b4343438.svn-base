...
Main difference between this plugin and similar plugins is that you can select certain days instead of just closing your website.
...
= Styling =
Custom styling of the landing page via page Additional CSS of the Customizer is being ignored. But you can add custom styling via the settings page.
