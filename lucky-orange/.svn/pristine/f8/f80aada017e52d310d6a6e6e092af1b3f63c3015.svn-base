...
= 2.1.2 =
* Use page variable for site IDs instead of query parameters. This should improve support with caching plugins.

= 2.1.0 =
* Supports loading the correct tracking code for classic customers.
