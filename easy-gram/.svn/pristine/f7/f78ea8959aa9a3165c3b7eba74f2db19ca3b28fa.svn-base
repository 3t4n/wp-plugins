<div class="easygram-widget" style="max-width: <?php echo absint( $instance['container_size'] ); ?>px; margin: -<?php echo esc_attr( $instance['photo_space']/2 ); ?>px;">
