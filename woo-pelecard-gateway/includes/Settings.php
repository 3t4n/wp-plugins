...
class Settings {
	...
	public static function get_admin_fields(): array {
		$settings = [
			...
			'hook_forieng_card' => [
				'title' => __( 'Root terminal', 'wc-pelecard-gateway' ),
				'label' => __( 'Enable foreign cards  on root terminal only', 'wc-pelecard-gateway' ),
				'type' => 'checkbox',
				'description' => __( 'Relevant for sites that have Subscriptions and want to use foregin credit card. The transaction will not be charged  on sub terminal.', 'wc-pelecard-gateway' ),
				'default' => 'no',
				'desc_tip' => true,
			],
			'payments_title' => [
