...
/**
 * Class Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Float_Validation_Rule_Builder
 *
 * @since 0.1.0
...
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Rules\Float_Validation_Rule;
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Rules\Numeric_Range_Validation_Rule;
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Rules\Regexp_Validation_Rule;
/**
 * Class for a float validation rule builder.
 *
 * @since 0.1.0
 */
class Float_Validation_Rule_Builder extends Abstract_Validation_Rule_Builder
{
    /**
     * Constructor.
     *
    ...
    {
        \array_unshift($initial_rules, new Float_Validation_Rule($strict));
    ...
    protected function is_allowed_rule(Validation_Rule $rule) : bool
    {
        ...
        return $rule->supports_type(Types::TYPE_FLOAT);
    }
}
