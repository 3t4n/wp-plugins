 ...
 */
namespace Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\REST_Routes\Exception;

use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\General\Exception\WP_Error_Exception;
use WP_Error;
/**
...
class REST_Exception extends WP_Error_Exception
{
    ...
    public function set_response_code(int $response_code) : void
    {
        if ($response_code < 400) {
            // Only error response code >= 400 are allowed.
            return;
        }
