...
namespace Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception;

use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\BodySummarizer;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\BodySummarizerInterface;
use Felix_Arntz\AI_Services_Dependencies\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null) : self
    {
        ...
        $uri = \Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
