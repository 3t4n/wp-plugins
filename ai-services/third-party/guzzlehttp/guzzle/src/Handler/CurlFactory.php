...
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\ConnectException;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\RequestException;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Promise as P;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Promise\FulfilledPromise;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Promise\PromiseInterface;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\LazyOpenStream;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\TransferStats;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Utils;
use Felix_Arntz\AI_Services_Dependencies\Psr\Http\Message\RequestInterface;
use Felix_Arntz\AI_Services_Dependencies\Psr\Http\Message\UriInterface;
/**
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx) : PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri) : string
    {
        ...
        $redactedUriString = \Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Psr7\Utils::streamFor($sink);
