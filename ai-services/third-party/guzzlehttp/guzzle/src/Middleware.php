...
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Cookie\CookieJarInterface;
...
use Felix_Arntz\AI_Services_Dependencies\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Felix_Arntz\\AI_Services_Dependencies\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
