...
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\BadResponseException;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\TooManyRedirectsException;
