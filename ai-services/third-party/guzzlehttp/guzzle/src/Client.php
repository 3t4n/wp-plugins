...
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Cookie\CookieJar;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\GuzzleException;
use Felix_Arntz\AI_Services_Dependencies\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Felix_Arntz\AI_Services_Dependencies\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
