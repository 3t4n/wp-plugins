 ...
 */
namespace Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Traits;
...
trait Type_Support
{
     ...
     */
    public final function supports_type(int $type) : bool
    {
     ...
     */
    protected abstract function get_supported_types() : int;
}
