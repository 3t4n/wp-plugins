...
/**
 * Class Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Rules\Float_Validation_Rule
 *
 * @since 0.1.0
...
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Validation\Contracts\With_Strict;
 ...
 * @since 0.1.0
 */
class Float_Validation_Rule implements Validation_Rule, With_Strict
{
    use Strict_Mode;
    /**
     * Constructor.
    ...
    public function validate($value) : void
    {
        ...
        if ($this->is_strict() || !\is_numeric($value)) {
            throw Validation_Exception::create('invalid_float', \sprintf(
