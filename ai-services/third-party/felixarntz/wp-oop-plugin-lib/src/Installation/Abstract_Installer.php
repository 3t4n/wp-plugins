 ...
 */
namespace Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\Installation;

use Exception;
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\General\Plugin_Env;
use Felix_Arntz\AI_Services_Dependencies\Felix_Arntz\WP_OOP_Plugin_Lib\General\Traits\Maybe_Throw;
...
abstract class Abstract_Installer implements Installer
{
    ...
    public function uninstall() : bool
    {
         ...
         */
        $site_ids = get_sites(array('fields' => 'ids', 'number' => 20, 'meta_key' => $this->version_option->get_key()));
     ...
     */
    protected abstract function install_data() : void;
    /**
     ...
     */
    protected abstract function upgrade_data(string $old_version) : void;
    /**
     ...
     */
    protected abstract function uninstall_data() : void;
}
