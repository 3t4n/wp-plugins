...
class User_Query implements Entity_Query
{
    ...
    public function get_entities() : array
    {
        ...
        $this->wp_obj->query();
        return \array_map(array($this, 'wrap_user'), $this->wp_obj->get_results());
    }
    /**
    ...
    {
        return wp_parse_args($query_args, array(
            'number' => 100,
            // Better default than -1 (unlimited).
            'count_total' => \false,
        ));
    }
    /**
