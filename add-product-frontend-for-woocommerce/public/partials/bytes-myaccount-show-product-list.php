		...
		<table class="bt_table">
			...
			while($loop->have_posts()) : $loop->the_post(); 
				...
				<tr>
					...
					<td>
						<a href="<?php echo esc_url(get_permalink(wc_get_page_id('myaccount'))); ?>edit-product-form/?id=<?php echo base64_encode(absint(get_the_id())); ?>" data-id="<?php echo base64_encode(absint(get_the_id())); ?>" class="edit_product"><?php esc_html_e('Edit', 'bytes_product_frontend'); ?></a>
					| <a href="javascript:void(0)" data-id="<?php echo base64_encode(absint(get_the_id())); ?>" class="delete_product"><?php esc_html_e('Delete', 'bytes_product_frontend'); ?></a>
					</td>
				</tr>
			<?php endwhile; ?>
			</tbody>
