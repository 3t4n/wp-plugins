...
if(!class_exists('APFFW_Bytes_Add_Product_Frontend_For_Woocommerce_Admin')){
	class APFFW_Bytes_Add_Product_Frontend_For_Woocommerce_Admin {
		...
		public function apffw_frontend_product_display_options(){
	        ...
	        add_settings_field("frontend_product_save_update_email", "Email notification for user", array($this, "apffw_display_send_email_notification_create_update_product"), "plugin-options", "header_section");
	        add_settings_field("frontend_product_save_update_email_admin", "Email notification for administrator", array($this, "apffw_display_send_email_notification_create_update_product_admin"), "plugin-options", "header_section");
	        ...
	        register_setting("header_section", "frontend_product_save_update_email");
	        register_setting("header_section", "frontend_product_save_update_email_admin");
		}
		...
		public function apffw_display_send_email_notification_create_update_product(){
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/setting/plugin-setting-email.php';
		}

		public function apffw_display_send_email_notification_create_update_product_admin(){
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/setting/plugin-setting-email-admin.php';
			echo '</div></div>';
		}
