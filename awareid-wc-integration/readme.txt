...
= 3.0.0 =
* Enhancement: Added support for biometric verification when registering users.

= 2.2.2 =
* Enhancement: Added support for AwareID watchlist checks.

= 2.2.1 =
* Security: Added proper nonce verification for form submissions
* Fix: Corrected timestamp handling for verification status changes
* Fix: Fixed issue where ignored states weren't being added to form
* Fix: Resolved issues with cookie handling
