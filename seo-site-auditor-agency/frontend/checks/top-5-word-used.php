<?php
if (!function_exists('sdt_top_5_word_used')) {

	function sdt_top_5_word_used($args) {
		global $html;
		...
		$repeated = array_filter(array_count_values($newWords), function($count) {
			return $count > 1;
		});
		$values = array();
		...
		<section class="container-details-page">
			<h2 class="title-section"><?php _e('TOP 5 WORDS USED', "SDT"); ?></h2>
			<article>
				<div class="tabla">
...
add_action("sdt_top_5_wordused", 'sdt_top_5_word_used');
