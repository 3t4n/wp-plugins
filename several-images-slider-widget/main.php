...
{
    update_option( 'sisw_gwl_version','2.5');
}
...
class SISW_multi_image_slider_widget
{
	function __construct()
	{
		...
		add_filter('plugin_row_meta',  array($this,'sisw_add_custom_plugin_links'), 10, 2);
	}
	 ...
	 * @since 1.0.0
	 */
	function sisw_add_custom_plugin_links($links, $file)
	{
		if (!isset($plugin)){
		...
		if ($plugin == $file) {
			$links[] = '<a href="https://wp-plugins.galaxyweblinks.com/wp-plugins/several-images-slider-widget/doc" target="_blank">Documentation</a>';
