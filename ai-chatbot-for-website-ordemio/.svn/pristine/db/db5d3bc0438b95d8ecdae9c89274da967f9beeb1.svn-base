        ...
        <div class="flex flex-row gap-3 justify-center">
            <div style="min-width: 390px;">
                ...
                <div class="mx-auto mb-5">
                    <h4 class="text-xl font-bold">Sign in</h4>
                </div>
                ...
                <form class="mx-auto" method="POST">
                    ...
                    <div class="flex items-start mt-5">
                        <label for="terms" class="text-sm font-medium text-gray-900 dark:text-gray-300">
                            Don't have an account? <a href="/wp-admin/admin.php?page=ordemio-settings" class="text-blue-600 hover:underline">Sign Up</a>
                        </label>
                    </div>
                    <input type="hidden" name="auth_user" value="Y">
                </form>
            </div>
            <div>
