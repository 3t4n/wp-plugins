...
class MoMo_Auto_Content_Generator {
    ...
    public function momo_acg_fe_chatbot_init() {
        ...
        include_once 'chatbot/admin/class-momo-embeddings-model.php';
        $this->embeddings = new MoMo_Embeddings_Model();
    ...
    public function momo_acg_rss_feed_init() {
        if ( is_admin() ) {
            ...
            /* if ( momoacg_fs()->is__premium_only() ) { */
            include_once 'autoblog/admin/class-momo-acg-rssfeed-admin-ajax.php';
            /* } */
        }
    }
