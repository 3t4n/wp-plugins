...
?></label>
							<select id="" name="momo_acg_chatbot_settings[model]" class="full-width ">
...
?>
							...
							<input type="text" class="full-width " name="momo_acg_chatbot_settings[temperature]" placeholder="0.2" value="<?php 
...
?>
							...
							<input type="number" name="momo_acg_chatbot_settings[max_tokens]" placeholder="660" class="full-width " value="<?php 
...
?>
							...
							<input type="text" class="full-width " name="momo_acg_chatbot_settings[max_length]" value="<?php 
...
?>:</label>
								<input type="text" class="full-width " placeholder="AI" name="momo_acg_chatbot_settings[ai_name]" value="<?php 
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[welcome_message]" placeholder="How can I help?" value="<?php 
...
?>:</label>
								<input type="text" class="full-width " placeholder="User" name="momo_acg_chatbot_settings[username]" value="<?php 
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[placeholder]" placeholder="Type your message here....." value="<?php 
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[typing]" placeholder="Collecting data" value="<?php 
...
?>:</label>
								<select name="momo_acg_chatbot_settings[position]" class="full-width ">
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[popup]" value="<?php 
echo esc_attr( $popup );
?>">
							</div>	
						</div>
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[icon_url]" placeholder="<?php 
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[width]" placeholder="400px" value="<?php 
echo esc_attr( $width );
?>">
							</div>
							<div class="momo-col">
...
?>:</label>
								<input type="text" class="full-width " name="momo_acg_chatbot_settings[height]" placeholder="600px" value="<?php 
