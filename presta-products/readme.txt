...
= 1.2.0 = (07/11/2024)
* Testée jusqu’à la version 6.6.2 de WordPress
* Nouveau: Gestion de matching des catégories Prestashop avec des catégories WP (PREMIUM)
* Fixed: Amélioration des flux API
