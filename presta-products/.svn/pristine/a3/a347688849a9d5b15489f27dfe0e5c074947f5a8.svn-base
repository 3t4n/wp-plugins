<div class="mt-4 clr ppgbo-examples" <?php echo (($page != 'examples') ? 'style="display:none;"' : ''); ?>>
    ...
    ?>
    <div class="mt-3">
        <h5><?php echo __( 'Catégories (correspondances)', 'presta-products'); ?></h5>
        <code>auto_category="1"</code><br>
        <i><?php echo __( 'Utilise l\'onglet Correspondance des catégories pour afficher les produits correspondant à la catégorie Wordpress en cours.<br>PREMIUM seulement.', 'presta-products'); ?></i>
    </div>
    <hr>
    <?php 
        }
