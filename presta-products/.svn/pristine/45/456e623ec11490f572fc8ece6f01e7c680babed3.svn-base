<div class="wrap clr">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        ?>
            ...
            <a href="admin.php?page=presta-products&amp;tab=categories" class="nav-tab <?php echo (($page == 'categories') ? 'nav-tab-active' : ''); ?>"><?php echo __( 'Correspondances des catégories', 'presta-products' ); ?></a>
        <?php
            }
            else {
        ?>
            ...
            <a href="javascript:;" class="nav-tab" title="<?php echo __( 'Uniquement en version PREMIUM.', 'presta-products' ); ?>"><?php echo __( 'Correspondances des catégories (Option PREMIUM)', 'presta-products' ); ?></a>
        <?php   
            }
        ?>
    </h2>