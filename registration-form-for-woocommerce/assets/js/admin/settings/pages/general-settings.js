...
export default () => {
	const { secretKey, siteKey, recaptchaV3SiteKey, recaptchaV3SecreteKey, captchaType, hasData } = useSelect((select) => {
		// eslint-disable-next-line no-shadow
		const { getSecretKey, getSiteKey, getRecaptchaV3SiteKey, getRecaptchaV3SecreteKey, getCaptchaType, hasData } = select('tgwcfb/settings');
		return {
	...
	const { setSecretKey, setSiteKey, setRecaptchaV3SiteKey, setRecaptchaV3SecreteKey, setCaptchaType } = useDispatch('tgwcfb/settings');
