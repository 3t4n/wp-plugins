...
= 1.6 =
* Tested plugin functionality with latest Wordpress 4.3.1 and looked for any conflicts - passed.
= 1.7 = 
* Tested plugin functionality with latest release of Wordpress 4.5 - passed.
