...
function abmsense_activate() {
    ...
    // Clear any cached frequency settings
    wp_cache_delete(ABMSENSE_PREFIX . 'report_frequency', 'options');
    delete_transient(ABMSENSE_PREFIX . 'report_frequency');
    
    // Delete the option first to ensure fresh start
    delete_option(ABMSENSE_PREFIX . 'report_frequency');
    
    // Set default report frequency
    update_option(ABMSENSE_PREFIX . 'report_frequency', 'weekly');
...
function abmsense_update_plugin_data() {
    ...
    $report_frequency = get_option(ABMSENSE_PREFIX . 'report_frequency', 'weekly'); // Add 'weekly' as default
