;(function($) {
    ...
    $.cyberslider = function(el) {
        ...
        base.el = el;
        base.$el = $(base.el);
        base.$viewport = base.$el.find('.cyberslider-viewport');
        base.$container = base.$viewport.find('.cyberslider-slides-container');
        base.$slides = base.$container.find('.cyberslider-slide');
        base.$images = base.$slides.find('.cyberslider-image');

        /** Get the plugin options */
        base.options = o = $.extend({}, $.cyberslider.defaults, $.parseJSON(base.$el.attr('data-options')));
        ...
        base.initialize = function() {
            ...
            base.clickEvent = ( base.supportsTouch ) ? 'touchstart.cyberslider' : 'click.cyberslider';
        ...
        base._setupResponsive = function() {
            ...
            $(window).bind('resize.cyberslider', function(event, force) {
            ...
            $(window).trigger('resize.cyberslider', true);
        ...
        base._setupArrows = function() {
            ...
            var $next = $('.cyberslider-next'),
                $prev = $('.cyberslider-prev'),
        ...
        base._setupPagination = function() {
            ...
            var $pagination = $('.cyberslider-pagination'),
        ...
        base._preload = function() {
            ...
            var loadComplete = function() {
                ...
                count++;
                if ( count >= base.count )
                    base.$el.find('.cyberslider-preload').animate({ 'opacity': 0 }, { duration: 400, complete: function() {
                        $(this).remove();
        ...
        base = $.extend({}, base, $.cyberslider.extensions);
     ...
     * @since 1.0
     */
    $.cyberslider.extensions = {};

    /** Initiates the plugin on each element */
    $.fn.cyberslider = function() {
        return this.each(function() {
            new $.cyberslider(this);
        });
    };
