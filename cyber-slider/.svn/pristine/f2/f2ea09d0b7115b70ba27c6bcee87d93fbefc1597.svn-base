...
?>
<div class="wrap">
    <form name="post" action="admin.php?page=cyberslider_edit_slideshow" method="post">
        <div id="icon-edit" class="icon32 icon32-posts-post"><br></div>
        <h2><?php _e( 'Edit Slideshow', 'cyberslider' ); ?></h2>
        <?php
            ...
            wp_nonce_field( "cyberslider-save_cyberslider_edit_slideshow", "cyberslider-save_cyberslider_edit_slideshow", false );
        ...
        <div class="main-panel">
            ...
            <input type="submit" name="save" class="button button-primary button-large" id="save" accesskey="p" value="<?php _e( 'Save Slideshow', 'cyberslider' ); ?>">
