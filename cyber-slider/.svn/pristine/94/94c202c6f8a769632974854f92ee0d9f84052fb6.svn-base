;(function($) {
    ...
    window.SlideView = wp.media.View.extend({
        ...
        initialize: function() {
            ...
            $('.delete-images').bind('click', function(event) {
                ...
                if ( confirm( cyberslider.delete_images ) )
            ...
            $(document).delegate('.delete-button', 'click', function(event) {
                ...
                if ( confirm( cyberslider.delete_image ) )
    ...
    window.EditSlideView = wp.media.View.extend({
        ...
        discardChanges: function(event) {
            ...
            if ( current === original )
                ...
                if ( confirm( cyberslider.media_upload.discard_changes ) ) {
    ...
    window.AddImageView = Backbone.View.extend({
        ...
        frameProperties: {
            title: cyberslider.media_upload.title,
            button: cyberslider.media_upload.button,
            multiple: true
        },
    ...
    window.ChangeImageView = AddImageView.extend({
        ...
        frameProperties: {
            title: cyberslider.media_upload.title,
            button: cyberslider.media_upload.change,
            multiple: false
        },
