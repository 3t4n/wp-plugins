...
class ESL_Slideshow {
    ...
    public static function enqueue_styles() {
        ...
        do_action( 'cyberslider_enqueue_slideshow_styles' );
    ...
    public static function enqueue_scripts() {
        ...
        do_action( 'cyberslider_enqueue_slideshow_scripts' );
    ...
    public static function print_custom_styles() {
        ...
        $defaults = cyberslider::get_instance()->customization_defaults();
        ...
        <style type="text/css">
            ...
            .cyberslider .cyberslider-arrows.cyberslider-next,
            .cyberslider .cyberslider-arrows.cyberslider-prev {
            ...
            .cyberslider .cyberslider-pagination .cyberslider-icon {
            ...
            .cyberslider .cyberslider-pagination .cyberslider-icon.inactive {
                <?php if ( $defaults->pagination->inactive != $c->pagination->inactive ) echo "background-image: url({$c->pagination->inactive});"; ?>
            }
            .cyberslider .cyberslider-pagination .cyberslider-icon.active {
    ...
    public function display_slideshow() {
        ...
        ob_start();
        require dirname( cyberslider::get_file() ) . DIRECTORY_SEPARATOR .'templates'. DIRECTORY_SEPARATOR .'slideshow.php';
        return ob_get_clean();
