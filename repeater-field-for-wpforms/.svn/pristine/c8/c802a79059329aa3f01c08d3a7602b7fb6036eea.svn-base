...
Tags: WPForms, WPForms fields, Repeater, Repeater form, Repeater field
...
[youtube https://www.youtube.com/watch?v=79wBkjxbOFw]

**DEMO**: <https://demo.add-ons.org/demo-repeater-fields/>
**Download Pro Version**: <https://add-ons.org/plugin/repeater-field-for-wpforms-pro/>
...
5. Document: https://add-ons.org/document-wpfoms-repeater-fields-2/
...
== Changelog ==
= 1.5.0 =
- Fixed: Save option Initial Rows = 0
...
= 1.4.7 =
- Changed: Format style value

= 1.4.6 =
- Added: added hook fiter

= 1.4.2 =
- Fixed: Phone field

= 1.4.1 =
- Fixed: Show textarea hidden

= 1.4.0 =
- Fixed: Compatible with WPForms 1.8.9
