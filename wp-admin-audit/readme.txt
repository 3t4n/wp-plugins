...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/wp-admin-audit)
...
== Upgrade Notice ==
= 1.2.14 =
Fix Sensitive data exposure vulnerability, Fix PHP error

= 1.2.13 =
WP Admin Audit joins Patchstack VDP, Updated PUC library, Tested with WP v6.7
