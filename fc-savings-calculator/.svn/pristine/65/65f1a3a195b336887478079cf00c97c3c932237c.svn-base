...
?>
	...
	<div id="savings-wrap" class="ac-calc-wrap tiny">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="savings-plugin" class="accuratecalculators ac-calculator tiny" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#SAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Savings Calculator Plugin for WordPress', 'fc-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This savings calculator calculates the future value of regular savings.', 'fc-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_SAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_SAVINGS_DERIVATIVE_OF; ?>">
			<meta itemprop="downloadUrl" content="<?php echo FC_SAVINGS_DOWNLOAD_URL; ?>">
			<meta itemprop="softwareVersion" content="<?php echo FC_SAVINGS_VER; ?>">
			...
			<!-- calculator title -->
			<div class="calc-name">
				<?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://AccurateCalculators.com/savings-calculator" target="_blank" data-bs-toggle="tooltip" data-bs-placement="right" title="' . esc_attr__('click for more features', 'fc-savings-calculator') . '">' . $title . '</a>' : $title) ?>
			</div>
			<!--no backlink option-->
			...
			<label class="label" for="edFV-sv"><?php _e('Final Amount (FV)', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFV-sv" maxlength="8" size="16" disabled>

			<label class="label" for="edInterest-sv"><?php _e('Interest Earned', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edInterest-sv" maxlength="14" size="16" disabled>

			<label class="label" for="edTotalInvested-sv"><?php _e('Total Invested', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalInvested-sv" maxlength="14" size="16" disabled>

			<label class="label" for="edFVDate-sv"><?php _e('Last Deposit', 'fc-savings-calculator') ?>:</label>
			...
			<div class="btn-group abbreviated">
				<div class="btn-row">
					<button type="button" id="btnCalc-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Calculate', 'fc-savings-calculator') ?>"><?php _e('C', 'fc-savings-calculator') ?></button>
					<button type="button" id="btnClear-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Clear', 'fc-savings-calculator') ?>"><?php _e('Cl', 'fc-savings-calculator') ?></button>
					<button type="button" id="btnPrint-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Print', 'fc-savings-calculator') ?>"><?php _e('P', 'fc-savings-calculator') ?></button>
					<button type="button" id="btnHelp-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Help', 'fc-savings-calculator') ?>"><?php _e('H', 'fc-savings-calculator') ?></button>
				</div>
				<div class="btn-row">
					<button type="button" id="btnSchedule-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Schedule', 'fc-savings-calculator') ?>"><?php _e('S', 'fc-savings-calculator') ?></button>
					<button type="button" id="btnCharts-sv" class="btn btn-primary btn-calculator" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php esc_attr_e('Charts', 'fc-savings-calculator') ?>"><?php _e('Ch', 'fc-savings-calculator') ?></button>
				</div>
			</div>
			...
			<div class="calc-footer">
				...
				<span id="CCY-sv" class="localization<?php echo strtolower($hide_intl_conventions) == 'yes' ? ' ac-hidden' : ''; ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('click to change currency or date format', 'fc-savings-calculator') ?>" role="button">$ : mm/dd/yyyy</span>
			</div>
		...
		<div id="zoomer-sv" class="<?php echo $class; ?>">
			<span id="shrink-sv" class="minus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="left" title="<?php esc_attr_e('Make me smaller.', 'fc-savings-calculator') ?>" role="button"></span>
			<span id="original-sv" class="cursor-pointer font-medium" role="button"><?php _e('Original Size', 'fc-savings-calculator') ?></span>
			<span id="grow-sv" class="plus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('Make me larger.', 'fc-savings-calculator') ?>" role="button"></span>
		</div>
...
?>
	...
	<div id="savings-wrap" class="ac-calc-wrap small">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="savings-plugin" class="accuratecalculators ac-calculator small" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#SAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Savings Calculator Plugin for WordPress', 'fc-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This savings calculator calculates the future value of regular savings.', 'fc-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_SAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_SAVINGS_DERIVATIVE_OF; ?>">
			...
			<label class="label" for="edFVDate-sv"><?php _e('Last Deposit Date', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFVDate-sv" maxlength="14" size="16" disabled>
			<!-- end savings calculator -->
		...
		<?php $class = (strtolower($hide_resize) === "yes") ? 'zoomer ac-hidden' : 'zoomer'; ?>
		<div id="zoomer-sv" class="<?php echo $class; ?>">
			<span id="shrink-sv" class="minus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="left" title="<?php esc_attr_e('Make me smaller.', 'fc-savings-calculator') ?>"></span>
			<span id="original-sv" class="cursor-pointer font-medium" role="button"><?php _e('Original Size', 'fc-savings-calculator') ?></span>
			<span id="grow-sv" class="plus cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php esc_attr_e('Make me larger.', 'fc-savings-calculator') ?>"></span>
		</div>
...
?>
	...
	<div id="savings-wrap" class="ac-calc-wrap medium">
		<!--see CSS vars for min-width and max-width for each calculator size.-->

		<!--calculator-->
		<div id="savings-plugin" class="accuratecalculators ac-calculator medium grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#SAVINGSPLUGIN">
			<meta itemprop="name" content="<?php _e('Savings Calculator Plugin for WordPress', 'fc-savings-calculator'); ?>">
			<meta itemprop="description" content="<?php _e('This savings calculator calculates the future value of regular savings.', 'fc-savings-calculator'); ?>">
			<meta itemprop="sameAs" content="<?php echo FC_SAVINGS_PLUGIN_HOMEPAGE; ?>">
			<meta itemprop="exampleOfWork" content="<?php echo FC_SAVINGS_DERIVATIVE_OF; ?>">
			...
			<label class="label" for="edTotalInvested-sv"><?php _e('Total Amount Invested', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edTotalInvested-sv" maxlength="14" size="16" disabled>
...
?>
	...
	<div id="savings-wrap" class="ac-calc-wrap large">
		...
		<div id="savings-plugin" class="accuratecalculators ac-calculator large grid-3-5" itemscope itemtype="https://schema.org/SoftwareApplication https://schema.org/WebApplication" itemid="https://accuratecalculators.com#SAVINGSPLUGIN">
			...
			<label class="label" for="edFV-sv"><?php _e('Final Amount (future value)', 'fc-savings-calculator') ?>:</label>
			<input type="tel" inputmode="decimal" class="calc-control num" id="edFV-sv" maxlength="8" size="16" disabled>
			...
			<div class="modal-content ac-modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">
						<?php _e('Currency and Date Conventions', 'fc-savings-calculator') ?>
					</h4>
				...
				<div class="modal-body">
					...
					?>
						...
						<div class="msg mb-6">
							<?php _e('The calculator will remember your choice. You may also change it at any time.', 'fc-savings-calculator') ?>
						</div>
						<div class="msg">
							<?php _e('Clicking "Save changes" will cause the calculator to reload. Your edits will be lost.', 'fc-savings-calculator') ?>
						</div>
					<?php
					}
					?>
				...
				<div class="modal-footer">
					<button id="CURRENCYDATE_cancel" type="button" class="btn btn-default" data-bs-dismiss="modal"><?php _e('Cancel', 'fc-savings-calculator') ?></button>
					<button id="CURRENCYDATE_save" type="button" class="btn btn-primary" data-bs-dismiss="modal"><?php _e('Save changes', 'fc-savings-calculator') ?></button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="rpt-title" class="modal-title">
						<?php _e('Cash flow forecast...', 'fc-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
				...
				<div class="modal-footer">
					<button id="RPT_cancel" type="button" class="btn btn-primary btn-primary-inverse px-8 py-2" data-bs-dismiss="modal">
						<?php _e('Close', 'fc-savings-calculator') ?>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="chart-title" class="modal-title">
						<?php _e('Charts', 'fc-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="hlp-title" class="modal-title">
						<?php _e('Help', 'fc-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
			...
			<div class="modal-content ac-modal-content">
				<div class="modal-header">
					<h4 id="msg-title" class="modal-title">
						<?php _e('Message', 'fc-savings-calculator') ?>
					</h4>
					<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
						<span class="sym text-3xl" aria-hidden="true">&times;</span>
					</button>
