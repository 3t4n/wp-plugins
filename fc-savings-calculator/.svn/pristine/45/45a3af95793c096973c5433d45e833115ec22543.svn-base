...
Donate link: N/A
Tags: calculator, saving, savings calculator, future value calculator, savings schedule, retirement saving, college saving
...
A savings calculator to create date-based future value schedules and charts. Rebrandable. Supports 90 currencies, 6 date formats, and 15 languages.


== Description ==  

The **[AC Savings Calculator Plugin (try it now!)](https://AccurateCalculators.com/calculator-plugins/savings-plugin)** creates date-based savings schedules and interactive charts. Answers the question "How much will I have after I make a series of deposits assuming a fixed rate of interest?". 
...
__NEW:__ Upgrade to the free [AC Savings Calculator Plus](https://accuratecalculators.com/calculator-plugins/savings-plus-plugin) v2.0 for a printable savings schedule.

== Installation ==

You can either (a) upload the *fc-savings-calculator* folder with all its files to the */wp-content/plugins/* directory, or (b) unzip the plugin's zip file directly into the */wp-content/plugins/* directory.
...
1. Add the shortcode *[fcsavingsplugin]* in the content area of your page or post and optionally configure the shortcode parameters. WordPress v5.8 introduced the block editor. To install this plugin as a widget in WordPress v5.8 or later, first install the widget shortcode block and then copy this plugin's shortcode into it.
...
I'm happy to provide support for all my plugins! If you have a question or run into an issue, please visit the WordPress plugin's [support forum](https://wordpress.org/support/plugin/fc-savings-calculator/) and post your question.  
...
1. The AC Savings Calculator's front end showing 2 of the 4 configurable sizes with different color settings.
2. Example of a savings schedule showing projected dates and a detailed summary.
