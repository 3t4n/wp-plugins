...
?>
<div class="wrap eis-page-container">
	...
	<form name="eis-form" method="post" action="options.php">
		<div class="eis-interface-settings<?php echo (!$interface_info['show_tabs'] ? ' no-tabs' : null) ?>" data-ajax-url="<?php echo admin_url('admin-ajax.php'); ?>" data-nonce="<?php echo wp_create_nonce('eis_interface_nonce'); ?>">
			<?php
