...
/*
*
*	Easy Interface Settings V 1.0.9
*	------------------------------------------------
...
if (!function_exists('eis_interfaces')) {
	...
	$eis_version = '1.0.6'; // version changed from 0 to 1.0.0
    ...
    ================================================== */
	function eis_setup() {
		load_plugin_textdomain( 'easy-interface-settings', false, plugin_basename( EIS_ROOT_PATH . 'languages' ) );
	}
	add_action('plugins_loaded', 'eis_setup');
